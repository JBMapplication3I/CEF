// <copyright file="TieredPricingFallbackProviderConfig.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Providers.Pricing.Tiered
{
    ...
    /// <seealso cref="TieredPricingProviderConfig"/>
    [PublicAPI, GeneratesAppSettings]
    internal static class TieredPricingFallbackProviderConfig
    {
        /// <summary>Initializes static members of the <see cref="TieredPricingFallbackProviderConfig" /> class.</summary>
        static TieredPricingFallbackProviderConfig()
        {
            CEFConfigDictionary.Load(typeof(TieredPricingFallbackProviderConfig));
        }
        ...
        internal static bool IsValid(bool isDefaultAndActivated)
            => (ProviderConfig.CheckIsEnabledBySettings<TieredPricingFallbackProvider>() || isDefaultAndActivated)
