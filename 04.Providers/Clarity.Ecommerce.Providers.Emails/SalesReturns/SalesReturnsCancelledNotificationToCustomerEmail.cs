// <copyright file="SalesReturnsCancelledNotificationToCustomerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales returns cancelled notification to customer email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales returns cancelled notification to customer email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesReturnsCancelledNotificationToCustomerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("Your return request has been canceled at {{CompanyName}}")]
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesReturns.Customer.Canceled.html")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesReturns.Customer.Cancelled";
