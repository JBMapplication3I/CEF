// <copyright file="SalesReturnsSubmittedNotificationToCustomerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales return submitted notification to customer email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales return submitted notification to customer email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesReturnsSubmittedNotificationToCustomerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("Your return request has been received at {{CompanyName}}")]
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesReturns.Customer.Submitted.html")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesReturns.Customer.Submitted";
