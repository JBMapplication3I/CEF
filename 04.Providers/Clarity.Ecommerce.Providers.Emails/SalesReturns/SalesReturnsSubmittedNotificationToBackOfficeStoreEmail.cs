// <copyright file="SalesReturnsSubmittedNotificationToBackOfficeStoreEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales returns submitted notification to back office store email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales returns submitted notification to back office store email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesReturnsSubmittedNotificationToBackOfficeStoreEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesReturns.BackOfficeStore.Submitted.html")]
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("A new return request has been submitted at {{CompanyName}}")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesReturns.BackOfficeStore.Submitted";
