// <copyright file="SalesReturnsConfirmedNotificationToCustomerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales return confirmed notification to customer email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales return confirmed notification to customer email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesReturnsConfirmedNotificationToCustomerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesReturns.Customer.Confirmed.html")]
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("Your sales return confirmation at {{CompanyName}}")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesReturns.Customer.Confirmed";
