// <copyright file="SalesReturnsShippedNotificationToBackOfficeEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales returns shipped notification to back office email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales returns shipped notification to back office email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesReturnsShippedNotificationToBackOfficeEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesReturns.BackOffice.Shipped.html")]
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("A return has been shipped for {{CompanyName}}")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesReturns.BackOffice.Shipped";
