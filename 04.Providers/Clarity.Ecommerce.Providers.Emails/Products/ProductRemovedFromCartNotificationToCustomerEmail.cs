// <copyright file="ProductRemovedFromCartNotificationToCustomerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the product removed from cart notification to customer email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>A product removed from cart notification email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class ProductRemovedFromCartNotificationToCustomerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("ProductRemovedFromCart.html")]
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("Product Removed From Cart At {{CompanyName}}")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.ProductRemovedFromCart";
