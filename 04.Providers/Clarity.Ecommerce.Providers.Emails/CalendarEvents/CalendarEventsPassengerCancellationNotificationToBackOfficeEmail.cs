// <copyright file="CalendarEventsPassengerCancellationNotificationToBackOfficeEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the calendar events passenger cancellation notification to back office email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>A calendar events passenger cancellation notification to back office email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class CalendarEventsPassengerCancellationNotificationToBackOfficeEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.CalendarEvents.Cancellation.BackOffice";
