// <copyright file="CalendarEventsPassengerCancellationNotificationToGroupLeaderEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the calendar events passenger cancellation notification to group leader email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>A calendar events passenger cancellation notification to group leader email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class CalendarEventsPassengerCancellationNotificationToGroupLeaderEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("CalendarEvents.Cancellation.html")]
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("A Passenger Has Cancelled for Calendar Event {{CalendarEvent}}")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.CalendarEvents.Cancellation.GroupOrganizer";
