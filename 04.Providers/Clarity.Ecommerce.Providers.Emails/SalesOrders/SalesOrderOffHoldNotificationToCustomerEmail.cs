// <copyright file="SalesOrderOffHoldNotificationToCustomerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales order off hold notification to customer email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales order off hold notification to customer email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesOrderOffHoldNotificationToCustomerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("Your order has been taken off of On Hold at {{CompanyName}}")]
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesOrders.Customer.OffHold.html")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesOrders.Customer.OffHold";
            ...
            Dictionary<string, object?>? customReplacements = null)
        {
            ...
            var emailToUseResult = await SharedSalesOrders.GetOrderCustomerEmailToUseAsync(order!, "off of on hold", contextProfileName).ConfigureAwait(false);
