// <copyright file="SalesOrderConfirmedNotificationToCustomerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales order confirmed notification to customer email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales order confirmed notification to customer email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesOrderConfirmedNotificationToCustomerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("Your order has been Confirmed at {{CompanyName}}")]
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesOrders.Customer.Confirmed.html")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesOrders.Customer.Confirmed";
            ...
            Dictionary<string, object?>? customReplacements = null)
        {
            ...
            var emailToUseResult = await SharedSalesOrders.GetOrderCustomerEmailToUseAsync(order!, "confirmed", contextProfileName).ConfigureAwait(false);
