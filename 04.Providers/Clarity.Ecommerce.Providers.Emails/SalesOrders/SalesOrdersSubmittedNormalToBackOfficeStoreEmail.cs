// <copyright file="SalesOrdersSubmittedNormalToBackOfficeStoreEmail.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    public class SalesOrdersSubmittedNormalToBackOfficeStoreEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("A new ship to store order has been submitted for {{CompanyName}}")]
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesOrders.BackOfficeStore.Submitted.Normal.html")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesOrders.BackOfficeStore.Submitted.Normal";
