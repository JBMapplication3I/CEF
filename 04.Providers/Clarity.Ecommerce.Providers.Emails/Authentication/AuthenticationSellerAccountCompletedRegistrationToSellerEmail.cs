// <copyright file="AuthenticationSellerAccountCompletedRegistrationToSellerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the authentication seller account completed registration to seller email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>An authentication seller account completed registration to seller email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class AuthenticationSellerAccountCompletedRegistrationToSellerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Authentication.NewSellerRegistered.Seller";
