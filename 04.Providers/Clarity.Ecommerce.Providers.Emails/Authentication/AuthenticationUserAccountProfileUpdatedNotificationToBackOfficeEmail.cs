// <copyright file="AuthenticationUserAccountProfileUpdatedNotificationToBackOfficeEmail.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    public class AuthenticationUserAccountProfileUpdatedNotificationToBackOfficeEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("UserAccountProfileUpdated.html")]
        ...
        [AppSettingsKey(".Subject"),
         DefaultValue("User Account Profile Updated at {{CompanyName}}")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Authentication.UserAccountProfileUpdated.BackOffice";
