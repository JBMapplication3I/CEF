// <copyright file="SalesQuotesSubmittedNormalToBackOfficeEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales quotes submitted normal to back office email class</summary>
#nullable enable
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales quotes submitted normal to back office email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesQuotesSubmittedNormalToBackOfficeEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
         DefaultValue("SalesQuotes.BackOffice.Submitted.Normal.html")]
        public override string? FullTemplatePath
        {
            get => CEFConfigDictionary.TryGet(out string? asValue, GetType())
                ? asValue
                : "SalesQuotes.BackOffice.Submitted.Normal.html";
            protected set => CEFConfigDictionary.TrySet(value, GetType());
        }
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesQuotes.BackOffice.Submitted.Normal";
