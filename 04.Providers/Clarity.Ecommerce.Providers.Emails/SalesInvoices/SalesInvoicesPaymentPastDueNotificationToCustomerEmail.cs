// <copyright file="SalesInvoicesPaymentPastDueNotificationToCustomerEmail.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sales invoices payment past due notification to customer email class</summary>
namespace Clarity.Ecommerce.Providers.Emails
{
    ...
    /// <summary>The sales invoices payment past due notification to customer email.</summary>
    /// <seealso cref="EmailSettingsBase"/>
    [PublicAPI, GeneratesAppSettings]
    public class SalesInvoicesPaymentPastDueNotificationToCustomerEmail : EmailSettingsBase
    {
        /// <inheritdoc/>
        ...
        [AppSettingsKey(".FullTemplatePath"),
            DefaultValue("SalesInvoices.Customer.PaymentPastDue.html")]
        ...
        [AppSettingsKey(".Subject"),
            DefaultValue("Invoice Payment Past Due at {{CompanyName}}")]
        ...
        /// <inheritdoc/>
        protected override string SettingsRoot => "Clarity.Notifications.SalesInvoices.Customer.PaymentPastDue";
            ...
            Dictionary<string, object?>? customReplacements = null)
        {
            ...
            var daysDistanceFromDueDate = Math.Abs((parameters["daysDistanceFromDueDate"] as int?)!.Value);
            // Generate
