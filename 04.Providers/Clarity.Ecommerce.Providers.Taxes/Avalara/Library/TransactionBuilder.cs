// <copyright file="TransactionBuilder.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the transaction builder class</summary>
namespace Avalara.AvaTax.RestClient
{
    ...
    /// <summary>TransactionBuilder helps you construct a new transaction using a fluent interface.</summary>
    public class TransactionBuilder
    {
        /// <summary>The model.</summary>
        private readonly CreateTransactionModel _model;
        ...
        /// <summary>Set the commit flag of the transaction.</summary>
        ...
        /// <summary>Enable diagnostic information.</summary>
        /// <returns>The TransactionBuilder object.</returns>
        ...
        /// <summary>Specify a specific usage type for the entire transaction.</summary>
        /// <param name="usageType">Type of the usage.</param>
        /// <returns>A TransactionBuilder.</returns>
        ...
        /// <summary>Set a specific discount amount.</summary>
        ...
        /// <summary>Set if discount is applicable for the current line.</summary>
        ...
        /// <summary>Set a specific transaction code.</summary>
        ...
        /// <summary>Set the document type.</summary>
        ...
        /// <summary>Add a parameter at the document level.</summary>
        /// <param name="name"> The parameter name.  For a list of valid parameter names, call
        ///                     AvaTaxClient.ListParameters()</param>
        ...
        /// <summary>Add a parameter to the current line.</summary>
        /// <param name="name"> The parameter name.  For a list of valid parameter names, call
        ///                     AvaTaxClient.ListParameters()</param>
        /// <param name="value">The value for this parameter.</param>
        /// <param name="unit"> The unit of measure of the parameter value.</param>
        ...
        public TransactionBuilder WithLineParameter(string name, string value, string? unit = null)
        {
            ...
            l.parameters ??= new();
            l.parameters.Add(new() { name = name, value = value, unit = unit });
            return this;
        }

        /// <summary>Add an address to this transaction.</summary>
        /// <param name="type">      Address Type. Can be ShipFrom, ShipTo, PointOfOrderAcceptance, PointOfOrderOrigin,
        ///                          SingleLocation.</param>
        ...
        /// <returns>A TransactionBuilder.</returns>
        public TransactionBuilder WithAddress(
            ...
            string? country)
        {
            if (_model.addresses == null)
            {
                _model.addresses = new();
            }
        ...
        /// <summary>Add an address to this transaction using an existing company location code.
        /// AvaTax will search for a company location whose code matches the `locationCode` parameter and use the
        /// address of that location.</summary>
        /// <param name="type">        Address Type. Can be ShipFrom, ShipTo, PointOfOrderAcceptance,
        ///                            PointOfOrderOrigin, SingleLocation.</param>
        ...
        /// <summary>Set a specific address type for an address object.</summary>
        ...
        /// <summary>Add a geocoded location address to this transaction.</summary>
        /// <param name="type">     The type.</param>
        ...
        /// <summary>Add an address to this line.</summary>
        /// <param name="type">      Address Type. Can be ShipFrom, ShipTo, PointOfOrderAcceptance, PointOfOrderOrigin,
        ///                          SingleLocation.</param>
        ...
        /// <summary>Add an address to this line using an existing company location code. AvaTax will search for a
        /// company location whose code matches the `locationCode` parameter and use the address of that location.</summary>
        /// <param name="type">        Address Type. Can be ShipFrom, ShipTo, PointOfOrderAcceptance,
        ///                            PointOfOrderOrigin, SingleLocation.</param>
        /// <param name="locationCode">The location code of the location to use as this address.</param>
        /// <returns>A TransactionBuilder.</returns>
        ...
        /// TODO: Verify Tax Override constraints and add exceptions.</summary>
        ...
        public TransactionBuilder WithLineTaxOverride(TaxOverrideType type, string reason, decimal taxAmount = 0, DateTime? taxDate = null)
        {
            ...
            {
                throw new("A valid date is required for a TaxDate Tax Override.");
            }
            var line = GetMostRecentLine("WithLineTaxOverride");
            line.taxOverride = new()
            {
                type = type,
                reason = reason,
                taxAmount = taxAmount,
        ...
        /// <summary>Add a line to this transaction.</summary>
        /// <param name="amount">           Value of the item.</param>
        /// <param name="quantity">         Quantity of the item.</param>
        /// <param name="taxCode">          Tax Code of the item. If left blank, the default item (P0000000) is assumed.
        ///                                 Use ListTaxCodes() for a list of values.</param>
        ...
        /// <param name="customerUsageType">The intended usage type for this line.  Use ListEntityUseCodes() for a list
        ///                                 of values.</param>
        ...
        /// <summary>Add a line with an exemption to this transaction.</summary>
        ...
        /// <summary>Add the Ref1 [and Ref2] field to the current line.
        /// Used for user-side reporting. Does not affect tax calculation.</summary>
        /// <param name="ref1">The first reference.</param>
        /// <param name="ref2">The second reference.</param>
        /// <returns>A TransactionBuilder.</returns>
        ...
        /// <summary>Set the transaction date.</summary>
        ...
        /// <summary>Set the salesperson code.</summary>
        ...
        /// <summary>Set the purchase order number.</summary>
        ...
        /// <summary>Set the exemption number.</summary>
        /// <param name="exemptionNumber">The exemption associated with the transaction.</param>
        /// <returns>The TransactionBuilder object.</returns>
        ...
        /// <summary>Set the reference code. Used to reference the original document for a return invoice.</summary>
        ...
        /// <summary>Set the batch code. TODO: Is this something we want/need to expose?</summary>
        ...
        /// <summary>Set a 3 character ISO 4217 currency code.</summary>
        ...
        /// <summary>Set the service mode of the transaction.
        /// The mode can be set to: Automatic (default), Local, or Remote.</summary>
        ...
        /// <summary>Set the exchange rate of the transaction. This is the exchange rate between this transaction's
        /// currency to the company's base currency.</summary>
        ...
        /// <summary>Set the exchange rate date of the transaction. This specifies the effective date of the exchange
        /// rate.</summary>
        ...
        /// <summary>Set the business identification number of the transaction.</summary>
        ...
        /// <summary>Enable the `seller importer of record` flag.</summary>
        /// <returns>The TransactionBuilder object.</returns>
        ...
        /// <summary>Set the description of the transaction.</summary>
        ...
        /// <summary>Set the email of the transaction.</summary>
        ...
        /// <summary>Checks to see if the current model has a line.</summary>
        ...
        private LineItemModel GetMostRecentLine(string memberName = "")
        {
            if (_model.lines!.Count == 0)
            {
                throw new InvalidOperationException(
                    $"No lines have been added. The {memberName} method applies to the most recent line. To use this "
                    + "function, first add a line.");
            }
            return _model.lines[^1];
        }
        #endregion
        ...
        {
            return await _client.CreateTransactionAsync(null, _model).ConfigureAwait(false);
        }
...
#else
        /// <summary>Create this transaction.</summary>
        /// <returns>A TransactionModel.</returns>
        public TransactionModel Create()
        {
            return _client.CreateTransaction(null, _model);
        }
        ...
        /// <summary>Return the current CreateTransactionModel but do not call AvaTax to record the transaction. If you
        /// would like to perform additional modifications to this object beyond the fluent interface, you can use this
        /// function to return the currently assembled model and then make additional changes to it.</summary>
        /// <returns>The create transaction model.</returns>
        public CreateTransactionModel GetCreateTransactionModel()
        {
            return _model;
        }

        /// <summary>For using this with an adjustment.</summary>
        ...
        /// <returns>The new adjustment request.</returns>
