// <copyright file="OracleTaxService.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the oracle tax service class</summary>
namespace Clarity.Ecommerce.Providers.Taxes.Oracle
{
    ...
    /// <summary>An oracle tax service.</summary>
    public class OracleTaxService
    {
        ...
        public static OracleRequest CreateOracleRequest(
        ...
        public static async Task<OracleResponse> GetOracleResponseAsync(OracleRequest request)
        {
            ...
            try
            {
                ...
                var webRequest = WebRequest.Create(OracleTaxesProviderConfig.Url!);
