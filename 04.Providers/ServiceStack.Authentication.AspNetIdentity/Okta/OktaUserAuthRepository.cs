// <copyright file="OktaUserAuthRepository.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the Okta user authentication repository class</summary>
namespace ServiceStack.Auth
{
    ...
    /// <summary>A Okta user authentication repository.</summary>
    /// <seealso cref="ICEFUserAuthRepository"/>
    [PublicAPI]
    public class OktaUserAuthRepository : ICEFUserAuthRepository
    {
        ...
        public IUserAuth? GetUserAuth(string userAuthId)
        {
            ...
            // Get a DB Context
            return RunWrappedInUserManager(
                userManager =>
                {
                    // Search for the user
        ...
        public bool TryAuthenticate(string userName, string password, out IUserAuth? userAuth)
        {
            ...
            return userManager.CheckPassword(user, password);
        }
        ...
        public IUserAuth UpdateUserAuth(IUserAuth existingUser, IUserAuth newUser, string password)
        {
                ...
                userManager =>
            {
                ...
                {
                    Logger.LogError(
                        $"{nameof(OktaUserAuthRepository)}.{nameof(UpdateUserAuth)}",
                ...
                userManager =>
            {
                var userAuth = !string.IsNullOrEmpty(authSession.UserAuthId)
                    ? MapUserToUserAuth(
                        ...
                        .Include(x => x.Account!.AccountUserRoles!.Select(z => z!.Slave!.Permissions.Select(a => a.Permission)))
                        .FilterByActive(true)
                        .Single(x => x.UserName == authSession.UserAuthId.Trim().ToLower()))
        ...
        private static IUserAuth MapUserToUserAuth(User user)
        {
            ...
            IUserAuth userAuth = new UserAuth
            {
                ...
                Permissions = user.Roles
                    ?.Where(x => (x.StartDate == null || x.StartDate < timestamp) && (x.EndDate == null || x.EndDate > timestamp))
        ...
        private static IUserAuthDetails MapUserToUserAuthDetails(IUser user)
        {
            ...
            IUserAuthDetails userAuthDetails = new UserAuthDetails
            {
                ...
                Provider = OktaAuthProvider.StaticName,
                UserAuthId = user.ID,
            };
            if (user.Contact == null)
            {
                ...
                return new()
                {
                    ...
                    Contact = new()
                    {
                        ...
                        FullName = userAuth.FullName
                            ?? $"{userAuth.FirstName?.Trim()} {userAuth.LastName?.Trim()}".Trim(),
                        Address = new()
                        {
