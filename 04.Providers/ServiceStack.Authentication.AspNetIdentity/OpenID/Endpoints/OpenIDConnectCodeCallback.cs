// <copyright file="OpenIDConnectCodeCallback.cs" company="clarity-ventures.com">
...
namespace ServiceStack.Auth
{
    ...
    [PublicAPI, UsedInStorefront, UsedInStoreAdmin,
        Route("/Authentication/OpenIDConnectCodeCallback", "POST",
            Summary = "Consumes the code response from Open ID Connect")]
    public class OpenIDConnectCodeCallback : IReturnVoid
    {
