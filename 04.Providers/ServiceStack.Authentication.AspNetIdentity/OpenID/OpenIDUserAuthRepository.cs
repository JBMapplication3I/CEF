// <copyright file="OpenIDUserAuthRepository.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the OpenID user authentication repository class</summary>
namespace ServiceStack.Auth
{
    ...
    /// <summary>A OpenID user authentication repository.</summary>
    /// <seealso cref="ICEFUserAuthRepository"/>
    [PublicAPI]
    public class OpenIDUserAuthRepository : ICEFUserAuthRepository
    {
        ...
        public IUserAuth UpdateUserAuth(IUserAuth existingUser, IUserAuth newUser, string password)
        {
                ...
                userManager =>
            {
                ...
                {
                    Logger.LogError(
                        $"{nameof(OpenIDUserAuthRepository)}.{nameof(UpdateUserAuth)}",
        ...
        private static IUserAuthDetails MapUserToUserAuthDetails(IUser user)
        {
            ...
            IUserAuthDetails userAuthDetails = new UserAuthDetails
            {
                ...
                Provider = OpenIDAuthProvider.StaticName,
                UserAuthId = user.ID,
            };
            if (user.Contact == null)
            {
