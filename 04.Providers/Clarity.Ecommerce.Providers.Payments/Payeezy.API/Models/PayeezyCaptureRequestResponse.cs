// <copyright file="PayeezyCaptureRequestResponse.cs" company="clarity-ventures.com">
// Copyright (c) 2018-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the payeezy capture request response class</summary>
...
namespace Clarity.Ecommerce.Providers.Payments.PayeezyAPI
{
    ...
    /// <summary>(Serializable)a payeezy capture request response.</summary>
    [PublicAPI]
    [Serializable]
    public class PayeezyCaptureRequestResponse
    {
