// <copyright file="EvoPaymentProviderParameters.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the evo payment provider parameters class</summary>
...
namespace Clarity.Ecommerce.Providers.Payments.EVO
{
    ...
    /// <summary>(Serializable) An EVO credit card or ACH parameters.</summary>
    /// <remarks>Core Credit Card/ACH Parameters. All credit card processors accept the basic parameters described in
    /// the following table.</remarks>
    /// <seealso cref="EvoRequestBase"/>
    [PublicAPI, Serializable, DataContract]
    public class EvoPaymentProviderParameters : EvoRequestBase
    {
        ...
        /// - D = Pinless debit<br/>
        /// - K = Telecheck<br/>
        /// See the EVO ACH Payment Service Guide for details on the ACH tender type.</summary>
        ...
        [JsonProperty("TENDER"), DataMember(Name = "TENDER"), ApiMember(Name = "TENDER",
             ...
             Description = "TENDER: (Required) The method of payment. Values are:"
                 + "A = Automated clearinghouse (ACH), C = Credit card, D = Pinless debit, K = Telecheck. "
                 + "See the EVO ACH Payment Service Guide for details on the ACH tender type.")]
        ...
        /// with a PNREF that is the same as the original. It appears only in the EVO Manager user interface and
        ...
        [JsonProperty("TRXTYPE"), DataMember(Name = "TRXTYPE"), ApiMember(Name = "TRXTYPE",
             ...
             Description = "TRXTYPE (Required): Indicates the type of transaction to perform. Values are: "
                 ...
                 + "It appears only in the EVO Manager user interface and never settles.")]
        ...
        /// amount you pass to EVO (use 100.00 not 100). EVO removes the decimal portion before sending the
        ...
        [JsonProperty("AMT"), DataMember(Name = "AMT"), ApiMember(Name = "AMT",
             ...
             Description = "AMT (Required): Amount (Default: U.S. based currency). Character length and limitations: "
                 ...
                 + "such as, Japanese Yen, include a decimal in the amount you pass to EVO (use 100.00 not 100)."
                 + " EVO removes the decimal portion before sending the value to the processor.")]
        ...
        /// This value does not activate the EVO Recurring Billing Service API. If the RECURRING parameter value is
        /// Y in the original transaction, this value is ignored when forming credit, void, and force transactions. If
        /// you subscribe to the EVO Fraud Protection Services:<br/>
        ...
        /// - To screen a prospective recurring customer, submit the transaction data on the EVO Manager Manual
        ...
        [JsonProperty("RECURRING"), DataMember(Name = "RECURRING"), ApiMember(Name = "RECURRING",
             ...
             Description = "RECURRING (Optional): Identifies the transaction as recurring. Value is: "
                 ...
                 + "This value does not activate the EVO Recurring Billing Service API. If the RECURRING "
                 + "parameter value is Y in the original transaction, this value is ignored when forming credit, "
                 + "void, and force transactions. If you subscribe to the EVO Fraud Protection Services: - To "
                 ...
                 + "submit the transaction data on the EVO Manager Manual Transactions page. The filters screen "
        ...
        /// Bill-to country. The EVO API accepts 3-digit numeric country codes. Refer to the ISO 3166-1 numeric
        /// country codes.<br/>
        ...
        /// Ship-to country. The EVO API accepts 3-digit numeric country codes. Refer to the ISO 3166-1 numeric
        /// country codes.<br/>
        /// Limitations: 3-character country code.</summary>
        ...
        /// transaction; it appears as the Transaction ID in EVO Manager reports.<br/>
        /// Limitations: 12 case-sensitive alphanumeric characters.</summary>
        /// <value>The identifier of the original transaction in EVO.</value>
