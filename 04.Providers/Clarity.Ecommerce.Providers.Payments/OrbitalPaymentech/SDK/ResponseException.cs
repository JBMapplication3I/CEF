...
namespace JPMC.MSDK
{
    ...
    public class ResponseException : Exception
    {
        ...
        public ResponseException( FilerException ex ) : base( ex.Message, ex )
        {
            this.error = ex.ErrorCode;
        }

        public ResponseException( ConverterException ex )
            : base( ex.Message, ex )
        {
            this.error = ex.ErrorCode;
        }
        ...
        public ResponseException(Error error, string message) : base(message)
        {
            this.error = error;
        }
        ...
        public ResponseException(Error error, string message, Exception exception) : base(message, exception)
        {
            this.error = error;
        }
