...
{
	/// <summary>
	/// Represents errors that occur during the processing of Filer 
	/// tasks.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	[System.Serializable]
	public class FilerException : Exception
	{
		...
		public FilerException(Error error)
		{
			this.error = error;
		}
		...
		public FilerException(Error error, string message) : base(message)
		{
			this.error = error;
		}
		...
		public FilerException(Error error, string message, Exception exception) : base(message, exception)
		{
			this.error = error;
		}
