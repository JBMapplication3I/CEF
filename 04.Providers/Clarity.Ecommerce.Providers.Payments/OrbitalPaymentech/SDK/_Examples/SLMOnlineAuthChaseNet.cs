namespace SLMOnlineAuthChaseNet
{
    using System;
    using JPMC.MSDK;

    internal class SLMOnlineAuthChaseNet
    {
        internal static void Main(string[] args)
        {
            ...
            try
            {
                ...
                request[SLM.NewTransaction.MerchantOrderNumber] = "Simple ChaseNet Auth";
                request[SLM.NewTransaction.MethodOfPayment] = "CZ";
                request[SLM.NewTransaction.AccountNumber] = "4636730000000006";
