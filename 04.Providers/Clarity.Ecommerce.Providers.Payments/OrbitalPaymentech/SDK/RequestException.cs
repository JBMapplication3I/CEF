...
{
	/// <summary>
	/// Represents errors that occur during the processing 
	/// of <see cref="IRequest"/> tasks.
	/// </summary>
	/// <remarks>
	...
	public class RequestException : Exception
	{
		...
		public RequestException(Error error, string message) : base(message)
		{
			this.error = error;
		}
		...
		public RequestException(Error error, string message, Exception exception) : base(message, exception)
		{
			this.error = error;
		}
