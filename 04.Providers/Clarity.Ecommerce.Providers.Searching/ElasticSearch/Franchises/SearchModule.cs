...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <seealso cref="SearchModuleBase{FranchiseSearchViewModel, FranchiseCatalogSearchForm, FranchiseIndexableModel}"/>
    internal partial class FranchiseSearchModule
        : SearchModuleBase<FranchiseSearchViewModel, FranchiseCatalogSearchForm, FranchiseIndexableModel>
    {
        ...
        protected override IPromise<IList<ISort>> Sort(
            SortDescriptor<FranchiseIndexableModel> sort,
            FranchiseCatalogSearchForm form)
        {
            return form.Sort switch
            {
                // Enums.SearchSort.PriceAscending => sort.Ascending(p => p.PricingToIndexAs),
                // Enums.SearchSort.PriceDescending => sort.Descending(p => p.PricingToIndexAs),
        ...
        protected override IAggregationContainer Aggregations(
            AggregationContainerDescriptor<FranchiseIndexableModel> a,
            FranchiseCatalogSearchForm form)
        {
            var returnQuery = a;
        ...
        protected override QueryContainer Query(
            QueryContainerDescriptor<FranchiseIndexableModel> q,
            FranchiseCatalogSearchForm form)
        {
            var returnQuery = q
            ...
            /*
                || q.Match(m => m
                    ...
                    .Boost(ElasticSearchingProviderConfig.SearchingFranchiseIndexBoostsBrandNameMatchKeyword)
                    .Fuzziness(Fuzziness.Auto)
                    .Query(form.Query)
                )
                || q.Prefix(m => m
                    .Field(p => p.BrandName.Suffix(Keyword))
                    .Boost(ElasticSearchingProviderConfig.SearchingFranchiseIndexBoostsBrandNamePrefixKeyword)
                    .Value(form.Query)
                )
                || q.Term(m => m
                    .Field(p => p.BrandName.Suffix(Keyword))
                    .Boost(ElasticSearchingProviderConfig.SearchingFranchiseIndexBoostsBrandNameTermKeyword)
                    .Value(form.Query)
                )
            */
            #endregion
            ...
            */
            ...
            returnQuery = DistrictsSingleQueryModification(q, returnQuery, form, true/*CEFConfigDictionary.RegionsEnabled*/);
            returnQuery = DistrictsAnyQueryModification(q, returnQuery, form, true/*CEFConfigDictionary.RegionsEnabled*/);
            returnQuery = DistrictsAllQueryModification(q, returnQuery, form, true/*CEFConfigDictionary.RegionsEnabled*/);
            ...
            */
            ...
            /*
            returnQuery = RolesSingleQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingFranchiseIndexFiltersIncludeRoles);
            returnQuery = RolesAnyQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingFranchiseIndexFiltersIncludeRoles);
            returnQuery = RolesAllQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingFranchiseIndexFiltersIncludeRoles);
            */
        ...
        protected override void SearchViewModelAdditionalAssignments(
            FranchiseSearchViewModel model,
            ISearchResponse<FranchiseIndexableModel> result)
        {
            ...
            // SearchViewModelAdditionalAssignmentsForRoles(model, result, ElasticSearchingProviderConfig.SearchingFranchiseIndexFiltersIncludeRoles);
