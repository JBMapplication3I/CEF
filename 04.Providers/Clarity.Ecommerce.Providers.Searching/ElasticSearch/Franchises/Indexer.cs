...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    internal class FranchiseIndexer : IndexerBase<FranchiseDumpReader, FranchiseIndexableModel>
    {
        // <inheritdoc/>
        protected override string GenIndexName()
            => $"{ElasticSearchingProviderConfig.SearchingFranchiseIndex}.{DateTime.UtcNow:yyyy-MM-dd.HH-mm-ss}";

        // <inheritdoc/>
        protected override string GetLiveIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingFranchiseIndex;

        // <inheritdoc/>
        protected override string GetOldIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingFranchiseIndexOld;

        // <inheritdoc/>
        protected override TypeMappingDescriptor<FranchiseIndexableModel> Map(TypeMappingDescriptor<FranchiseIndexableModel> map) => map
            .AutoMap()
            .Properties(ps => ps
