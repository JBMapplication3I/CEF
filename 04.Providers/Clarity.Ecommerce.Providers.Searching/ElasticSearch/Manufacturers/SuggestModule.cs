...
// </copyright>
// <summary>Implements the manufacturer suggest module class</summary>
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <summary>A manufacturer suggest module.</summary>
    /// <seealso cref="SuggestModuleBase{ManufacturerCatalogSearchForm, ManufacturerIndexableModel, ISearchSuggestResult}"/>
    internal class ManufacturerSuggestModule
        : SuggestModuleBase<ManufacturerCatalogSearchForm, ManufacturerIndexableModel, ManufacturerSuggestResult>
    {
        /// <summary>Initializes a new instance of the <see cref="ManufacturerSuggestModule"/> class.</summary>
        /// <param name="suggestFields">  The suggest fields.</param>
        /// <param name="mapSuggestModel">The map suggest model.</param>
        public ManufacturerSuggestModule(
                Func<FieldsDescriptor<ManufacturerIndexableModel>, IPromise<Fields>> suggestFields,
                Func<SuggestOption<ManufacturerIndexableModel>?, ManufacturerSuggestResult?> mapSuggestModel)
            : base(suggestFields, mapSuggestModel)
        {
        }

        /// <inheritdoc/>
        public override async Task<IEnumerable<ManufacturerSuggestResult?>> SuggestResultsAsync(
            ManufacturerCatalogSearchForm form,
            string name,
            string? contextProfileName)
        {
            var client = ElasticSearchClientFactory.GetClient();
            var result = await client.SearchAsync<ManufacturerIndexableModel>(s => s
                .Index<ManufacturerIndexableModel>()
            ...
            var results = new List<ManufacturerSuggestResult?>();
