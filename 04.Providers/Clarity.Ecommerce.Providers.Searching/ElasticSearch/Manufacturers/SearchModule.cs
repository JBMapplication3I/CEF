...
// </copyright>
// <summary>Implements the manufacturer search module class</summary>
...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <summary>A manufacturer search module.</summary>
    /// <seealso cref="SearchModuleBase{ManufacturerSearchViewModel,ManufacturerCatalogSearchForm,ManufacturerIndexableModel}"/>
    internal partial class ManufacturerSearchModule
        : SearchModuleBase<ManufacturerSearchViewModel, ManufacturerCatalogSearchForm, ManufacturerIndexableModel>
    {
        /// <inheritdoc/>
        protected override IPromise<IList<ISort>> Sort(
            SortDescriptor<ManufacturerIndexableModel> sort,
            ManufacturerCatalogSearchForm form)
        {
        ...
        protected override IAggregationContainer Aggregations(
            AggregationContainerDescriptor<ManufacturerIndexableModel> a,
            ManufacturerCatalogSearchForm form)
        {
            var returnQuery = a;
        ...
        protected override QueryContainer Query(
            QueryContainerDescriptor<ManufacturerIndexableModel> q,
            ManufacturerCatalogSearchForm form)
        {
            var returnQuery = q
            ...
            /*
                || q.Match(m => m
                    ...
                    .Boost(ElasticSearchingProviderConfig.SearchingManufacturerIndexBoostsBrandNameMatchKeyword)
                    .Fuzziness(Fuzziness.Auto)
                    .Query(form.Query)
                )
                || q.Prefix(m => m
                    .Field(p => p.BrandName.Suffix(Keyword))
                    .Boost(ElasticSearchingProviderConfig.SearchingManufacturerIndexBoostsBrandNamePrefixKeyword)
                    .Value(form.Query)
                )
                || q.Term(m => m
                    .Field(p => p.BrandName.Suffix(Keyword))
                    .Boost(ElasticSearchingProviderConfig.SearchingManufacturerIndexBoostsBrandNameTermKeyword)
                    .Value(form.Query)
                )
            */
            #endregion
            ...
            */
            ...
            /*
            returnQuery = RolesSingleQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingManufacturerIndexFiltersIncludeRoles);
            returnQuery = RolesAnyQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingManufacturerIndexFiltersIncludeRoles);
            returnQuery = RolesAllQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingManufacturerIndexFiltersIncludeRoles);
            */
        ...
        protected override void SearchViewModelAdditionalAssignments(
            ManufacturerSearchViewModel model,
            ISearchResponse<ManufacturerIndexableModel> result)
        {
            ...
            // SearchViewModelAdditionalAssignmentsForRoles(model, result, ElasticSearchingProviderConfig.SearchingManufacturerIndexFiltersIncludeRoles);
