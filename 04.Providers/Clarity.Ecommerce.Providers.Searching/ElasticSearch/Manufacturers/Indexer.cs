...
// </copyright>
// <summary>Implements the manufacturer indexer class</summary>
...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <summary>A manufacturer indexer.</summary>
    internal class ManufacturerIndexer : IndexerBase<ManufacturerDumpReader, ManufacturerIndexableModel>
    {
        // <inheritdoc/>
        protected override string GenIndexName()
            => $"{ElasticSearchingProviderConfig.SearchingManufacturerIndex}.{DateTime.UtcNow:yyyy-MM-dd.HH-mm-ss}";

        // <inheritdoc/>
        protected override string GetLiveIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingManufacturerIndex;

        // <inheritdoc/>
        protected override string GetOldIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingManufacturerIndexOld;

        // <inheritdoc/>
        protected override TypeMappingDescriptor<ManufacturerIndexableModel> Map(TypeMappingDescriptor<ManufacturerIndexableModel> map) => map
            .AutoMap()
            .Properties(ps => ps
