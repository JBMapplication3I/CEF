...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    internal class LotIndexer : IndexerBase<LotDumpReader, LotIndexableModel>
    {
        // <inheritdoc/>
        protected override string GenIndexName()
            => $"{ElasticSearchingProviderConfig.SearchingLotIndex}.{DateTime.UtcNow:yyyy-MM-dd.HH-mm-ss}";

        // <inheritdoc/>
        protected override string GetLiveIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingLotIndex;

        // <inheritdoc/>
        protected override string GetOldIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingLotIndexOld;

        // <inheritdoc/>
        protected override TypeMappingDescriptor<LotIndexableModel> Map(TypeMappingDescriptor<LotIndexableModel> map) => map
            .AutoMap()
            .Properties(ps => ps
