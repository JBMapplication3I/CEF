...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    public partial class ElasticSearchingProvider
    {
        ...
        private static readonly Func<SuggestOption<LotIndexableModel>?, LotSuggestResult?> MapLotSuggestModel
        ...
        private static int EventTypeIDForLotCatalogSearch { get; set; }

        /// <summary>Gets the product suggest module.</summary>
        /// <value>The product suggest module.</value>
        private static LotSuggestModule LotSuggestModule { get; }
            = new(LotSuggestFields, MapLotSuggestModel);

        /// <summary>Lot suggest fields.</summary>
        ...
        private static IPromise<Fields> LotSuggestFields<TIndexModel>(FieldsDescriptor<TIndexModel> f)
            where TIndexModel : LotIndexableModel
        {
            return f
                .Field(ff => ff.ID)
                .Field(ff => ff.Name)
