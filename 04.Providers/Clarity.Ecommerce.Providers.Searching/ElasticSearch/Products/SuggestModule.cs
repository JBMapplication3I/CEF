...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <seealso cref="SuggestModuleBase{ProductCatalogSearchForm, ProductIndexableModel, ProductSuggestResult}"/>
    internal class ProductSuggestModule
        : SuggestModuleBase<ProductCatalogSearchForm, ProductIndexableModel, ProductSuggestResult>
    {
        ...
        public ProductSuggestModule(
                Func<FieldsDescriptor<ProductIndexableModel>, IPromise<Fields>> suggestFields,
                Func<SuggestOption<ProductIndexableModel>?, ProductSuggestResult?> mapSuggestModel)
            : base(suggestFields, mapSuggestModel)
        {
        }

        /// <inheritdoc/>
        public override async Task<IEnumerable<ProductSuggestResult?>> SuggestResultsAsync(
            ProductCatalogSearchForm form,
            string name,
            string? contextProfileName)
        {
            var client = ElasticSearchClientFactory.GetClient();
            var result = await client.SearchAsync<ProductIndexableModel>(s => s
                .Index<ProductIndexableModel>()
            ...
            var results = new List<ProductSuggestResult?>();
