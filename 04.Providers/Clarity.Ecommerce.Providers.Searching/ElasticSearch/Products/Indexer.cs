...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    internal class ProductIndexer : IndexerBase<ProductDumpReader, ProductIndexableModel>
    {
        // <inheritdoc/>
        ...
        // <inheritdoc/>
        protected override string GetLiveIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingProductIndex;

        // <inheritdoc/>
        protected override string GetOldIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingProductIndexOld;

        // <inheritdoc/>
        protected override TypeMappingDescriptor<ProductIndexableModel> Map(TypeMappingDescriptor<ProductIndexableModel> map) => map
            .AutoMap()
            .Properties(ps => ps
