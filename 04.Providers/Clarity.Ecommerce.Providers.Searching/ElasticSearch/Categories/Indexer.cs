...
// </copyright>
// <summary>Implements the category indexer class</summary>
...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <summary>A category indexer.</summary>
    internal class CategoryIndexer : IndexerBase<CategoryDumpReader, CategoryIndexableModel>
    {
        // <inheritdoc/>
        protected override string GenIndexName()
            => $"{ElasticSearchingProviderConfig.SearchingCategoryIndex}.{DateTime.UtcNow:yyyy-MM-dd.HH-mm-ss}";

        // <inheritdoc/>
        protected override string GetLiveIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingCategoryIndex;

        // <inheritdoc/>
        protected override string GetOldIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingCategoryIndexOld;

        // <inheritdoc/>
        protected override TypeMappingDescriptor<CategoryIndexableModel> Map(TypeMappingDescriptor<CategoryIndexableModel> map) => map
            .AutoMap()
            .Properties(ps => ps
