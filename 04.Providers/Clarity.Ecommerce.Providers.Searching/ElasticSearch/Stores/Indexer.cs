...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    internal class StoreIndexer : IndexerBase<StoreDumpReader, StoreIndexableModel>
    {
        // <inheritdoc/>
        ...
        // <inheritdoc/>
        protected override string GetLiveIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingStoreIndex;

        // <inheritdoc/>
        protected override string GetOldIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingStoreIndexOld;

        // <inheritdoc/>
        protected override TypeMappingDescriptor<StoreIndexableModel> Map(TypeMappingDescriptor<StoreIndexableModel> map) => map
            .AutoMap()
            .Properties(ps => ps
                ...
                */
                .Nested<IndexableBadgeFilter>(n => n
                    .Name(p => p.Badges!.First())
                    .AutoMap()
                    .Properties(props => props
