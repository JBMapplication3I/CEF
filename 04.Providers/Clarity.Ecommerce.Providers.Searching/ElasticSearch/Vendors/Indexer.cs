...
// </copyright>
// <summary>Implements the vendor indexer class</summary>
...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <summary>A vendor indexer.</summary>
    internal class VendorIndexer : IndexerBase<VendorDumpReader, VendorIndexableModel>
    {
        // <inheritdoc/>
        protected override string GenIndexName()
            => $"{ElasticSearchingProviderConfig.SearchingVendorIndex}.{DateTime.UtcNow:yyyy-MM-dd.HH-mm-ss}";

        // <inheritdoc/>
        protected override string GetLiveIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingVendorIndex;

        // <inheritdoc/>
        protected override string GetOldIndexNameFromSetting() => ElasticSearchingProviderConfig.SearchingVendorIndexOld;

        // <inheritdoc/>
        protected override TypeMappingDescriptor<VendorIndexableModel> Map(TypeMappingDescriptor<VendorIndexableModel> map) => map
            .AutoMap()
            .Properties(ps => ps
