...
// </copyright>
// <summary>Implements the vendor search module class</summary>
...
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <summary>A vendor search module.</summary>
    /// <seealso cref="SearchModuleBase{VendorSearchViewModel,VendorCatalogSearchForm,VendorIndexableModel}"/>
    internal partial class VendorSearchModule
        : SearchModuleBase<VendorSearchViewModel, VendorCatalogSearchForm, VendorIndexableModel>
    {
        /// <inheritdoc/>
        protected override IPromise<IList<ISort>> Sort(
            SortDescriptor<VendorIndexableModel> sort,
            VendorCatalogSearchForm form)
        {
        ...
        protected override IAggregationContainer Aggregations(
            AggregationContainerDescriptor<VendorIndexableModel> a,
            VendorCatalogSearchForm form)
        {
            var returnQuery = a;
        ...
        protected override QueryContainer Query(
            QueryContainerDescriptor<VendorIndexableModel> q,
            VendorCatalogSearchForm form)
        {
            var returnQuery = q
            ...
            /*
                || q.Match(m => m
                    ...
                    .Boost(ElasticSearchingProviderConfig.SearchingVendorIndexBoostsBrandNameMatchKeyword)
                    .Fuzziness(Fuzziness.Auto)
                    .Query(form.Query)
                )
                || q.Prefix(m => m
                    .Field(p => p.BrandName.Suffix(Keyword))
                    .Boost(ElasticSearchingProviderConfig.SearchingVendorIndexBoostsBrandNamePrefixKeyword)
                    .Value(form.Query)
                )
                || q.Term(m => m
                    .Field(p => p.BrandName.Suffix(Keyword))
                    .Boost(ElasticSearchingProviderConfig.SearchingVendorIndexBoostsBrandNameTermKeyword)
                    .Value(form.Query)
                )
            */
            #endregion
            ...
            */
            ...
            /*
            returnQuery = RolesSingleQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingVendorIndexFiltersIncludeRoles);
            returnQuery = RolesAnyQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingVendorIndexFiltersIncludeRoles);
            returnQuery = RolesAllQueryModification(q, returnQuery, form, ElasticSearchingProviderConfig.SearchingVendorIndexFiltersIncludeRoles);
            */
        ...
        protected override void SearchViewModelAdditionalAssignments(
            VendorSearchViewModel model,
            ISearchResponse<VendorIndexableModel> result)
        {
            ...
            // SearchViewModelAdditionalAssignmentsForRoles(model, result, ElasticSearchingProviderConfig.SearchingVendorIndexFiltersIncludeRoles);
