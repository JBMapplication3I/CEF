...
// </copyright>
// <summary>Implements the vendor suggest module class</summary>
namespace Clarity.Ecommerce.Providers.Searching.ElasticSearch
{
    ...
    /// <summary>A vendor suggest module.</summary>
    /// <seealso cref="SuggestModuleBase{VendorCatalogSearchForm, VendorIndexableModel, ISearchSuggestResult}"/>
    internal class VendorSuggestModule
        : SuggestModuleBase<VendorCatalogSearchForm, VendorIndexableModel, VendorSuggestResult>
    {
        /// <summary>Initializes a new instance of the <see cref="VendorSuggestModule"/> class.</summary>
        /// <param name="suggestFields">  The suggest fields.</param>
        /// <param name="mapSuggestModel">The map suggest model.</param>
        public VendorSuggestModule(
                Func<FieldsDescriptor<VendorIndexableModel>, IPromise<Fields>> suggestFields,
                Func<SuggestOption<VendorIndexableModel>?, VendorSuggestResult?> mapSuggestModel)
            : base(suggestFields, mapSuggestModel)
        {
        }

        /// <inheritdoc/>
        public override async Task<IEnumerable<VendorSuggestResult?>> SuggestResultsAsync(
            VendorCatalogSearchForm form,
            string name,
            string? contextProfileName)
        {
            var client = ElasticSearchClientFactory.GetClient();
            var result = await client.SearchAsync<VendorIndexableModel>(s => s
                .Index<VendorIndexableModel>()
            ...
            var results = new List<VendorSuggestResult?>();
