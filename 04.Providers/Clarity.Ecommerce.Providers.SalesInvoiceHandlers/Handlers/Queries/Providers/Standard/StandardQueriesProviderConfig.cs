...
namespace Clarity.Ecommerce.Providers.SalesInvoiceHandlers.Queries.Standard
{
    ...
    /// <summary>A standard sales invoice queries provider configuration.</summary>
    internal static class StandardSalesInvoiceQueriesProviderConfig
    {
        /// <summary>Query if this Config is valid.</summary>
        /// <param name="isDefaultAndActivated">True if this Provider is default and activated.</param>
        /// <returns>true if valid, false if not.</returns>
        internal static bool IsValid(bool isDefaultAndActivated)
            => ProviderConfig.CheckIsEnabledBySettings<StandardSalesInvoiceQueriesProvider>() || isDefaultAndActivated;
    }
}
