// <copyright file="IStatusableWorkflowBase.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Declares the IStatusableWorkflowBase interface</summary>
namespace Clarity.Ecommerce.Interfaces.Workflow
{
    using DataModel;
    using Models;

    /// <summary>Interface for workflow for statusable bases.</summary>
    ...
    public interface IStatusableWorkflowBase<TIModel, TISearchModel, TIEntity, TEntity>
