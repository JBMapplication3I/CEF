// <copyright file="ICalculatedPrice.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Declares the ICalculatedPrice interface</summary>
namespace Clarity.Ecommerce.Interfaces.Models
{
    ...
    public interface ICalculatedPrice
    {
        ...
        /// <summary>Gets or sets the used rules.</summary>
        /// <value>The used rules.</value>
        List<IMultiUOMCalculatedPrice>? MultiUOMPrices { get; set; }
    }
}
