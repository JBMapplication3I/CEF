// <autogenerated>
// <copyright file="IBadgeModel.generated.cs" company="clarity-ventures.com">
...
{
    /// <summary>Interface for badge model.</summary>
    /// <seealso cref="INameableBaseModel"/>
    /// <seealso cref="IHaveATypeBaseModel{ITypeModel}"/>
    /// <seealso cref="IHaveImagesBaseModel{IBadgeImageModel,ITypeModel}"/>
    public partial interface IBadgeModel
        : INameableBaseModel
            , IHaveATypeBaseModel<ITypeModel>
            , IHaveImagesBaseModel<IBadgeImageModel, ITypeModel>
    {
    }
}
