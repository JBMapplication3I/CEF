// <copyright file="CEFConfig.GetFranchiseAdmin.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the CEF configuration class, Get Franchise Admin CEF Config section</summary>
...
namespace Clarity.Ecommerce.JSConfigs
{
	...
	public static partial class CEFConfigDictionary
	{
		...
		public static CEFActionResponse<string> GetBranFranchiseAdminCEFConfig()
		{
			var retVal = $@"/**
...
var settings = {GetFranchiseAdminCEFConfigInner()};
angular.module(""cefConfig"", []).constant(""cefConfig"", settings);";
		...
		public static CEFActionResponse<CEFConfig> GetFranchiseAdminCEFConfigAlt()
		{
			var serialized = GetFranchiseAdminCEFConfigInner();
			var deserialized = JsonConvert.DeserializeObject<CEFConfig>(serialized!);
			return deserialized.WrapInPassingCEFARIfNotNull();
		}

		private static string GetFranchiseAdminCEFConfigInner()
		{
			return "{" + $@"
{GetAuthBlock()}
...
routes: {{
api: {{
	host: {(APIFranchiseAdminRouteHostUrl != null ? $"\"{APIFranchiseAdminRouteHostUrl}\"" : "null")},
	root: {(APIFranchiseAdminRouteRelativePath != null ? $"\"{APIFranchiseAdminRouteRelativePath}\"" : "null")}
}},
