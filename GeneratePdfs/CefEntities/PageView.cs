...
namespace GeneratePdfs.CefEntities
{
    public partial class PageView
    {
        ...
        public virtual PageViewStatus Status { get; set; } = null!;
        public virtual PageViewType Type { get; set; } = null!;
        public virtual User? User { get; set; }
        public virtual Visitor? Visitor { get; set; }
        public virtual ICollection<PageViewEvent> PageViewEvents { get; set; }
    }
}
