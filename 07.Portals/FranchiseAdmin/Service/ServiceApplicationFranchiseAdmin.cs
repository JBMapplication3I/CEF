// <copyright file="ServiceApplicationFranchiseAdmin.cs" company="clarity-ventures.com">
// Copyright (c) 2021-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the service application franchise admin class</summary>
#nullable enable
namespace Clarity.Ecommerce.Service
{
    ...
    /// <summary>A service application franchise admin.</summary>
    /// <seealso cref="ServiceApplication"/>
    [PublicAPI]
    public class ServiceApplicationFranchiseAdmin : ServiceApplication
    {
        private ServiceAppHostFranchiseAdmin serviceStackHost = null!;
        ...
        protected override void Application_Start()
        {
            ...
            /* Update to the latest migration on first initialization
             !!! Don't do this with franchise admin, let the admin API deal with it. Don't want more than one API trying to upgrade at the same time
        ...
        /// <summary>A service application host franchise admin.</summary>
        /// <seealso cref="ServiceApplication.ServiceAppHost"/>
        public class ServiceAppHostFranchiseAdmin : ServiceAppHost
        {
            /// <summary>Initializes a new instance of the <see cref="ServiceAppHostFranchiseAdmin"/> class.</summary>
            public ServiceAppHostFranchiseAdmin()
            ...
            public override void Configure(Funq.Container container)
            {
                ...
                ServiceAppCommonFranchiseAdmin.Configure(this, container);
            }
            ...
            protected void RegisterService(
                ...
                ServiceAppHostFranchiseAdmin appHost,
                ...
                Type serviceType)
            {
                ...
                foreach (var action in serviceType.GetActions())
                {
                    ...
                    if (!requestType.HasAttribute<UsedInFranchiseAdminAttribute>())
                    {
                        // Don't process endpoints not marked for use in franchise admin
                        continue;
                    }
