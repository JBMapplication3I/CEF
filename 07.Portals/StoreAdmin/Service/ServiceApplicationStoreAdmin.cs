// <copyright file="ServiceApplicationStoreAdmin.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the service application store admin class</summary>
#nullable enable
namespace Clarity.Ecommerce.Service
{
    ...
    /// <summary>A service application store admin.</summary>
    /// <seealso cref="ServiceApplication"/>
    [PublicAPI]
    public class ServiceApplicationStoreAdmin : ServiceApplication
    {
        private ServiceAppHostStoreAdmin serviceStackHost = null!;
        ...
        protected override void Application_Start()
        {
            try
            {
                ...
                /* Update to the latest migration on first initialization
                 !!! Don't do this with store admin, let the admin API deal with it. Don't want more than one API trying to upgrade at the same time
        ...
        /// <summary>A service application host store admin.</summary>
        /// <seealso cref="ServiceApplication.ServiceAppHost"/>
        public class ServiceAppHostStoreAdmin : ServiceAppHost
        {
            /// <summary>Initializes a new instance of the <see cref="ServiceAppHostStoreAdmin"/> class.</summary>
            public ServiceAppHostStoreAdmin()
            ...
            public override void Configure(Funq.Container container)
            {
                ...
                ServiceAppCommonStoreAdmin.Configure(this, container);
            }
            ...
            protected override ServiceController CreateServiceController(params Assembly[] assembliesWithServices)
            {
                ...
                ////throw new(serviceHandlerClasses.Select(x => x.Name).Aggregate((c, n) => c + "\r\n" + n));
            ...
            protected void RegisterService(
                ...
                ServiceAppHostStoreAdmin appHost,
                ...
                Type serviceType)
            {
                ...
                foreach (var action in serviceType.GetActions())
                {
                    ...
                    if (!requestType.HasAttribute<UsedInStoreAdminAttribute>())
                    {
                        // Don't process endpoints not marked for use in store admin
                        continue;
                    }
