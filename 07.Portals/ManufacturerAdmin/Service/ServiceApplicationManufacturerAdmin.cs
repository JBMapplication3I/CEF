// <copyright file="ServiceApplicationManufacturerAdmin.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the service application manufacturer admin class</summary>
#nullable enable
namespace Clarity.Ecommerce.Service
{
    ...
    /// <summary>A service application manufacturer admin.</summary>
    /// <seealso cref="ServiceApplication"/>
    [PublicAPI]
    public class ServiceApplicationManufacturerAdmin : ServiceApplication
    {
        private ServiceAppHostManufacturerAdmin serviceStackHost = null!;
        ...
        protected override void Application_Start()
        {
            ...
            /* Update to the latest migration on first initialization
             !!! Don't do this with manufacturer admin, let the admin API deal with it. Don't want more than one API trying to upgrade at the same time
        ...
        /// <summary>A service application host manufacturer admin.</summary>
        /// <seealso cref="ServiceApplication.ServiceAppHost"/>
        public class ServiceAppHostManufacturerAdmin : ServiceAppHost
        {
            /// <summary>Initializes a new instance of the <see cref="ServiceAppHostManufacturerAdmin"/> class.</summary>
            public ServiceAppHostManufacturerAdmin()
            ...
            public override void Configure(Funq.Container container)
            {
                ...
                ServiceAppCommonManufacturerAdmin.Configure(this, container);
            }
            ...
            protected void RegisterService(
                ...
                ServiceAppHostManufacturerAdmin appHost,
                ...
                Type serviceType)
            {
                ...
                foreach (var action in serviceType.GetActions())
                {
                    ...
                    if (!requestType.HasAttribute<UsedInManufacturerAdminAttribute>())
                    {
                        // Don't process endpoints not marked for use in manufacturer admin
                        continue;
                    }
