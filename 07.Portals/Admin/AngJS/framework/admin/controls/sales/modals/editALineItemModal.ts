module cef.admin.controls.sales.modals {
    export class EditALineItemModalController extends core.TemplatedControllerBase {
        // Properties
        ...
        // Functions
        subtotal(): number {
            return (this.newValue.Quantity
                    + (this.newValue.QuantityBackOrdered || 0)
                    + (this.newValue.QuantityPreSold || 0))
        ...
        // Events
        onOpen(): void {
            this.newValue = angular.fromJson(angular.toJson(this.originalValue));
            this.productFilter = this.newValue.Sku;
        ...
        onSelectProduct($item: api.ProductModel, $model: number, $label: string, $event: ng.IAngularEvent): void {
            this.cvApi.products.AdminGetProductFull($item.ID).then(r => {
                ...
                this.newValue.ProductDescription
                    = this.newValue.Description
                    = r.data.ShortDescription || r.data.Description;
        ...
        constructor(
                ...
                private readonly originalValue: api.SalesItemBaseModel<api.AppliedDiscountBaseModel>,
                private readonly responses: Array<api.SalesQuoteModel>,
