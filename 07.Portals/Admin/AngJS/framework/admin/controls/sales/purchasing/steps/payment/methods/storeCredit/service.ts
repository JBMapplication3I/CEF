/**
 * @file framework/admin/purchasing/steps/payment/methods/storeCredit/api.ts
    ...
    export class StoreCreditPaymentMethod extends PaymentMethodBase {
        ...
        submit(cart: api.CartModel): ng.IPromise<boolean> {
            ...
            return this.$q.resolve(
                this.cvPurchaseService.finalize(api.CartByIDLookupKey.newFromCart(cart), dataToUse));
        }
        constructor(
