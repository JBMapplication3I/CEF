/**
 * @file framework/admin/purchasing/steps/payment/methods/wireTransfer/body.ts
...
module cef.admin.purchasing.steps.payment.methods.wireTransfer {
    ...
    adminApp.directive("cefPaymentMethodWireTransferBody", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { lookupKey: "=" },
        templateUrl: $filter("corsLink")("/framework/admin/controls/sales/purchasing/steps/payment/methods/wireTransfer/body.html", "ui"),
