/**
 * @file framework/admin/purchasing/steps/payment/methods/invoice/service.ts
...
module cef.admin.purchasing.steps.payment.methods.invoice {
    export class InvoicePaymentMethod extends PaymentMethodBase {
        ...
        submit(cart: api.CartModel): ng.IPromise<boolean> {
            ...
            if (this.paymentData.PayByBillMeLater["StoredFiles"] // Manually assigned by the Upload Widget
