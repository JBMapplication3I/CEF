/**
* @file framework/admin/controls/types/salesOrderType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc sales order types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class SalesOrderTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Sales Order Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("salesOrderTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/salesOrderTypes.detail.html", "ui"),
controller: SalesOrderTypeDetailController,
controllerAs: "salesOrderTypeDetailCtrl",
