/**
* @file framework/admin/controls/types/lotType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc lot types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class LotTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Lot Type";
// Collections
// <None>
...
adminApp.directive("lotTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/lotTypes.detail.html", "ui"),
controller: LotTypeDetailController,
controllerAs: "lotTypeDetailCtrl",
