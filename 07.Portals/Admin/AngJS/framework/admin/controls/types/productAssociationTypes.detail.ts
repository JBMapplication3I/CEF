/**
* @file framework/admin/controls/types/productAssociationType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc product association types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class ProductAssociationTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Product Association Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("productAssociationTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/productAssociationTypes.detail.html", "ui"),
controller: ProductAssociationTypeDetailController,
controllerAs: "productAssociationTypeDetailCtrl",
