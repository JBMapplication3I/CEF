/**
* @file framework/admin/controls/types/calendarEventImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc calendar event image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class CalendarEventImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Calendar Event Image Type";
// Collections
// <None>
// UI Data
// <None>
...
SortOrder: null,
TranslationKey: null,
// Calendar Event Image Type Specific Properties
};
return this.$q.resolve(this.record);
}
constructorPreAction(): ng.IPromise<void> {
this.detailName = "Calendar Event Image Type";
return this.$q.resolve();
}
loadRecordCall(id: number): ng.IHttpPromise<api.TypeModel> {
return this.cvApi.calendarEvents.GetCalendarEventImageTypeByID(id);
}
createRecordCall(routeParams?: api.TypeModel): ng.IHttpPromise<api.CEFActionResponseT<number>> {
return this.cvApi.calendarEvents.CreateCalendarEventImageType(routeParams);
}
updateRecordCall(routeParams?: api.TypeModel): ng.IHttpPromise<api.CEFActionResponseT<number>> {
return this.cvApi.calendarEvents.UpdateCalendarEventImageType(routeParams);
}
deactivateRecordCall(id: number): ng.IHttpPromise<api.CEFActionResponse> {
return this.cvApi.calendarEvents.DeactivateCalendarEventImageTypeByID(id);
}
reactivateRecordCall(id: number): ng.IHttpPromise<api.CEFActionResponse> {
return this.cvApi.calendarEvents.ReactivateCalendarEventImageTypeByID(id);
}
deleteRecordCall(id: number): ng.IHttpPromise<api.CEFActionResponse> {
return this.cvApi.calendarEvents.DeleteCalendarEventImageTypeByID(id);
}
...
adminApp.directive("calendarEventImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/calendarEventImageTypes.detail.html", "ui"),
controller: CalendarEventImageTypeDetailController,
controllerAs: "calendarEventImageTypeDetailCtrl",
