/**
* @file framework/admin/controls/types/salesQuoteEventType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc sales quote event types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class SalesQuoteEventTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Sales Quote Event Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("salesQuoteEventTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/salesQuoteEventTypes.detail.html", "ui"),
controller: SalesQuoteEventTypeDetailController,
controllerAs: "salesQuoteEventTypeDetailCtrl",
