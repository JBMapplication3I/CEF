/**
* @file framework/admin/controls/types/cartEventType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc cart event types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class CartEventTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Cart Event Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("cartEventTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/cartEventTypes.detail.html", "ui"),
controller: CartEventTypeDetailController,
controllerAs: "cartEventTypeDetailCtrl",
