/**
* @file framework/admin/controls/types/storeType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc store types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class StoreTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Store Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("storeTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/storeTypes.detail.html", "ui"),
controller: StoreTypeDetailController,
controllerAs: "storeTypeDetailCtrl",
