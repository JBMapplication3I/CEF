/**
* @file framework/admin/controls/types/franchiseImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc franchise image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class FranchiseImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Franchise Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("franchiseImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/franchiseImageTypes.detail.html", "ui"),
controller: FranchiseImageTypeDetailController,
controllerAs: "franchiseImageTypeDetailCtrl",
