/**
* @file framework/admin/controls/types/questionType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc question types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class QuestionTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Question Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("questionTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/questionTypes.detail.html", "ui"),
controller: QuestionTypeDetailController,
controllerAs: "questionTypeDetailCtrl",
