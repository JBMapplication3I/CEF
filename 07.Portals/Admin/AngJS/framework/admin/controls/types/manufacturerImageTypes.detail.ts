/**
* @file framework/admin/controls/types/manufacturerImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc manufacturer image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class ManufacturerImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Manufacturer Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("manufacturerImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/manufacturerImageTypes.detail.html", "ui"),
controller: ManufacturerImageTypeDetailController,
controllerAs: "manufacturerImageTypeDetailCtrl",
