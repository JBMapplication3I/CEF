/**
* @file framework/admin/controls/types/vendorType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc vendor types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class VendorTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Vendor Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("vendorTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/vendorTypes.detail.html", "ui"),
controller: VendorTypeDetailController,
controllerAs: "vendorTypeDetailCtrl",
