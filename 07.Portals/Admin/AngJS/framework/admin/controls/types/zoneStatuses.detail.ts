/**
* @file framework/admin/controls/types/zoneStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc zone statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class ZoneStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Zone Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("zoneStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/zoneStatuses.detail.html", "ui"),
controller: ZoneStatusDetailController,
controllerAs: "zoneStatusDetailCtrl",
