/**
* @file framework/admin/controls/types/manufacturerType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc manufacturer types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class ManufacturerTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Manufacturer Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("manufacturerTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/manufacturerTypes.detail.html", "ui"),
controller: ManufacturerTypeDetailController,
controllerAs: "manufacturerTypeDetailCtrl",
