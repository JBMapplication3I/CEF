/**
* @file framework/admin/controls/types/paymentStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc payment statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class PaymentStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Payment Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("paymentStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/paymentStatuses.detail.html", "ui"),
controller: PaymentStatusDetailController,
controllerAs: "paymentStatusDetailCtrl",
