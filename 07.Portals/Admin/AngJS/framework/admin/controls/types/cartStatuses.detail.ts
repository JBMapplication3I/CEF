/**
* @file framework/admin/controls/types/cartStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc cart statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class CartStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Cart Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("cartStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/cartStatuses.detail.html", "ui"),
controller: CartStatusDetailController,
controllerAs: "cartStatusDetailCtrl",
