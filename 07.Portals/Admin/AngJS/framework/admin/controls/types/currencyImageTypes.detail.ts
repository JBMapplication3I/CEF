/**
* @file framework/admin/controls/types/currencyImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc currency image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class CurrencyImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Currency Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("currencyImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/currencyImageTypes.detail.html", "ui"),
controller: CurrencyImageTypeDetailController,
controllerAs: "currencyImageTypeDetailCtrl",
