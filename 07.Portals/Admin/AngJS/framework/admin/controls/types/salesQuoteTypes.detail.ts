/**
* @file framework/admin/controls/types/salesQuoteType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc sales quote types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class SalesQuoteTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Sales Quote Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("salesQuoteTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/salesQuoteTypes.detail.html", "ui"),
controller: SalesQuoteTypeDetailController,
controllerAs: "salesQuoteTypeDetailCtrl",
