/**
* @file framework/admin/controls/types/settingType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc setting types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class SettingTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Setting Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("settingTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/settingTypes.detail.html", "ui"),
controller: SettingTypeDetailController,
controllerAs: "settingTypeDetailCtrl",
