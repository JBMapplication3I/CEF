/**
* @file framework/admin/controls/types/accountImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc account image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class AccountImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Account Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("accountImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/accountImageTypes.detail.html", "ui"),
controller: AccountImageTypeDetailController,
controllerAs: "accountImageTypeDetailCtrl",
