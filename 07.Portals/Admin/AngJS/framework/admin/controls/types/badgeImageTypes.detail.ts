/**
* @file framework/admin/controls/types/badgeImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc badge image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class BadgeImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Badge Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("badgeImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/badgeImageTypes.detail.html", "ui"),
controller: BadgeImageTypeDetailController,
controllerAs: "badgeImageTypeDetailCtrl",
