/**
* @file framework/admin/controls/types/accountStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc account statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class AccountStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Account Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("accountStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/accountStatuses.detail.html", "ui"),
controller: AccountStatusDetailController,
controllerAs: "accountStatusDetailCtrl",
