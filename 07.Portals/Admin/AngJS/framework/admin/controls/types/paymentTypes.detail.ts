/**
* @file framework/admin/controls/types/paymentType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc payment types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class PaymentTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
...
adminApp.directive("paymentTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/paymentTypes.detail.html", "ui"),
controller: PaymentTypeDetailController,
controllerAs: "paymentTypeDetailCtrl",
