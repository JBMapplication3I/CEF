/**
* @file framework/admin/controls/types/badgeType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc badge types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class BadgeTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Badge Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("badgeTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/badgeTypes.detail.html", "ui"),
controller: BadgeTypeDetailController,
controllerAs: "badgeTypeDetailCtrl",
