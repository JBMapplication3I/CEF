/**
* @file framework/admin/controls/types/salesOrderStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc sales order statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class SalesOrderStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Sales Order Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("salesOrderStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/salesOrderStatuses.detail.html", "ui"),
controller: SalesOrderStatusDetailController,
controllerAs: "salesOrderStatusDetailCtrl",
