/**
* @file framework/admin/controls/types/campaignStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc campaign statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class CampaignStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Campaign Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("campaignStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/campaignStatuses.detail.html", "ui"),
controller: CampaignStatusDetailController,
controllerAs: "campaignStatusDetailCtrl",
