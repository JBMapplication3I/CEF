/**
* @file framework/admin/controls/types/purchaseOrderEventType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc purchase order event types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class PurchaseOrderEventTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Purchase Order Event Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("purchaseOrderEventTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/purchaseOrderEventTypes.detail.html", "ui"),
controller: PurchaseOrderEventTypeDetailController,
controllerAs: "purchaseOrderEventTypeDetailCtrl",
