/**
* @file framework/admin/controls/types/visitStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc visit statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class VisitStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Visit Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("visitStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/visitStatuses.detail.html", "ui"),
controller: VisitStatusDetailController,
controllerAs: "visitStatusDetailCtrl",
