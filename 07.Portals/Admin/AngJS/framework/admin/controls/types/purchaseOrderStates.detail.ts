/**
* @file framework/admin/controls/types/purchaseOrderState.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc purchase order states detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class PurchaseOrderStateDetailController extends DetailBaseController<api.StateModel> {
// Forced overrides
detailName = "Purchase Order State";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("purchaseOrderStateDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/purchaseOrderStates.detail.html", "ui"),
controller: PurchaseOrderStateDetailController,
controllerAs: "purchaseOrderStateDetailCtrl",
