/**
* @file framework/admin/controls/types/regionImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc region image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class RegionImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Region Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("regionImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/regionImageTypes.detail.html", "ui"),
controller: RegionImageTypeDetailController,
controllerAs: "regionImageTypeDetailCtrl",
