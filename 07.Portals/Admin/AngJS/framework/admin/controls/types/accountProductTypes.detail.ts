/**
* @file framework/admin/controls/types/accountProductType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc account product types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class AccountProductTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Account Product Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("accountProductTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/accountProductTypes.detail.html", "ui"),
controller: AccountProductTypeDetailController,
controllerAs: "accountProductTypeDetailCtrl",
