/**
* @file framework/admin/controls/types/districtImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc district image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class DistrictImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "District Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("districtImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/districtImageTypes.detail.html", "ui"),
controller: DistrictImageTypeDetailController,
controllerAs: "districtImageTypeDetailCtrl",
