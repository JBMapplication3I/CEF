/**
* @file framework/admin/controls/types/lotStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc lot statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class LotStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Lot Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("lotStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/lotStatuses.detail.html", "ui"),
controller: LotStatusDetailController,
controllerAs: "lotStatusDetailCtrl",
