/**
* @file framework/admin/controls/types/sampleRequestEventType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc sample request event types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class SampleRequestEventTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Sample Request Event Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("sampleRequestEventTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/sampleRequestEventTypes.detail.html", "ui"),
controller: SampleRequestEventTypeDetailController,
controllerAs: "sampleRequestEventTypeDetailCtrl",
