/**
* @file framework/admin/controls/types/accountType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc account types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class AccountTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Account Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("accountTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/accountTypes.detail.html", "ui"),
controller: AccountTypeDetailController,
controllerAs: "accountTypeDetailCtrl",
