/**
* @file framework/admin/controls/types/categoryImageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc category image types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class CategoryImageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Category Image Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("categoryImageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/categoryImageTypes.detail.html", "ui"),
controller: CategoryImageTypeDetailController,
controllerAs: "categoryImageTypeDetailCtrl",
