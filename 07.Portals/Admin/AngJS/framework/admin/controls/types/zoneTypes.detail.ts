/**
* @file framework/admin/controls/types/zoneType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc zone types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class ZoneTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
detailName = "Zone Type";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("zoneTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/zoneTypes.detail.html", "ui"),
controller: ZoneTypeDetailController,
controllerAs: "zoneTypeDetailCtrl",
