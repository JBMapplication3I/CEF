/**
* @file framework/admin/controls/types/packageType.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc package types detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class PackageTypeDetailController extends DetailBaseController<api.TypeModel> {
// Forced overrides
...
adminApp.directive("packageTypeDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/packageTypes.detail.html", "ui"),
controller: PackageTypeDetailController,
controllerAs: "packageTypeDetailCtrl",
