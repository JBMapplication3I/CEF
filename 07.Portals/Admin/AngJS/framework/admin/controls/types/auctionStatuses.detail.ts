/**
* @file framework/admin/controls/types/auctionStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc auction statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class AuctionStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Auction Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("auctionStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/auctionStatuses.detail.html", "ui"),
controller: AuctionStatusDetailController,
controllerAs: "auctionStatusDetailCtrl",
