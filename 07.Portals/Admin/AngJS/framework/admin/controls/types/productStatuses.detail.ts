/**
* @file framework/admin/controls/types/productStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc product statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class ProductStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Product Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("productStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/productStatuses.detail.html", "ui"),
controller: ProductStatusDetailController,
controllerAs: "productStatusDetailCtrl",
