/**
* @file framework/admin/controls/types/futureImportStatus.detail.ts
* @author Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
* @desc future import statuses detail/editor class
* @auto-generated This file was auto-generated by the T4 template types.tt in the UI project
*/
module cef.admin.controls.types {
class FutureImportStatusDetailController extends DetailBaseController<api.StatusModel> {
// Forced overrides
detailName = "Future Import Status";
// Collections
// <None>
// UI Data
// <None>
...
adminApp.directive("futureImportStatusDetail", ($filter: ng.IFilterService): ng.IDirective => ({
restrict: "A",
templateUrl: $filter("corsLink")("/framework/admin/controls/types/futureImportStatuses.detail.html", "ui"),
controller: FutureImportStatusDetailController,
controllerAs: "futureImportStatusDetailCtrl",
