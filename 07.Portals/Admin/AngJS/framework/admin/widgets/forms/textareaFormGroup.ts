/**
 * @file framework/admin/widgets/forms/textareaInputFormGroup.ts
...
module cef.admin.widgets.forms {
    ...
    adminApp.directive("textareaFormGroup", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "EA",
        scope: {
            // Base Properties
            formIdentifier: "@key",
        ...
        templateUrl: $filter("corsLink")("/framework/admin/widgets/forms/textareaFormGroup.html", "ui"),
