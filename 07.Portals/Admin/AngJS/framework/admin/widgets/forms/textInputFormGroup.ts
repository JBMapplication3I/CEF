...
module cef.admin.widgets.forms {
    ...
    adminApp.directive("textInputFormGroup", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "EA",
        scope: {
            // Base Properties
            formIdentifier: "@key",
        ...
        templateUrl: $filter("corsLink")("/framework/admin/widgets/forms/textInputFormGroup.html", "ui"),
        controller: TextInputFormGroupController,
        controllerAs: "tIFGCtrl",
        bindToController: true
    }));

    adminApp.directive("ngAutocomplete", () => ({
        restrict: "A",
    ...
    adminApp.directive("ngAutofocus", () => ({
        restrict: "A",
        // Intentionally No Template
        link: <ng.IDirectivePrePost>{
            pre: (
