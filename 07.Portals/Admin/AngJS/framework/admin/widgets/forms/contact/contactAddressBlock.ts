module cef.admin.widgets.forms.contact {
    ...
    adminApp.directive("cefContactAddressBlock", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "EA",
        scope: {
            contact: "=",
            hideIcons: "=?",
        ...
        templateUrl: $filter("corsLink")("/framework/admin/widgets/forms/contact/contactAddressBlock.html", "ui"),
