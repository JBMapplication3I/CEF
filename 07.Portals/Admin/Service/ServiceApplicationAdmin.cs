// <copyright file="ServiceApplicationAdmin.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the service application admin class</summary>
#nullable enable
namespace Clarity.Ecommerce.Service
{
    ...
    /// <summary>A service application admin.</summary>
    /// <seealso cref="ServiceApplication"/>
    [PublicAPI]
    public class ServiceApplicationAdmin : ServiceApplication
    {
        private ServiceAppHostAdmin serviceStackHost = null!;
        ...
        protected override void Application_Start()
        {
            try
            {
                ...
                /* Update to the latest migration on first initialization
                 !!! Don't do this with admin, let the admin API deal with it. Don't want more than one API trying to upgrade at the same time
        ...
        /// <summary>A service application host admin.</summary>
        /// <seealso cref="ServiceApplication.ServiceAppHost"/>
        public class ServiceAppHostAdmin : ServiceAppHost
        {
            /// <summary>Initializes a new instance of the <see cref="ServiceAppHostAdmin"/> class.</summary>
            public ServiceAppHostAdmin()
            ...
            public override void Configure(Funq.Container container)
            {
                ...
                ServiceAppCommonAdmin.Configure(this, container);
            }
                ...
                Type serviceType)
            {
                ...
                foreach (var action in serviceType.GetActions())
                {
                    ...
                    if (!requestType.HasAttribute<UsedInAdminAttribute>())
                    {
                        // Don't process endpoints not marked for use in admin
                        continue;
                    }
