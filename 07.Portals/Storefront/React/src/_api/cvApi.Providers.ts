...
export class Providers {
	...
	CalculateInventory = (id: number): IHttpPromise<CEFActionResponseT<CalculatedInventory>> =>
		axios.get(["Providers", "Inventory", "CalculateInventory", id].join("/"));
	...
	CheckHasAnyAvailableInventory = (id: number): IHttpPromise<CEFActionResponseT<boolean>> =>
		axios.get(["Providers", "Inventory", "CheckHasAnyAvailableInventory", id].join("/"));
	 ...
	 * @public
	 */
	ConvertQuoteToOrderForCurrentUser = (id: number): IHttpPromise<CEFActionResponseT<{ item1: number, item2: number }>> =>
		axios.post(["Providers", "Quoting", "Actions", "CurrentUser", "ConvertToOrder", id].join("/"));
	...
	GetDiscountsForInvoice = (id: number): IHttpPromise<DiscountsForInvoice> =>
		axios.get(["Providers", "Invoicing", "Queries", "Secured", "DiscountsFor", id].join("/"));
	...
	GetDiscountsForOrder = (id: number): IHttpPromise<DiscountsForOrderResponse> =>
		axios.get(["Providers", "Ordering", "Queries", "Secured", "DiscountsFor", id].join("/"));
	...
	GetDiscountsForQuote = (id: number): IHttpPromise<DiscountsForQuote> =>
		axios.get(["Providers", "Quoting", "Queries", "Secured", "DiscountsFor", id].join("/"));
	...
	GetSecureSalesInvoice = (id: number): IHttpPromise<SalesInvoiceModel> =>
		axios.get(["Providers", "Invoicing", "Queries", "Secured", id].join("/"));
	...
	GetSecureSalesQuote = (id: number): IHttpPromise<SalesQuoteModel> =>
		axios.get(["Providers", "Quoting", "Queries", "Secured", id].join("/"));
	...
	GetSecureSalesReturn = (id: number): IHttpPromise<SalesReturnModel> =>
		axios.get(["Providers", "Returning", "Queries", "Secured", id].join("/"));
	...
	GetSecureSampleRequest = (id: number): IHttpPromise<SampleRequestModel> =>
		axios.get(["Providers", "Sampling", "Queries", "Secured", id].join("/"));
	...
	IsSalesOrderReadyForReturn = (id: number): IHttpPromise<CEFActionResponse> =>
		axios.get(["Providers", "Returning", "Queries", "IsSalesOrderReadyForReturn", id].join("/"));
	 ...
	 * @public
	 */
	SetSalesQuoteAsApproved = (id: number): IHttpPromise<CEFActionResponse> =>
		axios.patch(["Providers", "Quoting", "Actions", "Approve", id].join("/"));
	 ...
	 * @public
	 */
	SetSalesQuoteAsRejected = (id: number): IHttpPromise<CEFActionResponse> =>
		axios.patch(["Providers", "Quoting", "Actions", "Reject", id].join("/"));
	 ...
	 * @public
	 */
	SetSalesQuoteAsVoided = (id: number): IHttpPromise<CEFActionResponse> =>
		axios.patch(["Providers", "Quoting", "Actions", "Void", id].join("/"));
