import { AccountContactModel, AccountModel, CartModel, SearchSort, UserModel } from "../_api/cvApi._DtoClasses";
...
export interface ICart {
  ...
  RateQuotes: Array<any>;
  ID: number;
  CustomKey: string;
  Active: boolean;
  CreatedDate: string;
  SerializableAttributes: any;
}
...
export interface ICurrentAccount extends AccountModel {}

export interface IStaticCartsReducer {
  compareList: CartModel;
  favoritesList: CartModel;
  wishList: CartModel;
  notifyMeList: CartModel;
  shoppingList: CartModel;
}
...
export interface IFeatureSet {
  ...
  addressBook: {
    ...
    dashboardCanEditShippingAddressesInBook: boolean;
    dashboardCanEditBillingAddressesInBook: boolean;
  ...
  carts: {
    ...
    productAlert: ISimpleEnablableFeature;
    shoppingLists: ISimpleEnablableFeature;
    watchList: ISimpleEnablableFeature;
