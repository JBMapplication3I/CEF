...
<footer
  id="footer"
  class="container-fluid bg-dark-blue text-light py-4 d-print-none text-white-50 translate-cloak"
  translate-cloak
...
<script defer src="/Portals/_default/Skins/Clarity/js/lazysizes.min.js"></script>
<script defer src="/Portals/_default/Skins/Clarity/bootstrap/javascripts/bootstrap.bundle.min.js"></script>
...
<script src="/Portals/_default/Skins/Clarity/js/custom.js"></script>
<script src="/Portals/_default/Skins/Clarity/js/doubletaptogo.min.js"></script>
<script src="/Portals/_default/Skins/Clarity/js/scripts.js"></script>
<% } else { %>
<script defer src="/DesktopModules/ClarityEcommerce/UI-Storefront/lib/cef/js/1-angular.js?_=<%= 1/*DateTime.Now.Ticks*/ %><%= BuildNumber %>"></script>
<script defer src="/DesktopModules/ClarityEcommerce/UI-Storefront/lib/cef/js/2-kendo.min.js?_=<%= 1/*DateTime.Now.Ticks*/ %><%= BuildNumber %>"></script>
<script defer src="/Portals/_default/Skins/Clarity/js/lazysizes.min.js"></script>
...
<script defer src="/DesktopModules/ClarityEcommerce/UI-Storefront/lib/cef/js/6-cef-store-init.min.js?_=<%= 1/*DateTime.Now.Ticks*/ %><%= BuildNumber %>"></script>
<script defer src="https://kit.fontawesome.com/4d87c1b73b.js" crossorigin="anonymous"></script>
<script defer src="/Portals/_default/Skins/Clarity/js/custom.js"></script>
<script defer src="/Portals/_default/Skins/Clarity/js/doubletaptogo.min.js"></script>
<script defer src="/Portals/_default/Skins/Clarity/js/scripts.js"></script>
<% } %>
