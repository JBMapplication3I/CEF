...
<div class="siteWrapper">
  ...
  <div id="body-with-min-height" class="w-100" style="min-height: 65vh;">
    ...
    <div class="container-fluid">
      <div class="row">
        <div data-react-component="Cart" data-react-props='{"includeQuickOrder":"true", "cartType": "Quote Cart"}'
          class="col-12 offset-xl-1 col-xl-10 offset-tk-2 col-tk-8 offset-fk-3 col-fk-6"></div>
      </div>
    </div>
    <div class="container-fluid">
      <div class="row">
