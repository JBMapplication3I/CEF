/**
 * @file framework/store/purchasing/steps/billing/body.ts
...
module cef.store.purchasing.steps.billing {
    ...
    class PurchaseStepBillingBodyController extends core.TemplatedControllerBase {
        ...
        private readAddressBook(newID: number = null) {
            ...
            this.cvAuthenticationService.preAuth().finally(() => {
                ...
                this.cvAddressBookService.getBook(false).then(book => {
                    this.book = book;
                    if (tempID) {
    ...
    cefApp.directive("cefPurchaseStepBillingBody", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { cartType: "@", idSuffix: "@" },
        templateUrl: $filter("corsLink")("/framework/store/purchasing/steps/billing/body.html", "ui"),
