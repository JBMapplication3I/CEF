/**
 * @file framework/store/purchasing/steps/billing/service.ts
...
module cef.store.purchasing.steps.billing {
    ...
    export class PurchaseStepBilling extends PurchaseStep {
        ...
        initialize(cart: api.CartModel): ng.IPromise<boolean> {
            ...
            return this.$q((resolve, __) => {
                ...
                this.cvAuthenticationService.preAuth().finally(() => {
                    ...
                    this.cvAddressBookService.refreshContactChecks(false, "purchasing.steps.billing.service").finally(() => {
        ...
        submit(cartType: string): ng.IPromise<boolean> {
            this.consoleDebug(`PurchaseStepBilling.submit(cartType: "${cartType}")`);
            return this.$q((resolve, reject) => {
                this.cvCartService.applyBillingContact(cartType, this.currentAccountContact.Slave)
                    .then(() => resolve(true))
                    .catch(reject);
            });
        }
