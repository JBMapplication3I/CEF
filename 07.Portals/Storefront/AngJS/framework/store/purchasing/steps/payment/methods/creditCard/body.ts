/**
 * @file framework/store/purchasing/steps/payment/methods/creditCard/body.ts
...
module cef.store.purchasing.steps.payment.methods.creditCard {
    class CreditCardPaymentMethodBodyController extends core.TemplatedControllerBase {
        ...
        private add(): void {
            this.cvWalletModalFactory(
                this.$translate("ui.storefront.wallet.walletList.AddCard"), // Title
                this.$translate("ui.storefront.cart.Add"), // Button
                null, // Callback
                ...
                this.setRunning();
                this.cvWalletService.addEntry(newEntryToBeAdded).then(added => {
    ...
    cefApp.directive("cefPaymentMethodCreditCardBody", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { cartType: "@" },
        templateUrl: $filter("corsLink")("/framework/store/purchasing/steps/payment/methods/creditCard/body.html", "ui"),
