/**
 * @file framework/store/purchasing/steps/payment/methods/invoice/body.ts
...
module cef.store.purchasing.steps.payment.methods.invoice {
    ...
    cefApp.directive("cefPaymentMethodInvoiceBody", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { cartType: "@" },
        templateUrl: $filter("corsLink")("/framework/store/purchasing/steps/payment/methods/invoice/body.html", "ui"),
