/**
 * @file framework/store/purchasing/steps/payment/methods/quoteMe/body.ts
 * @author Copyright (c) 2019-2023 clarity-ventures.com. All rights reserved.
 * @desc Purchase items in the cart: The steps of the wizard
 */
module cef.store.purchasing.steps.payment.methods.quoteMe {
    class QuoteMePaymentMethodController extends core.TemplatedControllerBase {
        // Properties
    ...
    cefApp.directive("cefPaymentMethodQuoteMeBody", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { cartType: "@" },
        templateUrl: $filter("corsLink")("/framework/store/purchasing/steps/payment/methods/quoteMe/body.html", "ui"),
        controller: QuoteMePaymentMethodController,
        controllerAs: "pmqmbCtrl",
