/**
 * @file framework/store/purchasing/steps/payment/methods/storeCredit/body.ts
...
module cef.store.purchasing.steps.payment.methods.storeCredit {
    ...
    cefApp.directive("cefPaymentMethodStoreCreditBody", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { cartType: "@" },
        templateUrl: $filter("corsLink")("/framework/store/purchasing/steps/payment/methods/storeCredit/body.html", "ui"),
