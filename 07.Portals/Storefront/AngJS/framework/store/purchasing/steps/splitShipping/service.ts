/**
 * @file framework/store/purchasing/steps/ssplitShipping/step.splitShipping.api.ts
 * @author Copyright (c) 2019-2023 clarity-ventures.com. All rights reserved.
 * @desc Purchase items in the cart: The steps of the wizard
 */
module cef.store.purchasing.steps.splitShipping {
    ...
    export class PurchaseStepSplitShipping extends PurchaseStep {
        ...
        initialize(cart: api.CartModel): ng.IPromise<boolean> {
            ...
            return this.$q((resolve, __) => {
                ...
                this.cvAuthenticationService.preAuth().finally(() => {
                    ...
                    this.cvAddressBookService.refreshContactChecks(false, "purchasing.steps.splitShipping.service").then(() => {
        ...
        activate(cartType: string): ng.IPromise<boolean> {
            this.consoleDebug(`PurchaseStepSplitShipping.activate(cartType: "${cartType}")`);
            // Do Nothing
            return this.$q.resolve(true);
        }
        ...
        submit(cartType: string): ng.IPromise<boolean> {
            this.consoleDebug(`PurchaseStepSplitShipping.submit(cartType: "${cartType}")`);
