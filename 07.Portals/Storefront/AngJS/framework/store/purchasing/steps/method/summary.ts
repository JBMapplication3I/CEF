/**
 * @file framework/store/purchasing/steps/method/summary.ts
...
module cef.store.purchasing.steps.method {
    ...
    cefApp.directive("cefPurchaseStepMethodSummary", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { cartType: "@" },
        templateUrl: $filter("corsLink")("/framework/store/purchasing/steps/method/summary.html", "ui"),
