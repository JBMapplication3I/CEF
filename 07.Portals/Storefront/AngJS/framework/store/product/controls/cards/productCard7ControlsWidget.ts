/**
 * @file framework/store/product/controls/cards/productCard7ControlsWidget.ts
 * @author Copyright (c) 2019-2023 clarity-ventures.com. All rights reserved.
 * @desc Product Card Sub-module #7: Controls widget
 */
module cef.store.product.controls.cards {
    class ProductCardControlsGenWidgetController extends ProductCardGenWidgetControllerBase {
    ...
    cefApp.directive("cefProductCardControlsGenWidget", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "EA",
        scope: {
            product: "=?",
            productId: "=?",
        ...
        templateUrl: $filter("corsLink")("/framework/store/product/controls/cards/productCard7ControlsWidget.html", "ui"),
        controller: ProductCardControlsGenWidgetController,
