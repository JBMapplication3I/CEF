...
//     cssPrefix?: string;
//     cssDomPrefix?: string;
//     cssTransformProp?: any;
//     domPrefix?: string;
//     ieMode?: number;
//     platform?: string;
//     backCompat?: boolean;
//     scrollbarsWidth?: number;
//     getDoc?: () => any;
...
//     Element?: any;
//     Event?: any;
//     normalizeCSS: (source: string) => string;
// }

// window["MagicScroll"] = (function() {
//     var u, v;
//     u = v = (function() {
//         var jsUnpack = <jsUnpack>{
//             version: "v3.3-b5-1-gac3ac3e",
//             UUID: 0,
//             storage: {},
//             $uuid: x => x.$J_UUID || (x.$J_UUID = ++MainObject2.UUID),
//             getStorage: key => MainObject2.storage[key] || (MainObject2.storage[key] = {}),
//             $F: function() {},
//             $false: () => false,
//             $true: () => true,
//             stylesId: "mjs-" + Math.floor(Math.random() * new Date().getTime()),
//             //defined: x => undefined != x,
//             ifndef: (x, y) => undefined != x ? x : y,
//             exists: x => !!x,
//             jTypeOf: x => {
...
//                     && x.constructor === MainObject2.Class) {
//                     return "class";
//                 }
...
//                     return "string";
//                 }
//                 if (MainObject2.browser.trident) {
//                     if (!angular.isUndefined(x.cancelBubble)) {
//                         return "event";
//                     }
//                 } else {
//                     if (x === window.event
//                         || x.constructor == Event
//                         || x.constructor == MouseEvent
//                         || x.constructor == UIEvent
//                         || x.constructor == KeyboardEvent
//                         || x.constructor == KeyEvent) {
//                         return "event";
//                     }
//                 }
...
//                     }
//                     for (var x in (z || {})) {
//                         if (!arr[i].prototype[x]) {
//                             arr[i].prototype[x] = z[x];
//                         }
//                     }
//                 }
//                 return arr[0];
...
//                         arr[max] = x[max]
//                     }
//                     return MainObject2.$(arr)
//                 }
//                 return MainObject2.$(Array.prototype.slice.call(x))
//             },
//             now: () => new Date().getTime(),
//             detach: z => {
//                 var x;
//                 switch (MainObject2.jTypeOf(z)) {
//                     case "object": {
//                         x = {};
//                         for (var y in z) {
//                             x[y] = MainObject2.detach(z[y]);
//                         }
//                         break;
//                     }
//                     case "array": {
//                         x = [];
//                         for (var i = 0, max = z.length; i < max; i++) {
//                             x[i] = MainObject2.detach(z[i]);
//                         }
//                         break;
//                     }
//                     default: {
...
//                     return x;
//                 }
//                 switch (MainObject2.jTypeOf(x)) {
//                     case "array": {
//                         x = MainObject2.nativize(
//                             x,
//                             MainObject2.extend(MainObject2.Array, { $J_EXT: MainObject2.$F })
//                         );
//                         x.jEach = x.forEach;
//                         return x;
//                     }
...
//                     case "document": {
//                         MainObject2.$uuid(x);
//                         x = MainObject2.extend(x, MainObject2.Doc);
//                         break;
//                     }
//                     case "element": {
//                         MainObject2.$uuid(x);
//                         x = MainObject2.extend(x, MainObject2.Element);
//                         break;
//                     }
//                     case "event": {
//                         x = MainObject2.extend(x, MainObject2.Event);
//                         break;
//                     }
//                     case "textnode":
//                     case "function":
...
//                 }
//                 if (doSomething) {
//                     return MainObject2.extend(x, { $J_EXT: MainObject2.$F });
//                 }
//                 return x;
//             },
//             $new: (elementType, props?, styles?) => MainObject2.$(MainObject2.doc.createElement(elementType)).setProps(props || {}).jSetCss(styles || {}),
//             addCSS: (y, z, w) => {
//                 var v, ab, x, ad = [], ac = -1;
//                 w || (w = MainObject2.stylesId);
//                 v = MainObject2.$(w) || MainObject2.$new("style", {
//                     id: w,
//                     type: "text/css"
//                 }).jAppendTo((document.head || document.body), "top");
//                 ab = v.sheet || v.styleSheet;
//                 if ("string" != MainObject2.jTypeOf(z)) {
//                     for (var a in z) {
//                         ad.push(a + ":" + z[a]);
//                     }
//                     z = ad.join(";");
...
//                 var x, w;
//                 x = MainObject2.$(y);
//                 if ("element" !== MainObject2.jTypeOf(x)) {
//                     return;
//                 }
...
//                 }
//             },
//             generateUUID: () => "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, seed => {
//                 var rand = Math.random() * 16 | 0;
//                 return (seed == "x" ? rand : (rand & 3 | 8)).toString(16);
//             }).toUpperCase(),
//             getAbsoluteURL: (() => {
//                 var V;
//                 return W => {
...
//             }
//         };
//         var MainObject2 = jsUnpack;
//         if (!window["magicJS"]) {
//             window["magicJS"] = jsUnpack;
//             window["$mjs"] = jsUnpack.$;
//         }
//         MainObject2.Array = {
//             $J_TYPE: "array",
//             indexOf: (y, obj) => {
//                 for (var max = this.length, i = (obj < 0) ? Math.max(0, max + obj) : obj || 0; i < max; i++) {
//                     if (this[i] === y) {
//                         return i;
//                     }
//                 }
//                 return -1;
//             },
//             contains: (source, lookup) => this.indexOf(source, lookup) != -1,
//             forEach: (arr, expr): void => {
//                 for (var i = 0, max = this.length; i < max; i++) {
//                     if (i in this) {
//                         arr.call(expr, this[i], i, this);
//                     }
//                 }
//             },
//             filter: (arr, expr) => {
...
//                     if (i in this) {
//                         var x = this[i];
//                         if (arr.call(expr, this[i], i, this)) {
//                             filtered.push(x);
//                         }
//                     }
//                 }
...
//                 for (var i = 0, max = this.length; i < max; i++) {
//                     if (i in this) {
//                         arr[i] = obj.call(expr, this[i], i, this);
//                     }
//                 }
//                 return arr;
//             }
//         };
//         MainObject2.implement(String, {
//             $J_TYPE: "string",
//             eq: function(V, W) {
...
//             }
//         });
//         jsUnpack.implement(Function, {
//             $J_TYPE: "function",
//             jBind: function() {
//                 var W = MainObject2.$A(arguments),
//                     V = this,
//                     X = W.shift();
//                 return function() {
//                     return V.apply(X || null, W.concat(MainObject2.$A(arguments)))
//                 }
//             },
...
//                     V = this,
//                     X = W.shift();
//                 return (Y) => V.apply(X || null, MainObject2.$([Y || (MainObject2.browser.ieMode ? window.event : null)]).concat(W));
//             },
//             jDelay: function() {
//                 var W = MainObject2.$A(arguments),
//                     V = this,
//                     X = W.shift();
//                 return window.setTimeout(() => V.apply(V, W), X || 0);
//             },
//             jDefer: function() {
//                 var W = MainObject2.$A(arguments),
//                     V = this;
...
//                     V = this,
//                     X = W.shift();
//                 return window.setInterval(() => V.apply(V, W), X || 0);
//             }
//         });
//         var S = {},
...
//             engine: (J && J[1]) ? J[1].toLowerCase()
//                 : (window["opera"]) ? "presto"
//                 : !!(window["ActiveXObject"]) ? "trident"
//                 : (undefined !== document["getBoxObjectFor"] || null != window["mozInnerScreenY"]) ? "gecko"
//                 : (null !== window["WebKitPoint"] || !navigator["taintEnabled"]) ? "webkit"
//                 : "unknown",
...
//             scrollbarsWidth: 0,
//             getDoc: () => (document.compatMode && "backcompat" == document.compatMode.toLowerCase()) ? document.body : document.documentElement,
...
//             ready: false,
//             onready: (): void => {
//                 if (MainObject2.browser.ready) {
//                     return;
//                 }
//                 var Y, X;
//                 MainObject2.browser.ready = true;
//                 MainObject2.body = MainObject2.$(document.body);
//                 MainObject2.win = MainObject2.$(window);
//                 try {
//                     var W = MainObject2.$new("div").jSetCss({
//                         width: 100,
//                         height: 100,
//                         overflow: "scroll",
//                         position: "absolute",
...
//                     MainObject2.browser.scrollbarsWidth = W.offsetWidth - W.clientWidth;
//                     W.jRemove()
//                 } catch (V) {}
//                 try {
//                     Y = MainObject2.$new("div");
//                     X = Y.style;
//                     X.cssText = "background:url(https://),url(https://),red url(https://)";
//                     MainObject2.browser.features.multibackground = (/(url\s*\(.*?){3}/).test(X.background);
//                     X = null;
//                     Y = null
//                 } catch (V) {}
//                 if (!MainObject2.browser.cssTransformProp) {
//                     MainObject2.browser.cssTransformProp = MainObject2.normalizeCSS("transform").dashize()
//                 }
//                 try {
//                     Y = MainObject2.$new("div");
//                     Y.style.cssText = MainObject2.normalizeCSS("filter").dashize() + ":blur(2px);";
//                     MainObject2.browser.features.cssFilters = !!Y.style.length && (!MainObject2.browser.ieMode || MainObject2.browser.ieMode > 9);
//                     Y = null
//                 } catch (V) {}
//                 if (!MainObject2.browser.features.cssFilters) {
//                     MainObject2.$(document.documentElement).jAddClass("no-cssfilters-magic")
//                 }
//                 try {
//                     MainObject2.browser.features.canvas = (function() {
//                         var Z = MainObject2.$new("canvas");
...
//                 }
//                 MainObject2.Doc.jCallEvent.call(MainObject2.$(document), "domready")
//             }
//         };
//         (function() {
//             var aa = [],
//                 Z, Y, W;
//             var V = function(): boolean { return !!(arguments.callee.caller); };
//             switch (MainObject2.browser.engine) {
//                 case "trident":
//                     if (!MainObject2.browser.version) {
//                         MainObject2.browser.version = !!(window["XMLHttpRequest"]) ? 3 : 2
//                     }
//                     break;
//                 case "gecko":
//                     MainObject2.browser.version = (O && O[2]) ? parseFloat(O[2]) : 0;
//                     break
//             }
//             MainObject2.browser[MainObject2.browser.engine] = true;
//             if (O && "crios" === O[1]) {
//                 MainObject2.browser.uaName = "chrome"
//             }
//             if (!!window["chrome"]) {
//                 MainObject2.browser.chrome = true
//             }
//             if (O && "opr" === O[1]) {
//                 MainObject2.browser.uaName = "opera";
//                 MainObject2.browser.opera = true
//             }
//             if ("safari" === MainObject2.browser.uaName && (Q && Q[1])) {
//                 MainObject2.browser.uaVersion = parseFloat(Q[1])
//             }
//             if ("android" == MainObject2.browser.platform && MainObject2.browser.webkit && (Q && Q[1])) {
//                 MainObject2.browser.androidBrowser = true
//             }
//             Z = ({
//                 gecko: ["-moz-", "Moz", "moz"],
...
//                 trident: ["-ms-", "ms", "ms"],
//                 presto: ["-o-", "O", "o"]
//             })[MainObject2.browser.engine] || ["", "", ""];
//             MainObject2.browser.cssPrefix = Z[0];
//             MainObject2.browser.cssDomPrefix = Z[1];
//             MainObject2.browser.domPrefix = Z[2];
//             MainObject2.browser.ieMode = (!MainObject2.browser.trident) ? undefined : (document["documentMode"]) ? document["documentMode"] : function() {
//                 var ab = 0;
//                 if (MainObject2.browser.backCompat) {
//                     return 5;
//                 }
//                 switch (MainObject2.browser.version) {
//                     case 2: {
//                         ab = 6;
//                         break;
//                     }
...
//                 return ab;
//             }();
//             aa.push(MainObject2.browser.platform + "-magic");
//             if (MainObject2.browser.mobile) {
//                 aa.push("mobile-magic")
//             }
//             if (MainObject2.browser.androidBrowser) {
//                 aa.push("android-browser-magic")
//             }
//             if (MainObject2.browser.ieMode) {
//                 MainObject2.browser.uaName = "ie";
//                 MainObject2.browser.uaVersion = MainObject2.browser.ieMode;
//                 aa.push("ie" + MainObject2.browser.ieMode + "-magic");
//                 for (Y = 11; Y > MainObject2.browser.ieMode; Y--) {
//                     aa.push("lt-ie" + Y + "-magic")
//                 }
//             }
//             if (MainObject2.browser.webkit && MainObject2.browser.version < 536) {
//                 MainObject2.browser.features.fullScreen = false
//             }
//             if (MainObject2.browser.requestAnimationFrame) {
//                 MainObject2.browser.requestAnimationFrame.call(window, function() {
//                     MainObject2.browser.features.requestAnimationFrame = true
//                 })
//             }
//             if (MainObject2.browser.features.svg) {
//                 aa.push("svg-magic")
//             } else {
//                 aa.push("no-svg-magic")
//             }
//             W = (document.documentElement.className || "").match(/\S+/g) || [];
//             document.documentElement.className = MainObject2.$(W).concat(aa).join(" ");
//             try {
//                 document.documentElement.setAttribute("data-magic-ua", MainObject2.browser.uaName);
//                 document.documentElement.setAttribute("data-magic-ua-ver", String(MainObject2.browser.uaVersion))
//             } catch (X) {}
//             if (MainObject2.browser.ieMode && MainObject2.browser.ieMode < 9) {
//                 document.createElement("figure");
//                 document.createElement("figcaption")
//             }
//         })();
//         (function() {
//             MainObject2.browser.fullScreen = {
//                 capable: MainObject2.browser.features.fullScreen,
//                 enabled: function() {
//                     return !!(document["fullscreenElement"]
//                               || document[MainObject2.browser.domPrefix + "FullscreenElement"]
//                               || document["fullScreen"]
//                               || document["webkitIsFullScreen"]
//                               || document[MainObject2.browser.domPrefix + "FullScreen"])
//                 },
//                 request: function(V, W) {
//                     W || (W = {});
//                     if (this.capable) {
//                         MainObject2.$(document).jAddEvent(this.changeEventName, this.onchange = function(X) {
//                             if (this.enabled()) {
//                                 W.onEnter && W.onEnter()
//                             } else {
//                                 MainObject2.$(document).jRemoveEvent(this.changeEventName, this.onchange);
//                                 W.onExit && W.onExit()
//                             }
//                         }.jBindAsEvent(this));
//                         MainObject2.$(document).jAddEvent(this.errorEventName, this.onerror = function(X) {
//                             W.fallback && W.fallback();
//                             MainObject2.$(document).jRemoveEvent(this.errorEventName, this.onerror)
//                         }.jBindAsEvent(this));
//                         (V[MainObject2.browser.domPrefix + "RequestFullscreen"] || V[MainObject2.browser.domPrefix + "RequestFullScreen"] || V.requestFullscreen || function() {}).call(V)
//                     } else {
//                         if (W.fallback) {
//                             W.fallback()
//                         }
//                     }
//                 },
//                 cancel: (document.exitFullscreen || document["cancelFullScreen"] || document[MainObject2.browser.domPrefix + "ExitFullscreen"] || document[MainObject2.browser.domPrefix + "CancelFullScreen"] || function() {}).jBind(document),
//                 changeEventName: document["msExitFullscreen"] ? "MSFullscreenChange" : (document.exitFullscreen ? "" : MainObject2.browser.domPrefix) + "fullscreenchange",
//                 errorEventName: document["msExitFullscreen"] ? "MSFullscreenError" : (document.exitFullscreen ? "" : MainObject2.browser.domPrefix) + "fullscreenerror",
//                 prefix: MainObject2.browser.domPrefix,
//                 activeElement: null
//             }
//         })();
//         var whiteSpaceDetectRegex = /\S+/g,
//             cssDetectRegex = /^(border(Top|Bottom|Left|Right)Width)|((padding|margin)(Top|Bottom|Left|Right))$/,
//             floatOption = {
...
//                 return V;
//             };
//         function doNormalize(source: string): string {
//             var W = (MainObject2.browser.webkit && "filter" == source) ? false : (source in F);
//             if (!W) {
//                 var V = MainObject2.browser.cssDomPrefix + source.charAt(0).toUpperCase() + source.slice(1);
//                 if (V in F) {
//                     return V;
//                 }
//             }
//             return source;
//         }
//         MainObject2.normalizeCSS = doNormalize;
//         MainObject2.Element = {
//             jHasClass: V => !(V || "").has(" ") && (this.className || "").has(V, " "),
//             jAddClass: (Z) => {
//                 var W = (this.className || "").match(whiteSpaceDetectRegex) || [],
//                     Y = (Z || "").match(whiteSpaceDetectRegex) || [],
//                     V = Y.length,
//                     X = 0;
//                 for (; X < V; X++) {
//                     if (!MainObject2.$(W).contains(Y[X])) {
//                         W.push(Y[X]);
//                     }
//                 }
...
//             jRemoveClass: (aa) => {
//                 var W = (this.className || "").match(whiteSpaceDetectRegex) || [],
//                     Z = (aa || "").match(whiteSpaceDetectRegex) || [],
//                     V = Z.length,
//                     Y = 0,
//                     X;
//                 for (; Y < V; Y++) {
//                     if ((X = MainObject2.$(W).indexOf(Z[Y])) > -1) {
//                         W.splice(X, 1)
//                     }
//                 }
...
//                 return this;
//             },
//             jToggleClass: V => this.jHasClass(V) ? this.jRemoveClass(V) : this.jAddClass(V),
//             jGetCss: W => {
//                 var X = W.jCamelize(),
//                     V = null;
//                 W = floatOption[X] || (floatOption[X] = doNormalize(X));
//                 V = H(this, W);
//                 if ("auto" === V) {
//                     V = null;
//                 }
//                 if (null !== V) {
//                     if ("opacity" == W) {
//                         return !angular.isUndefined(V) ? parseFloat(V) : 1;
//                     }
//                     if (cssDetectRegex.test(W)) {
...
//                         return this;
//                     }
//                     W = floatOption[Y] || (floatOption[Y] = doNormalize(Y));
//                     this.style[W] = V + (("number" == MainObject2.jTypeOf(V) && !P[Y]) ? "px" : "");
//                 } catch (X) {}
//                 return this;
//             },
//             jSetCss: W => {
...
//             jGetStyles: function () {
//                 var V = {};
//                 MainObject2.$A(arguments).jEach(function(W) { V[W] = this.jGetCss(W); }, this);
//                 return V;
//             },
...
//                 X = parseInt(String(parseFloat(X) * 100));
//                 if (V) {
//                     if (0 === X) {
...
//                 var w = W.indexOf("ms") > -1 ? parseFloat(W) : W.indexOf("s") > -1 ? parseFloat(W) * 1000 : 0;
//                 var v = V.indexOf("ms") > -1 ? parseFloat(V) : V.indexOf("s") > -1 ? parseFloat(V) * 1000 : 0;
//                 return w + v;
//             },
//             hide: function() {
//                 return this.jSetCss({
...
//                     W = 0,
//                     Y = 0;
//                 if (!angular.isUndefined(document.documentElement.getBoundingClientRect)) {
//                     var V = this.getBoundingClientRect(),
//                         X = MainObject2.$(document).jGetScroll(),
//                         aa = MainObject2.browser.getDoc();
//                     return {
...
//             },
//             kill: function() {
//                 MainObject2.$A(this.childNodes).jEach(function(V) {
...
//                 this.jClearEvents();
//                 if (this.$J_UUID) {
//                     MainObject2.storage[this.$J_UUID] = null;
//                     delete MainObject2.storage[this.$J_UUID]
//                 }
//                 return null
//             },
//             append: function(X, W) {
...
//                 var V = MainObject2.$(X).append(this, W);
//                 return this
//             },
//             enclose: function(V) {
...
//             },
//             hasChild: function(V) {
//                 if ("element" !== MainObject2.jTypeOf("string" == MainObject2.jTypeOf(V) ? V = document.getElementById(V) : V)) {
//                     return false
//                 }
//                 return (this == V) ? false : (this.contains && !(MainObject2.browser.webkit419)) ? (this.contains(V)) : (this.compareDocumentPosition) ? !!(this.compareDocumentPosition(V) & 16) : MainObject2.$A(this.byTag(V.tagName)).contains(V)
//             }
//         };
//         MainObject2.Element.jGetStyle = MainObject2.Element.jGetCss;
//         MainObject2.Element.jSetStyle = MainObject2.Element.jSetCss;
//         if (!window["Element"]) {
//             window["Element"] = MainObject2.$F;
//             if (MainObject2.browser.engine.webkit) {
//                 window.document.createElement("iframe")
//             }
//             Element.prototype = (MainObject2.browser.engine.webkit) ? window["[[DOMElement.prototype]]"] : {}
//         }
//         MainObject2.implement(Element, {
//             $J_TYPE: "element"
//         });
//         MainObject2.Doc = {
//             jGetSize: function() {
//                 if (MainObject2.browser.touchScreen || MainObject2.browser.presto925 || MainObject2.browser.webkit419) {
//                     return {
...
//                 }
//                 return {
//                     width: MainObject2.browser.getDoc().clientWidth,
//                     height: MainObject2.browser.getDoc().clientHeight
//                 }
//             },
//             jGetScroll: function() {
//                 return {
//                     x: window.pageXOffset || MainObject2.browser.getDoc().scrollLeft,
//                     y: window.pageYOffset || MainObject2.browser.getDoc().scrollTop
//                 }
//             },
//             jGetFullSize: function() {
//                 var V = this.jGetSize();
//                 return {
//                     width: Math.max(MainObject2.browser.getDoc().scrollWidth, V.width),
//                     height: Math.max(MainObject2.browser.getDoc().scrollHeight, V.height)
//                 }
//             }
//         };
//         MainObject2.extend(document, {
//             $J_TYPE: "document"
//         });
//         MainObject2.extend(window, {
//             $J_TYPE: "window"
//         });
//         MainObject2.extend([MainObject2.Element, MainObject2.Doc], {
//             jFetch: function(Y, W) {
//                 var V = MainObject2.getStorage(this.$J_UUID),
//                     X = V[Y];
...
//                     return MainObject2.$A(this.getElementsByTagName("*")).filter(function(X) {
//                         try {
...
//             }
//         });
//         if (MainObject2.browser.fullScreen.capable && !document["requestFullScreen"]) {
//             MainObject2.Element.requestFullScreen = function() {
//                 MainObject2.browser.fullScreen.request(this)
//             }
//         }
//         MainObject2.Event = {
//             $J_TYPE: "event",
//             isQueueStopped: MainObject2.$false,
//             stop: function() {
...
//             },
//             stopQueue: function() {
//                 this.isQueueStopped = MainObject2.$true;
//                 return this
//             },
//             getClientXY: function() {
//                 var W, V;
//                 W = ((/touch/i).test(this.type)) ? this.changedTouches[0] : this;
//                 return (angular.isUndefined(W)) ? {
//                     x: 0,
//                     y: 0
//                 } : {
//                     x: W.clientX,
...
//                     y: 0
//                 } : {
//                     x: W.pageX || W.clientX + MainObject2.browser.getDoc().scrollLeft,
//                     y: W.pageY || W.clientY + MainObject2.browser.getDoc().scrollTop
//                 }
//             },
//             getTarget: function() {
...
//             }
//         };
//         MainObject2._event_add_ = "addEventListener";
//         MainObject2._event_del_ = "removeEventListener";
//         MainObject2._event_prefix_ = "";
//         if (!document.addEventListener) {
//             MainObject2._event_add_ = "attachEvent";
//             MainObject2._event_del_ = "detachEvent";
//             MainObject2._event_prefix_ = "on"
//         }
//         MainObject2.Event.Custom = {
//             type: null,
//             x: null,
//             y: null,
//             timeStamp: null,
...
//                 var ac, V, Y, ab, W;
//                 if ("string" == MainObject2.jTypeOf(X)) {
//                     W = X.split(" ");
//                     if (W.length > 1) {
//                         X = W
//                     }
//                 }
//                 if (MainObject2.jTypeOf(X) == "array") {
//                     MainObject2.$(X).jEach(this.jAddEvent.jBindAsEvent(this, Z, aa, ad));
//                     return this
//                 }
//                 if (!X || !Z || MainObject2.jTypeOf(X) != "string" || MainObject2.jTypeOf(Z) != "function") {
//                     return this
//                 }
//                 if (X == "domready" && MainObject2.browser.ready) {
//                     Z.call(this);
//                     return this
//                 }
//                 X = S[X] || X;
//                 aa = parseInt(aa || 50);
//                 if (!Z.$J_EUID) {
//                     Z.$J_EUID = Math.floor(Math.random() * MainObject2.now())
//                 }
//                 ac = MainObject2.Doc.jFetch.call(this, "_EVENTS_", {});
//                 V = ac[X];
//                 if (!V) {
//                     ac[X] = V = MainObject2.$([]);
//                     Y = this;
//                     if (MainObject2.Event.Custom[X]) {
//                         MainObject2.Event.Custom[X].handler.add.call(this, ad)
//                     } else {
//                         V.handle = function(ae) {
//                             ae = MainObject2.extend(ae || window["e"], {
//                                 $J_TYPE: "event"
//                             });
//                             MainObject2.Doc.jCallEvent.call(Y, X, MainObject2.$(ae))
//                         };
//                         this[MainObject2._event_add_](MainObject2._event_prefix_ + X, V.handle, false)
//                     }
//                 }
//                 ab = {
//                     type: X,
...
//                 var Z = MainObject2.Doc.jFetch.call(this, "_EVENTS_", {}),
//                     X, V, W, ac, aa, Y;
//                 aa = arguments.length > 1 ? arguments[1] : -100;
//                 if ("string" == MainObject2.jTypeOf(ab)) {
//                     Y = ab.split(" ");
//                     if (Y.length > 1) {
//                         ab = Y
//                     }
//                 }
//                 if (MainObject2.jTypeOf(ab) == "array") {
//                     MainObject2.$(ab).jEach(this.jRemoveEvent.jBindAsEvent(this, aa));
//                     return this
//                 }
//                 ab = S[ab] || ab;
//                 if (!ab || MainObject2.jTypeOf(ab) != "string" || !Z || !Z[ab]) {
//                     return this
//                 }
//                 X = Z[ab] || [];
...
//                 }
//                 if (0 === X.length) {
//                     if (MainObject2.Event.Custom[ab]) {
//                         MainObject2.Event.Custom[ab].handler.jRemove.call(this)
//                     } else {
//                         this[MainObject2._event_del_](MainObject2._event_prefix_ + ab, X.handle, false)
//                     }
//                     delete Z[ab]
//                 }
//                 return this
...
//                 var Y = MainObject2.Doc.jFetch.call(this, "_EVENTS_", {}),
//                     X, V, W;
//                 Z = S[Z] || Z;
//                 if (!Z || MainObject2.jTypeOf(Z) != "string" || !Y || !Y[Z]) {
//                     return this
//                 }
//                 try {
//                     ab = MainObject2.extend(ab || {}, {
//                         type: Z
//                     })
//                 } catch (aa) {}
//                 if (undefined === ab.timeStamp) {
//                     ab.timeStamp = MainObject2.now()
//                 }
//                 X = Y[Z] || [];
...
//                 W = S[W] || W;
//                 if (!Z) {
//                     MainObject2.Doc.jCallEvent.call(this, W);
//                     return this
//                 }
...
//                 var W = MainObject2.Doc.jFetch.call(this, "_EVENTS_");
//                 if (!W) {
//                     return this
//                 }
//                 for (var V in W) {
//                     MainObject2.Doc.jRemoveEvent.call(this, V)
//                 }
//                 MainObject2.Doc.jDel.call(this, "_EVENTS_");
//                 return this
//             }
//         });
//         (function(V) {
...
//             }
//         })(jsUnpack);
//         MainObject2.Class = function() {
//             var Z = null,
//                 W = MainObject2.$A(arguments);
//             if ("class" == MainObject2.jTypeOf(W[0])) {
//                 Z = W.shift()
//             }
//             var V = function() {
//                 for (var ac in this) {
//                     this[ac] = MainObject2.detach(this[ac])
//                 }
...
//                     for (var ad in ae) {
//                         var ab = ae[ad];
//                         switch (MainObject2.jTypeOf(ab)) {
//                             case "function":
//                                 this.$parent[ad] = MainObject2.Class.wrap(this, ab);
//                                 break;
//                             case "object":
//                                 this.$parent[ad] = MainObject2.detach(ab);
//                                 break;
//                             case "array":
//                                 this.$parent[ad] = MainObject2.detach(ab);
//                                 break
...
//             };
//             if (!V.prototype.init) {
//                 V.prototype.init = MainObject2.$F
//             }
//             if (Z) {
//                 var Y = function() {};
...
//                 V.$parent = null
//             }
//             V.constructor = MainObject2.Class;
//             V.prototype.constructor = V;
//             MainObject2.extend(V.prototype, W[0]);
//             MainObject2.extend(V, {
//                 $J_TYPE: "class"
//             });
//             return V;
//         };
//         jsUnpack.Class.wrap = function(V, W) {
//             return function() {
//                 var Y = this.caller;
...
//             }
//         })(jsUnpack);
//         MainObject2.Event.Custom.dbltap = new MainObject2.Class(MainObject2.extend(MainObject2.Event.Custom, {
//             type: "dbltap",
//             timedout: false,
//             tm: null,
//             init: function(W, V) {
...
//             }
//         }));
//         MainObject2.Event.Custom.dbltap.handler = {
//             options: {
//                 threshold: 300
//             },
//             add: function(V) {
//                 this.jStore("event:dbltap:options", MainObject2.extend(MainObject2.detach(MainObject2.Event.Custom.dbltap.handler.options), V || {}));
//                 this.jAddEvent("tap", MainObject2.Event.Custom.dbltap.handler.handle, 1)
//             },
//             jRemove: function() {
//                 this.jRemoveEvent("tap", MainObject2.Event.Custom.dbltap.handler.handle)
//             },
//             handle: function(X) {
//                 var W, V;
...
//                 if (!W) {
//                     W = new MainObject2.Event.Custom.dbltap(this, X);
//                     W.tm = setTimeout(function() {
//                         W.timedout = true;
//                         X.isQueueStopped = MainObject2.$false;
...
//             }
//         })(jsUnpack);
//         MainObject2.Event.Custom.touchpinch = new MainObject2.Class(MainObject2.extend(MainObject2.Event.Custom, {
//             type: "touchpinch",
//             scale: 1,
//             previousScale: 1,
//             curScale: 1,
...
//             }
//         }));
//         MainObject2.Event.Custom.touchpinch.handler = {
//             add: function() {
//                 this.jAddEvent("touchstart", MainObject2.Event.Custom.touchpinch.handler.handleTouchStart, 1);
//                 this.jAddEvent("touchend", MainObject2.Event.Custom.touchpinch.handler.handleTouchEnd, 1);
//                 this.jAddEvent("touchmove", MainObject2.Event.Custom.touchpinch.handler.handleTouchMove, 1)
//             },
//             jRemove: function() {
//                 this.jRemoveEvent("touchstart", MainObject2.Event.Custom.touchpinch.handler.handleTouchStart);
//                 this.jRemoveEvent("touchend", MainObject2.Event.Custom.touchpinch.handler.handleTouchEnd);
//                 this.jRemoveEvent("touchmove", MainObject2.Event.Custom.touchpinch.handler.handleTouchMove)
//             },
...
//                 }
//                 W.stopDefaults();
//                 V = new MainObject2.Event.Custom.touchpinch(this, W);
...
//         })(jsUnpack);
//         MainObject2.win = MainObject2.$(window);
//         MainObject2.doc = MainObject2.$(document);
//         return jsUnpack
//     })();
//     (function(H) {
//         if (!H) {
...
//                     continue
//                 }
//                 for (var order in F[t]) {
//                     if (order == "orders" || order == "function") {
//                         continue
//                     }
//                     for (var f in F[t][order]) {
...
//         k = j;
//     var o;
//     var p: () => string | string = function(): string {
//         return "mgctlbxN$MSC mgctlbxV$" + "v2.0.38".replace("v", "") + " mgctlbxL$" + "c".toUpperCase()
//             + ((window["mgctlbx$Pltm"] && "string" == v.jTypeOf(window["mgctlbx$Pltm"]))
...
//             var F = G.cloneNode();
//             var figure = document.createElement("figure"), figcaption = document.createElement("figcaption");
...
//                 G = parseInt(String(Math.abs(this.nextAngle / this.circle))),
//                 K, J, F = j(function(L) {
//                     while (G != 0) {
//                         G--;
//                         if (I <= 0) {
...
//                     if ((I = j(K).byTag("span")[0]) && "" !== I.innerHTML.trim()) {
//                         J = j(I.cloneNode(true)).jAddClass("mcs-caption");
//                         J.setAttribute("magic-user", "yes")
//                     } else {
//                         if (((G = F.nextSibling) && 3 == G.nodeType && "" !== G.nodeValue.trim()) || (I && (G = I.nextSibling) && 3 == G.nodeType && "" !== G.nodeValue.trim())) {
//                             J = v.$new("span", {
//                                 "class": "mcs-caption"
...
//                     return F;
//                 }
//                 F = new v.Scroll.Full(G, l ? { autostart: true } : {});
//                 if (!F.o("autostart")) {
//                     F = null;
//                     return false;
//                 }
...
//         }).jAppendTo(document.body);
//         v.defined(window["MagicScrollOptions"])
//             || (window["MagicScrollOptions"] = {});
//         v.defined(window["MagicScrollMobileOptions"])
//             || (window["MagicScrollMobileOptions"] = {});
//         v.defined(window["MagicScrollExtraOptions"])
//             || (window["MagicScrollExtraOptions"] = {});
//         v.defined(window["MagicScrollMobileExtraOptions"])
//             || (window["MagicScrollMobileExtraOptions"] = {});
//         var F = window["MagicScrollMobileExtraOptions"].beforeInit
//             || window["MagicScrollExtraOptions"].beforeInit
//             || window["MagicScrollMobileOptions"].beforeInit
//             || window["MagicScrollOptions"].beforeInit
//             || v.$F;
//         F();
//         q.start.jDelay(10)
//     });
