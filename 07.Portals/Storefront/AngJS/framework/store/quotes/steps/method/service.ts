/**
 * @file framework/store/quotes/steps/method/api.ts
...
module cef.store.quotes.steps.method {
    ...
    export class SubmitQuoteStepMethod extends SubmitQuoteStep {
        // Properties
        get name(): string { return this.cvServiceStrings.submitQuote.steps.method; }
        // Functions
        ...
        constructor(
            ...
            this.consoleDebug(`SubmitQuoteStepMethod.ctor()`);
        }
    }
}
