/**
 * @file framework/store/quotes/steps/confirmation/body.ts
...
module cef.store.quotes.steps.confirmation {
    ...
    class SubmitQuoteStepConfirmationBodyController extends core.TemplatedControllerBase {
        // Bound Scope Properties
        protected cartType: string;
        protected idSuffix: string;
        // Properties
        private get step(): SubmitQuoteStepConfirmation {
            if (!this.cartType
            ...
            return <SubmitQuoteStepConfirmation>
    ...
    cefApp.directive("cefSubmitQuoteStepConfirmationBody", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: { cartType: "@" },
        templateUrl: $filter("corsLink")("/framework/store/quotes/steps/confirmation/body.html", "ui"),
        controller: SubmitQuoteStepConfirmationBodyController,
