module cef.store.userDashboard.controls.orderRequests {
    class AddToOrderRequestButtonController extends core.TemplatedControllerBase {
    ...
    cefApp.directive("cefOrderRequestButton", ($filter: ng.IFilterService, $moment: any): ng.IDirective => ({
        restrict: "A",
        scope: {
            text: "@",
            product: "@",
        ...
        templateUrl: $filter("corsLink")("/framework/store/userDashboard/controls/orderRequests/addToOrderRequestButton.html", "ui"),
        controller: AddToOrderRequestButtonController,
        controllerAs: "orderRequestAddToButtonCtrl",
