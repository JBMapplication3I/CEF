module cef.store.userDashboard.controls.orderRequests {
    class OrderRequestsTableController extends core.TemplatedControllerBase {
    ...
    cefApp.directive("cefOrderRequestsTable", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: true,
        templateUrl: $filter("corsLink")("/framework/store/userDashboard/controls/orderRequests/orderRequestsTable.html", "ui"),
        controller: OrderRequestsTableController,
        controllerAs: "orderRequestsTableCtrl"
    }));
}
