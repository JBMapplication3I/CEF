module cef.store.userDashboard.controls.orderRequests {
    ...
    class AddToOrderRequestButtonCatalogController extends core.TemplatedControllerBase {
        ...
        onClick(): void {
            this.cvLoginModalFactory(null, null, false, true, this.cvServiceStrings.modalSizes.md).then(success => {
                ...
                this.$uibModal.open({
                    ...
                    templateUrl: this.$filter("corsLink")("/framework/store/userDashboard/controls/orderRequests/orderRequests.addTo.modal.html", "ui"),
    ...
    cefApp.directive("cefAddToOrderRequestCatalog", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: {
            text: "@",
            product: "@",
        ...
        templateUrl: $filter("corsLink")("/framework/store/userDashboard/controls/orderRequests/addToOrderRequestButtonCatalog.html", "ui"),
        controller: AddToOrderRequestButtonCatalogController,
        controllerAs: "orderRequestAddToButtonCatalogCtrl",
