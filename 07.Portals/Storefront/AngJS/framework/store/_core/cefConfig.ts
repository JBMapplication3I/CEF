module cef.store.core {
    ...
    export interface ISubmitQuoteStepConfig {
        show: boolean;
        showConditionally?: boolean;
        showButton: boolean;
        name: string;
    ...
    export interface ISubmitQuotePaymentMethodConfig {
        name: string;
        titleKey: string;
        order: number;
        templateURL: string;
        ...
        restrictedByAccountTypes?: string;
    }
    ...
    export interface ISubmitQuoteConfig {
        allowGuest: boolean;
        miniCart: ISimpleEnablableFeature;
        sections: { [name: string]: ISubmitQuoteStepConfig };
        paymentMethods: { [name: string]: ISubmitQuotePaymentMethodConfig };
        showSpecialInstructions: boolean;
    }
    ...
    export interface IFeatureSet {
        ...
        affiliates: ISimpleEnablableFeature;
        badges: ISimpleEnablableFeature;
        brands: {
            enabled: boolean;
            removeBrandCatalogSearchFilter: boolean;
        };
        ...
        carts: {
            ...
            shoppingLists: {
                enabled: boolean;
                assignNameToAndShowDisplayName: boolean;
            }
        ...
        manufacturers: ISimpleEnablableFeature;
        ...
        vendors: ISimpleEnablableFeature;
    }
    ...
    export interface CefConfig {
        ...
        routes: {
            ...
            cart: IUrlConfig;
            quoteCart: IUrlConfig;
            submitQuote: IUrlConfig;
        ...
        catalog: {
            ...
            /**
             * Search Catalog: Limits the number of top-level categories displayed in the catalog filter
             * accordion on the catalog.
             * @default 20
             * @type {number}
             */
            maxTopLevelCategoriesInFilter: number;
        };
        checkout: CheckoutConfig;
        purchase: IPurchaseConfig;
        submitQuote: ISubmitQuoteConfig;
        ...
        newUserRegister: {
            newUsersAreDefaultApproved: boolean;
            newUsersAreDefaultLockedOut: boolean;
        };
        /**
        ...
        addToQuoteCartModalDisabled: boolean;
        paymentHubEnabled: boolean;
        paymentHubHeaderEnabled: boolean;
        searchBarDisabled: boolean;
        headerProductsDisabled: boolean;
        headerBotDisabled: boolean;
