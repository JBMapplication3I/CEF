module cef.store.widgets.loadingWidget {
    ...
    cefApp.directive("cefLoadingWidget", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: {
            overlay: "=?",
            padIn: "=?",
        ...
        templateUrl: $filter("corsLink")("/framework/store/widgets/loadingWidget/loadingWidget.html", "ui"),
