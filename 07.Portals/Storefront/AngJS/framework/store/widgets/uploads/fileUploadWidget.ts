/**
 * @file framework/store/widgets/uploads/fileUploadWidget.ts
...
module cef.store.widgets.uploads {
    ...
    cefApp.directive("cefUploadFileWidget", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: {
            uploadType: "@",
            master: "=",
        ...
        templateUrl: $filter("corsLink")("/framework/store/widgets/uploads/fileUploadWidget.html", "ui"),
