/**
 * @file framework/store/widgets/forms/contact/_contactEditorControllerBase.ts
...
module cef.store.widgets.forms.contact {
    export abstract class ContactEditorControllerBase extends core.TemplatedControllerBase {
        ...
        runPhonePrefixLookups(): void {
            ...
            if (!this.cefConfig.featureSet.contacts.phonePrefixLookups.enabled // Don't use this
