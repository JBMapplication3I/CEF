/**
 * @file framework/store/widgets/forms/passwordInputFormGroup.ts
...
module cef.store.widgets.forms {
    class PasswordInputFormGroupController extends InputFormGroupControllerBase {
        ...
        get buttonTitleKey(): string {
            return 'ui.storefront.userDashboard2.controls.userProfile.'
        ...
        extraOnChange($event: ng.IAngularEvent): void {
            ...
            this.cvAuthenticationService.validatePasswordIsGood({ Password: this.control.$modelValue })
                .then(r => {
    ...
    cefApp.directive("passwordInputFormGroup", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "EA",
        scope: {
            // Base Properties
            formIdentifier: "@key",
        ...
        templateUrl: $filter("corsLink")("/framework/store/widgets/forms/passwordInputFormGroup.html", "ui"),
