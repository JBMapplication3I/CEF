/**
 * @file framework/store/widgets/forms/dateInputFormGroup.ts
...
module cef.store.widgets.forms {
    ...
    cefApp.directive("dateInputFormGroup", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "EA",
        scope: {
            // Base Properties
            formIdentifier: "@key",
        ...
        templateUrl: $filter("corsLink")("/framework/store/widgets/forms/dateInputFormGroup.html", "ui"),
