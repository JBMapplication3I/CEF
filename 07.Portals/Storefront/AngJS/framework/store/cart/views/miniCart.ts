/**
 * @file framework/store/cart/views/miniCart.ts
 * @author Cipyright (c) 2014-2021 clarity-ventures.com. All rights reserved.
 * @desc Mini-Cart class, normally shown on the checkout page
 */
module cef.store.cart.views {
    class MiniCartController extends CartController {
        // Bound by Scope
        ...
        private loadCart(cartType: string): void {
            ...
            this.cvCartService.loadCart(this.type, false, "miniCart.loadCart")
    ...
    cefApp.directive("cefMiniCart", ($filter: ng.IFilterService): ng.IDirective => ({
        restrict: "A",
        scope: {
            /**
             * The type of cart
        ...
        templateUrl: $filter("corsLink")("/framework/store/cart/views/miniCart.html", "ui"),
