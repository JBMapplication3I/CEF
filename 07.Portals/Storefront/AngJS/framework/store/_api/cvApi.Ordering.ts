/**
 * @file framework/store/_api/cvApi.Ordering.ts
...
module cef.store.api {
	...
	export interface UpdateOrderDto {
		FusionOrders: Array<FusionSalesOrder>;
	}
	/**
	 * Updates the order's status from Fusion.
	 * @public
	...
	export class Ordering extends ServiceStackRoute {
		 ...
		 * @public
		 */
		GetCurrentAccountSalesOrders = (routeParams?: GetCurrentAccountSalesOrdersDto) => this.$http<SalesOrderPagedResults>({
			url: [this.rootUrl, "Ordering", "CurrentAccount", "SalesOrders"].join("/"),
			method: "POST",
			data: routeParams
		});
		 ...
		 * @public
		 */
		GetCurrentStoreSalesOrders = (routeParams?: GetCurrentStoreSalesOrdersDto) => this.$http<SalesOrderPagedResults>({
			url: [this.rootUrl, "Ordering", "CurrentStore", "SalesOrders"].join("/"),
			method: "POST",
			data: routeParams
		});
		 ...
		 * @public
		 */
		GetCurrentUserSalesOrders = (routeParams?: GetCurrentUserSalesOrdersDto) => this.$http<SalesOrderPagedResults>({
			url: [this.rootUrl, "Ordering", "CurrentUser", "SalesOrders"].join("/"),
			method: "POST",
			data: routeParams
		});
		 ...
		 * @public
		 */
		GetSecureSalesOrder = (id: number) => this.$http<SalesOrderModel>({
			url: [this.rootUrl, "Ordering", "SecureSalesOrder", id].join("/"),
			method: "GET",
		});
		 ...
		 * @public
		 */
		GetSubscriptionBySalesOrderID = (routeParams?: GetSubscriptionBySalesOrderIDDto) => this.$http<SubscriptionModel>({
			url: [this.rootUrl, "Ordering", "SalesOrder", "Detail", "Subscription"].join("/"),
			method: "GET",
			params: routeParams
		});
		 ...
		 * @public
		 */
		GetSubscriptionHistoryBySubscriptionID = (routeParams: GetSubscriptionHistoryBySubscriptionIDDto) => this.$http<SubscriptionHistoryPagedResults>({
			url: [this.rootUrl, "Ordering", "SalesOrder", "Detail", "Subscription", "History"].join("/"),
			method: "POST",
			data: routeParams
		});
		...
		/**
		 * Updates the order's status from Fusion.
		 * @param {@link cef.store.api.UpdateOrderDto} routeParams - The route parameters as a Body Object
		 * @generatedByCSharpType Clarity.Clients.JBM.UpdateOrder
		 * @path <API Root>/Ordering/UpdateOrder
		 * @verb POST
		 * @returns {ng.IHttpPromise<CEFActionResponse>}
		 * @public
		 */
		UpdateOrder = (routeParams: UpdateOrderDto) => this.$http<CEFActionResponse>({
			url: [this.rootUrl, "Ordering", "UpdateOrder"].join("/"),
			method: "POST",
			data: routeParams
		});
		...
		/**
		 * Updates the order's status from Fusion.
		 * @param {@link cef.store.api.UpdateOrderStatusDto} routeParams - The route parameters as a Body Object
		 * @generatedByCSharpType Clarity.Clients.JBM.UpdateOrderStatus
		 * @path <API Root>/Ordering/UpdateOrderStatus
		 * @verb POST
		 * @returns {ng.IHttpPromise<CEFActionResponse>}
		 * @public
		 */
		UpdateOrderStatus = (routeParams: UpdateOrderStatusDto) => this.$http<CEFActionResponse>({
			url: [this.rootUrl, "Ordering", "UpdateOrderStatus"].join("/"),
			method: "POST",
			data: routeParams
		});
