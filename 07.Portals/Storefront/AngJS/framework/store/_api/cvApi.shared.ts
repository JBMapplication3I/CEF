/**
 * @file framework/store/_api/clarityEcomService_shared.ts
...
module cef.store.api {
    ...
    export interface SearchViewModelBase<TSearchForm extends SearchFormBase,TIndexModel extends IndexableModelBase> {
        ...
        HitsMetaDataHitScores?: cefalt.store.Dictionary<number>;

        /** Gets or sets the attributes. */
        Attributes: Array<KeyValuePair<string, Array<KeyValuePair<string, number | null>>>>;

        /** Gets or sets the brand IDs. */
        BrandIDs: cefalt.store.Dictionary<number | null>;

        /** Gets or sets the brand names. */
        BrandNames: cefalt.store.Dictionary<number | null>;

        /** Gets or sets the categories tree. */
        CategoriesTree: AggregateTree;

        /** Gets or sets the franchise IDs. */
        FranchiseIDs: cefalt.store.Dictionary<number | null>;

        /** Gets or sets the product IDs. */
        ProductIDs: cefalt.store.Dictionary<number | null>;

        /** Gets or sets the manufacturer IDs. */
        ManufacturerIDs: cefalt.store.Dictionary<number | null>;

        /** Gets or sets the store IDs. */
        StoreIDs: cefalt.store.Dictionary<number | null>;

        /** Gets or sets the type values. */
        Types: cefalt.store.Dictionary<IndexableTypeModel | null>;

        /** Gets or sets the vendor IDs. */
        VendorIDs: cefalt.store.Dictionary<number | null>;
    ...
    export interface AppliedDiscountBaseModel extends AmARelationshipTableBaseModel {
        DiscountID: number;
        DiscountKey?: string;
        DiscountName?: string;
    ...
    export interface ProductModel extends HasInventoryObject, HasPricingObject, HasRatingObject, HasSortOrderObject {
        $_rawPricesUOMs?: object;
    }
