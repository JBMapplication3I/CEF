...
namespace Clarity.Ecommerce.Service
{
    ...
    public static class ServiceAppCommonBrandAdmin
    {
        ...
        public static void Configure(ServiceStackHost appHost, Container container)
        {
            ...
            ClarityEcommerceServiceBase.CurrentAPIKind = Enums.APIKind.BrandAdmin;
        ...
        private static void SetupCORS(IAppHost appHost)
        {
            ...
            appHost.Plugins.Add(new CorsFeature(
                ...
                // ReSharper disable once StyleCop.SA1118
                allowOriginWhitelist: CEFConfigDictionary.ServiceStackOriginsWhiteList));
        }
