// <copyright file="ISalesEventBaseModel.cs" company="clarity-ventures.com">
// Copyright (c) 2022-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Declares the ISalesEventBaseModel interface</summary>
namespace Clarity.Ecommerce.MVC.Api.Models
{
    /// <summary>Interface for sales event base model.</summary>
    public interface ISalesEventBaseModel : INameableBaseModel, IHaveATypeBaseModel<ITypeModel>
    {
