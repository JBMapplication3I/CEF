// <copyright file="ServiceApplicationVendorAdmin.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the service application vendor admin class</summary>
#nullable enable
namespace Clarity.Ecommerce.Service
{
    ...
    /// <summary>A service application vendor admin.</summary>
    /// <seealso cref="ServiceApplication"/>
    [PublicAPI]
    public class ServiceApplicationVendorAdmin : ServiceApplication
    {
        private ServiceAppHostVendorAdmin serviceStackHost = null!;
        ...
        protected override void Application_Start()
        {
            ...
            /* Update to the latest migration on first initialization
             !!! Don't do this with vendor admin, let the admin API deal with it. Don't want more than one API trying to upgrade at the same time
        ...
        /// <summary>A service application host vendor admin.</summary>
        /// <seealso cref="ServiceApplication.ServiceAppHost"/>
        public class ServiceAppHostVendorAdmin : ServiceAppHost
        {
            /// <summary>Initializes a new instance of the <see cref="ServiceAppHostVendorAdmin"/> class.</summary>
            public ServiceAppHostVendorAdmin()
            ...
            public override void Configure(Funq.Container container)
            {
                ...
                ServiceAppCommonVendorAdmin.Configure(this, container);
            }
            ...
            protected void RegisterService(
                ...
                ServiceAppHostVendorAdmin appHost,
                ...
                Type serviceType)
            {
                ...
                foreach (var action in serviceType.GetActions())
                {
                    ...
                    if (!requestType.HasAttribute<UsedInVendorAdminAttribute>())
                    {
                        // Don't process endpoints not marked for use in vendor admin
                        continue;
                    }
