// <copyright file="ImplementsKeyOnBodyBase.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Service
{
    ...
    /// <summary>The implements identifier on the body of the request instead of the path.</summary>
    public abstract class ImplementsKeyOnBodyBase : IImplementsKeyBase
    {
