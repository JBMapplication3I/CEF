// <copyright file="ImplementsKeyBase.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Service
{
    ...
    /// <summary>The implements key.</summary>
    public class ImplementsKeyBase : IImplementsKeyBase
    {
        /// <summary>Gets or sets the key.</summary>
        /// <value>The key.</value>
        [ApiMember(Name = nameof(Key), DataType = "string", ParameterType = "path", IsRequired = true,
