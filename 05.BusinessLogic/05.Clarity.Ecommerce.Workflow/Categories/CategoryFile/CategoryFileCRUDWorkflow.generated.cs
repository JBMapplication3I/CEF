// <autogenerated>
// <copyright file="CategoryFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CategoryFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ICategoryFileModel, ICategoryFileSearchModel, ICategoryFile, CategoryFile}"/>
    /// <seealso cref="ICategoryFileWorkflow"/>
    public partial class CategoryFileWorkflow
        : NameableWorkflowBase<ICategoryFileModel, ICategoryFileSearchModel, ICategoryFile, CategoryFile>
            , ICategoryFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CategoryFile?, string?, ICategoryFileModel?> MapFromConcreteFull
            => ModelMapperForCategoryFile.MapCategoryFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CategoryFile>, string?, IEnumerable<ICategoryFileModel>> SelectLiteAndMapToModel
            => ModelMapperForCategoryFile.SelectLiteCategoryFileAndMapToCategoryFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CategoryFile>, string?, IEnumerable<ICategoryFileModel>> SelectListAndMapToModel
            => ModelMapperForCategoryFile.SelectListCategoryFileAndMapToCategoryFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CategoryFile>, string?, ICategoryFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCategoryFile.SelectFirstFullCategoryFileAndMapToCategoryFileModel;

        /// <inheritdoc/>
        protected override Func<ICategoryFile, ICategoryFileModel, DateTime, DateTime?, ICategoryFile> UpdateEntityFromModel
            => ModelMapperForCategoryFile.UpdateCategoryFileFromModel;
        #endregion
        ...
        {
            return await context.Set<CategoryFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<ICategoryFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<ICategoryFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<CategoryFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<CategoryFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<CategoryFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<CategoryFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<CategoryFile>> FilterQueryByModelExtensionAsync(
            IQueryable<CategoryFile> query,
            ICategoryFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCategoryFilesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ICategoryFile entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the CategoryFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the CategoryFile entity");
        }
