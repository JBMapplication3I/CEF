// <autogenerated>
// <copyright file="CategoryImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CategoryImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ICategoryImageModel, ICategoryImageSearchModel, ICategoryImage, CategoryImage}"/>
    /// <seealso cref="ICategoryImageWorkflow"/>
    public partial class CategoryImageWorkflow
        : NameableWorkflowBase<ICategoryImageModel, ICategoryImageSearchModel, ICategoryImage, CategoryImage>
            , ICategoryImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CategoryImage?, string?, ICategoryImageModel?> MapFromConcreteFull
            => ModelMapperForCategoryImage.MapCategoryImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CategoryImage>, string?, IEnumerable<ICategoryImageModel>> SelectLiteAndMapToModel
            => ModelMapperForCategoryImage.SelectLiteCategoryImageAndMapToCategoryImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CategoryImage>, string?, IEnumerable<ICategoryImageModel>> SelectListAndMapToModel
            => ModelMapperForCategoryImage.SelectListCategoryImageAndMapToCategoryImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CategoryImage>, string?, ICategoryImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCategoryImage.SelectFirstFullCategoryImageAndMapToCategoryImageModel;

        /// <inheritdoc/>
        protected override Func<ICategoryImage, ICategoryImageModel, DateTime, DateTime?, ICategoryImage> UpdateEntityFromModel
            => ModelMapperForCategoryImage.UpdateCategoryImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CategoryImage>> FilterQueryByModelExtensionAsync(
            IQueryable<CategoryImage> query,
            ICategoryImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCategoryImagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ICategoryImage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.CategoryImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateCategoryImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the CategoryImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (CategoryImageType)resolved.Result!.CreateCategoryImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the CategoryImage entity");
        }
