// <autogenerated>
// <copyright file="UiTranslationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for UiTranslation entities.</summary>
    /// <seealso cref="WorkflowBase{IUiTranslationModel, IUiTranslationSearchModel, IUiTranslation, UiTranslation}"/>
    /// <seealso cref="IUiTranslationWorkflow"/>
    public partial class UiTranslationWorkflow
        : WorkflowBase<IUiTranslationModel, IUiTranslationSearchModel, IUiTranslation, UiTranslation>
            , IUiTranslationWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<UiTranslation?, string?, IUiTranslationModel?> MapFromConcreteFull
            => ModelMapperForUiTranslation.MapUiTranslationModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<UiTranslation>, string?, IEnumerable<IUiTranslationModel>> SelectLiteAndMapToModel
            => ModelMapperForUiTranslation.SelectLiteUiTranslationAndMapToUiTranslationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UiTranslation>, string?, IEnumerable<IUiTranslationModel>> SelectListAndMapToModel
            => ModelMapperForUiTranslation.SelectListUiTranslationAndMapToUiTranslationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UiTranslation>, string?, IUiTranslationModel?> SelectFirstFullAndMapToModel
            => ModelMapperForUiTranslation.SelectFirstFullUiTranslationAndMapToUiTranslationModel;

        /// <inheritdoc/>
        protected override Func<IUiTranslation, IUiTranslationModel, DateTime, DateTime?, IUiTranslation> UpdateEntityFromModel
            => ModelMapperForUiTranslation.UpdateUiTranslationFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<UiTranslation>> FilterQueryByModelExtensionAsync(
        ...
        /// <summary>Relate Required UiKey.</summary>
        /// <exception cref="ArgumentNullException">Thrown when one or more required arguments are null.</exception>
        /// <param name="entity">            The entity that has a Required UiKey.</param>
        /// <param name="model">             The model that has a Required UiKey.</param>
        /// <param name="timestamp">         The timestamp Date/Time.</param>
        /// <param name="contextProfileName">Name of the context profile.</param>
        protected virtual async Task RelateRequiredUiKeyAsync(
            IUiTranslation entity,
            IUiTranslationModel model,
            DateTime timestamp,
            string? contextProfileName)
        {
            using var context = RegistryLoaderWrapper.GetContext(contextProfileName);
            await RelateRequiredUiKeyAsync(
                    entity,
                    model,
                    timestamp,
                    context)
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.UiKeys.ResolveWithAutoGenerateOptionalAsync(
                    byID: model.UiKeyID, // By Other ID
                    byKey: model.UiKeyKey, // By Flattened Other Key
                    model: model.UiKey, // The other property as a model
                    context: context)
                .ConfigureAwait(false);
            // Check for IDs and objects
            var entityIDIsNull = !Contract.CheckValidID(entity.UiKeyID);
            var modelIDIsNull = !Contract.CheckValidID(resolved.Result?.ID);
            var entityObjectIsNull = entity.UiKey == null;
            if (!resolved.ActionSucceeded && model.UiKey != null)
            {
                resolved.Result = model.UiKey;
            }
            ...
            if (modelIDIsNull && modelObjectIsNull)
            {
                ...
                throw new ArgumentException("Cannot assign a null to a non-nullable UiKeyID");
            }
            var entityIDAndModelIDHaveSameID = !entityIDIsNull && !modelIDIsNull && entity.UiKeyID == resolved.Result!.ID;
            var entityObjectAndModelObjectHaveSameID = !entityObjectIsNull && !modelObjectIsNull && entity.UiKeyID == resolved.Result!.ID;
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.UiKey!.UpdateUiKeyFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            {
                ...
                entity.UiKeyID = resolved.Result!.ID;
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive UiKeyID to the UiTranslation entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.UiKeyID = 0;
                entity.UiKey = (UiKey)resolved.Result!.CreateUiKeyEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given UiKey to the UiTranslation entity");
        }
...
#pragma warning restore 1998
            ...
            IClarityEcommerceEntities context)
        {
            ...
            await RelateRequiredUiKeyAsync(entity, model, timestamp, context).ConfigureAwait(false);
        }
