// <autogenerated>
// <copyright file="LanguageImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for LanguageImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ILanguageImageModel, ILanguageImageSearchModel, ILanguageImage, LanguageImage}"/>
    /// <seealso cref="ILanguageImageWorkflow"/>
    public partial class LanguageImageWorkflow
        : NameableWorkflowBase<ILanguageImageModel, ILanguageImageSearchModel, ILanguageImage, LanguageImage>
            , ILanguageImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<LanguageImage?, string?, ILanguageImageModel?> MapFromConcreteFull
            => ModelMapperForLanguageImage.MapLanguageImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<LanguageImage>, string?, IEnumerable<ILanguageImageModel>> SelectLiteAndMapToModel
            => ModelMapperForLanguageImage.SelectLiteLanguageImageAndMapToLanguageImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<LanguageImage>, string?, IEnumerable<ILanguageImageModel>> SelectListAndMapToModel
            => ModelMapperForLanguageImage.SelectListLanguageImageAndMapToLanguageImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<LanguageImage>, string?, ILanguageImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForLanguageImage.SelectFirstFullLanguageImageAndMapToLanguageImageModel;

        /// <inheritdoc/>
        protected override Func<ILanguageImage, ILanguageImageModel, DateTime, DateTime?, ILanguageImage> UpdateEntityFromModel
            => ModelMapperForLanguageImage.UpdateLanguageImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<LanguageImage>> FilterQueryByModelExtensionAsync(
            IQueryable<LanguageImage> query,
            ILanguageImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterLanguageImagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ILanguageImage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.LanguageImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateLanguageImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the LanguageImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (LanguageImageType)resolved.Result!.CreateLanguageImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the LanguageImage entity");
        }
