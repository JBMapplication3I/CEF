// <autogenerated>
// <copyright file="CurrencyImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CurrencyImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ICurrencyImageModel, ICurrencyImageSearchModel, ICurrencyImage, CurrencyImage}"/>
    /// <seealso cref="ICurrencyImageWorkflow"/>
    public partial class CurrencyImageWorkflow
        : NameableWorkflowBase<ICurrencyImageModel, ICurrencyImageSearchModel, ICurrencyImage, CurrencyImage>
            , ICurrencyImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CurrencyImage?, string?, ICurrencyImageModel?> MapFromConcreteFull
            => ModelMapperForCurrencyImage.MapCurrencyImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CurrencyImage>, string?, IEnumerable<ICurrencyImageModel>> SelectLiteAndMapToModel
            => ModelMapperForCurrencyImage.SelectLiteCurrencyImageAndMapToCurrencyImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CurrencyImage>, string?, IEnumerable<ICurrencyImageModel>> SelectListAndMapToModel
            => ModelMapperForCurrencyImage.SelectListCurrencyImageAndMapToCurrencyImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CurrencyImage>, string?, ICurrencyImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCurrencyImage.SelectFirstFullCurrencyImageAndMapToCurrencyImageModel;

        /// <inheritdoc/>
        protected override Func<ICurrencyImage, ICurrencyImageModel, DateTime, DateTime?, ICurrencyImage> UpdateEntityFromModel
            => ModelMapperForCurrencyImage.UpdateCurrencyImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CurrencyImage>> FilterQueryByModelExtensionAsync(
            IQueryable<CurrencyImage> query,
            ICurrencyImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCurrencyImagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ICurrencyImage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.CurrencyImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateCurrencyImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the CurrencyImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (CurrencyImageType)resolved.Result!.CreateCurrencyImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the CurrencyImage entity");
        }
