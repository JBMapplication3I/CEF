// <autogenerated>
// <copyright file="SalesReturnPaymentWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesReturnPayment entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesReturnPaymentModel, ISalesReturnPaymentSearchModel, ISalesReturnPayment, SalesReturnPayment}"/>
    /// <seealso cref="ISalesReturnPaymentWorkflow"/>
    public partial class SalesReturnPaymentWorkflow
        : WorkflowBase<ISalesReturnPaymentModel, ISalesReturnPaymentSearchModel, ISalesReturnPayment, SalesReturnPayment>
            , ISalesReturnPaymentWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesReturnPayment?, string?, ISalesReturnPaymentModel?> MapFromConcreteFull
            => ModelMapperForSalesReturnPayment.MapSalesReturnPaymentModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnPayment>, string?, IEnumerable<ISalesReturnPaymentModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesReturnPayment.SelectLiteSalesReturnPaymentAndMapToSalesReturnPaymentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnPayment>, string?, IEnumerable<ISalesReturnPaymentModel>> SelectListAndMapToModel
            => ModelMapperForSalesReturnPayment.SelectListSalesReturnPaymentAndMapToSalesReturnPaymentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnPayment>, string?, ISalesReturnPaymentModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesReturnPayment.SelectFirstFullSalesReturnPaymentAndMapToSalesReturnPaymentModel;

        /// <inheritdoc/>
        protected override Func<ISalesReturnPayment, ISalesReturnPaymentModel, DateTime, DateTime?, ISalesReturnPayment> UpdateEntityFromModel
            => ModelMapperForSalesReturnPayment.UpdateSalesReturnPaymentFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesReturnPayment>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesReturnPayment> query,
            ISalesReturnPaymentSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesReturnPaymentsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesReturnPayment entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesReturnPayment entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesReturnPayment entity");
        }
