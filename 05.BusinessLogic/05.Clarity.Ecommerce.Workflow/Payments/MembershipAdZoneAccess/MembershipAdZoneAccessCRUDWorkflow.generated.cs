// <autogenerated>
// <copyright file="MembershipAdZoneAccessWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for MembershipAdZoneAccess entities.</summary>
    /// <seealso cref="WorkflowBase{IMembershipAdZoneAccessModel, IMembershipAdZoneAccessSearchModel, IMembershipAdZoneAccess, MembershipAdZoneAccess}"/>
    /// <seealso cref="IMembershipAdZoneAccessWorkflow"/>
    public partial class MembershipAdZoneAccessWorkflow
        : WorkflowBase<IMembershipAdZoneAccessModel, IMembershipAdZoneAccessSearchModel, IMembershipAdZoneAccess, MembershipAdZoneAccess>
            , IMembershipAdZoneAccessWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<MembershipAdZoneAccess?, string?, IMembershipAdZoneAccessModel?> MapFromConcreteFull
            => ModelMapperForMembershipAdZoneAccess.MapMembershipAdZoneAccessModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<MembershipAdZoneAccess>, string?, IEnumerable<IMembershipAdZoneAccessModel>> SelectLiteAndMapToModel
            => ModelMapperForMembershipAdZoneAccess.SelectLiteMembershipAdZoneAccessAndMapToMembershipAdZoneAccessModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<MembershipAdZoneAccess>, string?, IEnumerable<IMembershipAdZoneAccessModel>> SelectListAndMapToModel
            => ModelMapperForMembershipAdZoneAccess.SelectListMembershipAdZoneAccessAndMapToMembershipAdZoneAccessModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<MembershipAdZoneAccess>, string?, IMembershipAdZoneAccessModel?> SelectFirstFullAndMapToModel
            => ModelMapperForMembershipAdZoneAccess.SelectFirstFullMembershipAdZoneAccessAndMapToMembershipAdZoneAccessModel;

        /// <inheritdoc/>
        protected override Func<IMembershipAdZoneAccess, IMembershipAdZoneAccessModel, DateTime, DateTime?, IMembershipAdZoneAccess> UpdateEntityFromModel
            => ModelMapperForMembershipAdZoneAccess.UpdateMembershipAdZoneAccessFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<MembershipAdZoneAccess>> FilterQueryByModelExtensionAsync(
            IQueryable<MembershipAdZoneAccess> query,
            IMembershipAdZoneAccessSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterMembershipAdZoneAccessesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IMembershipAdZoneAccess entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.MembershipAdZoneAccessByLevels != null) { await Workflows.MembershipAdZoneAccessWithMembershipAdZoneAccessByLevelsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Slave!.UpdateAdZoneAccessFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the MembershipAdZoneAccess entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.SlaveID = 0;
                entity.Slave = (AdZoneAccess)resolved.Result!.CreateAdZoneAccessEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the MembershipAdZoneAccess entity");
        }
