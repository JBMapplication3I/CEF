// <autogenerated>
// <copyright file="MembershipRepeatTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for MembershipRepeatType entities.</summary>
    /// <seealso cref="WorkflowBase{IMembershipRepeatTypeModel, IMembershipRepeatTypeSearchModel, IMembershipRepeatType, MembershipRepeatType}"/>
    /// <seealso cref="IMembershipRepeatTypeWorkflow"/>
    public partial class MembershipRepeatTypeWorkflow
        : WorkflowBase<IMembershipRepeatTypeModel, IMembershipRepeatTypeSearchModel, IMembershipRepeatType, MembershipRepeatType>
            , IMembershipRepeatTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<MembershipRepeatType?, string?, IMembershipRepeatTypeModel?> MapFromConcreteFull
            => ModelMapperForMembershipRepeatType.MapMembershipRepeatTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<MembershipRepeatType>, string?, IEnumerable<IMembershipRepeatTypeModel>> SelectLiteAndMapToModel
            => ModelMapperForMembershipRepeatType.SelectLiteMembershipRepeatTypeAndMapToMembershipRepeatTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<MembershipRepeatType>, string?, IEnumerable<IMembershipRepeatTypeModel>> SelectListAndMapToModel
            => ModelMapperForMembershipRepeatType.SelectListMembershipRepeatTypeAndMapToMembershipRepeatTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<MembershipRepeatType>, string?, IMembershipRepeatTypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForMembershipRepeatType.SelectFirstFullMembershipRepeatTypeAndMapToMembershipRepeatTypeModel;

        /// <inheritdoc/>
        protected override Func<IMembershipRepeatType, IMembershipRepeatTypeModel, DateTime, DateTime?, IMembershipRepeatType> UpdateEntityFromModel
            => ModelMapperForMembershipRepeatType.UpdateMembershipRepeatTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<MembershipRepeatType>> FilterQueryByModelExtensionAsync(
            IQueryable<MembershipRepeatType> query,
            IMembershipRepeatTypeSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterMembershipRepeatTypesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IMembershipRepeatType entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the MembershipRepeatType entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the MembershipRepeatType entity");
        }
