// <autogenerated>
// <copyright file="SalesOrderPaymentWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderPayment entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesOrderPaymentModel, ISalesOrderPaymentSearchModel, ISalesOrderPayment, SalesOrderPayment}"/>
    /// <seealso cref="ISalesOrderPaymentWorkflow"/>
    public partial class SalesOrderPaymentWorkflow
        : WorkflowBase<ISalesOrderPaymentModel, ISalesOrderPaymentSearchModel, ISalesOrderPayment, SalesOrderPayment>
            , ISalesOrderPaymentWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderPayment?, string?, ISalesOrderPaymentModel?> MapFromConcreteFull
            => ModelMapperForSalesOrderPayment.MapSalesOrderPaymentModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderPayment>, string?, IEnumerable<ISalesOrderPaymentModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderPayment.SelectLiteSalesOrderPaymentAndMapToSalesOrderPaymentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderPayment>, string?, IEnumerable<ISalesOrderPaymentModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrderPayment.SelectListSalesOrderPaymentAndMapToSalesOrderPaymentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderPayment>, string?, ISalesOrderPaymentModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderPayment.SelectFirstFullSalesOrderPaymentAndMapToSalesOrderPaymentModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderPayment, ISalesOrderPaymentModel, DateTime, DateTime?, ISalesOrderPayment> UpdateEntityFromModel
            => ModelMapperForSalesOrderPayment.UpdateSalesOrderPaymentFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderPayment>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesOrderPayment> query,
            ISalesOrderPaymentSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderPaymentsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesOrderPayment entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesOrderPayment entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesOrderPayment entity");
        }
