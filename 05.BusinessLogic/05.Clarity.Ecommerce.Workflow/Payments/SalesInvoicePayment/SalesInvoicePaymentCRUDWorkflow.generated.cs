// <autogenerated>
// <copyright file="SalesInvoicePaymentWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesInvoicePayment entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesInvoicePaymentModel, ISalesInvoicePaymentSearchModel, ISalesInvoicePayment, SalesInvoicePayment}"/>
    /// <seealso cref="ISalesInvoicePaymentWorkflow"/>
    public partial class SalesInvoicePaymentWorkflow
        : WorkflowBase<ISalesInvoicePaymentModel, ISalesInvoicePaymentSearchModel, ISalesInvoicePayment, SalesInvoicePayment>
            , ISalesInvoicePaymentWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesInvoicePayment?, string?, ISalesInvoicePaymentModel?> MapFromConcreteFull
            => ModelMapperForSalesInvoicePayment.MapSalesInvoicePaymentModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoicePayment>, string?, IEnumerable<ISalesInvoicePaymentModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesInvoicePayment.SelectLiteSalesInvoicePaymentAndMapToSalesInvoicePaymentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoicePayment>, string?, IEnumerable<ISalesInvoicePaymentModel>> SelectListAndMapToModel
            => ModelMapperForSalesInvoicePayment.SelectListSalesInvoicePaymentAndMapToSalesInvoicePaymentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoicePayment>, string?, ISalesInvoicePaymentModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesInvoicePayment.SelectFirstFullSalesInvoicePaymentAndMapToSalesInvoicePaymentModel;

        /// <inheritdoc/>
        protected override Func<ISalesInvoicePayment, ISalesInvoicePaymentModel, DateTime, DateTime?, ISalesInvoicePayment> UpdateEntityFromModel
            => ModelMapperForSalesInvoicePayment.UpdateSalesInvoicePaymentFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesInvoicePayment>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesInvoicePayment> query,
            ISalesInvoicePaymentSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesInvoicePaymentsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesInvoicePayment entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesInvoicePayment entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesInvoicePayment entity");
        }
