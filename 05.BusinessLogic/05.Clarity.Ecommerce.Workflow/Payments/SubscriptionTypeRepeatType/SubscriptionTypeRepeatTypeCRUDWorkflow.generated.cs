// <autogenerated>
// <copyright file="SubscriptionTypeRepeatTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SubscriptionTypeRepeatType entities.</summary>
    /// <seealso cref="WorkflowBase{ISubscriptionTypeRepeatTypeModel, ISubscriptionTypeRepeatTypeSearchModel, ISubscriptionTypeRepeatType, SubscriptionTypeRepeatType}"/>
    /// <seealso cref="ISubscriptionTypeRepeatTypeWorkflow"/>
    public partial class SubscriptionTypeRepeatTypeWorkflow
        : WorkflowBase<ISubscriptionTypeRepeatTypeModel, ISubscriptionTypeRepeatTypeSearchModel, ISubscriptionTypeRepeatType, SubscriptionTypeRepeatType>
            , ISubscriptionTypeRepeatTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SubscriptionTypeRepeatType?, string?, ISubscriptionTypeRepeatTypeModel?> MapFromConcreteFull
            => ModelMapperForSubscriptionTypeRepeatType.MapSubscriptionTypeRepeatTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SubscriptionTypeRepeatType>, string?, IEnumerable<ISubscriptionTypeRepeatTypeModel>> SelectLiteAndMapToModel
            => ModelMapperForSubscriptionTypeRepeatType.SelectLiteSubscriptionTypeRepeatTypeAndMapToSubscriptionTypeRepeatTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SubscriptionTypeRepeatType>, string?, IEnumerable<ISubscriptionTypeRepeatTypeModel>> SelectListAndMapToModel
            => ModelMapperForSubscriptionTypeRepeatType.SelectListSubscriptionTypeRepeatTypeAndMapToSubscriptionTypeRepeatTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SubscriptionTypeRepeatType>, string?, ISubscriptionTypeRepeatTypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSubscriptionTypeRepeatType.SelectFirstFullSubscriptionTypeRepeatTypeAndMapToSubscriptionTypeRepeatTypeModel;

        /// <inheritdoc/>
        protected override Func<ISubscriptionTypeRepeatType, ISubscriptionTypeRepeatTypeModel, DateTime, DateTime?, ISubscriptionTypeRepeatType> UpdateEntityFromModel
            => ModelMapperForSubscriptionTypeRepeatType.UpdateSubscriptionTypeRepeatTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SubscriptionTypeRepeatType>> FilterQueryByModelExtensionAsync(
            IQueryable<SubscriptionTypeRepeatType> query,
            ISubscriptionTypeRepeatTypeSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSubscriptionTypeRepeatTypesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISubscriptionTypeRepeatType entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Slave!.UpdateRepeatTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SubscriptionTypeRepeatType entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.SlaveID = 0;
                entity.Slave = (RepeatType)resolved.Result!.CreateRepeatTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SubscriptionTypeRepeatType entity");
        }
