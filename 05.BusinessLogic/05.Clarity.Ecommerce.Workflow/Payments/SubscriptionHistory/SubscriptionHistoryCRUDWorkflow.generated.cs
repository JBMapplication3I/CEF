// <autogenerated>
// <copyright file="SubscriptionHistoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SubscriptionHistory entities.</summary>
    /// <seealso cref="WorkflowBase{ISubscriptionHistoryModel, ISubscriptionHistorySearchModel, ISubscriptionHistory, SubscriptionHistory}"/>
    /// <seealso cref="ISubscriptionHistoryWorkflow"/>
    public partial class SubscriptionHistoryWorkflow
        : WorkflowBase<ISubscriptionHistoryModel, ISubscriptionHistorySearchModel, ISubscriptionHistory, SubscriptionHistory>
            , ISubscriptionHistoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SubscriptionHistory?, string?, ISubscriptionHistoryModel?> MapFromConcreteFull
            => ModelMapperForSubscriptionHistory.MapSubscriptionHistoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SubscriptionHistory>, string?, IEnumerable<ISubscriptionHistoryModel>> SelectLiteAndMapToModel
            => ModelMapperForSubscriptionHistory.SelectLiteSubscriptionHistoryAndMapToSubscriptionHistoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SubscriptionHistory>, string?, IEnumerable<ISubscriptionHistoryModel>> SelectListAndMapToModel
            => ModelMapperForSubscriptionHistory.SelectListSubscriptionHistoryAndMapToSubscriptionHistoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SubscriptionHistory>, string?, ISubscriptionHistoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSubscriptionHistory.SelectFirstFullSubscriptionHistoryAndMapToSubscriptionHistoryModel;

        /// <inheritdoc/>
        protected override Func<ISubscriptionHistory, ISubscriptionHistoryModel, DateTime, DateTime?, ISubscriptionHistory> UpdateEntityFromModel
            => ModelMapperForSubscriptionHistory.UpdateSubscriptionHistoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SubscriptionHistory>> FilterQueryByModelExtensionAsync(
            IQueryable<SubscriptionHistory> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSubscriptionHistoriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISubscriptionHistory entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Subscriptions.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateSubscriptionFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the SubscriptionHistory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the SubscriptionHistory entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Payments.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdatePaymentFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SubscriptionHistory entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (Payment)resolved.Result!.CreatePaymentEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SubscriptionHistory entity");
        }
