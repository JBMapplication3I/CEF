// <autogenerated>
// <copyright file="SalesQuoteFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesQuoteFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesQuoteFileModel, ISalesQuoteFileSearchModel, ISalesQuoteFile, SalesQuoteFile}"/>
    /// <seealso cref="ISalesQuoteFileWorkflow"/>
    public partial class SalesQuoteFileWorkflow
        : NameableWorkflowBase<ISalesQuoteFileModel, ISalesQuoteFileSearchModel, ISalesQuoteFile, SalesQuoteFile>
            , ISalesQuoteFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesQuoteFile?, string?, ISalesQuoteFileModel?> MapFromConcreteFull
            => ModelMapperForSalesQuoteFile.MapSalesQuoteFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteFile>, string?, IEnumerable<ISalesQuoteFileModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesQuoteFile.SelectLiteSalesQuoteFileAndMapToSalesQuoteFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteFile>, string?, IEnumerable<ISalesQuoteFileModel>> SelectListAndMapToModel
            => ModelMapperForSalesQuoteFile.SelectListSalesQuoteFileAndMapToSalesQuoteFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteFile>, string?, ISalesQuoteFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesQuoteFile.SelectFirstFullSalesQuoteFileAndMapToSalesQuoteFileModel;

        /// <inheritdoc/>
        protected override Func<ISalesQuoteFile, ISalesQuoteFileModel, DateTime, DateTime?, ISalesQuoteFile> UpdateEntityFromModel
            => ModelMapperForSalesQuoteFile.UpdateSalesQuoteFileFromModel;
        #endregion
        ...
        {
            return await context.Set<SalesQuoteFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<ISalesQuoteFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<ISalesQuoteFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<SalesQuoteFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<SalesQuoteFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<SalesQuoteFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<SalesQuoteFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesQuoteFile>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesQuoteFile> query,
            ISalesQuoteFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesQuoteFilesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesQuoteFile entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesQuoteFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesQuoteFile entity");
        }
