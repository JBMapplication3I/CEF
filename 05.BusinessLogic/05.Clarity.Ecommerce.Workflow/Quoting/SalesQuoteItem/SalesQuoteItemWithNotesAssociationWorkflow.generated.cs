// <autogenerated>
// <copyright file="SalesQuoteItemWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Quote Item Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesQuoteItem, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesQuoteItemWithNotesAssociationWorkflow"/>
    public partial class SalesQuoteItemWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>, ISalesQuoteItem, INoteModel, INote, Note>
        , ISalesQuoteItemWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesQuoteItem entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel> model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesQuoteItem entity, INote newEntity)
        {
