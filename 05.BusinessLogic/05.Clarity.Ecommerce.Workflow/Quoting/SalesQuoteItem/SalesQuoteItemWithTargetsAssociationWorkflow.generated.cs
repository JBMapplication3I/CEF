// <autogenerated>
// <copyright file="SalesQuoteItemWithTargetsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Quote Item Targets association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesQuoteItem, ISalesItemTargetBaseModel, ISalesQuoteItemTarget, SalesQuoteItemTarget}"/>
    /// <seealso cref="ISalesQuoteItemWithTargetsAssociationWorkflow"/>
    public partial class SalesQuoteItemWithTargetsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>, ISalesQuoteItem, ISalesItemTargetBaseModel, ISalesQuoteItemTarget, SalesQuoteItemTarget>
        , ISalesQuoteItemWithTargetsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SalesQuoteItemTarget>? GetObjectsCollection(ISalesQuoteItem entity) { return entity.Targets; }

        /// <inheritdoc/>
        protected override List<ISalesItemTargetBaseModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel> model) { return model.Targets; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesQuoteItem entity, ISalesQuoteItemTarget newEntity)
        {
            if (newEntity == null) { return; }
            entity.Targets!.Add((SalesQuoteItemTarget)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(ISalesQuoteItem entity)
        {
            ...
            entity.Targets = new HashSet<SalesQuoteItemTarget>();
        }

        /// <inheritdoc/>
        protected override async Task DeactivateObjectAsync(ISalesQuoteItemTarget entity, DateTime timestamp)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<bool> MatchObjectModelWithObjectEntityAsync(ISalesItemTargetBaseModel model, ISalesQuoteItemTarget entity, IClarityEcommerceEntities context)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<ISalesQuoteItemTarget> ModelToNewObjectAsync(
            ...
            var thisEntityTypeID = Contract.CheckValidID(model.TypeID)
                ...
                : model.Type != null && Contract.CheckValidID(model.Type.ID)
                    ...
                    : UpsertThisEntityTypeAndGetID(
                        ...
                        timestamp,
                        context);
            if (thisEntityTypeID <= 0) { throw new ArgumentException("SalesQuoteItemTarget requires a valid Type."); }
            // Create a new entity and populate it with data
            var newEntity = model.CreateSalesQuoteItemTargetEntity(timestamp, context.ContextProfileName);
