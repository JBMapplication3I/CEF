// <autogenerated>
// <copyright file="SalesQuoteItemWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesQuoteItem entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesItemBaseModel, ISalesItemBaseSearchModel, ISalesQuoteItem, SalesQuoteItem}"/>
    /// <seealso cref="ISalesQuoteItemWorkflow"/>
    public partial class SalesQuoteItemWorkflow
        : NameableWorkflowBase<ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>, ISalesItemBaseSearchModel, ISalesQuoteItem, SalesQuoteItem>
            , ISalesQuoteItemWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesQuoteItem?, string?, ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>?> MapFromConcreteFull
            => ModelMapperForSalesQuoteItem.MapSalesQuoteItemModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>>> SelectLiteAndMapToModel
            => ModelMapperForSalesQuoteItem.SelectLiteSalesQuoteItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>>> SelectListAndMapToModel
            => ModelMapperForSalesQuoteItem.SelectListSalesQuoteItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteItem>, string?, ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesQuoteItem.SelectFirstFullSalesQuoteItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<ISalesQuoteItem, ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>, DateTime, DateTime?, ISalesQuoteItem> UpdateEntityFromModel
            => ModelMapperForSalesQuoteItem.UpdateSalesQuoteItemFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesQuoteItem>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesQuoteItem> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesQuoteItemsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Targets != null) { await Workflows.SalesQuoteItemWithTargetsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.SalesQuoteItemID = entity.ID;
                    }
                }
                await Workflows.SalesQuoteItemWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Product to the SalesQuoteItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SalesQuoteItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given OriginalCurrency to the SalesQuoteItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SellingCurrency to the SalesQuoteItem entity");
        }
