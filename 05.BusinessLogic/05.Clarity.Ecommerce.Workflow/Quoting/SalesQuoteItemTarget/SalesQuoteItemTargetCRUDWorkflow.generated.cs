// <autogenerated>
// <copyright file="SalesQuoteItemTargetWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesQuoteItemTarget entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ISalesQuoteItemTarget, SalesQuoteItemTarget}"/>
    /// <seealso cref="ISalesQuoteItemTargetWorkflow"/>
    public partial class SalesQuoteItemTargetWorkflow
        : WorkflowBase<ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ISalesQuoteItemTarget, SalesQuoteItemTarget>
            , ISalesQuoteItemTargetWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesQuoteItemTarget?, string?, ISalesItemTargetBaseModel?> MapFromConcreteFull
            => ModelMapperForSalesQuoteItemTarget.MapSalesQuoteItemTargetModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesQuoteItemTarget.SelectLiteSalesQuoteItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectListAndMapToModel
            => ModelMapperForSalesQuoteItemTarget.SelectListSalesQuoteItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteItemTarget>, string?, ISalesItemTargetBaseModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesQuoteItemTarget.SelectFirstFullSalesQuoteItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<ISalesQuoteItemTarget, ISalesItemTargetBaseModel, DateTime, DateTime?, ISalesQuoteItemTarget> UpdateEntityFromModel
            => ModelMapperForSalesQuoteItemTarget.UpdateSalesQuoteItemTargetFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesQuoteItemTarget>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesQuoteItemTarget> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesQuoteItemTargetsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesQuoteItemTarget entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SalesQuoteItemTarget entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SalesQuoteItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive DestinationContactID to the SalesQuoteItemTarget entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given DestinationContact to the SalesQuoteItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BrandProduct to the SalesQuoteItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SelectedRateQuote to the SalesQuoteItemTarget entity");
        }
