// <autogenerated>
// <copyright file="SalesQuoteCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesQuoteCategory entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesQuoteCategoryModel, ISalesQuoteCategorySearchModel, ISalesQuoteCategory, SalesQuoteCategory}"/>
    /// <seealso cref="ISalesQuoteCategoryWorkflow"/>
    public partial class SalesQuoteCategoryWorkflow
        : WorkflowBase<ISalesQuoteCategoryModel, ISalesQuoteCategorySearchModel, ISalesQuoteCategory, SalesQuoteCategory>
            , ISalesQuoteCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesQuoteCategory?, string?, ISalesQuoteCategoryModel?> MapFromConcreteFull
            => ModelMapperForSalesQuoteCategory.MapSalesQuoteCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteCategory>, string?, IEnumerable<ISalesQuoteCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesQuoteCategory.SelectLiteSalesQuoteCategoryAndMapToSalesQuoteCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteCategory>, string?, IEnumerable<ISalesQuoteCategoryModel>> SelectListAndMapToModel
            => ModelMapperForSalesQuoteCategory.SelectListSalesQuoteCategoryAndMapToSalesQuoteCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteCategory>, string?, ISalesQuoteCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesQuoteCategory.SelectFirstFullSalesQuoteCategoryAndMapToSalesQuoteCategoryModel;

        /// <inheritdoc/>
        protected override Func<ISalesQuoteCategory, ISalesQuoteCategoryModel, DateTime, DateTime?, ISalesQuoteCategory> UpdateEntityFromModel
            => ModelMapperForSalesQuoteCategory.UpdateSalesQuoteCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesQuoteCategory>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesQuoteCategory> query,
            ISalesQuoteCategorySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesQuoteCategoriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesQuoteCategory entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesQuoteCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesQuoteCategory entity");
        }
