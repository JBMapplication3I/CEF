// <autogenerated>
// <copyright file="SalesQuoteSalesOrderWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesQuoteSalesOrder entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesQuoteSalesOrderModel, ISalesQuoteSalesOrderSearchModel, ISalesQuoteSalesOrder, SalesQuoteSalesOrder}"/>
    /// <seealso cref="ISalesQuoteSalesOrderWorkflow"/>
    public partial class SalesQuoteSalesOrderWorkflow
        : WorkflowBase<ISalesQuoteSalesOrderModel, ISalesQuoteSalesOrderSearchModel, ISalesQuoteSalesOrder, SalesQuoteSalesOrder>
            , ISalesQuoteSalesOrderWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesQuoteSalesOrder?, string?, ISalesQuoteSalesOrderModel?> MapFromConcreteFull
            => ModelMapperForSalesQuoteSalesOrder.MapSalesQuoteSalesOrderModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteSalesOrder>, string?, IEnumerable<ISalesQuoteSalesOrderModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesQuoteSalesOrder.SelectLiteSalesQuoteSalesOrderAndMapToSalesQuoteSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteSalesOrder>, string?, IEnumerable<ISalesQuoteSalesOrderModel>> SelectListAndMapToModel
            => ModelMapperForSalesQuoteSalesOrder.SelectListSalesQuoteSalesOrderAndMapToSalesQuoteSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteSalesOrder>, string?, ISalesQuoteSalesOrderModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesQuoteSalesOrder.SelectFirstFullSalesQuoteSalesOrderAndMapToSalesQuoteSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<ISalesQuoteSalesOrder, ISalesQuoteSalesOrderModel, DateTime, DateTime?, ISalesQuoteSalesOrder> UpdateEntityFromModel
            => ModelMapperForSalesQuoteSalesOrder.UpdateSalesQuoteSalesOrderFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesQuoteSalesOrder>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesQuoteSalesOrder> query,
            ISalesQuoteSalesOrderSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesQuoteSalesOrdersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesQuoteSalesOrder entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesQuotes.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateSalesQuoteFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the SalesQuoteSalesOrder entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the SalesQuoteSalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesQuoteSalesOrder entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesQuoteSalesOrder entity");
        }
