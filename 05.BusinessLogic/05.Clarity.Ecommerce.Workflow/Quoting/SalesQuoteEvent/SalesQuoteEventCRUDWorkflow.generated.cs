// <autogenerated>
// <copyright file="SalesQuoteEventWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesQuoteEvent entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesQuoteEventModel, ISalesQuoteEventSearchModel, ISalesQuoteEvent, SalesQuoteEvent}"/>
    /// <seealso cref="ISalesQuoteEventWorkflow"/>
    public partial class SalesQuoteEventWorkflow
        : NameableWorkflowBase<ISalesQuoteEventModel, ISalesQuoteEventSearchModel, ISalesQuoteEvent, SalesQuoteEvent>
            , ISalesQuoteEventWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesQuoteEvent?, string?, ISalesQuoteEventModel?> MapFromConcreteFull
            => ModelMapperForSalesQuoteEvent.MapSalesQuoteEventModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteEvent>, string?, IEnumerable<ISalesQuoteEventModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesQuoteEvent.SelectLiteSalesQuoteEventAndMapToSalesQuoteEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteEvent>, string?, IEnumerable<ISalesQuoteEventModel>> SelectListAndMapToModel
            => ModelMapperForSalesQuoteEvent.SelectListSalesQuoteEventAndMapToSalesQuoteEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesQuoteEvent>, string?, ISalesQuoteEventModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesQuoteEvent.SelectFirstFullSalesQuoteEventAndMapToSalesQuoteEventModel;

        /// <inheritdoc/>
        protected override Func<ISalesQuoteEvent, ISalesQuoteEventModel, DateTime, DateTime?, ISalesQuoteEvent> UpdateEntityFromModel
            => ModelMapperForSalesQuoteEvent.UpdateSalesQuoteEventFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesQuoteEvent>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesQuoteEvent> query,
            ISalesQuoteEventSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesQuoteEventsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesQuoteEvent entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesQuoteEventTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateSalesQuoteEventTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SalesQuoteEvent entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (SalesQuoteEventType)resolved.Result!.CreateSalesQuoteEventTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SalesQuoteEvent entity");
        }
