// <autogenerated>
// <copyright file="SalesQuoteWithRateQuotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Quote Rate Quotes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesQuoteModel, ISalesQuote, IRateQuoteModel, IRateQuote, RateQuote}"/>
    /// <seealso cref="ISalesQuoteWithRateQuotesAssociationWorkflow"/>
    public partial class SalesQuoteWithRateQuotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesQuoteModel, ISalesQuote, IRateQuoteModel, IRateQuote, RateQuote>
        , ISalesQuoteWithRateQuotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<RateQuote>? GetObjectsCollection(ISalesQuote entity) { return entity.RateQuotes; }

        /// <inheritdoc/>
        protected override List<IRateQuoteModel>? GetModelObjectsList(ISalesQuoteModel model) { return model.RateQuotes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesQuote entity, IRateQuote newEntity)
        {
