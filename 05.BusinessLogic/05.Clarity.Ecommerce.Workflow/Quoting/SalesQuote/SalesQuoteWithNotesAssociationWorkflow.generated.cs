// <autogenerated>
// <copyright file="SalesQuoteWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Quote Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesQuoteModel, ISalesQuote, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesQuoteWithNotesAssociationWorkflow"/>
    public partial class SalesQuoteWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesQuoteModel, ISalesQuote, INoteModel, INote, Note>
        , ISalesQuoteWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesQuote entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesQuoteModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesQuote entity, INote newEntity)
        {
