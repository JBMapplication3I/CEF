// <copyright file="DiscountWithCountriesAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2018-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate discount countries workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    {
        /// <inheritdoc/>
        protected override bool ValidateObjectModelIsGoodForDatabaseAdditionalChecks(IDiscountCountryModel model)
        {
            // Must have something to recognize the Country by
            ...
            IClarityEcommerceEntities context)
        {
            Contract.Requires<InvalidOperationException>(
                ...
                "Must pass either the Country ID, Key or Name to match against");
            newEntity.SlaveID = await Workflows.Countries.ResolveToIDAsync(
                    byID: model.SlaveID,
