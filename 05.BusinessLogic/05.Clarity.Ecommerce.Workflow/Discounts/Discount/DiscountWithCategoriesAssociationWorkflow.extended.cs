// <copyright file="DiscountWithCategoriesAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2018-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate discount categories workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class DiscountWithCategoriesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override bool ValidateObjectModelIsGoodForDatabaseAdditionalChecks(IDiscountCategoryModel model)
        {
            ...
            IClarityEcommerceEntities context)
        {
            ...
            newEntity.SlaveID = await Workflows.Categories.ResolveToIDAsync(
                    byID: model.SlaveID,
