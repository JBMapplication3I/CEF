// <copyright file="DiscountWithProductsAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2018-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate discount products workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class DiscountWithProductsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override bool ValidateObjectModelIsGoodForDatabaseAdditionalChecks(IDiscountProductModel model)
        {
