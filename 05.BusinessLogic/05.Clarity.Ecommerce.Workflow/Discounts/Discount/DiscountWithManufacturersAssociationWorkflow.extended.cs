// <copyright file="DiscountWithManufacturersAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2018-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate discount manufacturers workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class DiscountWithManufacturersAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override bool ValidateObjectModelIsGoodForDatabaseAdditionalChecks(IDiscountManufacturerModel model)
        {
        ...
        protected override async Task ModelToNewObjectAdditionalPropertiesAsync(
            IDiscountManufacturer newEntity,
            IDiscountManufacturerModel model,
            DateTime timestamp,
            IClarityEcommerceEntities context)
        {
