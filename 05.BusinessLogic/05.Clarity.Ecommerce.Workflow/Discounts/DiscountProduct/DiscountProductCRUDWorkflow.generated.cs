// <autogenerated>
// <copyright file="DiscountProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DiscountProduct entities.</summary>
    /// <seealso cref="WorkflowBase{IDiscountProductModel, IDiscountProductSearchModel, IDiscountProduct, DiscountProduct}"/>
    /// <seealso cref="IDiscountProductWorkflow"/>
    public partial class DiscountProductWorkflow
        : WorkflowBase<IDiscountProductModel, IDiscountProductSearchModel, IDiscountProduct, DiscountProduct>
            , IDiscountProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DiscountProduct?, string?, IDiscountProductModel?> MapFromConcreteFull
            => ModelMapperForDiscountProduct.MapDiscountProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountProduct>, string?, IEnumerable<IDiscountProductModel>> SelectLiteAndMapToModel
            => ModelMapperForDiscountProduct.SelectLiteDiscountProductAndMapToDiscountProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountProduct>, string?, IEnumerable<IDiscountProductModel>> SelectListAndMapToModel
            => ModelMapperForDiscountProduct.SelectListDiscountProductAndMapToDiscountProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountProduct>, string?, IDiscountProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDiscountProduct.SelectFirstFullDiscountProductAndMapToDiscountProductModel;

        /// <inheritdoc/>
        protected override Func<IDiscountProduct, IDiscountProductModel, DateTime, DateTime?, IDiscountProduct> UpdateEntityFromModel
            => ModelMapperForDiscountProduct.UpdateDiscountProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DiscountProduct>> FilterQueryByModelExtensionAsync(
            IQueryable<DiscountProduct> query,
            IDiscountProductSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDiscountProductsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DiscountProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DiscountProduct entity");
        }
