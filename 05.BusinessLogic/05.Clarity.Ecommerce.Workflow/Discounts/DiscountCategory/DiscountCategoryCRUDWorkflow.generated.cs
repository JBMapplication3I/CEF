// <autogenerated>
// <copyright file="DiscountCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DiscountCategory entities.</summary>
    /// <seealso cref="WorkflowBase{IDiscountCategoryModel, IDiscountCategorySearchModel, IDiscountCategory, DiscountCategory}"/>
    /// <seealso cref="IDiscountCategoryWorkflow"/>
    public partial class DiscountCategoryWorkflow
        : WorkflowBase<IDiscountCategoryModel, IDiscountCategorySearchModel, IDiscountCategory, DiscountCategory>
            , IDiscountCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DiscountCategory?, string?, IDiscountCategoryModel?> MapFromConcreteFull
            => ModelMapperForDiscountCategory.MapDiscountCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountCategory>, string?, IEnumerable<IDiscountCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForDiscountCategory.SelectLiteDiscountCategoryAndMapToDiscountCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountCategory>, string?, IEnumerable<IDiscountCategoryModel>> SelectListAndMapToModel
            => ModelMapperForDiscountCategory.SelectListDiscountCategoryAndMapToDiscountCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountCategory>, string?, IDiscountCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDiscountCategory.SelectFirstFullDiscountCategoryAndMapToDiscountCategoryModel;

        /// <inheritdoc/>
        protected override Func<IDiscountCategory, IDiscountCategoryModel, DateTime, DateTime?, IDiscountCategory> UpdateEntityFromModel
            => ModelMapperForDiscountCategory.UpdateDiscountCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DiscountCategory>> FilterQueryByModelExtensionAsync(
            IQueryable<DiscountCategory> query,
            IDiscountCategorySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDiscountCategoriesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DiscountCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DiscountCategory entity");
        }
