// <autogenerated>
// <copyright file="DiscountAccountWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DiscountAccount entities.</summary>
    /// <seealso cref="WorkflowBase{IDiscountAccountModel, IDiscountAccountSearchModel, IDiscountAccount, DiscountAccount}"/>
    /// <seealso cref="IDiscountAccountWorkflow"/>
    public partial class DiscountAccountWorkflow
        : WorkflowBase<IDiscountAccountModel, IDiscountAccountSearchModel, IDiscountAccount, DiscountAccount>
            , IDiscountAccountWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DiscountAccount?, string?, IDiscountAccountModel?> MapFromConcreteFull
            => ModelMapperForDiscountAccount.MapDiscountAccountModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountAccount>, string?, IEnumerable<IDiscountAccountModel>> SelectLiteAndMapToModel
            => ModelMapperForDiscountAccount.SelectLiteDiscountAccountAndMapToDiscountAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountAccount>, string?, IEnumerable<IDiscountAccountModel>> SelectListAndMapToModel
            => ModelMapperForDiscountAccount.SelectListDiscountAccountAndMapToDiscountAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountAccount>, string?, IDiscountAccountModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDiscountAccount.SelectFirstFullDiscountAccountAndMapToDiscountAccountModel;

        /// <inheritdoc/>
        protected override Func<IDiscountAccount, IDiscountAccountModel, DateTime, DateTime?, IDiscountAccount> UpdateEntityFromModel
            => ModelMapperForDiscountAccount.UpdateDiscountAccountFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DiscountAccount>> FilterQueryByModelExtensionAsync(
            IQueryable<DiscountAccount> query,
            IDiscountAccountSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDiscountAccountsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DiscountAccount entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DiscountAccount entity");
        }
