// <autogenerated>
// <copyright file="DiscountBrandWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DiscountBrand entities.</summary>
    /// <seealso cref="WorkflowBase{IDiscountBrandModel, IDiscountBrandSearchModel, IDiscountBrand, DiscountBrand}"/>
    /// <seealso cref="IDiscountBrandWorkflow"/>
    public partial class DiscountBrandWorkflow
        : WorkflowBase<IDiscountBrandModel, IDiscountBrandSearchModel, IDiscountBrand, DiscountBrand>
            , IDiscountBrandWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DiscountBrand?, string?, IDiscountBrandModel?> MapFromConcreteFull
            => ModelMapperForDiscountBrand.MapDiscountBrandModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountBrand>, string?, IEnumerable<IDiscountBrandModel>> SelectLiteAndMapToModel
            => ModelMapperForDiscountBrand.SelectLiteDiscountBrandAndMapToDiscountBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountBrand>, string?, IEnumerable<IDiscountBrandModel>> SelectListAndMapToModel
            => ModelMapperForDiscountBrand.SelectListDiscountBrandAndMapToDiscountBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountBrand>, string?, IDiscountBrandModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDiscountBrand.SelectFirstFullDiscountBrandAndMapToDiscountBrandModel;

        /// <inheritdoc/>
        protected override Func<IDiscountBrand, IDiscountBrandModel, DateTime, DateTime?, IDiscountBrand> UpdateEntityFromModel
            => ModelMapperForDiscountBrand.UpdateDiscountBrandFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DiscountBrand>> FilterQueryByModelExtensionAsync(
            IQueryable<DiscountBrand> query,
            IDiscountBrandSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDiscountBrandsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IDiscountBrand entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DiscountBrand entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DiscountBrand entity");
        }
