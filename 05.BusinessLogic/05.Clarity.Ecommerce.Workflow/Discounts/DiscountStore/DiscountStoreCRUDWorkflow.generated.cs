// <autogenerated>
// <copyright file="DiscountStoreWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DiscountStore entities.</summary>
    /// <seealso cref="WorkflowBase{IDiscountStoreModel, IDiscountStoreSearchModel, IDiscountStore, DiscountStore}"/>
    /// <seealso cref="IDiscountStoreWorkflow"/>
    public partial class DiscountStoreWorkflow
        : WorkflowBase<IDiscountStoreModel, IDiscountStoreSearchModel, IDiscountStore, DiscountStore>
            , IDiscountStoreWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DiscountStore?, string?, IDiscountStoreModel?> MapFromConcreteFull
            => ModelMapperForDiscountStore.MapDiscountStoreModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountStore>, string?, IEnumerable<IDiscountStoreModel>> SelectLiteAndMapToModel
            => ModelMapperForDiscountStore.SelectLiteDiscountStoreAndMapToDiscountStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountStore>, string?, IEnumerable<IDiscountStoreModel>> SelectListAndMapToModel
            => ModelMapperForDiscountStore.SelectListDiscountStoreAndMapToDiscountStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountStore>, string?, IDiscountStoreModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDiscountStore.SelectFirstFullDiscountStoreAndMapToDiscountStoreModel;

        /// <inheritdoc/>
        protected override Func<IDiscountStore, IDiscountStoreModel, DateTime, DateTime?, IDiscountStore> UpdateEntityFromModel
            => ModelMapperForDiscountStore.UpdateDiscountStoreFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DiscountStore>> FilterQueryByModelExtensionAsync(
            IQueryable<DiscountStore> query,
            IDiscountStoreSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDiscountStoresBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DiscountStore entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DiscountStore entity");
        }
