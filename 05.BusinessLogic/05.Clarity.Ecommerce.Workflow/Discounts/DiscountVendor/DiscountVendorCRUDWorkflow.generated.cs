// <autogenerated>
// <copyright file="DiscountVendorWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DiscountVendor entities.</summary>
    /// <seealso cref="WorkflowBase{IDiscountVendorModel, IDiscountVendorSearchModel, IDiscountVendor, DiscountVendor}"/>
    /// <seealso cref="IDiscountVendorWorkflow"/>
    public partial class DiscountVendorWorkflow
        : WorkflowBase<IDiscountVendorModel, IDiscountVendorSearchModel, IDiscountVendor, DiscountVendor>
            , IDiscountVendorWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DiscountVendor?, string?, IDiscountVendorModel?> MapFromConcreteFull
            => ModelMapperForDiscountVendor.MapDiscountVendorModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountVendor>, string?, IEnumerable<IDiscountVendorModel>> SelectLiteAndMapToModel
            => ModelMapperForDiscountVendor.SelectLiteDiscountVendorAndMapToDiscountVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountVendor>, string?, IEnumerable<IDiscountVendorModel>> SelectListAndMapToModel
            => ModelMapperForDiscountVendor.SelectListDiscountVendorAndMapToDiscountVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountVendor>, string?, IDiscountVendorModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDiscountVendor.SelectFirstFullDiscountVendorAndMapToDiscountVendorModel;

        /// <inheritdoc/>
        protected override Func<IDiscountVendor, IDiscountVendorModel, DateTime, DateTime?, IDiscountVendor> UpdateEntityFromModel
            => ModelMapperForDiscountVendor.UpdateDiscountVendorFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DiscountVendor>> FilterQueryByModelExtensionAsync(
            IQueryable<DiscountVendor> query,
            IDiscountVendorSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDiscountVendorsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DiscountVendor entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DiscountVendor entity");
        }
