// <autogenerated>
// <copyright file="DiscountUserWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DiscountUser entities.</summary>
    /// <seealso cref="WorkflowBase{IDiscountUserModel, IDiscountUserSearchModel, IDiscountUser, DiscountUser}"/>
    /// <seealso cref="IDiscountUserWorkflow"/>
    public partial class DiscountUserWorkflow
        : WorkflowBase<IDiscountUserModel, IDiscountUserSearchModel, IDiscountUser, DiscountUser>
            , IDiscountUserWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DiscountUser?, string?, IDiscountUserModel?> MapFromConcreteFull
            => ModelMapperForDiscountUser.MapDiscountUserModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountUser>, string?, IEnumerable<IDiscountUserModel>> SelectLiteAndMapToModel
            => ModelMapperForDiscountUser.SelectLiteDiscountUserAndMapToDiscountUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountUser>, string?, IEnumerable<IDiscountUserModel>> SelectListAndMapToModel
            => ModelMapperForDiscountUser.SelectListDiscountUserAndMapToDiscountUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DiscountUser>, string?, IDiscountUserModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDiscountUser.SelectFirstFullDiscountUserAndMapToDiscountUserModel;

        /// <inheritdoc/>
        protected override Func<IDiscountUser, IDiscountUserModel, DateTime, DateTime?, IDiscountUser> UpdateEntityFromModel
            => ModelMapperForDiscountUser.UpdateDiscountUserFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DiscountUser>> FilterQueryByModelExtensionAsync(
            IQueryable<DiscountUser> query,
            IDiscountUserSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDiscountUsersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DiscountUser entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DiscountUser entity");
        }
