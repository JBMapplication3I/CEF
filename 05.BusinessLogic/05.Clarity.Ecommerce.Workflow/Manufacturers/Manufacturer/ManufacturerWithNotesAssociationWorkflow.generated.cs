// <autogenerated>
// <copyright file="ManufacturerWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Manufacturer Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IManufacturerModel, IManufacturer, INoteModel, INote, Note}"/>
    /// <seealso cref="IManufacturerWithNotesAssociationWorkflow"/>
    public partial class ManufacturerWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<IManufacturerModel, IManufacturer, INoteModel, INote, Note>
        , IManufacturerWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IManufacturer entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(IManufacturerModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IManufacturer entity, INote newEntity)
        {
