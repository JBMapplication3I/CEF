// <autogenerated>
// <copyright file="ManufacturerWithVendorsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Manufacturer Vendors association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IManufacturerModel, IManufacturer, IVendorManufacturerModel, IVendorManufacturer, VendorManufacturer}"/>
    /// <seealso cref="IManufacturerWithVendorsAssociationWorkflow"/>
    public partial class ManufacturerWithVendorsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<IManufacturerModel, IManufacturer, IVendorManufacturerModel, IVendorManufacturer, VendorManufacturer>
        , IManufacturerWithVendorsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<VendorManufacturer>? GetObjectsCollection(IManufacturer entity) { return entity.Vendors; }

        /// <inheritdoc/>
        protected override List<IVendorManufacturerModel>? GetModelObjectsList(IManufacturerModel model) { return model.Vendors; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IManufacturer entity, IVendorManufacturer newEntity)
        {
            if (newEntity == null) { return; }
            entity.Vendors!.Add((VendorManufacturer)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(IManufacturer entity)
        {
            ...
            entity.Vendors = new HashSet<VendorManufacturer>();
        }
