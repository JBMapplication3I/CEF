// <autogenerated>
// <copyright file="ManufacturerWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for Manufacturer entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IManufacturerModel, IManufacturerSearchModel, IManufacturer, Manufacturer}"/>
    /// <seealso cref="IManufacturerWorkflow"/>
    public partial class ManufacturerWorkflow
        : NameableWorkflowBase<IManufacturerModel, IManufacturerSearchModel, IManufacturer, Manufacturer>
            , IManufacturerWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<Manufacturer?, string?, IManufacturerModel?> MapFromConcreteFull
            => ModelMapperForManufacturer.MapManufacturerModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<Manufacturer>, string?, IEnumerable<IManufacturerModel>> SelectLiteAndMapToModel
            => ModelMapperForManufacturer.SelectLiteManufacturerAndMapToManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Manufacturer>, string?, IEnumerable<IManufacturerModel>> SelectListAndMapToModel
            => ModelMapperForManufacturer.SelectListManufacturerAndMapToManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Manufacturer>, string?, IManufacturerModel?> SelectFirstFullAndMapToModel
            => ModelMapperForManufacturer.SelectFirstFullManufacturerAndMapToManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IManufacturer, IManufacturerModel, DateTime, DateTime?, IManufacturer> UpdateEntityFromModel
            => ModelMapperForManufacturer.UpdateManufacturerFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<Manufacturer>> FilterQueryByModelExtensionAsync(
            IQueryable<Manufacturer> query,
            IManufacturerSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterManufacturersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.ManufacturerID = entity.ID;
                    }
                }
                await Workflows.ManufacturerWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
            if (model.Images != null) { await Workflows.ManufacturerWithImagesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            if (model.Products != null) { await Workflows.ManufacturerWithProductsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: Stores
            if (model.Vendors != null) { await Workflows.ManufacturerWithVendorsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.ManufacturerTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateManufacturerTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the Manufacturer entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (ManufacturerType)resolved.Result!.CreateManufacturerTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Contact to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderDollarAmountBufferProduct to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderQuantityAmountBufferProduct to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderDollarAmountBufferCategory to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderQuantityAmountBufferCategory to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingDollarAmountBufferProduct to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingQuantityAmountBufferProduct to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingDollarAmountBufferCategory to the Manufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingQuantityAmountBufferCategory to the Manufacturer entity");
        }
