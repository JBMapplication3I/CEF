// <autogenerated>
// <copyright file="ManufacturerProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for ManufacturerProduct entities.</summary>
    /// <seealso cref="WorkflowBase{IManufacturerProductModel, IManufacturerProductSearchModel, IManufacturerProduct, ManufacturerProduct}"/>
    /// <seealso cref="IManufacturerProductWorkflow"/>
    public partial class ManufacturerProductWorkflow
        : WorkflowBase<IManufacturerProductModel, IManufacturerProductSearchModel, IManufacturerProduct, ManufacturerProduct>
            , IManufacturerProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<ManufacturerProduct?, string?, IManufacturerProductModel?> MapFromConcreteFull
            => ModelMapperForManufacturerProduct.MapManufacturerProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<ManufacturerProduct>, string?, IEnumerable<IManufacturerProductModel>> SelectLiteAndMapToModel
            => ModelMapperForManufacturerProduct.SelectLiteManufacturerProductAndMapToManufacturerProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ManufacturerProduct>, string?, IEnumerable<IManufacturerProductModel>> SelectListAndMapToModel
            => ModelMapperForManufacturerProduct.SelectListManufacturerProductAndMapToManufacturerProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ManufacturerProduct>, string?, IManufacturerProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForManufacturerProduct.SelectFirstFullManufacturerProductAndMapToManufacturerProductModel;

        /// <inheritdoc/>
        protected override Func<IManufacturerProduct, IManufacturerProductModel, DateTime, DateTime?, IManufacturerProduct> UpdateEntityFromModel
            => ModelMapperForManufacturerProduct.UpdateManufacturerProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<ManufacturerProduct>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterManufacturerProductsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IManufacturerProduct entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateManufacturerFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the ManufacturerProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the ManufacturerProduct entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the ManufacturerProduct entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the ManufacturerProduct entity");
        }
