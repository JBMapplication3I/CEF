// <autogenerated>
// <copyright file="ProductCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for ProductCategory entities.</summary>
    /// <seealso cref="WorkflowBase{IProductCategoryModel, IProductCategorySearchModel, IProductCategory, ProductCategory}"/>
    /// <seealso cref="IProductCategoryWorkflow"/>
    public partial class ProductCategoryWorkflow
        : WorkflowBase<IProductCategoryModel, IProductCategorySearchModel, IProductCategory, ProductCategory>
            , IProductCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<ProductCategory?, string?, IProductCategoryModel?> MapFromConcreteFull
            => ModelMapperForProductCategory.MapProductCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductCategory>, string?, IEnumerable<IProductCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForProductCategory.SelectLiteProductCategoryAndMapToProductCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductCategory>, string?, IEnumerable<IProductCategoryModel>> SelectListAndMapToModel
            => ModelMapperForProductCategory.SelectListProductCategoryAndMapToProductCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductCategory>, string?, IProductCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForProductCategory.SelectFirstFullProductCategoryAndMapToProductCategoryModel;

        /// <inheritdoc/>
        protected override Func<IProductCategory, IProductCategoryModel, DateTime, DateTime?, IProductCategory> UpdateEntityFromModel
            => ModelMapperForProductCategory.UpdateProductCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<ProductCategory>> FilterQueryByModelExtensionAsync(
            IQueryable<ProductCategory> query,
            IProductCategorySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterProductCategoriesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the ProductCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the ProductCategory entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the ProductCategory entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the ProductCategory entity");
        }
