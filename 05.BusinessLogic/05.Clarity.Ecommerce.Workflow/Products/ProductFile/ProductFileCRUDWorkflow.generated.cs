// <autogenerated>
// <copyright file="ProductFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for ProductFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IProductFileModel, IProductFileSearchModel, IProductFile, ProductFile}"/>
    /// <seealso cref="IProductFileWorkflow"/>
    public partial class ProductFileWorkflow
        : NameableWorkflowBase<IProductFileModel, IProductFileSearchModel, IProductFile, ProductFile>
            , IProductFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<ProductFile?, string?, IProductFileModel?> MapFromConcreteFull
            => ModelMapperForProductFile.MapProductFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductFile>, string?, IEnumerable<IProductFileModel>> SelectLiteAndMapToModel
            => ModelMapperForProductFile.SelectLiteProductFileAndMapToProductFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductFile>, string?, IEnumerable<IProductFileModel>> SelectListAndMapToModel
            => ModelMapperForProductFile.SelectListProductFileAndMapToProductFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductFile>, string?, IProductFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForProductFile.SelectFirstFullProductFileAndMapToProductFileModel;

        /// <inheritdoc/>
        protected override Func<IProductFile, IProductFileModel, DateTime, DateTime?, IProductFile> UpdateEntityFromModel
            => ModelMapperForProductFile.UpdateProductFileFromModel;
        #endregion
        ...
        /// <inheritdoc/>
        public virtual async Task<IProductFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<IProductFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<ProductFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<ProductFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<ProductFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<ProductFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<ProductFile>> FilterQueryByModelExtensionAsync(
            IQueryable<ProductFile> query,
            IProductFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterProductFilesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the ProductFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the ProductFile entity");
        }
