// <autogenerated>
// <copyright file="ProductInventoryLocationSectionWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for ProductInventoryLocationSection entities.</summary>
    /// <seealso cref="WorkflowBase{IProductInventoryLocationSectionModel, IProductInventoryLocationSectionSearchModel, IProductInventoryLocationSection, ProductInventoryLocationSection}"/>
    /// <seealso cref="IProductInventoryLocationSectionWorkflow"/>
    public partial class ProductInventoryLocationSectionWorkflow
        : WorkflowBase<IProductInventoryLocationSectionModel, IProductInventoryLocationSectionSearchModel, IProductInventoryLocationSection, ProductInventoryLocationSection>
            , IProductInventoryLocationSectionWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<ProductInventoryLocationSection?, string?, IProductInventoryLocationSectionModel?> MapFromConcreteFull
            => ModelMapperForProductInventoryLocationSection.MapProductInventoryLocationSectionModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductInventoryLocationSection>, string?, IEnumerable<IProductInventoryLocationSectionModel>> SelectLiteAndMapToModel
            => ModelMapperForProductInventoryLocationSection.SelectLiteProductInventoryLocationSectionAndMapToProductInventoryLocationSectionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductInventoryLocationSection>, string?, IEnumerable<IProductInventoryLocationSectionModel>> SelectListAndMapToModel
            => ModelMapperForProductInventoryLocationSection.SelectListProductInventoryLocationSectionAndMapToProductInventoryLocationSectionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductInventoryLocationSection>, string?, IProductInventoryLocationSectionModel?> SelectFirstFullAndMapToModel
            => ModelMapperForProductInventoryLocationSection.SelectFirstFullProductInventoryLocationSectionAndMapToProductInventoryLocationSectionModel;

        /// <inheritdoc/>
        protected override Func<IProductInventoryLocationSection, IProductInventoryLocationSectionModel, DateTime, DateTime?, IProductInventoryLocationSection> UpdateEntityFromModel
            => ModelMapperForProductInventoryLocationSection.UpdateProductInventoryLocationSectionFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<ProductInventoryLocationSection>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterProductInventoryLocationSectionsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the ProductInventoryLocationSection entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the ProductInventoryLocationSection entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.InventoryLocationSections.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateInventoryLocationSectionFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the ProductInventoryLocationSection entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (InventoryLocationSection)resolved.Result!.CreateInventoryLocationSectionEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the ProductInventoryLocationSection entity");
        }
