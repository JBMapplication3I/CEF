// <autogenerated>
// <copyright file="ProductShipCarrierMethodWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for ProductShipCarrierMethod entities.</summary>
    /// <seealso cref="WorkflowBase{IProductShipCarrierMethodModel, IProductShipCarrierMethodSearchModel, IProductShipCarrierMethod, ProductShipCarrierMethod}"/>
    /// <seealso cref="IProductShipCarrierMethodWorkflow"/>
    public partial class ProductShipCarrierMethodWorkflow
        : WorkflowBase<IProductShipCarrierMethodModel, IProductShipCarrierMethodSearchModel, IProductShipCarrierMethod, ProductShipCarrierMethod>
            , IProductShipCarrierMethodWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<ProductShipCarrierMethod?, string?, IProductShipCarrierMethodModel?> MapFromConcreteFull
            => ModelMapperForProductShipCarrierMethod.MapProductShipCarrierMethodModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductShipCarrierMethod>, string?, IEnumerable<IProductShipCarrierMethodModel>> SelectLiteAndMapToModel
            => ModelMapperForProductShipCarrierMethod.SelectLiteProductShipCarrierMethodAndMapToProductShipCarrierMethodModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductShipCarrierMethod>, string?, IEnumerable<IProductShipCarrierMethodModel>> SelectListAndMapToModel
            => ModelMapperForProductShipCarrierMethod.SelectListProductShipCarrierMethodAndMapToProductShipCarrierMethodModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ProductShipCarrierMethod>, string?, IProductShipCarrierMethodModel?> SelectFirstFullAndMapToModel
            => ModelMapperForProductShipCarrierMethod.SelectFirstFullProductShipCarrierMethodAndMapToProductShipCarrierMethodModel;

        /// <inheritdoc/>
        protected override Func<IProductShipCarrierMethod, IProductShipCarrierMethodModel, DateTime, DateTime?, IProductShipCarrierMethod> UpdateEntityFromModel
            => ModelMapperForProductShipCarrierMethod.UpdateProductShipCarrierMethodFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<ProductShipCarrierMethod>> FilterQueryByModelExtensionAsync(
            IQueryable<ProductShipCarrierMethod> query,
            IProductShipCarrierMethodSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterProductShipCarrierMethodsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IProductShipCarrierMethod entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the ProductShipCarrierMethod entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the ProductShipCarrierMethod entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the ProductShipCarrierMethod entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (ShipCarrierMethod)resolved.Result!.CreateShipCarrierMethodEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the ProductShipCarrierMethod entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the ProductShipCarrierMethod entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the ProductShipCarrierMethod entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Currency to the ProductShipCarrierMethod entity");
        }
