// <autogenerated>
// <copyright file="ScheduledJobConfigurationSettingWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for ScheduledJobConfigurationSetting entities.</summary>
    /// <seealso cref="WorkflowBase{IScheduledJobConfigurationSettingModel, IScheduledJobConfigurationSettingSearchModel, IScheduledJobConfigurationSetting, ScheduledJobConfigurationSetting}"/>
    /// <seealso cref="IScheduledJobConfigurationSettingWorkflow"/>
    public partial class ScheduledJobConfigurationSettingWorkflow
        : WorkflowBase<IScheduledJobConfigurationSettingModel, IScheduledJobConfigurationSettingSearchModel, IScheduledJobConfigurationSetting, ScheduledJobConfigurationSetting>
            , IScheduledJobConfigurationSettingWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<ScheduledJobConfigurationSetting?, string?, IScheduledJobConfigurationSettingModel?> MapFromConcreteFull
            => ModelMapperForScheduledJobConfigurationSetting.MapScheduledJobConfigurationSettingModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<ScheduledJobConfigurationSetting>, string?, IEnumerable<IScheduledJobConfigurationSettingModel>> SelectLiteAndMapToModel
            => ModelMapperForScheduledJobConfigurationSetting.SelectLiteScheduledJobConfigurationSettingAndMapToScheduledJobConfigurationSettingModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ScheduledJobConfigurationSetting>, string?, IEnumerable<IScheduledJobConfigurationSettingModel>> SelectListAndMapToModel
            => ModelMapperForScheduledJobConfigurationSetting.SelectListScheduledJobConfigurationSettingAndMapToScheduledJobConfigurationSettingModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ScheduledJobConfigurationSetting>, string?, IScheduledJobConfigurationSettingModel?> SelectFirstFullAndMapToModel
            => ModelMapperForScheduledJobConfigurationSetting.SelectFirstFullScheduledJobConfigurationSettingAndMapToScheduledJobConfigurationSettingModel;

        /// <inheritdoc/>
        protected override Func<IScheduledJobConfigurationSetting, IScheduledJobConfigurationSettingModel, DateTime, DateTime?, IScheduledJobConfigurationSetting> UpdateEntityFromModel
            => ModelMapperForScheduledJobConfigurationSetting.UpdateScheduledJobConfigurationSettingFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<ScheduledJobConfigurationSetting>> FilterQueryByModelExtensionAsync(
            IQueryable<ScheduledJobConfigurationSetting> query,
            IScheduledJobConfigurationSettingSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterScheduledJobConfigurationSettingsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.ScheduledJobConfigurations.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateScheduledJobConfigurationFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the ScheduledJobConfigurationSetting entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the ScheduledJobConfigurationSetting entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Settings.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateSettingFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the ScheduledJobConfigurationSetting entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (Setting)resolved.Result!.CreateSettingEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the ScheduledJobConfigurationSetting entity");
        }
