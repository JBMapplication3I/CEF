// <autogenerated>
// <copyright file="DistrictLanguageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DistrictLanguage entities.</summary>
    /// <seealso cref="WorkflowBase{IDistrictLanguageModel, IDistrictLanguageSearchModel, IDistrictLanguage, DistrictLanguage}"/>
    /// <seealso cref="IDistrictLanguageWorkflow"/>
    public partial class DistrictLanguageWorkflow
        : WorkflowBase<IDistrictLanguageModel, IDistrictLanguageSearchModel, IDistrictLanguage, DistrictLanguage>
            , IDistrictLanguageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DistrictLanguage?, string?, IDistrictLanguageModel?> MapFromConcreteFull
            => ModelMapperForDistrictLanguage.MapDistrictLanguageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DistrictLanguage>, string?, IEnumerable<IDistrictLanguageModel>> SelectLiteAndMapToModel
            => ModelMapperForDistrictLanguage.SelectLiteDistrictLanguageAndMapToDistrictLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DistrictLanguage>, string?, IEnumerable<IDistrictLanguageModel>> SelectListAndMapToModel
            => ModelMapperForDistrictLanguage.SelectListDistrictLanguageAndMapToDistrictLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DistrictLanguage>, string?, IDistrictLanguageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDistrictLanguage.SelectFirstFullDistrictLanguageAndMapToDistrictLanguageModel;

        /// <inheritdoc/>
        protected override Func<IDistrictLanguage, IDistrictLanguageModel, DateTime, DateTime?, IDistrictLanguage> UpdateEntityFromModel
            => ModelMapperForDistrictLanguage.UpdateDistrictLanguageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DistrictLanguage>> FilterQueryByModelExtensionAsync(
            IQueryable<DistrictLanguage> query,
            IDistrictLanguageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDistrictLanguagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IDistrictLanguage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DistrictLanguage entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DistrictLanguage entity");
        }
