// <autogenerated>
// <copyright file="RegionImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for RegionImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IRegionImageModel, IRegionImageSearchModel, IRegionImage, RegionImage}"/>
    /// <seealso cref="IRegionImageWorkflow"/>
    public partial class RegionImageWorkflow
        : NameableWorkflowBase<IRegionImageModel, IRegionImageSearchModel, IRegionImage, RegionImage>
            , IRegionImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<RegionImage?, string?, IRegionImageModel?> MapFromConcreteFull
            => ModelMapperForRegionImage.MapRegionImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<RegionImage>, string?, IEnumerable<IRegionImageModel>> SelectLiteAndMapToModel
            => ModelMapperForRegionImage.SelectLiteRegionImageAndMapToRegionImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<RegionImage>, string?, IEnumerable<IRegionImageModel>> SelectListAndMapToModel
            => ModelMapperForRegionImage.SelectListRegionImageAndMapToRegionImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<RegionImage>, string?, IRegionImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForRegionImage.SelectFirstFullRegionImageAndMapToRegionImageModel;

        /// <inheritdoc/>
        protected override Func<IRegionImage, IRegionImageModel, DateTime, DateTime?, IRegionImage> UpdateEntityFromModel
            => ModelMapperForRegionImage.UpdateRegionImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<RegionImage>> FilterQueryByModelExtensionAsync(
            IQueryable<RegionImage> query,
            IRegionImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterRegionImagesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.RegionImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateRegionImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the RegionImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (RegionImageType)resolved.Result!.CreateRegionImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the RegionImage entity");
        }
