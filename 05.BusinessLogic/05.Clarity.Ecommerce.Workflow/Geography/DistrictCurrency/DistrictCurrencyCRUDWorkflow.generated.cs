// <autogenerated>
// <copyright file="DistrictCurrencyWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for DistrictCurrency entities.</summary>
    /// <seealso cref="WorkflowBase{IDistrictCurrencyModel, IDistrictCurrencySearchModel, IDistrictCurrency, DistrictCurrency}"/>
    /// <seealso cref="IDistrictCurrencyWorkflow"/>
    public partial class DistrictCurrencyWorkflow
        : WorkflowBase<IDistrictCurrencyModel, IDistrictCurrencySearchModel, IDistrictCurrency, DistrictCurrency>
            , IDistrictCurrencyWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<DistrictCurrency?, string?, IDistrictCurrencyModel?> MapFromConcreteFull
            => ModelMapperForDistrictCurrency.MapDistrictCurrencyModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<DistrictCurrency>, string?, IEnumerable<IDistrictCurrencyModel>> SelectLiteAndMapToModel
            => ModelMapperForDistrictCurrency.SelectLiteDistrictCurrencyAndMapToDistrictCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DistrictCurrency>, string?, IEnumerable<IDistrictCurrencyModel>> SelectListAndMapToModel
            => ModelMapperForDistrictCurrency.SelectListDistrictCurrencyAndMapToDistrictCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<DistrictCurrency>, string?, IDistrictCurrencyModel?> SelectFirstFullAndMapToModel
            => ModelMapperForDistrictCurrency.SelectFirstFullDistrictCurrencyAndMapToDistrictCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IDistrictCurrency, IDistrictCurrencyModel, DateTime, DateTime?, IDistrictCurrency> UpdateEntityFromModel
            => ModelMapperForDistrictCurrency.UpdateDistrictCurrencyFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<DistrictCurrency>> FilterQueryByModelExtensionAsync(
            IQueryable<DistrictCurrency> query,
            IDistrictCurrencySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterDistrictCurrenciesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IDistrictCurrency entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the DistrictCurrency entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the DistrictCurrency entity");
        }
