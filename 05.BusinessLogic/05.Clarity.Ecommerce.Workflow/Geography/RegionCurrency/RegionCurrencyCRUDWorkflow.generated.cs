// <autogenerated>
// <copyright file="RegionCurrencyWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for RegionCurrency entities.</summary>
    /// <seealso cref="WorkflowBase{IRegionCurrencyModel, IRegionCurrencySearchModel, IRegionCurrency, RegionCurrency}"/>
    /// <seealso cref="IRegionCurrencyWorkflow"/>
    public partial class RegionCurrencyWorkflow
        : WorkflowBase<IRegionCurrencyModel, IRegionCurrencySearchModel, IRegionCurrency, RegionCurrency>
            , IRegionCurrencyWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<RegionCurrency?, string?, IRegionCurrencyModel?> MapFromConcreteFull
            => ModelMapperForRegionCurrency.MapRegionCurrencyModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<RegionCurrency>, string?, IEnumerable<IRegionCurrencyModel>> SelectLiteAndMapToModel
            => ModelMapperForRegionCurrency.SelectLiteRegionCurrencyAndMapToRegionCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<RegionCurrency>, string?, IEnumerable<IRegionCurrencyModel>> SelectListAndMapToModel
            => ModelMapperForRegionCurrency.SelectListRegionCurrencyAndMapToRegionCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<RegionCurrency>, string?, IRegionCurrencyModel?> SelectFirstFullAndMapToModel
            => ModelMapperForRegionCurrency.SelectFirstFullRegionCurrencyAndMapToRegionCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IRegionCurrency, IRegionCurrencyModel, DateTime, DateTime?, IRegionCurrency> UpdateEntityFromModel
            => ModelMapperForRegionCurrency.UpdateRegionCurrencyFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<RegionCurrency>> FilterQueryByModelExtensionAsync(
            IQueryable<RegionCurrency> query,
            IRegionCurrencySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterRegionCurrenciesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IRegionCurrency entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the RegionCurrency entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the RegionCurrency entity");
        }
