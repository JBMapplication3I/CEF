// <autogenerated>
// <copyright file="AddressWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for Address entities.</summary>
    /// <seealso cref="WorkflowBase{IAddressModel, IAddressSearchModel, IAddress, Address}"/>
    /// <seealso cref="IAddressWorkflow"/>
    public partial class AddressWorkflow
        : WorkflowBase<IAddressModel, IAddressSearchModel, IAddress, Address>
            , IAddressWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<Address?, string?, IAddressModel?> MapFromConcreteFull
            => ModelMapperForAddress.MapAddressModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<Address>, string?, IEnumerable<IAddressModel>> SelectLiteAndMapToModel
            => ModelMapperForAddress.SelectLiteAddressAndMapToAddressModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Address>, string?, IEnumerable<IAddressModel>> SelectListAndMapToModel
            => ModelMapperForAddress.SelectListAddressAndMapToAddressModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Address>, string?, IAddressModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAddress.SelectFirstFullAddressAndMapToAddressModel;

        /// <inheritdoc/>
        protected override Func<IAddress, IAddressModel, DateTime, DateTime?, IAddress> UpdateEntityFromModel
            => ModelMapperForAddress.UpdateAddressFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<Address>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAddressesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Country to the Address entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Region to the Address entity");
        }
