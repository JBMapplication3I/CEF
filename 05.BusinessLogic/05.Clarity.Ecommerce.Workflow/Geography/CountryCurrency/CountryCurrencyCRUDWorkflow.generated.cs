// <autogenerated>
// <copyright file="CountryCurrencyWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CountryCurrency entities.</summary>
    /// <seealso cref="WorkflowBase{ICountryCurrencyModel, ICountryCurrencySearchModel, ICountryCurrency, CountryCurrency}"/>
    /// <seealso cref="ICountryCurrencyWorkflow"/>
    public partial class CountryCurrencyWorkflow
        : WorkflowBase<ICountryCurrencyModel, ICountryCurrencySearchModel, ICountryCurrency, CountryCurrency>
            , ICountryCurrencyWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CountryCurrency?, string?, ICountryCurrencyModel?> MapFromConcreteFull
            => ModelMapperForCountryCurrency.MapCountryCurrencyModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryCurrency>, string?, IEnumerable<ICountryCurrencyModel>> SelectLiteAndMapToModel
            => ModelMapperForCountryCurrency.SelectLiteCountryCurrencyAndMapToCountryCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryCurrency>, string?, IEnumerable<ICountryCurrencyModel>> SelectListAndMapToModel
            => ModelMapperForCountryCurrency.SelectListCountryCurrencyAndMapToCountryCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryCurrency>, string?, ICountryCurrencyModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCountryCurrency.SelectFirstFullCountryCurrencyAndMapToCountryCurrencyModel;

        /// <inheritdoc/>
        protected override Func<ICountryCurrency, ICountryCurrencyModel, DateTime, DateTime?, ICountryCurrency> UpdateEntityFromModel
            => ModelMapperForCountryCurrency.UpdateCountryCurrencyFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CountryCurrency>> FilterQueryByModelExtensionAsync(
            IQueryable<CountryCurrency> query,
            ICountryCurrencySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCountryCurrenciesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ICountryCurrency entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the CountryCurrency entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the CountryCurrency entity");
        }
