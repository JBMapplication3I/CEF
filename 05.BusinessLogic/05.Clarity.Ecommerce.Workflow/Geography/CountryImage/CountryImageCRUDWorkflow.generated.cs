// <autogenerated>
// <copyright file="CountryImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CountryImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ICountryImageModel, ICountryImageSearchModel, ICountryImage, CountryImage}"/>
    /// <seealso cref="ICountryImageWorkflow"/>
    public partial class CountryImageWorkflow
        : NameableWorkflowBase<ICountryImageModel, ICountryImageSearchModel, ICountryImage, CountryImage>
            , ICountryImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CountryImage?, string?, ICountryImageModel?> MapFromConcreteFull
            => ModelMapperForCountryImage.MapCountryImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryImage>, string?, IEnumerable<ICountryImageModel>> SelectLiteAndMapToModel
            => ModelMapperForCountryImage.SelectLiteCountryImageAndMapToCountryImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryImage>, string?, IEnumerable<ICountryImageModel>> SelectListAndMapToModel
            => ModelMapperForCountryImage.SelectListCountryImageAndMapToCountryImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryImage>, string?, ICountryImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCountryImage.SelectFirstFullCountryImageAndMapToCountryImageModel;

        /// <inheritdoc/>
        protected override Func<ICountryImage, ICountryImageModel, DateTime, DateTime?, ICountryImage> UpdateEntityFromModel
            => ModelMapperForCountryImage.UpdateCountryImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CountryImage>> FilterQueryByModelExtensionAsync(
            IQueryable<CountryImage> query,
            ICountryImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCountryImagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ICountryImage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.CountryImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateCountryImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the CountryImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (CountryImageType)resolved.Result!.CreateCountryImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the CountryImage entity");
        }
