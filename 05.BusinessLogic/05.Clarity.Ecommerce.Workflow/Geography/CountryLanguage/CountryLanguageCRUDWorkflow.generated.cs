// <autogenerated>
// <copyright file="CountryLanguageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CountryLanguage entities.</summary>
    /// <seealso cref="WorkflowBase{ICountryLanguageModel, ICountryLanguageSearchModel, ICountryLanguage, CountryLanguage}"/>
    /// <seealso cref="ICountryLanguageWorkflow"/>
    public partial class CountryLanguageWorkflow
        : WorkflowBase<ICountryLanguageModel, ICountryLanguageSearchModel, ICountryLanguage, CountryLanguage>
            , ICountryLanguageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CountryLanguage?, string?, ICountryLanguageModel?> MapFromConcreteFull
            => ModelMapperForCountryLanguage.MapCountryLanguageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryLanguage>, string?, IEnumerable<ICountryLanguageModel>> SelectLiteAndMapToModel
            => ModelMapperForCountryLanguage.SelectLiteCountryLanguageAndMapToCountryLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryLanguage>, string?, IEnumerable<ICountryLanguageModel>> SelectListAndMapToModel
            => ModelMapperForCountryLanguage.SelectListCountryLanguageAndMapToCountryLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CountryLanguage>, string?, ICountryLanguageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCountryLanguage.SelectFirstFullCountryLanguageAndMapToCountryLanguageModel;

        /// <inheritdoc/>
        protected override Func<ICountryLanguage, ICountryLanguageModel, DateTime, DateTime?, ICountryLanguage> UpdateEntityFromModel
            => ModelMapperForCountryLanguage.UpdateCountryLanguageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CountryLanguage>> FilterQueryByModelExtensionAsync(
            IQueryable<CountryLanguage> query,
            ICountryLanguageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCountryLanguagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ICountryLanguage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the CountryLanguage entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the CountryLanguage entity");
        }
