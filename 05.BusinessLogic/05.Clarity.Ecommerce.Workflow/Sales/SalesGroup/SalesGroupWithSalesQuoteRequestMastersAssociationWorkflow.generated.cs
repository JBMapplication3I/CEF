// <autogenerated>
// <copyright file="SalesGroupWithSalesQuoteRequestMastersAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Group Sales Quote Request Masters association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesGroupModel, ISalesGroup, ISalesQuoteModel, ISalesQuote, SalesQuote}"/>
    /// <seealso cref="ISalesGroupWithSalesQuoteRequestMastersAssociationWorkflow"/>
    public partial class SalesGroupWithSalesQuoteRequestMastersAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesGroupModel, ISalesGroup, ISalesQuoteModel, ISalesQuote, SalesQuote>
        , ISalesGroupWithSalesQuoteRequestMastersAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SalesQuote>? GetObjectsCollection(ISalesGroup entity) { return entity.SalesQuoteRequestMasters; }

        /// <inheritdoc/>
        protected override List<ISalesQuoteModel>? GetModelObjectsList(ISalesGroupModel model) { return model.SalesQuoteRequestMasters; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesGroup entity, ISalesQuote newEntity)
        {
            if (newEntity == null) { return; }
            entity.SalesQuoteRequestMasters!.Add((SalesQuote)newEntity);
        }

        /// <inheritdoc/>
        protected override void InitializeObjectListIfNull(ISalesGroup entity)
        {
            if (entity.SalesQuoteRequestMasters != null) { return; }
            entity.SalesQuoteRequestMasters = new HashSet<SalesQuote>();
        }
