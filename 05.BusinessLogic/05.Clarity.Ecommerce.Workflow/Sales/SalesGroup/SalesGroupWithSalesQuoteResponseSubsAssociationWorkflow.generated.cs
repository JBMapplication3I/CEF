// <autogenerated>
// <copyright file="SalesGroupWithSalesQuoteResponseSubsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Group Sales Quote Response Subs association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesGroupModel, ISalesGroup, ISalesQuoteModel, ISalesQuote, SalesQuote}"/>
    /// <seealso cref="ISalesGroupWithSalesQuoteResponseSubsAssociationWorkflow"/>
    public partial class SalesGroupWithSalesQuoteResponseSubsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesGroupModel, ISalesGroup, ISalesQuoteModel, ISalesQuote, SalesQuote>
        , ISalesGroupWithSalesQuoteResponseSubsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SalesQuote>? GetObjectsCollection(ISalesGroup entity) { return entity.SalesQuoteResponseSubs; }

        /// <inheritdoc/>
        protected override List<ISalesQuoteModel>? GetModelObjectsList(ISalesGroupModel model) { return model.SalesQuoteResponseSubs; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesGroup entity, ISalesQuote newEntity)
        {
            if (newEntity == null) { return; }
            entity.SalesQuoteResponseSubs!.Add((SalesQuote)newEntity);
        }

        /// <inheritdoc/>
        protected override void InitializeObjectListIfNull(ISalesGroup entity)
        {
            if (entity.SalesQuoteResponseSubs != null) { return; }
            entity.SalesQuoteResponseSubs = new HashSet<SalesQuote>();
        }
