// <autogenerated>
// <copyright file="SalesGroupWithSalesQuoteResponseMastersAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Group Sales Quote Response Masters association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesGroupModel, ISalesGroup, ISalesQuoteModel, ISalesQuote, SalesQuote}"/>
    /// <seealso cref="ISalesGroupWithSalesQuoteResponseMastersAssociationWorkflow"/>
    public partial class SalesGroupWithSalesQuoteResponseMastersAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesGroupModel, ISalesGroup, ISalesQuoteModel, ISalesQuote, SalesQuote>
        , ISalesGroupWithSalesQuoteResponseMastersAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SalesQuote>? GetObjectsCollection(ISalesGroup entity) { return entity.SalesQuoteResponseMasters; }

        /// <inheritdoc/>
        protected override List<ISalesQuoteModel>? GetModelObjectsList(ISalesGroupModel model) { return model.SalesQuoteResponseMasters; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesGroup entity, ISalesQuote newEntity)
        {
            if (newEntity == null) { return; }
            entity.SalesQuoteResponseMasters!.Add((SalesQuote)newEntity);
        }

        /// <inheritdoc/>
        protected override void InitializeObjectListIfNull(ISalesGroup entity)
        {
            if (entity.SalesQuoteResponseMasters != null) { return; }
            entity.SalesQuoteResponseMasters = new HashSet<SalesQuote>();
        }
