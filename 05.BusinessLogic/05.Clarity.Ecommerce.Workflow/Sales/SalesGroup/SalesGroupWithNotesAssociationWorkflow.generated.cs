// <autogenerated>
// <copyright file="SalesGroupWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Group Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesGroupModel, ISalesGroup, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesGroupWithNotesAssociationWorkflow"/>
    public partial class SalesGroupWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesGroupModel, ISalesGroup, INoteModel, INote, Note>
        , ISalesGroupWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesGroup entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesGroupModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesGroup entity, INote newEntity)
        {
