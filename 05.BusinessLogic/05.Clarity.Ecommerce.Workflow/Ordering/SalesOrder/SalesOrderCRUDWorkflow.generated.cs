// <autogenerated>
// <copyright file="SalesOrderWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrder entities.</summary>
    /// <seealso cref="SalesCollectionWorkflowBase{ISalesOrderModel, ISalesOrderSearchModel, ISalesOrder, SalesOrder, SalesOrderStatus, SalesOrderType, ITypeModel, ISalesOrderItem, SalesOrderItem, AppliedSalesOrderDiscount, SalesOrderState, SalesOrderFile, ISalesOrderFileModel, SalesOrderContact, ISalesOrderContactModel, SalesOrderEvent, ISalesOrderEventModel, SalesOrderEventType, AppliedSalesOrderItemDiscount, SalesOrderItemTarget, IAppliedSalesOrderDiscountModel, IAppliedSalesOrderItemDiscountModel}"/>
    /// <seealso cref="ISalesOrderWorkflow"/>
    public partial class SalesOrderWorkflow
        : SalesCollectionWorkflowBase<ISalesOrderModel,
            ...
            , ISalesOrderWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrder?, string?, ISalesOrderModel?> MapFromConcreteFull
            => ModelMapperForSalesOrder.MapSalesOrderModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrder>, string?, IEnumerable<ISalesOrderModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrder.SelectLiteSalesOrderAndMapToSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrder>, string?, IEnumerable<ISalesOrderModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrder.SelectListSalesOrderAndMapToSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrder>, string?, ISalesOrderModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrder.SelectFirstFullSalesOrderAndMapToSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrder, ISalesOrderModel, DateTime, DateTime?, ISalesOrder> UpdateEntityFromModel
            => ModelMapperForSalesOrder.UpdateSalesOrderFromModel;
        #endregion
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Notes != null)
            {
                ...
                await Workflows.SalesOrderWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
            if (model.SalesOrderPayments != null) { await Workflows.SalesOrderWithSalesOrderPaymentsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.AssociatedSalesQuotes != null) { await Workflows.SalesOrderWithAssociatedSalesQuotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.AssociatedSalesReturns != null) { await Workflows.SalesOrderWithAssociatedSalesReturnsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.AssociatedSalesInvoices != null) { await Workflows.SalesOrderWithAssociatedSalesInvoicesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.AssociatedPurchaseOrders != null) { await Workflows.SalesOrderWithAssociatedPurchaseOrdersAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.SalesItems != null) { await Workflows.SalesOrderWithSalesItemsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: Discounts
            if (model.StoredFiles != null) { await Workflows.SalesOrderWithStoredFilesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Contacts != null) { await Workflows.SalesOrderWithContactsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: SalesEvents
            if (model.RateQuotes != null) { await Workflows.SalesOrderWithRateQuotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given InventoryLocation to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Account to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Franchise to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesOrderStatuses.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive StatusID to the SalesOrder entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.StatusID = 0;
                entity.Status = (SalesOrderStatus)resolved.Result!.CreateSalesOrderStatusEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Status to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SalesOrderStates.ResolveWithAutoGenerateOptionalAsync(
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive StateID to the SalesOrder entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.StateID = 0;
                entity.State = (SalesOrderState)resolved.Result!.CreateSalesOrderStateEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given State to the SalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SalesOrderTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SalesOrder entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.TypeID = 0;
                entity.Type = (SalesOrderType)resolved.Result!.CreateSalesOrderTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SalesOrder entity");
        }
