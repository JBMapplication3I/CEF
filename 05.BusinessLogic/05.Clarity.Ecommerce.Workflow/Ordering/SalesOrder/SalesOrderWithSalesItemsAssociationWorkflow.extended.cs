// <copyright file="SalesOrderWithSalesItemsAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate account attributes class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An associate sales order sales items.</summary>
    public partial class SalesOrderWithSalesItemsAssociationWorkflow
    {
        /// <inheritdoc/>
            ...
            IClarityEcommerceEntities context)
        {
            ...
            newEntity.SellingCurrencyID = await Workflows.Currencies.ResolveWithAutoGenerateToIDAsync(
                    ...
                    context)
                .ConfigureAwait(false);
            await Workflows.SalesOrderItemWithDiscountsAssociation.AssociateObjectsAsync(
                    newEntity,
                    model,
                    timestamp,
                    context)
