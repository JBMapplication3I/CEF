// <autogenerated>
// <copyright file="SalesOrderContactWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderContact entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesOrderContactModel, ISalesOrderContactSearchModel, ISalesOrderContact, SalesOrderContact}"/>
    /// <seealso cref="ISalesOrderContactWorkflow"/>
    public partial class SalesOrderContactWorkflow
        : WorkflowBase<ISalesOrderContactModel, ISalesOrderContactSearchModel, ISalesOrderContact, SalesOrderContact>
            , ISalesOrderContactWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderContact?, string?, ISalesOrderContactModel?> MapFromConcreteFull
            => ModelMapperForSalesOrderContact.MapSalesOrderContactModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderContact>, string?, IEnumerable<ISalesOrderContactModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderContact.SelectLiteSalesOrderContactAndMapToSalesOrderContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderContact>, string?, IEnumerable<ISalesOrderContactModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrderContact.SelectListSalesOrderContactAndMapToSalesOrderContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderContact>, string?, ISalesOrderContactModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderContact.SelectFirstFullSalesOrderContactAndMapToSalesOrderContactModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderContact, ISalesOrderContactModel, DateTime, DateTime?, ISalesOrderContact> UpdateEntityFromModel
            => ModelMapperForSalesOrderContact.UpdateSalesOrderContactFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderContact>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderContactsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesOrderContact entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesOrderContact entity");
        }
