// <autogenerated>
// <copyright file="SalesOrderItemWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderItem entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesItemBaseModel, ISalesItemBaseSearchModel, ISalesOrderItem, SalesOrderItem}"/>
    /// <seealso cref="ISalesOrderItemWorkflow"/>
    public partial class SalesOrderItemWorkflow
        : NameableWorkflowBase<ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>, ISalesItemBaseSearchModel, ISalesOrderItem, SalesOrderItem>
            , ISalesOrderItemWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderItem?, string?, ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>?> MapFromConcreteFull
            => ModelMapperForSalesOrderItem.MapSalesOrderItemModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderItem.SelectLiteSalesOrderItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>>> SelectListAndMapToModel
            => ModelMapperForSalesOrderItem.SelectListSalesOrderItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderItem>, string?, ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderItem.SelectFirstFullSalesOrderItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderItem, ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>, DateTime, DateTime?, ISalesOrderItem> UpdateEntityFromModel
            => ModelMapperForSalesOrderItem.UpdateSalesOrderItemFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderItem>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderItemsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Targets != null) { await Workflows.SalesOrderItemWithTargetsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.SalesOrderItemID = entity.ID;
                    }
                }
                await Workflows.SalesOrderItemWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Product to the SalesOrderItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SalesOrderItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given OriginalCurrency to the SalesOrderItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SellingCurrency to the SalesOrderItem entity");
        }
