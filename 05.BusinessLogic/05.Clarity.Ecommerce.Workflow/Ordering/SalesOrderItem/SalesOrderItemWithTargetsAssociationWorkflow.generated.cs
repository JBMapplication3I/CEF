// <autogenerated>
// <copyright file="SalesOrderItemWithTargetsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Order Item Targets association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesOrderItem, ISalesItemTargetBaseModel, ISalesOrderItemTarget, SalesOrderItemTarget}"/>
    /// <seealso cref="ISalesOrderItemWithTargetsAssociationWorkflow"/>
    public partial class SalesOrderItemWithTargetsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>, ISalesOrderItem, ISalesItemTargetBaseModel, ISalesOrderItemTarget, SalesOrderItemTarget>
        , ISalesOrderItemWithTargetsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SalesOrderItemTarget>? GetObjectsCollection(ISalesOrderItem entity) { return entity.Targets; }

        /// <inheritdoc/>
        protected override List<ISalesItemTargetBaseModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel> model) { return model.Targets; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesOrderItem entity, ISalesOrderItemTarget newEntity)
        {
            if (newEntity == null) { return; }
            entity.Targets!.Add((SalesOrderItemTarget)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(ISalesOrderItem entity)
        {
            ...
            entity.Targets = new HashSet<SalesOrderItemTarget>();
        }

        /// <inheritdoc/>
        protected override async Task DeactivateObjectAsync(ISalesOrderItemTarget entity, DateTime timestamp)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<bool> MatchObjectModelWithObjectEntityAsync(ISalesItemTargetBaseModel model, ISalesOrderItemTarget entity, IClarityEcommerceEntities context)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<ISalesOrderItemTarget> ModelToNewObjectAsync(
            ...
            var thisEntityTypeID = Contract.CheckValidID(model.TypeID)
                ...
                : model.Type != null && Contract.CheckValidID(model.Type.ID)
                    ...
                    : UpsertThisEntityTypeAndGetID(
                        ...
                        timestamp,
                        context);
            if (thisEntityTypeID <= 0) { throw new ArgumentException("SalesOrderItemTarget requires a valid Type."); }
            // Create a new entity and populate it with data
            var newEntity = model.CreateSalesOrderItemTargetEntity(timestamp, context.ContextProfileName);
