// <autogenerated>
// <copyright file="SalesOrderItemWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Order Item Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesOrderItem, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesOrderItemWithNotesAssociationWorkflow"/>
    public partial class SalesOrderItemWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>, ISalesOrderItem, INoteModel, INote, Note>
        , ISalesOrderItemWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesOrderItem entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel> model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesOrderItem entity, INote newEntity)
        {
