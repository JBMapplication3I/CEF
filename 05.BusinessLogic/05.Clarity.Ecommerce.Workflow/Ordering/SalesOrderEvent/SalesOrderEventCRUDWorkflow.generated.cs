// <autogenerated>
// <copyright file="SalesOrderEventWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderEvent entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesOrderEventModel, ISalesOrderEventSearchModel, ISalesOrderEvent, SalesOrderEvent}"/>
    /// <seealso cref="ISalesOrderEventWorkflow"/>
    public partial class SalesOrderEventWorkflow
        : NameableWorkflowBase<ISalesOrderEventModel, ISalesOrderEventSearchModel, ISalesOrderEvent, SalesOrderEvent>
            , ISalesOrderEventWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderEvent?, string?, ISalesOrderEventModel?> MapFromConcreteFull
            => ModelMapperForSalesOrderEvent.MapSalesOrderEventModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderEvent>, string?, IEnumerable<ISalesOrderEventModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderEvent.SelectLiteSalesOrderEventAndMapToSalesOrderEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderEvent>, string?, IEnumerable<ISalesOrderEventModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrderEvent.SelectListSalesOrderEventAndMapToSalesOrderEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderEvent>, string?, ISalesOrderEventModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderEvent.SelectFirstFullSalesOrderEventAndMapToSalesOrderEventModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderEvent, ISalesOrderEventModel, DateTime, DateTime?, ISalesOrderEvent> UpdateEntityFromModel
            => ModelMapperForSalesOrderEvent.UpdateSalesOrderEventFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderEvent>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesOrderEvent> query,
            ISalesOrderEventSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderEventsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesOrderEventTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateSalesOrderEventTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SalesOrderEvent entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (SalesOrderEventType)resolved.Result!.CreateSalesOrderEventTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SalesOrderEvent entity");
        }
