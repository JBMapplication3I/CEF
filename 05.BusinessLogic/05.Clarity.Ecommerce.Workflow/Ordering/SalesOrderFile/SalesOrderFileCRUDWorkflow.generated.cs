// <autogenerated>
// <copyright file="SalesOrderFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesOrderFileModel, ISalesOrderFileSearchModel, ISalesOrderFile, SalesOrderFile}"/>
    /// <seealso cref="ISalesOrderFileWorkflow"/>
    public partial class SalesOrderFileWorkflow
        : NameableWorkflowBase<ISalesOrderFileModel, ISalesOrderFileSearchModel, ISalesOrderFile, SalesOrderFile>
            , ISalesOrderFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderFile?, string?, ISalesOrderFileModel?> MapFromConcreteFull
            => ModelMapperForSalesOrderFile.MapSalesOrderFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderFile>, string?, IEnumerable<ISalesOrderFileModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderFile.SelectLiteSalesOrderFileAndMapToSalesOrderFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderFile>, string?, IEnumerable<ISalesOrderFileModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrderFile.SelectListSalesOrderFileAndMapToSalesOrderFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderFile>, string?, ISalesOrderFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderFile.SelectFirstFullSalesOrderFileAndMapToSalesOrderFileModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderFile, ISalesOrderFileModel, DateTime, DateTime?, ISalesOrderFile> UpdateEntityFromModel
            => ModelMapperForSalesOrderFile.UpdateSalesOrderFileFromModel;
        #endregion
        ...
        {
            return await context.Set<SalesOrderFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<ISalesOrderFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<ISalesOrderFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<SalesOrderFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<SalesOrderFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<SalesOrderFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<SalesOrderFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderFile>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesOrderFile> query,
            ISalesOrderFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderFilesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesOrderFile entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesOrderFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesOrderFile entity");
        }
