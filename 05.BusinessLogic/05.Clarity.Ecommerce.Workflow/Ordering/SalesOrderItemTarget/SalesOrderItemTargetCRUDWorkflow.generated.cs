// <autogenerated>
// <copyright file="SalesOrderItemTargetWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderItemTarget entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ISalesOrderItemTarget, SalesOrderItemTarget}"/>
    /// <seealso cref="ISalesOrderItemTargetWorkflow"/>
    public partial class SalesOrderItemTargetWorkflow
        : WorkflowBase<ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ISalesOrderItemTarget, SalesOrderItemTarget>
            , ISalesOrderItemTargetWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderItemTarget?, string?, ISalesItemTargetBaseModel?> MapFromConcreteFull
            => ModelMapperForSalesOrderItemTarget.MapSalesOrderItemTargetModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderItemTarget.SelectLiteSalesOrderItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrderItemTarget.SelectListSalesOrderItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderItemTarget>, string?, ISalesItemTargetBaseModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderItemTarget.SelectFirstFullSalesOrderItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderItemTarget, ISalesItemTargetBaseModel, DateTime, DateTime?, ISalesOrderItemTarget> UpdateEntityFromModel
            => ModelMapperForSalesOrderItemTarget.UpdateSalesOrderItemTargetFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderItemTarget>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesOrderItemTarget> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderItemTargetsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesOrderItemTarget entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SalesOrderItemTarget entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SalesOrderItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive DestinationContactID to the SalesOrderItemTarget entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given DestinationContact to the SalesOrderItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BrandProduct to the SalesOrderItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SelectedRateQuote to the SalesOrderItemTarget entity");
        }
