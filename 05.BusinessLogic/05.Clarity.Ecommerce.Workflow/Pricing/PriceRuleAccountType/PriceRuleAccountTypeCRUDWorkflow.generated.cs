// <autogenerated>
// <copyright file="PriceRuleAccountTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleAccountType entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleAccountTypeModel, IPriceRuleAccountTypeSearchModel, IPriceRuleAccountType, PriceRuleAccountType}"/>
    /// <seealso cref="IPriceRuleAccountTypeWorkflow"/>
    public partial class PriceRuleAccountTypeWorkflow
        : WorkflowBase<IPriceRuleAccountTypeModel, IPriceRuleAccountTypeSearchModel, IPriceRuleAccountType, PriceRuleAccountType>
            , IPriceRuleAccountTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleAccountType?, string?, IPriceRuleAccountTypeModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleAccountType.MapPriceRuleAccountTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleAccountType>, string?, IEnumerable<IPriceRuleAccountTypeModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleAccountType.SelectLitePriceRuleAccountTypeAndMapToPriceRuleAccountTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleAccountType>, string?, IEnumerable<IPriceRuleAccountTypeModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleAccountType.SelectListPriceRuleAccountTypeAndMapToPriceRuleAccountTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleAccountType>, string?, IPriceRuleAccountTypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleAccountType.SelectFirstFullPriceRuleAccountTypeAndMapToPriceRuleAccountTypeModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleAccountType, IPriceRuleAccountTypeModel, DateTime, DateTime?, IPriceRuleAccountType> UpdateEntityFromModel
            => ModelMapperForPriceRuleAccountType.UpdatePriceRuleAccountTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleAccountType>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleAccountType> query,
            IPriceRuleAccountTypeSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleAccountTypesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdatePriceRuleFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleAccountType entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleAccountType entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleAccountType entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (AccountType)resolved.Result!.CreateAccountTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleAccountType entity");
        }
