// <autogenerated>
// <copyright file="PriceRuleFranchiseWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleFranchise entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleFranchiseModel, IPriceRuleFranchiseSearchModel, IPriceRuleFranchise, PriceRuleFranchise}"/>
    /// <seealso cref="IPriceRuleFranchiseWorkflow"/>
    public partial class PriceRuleFranchiseWorkflow
        : WorkflowBase<IPriceRuleFranchiseModel, IPriceRuleFranchiseSearchModel, IPriceRuleFranchise, PriceRuleFranchise>
            , IPriceRuleFranchiseWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleFranchise?, string?, IPriceRuleFranchiseModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleFranchise.MapPriceRuleFranchiseModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleFranchise>, string?, IEnumerable<IPriceRuleFranchiseModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleFranchise.SelectLitePriceRuleFranchiseAndMapToPriceRuleFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleFranchise>, string?, IEnumerable<IPriceRuleFranchiseModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleFranchise.SelectListPriceRuleFranchiseAndMapToPriceRuleFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleFranchise>, string?, IPriceRuleFranchiseModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleFranchise.SelectFirstFullPriceRuleFranchiseAndMapToPriceRuleFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleFranchise, IPriceRuleFranchiseModel, DateTime, DateTime?, IPriceRuleFranchise> UpdateEntityFromModel
            => ModelMapperForPriceRuleFranchise.UpdatePriceRuleFranchiseFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleFranchise>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleFranchise> query,
            IPriceRuleFranchiseSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleFranchisesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IPriceRuleFranchise entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleFranchise entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleFranchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleFranchise entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleFranchise entity");
        }
