// <autogenerated>
// <copyright file="PriceRuleProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleProduct entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleProductModel, IPriceRuleProductSearchModel, IPriceRuleProduct, PriceRuleProduct}"/>
    /// <seealso cref="IPriceRuleProductWorkflow"/>
    public partial class PriceRuleProductWorkflow
        : WorkflowBase<IPriceRuleProductModel, IPriceRuleProductSearchModel, IPriceRuleProduct, PriceRuleProduct>
            , IPriceRuleProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleProduct?, string?, IPriceRuleProductModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleProduct.MapPriceRuleProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleProduct>, string?, IEnumerable<IPriceRuleProductModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleProduct.SelectLitePriceRuleProductAndMapToPriceRuleProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleProduct>, string?, IEnumerable<IPriceRuleProductModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleProduct.SelectListPriceRuleProductAndMapToPriceRuleProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleProduct>, string?, IPriceRuleProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleProduct.SelectFirstFullPriceRuleProductAndMapToPriceRuleProductModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleProduct, IPriceRuleProductModel, DateTime, DateTime?, IPriceRuleProduct> UpdateEntityFromModel
            => ModelMapperForPriceRuleProduct.UpdatePriceRuleProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleProduct>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleProduct> query,
            IPriceRuleProductSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleProductsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleProduct entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleProduct entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleProduct entity");
        }
