// <autogenerated>
// <copyright file="PriceRuleAccountWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleAccount entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleAccountModel, IPriceRuleAccountSearchModel, IPriceRuleAccount, PriceRuleAccount}"/>
    /// <seealso cref="IPriceRuleAccountWorkflow"/>
    public partial class PriceRuleAccountWorkflow
        : WorkflowBase<IPriceRuleAccountModel, IPriceRuleAccountSearchModel, IPriceRuleAccount, PriceRuleAccount>
            , IPriceRuleAccountWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleAccount?, string?, IPriceRuleAccountModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleAccount.MapPriceRuleAccountModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleAccount>, string?, IEnumerable<IPriceRuleAccountModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleAccount.SelectLitePriceRuleAccountAndMapToPriceRuleAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleAccount>, string?, IEnumerable<IPriceRuleAccountModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleAccount.SelectListPriceRuleAccountAndMapToPriceRuleAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleAccount>, string?, IPriceRuleAccountModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleAccount.SelectFirstFullPriceRuleAccountAndMapToPriceRuleAccountModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleAccount, IPriceRuleAccountModel, DateTime, DateTime?, IPriceRuleAccount> UpdateEntityFromModel
            => ModelMapperForPriceRuleAccount.UpdatePriceRuleAccountFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleAccount>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleAccount> query,
            IPriceRuleAccountSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleAccountsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleAccount entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleAccount entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleAccount entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleAccount entity");
        }
