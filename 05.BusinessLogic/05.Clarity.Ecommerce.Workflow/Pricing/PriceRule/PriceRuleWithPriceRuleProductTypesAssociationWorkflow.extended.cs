// <copyright file="PriceRuleWithPriceRuleProductTypesAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2017-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate price rule product types workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class PriceRuleWithPriceRuleProductTypesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override bool ValidateObjectModelIsGoodForDatabaseAdditionalChecks(IPriceRuleProductTypeModel model)
        {
        ...
        protected override async Task ModelToNewObjectAdditionalPropertiesAsync(
            IPriceRuleProductType newEntity,
            IPriceRuleProductTypeModel model,
            DateTime timestamp,
            IClarityEcommerceEntities context)
        {
            ...
            newEntity.SlaveID = await Workflows.ProductTypes.ResolveWithAutoGenerateToIDAsync(
                    byID: model.SlaveID,
