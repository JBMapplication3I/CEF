// <autogenerated>
// <copyright file="PriceRuleManufacturerWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleManufacturer entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleManufacturerModel, IPriceRuleManufacturerSearchModel, IPriceRuleManufacturer, PriceRuleManufacturer}"/>
    /// <seealso cref="IPriceRuleManufacturerWorkflow"/>
    public partial class PriceRuleManufacturerWorkflow
        : WorkflowBase<IPriceRuleManufacturerModel, IPriceRuleManufacturerSearchModel, IPriceRuleManufacturer, PriceRuleManufacturer>
            , IPriceRuleManufacturerWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleManufacturer?, string?, IPriceRuleManufacturerModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleManufacturer.MapPriceRuleManufacturerModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleManufacturer>, string?, IEnumerable<IPriceRuleManufacturerModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleManufacturer.SelectLitePriceRuleManufacturerAndMapToPriceRuleManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleManufacturer>, string?, IEnumerable<IPriceRuleManufacturerModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleManufacturer.SelectListPriceRuleManufacturerAndMapToPriceRuleManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleManufacturer>, string?, IPriceRuleManufacturerModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleManufacturer.SelectFirstFullPriceRuleManufacturerAndMapToPriceRuleManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleManufacturer, IPriceRuleManufacturerModel, DateTime, DateTime?, IPriceRuleManufacturer> UpdateEntityFromModel
            => ModelMapperForPriceRuleManufacturer.UpdatePriceRuleManufacturerFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleManufacturer>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleManufacturer> query,
            IPriceRuleManufacturerSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleManufacturersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleManufacturer entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleManufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Manufacturers.ResolveWithAutoGenerateOptionalAsync(
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleManufacturer entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (Manufacturer)resolved.Result!.CreateManufacturerEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleManufacturer entity");
        }
