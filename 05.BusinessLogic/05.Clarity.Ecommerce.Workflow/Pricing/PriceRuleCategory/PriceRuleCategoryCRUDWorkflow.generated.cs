// <autogenerated>
// <copyright file="PriceRuleCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleCategory entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleCategoryModel, IPriceRuleCategorySearchModel, IPriceRuleCategory, PriceRuleCategory}"/>
    /// <seealso cref="IPriceRuleCategoryWorkflow"/>
    public partial class PriceRuleCategoryWorkflow
        : WorkflowBase<IPriceRuleCategoryModel, IPriceRuleCategorySearchModel, IPriceRuleCategory, PriceRuleCategory>
            , IPriceRuleCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleCategory?, string?, IPriceRuleCategoryModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleCategory.MapPriceRuleCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleCategory>, string?, IEnumerable<IPriceRuleCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleCategory.SelectLitePriceRuleCategoryAndMapToPriceRuleCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleCategory>, string?, IEnumerable<IPriceRuleCategoryModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleCategory.SelectListPriceRuleCategoryAndMapToPriceRuleCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleCategory>, string?, IPriceRuleCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleCategory.SelectFirstFullPriceRuleCategoryAndMapToPriceRuleCategoryModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleCategory, IPriceRuleCategoryModel, DateTime, DateTime?, IPriceRuleCategory> UpdateEntityFromModel
            => ModelMapperForPriceRuleCategory.UpdatePriceRuleCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleCategory>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleCategory> query,
            IPriceRuleCategorySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleCategoriesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleCategory entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleCategory entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleCategory entity");
        }
