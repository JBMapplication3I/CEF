// <autogenerated>
// <copyright file="PriceRuleBrandWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleBrand entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleBrandModel, IPriceRuleBrandSearchModel, IPriceRuleBrand, PriceRuleBrand}"/>
    /// <seealso cref="IPriceRuleBrandWorkflow"/>
    public partial class PriceRuleBrandWorkflow
        : WorkflowBase<IPriceRuleBrandModel, IPriceRuleBrandSearchModel, IPriceRuleBrand, PriceRuleBrand>
            , IPriceRuleBrandWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleBrand?, string?, IPriceRuleBrandModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleBrand.MapPriceRuleBrandModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleBrand>, string?, IEnumerable<IPriceRuleBrandModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleBrand.SelectLitePriceRuleBrandAndMapToPriceRuleBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleBrand>, string?, IEnumerable<IPriceRuleBrandModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleBrand.SelectListPriceRuleBrandAndMapToPriceRuleBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleBrand>, string?, IPriceRuleBrandModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleBrand.SelectFirstFullPriceRuleBrandAndMapToPriceRuleBrandModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleBrand, IPriceRuleBrandModel, DateTime, DateTime?, IPriceRuleBrand> UpdateEntityFromModel
            => ModelMapperForPriceRuleBrand.UpdatePriceRuleBrandFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleBrand>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleBrand> query,
            IPriceRuleBrandSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleBrandsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IPriceRuleBrand entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleBrand entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleBrand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateBrandFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleBrand entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (Brand)resolved.Result!.CreateBrandEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleBrand entity");
        }
