// <autogenerated>
// <copyright file="PriceRuleCountryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleCountry entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleCountryModel, IPriceRuleCountrySearchModel, IPriceRuleCountry, PriceRuleCountry}"/>
    /// <seealso cref="IPriceRuleCountryWorkflow"/>
    public partial class PriceRuleCountryWorkflow
        : WorkflowBase<IPriceRuleCountryModel, IPriceRuleCountrySearchModel, IPriceRuleCountry, PriceRuleCountry>
            , IPriceRuleCountryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleCountry?, string?, IPriceRuleCountryModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleCountry.MapPriceRuleCountryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleCountry>, string?, IEnumerable<IPriceRuleCountryModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleCountry.SelectLitePriceRuleCountryAndMapToPriceRuleCountryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleCountry>, string?, IEnumerable<IPriceRuleCountryModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleCountry.SelectListPriceRuleCountryAndMapToPriceRuleCountryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleCountry>, string?, IPriceRuleCountryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleCountry.SelectFirstFullPriceRuleCountryAndMapToPriceRuleCountryModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleCountry, IPriceRuleCountryModel, DateTime, DateTime?, IPriceRuleCountry> UpdateEntityFromModel
            => ModelMapperForPriceRuleCountry.UpdatePriceRuleCountryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleCountry>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleCountry> query,
            IPriceRuleCountrySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleCountriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IPriceRuleCountry entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleCountry entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleCountry entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleCountry entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (Country)resolved.Result!.CreateCountryEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleCountry entity");
        }
