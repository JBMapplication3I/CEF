// <autogenerated>
// <copyright file="PriceRuleProductTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleProductType entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleProductTypeModel, IPriceRuleProductTypeSearchModel, IPriceRuleProductType, PriceRuleProductType}"/>
    /// <seealso cref="IPriceRuleProductTypeWorkflow"/>
    public partial class PriceRuleProductTypeWorkflow
        : WorkflowBase<IPriceRuleProductTypeModel, IPriceRuleProductTypeSearchModel, IPriceRuleProductType, PriceRuleProductType>
            , IPriceRuleProductTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleProductType?, string?, IPriceRuleProductTypeModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleProductType.MapPriceRuleProductTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleProductType>, string?, IEnumerable<IPriceRuleProductTypeModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleProductType.SelectLitePriceRuleProductTypeAndMapToPriceRuleProductTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleProductType>, string?, IEnumerable<IPriceRuleProductTypeModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleProductType.SelectListPriceRuleProductTypeAndMapToPriceRuleProductTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleProductType>, string?, IPriceRuleProductTypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleProductType.SelectFirstFullPriceRuleProductTypeAndMapToPriceRuleProductTypeModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleProductType, IPriceRuleProductTypeModel, DateTime, DateTime?, IPriceRuleProductType> UpdateEntityFromModel
            => ModelMapperForPriceRuleProductType.UpdatePriceRuleProductTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleProductType>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleProductType> query,
            IPriceRuleProductTypeSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleProductTypesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleProductType entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleProductType entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleProductType entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (ProductType)resolved.Result!.CreateProductTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleProductType entity");
        }
