// <autogenerated>
// <copyright file="PriceRuleVendorWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PriceRuleVendor entities.</summary>
    /// <seealso cref="WorkflowBase{IPriceRuleVendorModel, IPriceRuleVendorSearchModel, IPriceRuleVendor, PriceRuleVendor}"/>
    /// <seealso cref="IPriceRuleVendorWorkflow"/>
    public partial class PriceRuleVendorWorkflow
        : WorkflowBase<IPriceRuleVendorModel, IPriceRuleVendorSearchModel, IPriceRuleVendor, PriceRuleVendor>
            , IPriceRuleVendorWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PriceRuleVendor?, string?, IPriceRuleVendorModel?> MapFromConcreteFull
            => ModelMapperForPriceRuleVendor.MapPriceRuleVendorModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleVendor>, string?, IEnumerable<IPriceRuleVendorModel>> SelectLiteAndMapToModel
            => ModelMapperForPriceRuleVendor.SelectLitePriceRuleVendorAndMapToPriceRuleVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleVendor>, string?, IEnumerable<IPriceRuleVendorModel>> SelectListAndMapToModel
            => ModelMapperForPriceRuleVendor.SelectListPriceRuleVendorAndMapToPriceRuleVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PriceRuleVendor>, string?, IPriceRuleVendorModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPriceRuleVendor.SelectFirstFullPriceRuleVendorAndMapToPriceRuleVendorModel;

        /// <inheritdoc/>
        protected override Func<IPriceRuleVendor, IPriceRuleVendorModel, DateTime, DateTime?, IPriceRuleVendor> UpdateEntityFromModel
            => ModelMapperForPriceRuleVendor.UpdatePriceRuleVendorFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PriceRuleVendor>> FilterQueryByModelExtensionAsync(
            IQueryable<PriceRuleVendor> query,
            IPriceRuleVendorSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPriceRuleVendorsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the PriceRuleVendor entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the PriceRuleVendor entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateVendorFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PriceRuleVendor entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (Vendor)resolved.Result!.CreateVendorEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PriceRuleVendor entity");
        }
