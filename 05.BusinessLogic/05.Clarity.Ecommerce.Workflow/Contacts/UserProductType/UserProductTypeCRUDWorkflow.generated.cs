// <autogenerated>
// <copyright file="UserProductTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for UserProductType entities.</summary>
    /// <seealso cref="WorkflowBase{IUserProductTypeModel, IUserProductTypeSearchModel, IUserProductType, UserProductType}"/>
    /// <seealso cref="IUserProductTypeWorkflow"/>
    public partial class UserProductTypeWorkflow
        : WorkflowBase<IUserProductTypeModel, IUserProductTypeSearchModel, IUserProductType, UserProductType>
            , IUserProductTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<UserProductType?, string?, IUserProductTypeModel?> MapFromConcreteFull
            => ModelMapperForUserProductType.MapUserProductTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserProductType>, string?, IEnumerable<IUserProductTypeModel>> SelectLiteAndMapToModel
            => ModelMapperForUserProductType.SelectLiteUserProductTypeAndMapToUserProductTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserProductType>, string?, IEnumerable<IUserProductTypeModel>> SelectListAndMapToModel
            => ModelMapperForUserProductType.SelectListUserProductTypeAndMapToUserProductTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserProductType>, string?, IUserProductTypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForUserProductType.SelectFirstFullUserProductTypeAndMapToUserProductTypeModel;

        /// <inheritdoc/>
        protected override Func<IUserProductType, IUserProductTypeModel, DateTime, DateTime?, IUserProductType> UpdateEntityFromModel
            => ModelMapperForUserProductType.UpdateUserProductTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<UserProductType>> FilterQueryByModelExtensionAsync(
            IQueryable<UserProductType> query,
            IUserProductTypeSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterUserProductTypesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IUserProductType entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the UserProductType entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the UserProductType entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the UserProductType entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the UserProductType entity");
        }
