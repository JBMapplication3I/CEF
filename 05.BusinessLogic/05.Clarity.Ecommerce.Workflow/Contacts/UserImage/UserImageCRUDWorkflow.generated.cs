// <autogenerated>
// <copyright file="UserImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for UserImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IUserImageModel, IUserImageSearchModel, IUserImage, UserImage}"/>
    /// <seealso cref="IUserImageWorkflow"/>
    public partial class UserImageWorkflow
        : NameableWorkflowBase<IUserImageModel, IUserImageSearchModel, IUserImage, UserImage>
            , IUserImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<UserImage?, string?, IUserImageModel?> MapFromConcreteFull
            => ModelMapperForUserImage.MapUserImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserImage>, string?, IEnumerable<IUserImageModel>> SelectLiteAndMapToModel
            => ModelMapperForUserImage.SelectLiteUserImageAndMapToUserImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserImage>, string?, IEnumerable<IUserImageModel>> SelectListAndMapToModel
            => ModelMapperForUserImage.SelectListUserImageAndMapToUserImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserImage>, string?, IUserImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForUserImage.SelectFirstFullUserImageAndMapToUserImageModel;

        /// <inheritdoc/>
        protected override Func<IUserImage, IUserImageModel, DateTime, DateTime?, IUserImage> UpdateEntityFromModel
            => ModelMapperForUserImage.UpdateUserImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<UserImage>> FilterQueryByModelExtensionAsync(
            IQueryable<UserImage> query,
            IUserImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterUserImagesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.UserImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateUserImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the UserImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (UserImageType)resolved.Result!.CreateUserImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the UserImage entity");
        }
