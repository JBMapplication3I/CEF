// <autogenerated>
// <copyright file="ContactWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for Contact entities.</summary>
    /// <seealso cref="WorkflowBase{IContactModel, IContactSearchModel, IContact, Contact}"/>
    /// <seealso cref="IContactWorkflow"/>
    public partial class ContactWorkflow
        : WorkflowBase<IContactModel, IContactSearchModel, IContact, Contact>
            , IContactWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<Contact?, string?, IContactModel?> MapFromConcreteFull
            => ModelMapperForContact.MapContactModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<Contact>, string?, IEnumerable<IContactModel>> SelectLiteAndMapToModel
            => ModelMapperForContact.SelectLiteContactAndMapToContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Contact>, string?, IEnumerable<IContactModel>> SelectListAndMapToModel
            => ModelMapperForContact.SelectListContactAndMapToContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Contact>, string?, IContactModel?> SelectFirstFullAndMapToModel
            => ModelMapperForContact.SelectFirstFullContactAndMapToContactModel;

        /// <inheritdoc/>
        protected override Func<IContact, IContactModel, DateTime, DateTime?, IContact> UpdateEntityFromModel
            => ModelMapperForContact.UpdateContactFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<Contact>> FilterQueryByModelExtensionAsync(
            IQueryable<Contact> query,
            IContactSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterContactsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Images != null) { await Workflows.ContactWithImagesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.ContactTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateContactTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the Contact entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (ContactType)resolved.Result!.CreateContactTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the Contact entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Address to the Contact entity");
        }
