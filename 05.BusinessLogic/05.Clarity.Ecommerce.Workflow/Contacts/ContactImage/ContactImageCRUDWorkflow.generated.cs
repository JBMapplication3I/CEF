// <autogenerated>
// <copyright file="ContactImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for ContactImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IContactImageModel, IContactImageSearchModel, IContactImage, ContactImage}"/>
    /// <seealso cref="IContactImageWorkflow"/>
    public partial class ContactImageWorkflow
        : NameableWorkflowBase<IContactImageModel, IContactImageSearchModel, IContactImage, ContactImage>
            , IContactImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<ContactImage?, string?, IContactImageModel?> MapFromConcreteFull
            => ModelMapperForContactImage.MapContactImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<ContactImage>, string?, IEnumerable<IContactImageModel>> SelectLiteAndMapToModel
            => ModelMapperForContactImage.SelectLiteContactImageAndMapToContactImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ContactImage>, string?, IEnumerable<IContactImageModel>> SelectListAndMapToModel
            => ModelMapperForContactImage.SelectListContactImageAndMapToContactImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<ContactImage>, string?, IContactImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForContactImage.SelectFirstFullContactImageAndMapToContactImageModel;

        /// <inheritdoc/>
        protected override Func<IContactImage, IContactImageModel, DateTime, DateTime?, IContactImage> UpdateEntityFromModel
            => ModelMapperForContactImage.UpdateContactImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<ContactImage>> FilterQueryByModelExtensionAsync(
            IQueryable<ContactImage> query,
            IContactImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterContactImagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IContactImage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.ContactImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateContactImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the ContactImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (ContactImageType)resolved.Result!.CreateContactImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the ContactImage entity");
        }
