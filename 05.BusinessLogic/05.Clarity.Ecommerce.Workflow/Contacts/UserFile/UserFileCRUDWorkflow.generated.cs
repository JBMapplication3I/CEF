// <autogenerated>
// <copyright file="UserFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for UserFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IUserFileModel, IUserFileSearchModel, IUserFile, UserFile}"/>
    /// <seealso cref="IUserFileWorkflow"/>
    public partial class UserFileWorkflow
        : NameableWorkflowBase<IUserFileModel, IUserFileSearchModel, IUserFile, UserFile>
            , IUserFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<UserFile?, string?, IUserFileModel?> MapFromConcreteFull
            => ModelMapperForUserFile.MapUserFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserFile>, string?, IEnumerable<IUserFileModel>> SelectLiteAndMapToModel
            => ModelMapperForUserFile.SelectLiteUserFileAndMapToUserFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserFile>, string?, IEnumerable<IUserFileModel>> SelectListAndMapToModel
            => ModelMapperForUserFile.SelectListUserFileAndMapToUserFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserFile>, string?, IUserFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForUserFile.SelectFirstFullUserFileAndMapToUserFileModel;

        /// <inheritdoc/>
        protected override Func<IUserFile, IUserFileModel, DateTime, DateTime?, IUserFile> UpdateEntityFromModel
            => ModelMapperForUserFile.UpdateUserFileFromModel;
        #endregion
        ...
        {
            return await context.Set<UserFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<IUserFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<IUserFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<UserFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        protected virtual Task<UserFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<UserFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<UserFile>> FilterQueryByModelExtensionAsync(
            IQueryable<UserFile> query,
            IUserFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterUserFilesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the UserFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the UserFile entity");
        }
