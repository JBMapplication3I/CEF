// <autogenerated>
// <copyright file="UserWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An User Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IUserModel, IUser, INoteModel, INote, Note}"/>
    /// <seealso cref="IUserWithNotesAssociationWorkflow"/>
    public partial class UserWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<IUserModel, IUser, INoteModel, INote, Note>
        , IUserWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IUser entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(IUserModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IUser entity, INote newEntity)
        {
