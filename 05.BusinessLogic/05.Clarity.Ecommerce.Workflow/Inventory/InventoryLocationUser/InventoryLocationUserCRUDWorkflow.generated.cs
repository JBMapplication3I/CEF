// <autogenerated>
// <copyright file="InventoryLocationUserWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for InventoryLocationUser entities.</summary>
    /// <seealso cref="WorkflowBase{IInventoryLocationUserModel, IInventoryLocationUserSearchModel, IInventoryLocationUser, InventoryLocationUser}"/>
    /// <seealso cref="IInventoryLocationUserWorkflow"/>
    public partial class InventoryLocationUserWorkflow
        : WorkflowBase<IInventoryLocationUserModel, IInventoryLocationUserSearchModel, IInventoryLocationUser, InventoryLocationUser>
            , IInventoryLocationUserWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<InventoryLocationUser?, string?, IInventoryLocationUserModel?> MapFromConcreteFull
            => ModelMapperForInventoryLocationUser.MapInventoryLocationUserModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocationUser>, string?, IEnumerable<IInventoryLocationUserModel>> SelectLiteAndMapToModel
            => ModelMapperForInventoryLocationUser.SelectLiteInventoryLocationUserAndMapToInventoryLocationUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocationUser>, string?, IEnumerable<IInventoryLocationUserModel>> SelectListAndMapToModel
            => ModelMapperForInventoryLocationUser.SelectListInventoryLocationUserAndMapToInventoryLocationUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocationUser>, string?, IInventoryLocationUserModel?> SelectFirstFullAndMapToModel
            => ModelMapperForInventoryLocationUser.SelectFirstFullInventoryLocationUserAndMapToInventoryLocationUserModel;

        /// <inheritdoc/>
        protected override Func<IInventoryLocationUser, IInventoryLocationUserModel, DateTime, DateTime?, IInventoryLocationUser> UpdateEntityFromModel
            => ModelMapperForInventoryLocationUser.UpdateInventoryLocationUserFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<InventoryLocationUser>> FilterQueryByModelExtensionAsync(
            IQueryable<InventoryLocationUser> query,
            IInventoryLocationUserSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterInventoryLocationUsersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IInventoryLocationUser entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the InventoryLocationUser entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the InventoryLocationUser entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the InventoryLocationUser entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the InventoryLocationUser entity");
        }
