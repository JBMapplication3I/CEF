// <autogenerated>
// <copyright file="InventoryLocationRegionWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for InventoryLocationRegion entities.</summary>
    /// <seealso cref="WorkflowBase{IInventoryLocationRegionModel, IInventoryLocationRegionSearchModel, IInventoryLocationRegion, InventoryLocationRegion}"/>
    /// <seealso cref="IInventoryLocationRegionWorkflow"/>
    public partial class InventoryLocationRegionWorkflow
        : WorkflowBase<IInventoryLocationRegionModel, IInventoryLocationRegionSearchModel, IInventoryLocationRegion, InventoryLocationRegion>
            , IInventoryLocationRegionWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<InventoryLocationRegion?, string?, IInventoryLocationRegionModel?> MapFromConcreteFull
            => ModelMapperForInventoryLocationRegion.MapInventoryLocationRegionModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocationRegion>, string?, IEnumerable<IInventoryLocationRegionModel>> SelectLiteAndMapToModel
            => ModelMapperForInventoryLocationRegion.SelectLiteInventoryLocationRegionAndMapToInventoryLocationRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocationRegion>, string?, IEnumerable<IInventoryLocationRegionModel>> SelectListAndMapToModel
            => ModelMapperForInventoryLocationRegion.SelectListInventoryLocationRegionAndMapToInventoryLocationRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocationRegion>, string?, IInventoryLocationRegionModel?> SelectFirstFullAndMapToModel
            => ModelMapperForInventoryLocationRegion.SelectFirstFullInventoryLocationRegionAndMapToInventoryLocationRegionModel;

        /// <inheritdoc/>
        protected override Func<IInventoryLocationRegion, IInventoryLocationRegionModel, DateTime, DateTime?, IInventoryLocationRegion> UpdateEntityFromModel
            => ModelMapperForInventoryLocationRegion.UpdateInventoryLocationRegionFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<InventoryLocationRegion>> FilterQueryByModelExtensionAsync(
            IQueryable<InventoryLocationRegion> query,
            IInventoryLocationRegionSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterInventoryLocationRegionsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IInventoryLocationRegion entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Slave!.UpdateRegionFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the InventoryLocationRegion entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.SlaveID = 0;
                entity.Slave = (Region)resolved.Result!.CreateRegionEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the InventoryLocationRegion entity");
        }
