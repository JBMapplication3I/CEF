// <autogenerated>
// <copyright file="InventoryLocationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for InventoryLocation entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IInventoryLocationModel, IInventoryLocationSearchModel, IInventoryLocation, InventoryLocation}"/>
    /// <seealso cref="IInventoryLocationWorkflow"/>
    public partial class InventoryLocationWorkflow
        : NameableWorkflowBase<IInventoryLocationModel, IInventoryLocationSearchModel, IInventoryLocation, InventoryLocation>
            , IInventoryLocationWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<InventoryLocation?, string?, IInventoryLocationModel?> MapFromConcreteFull
            => ModelMapperForInventoryLocation.MapInventoryLocationModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocation>, string?, IEnumerable<IInventoryLocationModel>> SelectLiteAndMapToModel
            => ModelMapperForInventoryLocation.SelectLiteInventoryLocationAndMapToInventoryLocationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocation>, string?, IEnumerable<IInventoryLocationModel>> SelectListAndMapToModel
            => ModelMapperForInventoryLocation.SelectListInventoryLocationAndMapToInventoryLocationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<InventoryLocation>, string?, IInventoryLocationModel?> SelectFirstFullAndMapToModel
            => ModelMapperForInventoryLocation.SelectFirstFullInventoryLocationAndMapToInventoryLocationModel;

        /// <inheritdoc/>
        protected override Func<IInventoryLocation, IInventoryLocationModel, DateTime, DateTime?, IInventoryLocation> UpdateEntityFromModel
            => ModelMapperForInventoryLocation.UpdateInventoryLocationFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<InventoryLocation>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterInventoryLocationsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Brands != null) { await Workflows.InventoryLocationWithBrandsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            if (model.Sections != null) { await Workflows.InventoryLocationWithSectionsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Contact to the InventoryLocation entity");
        }
