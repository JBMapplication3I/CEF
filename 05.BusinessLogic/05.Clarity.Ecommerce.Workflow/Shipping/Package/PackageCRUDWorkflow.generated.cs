// <autogenerated>
// <copyright file="PackageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for Package entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IPackageModel, IPackageSearchModel, IPackage, Package}"/>
    /// <seealso cref="IPackageWorkflow"/>
    public partial class PackageWorkflow
        : NameableWorkflowBase<IPackageModel, IPackageSearchModel, IPackage, Package>
            , IPackageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<Package?, string?, IPackageModel?> MapFromConcreteFull
            => ModelMapperForPackage.MapPackageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<Package>, string?, IEnumerable<IPackageModel>> SelectLiteAndMapToModel
            => ModelMapperForPackage.SelectLitePackageAndMapToPackageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Package>, string?, IEnumerable<IPackageModel>> SelectListAndMapToModel
            => ModelMapperForPackage.SelectListPackageAndMapToPackageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Package>, string?, IPackageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPackage.SelectFirstFullPackageAndMapToPackageModel;

        /// <inheritdoc/>
        protected override Func<IPackage, IPackageModel, DateTime, DateTime?, IPackage> UpdateEntityFromModel
            => ModelMapperForPackage.UpdatePackageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<Package>> FilterQueryByModelExtensionAsync(
            IQueryable<Package> query,
            IPackageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPackagesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.PackageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdatePackageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the Package entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (PackageType)resolved.Result!.CreatePackageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the Package entity");
        }
