// <autogenerated>
// <copyright file="TaxRegionWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for TaxRegion entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ITaxRegionModel, ITaxRegionSearchModel, ITaxRegion, TaxRegion}"/>
    /// <seealso cref="ITaxRegionWorkflow"/>
    public partial class TaxRegionWorkflow
        : NameableWorkflowBase<ITaxRegionModel, ITaxRegionSearchModel, ITaxRegion, TaxRegion>
            , ITaxRegionWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<TaxRegion?, string?, ITaxRegionModel?> MapFromConcreteFull
            => ModelMapperForTaxRegion.MapTaxRegionModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<TaxRegion>, string?, IEnumerable<ITaxRegionModel>> SelectLiteAndMapToModel
            => ModelMapperForTaxRegion.SelectLiteTaxRegionAndMapToTaxRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<TaxRegion>, string?, IEnumerable<ITaxRegionModel>> SelectListAndMapToModel
            => ModelMapperForTaxRegion.SelectListTaxRegionAndMapToTaxRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<TaxRegion>, string?, ITaxRegionModel?> SelectFirstFullAndMapToModel
            => ModelMapperForTaxRegion.SelectFirstFullTaxRegionAndMapToTaxRegionModel;

        /// <inheritdoc/>
        protected override Func<ITaxRegion, ITaxRegionModel, DateTime, DateTime?, ITaxRegion> UpdateEntityFromModel
            => ModelMapperForTaxRegion.UpdateTaxRegionFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<TaxRegion>> FilterQueryByModelExtensionAsync(
            IQueryable<TaxRegion> query,
            ITaxRegionSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterTaxRegionsBySearchModel(search);
        }
        ...
        /// <summary>Relate Required Region.</summary>
        /// <exception cref="ArgumentNullException">Thrown when one or more required arguments are null.</exception>
        /// <param name="entity">            The entity that has a Required Region.</param>
        /// <param name="model">             The model that has a Required Region.</param>
        /// <param name="timestamp">         The timestamp Date/Time.</param>
        /// <param name="contextProfileName">Name of the context profile.</param>
        protected virtual async Task RelateRequiredRegionAsync(
            ITaxRegion entity,
            ITaxRegionModel model,
            DateTime timestamp,
            string? contextProfileName)
        {
            using var context = RegistryLoaderWrapper.GetContext(contextProfileName);
            await RelateRequiredRegionAsync(
                    entity,
                    model,
                    timestamp,
                    context)
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Regions.ResolveAsync(
                    ...
                    model: model.Region, // Manual name if not UserProductType and not Discount or Discount and not Master
                    context: context,
                    isInner: false)
                .ConfigureAwait(false);
            ...
            if (modelIDIsNull && modelObjectIsNull)
            {
                ...
                throw new ArgumentException("Cannot assign a null to a non-nullable RegionID");
            }
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive RegionID to the TaxRegion entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Region to the TaxRegion entity");
        }
...
#pragma warning restore 1998
            ...
            IClarityEcommerceEntities context)
        {
            ...
            await RelateRequiredRegionAsync(entity, model, timestamp, context).ConfigureAwait(false);
        }
