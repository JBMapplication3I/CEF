// <autogenerated>
// <copyright file="SampleRequestContactWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SampleRequestContact entities.</summary>
    /// <seealso cref="WorkflowBase{ISampleRequestContactModel, ISampleRequestContactSearchModel, ISampleRequestContact, SampleRequestContact}"/>
    /// <seealso cref="ISampleRequestContactWorkflow"/>
    public partial class SampleRequestContactWorkflow
        : WorkflowBase<ISampleRequestContactModel, ISampleRequestContactSearchModel, ISampleRequestContact, SampleRequestContact>
            , ISampleRequestContactWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SampleRequestContact?, string?, ISampleRequestContactModel?> MapFromConcreteFull
            => ModelMapperForSampleRequestContact.MapSampleRequestContactModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestContact>, string?, IEnumerable<ISampleRequestContactModel>> SelectLiteAndMapToModel
            => ModelMapperForSampleRequestContact.SelectLiteSampleRequestContactAndMapToSampleRequestContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestContact>, string?, IEnumerable<ISampleRequestContactModel>> SelectListAndMapToModel
            => ModelMapperForSampleRequestContact.SelectListSampleRequestContactAndMapToSampleRequestContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestContact>, string?, ISampleRequestContactModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSampleRequestContact.SelectFirstFullSampleRequestContactAndMapToSampleRequestContactModel;

        /// <inheritdoc/>
        protected override Func<ISampleRequestContact, ISampleRequestContactModel, DateTime, DateTime?, ISampleRequestContact> UpdateEntityFromModel
            => ModelMapperForSampleRequestContact.UpdateSampleRequestContactFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SampleRequestContact>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSampleRequestContactsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SampleRequestContact entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SampleRequestContact entity");
        }
