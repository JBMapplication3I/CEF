// <autogenerated>
// <copyright file="SampleRequestEventWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SampleRequestEvent entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISampleRequestEventModel, ISampleRequestEventSearchModel, ISampleRequestEvent, SampleRequestEvent}"/>
    /// <seealso cref="ISampleRequestEventWorkflow"/>
    public partial class SampleRequestEventWorkflow
        : NameableWorkflowBase<ISampleRequestEventModel, ISampleRequestEventSearchModel, ISampleRequestEvent, SampleRequestEvent>
            , ISampleRequestEventWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SampleRequestEvent?, string?, ISampleRequestEventModel?> MapFromConcreteFull
            => ModelMapperForSampleRequestEvent.MapSampleRequestEventModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestEvent>, string?, IEnumerable<ISampleRequestEventModel>> SelectLiteAndMapToModel
            => ModelMapperForSampleRequestEvent.SelectLiteSampleRequestEventAndMapToSampleRequestEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestEvent>, string?, IEnumerable<ISampleRequestEventModel>> SelectListAndMapToModel
            => ModelMapperForSampleRequestEvent.SelectListSampleRequestEventAndMapToSampleRequestEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestEvent>, string?, ISampleRequestEventModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSampleRequestEvent.SelectFirstFullSampleRequestEventAndMapToSampleRequestEventModel;

        /// <inheritdoc/>
        protected override Func<ISampleRequestEvent, ISampleRequestEventModel, DateTime, DateTime?, ISampleRequestEvent> UpdateEntityFromModel
            => ModelMapperForSampleRequestEvent.UpdateSampleRequestEventFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SampleRequestEvent>> FilterQueryByModelExtensionAsync(
            IQueryable<SampleRequestEvent> query,
            ISampleRequestEventSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSampleRequestEventsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISampleRequestEvent entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SampleRequestEventTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateSampleRequestEventTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SampleRequestEvent entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (SampleRequestEventType)resolved.Result!.CreateSampleRequestEventTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SampleRequestEvent entity");
        }
