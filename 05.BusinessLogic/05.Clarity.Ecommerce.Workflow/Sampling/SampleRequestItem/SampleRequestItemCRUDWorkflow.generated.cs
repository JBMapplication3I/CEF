// <autogenerated>
// <copyright file="SampleRequestItemWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SampleRequestItem entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesItemBaseModel, ISalesItemBaseSearchModel, ISampleRequestItem, SampleRequestItem}"/>
    /// <seealso cref="ISampleRequestItemWorkflow"/>
    public partial class SampleRequestItemWorkflow
        : NameableWorkflowBase<ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>, ISalesItemBaseSearchModel, ISampleRequestItem, SampleRequestItem>
            , ISampleRequestItemWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SampleRequestItem?, string?, ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>?> MapFromConcreteFull
            => ModelMapperForSampleRequestItem.MapSampleRequestItemModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>>> SelectLiteAndMapToModel
            => ModelMapperForSampleRequestItem.SelectLiteSampleRequestItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>>> SelectListAndMapToModel
            => ModelMapperForSampleRequestItem.SelectListSampleRequestItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestItem>, string?, ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>?> SelectFirstFullAndMapToModel
            => ModelMapperForSampleRequestItem.SelectFirstFullSampleRequestItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<ISampleRequestItem, ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>, DateTime, DateTime?, ISampleRequestItem> UpdateEntityFromModel
            => ModelMapperForSampleRequestItem.UpdateSampleRequestItemFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SampleRequestItem>> FilterQueryByModelExtensionAsync(
            IQueryable<SampleRequestItem> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSampleRequestItemsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISampleRequestItem entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Targets != null) { await Workflows.SampleRequestItemWithTargetsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.SampleRequestItemID = entity.ID;
                    }
                }
                await Workflows.SampleRequestItemWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Product to the SampleRequestItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SampleRequestItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given OriginalCurrency to the SampleRequestItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SellingCurrency to the SampleRequestItem entity");
        }
