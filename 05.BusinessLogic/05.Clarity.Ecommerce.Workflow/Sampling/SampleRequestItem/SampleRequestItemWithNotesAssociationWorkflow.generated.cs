// <autogenerated>
// <copyright file="SampleRequestItemWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sample Request Item Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISampleRequestItem, INoteModel, INote, Note}"/>
    /// <seealso cref="ISampleRequestItemWithNotesAssociationWorkflow"/>
    public partial class SampleRequestItemWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>, ISampleRequestItem, INoteModel, INote, Note>
        , ISampleRequestItemWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISampleRequestItem entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel> model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISampleRequestItem entity, INote newEntity)
        {
