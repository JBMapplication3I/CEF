// <autogenerated>
// <copyright file="SampleRequestItemWithTargetsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sample Request Item Targets association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISampleRequestItem, ISalesItemTargetBaseModel, ISampleRequestItemTarget, SampleRequestItemTarget}"/>
    /// <seealso cref="ISampleRequestItemWithTargetsAssociationWorkflow"/>
    public partial class SampleRequestItemWithTargetsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>, ISampleRequestItem, ISalesItemTargetBaseModel, ISampleRequestItemTarget, SampleRequestItemTarget>
        , ISampleRequestItemWithTargetsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SampleRequestItemTarget>? GetObjectsCollection(ISampleRequestItem entity) { return entity.Targets; }

        /// <inheritdoc/>
        protected override List<ISalesItemTargetBaseModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel> model) { return model.Targets; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISampleRequestItem entity, ISampleRequestItemTarget newEntity)
        {
            if (newEntity == null) { return; }
            entity.Targets!.Add((SampleRequestItemTarget)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(ISampleRequestItem entity)
        {
            ...
            entity.Targets = new HashSet<SampleRequestItemTarget>();
        }

        /// <inheritdoc/>
        protected override async Task DeactivateObjectAsync(ISampleRequestItemTarget entity, DateTime timestamp)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<bool> MatchObjectModelWithObjectEntityAsync(ISalesItemTargetBaseModel model, ISampleRequestItemTarget entity, IClarityEcommerceEntities context)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<ISampleRequestItemTarget> ModelToNewObjectAsync(
            ...
            var thisEntityTypeID = Contract.CheckValidID(model.TypeID)
                ...
                : model.Type != null && Contract.CheckValidID(model.Type.ID)
                    ...
                    : UpsertThisEntityTypeAndGetID(
                        ...
                        timestamp,
                        context);
            if (thisEntityTypeID <= 0) { throw new ArgumentException("SampleRequestItemTarget requires a valid Type."); }
            // Create a new entity and populate it with data
            var newEntity = model.CreateSampleRequestItemTargetEntity(timestamp, context.ContextProfileName);
