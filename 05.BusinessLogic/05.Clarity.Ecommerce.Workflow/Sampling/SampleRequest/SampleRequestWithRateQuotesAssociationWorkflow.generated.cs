// <autogenerated>
// <copyright file="SampleRequestWithRateQuotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sample Request Rate Quotes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISampleRequestModel, ISampleRequest, IRateQuoteModel, IRateQuote, RateQuote}"/>
    /// <seealso cref="ISampleRequestWithRateQuotesAssociationWorkflow"/>
    public partial class SampleRequestWithRateQuotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISampleRequestModel, ISampleRequest, IRateQuoteModel, IRateQuote, RateQuote>
        , ISampleRequestWithRateQuotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<RateQuote>? GetObjectsCollection(ISampleRequest entity) { return entity.RateQuotes; }

        /// <inheritdoc/>
        protected override List<IRateQuoteModel>? GetModelObjectsList(ISampleRequestModel model) { return model.RateQuotes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISampleRequest entity, IRateQuote newEntity)
        {
