// <autogenerated>
// <copyright file="SampleRequestWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sample Request Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISampleRequestModel, ISampleRequest, INoteModel, INote, Note}"/>
    /// <seealso cref="ISampleRequestWithNotesAssociationWorkflow"/>
    public partial class SampleRequestWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISampleRequestModel, ISampleRequest, INoteModel, INote, Note>
        , ISampleRequestWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISampleRequest entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISampleRequestModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISampleRequest entity, INote newEntity)
        {
