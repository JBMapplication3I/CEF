// <copyright file="SampleRequestWithContactsAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2017-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate sample request contacts workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class SampleRequestWithContactsAssociationWorkflow
    {
        ...
        protected override Task ModelToNewObjectAdditionalPropertiesAsync(
            ISampleRequestContact newEntity,
            ISampleRequestContactModel model,
            DateTime timestamp,
            IClarityEcommerceEntities context)
        {
