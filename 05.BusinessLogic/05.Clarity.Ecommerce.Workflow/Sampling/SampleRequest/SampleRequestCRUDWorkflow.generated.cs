// <autogenerated>
// <copyright file="SampleRequestWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SampleRequest entities.</summary>
    /// <seealso cref="SalesCollectionWorkflowBase{ISampleRequestModel, ISampleRequestSearchModel, ISampleRequest, SampleRequest, SampleRequestStatus, SampleRequestType, ITypeModel, ISampleRequestItem, SampleRequestItem, AppliedSampleRequestDiscount, SampleRequestState, SampleRequestFile, ISampleRequestFileModel, SampleRequestContact, ISampleRequestContactModel, SampleRequestEvent, ISampleRequestEventModel, SampleRequestEventType, AppliedSampleRequestItemDiscount, SampleRequestItemTarget, IAppliedSampleRequestDiscountModel, IAppliedSampleRequestItemDiscountModel}"/>
    /// <seealso cref="ISampleRequestWorkflow"/>
    public partial class SampleRequestWorkflow
        : SalesCollectionWorkflowBase<ISampleRequestModel,
            ...
            , ISampleRequestWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SampleRequest?, string?, ISampleRequestModel?> MapFromConcreteFull
            => ModelMapperForSampleRequest.MapSampleRequestModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequest>, string?, IEnumerable<ISampleRequestModel>> SelectLiteAndMapToModel
            => ModelMapperForSampleRequest.SelectLiteSampleRequestAndMapToSampleRequestModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequest>, string?, IEnumerable<ISampleRequestModel>> SelectListAndMapToModel
            => ModelMapperForSampleRequest.SelectListSampleRequestAndMapToSampleRequestModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequest>, string?, ISampleRequestModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSampleRequest.SelectFirstFullSampleRequestAndMapToSampleRequestModel;

        /// <inheritdoc/>
        protected override Func<ISampleRequest, ISampleRequestModel, DateTime, DateTime?, ISampleRequest> UpdateEntityFromModel
            => ModelMapperForSampleRequest.UpdateSampleRequestFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SampleRequest>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.SampleRequestID = entity.ID;
                    }
                }
                await Workflows.SampleRequestWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
            if (model.SalesItems != null) { await Workflows.SampleRequestWithSalesItemsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: Discounts
            if (model.StoredFiles != null) { await Workflows.SampleRequestWithStoredFilesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Contacts != null) { await Workflows.SampleRequestWithContactsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: SalesEvents
            if (model.RateQuotes != null) { await Workflows.SampleRequestWithRateQuotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesGroups.ResolveWithAutoGenerateOptionalAsync(
                    byID: model.SalesGroupID, // By Other ID
                    byKey: model.SalesGroupKey, // By Flattened Other Key
                    model: model.SalesGroup, // The other property as a model
                    context: context)
                .ConfigureAwait(false);
            ...
            if (!entityIDIsNull && modelObjectIsActive)
            {
                ...
                entity.SalesGroupID = null;
                entity.SalesGroup = (SalesGroup)resolved.Result!.CreateSalesGroupEntity(timestamp, context.ContextProfileName);
                return;
            }
            if (entityIDIsNull && modelObjectIsActive)
            {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SalesGroup to the SampleRequest entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Account to the SampleRequest entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the SampleRequest entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Franchise to the SampleRequest entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the SampleRequest entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SampleRequest entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SampleRequestStatuses.ResolveWithAutoGenerateOptionalAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SampleRequestStates.ResolveWithAutoGenerateOptionalAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SampleRequestTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BillingContact to the SampleRequest entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given ShippingContact to the SampleRequest entity");
        }
