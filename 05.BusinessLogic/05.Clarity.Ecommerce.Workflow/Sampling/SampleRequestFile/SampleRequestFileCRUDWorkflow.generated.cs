// <autogenerated>
// <copyright file="SampleRequestFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SampleRequestFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISampleRequestFileModel, ISampleRequestFileSearchModel, ISampleRequestFile, SampleRequestFile}"/>
    /// <seealso cref="ISampleRequestFileWorkflow"/>
    public partial class SampleRequestFileWorkflow
        : NameableWorkflowBase<ISampleRequestFileModel, ISampleRequestFileSearchModel, ISampleRequestFile, SampleRequestFile>
            , ISampleRequestFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SampleRequestFile?, string?, ISampleRequestFileModel?> MapFromConcreteFull
            => ModelMapperForSampleRequestFile.MapSampleRequestFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestFile>, string?, IEnumerable<ISampleRequestFileModel>> SelectLiteAndMapToModel
            => ModelMapperForSampleRequestFile.SelectLiteSampleRequestFileAndMapToSampleRequestFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestFile>, string?, IEnumerable<ISampleRequestFileModel>> SelectListAndMapToModel
            => ModelMapperForSampleRequestFile.SelectListSampleRequestFileAndMapToSampleRequestFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestFile>, string?, ISampleRequestFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSampleRequestFile.SelectFirstFullSampleRequestFileAndMapToSampleRequestFileModel;

        /// <inheritdoc/>
        protected override Func<ISampleRequestFile, ISampleRequestFileModel, DateTime, DateTime?, ISampleRequestFile> UpdateEntityFromModel
            => ModelMapperForSampleRequestFile.UpdateSampleRequestFileFromModel;
        #endregion
        ...
        {
            return await context.Set<SampleRequestFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<ISampleRequestFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<ISampleRequestFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<SampleRequestFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<SampleRequestFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<SampleRequestFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<SampleRequestFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<SampleRequestFile>> FilterQueryByModelExtensionAsync(
            IQueryable<SampleRequestFile> query,
            ISampleRequestFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSampleRequestFilesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISampleRequestFile entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SampleRequestFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SampleRequestFile entity");
        }
