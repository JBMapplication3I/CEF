// <autogenerated>
// <copyright file="SampleRequestItemTargetWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SampleRequestItemTarget entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ISampleRequestItemTarget, SampleRequestItemTarget}"/>
    /// <seealso cref="ISampleRequestItemTargetWorkflow"/>
    public partial class SampleRequestItemTargetWorkflow
        : WorkflowBase<ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ISampleRequestItemTarget, SampleRequestItemTarget>
            , ISampleRequestItemTargetWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SampleRequestItemTarget?, string?, ISalesItemTargetBaseModel?> MapFromConcreteFull
            => ModelMapperForSampleRequestItemTarget.MapSampleRequestItemTargetModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectLiteAndMapToModel
            => ModelMapperForSampleRequestItemTarget.SelectLiteSampleRequestItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectListAndMapToModel
            => ModelMapperForSampleRequestItemTarget.SelectListSampleRequestItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SampleRequestItemTarget>, string?, ISalesItemTargetBaseModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSampleRequestItemTarget.SelectFirstFullSampleRequestItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<ISampleRequestItemTarget, ISalesItemTargetBaseModel, DateTime, DateTime?, ISampleRequestItemTarget> UpdateEntityFromModel
            => ModelMapperForSampleRequestItemTarget.UpdateSampleRequestItemTargetFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SampleRequestItemTarget>> FilterQueryByModelExtensionAsync(
            IQueryable<SampleRequestItemTarget> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSampleRequestItemTargetsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISampleRequestItemTarget entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SampleRequestItemTarget entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SampleRequestItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive DestinationContactID to the SampleRequestItemTarget entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given DestinationContact to the SampleRequestItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BrandProduct to the SampleRequestItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SelectedRateQuote to the SampleRequestItemTarget entity");
        }
