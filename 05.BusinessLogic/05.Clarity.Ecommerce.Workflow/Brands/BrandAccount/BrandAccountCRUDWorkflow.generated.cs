// <autogenerated>
// <copyright file="BrandAccountWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandAccount entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandAccountModel, IBrandAccountSearchModel, IBrandAccount, BrandAccount}"/>
    /// <seealso cref="IBrandAccountWorkflow"/>
    public partial class BrandAccountWorkflow
        : WorkflowBase<IBrandAccountModel, IBrandAccountSearchModel, IBrandAccount, BrandAccount>
            , IBrandAccountWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandAccount?, string?, IBrandAccountModel?> MapFromConcreteFull
            => ModelMapperForBrandAccount.MapBrandAccountModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandAccount>, string?, IEnumerable<IBrandAccountModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandAccount.SelectLiteBrandAccountAndMapToBrandAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandAccount>, string?, IEnumerable<IBrandAccountModel>> SelectListAndMapToModel
            => ModelMapperForBrandAccount.SelectListBrandAccountAndMapToBrandAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandAccount>, string?, IBrandAccountModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandAccount.SelectFirstFullBrandAccountAndMapToBrandAccountModel;

        /// <inheritdoc/>
        protected override Func<IBrandAccount, IBrandAccountModel, DateTime, DateTime?, IBrandAccount> UpdateEntityFromModel
            => ModelMapperForBrandAccount.UpdateBrandAccountFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandAccount>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandAccount> query,
            IBrandAccountSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandAccountsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandAccount entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandAccount entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandAccount entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandAccount entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given PricePoint to the BrandAccount entity");
        }
