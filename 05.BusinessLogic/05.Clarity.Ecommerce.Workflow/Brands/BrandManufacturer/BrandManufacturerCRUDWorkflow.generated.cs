// <autogenerated>
// <copyright file="BrandManufacturerWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandManufacturer entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandManufacturerModel, IBrandManufacturerSearchModel, IBrandManufacturer, BrandManufacturer}"/>
    /// <seealso cref="IBrandManufacturerWorkflow"/>
    public partial class BrandManufacturerWorkflow
        : WorkflowBase<IBrandManufacturerModel, IBrandManufacturerSearchModel, IBrandManufacturer, BrandManufacturer>
            , IBrandManufacturerWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandManufacturer?, string?, IBrandManufacturerModel?> MapFromConcreteFull
            => ModelMapperForBrandManufacturer.MapBrandManufacturerModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandManufacturer>, string?, IEnumerable<IBrandManufacturerModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandManufacturer.SelectLiteBrandManufacturerAndMapToBrandManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandManufacturer>, string?, IEnumerable<IBrandManufacturerModel>> SelectListAndMapToModel
            => ModelMapperForBrandManufacturer.SelectListBrandManufacturerAndMapToBrandManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandManufacturer>, string?, IBrandManufacturerModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandManufacturer.SelectFirstFullBrandManufacturerAndMapToBrandManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IBrandManufacturer, IBrandManufacturerModel, DateTime, DateTime?, IBrandManufacturer> UpdateEntityFromModel
            => ModelMapperForBrandManufacturer.UpdateBrandManufacturerFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandManufacturer>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandManufacturer> query,
            IBrandManufacturerSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandManufacturersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IBrandManufacturer entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandManufacturer entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandManufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandManufacturer entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandManufacturer entity");
        }
