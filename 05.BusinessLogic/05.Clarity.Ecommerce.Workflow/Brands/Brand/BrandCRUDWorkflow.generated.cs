// <autogenerated>
// <copyright file="BrandWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for Brand entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IBrandModel, IBrandSearchModel, IBrand, Brand}"/>
    /// <seealso cref="IBrandWorkflow"/>
    public partial class BrandWorkflow
        : NameableWorkflowBase<IBrandModel, IBrandSearchModel, IBrand, Brand>
            , IBrandWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<Brand?, string?, IBrandModel?> MapFromConcreteFull
            => ModelMapperForBrand.MapBrandModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<Brand>, string?, IEnumerable<IBrandModel>> SelectLiteAndMapToModel
            => ModelMapperForBrand.SelectLiteBrandAndMapToBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Brand>, string?, IEnumerable<IBrandModel>> SelectListAndMapToModel
            => ModelMapperForBrand.SelectListBrandAndMapToBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Brand>, string?, IBrandModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrand.SelectFirstFullBrandAndMapToBrandModel;

        /// <inheritdoc/>
        protected override Func<IBrand, IBrandModel, DateTime, DateTime?, IBrand> UpdateEntityFromModel
            => ModelMapperForBrand.UpdateBrandFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<Brand>> FilterQueryByModelExtensionAsync(
            IQueryable<Brand> query,
            IBrandSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Products != null) { await Workflows.BrandWithProductsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            // Skipped: Not supposed to map this property in via this manner: BrandInventoryLocations
            if (model.BrandLanguages != null) { await Workflows.BrandWithBrandLanguagesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderDollarAmountBufferProduct to the Brand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderQuantityAmountBufferProduct to the Brand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderDollarAmountBufferCategory to the Brand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderQuantityAmountBufferCategory to the Brand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingDollarAmountBufferProduct to the Brand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingQuantityAmountBufferProduct to the Brand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingDollarAmountBufferCategory to the Brand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingQuantityAmountBufferCategory to the Brand entity");
        }
