// <autogenerated>
// <copyright file="BrandWithFranchisesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Brand Franchises association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IBrandModel, IBrand, IBrandFranchiseModel, IBrandFranchise, BrandFranchise}"/>
    /// <seealso cref="IBrandWithFranchisesAssociationWorkflow"/>
    public partial class BrandWithFranchisesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<IBrandModel, IBrand, IBrandFranchiseModel, IBrandFranchise, BrandFranchise>
        , IBrandWithFranchisesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<BrandFranchise>? GetObjectsCollection(IBrand entity) { return entity.Franchises; }

        /// <inheritdoc/>
        protected override List<IBrandFranchiseModel>? GetModelObjectsList(IBrandModel model) { return model.Franchises; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IBrand entity, IBrandFranchise newEntity)
        {
            if (newEntity == null) { return; }
            entity.Franchises!.Add((BrandFranchise)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(IBrand entity)
        {
            ...
            entity.Franchises = new HashSet<BrandFranchise>();
        }
