// <autogenerated>
// <copyright file="BrandWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Brand Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IBrandModel, IBrand, INoteModel, INote, Note}"/>
    /// <seealso cref="IBrandWithNotesAssociationWorkflow"/>
    public partial class BrandWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<IBrandModel, IBrand, INoteModel, INote, Note>
        , IBrandWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IBrand entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(IBrandModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IBrand entity, INote newEntity)
        {
