// <autogenerated>
// <copyright file="BrandSiteDomainWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandSiteDomain entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandSiteDomainModel, IBrandSiteDomainSearchModel, IBrandSiteDomain, BrandSiteDomain}"/>
    /// <seealso cref="IBrandSiteDomainWorkflow"/>
    public partial class BrandSiteDomainWorkflow
        : WorkflowBase<IBrandSiteDomainModel, IBrandSiteDomainSearchModel, IBrandSiteDomain, BrandSiteDomain>
            , IBrandSiteDomainWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandSiteDomain?, string?, IBrandSiteDomainModel?> MapFromConcreteFull
            => ModelMapperForBrandSiteDomain.MapBrandSiteDomainModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandSiteDomain>, string?, IEnumerable<IBrandSiteDomainModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandSiteDomain.SelectLiteBrandSiteDomainAndMapToBrandSiteDomainModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandSiteDomain>, string?, IEnumerable<IBrandSiteDomainModel>> SelectListAndMapToModel
            => ModelMapperForBrandSiteDomain.SelectListBrandSiteDomainAndMapToBrandSiteDomainModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandSiteDomain>, string?, IBrandSiteDomainModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandSiteDomain.SelectFirstFullBrandSiteDomainAndMapToBrandSiteDomainModel;

        /// <inheritdoc/>
        protected override Func<IBrandSiteDomain, IBrandSiteDomainModel, DateTime, DateTime?, IBrandSiteDomain> UpdateEntityFromModel
            => ModelMapperForBrandSiteDomain.UpdateBrandSiteDomainFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandSiteDomain>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandSiteDomain> query,
            IBrandSiteDomainSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandSiteDomainsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IBrandSiteDomain entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandSiteDomain entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandSiteDomain entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateSiteDomainFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandSiteDomain entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (SiteDomain)resolved.Result!.CreateSiteDomainEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandSiteDomain entity");
        }
