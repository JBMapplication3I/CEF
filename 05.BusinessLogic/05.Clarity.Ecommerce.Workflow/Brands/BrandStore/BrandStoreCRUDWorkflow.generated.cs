// <autogenerated>
// <copyright file="BrandStoreWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandStore entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandStoreModel, IBrandStoreSearchModel, IBrandStore, BrandStore}"/>
    /// <seealso cref="IBrandStoreWorkflow"/>
    public partial class BrandStoreWorkflow
        : WorkflowBase<IBrandStoreModel, IBrandStoreSearchModel, IBrandStore, BrandStore>
            , IBrandStoreWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandStore?, string?, IBrandStoreModel?> MapFromConcreteFull
            => ModelMapperForBrandStore.MapBrandStoreModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandStore>, string?, IEnumerable<IBrandStoreModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandStore.SelectLiteBrandStoreAndMapToBrandStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandStore>, string?, IEnumerable<IBrandStoreModel>> SelectListAndMapToModel
            => ModelMapperForBrandStore.SelectListBrandStoreAndMapToBrandStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandStore>, string?, IBrandStoreModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandStore.SelectFirstFullBrandStoreAndMapToBrandStoreModel;

        /// <inheritdoc/>
        protected override Func<IBrandStore, IBrandStoreModel, DateTime, DateTime?, IBrandStore> UpdateEntityFromModel
            => ModelMapperForBrandStore.UpdateBrandStoreFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandStore>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandStore> query,
            IBrandStoreSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandStoresBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandStore entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandStore entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandStore entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandStore entity");
        }
