// <autogenerated>
// <copyright file="BrandVendorWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandVendor entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandVendorModel, IBrandVendorSearchModel, IBrandVendor, BrandVendor}"/>
    /// <seealso cref="IBrandVendorWorkflow"/>
    public partial class BrandVendorWorkflow
        : WorkflowBase<IBrandVendorModel, IBrandVendorSearchModel, IBrandVendor, BrandVendor>
            , IBrandVendorWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandVendor?, string?, IBrandVendorModel?> MapFromConcreteFull
            => ModelMapperForBrandVendor.MapBrandVendorModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandVendor>, string?, IEnumerable<IBrandVendorModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandVendor.SelectLiteBrandVendorAndMapToBrandVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandVendor>, string?, IEnumerable<IBrandVendorModel>> SelectListAndMapToModel
            => ModelMapperForBrandVendor.SelectListBrandVendorAndMapToBrandVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandVendor>, string?, IBrandVendorModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandVendor.SelectFirstFullBrandVendorAndMapToBrandVendorModel;

        /// <inheritdoc/>
        protected override Func<IBrandVendor, IBrandVendorModel, DateTime, DateTime?, IBrandVendor> UpdateEntityFromModel
            => ModelMapperForBrandVendor.UpdateBrandVendorFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandVendor>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandVendor> query,
            IBrandVendorSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandVendorsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandVendor entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandVendor entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandVendor entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandVendor entity");
        }
