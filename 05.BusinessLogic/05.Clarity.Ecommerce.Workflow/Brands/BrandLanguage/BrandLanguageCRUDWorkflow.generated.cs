// <autogenerated>
// <copyright file="BrandLanguageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandLanguage entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandLanguageModel, IBrandLanguageSearchModel, IBrandLanguage, BrandLanguage}"/>
    /// <seealso cref="IBrandLanguageWorkflow"/>
    public partial class BrandLanguageWorkflow
        : WorkflowBase<IBrandLanguageModel, IBrandLanguageSearchModel, IBrandLanguage, BrandLanguage>
            , IBrandLanguageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandLanguage?, string?, IBrandLanguageModel?> MapFromConcreteFull
            => ModelMapperForBrandLanguage.MapBrandLanguageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandLanguage>, string?, IEnumerable<IBrandLanguageModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandLanguage.SelectLiteBrandLanguageAndMapToBrandLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandLanguage>, string?, IEnumerable<IBrandLanguageModel>> SelectListAndMapToModel
            => ModelMapperForBrandLanguage.SelectListBrandLanguageAndMapToBrandLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandLanguage>, string?, IBrandLanguageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandLanguage.SelectFirstFullBrandLanguageAndMapToBrandLanguageModel;

        /// <inheritdoc/>
        protected override Func<IBrandLanguage, IBrandLanguageModel, DateTime, DateTime?, IBrandLanguage> UpdateEntityFromModel
            => ModelMapperForBrandLanguage.UpdateBrandLanguageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandLanguage>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandLanguage> query,
            IBrandLanguageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandLanguagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IBrandLanguage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandLanguage entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandLanguage entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandLanguage entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandLanguage entity");
        }
