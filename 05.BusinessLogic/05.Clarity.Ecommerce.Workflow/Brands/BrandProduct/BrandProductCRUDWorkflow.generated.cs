// <autogenerated>
// <copyright file="BrandProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandProduct entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandProductModel, IBrandProductSearchModel, IBrandProduct, BrandProduct}"/>
    /// <seealso cref="IBrandProductWorkflow"/>
    public partial class BrandProductWorkflow
        : WorkflowBase<IBrandProductModel, IBrandProductSearchModel, IBrandProduct, BrandProduct>
            , IBrandProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandProduct?, string?, IBrandProductModel?> MapFromConcreteFull
            => ModelMapperForBrandProduct.MapBrandProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandProduct>, string?, IEnumerable<IBrandProductModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandProduct.SelectLiteBrandProductAndMapToBrandProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandProduct>, string?, IEnumerable<IBrandProductModel>> SelectListAndMapToModel
            => ModelMapperForBrandProduct.SelectListBrandProductAndMapToBrandProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandProduct>, string?, IBrandProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandProduct.SelectFirstFullBrandProductAndMapToBrandProductModel;

        /// <inheritdoc/>
        protected override Func<IBrandProduct, IBrandProductModel, DateTime, DateTime?, IBrandProduct> UpdateEntityFromModel
            => ModelMapperForBrandProduct.UpdateBrandProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandProduct>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandProductsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandProduct entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandProduct entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandProduct entity");
        }
