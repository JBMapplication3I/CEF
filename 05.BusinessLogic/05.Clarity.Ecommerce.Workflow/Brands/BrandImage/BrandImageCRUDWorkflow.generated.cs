// <autogenerated>
// <copyright file="BrandImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IBrandImageModel, IBrandImageSearchModel, IBrandImage, BrandImage}"/>
    /// <seealso cref="IBrandImageWorkflow"/>
    public partial class BrandImageWorkflow
        : NameableWorkflowBase<IBrandImageModel, IBrandImageSearchModel, IBrandImage, BrandImage>
            , IBrandImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandImage?, string?, IBrandImageModel?> MapFromConcreteFull
            => ModelMapperForBrandImage.MapBrandImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandImage>, string?, IEnumerable<IBrandImageModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandImage.SelectLiteBrandImageAndMapToBrandImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandImage>, string?, IEnumerable<IBrandImageModel>> SelectListAndMapToModel
            => ModelMapperForBrandImage.SelectListBrandImageAndMapToBrandImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandImage>, string?, IBrandImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandImage.SelectFirstFullBrandImageAndMapToBrandImageModel;

        /// <inheritdoc/>
        protected override Func<IBrandImage, IBrandImageModel, DateTime, DateTime?, IBrandImage> UpdateEntityFromModel
            => ModelMapperForBrandImage.UpdateBrandImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandImage>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandImage> query,
            IBrandImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandImagesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.BrandImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateBrandImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the BrandImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (BrandImageType)resolved.Result!.CreateBrandImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the BrandImage entity");
        }
