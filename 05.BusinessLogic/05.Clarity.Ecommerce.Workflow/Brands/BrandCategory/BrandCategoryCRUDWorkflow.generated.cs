// <autogenerated>
// <copyright file="BrandCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandCategory entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandCategoryModel, IBrandCategorySearchModel, IBrandCategory, BrandCategory}"/>
    /// <seealso cref="IBrandCategoryWorkflow"/>
    public partial class BrandCategoryWorkflow
        : WorkflowBase<IBrandCategoryModel, IBrandCategorySearchModel, IBrandCategory, BrandCategory>
            , IBrandCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandCategory?, string?, IBrandCategoryModel?> MapFromConcreteFull
            => ModelMapperForBrandCategory.MapBrandCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandCategory>, string?, IEnumerable<IBrandCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandCategory.SelectLiteBrandCategoryAndMapToBrandCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandCategory>, string?, IEnumerable<IBrandCategoryModel>> SelectListAndMapToModel
            => ModelMapperForBrandCategory.SelectListBrandCategoryAndMapToBrandCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandCategory>, string?, IBrandCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandCategory.SelectFirstFullBrandCategoryAndMapToBrandCategoryModel;

        /// <inheritdoc/>
        protected override Func<IBrandCategory, IBrandCategoryModel, DateTime, DateTime?, IBrandCategory> UpdateEntityFromModel
            => ModelMapperForBrandCategory.UpdateBrandCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandCategory>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandCategory> query,
            IBrandCategorySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandCategoriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IBrandCategory entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandCategory entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandCategory entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandCategory entity");
        }
