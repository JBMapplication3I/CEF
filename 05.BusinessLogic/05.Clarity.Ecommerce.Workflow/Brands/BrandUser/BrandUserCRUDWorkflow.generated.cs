// <autogenerated>
// <copyright file="BrandUserWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandUser entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandUserModel, IBrandUserSearchModel, IBrandUser, BrandUser}"/>
    /// <seealso cref="IBrandUserWorkflow"/>
    public partial class BrandUserWorkflow
        : WorkflowBase<IBrandUserModel, IBrandUserSearchModel, IBrandUser, BrandUser>
            , IBrandUserWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandUser?, string?, IBrandUserModel?> MapFromConcreteFull
            => ModelMapperForBrandUser.MapBrandUserModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandUser>, string?, IEnumerable<IBrandUserModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandUser.SelectLiteBrandUserAndMapToBrandUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandUser>, string?, IEnumerable<IBrandUserModel>> SelectListAndMapToModel
            => ModelMapperForBrandUser.SelectListBrandUserAndMapToBrandUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandUser>, string?, IBrandUserModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandUser.SelectFirstFullBrandUserAndMapToBrandUserModel;

        /// <inheritdoc/>
        protected override Func<IBrandUser, IBrandUserModel, DateTime, DateTime?, IBrandUser> UpdateEntityFromModel
            => ModelMapperForBrandUser.UpdateBrandUserFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandUser>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandUser> query,
            IBrandUserSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandUsersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandUser entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandUser entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandUser entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandUser entity");
        }
