// <autogenerated>
// <copyright file="PurchaseOrderFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PurchaseOrderFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IPurchaseOrderFileModel, IPurchaseOrderFileSearchModel, IPurchaseOrderFile, PurchaseOrderFile}"/>
    /// <seealso cref="IPurchaseOrderFileWorkflow"/>
    public partial class PurchaseOrderFileWorkflow
        : NameableWorkflowBase<IPurchaseOrderFileModel, IPurchaseOrderFileSearchModel, IPurchaseOrderFile, PurchaseOrderFile>
            , IPurchaseOrderFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PurchaseOrderFile?, string?, IPurchaseOrderFileModel?> MapFromConcreteFull
            => ModelMapperForPurchaseOrderFile.MapPurchaseOrderFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrderFile>, string?, IEnumerable<IPurchaseOrderFileModel>> SelectLiteAndMapToModel
            => ModelMapperForPurchaseOrderFile.SelectLitePurchaseOrderFileAndMapToPurchaseOrderFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrderFile>, string?, IEnumerable<IPurchaseOrderFileModel>> SelectListAndMapToModel
            => ModelMapperForPurchaseOrderFile.SelectListPurchaseOrderFileAndMapToPurchaseOrderFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrderFile>, string?, IPurchaseOrderFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPurchaseOrderFile.SelectFirstFullPurchaseOrderFileAndMapToPurchaseOrderFileModel;

        /// <inheritdoc/>
        protected override Func<IPurchaseOrderFile, IPurchaseOrderFileModel, DateTime, DateTime?, IPurchaseOrderFile> UpdateEntityFromModel
            => ModelMapperForPurchaseOrderFile.UpdatePurchaseOrderFileFromModel;
        #endregion
        ...
        {
            return await context.Set<PurchaseOrderFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<IPurchaseOrderFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<IPurchaseOrderFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<PurchaseOrderFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<PurchaseOrderFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<PurchaseOrderFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<PurchaseOrderFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<PurchaseOrderFile>> FilterQueryByModelExtensionAsync(
            IQueryable<PurchaseOrderFile> query,
            IPurchaseOrderFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPurchaseOrderFilesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IPurchaseOrderFile entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the PurchaseOrderFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the PurchaseOrderFile entity");
        }
