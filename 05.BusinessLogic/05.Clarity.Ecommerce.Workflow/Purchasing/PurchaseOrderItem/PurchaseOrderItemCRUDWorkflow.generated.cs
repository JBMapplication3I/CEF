// <autogenerated>
// <copyright file="PurchaseOrderItemWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PurchaseOrderItem entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesItemBaseModel, ISalesItemBaseSearchModel, IPurchaseOrderItem, PurchaseOrderItem}"/>
    /// <seealso cref="IPurchaseOrderItemWorkflow"/>
    public partial class PurchaseOrderItemWorkflow
        : NameableWorkflowBase<ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>, ISalesItemBaseSearchModel, IPurchaseOrderItem, PurchaseOrderItem>
            , IPurchaseOrderItemWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PurchaseOrderItem?, string?, ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>?> MapFromConcreteFull
            => ModelMapperForPurchaseOrderItem.MapPurchaseOrderItemModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrderItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>>> SelectLiteAndMapToModel
            => ModelMapperForPurchaseOrderItem.SelectLitePurchaseOrderItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrderItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>>> SelectListAndMapToModel
            => ModelMapperForPurchaseOrderItem.SelectListPurchaseOrderItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrderItem>, string?, ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>?> SelectFirstFullAndMapToModel
            => ModelMapperForPurchaseOrderItem.SelectFirstFullPurchaseOrderItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IPurchaseOrderItem, ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>, DateTime, DateTime?, IPurchaseOrderItem> UpdateEntityFromModel
            => ModelMapperForPurchaseOrderItem.UpdatePurchaseOrderItemFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PurchaseOrderItem>> FilterQueryByModelExtensionAsync(
            IQueryable<PurchaseOrderItem> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPurchaseOrderItemsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IPurchaseOrderItem entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Targets != null) { await Workflows.PurchaseOrderItemWithTargetsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.PurchaseOrderItemID = entity.ID;
                    }
                }
                await Workflows.PurchaseOrderItemWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Product to the PurchaseOrderItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the PurchaseOrderItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given OriginalCurrency to the PurchaseOrderItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SellingCurrency to the PurchaseOrderItem entity");
        }
