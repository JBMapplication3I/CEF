// <autogenerated>
// <copyright file="PurchaseOrderItemWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Purchase Order Item Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, IPurchaseOrderItem, INoteModel, INote, Note}"/>
    /// <seealso cref="IPurchaseOrderItemWithNotesAssociationWorkflow"/>
    public partial class PurchaseOrderItemWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>, IPurchaseOrderItem, INoteModel, INote, Note>
        , IPurchaseOrderItemWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IPurchaseOrderItem entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel> model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IPurchaseOrderItem entity, INote newEntity)
        {
