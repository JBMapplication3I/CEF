// <copyright file="PurchaseOrderContactCRUDWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2017-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the purchase order contact workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class PurchaseOrderContactWorkflow
    {
        ...
        {
            entity.UpdatePurchaseOrderContactFromModel(model, timestamp, Contract.CheckValidID(entity.ID) ? timestamp : null);
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<PurchaseOrderContact>> FilterQueryByModelCustomAsync(
