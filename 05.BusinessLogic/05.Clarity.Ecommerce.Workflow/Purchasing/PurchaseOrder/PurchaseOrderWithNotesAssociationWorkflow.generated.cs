// <autogenerated>
// <copyright file="PurchaseOrderWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Purchase Order Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IPurchaseOrderModel, IPurchaseOrder, INoteModel, INote, Note}"/>
    /// <seealso cref="IPurchaseOrderWithNotesAssociationWorkflow"/>
    public partial class PurchaseOrderWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<IPurchaseOrderModel, IPurchaseOrder, INoteModel, INote, Note>
        , IPurchaseOrderWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IPurchaseOrder entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(IPurchaseOrderModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IPurchaseOrder entity, INote newEntity)
        {
