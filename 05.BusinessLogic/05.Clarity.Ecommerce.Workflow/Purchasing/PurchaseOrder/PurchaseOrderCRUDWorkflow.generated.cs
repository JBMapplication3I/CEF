// <autogenerated>
// <copyright file="PurchaseOrderWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PurchaseOrder entities.</summary>
    /// <seealso cref="SalesCollectionWorkflowBase{IPurchaseOrderModel, IPurchaseOrderSearchModel, IPurchaseOrder, PurchaseOrder, PurchaseOrderStatus, PurchaseOrderType, ITypeModel, IPurchaseOrderItem, PurchaseOrderItem, AppliedPurchaseOrderDiscount, PurchaseOrderState, PurchaseOrderFile, IPurchaseOrderFileModel, PurchaseOrderContact, IPurchaseOrderContactModel, PurchaseOrderEvent, IPurchaseOrderEventModel, PurchaseOrderEventType, AppliedPurchaseOrderItemDiscount, PurchaseOrderItemTarget, IAppliedPurchaseOrderDiscountModel, IAppliedPurchaseOrderItemDiscountModel}"/>
    /// <seealso cref="IPurchaseOrderWorkflow"/>
    public partial class PurchaseOrderWorkflow
        : SalesCollectionWorkflowBase<IPurchaseOrderModel,
            ...
            , IPurchaseOrderWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PurchaseOrder?, string?, IPurchaseOrderModel?> MapFromConcreteFull
            => ModelMapperForPurchaseOrder.MapPurchaseOrderModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrder>, string?, IEnumerable<IPurchaseOrderModel>> SelectLiteAndMapToModel
            => ModelMapperForPurchaseOrder.SelectLitePurchaseOrderAndMapToPurchaseOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrder>, string?, IEnumerable<IPurchaseOrderModel>> SelectListAndMapToModel
            => ModelMapperForPurchaseOrder.SelectListPurchaseOrderAndMapToPurchaseOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PurchaseOrder>, string?, IPurchaseOrderModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPurchaseOrder.SelectFirstFullPurchaseOrderAndMapToPurchaseOrderModel;

        /// <inheritdoc/>
        protected override Func<IPurchaseOrder, IPurchaseOrderModel, DateTime, DateTime?, IPurchaseOrder> UpdateEntityFromModel
            => ModelMapperForPurchaseOrder.UpdatePurchaseOrderFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PurchaseOrder>> FilterQueryByModelExtensionAsync(
            IQueryable<PurchaseOrder> query,
            IPurchaseOrderSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPurchaseOrdersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.PurchaseOrderID = entity.ID;
                    }
                }
                await Workflows.PurchaseOrderWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
            if (model.AssociatedSalesOrders != null) { await Workflows.PurchaseOrderWithAssociatedSalesOrdersAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.SalesItems != null) { await Workflows.PurchaseOrderWithSalesItemsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: Discounts
            if (model.StoredFiles != null) { await Workflows.PurchaseOrderWithStoredFilesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Contacts != null) { await Workflows.PurchaseOrderWithContactsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: SalesEvents
            if (model.RateQuotes != null) { await Workflows.PurchaseOrderWithRateQuotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }

        #region Relate Workflows
        /// <summary>Relate Optional InventoryLocation.</summary>
        /// <exception cref="ArgumentNullException">Thrown when one or more required arguments are null.</exception>
        /// <param name="entity">            The entity that has a Optional InventoryLocation.</param>
        /// <param name="model">             The model that has a Optional InventoryLocation.</param>
        /// <param name="timestamp">         The timestamp Date/Time.</param>
        /// <param name="contextProfileName">Name of the context profile.</param>
        protected virtual async Task RelateOptionalInventoryLocationAsync(
            IPurchaseOrder entity,
            IPurchaseOrderModel model,
            DateTime timestamp,
            string? contextProfileName)
        {
            using var context = RegistryLoaderWrapper.GetContext(contextProfileName);
            await RelateOptionalInventoryLocationAsync(
                    entity,
                    model,
                    timestamp,
                    context)
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.InventoryLocations.ResolveAsync(
                    ...
                    model: model.InventoryLocation, // Manual name if not UserProductType and not Discount or Discount and not Master
                    context: context,
                    isInner: true)
                .ConfigureAwait(false);
            ...
            if (!modelObjectIsNull && !modelObjectIDIsNull)
            {
                ...
                entity.InventoryLocationID = null;
            ...
            if (!entityIDIsNull && modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot create a new record of type 'InventoryLocation' in this manner.");
            }
            if (entityIDIsNull && modelObjectIsActive)
            {
            ...
            //     entity.InventoryLocation.UpdateInventoryLocationFromModel(resolved.Result, updateTimestamp);
            //     return;
            // }
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given InventoryLocation to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given ShipCarrier to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Vendor to the PurchaseOrder entity");
        }

        /// <summary>Relate Optional SalesGroup.</summary>
        /// <exception cref="ArgumentNullException">Thrown when one or more required arguments are null.</exception>
        /// <param name="entity">            The entity that has a Optional SalesGroup.</param>
        /// <param name="model">             The model that has a Optional SalesGroup.</param>
        /// <param name="timestamp">         The timestamp Date/Time.</param>
        /// <param name="contextProfileName">Name of the context profile.</param>
        protected virtual async Task RelateOptionalSalesGroupAsync(
            IPurchaseOrder entity,
            IPurchaseOrderModel model,
            DateTime timestamp,
            string? contextProfileName)
        {
            using var context = RegistryLoaderWrapper.GetContext(contextProfileName);
            await RelateOptionalSalesGroupAsync(
                    entity,
                    model,
                    timestamp,
                    context)
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesGroups.ResolveAsync(
                    byID: model.SalesGroupID, // By Other ID
                    byKey: model.SalesGroupKey, // By Flattened Other Key
                    model: model.SalesGroup, // Manual name if not UserProductType and not Discount or Discount and not Master
                    context: context,
                    isInner: true)
                .ConfigureAwait(false);
            // Check for IDs and objects
            var entityIDIsNull = !Contract.CheckValidID(entity.SalesGroupID);
            var modelIDIsNull = !Contract.CheckValidID(resolved.Result?.ID);
            var entityObjectIsNull = entity.SalesGroup == null;
            if (!resolved.ActionSucceeded && model.SalesGroup != null)
            {
                resolved.Result = model.SalesGroup;
            }
            var modelObjectIsNull = !resolved.ActionSucceeded;
            if (entityIDIsNull && modelIDIsNull && entityObjectIsNull && modelObjectIsNull)
            {
            ...
            var entityIDAndModelIDHaveSameID = !entityIDIsNull && !modelIDIsNull && entity.SalesGroupID == resolved.Result!.ID;
            var entityObjectAndModelObjectHaveSameID = !entityObjectIsNull && !modelObjectIsNull && entity.SalesGroupID == resolved.Result!.ID;
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                // [Optional/Required] Scenario 2: They match IDs, just update the entity from the model if it is present
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.SalesGroup!.UpdateSalesGroupFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            {
                // [Optional/Required] Scenario 3: We have IDs but they don't match, assign the model's ID to the entity's ID
                entity.SalesGroupID = resolved.Result!.ID;
                if (!modelObjectIsNull)
                {
                    if (!entityObjectIsNull)
                    {
            ...
            //     // TODO: Determine 'Equals' object between the objects so we only update if different
            //     // [Optional] Scenario 9: We have data on both sides, update the object, assign the values using the Update action
            //     entity.SalesGroup.UpdateSalesGroupFromModel(resolved.Result, updateTimestamp);
            //     return;
            // }
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SalesGroup to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Account to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Franchise to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.PurchaseOrderStatuses.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Status!.UpdatePurchaseOrderStatusFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive StatusID to the PurchaseOrder entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.StatusID = 0;
                entity.Status = (PurchaseOrderStatus)resolved.Result!.CreatePurchaseOrderStatusEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Status to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.PurchaseOrderStates.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.State!.UpdatePurchaseOrderStateFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive StateID to the PurchaseOrder entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.StateID = 0;
                entity.State = (PurchaseOrderState)resolved.Result!.CreatePurchaseOrderStateEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given State to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.PurchaseOrderTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Type!.UpdatePurchaseOrderTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the PurchaseOrder entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.TypeID = 0;
                entity.Type = (PurchaseOrderType)resolved.Result!.CreatePurchaseOrderTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BillingContact to the PurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given ShippingContact to the PurchaseOrder entity");
        }
...
#pragma warning restore 1998
            ...
            IClarityEcommerceEntities context)
        {
            ...
            await RelateOptionalSalesGroupAsync(entity, model, timestamp, context).ConfigureAwait(false);
