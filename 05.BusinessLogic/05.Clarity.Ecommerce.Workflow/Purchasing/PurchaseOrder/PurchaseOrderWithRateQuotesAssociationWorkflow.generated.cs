// <autogenerated>
// <copyright file="PurchaseOrderWithRateQuotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Purchase Order Rate Quotes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IPurchaseOrderModel, IPurchaseOrder, IRateQuoteModel, IRateQuote, RateQuote}"/>
    /// <seealso cref="IPurchaseOrderWithRateQuotesAssociationWorkflow"/>
    public partial class PurchaseOrderWithRateQuotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<IPurchaseOrderModel, IPurchaseOrder, IRateQuoteModel, IRateQuote, RateQuote>
        , IPurchaseOrderWithRateQuotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<RateQuote>? GetObjectsCollection(IPurchaseOrder entity) { return entity.RateQuotes; }

        /// <inheritdoc/>
        protected override List<IRateQuoteModel>? GetModelObjectsList(IPurchaseOrderModel model) { return model.RateQuotes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IPurchaseOrder entity, IRateQuote newEntity)
        {
