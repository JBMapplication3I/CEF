// <copyright file="PurchaseOrderWithContactsAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2017-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate purchase order contacts workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class PurchaseOrderWithContactsAssociationWorkflow
    {
        ...
        protected override Task ModelToNewObjectAdditionalPropertiesAsync(
            IPurchaseOrderContact newEntity,
            IPurchaseOrderContactModel model,
            DateTime timestamp,
            IClarityEcommerceEntities context)
        {
