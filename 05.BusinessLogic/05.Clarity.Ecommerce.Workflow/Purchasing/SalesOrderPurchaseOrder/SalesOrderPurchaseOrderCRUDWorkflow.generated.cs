// <autogenerated>
// <copyright file="SalesOrderPurchaseOrderWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderPurchaseOrder entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesOrderPurchaseOrderModel, ISalesOrderPurchaseOrderSearchModel, ISalesOrderPurchaseOrder, SalesOrderPurchaseOrder}"/>
    /// <seealso cref="ISalesOrderPurchaseOrderWorkflow"/>
    public partial class SalesOrderPurchaseOrderWorkflow
        : WorkflowBase<ISalesOrderPurchaseOrderModel, ISalesOrderPurchaseOrderSearchModel, ISalesOrderPurchaseOrder, SalesOrderPurchaseOrder>
            , ISalesOrderPurchaseOrderWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderPurchaseOrder?, string?, ISalesOrderPurchaseOrderModel?> MapFromConcreteFull
            => ModelMapperForSalesOrderPurchaseOrder.MapSalesOrderPurchaseOrderModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderPurchaseOrder>, string?, IEnumerable<ISalesOrderPurchaseOrderModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderPurchaseOrder.SelectLiteSalesOrderPurchaseOrderAndMapToSalesOrderPurchaseOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderPurchaseOrder>, string?, IEnumerable<ISalesOrderPurchaseOrderModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrderPurchaseOrder.SelectListSalesOrderPurchaseOrderAndMapToSalesOrderPurchaseOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderPurchaseOrder>, string?, ISalesOrderPurchaseOrderModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderPurchaseOrder.SelectFirstFullSalesOrderPurchaseOrderAndMapToSalesOrderPurchaseOrderModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderPurchaseOrder, ISalesOrderPurchaseOrderModel, DateTime, DateTime?, ISalesOrderPurchaseOrder> UpdateEntityFromModel
            => ModelMapperForSalesOrderPurchaseOrder.UpdateSalesOrderPurchaseOrderFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderPurchaseOrder>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesOrderPurchaseOrder> query,
            ISalesOrderPurchaseOrderSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderPurchaseOrdersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesOrderPurchaseOrder entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesOrders.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateSalesOrderFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the SalesOrderPurchaseOrder entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the SalesOrderPurchaseOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.PurchaseOrders.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdatePurchaseOrderFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesOrderPurchaseOrder entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (PurchaseOrder)resolved.Result!.CreatePurchaseOrderEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesOrderPurchaseOrder entity");
        }
