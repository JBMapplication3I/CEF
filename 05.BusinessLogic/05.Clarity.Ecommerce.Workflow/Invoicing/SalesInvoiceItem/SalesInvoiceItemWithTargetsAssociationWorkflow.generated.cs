// <autogenerated>
// <copyright file="SalesInvoiceItemWithTargetsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Invoice Item Targets association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesInvoiceItem, ISalesItemTargetBaseModel, ISalesInvoiceItemTarget, SalesInvoiceItemTarget}"/>
    /// <seealso cref="ISalesInvoiceItemWithTargetsAssociationWorkflow"/>
    public partial class SalesInvoiceItemWithTargetsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>, ISalesInvoiceItem, ISalesItemTargetBaseModel, ISalesInvoiceItemTarget, SalesInvoiceItemTarget>
        , ISalesInvoiceItemWithTargetsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SalesInvoiceItemTarget>? GetObjectsCollection(ISalesInvoiceItem entity) { return entity.Targets; }

        /// <inheritdoc/>
        protected override List<ISalesItemTargetBaseModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel> model) { return model.Targets; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesInvoiceItem entity, ISalesInvoiceItemTarget newEntity)
        {
            if (newEntity == null) { return; }
            entity.Targets!.Add((SalesInvoiceItemTarget)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(ISalesInvoiceItem entity)
        {
            ...
            entity.Targets = new HashSet<SalesInvoiceItemTarget>();
        }

        /// <inheritdoc/>
        protected override async Task DeactivateObjectAsync(ISalesInvoiceItemTarget entity, DateTime timestamp)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<bool> MatchObjectModelWithObjectEntityAsync(ISalesItemTargetBaseModel model, ISalesInvoiceItemTarget entity, IClarityEcommerceEntities context)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<ISalesInvoiceItemTarget> ModelToNewObjectAsync(
            ...
            var thisEntityTypeID = Contract.CheckValidID(model.TypeID)
                ...
                : model.Type != null && Contract.CheckValidID(model.Type.ID)
                    ...
                    : UpsertThisEntityTypeAndGetID(
                        ...
                        timestamp,
                        context);
            if (thisEntityTypeID <= 0) { throw new ArgumentException("SalesInvoiceItemTarget requires a valid Type."); }
            // Create a new entity and populate it with data
            var newEntity = model.CreateSalesInvoiceItemTargetEntity(timestamp, context.ContextProfileName);
