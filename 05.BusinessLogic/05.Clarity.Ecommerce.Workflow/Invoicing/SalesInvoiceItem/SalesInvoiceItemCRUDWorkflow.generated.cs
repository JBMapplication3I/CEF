// <autogenerated>
// <copyright file="SalesInvoiceItemWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesInvoiceItem entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesItemBaseModel, ISalesItemBaseSearchModel, ISalesInvoiceItem, SalesInvoiceItem}"/>
    /// <seealso cref="ISalesInvoiceItemWorkflow"/>
    public partial class SalesInvoiceItemWorkflow
        : NameableWorkflowBase<ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>, ISalesItemBaseSearchModel, ISalesInvoiceItem, SalesInvoiceItem>
            , ISalesInvoiceItemWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesInvoiceItem?, string?, ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>?> MapFromConcreteFull
            => ModelMapperForSalesInvoiceItem.MapSalesInvoiceItemModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>>> SelectLiteAndMapToModel
            => ModelMapperForSalesInvoiceItem.SelectLiteSalesInvoiceItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>>> SelectListAndMapToModel
            => ModelMapperForSalesInvoiceItem.SelectListSalesInvoiceItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceItem>, string?, ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesInvoiceItem.SelectFirstFullSalesInvoiceItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<ISalesInvoiceItem, ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>, DateTime, DateTime?, ISalesInvoiceItem> UpdateEntityFromModel
            => ModelMapperForSalesInvoiceItem.UpdateSalesInvoiceItemFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesInvoiceItem>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesInvoiceItemsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Targets != null) { await Workflows.SalesInvoiceItemWithTargetsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.SalesInvoiceItemID = entity.ID;
                    }
                }
                await Workflows.SalesInvoiceItemWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Product to the SalesInvoiceItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SalesInvoiceItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given OriginalCurrency to the SalesInvoiceItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SellingCurrency to the SalesInvoiceItem entity");
        }
