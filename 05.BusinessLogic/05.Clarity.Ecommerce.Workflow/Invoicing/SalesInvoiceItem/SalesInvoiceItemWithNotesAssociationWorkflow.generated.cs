// <autogenerated>
// <copyright file="SalesInvoiceItemWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Invoice Item Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesInvoiceItem, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesInvoiceItemWithNotesAssociationWorkflow"/>
    public partial class SalesInvoiceItemWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>, ISalesInvoiceItem, INoteModel, INote, Note>
        , ISalesInvoiceItemWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesInvoiceItem entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel> model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesInvoiceItem entity, INote newEntity)
        {
