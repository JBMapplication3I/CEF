// <copyright file="SalesInvoiceWithContactsAssociationWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2017-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the associate sales invoice contacts workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class SalesInvoiceWithContactsAssociationWorkflow
    {
        ...
        protected override Task ModelToNewObjectAdditionalPropertiesAsync(
            ISalesInvoiceContact newEntity,
            ISalesInvoiceContactModel model,
            DateTime timestamp,
            IClarityEcommerceEntities context)
        {
