// <autogenerated>
// <copyright file="SalesInvoiceWithRateQuotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Invoice Rate Quotes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesInvoiceModel, ISalesInvoice, IRateQuoteModel, IRateQuote, RateQuote}"/>
    /// <seealso cref="ISalesInvoiceWithRateQuotesAssociationWorkflow"/>
    public partial class SalesInvoiceWithRateQuotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesInvoiceModel, ISalesInvoice, IRateQuoteModel, IRateQuote, RateQuote>
        , ISalesInvoiceWithRateQuotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<RateQuote>? GetObjectsCollection(ISalesInvoice entity) { return entity.RateQuotes; }

        /// <inheritdoc/>
        protected override List<IRateQuoteModel>? GetModelObjectsList(ISalesInvoiceModel model) { return model.RateQuotes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesInvoice entity, IRateQuote newEntity)
        {
