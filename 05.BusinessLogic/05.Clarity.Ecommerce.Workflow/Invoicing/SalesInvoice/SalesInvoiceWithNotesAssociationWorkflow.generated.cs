// <autogenerated>
// <copyright file="SalesInvoiceWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Invoice Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesInvoiceModel, ISalesInvoice, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesInvoiceWithNotesAssociationWorkflow"/>
    public partial class SalesInvoiceWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesInvoiceModel, ISalesInvoice, INoteModel, INote, Note>
        , ISalesInvoiceWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesInvoice entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesInvoiceModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesInvoice entity, INote newEntity)
        {
