// <autogenerated>
// <copyright file="SalesInvoiceWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesInvoice entities.</summary>
    /// <seealso cref="SalesCollectionWorkflowBase{ISalesInvoiceModel, ISalesInvoiceSearchModel, ISalesInvoice, SalesInvoice, SalesInvoiceStatus, SalesInvoiceType, ITypeModel, ISalesInvoiceItem, SalesInvoiceItem, AppliedSalesInvoiceDiscount, SalesInvoiceState, SalesInvoiceFile, ISalesInvoiceFileModel, SalesInvoiceContact, ISalesInvoiceContactModel, SalesInvoiceEvent, ISalesInvoiceEventModel, SalesInvoiceEventType, AppliedSalesInvoiceItemDiscount, SalesInvoiceItemTarget, IAppliedSalesInvoiceDiscountModel, IAppliedSalesInvoiceItemDiscountModel}"/>
    /// <seealso cref="ISalesInvoiceWorkflow"/>
    public partial class SalesInvoiceWorkflow
        : SalesCollectionWorkflowBase<ISalesInvoiceModel,
            ...
            IAppliedSalesInvoiceItemDiscountModel>
            , ISalesInvoiceWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesInvoice?, string?, ISalesInvoiceModel?> MapFromConcreteFull
            => ModelMapperForSalesInvoice.MapSalesInvoiceModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoice>, string?, IEnumerable<ISalesInvoiceModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesInvoice.SelectLiteSalesInvoiceAndMapToSalesInvoiceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoice>, string?, IEnumerable<ISalesInvoiceModel>> SelectListAndMapToModel
            => ModelMapperForSalesInvoice.SelectListSalesInvoiceAndMapToSalesInvoiceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoice>, string?, ISalesInvoiceModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesInvoice.SelectFirstFullSalesInvoiceAndMapToSalesInvoiceModel;

        /// <inheritdoc/>
        protected override Func<ISalesInvoice, ISalesInvoiceModel, DateTime, DateTime?, ISalesInvoice> UpdateEntityFromModel
            => ModelMapperForSalesInvoice.UpdateSalesInvoiceFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesInvoice>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesInvoicesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Notes != null)
            {
                if (Contract.CheckValidID(entity.ID))
                {
                    ...
                    {
                        note.SalesInvoiceID = entity.ID;
                    }
                }
                await Workflows.SalesInvoiceWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
            if (model.AssociatedSalesOrders != null) { await Workflows.SalesInvoiceWithAssociatedSalesOrdersAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.SalesInvoicePayments != null) { await Workflows.SalesInvoiceWithSalesInvoicePaymentsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.SalesItems != null) { await Workflows.SalesInvoiceWithSalesItemsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: Discounts
            if (model.StoredFiles != null) { await Workflows.SalesInvoiceWithStoredFilesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Contacts != null) { await Workflows.SalesInvoiceWithContactsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: SalesEvents
            if (model.RateQuotes != null) { await Workflows.SalesInvoiceWithRateQuotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SalesGroup to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Account to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Franchise to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesInvoiceStatuses.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Status!.UpdateSalesInvoiceStatusFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive StatusID to the SalesInvoice entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.StatusID = 0;
                entity.Status = (SalesInvoiceStatus)resolved.Result!.CreateSalesInvoiceStatusEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Status to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SalesInvoiceStates.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.State!.UpdateSalesInvoiceStateFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive StateID to the SalesInvoice entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.StateID = 0;
                entity.State = (SalesInvoiceState)resolved.Result!.CreateSalesInvoiceStateEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given State to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SalesInvoiceTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Type!.UpdateSalesInvoiceTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SalesInvoice entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.TypeID = 0;
                entity.Type = (SalesInvoiceType)resolved.Result!.CreateSalesInvoiceTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BillingContact to the SalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given ShippingContact to the SalesInvoice entity");
        }
