// <autogenerated>
// <copyright file="SalesInvoiceFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesInvoiceFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesInvoiceFileModel, ISalesInvoiceFileSearchModel, ISalesInvoiceFile, SalesInvoiceFile}"/>
    /// <seealso cref="ISalesInvoiceFileWorkflow"/>
    public partial class SalesInvoiceFileWorkflow
        : NameableWorkflowBase<ISalesInvoiceFileModel, ISalesInvoiceFileSearchModel, ISalesInvoiceFile, SalesInvoiceFile>
            , ISalesInvoiceFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesInvoiceFile?, string?, ISalesInvoiceFileModel?> MapFromConcreteFull
            => ModelMapperForSalesInvoiceFile.MapSalesInvoiceFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceFile>, string?, IEnumerable<ISalesInvoiceFileModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesInvoiceFile.SelectLiteSalesInvoiceFileAndMapToSalesInvoiceFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceFile>, string?, IEnumerable<ISalesInvoiceFileModel>> SelectListAndMapToModel
            => ModelMapperForSalesInvoiceFile.SelectListSalesInvoiceFileAndMapToSalesInvoiceFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceFile>, string?, ISalesInvoiceFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesInvoiceFile.SelectFirstFullSalesInvoiceFileAndMapToSalesInvoiceFileModel;

        /// <inheritdoc/>
        protected override Func<ISalesInvoiceFile, ISalesInvoiceFileModel, DateTime, DateTime?, ISalesInvoiceFile> UpdateEntityFromModel
            => ModelMapperForSalesInvoiceFile.UpdateSalesInvoiceFileFromModel;
        #endregion
        ...
        {
            return await context.Set<SalesInvoiceFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<ISalesInvoiceFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<ISalesInvoiceFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<SalesInvoiceFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<SalesInvoiceFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<SalesInvoiceFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<SalesInvoiceFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesInvoiceFile>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesInvoiceFile> query,
            ISalesInvoiceFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesInvoiceFilesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesInvoiceFile entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesInvoiceFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesInvoiceFile entity");
        }
