// <autogenerated>
// <copyright file="SalesInvoiceContactWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesInvoiceContact entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesInvoiceContactModel, ISalesInvoiceContactSearchModel, ISalesInvoiceContact, SalesInvoiceContact}"/>
    /// <seealso cref="ISalesInvoiceContactWorkflow"/>
    public partial class SalesInvoiceContactWorkflow
        : WorkflowBase<ISalesInvoiceContactModel, ISalesInvoiceContactSearchModel, ISalesInvoiceContact, SalesInvoiceContact>
            , ISalesInvoiceContactWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesInvoiceContact?, string?, ISalesInvoiceContactModel?> MapFromConcreteFull
            => ModelMapperForSalesInvoiceContact.MapSalesInvoiceContactModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceContact>, string?, IEnumerable<ISalesInvoiceContactModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesInvoiceContact.SelectLiteSalesInvoiceContactAndMapToSalesInvoiceContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceContact>, string?, IEnumerable<ISalesInvoiceContactModel>> SelectListAndMapToModel
            => ModelMapperForSalesInvoiceContact.SelectListSalesInvoiceContactAndMapToSalesInvoiceContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceContact>, string?, ISalesInvoiceContactModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesInvoiceContact.SelectFirstFullSalesInvoiceContactAndMapToSalesInvoiceContactModel;

        /// <inheritdoc/>
        protected override Func<ISalesInvoiceContact, ISalesInvoiceContactModel, DateTime, DateTime?, ISalesInvoiceContact> UpdateEntityFromModel
            => ModelMapperForSalesInvoiceContact.UpdateSalesInvoiceContactFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesInvoiceContact>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesInvoiceContactsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesInvoiceContact entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesInvoiceContact entity");
        }
