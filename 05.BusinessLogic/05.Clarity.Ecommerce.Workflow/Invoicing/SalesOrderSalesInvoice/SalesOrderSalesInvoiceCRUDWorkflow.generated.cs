// <autogenerated>
// <copyright file="SalesOrderSalesInvoiceWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesOrderSalesInvoice entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesOrderSalesInvoiceModel, ISalesOrderSalesInvoiceSearchModel, ISalesOrderSalesInvoice, SalesOrderSalesInvoice}"/>
    /// <seealso cref="ISalesOrderSalesInvoiceWorkflow"/>
    public partial class SalesOrderSalesInvoiceWorkflow
        : WorkflowBase<ISalesOrderSalesInvoiceModel, ISalesOrderSalesInvoiceSearchModel, ISalesOrderSalesInvoice, SalesOrderSalesInvoice>
            , ISalesOrderSalesInvoiceWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesOrderSalesInvoice?, string?, ISalesOrderSalesInvoiceModel?> MapFromConcreteFull
            => ModelMapperForSalesOrderSalesInvoice.MapSalesOrderSalesInvoiceModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderSalesInvoice>, string?, IEnumerable<ISalesOrderSalesInvoiceModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesOrderSalesInvoice.SelectLiteSalesOrderSalesInvoiceAndMapToSalesOrderSalesInvoiceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderSalesInvoice>, string?, IEnumerable<ISalesOrderSalesInvoiceModel>> SelectListAndMapToModel
            => ModelMapperForSalesOrderSalesInvoice.SelectListSalesOrderSalesInvoiceAndMapToSalesOrderSalesInvoiceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesOrderSalesInvoice>, string?, ISalesOrderSalesInvoiceModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesOrderSalesInvoice.SelectFirstFullSalesOrderSalesInvoiceAndMapToSalesOrderSalesInvoiceModel;

        /// <inheritdoc/>
        protected override Func<ISalesOrderSalesInvoice, ISalesOrderSalesInvoiceModel, DateTime, DateTime?, ISalesOrderSalesInvoice> UpdateEntityFromModel
            => ModelMapperForSalesOrderSalesInvoice.UpdateSalesOrderSalesInvoiceFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesOrderSalesInvoice>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesOrderSalesInvoice> query,
            ISalesOrderSalesInvoiceSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesOrderSalesInvoicesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesOrderSalesInvoice entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the SalesOrderSalesInvoice entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the SalesOrderSalesInvoice entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesInvoices.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateSalesInvoiceFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesOrderSalesInvoice entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (SalesInvoice)resolved.Result!.CreateSalesInvoiceEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesOrderSalesInvoice entity");
        }
