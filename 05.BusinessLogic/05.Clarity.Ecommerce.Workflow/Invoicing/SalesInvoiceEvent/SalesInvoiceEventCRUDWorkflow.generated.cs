// <autogenerated>
// <copyright file="SalesInvoiceEventWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesInvoiceEvent entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesInvoiceEventModel, ISalesInvoiceEventSearchModel, ISalesInvoiceEvent, SalesInvoiceEvent}"/>
    /// <seealso cref="ISalesInvoiceEventWorkflow"/>
    public partial class SalesInvoiceEventWorkflow
        : NameableWorkflowBase<ISalesInvoiceEventModel, ISalesInvoiceEventSearchModel, ISalesInvoiceEvent, SalesInvoiceEvent>
            , ISalesInvoiceEventWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesInvoiceEvent?, string?, ISalesInvoiceEventModel?> MapFromConcreteFull
            => ModelMapperForSalesInvoiceEvent.MapSalesInvoiceEventModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceEvent>, string?, IEnumerable<ISalesInvoiceEventModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesInvoiceEvent.SelectLiteSalesInvoiceEventAndMapToSalesInvoiceEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceEvent>, string?, IEnumerable<ISalesInvoiceEventModel>> SelectListAndMapToModel
            => ModelMapperForSalesInvoiceEvent.SelectListSalesInvoiceEventAndMapToSalesInvoiceEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesInvoiceEvent>, string?, ISalesInvoiceEventModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesInvoiceEvent.SelectFirstFullSalesInvoiceEventAndMapToSalesInvoiceEventModel;

        /// <inheritdoc/>
        protected override Func<ISalesInvoiceEvent, ISalesInvoiceEventModel, DateTime, DateTime?, ISalesInvoiceEvent> UpdateEntityFromModel
            => ModelMapperForSalesInvoiceEvent.UpdateSalesInvoiceEventFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesInvoiceEvent>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesInvoiceEvent> query,
            ISalesInvoiceEventSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesInvoiceEventsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesInvoiceEvent entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesInvoiceEventTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateSalesInvoiceEventTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the SalesInvoiceEvent entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (SalesInvoiceEventType)resolved.Result!.CreateSalesInvoiceEventTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the SalesInvoiceEvent entity");
        }
