// <autogenerated>
// <copyright file="VendorProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for VendorProduct entities.</summary>
    /// <seealso cref="WorkflowBase{IVendorProductModel, IVendorProductSearchModel, IVendorProduct, VendorProduct}"/>
    /// <seealso cref="IVendorProductWorkflow"/>
    public partial class VendorProductWorkflow
        : WorkflowBase<IVendorProductModel, IVendorProductSearchModel, IVendorProduct, VendorProduct>
            , IVendorProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<VendorProduct?, string?, IVendorProductModel?> MapFromConcreteFull
            => ModelMapperForVendorProduct.MapVendorProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorProduct>, string?, IEnumerable<IVendorProductModel>> SelectLiteAndMapToModel
            => ModelMapperForVendorProduct.SelectLiteVendorProductAndMapToVendorProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorProduct>, string?, IEnumerable<IVendorProductModel>> SelectListAndMapToModel
            => ModelMapperForVendorProduct.SelectListVendorProductAndMapToVendorProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorProduct>, string?, IVendorProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForVendorProduct.SelectFirstFullVendorProductAndMapToVendorProductModel;

        /// <inheritdoc/>
        protected override Func<IVendorProduct, IVendorProductModel, DateTime, DateTime?, IVendorProduct> UpdateEntityFromModel
            => ModelMapperForVendorProduct.UpdateVendorProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<VendorProduct>> FilterQueryByModelExtensionAsync(
            IQueryable<VendorProduct> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterVendorProductsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the VendorProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the VendorProduct entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the VendorProduct entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the VendorProduct entity");
        }
