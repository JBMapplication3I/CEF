// <autogenerated>
// <copyright file="VendorAccountWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for VendorAccount entities.</summary>
    /// <seealso cref="WorkflowBase{IVendorAccountModel, IVendorAccountSearchModel, IVendorAccount, VendorAccount}"/>
    /// <seealso cref="IVendorAccountWorkflow"/>
    public partial class VendorAccountWorkflow
        : WorkflowBase<IVendorAccountModel, IVendorAccountSearchModel, IVendorAccount, VendorAccount>
            , IVendorAccountWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<VendorAccount?, string?, IVendorAccountModel?> MapFromConcreteFull
            => ModelMapperForVendorAccount.MapVendorAccountModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorAccount>, string?, IEnumerable<IVendorAccountModel>> SelectLiteAndMapToModel
            => ModelMapperForVendorAccount.SelectLiteVendorAccountAndMapToVendorAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorAccount>, string?, IEnumerable<IVendorAccountModel>> SelectListAndMapToModel
            => ModelMapperForVendorAccount.SelectListVendorAccountAndMapToVendorAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorAccount>, string?, IVendorAccountModel?> SelectFirstFullAndMapToModel
            => ModelMapperForVendorAccount.SelectFirstFullVendorAccountAndMapToVendorAccountModel;

        /// <inheritdoc/>
        protected override Func<IVendorAccount, IVendorAccountModel, DateTime, DateTime?, IVendorAccount> UpdateEntityFromModel
            => ModelMapperForVendorAccount.UpdateVendorAccountFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<VendorAccount>> FilterQueryByModelExtensionAsync(
            IQueryable<VendorAccount> query,
            IVendorAccountSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterVendorAccountsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IVendorAccount entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the VendorAccount entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the VendorAccount entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the VendorAccount entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the VendorAccount entity");
        }
