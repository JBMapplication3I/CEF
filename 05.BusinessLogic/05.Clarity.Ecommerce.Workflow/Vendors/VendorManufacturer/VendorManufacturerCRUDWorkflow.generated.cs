// <autogenerated>
// <copyright file="VendorManufacturerWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for VendorManufacturer entities.</summary>
    /// <seealso cref="WorkflowBase{IVendorManufacturerModel, IVendorManufacturerSearchModel, IVendorManufacturer, VendorManufacturer}"/>
    /// <seealso cref="IVendorManufacturerWorkflow"/>
    public partial class VendorManufacturerWorkflow
        : WorkflowBase<IVendorManufacturerModel, IVendorManufacturerSearchModel, IVendorManufacturer, VendorManufacturer>
            , IVendorManufacturerWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<VendorManufacturer?, string?, IVendorManufacturerModel?> MapFromConcreteFull
            => ModelMapperForVendorManufacturer.MapVendorManufacturerModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorManufacturer>, string?, IEnumerable<IVendorManufacturerModel>> SelectLiteAndMapToModel
            => ModelMapperForVendorManufacturer.SelectLiteVendorManufacturerAndMapToVendorManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorManufacturer>, string?, IEnumerable<IVendorManufacturerModel>> SelectListAndMapToModel
            => ModelMapperForVendorManufacturer.SelectListVendorManufacturerAndMapToVendorManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<VendorManufacturer>, string?, IVendorManufacturerModel?> SelectFirstFullAndMapToModel
            => ModelMapperForVendorManufacturer.SelectFirstFullVendorManufacturerAndMapToVendorManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IVendorManufacturer, IVendorManufacturerModel, DateTime, DateTime?, IVendorManufacturer> UpdateEntityFromModel
            => ModelMapperForVendorManufacturer.UpdateVendorManufacturerFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<VendorManufacturer>> FilterQueryByModelExtensionAsync(
            IQueryable<VendorManufacturer> query,
            IVendorManufacturerSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterVendorManufacturersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IVendorManufacturer entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateVendorFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the VendorManufacturer entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the VendorManufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the VendorManufacturer entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the VendorManufacturer entity");
        }
