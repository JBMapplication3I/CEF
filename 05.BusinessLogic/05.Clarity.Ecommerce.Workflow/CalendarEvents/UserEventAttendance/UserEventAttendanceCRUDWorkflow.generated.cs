// <autogenerated>
// <copyright file="UserEventAttendanceWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for UserEventAttendance entities.</summary>
    /// <seealso cref="WorkflowBase{IUserEventAttendanceModel, IUserEventAttendanceSearchModel, IUserEventAttendance, UserEventAttendance}"/>
    /// <seealso cref="IUserEventAttendanceWorkflow"/>
    public partial class UserEventAttendanceWorkflow
        : WorkflowBase<IUserEventAttendanceModel, IUserEventAttendanceSearchModel, IUserEventAttendance, UserEventAttendance>
            , IUserEventAttendanceWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<UserEventAttendance?, string?, IUserEventAttendanceModel?> MapFromConcreteFull
            => ModelMapperForUserEventAttendance.MapUserEventAttendanceModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserEventAttendance>, string?, IEnumerable<IUserEventAttendanceModel>> SelectLiteAndMapToModel
            => ModelMapperForUserEventAttendance.SelectLiteUserEventAttendanceAndMapToUserEventAttendanceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserEventAttendance>, string?, IEnumerable<IUserEventAttendanceModel>> SelectListAndMapToModel
            => ModelMapperForUserEventAttendance.SelectListUserEventAttendanceAndMapToUserEventAttendanceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<UserEventAttendance>, string?, IUserEventAttendanceModel?> SelectFirstFullAndMapToModel
            => ModelMapperForUserEventAttendance.SelectFirstFullUserEventAttendanceAndMapToUserEventAttendanceModel;

        /// <inheritdoc/>
        protected override Func<IUserEventAttendance, IUserEventAttendanceModel, DateTime, DateTime?, IUserEventAttendance> UpdateEntityFromModel
            => ModelMapperForUserEventAttendance.UpdateUserEventAttendanceFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<UserEventAttendance>> FilterQueryByModelExtensionAsync(
            IQueryable<UserEventAttendance> query,
            IUserEventAttendanceSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterUserEventAttendancesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IUserEventAttendance entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.UserEventAttendanceTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateUserEventAttendanceTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the UserEventAttendance entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (UserEventAttendanceType)resolved.Result!.CreateUserEventAttendanceTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the UserEventAttendance entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.CalendarEvents.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Master!.UpdateCalendarEventFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the UserEventAttendance entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the UserEventAttendance entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the UserEventAttendance entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the UserEventAttendance entity");
        }
