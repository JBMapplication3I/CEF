// <autogenerated>
// <copyright file="CalendarEventWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CalendarEvent entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ICalendarEventModel, ICalendarEventSearchModel, ICalendarEvent, CalendarEvent}"/>
    /// <seealso cref="ICalendarEventWorkflow"/>
    public partial class CalendarEventWorkflow
        : NameableWorkflowBase<ICalendarEventModel, ICalendarEventSearchModel, ICalendarEvent, CalendarEvent>
            , ICalendarEventWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CalendarEvent?, string?, ICalendarEventModel?> MapFromConcreteFull
            => ModelMapperForCalendarEvent.MapCalendarEventModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CalendarEvent>, string?, IEnumerable<ICalendarEventModel>> SelectLiteAndMapToModel
            => ModelMapperForCalendarEvent.SelectLiteCalendarEventAndMapToCalendarEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CalendarEvent>, string?, IEnumerable<ICalendarEventModel>> SelectListAndMapToModel
            => ModelMapperForCalendarEvent.SelectListCalendarEventAndMapToCalendarEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CalendarEvent>, string?, ICalendarEventModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCalendarEvent.SelectFirstFullCalendarEventAndMapToCalendarEventModel;

        /// <inheritdoc/>
        protected override Func<ICalendarEvent, ICalendarEventModel, DateTime, DateTime?, ICalendarEvent> UpdateEntityFromModel
            => ModelMapperForCalendarEvent.UpdateCalendarEventFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CalendarEvent>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCalendarEventsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Images != null) { await Workflows.CalendarEventWithImagesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.StoredFiles != null) { await Workflows.CalendarEventWithStoredFilesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Products != null) { await Workflows.CalendarEventWithProductsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.CalendarEventDetails != null) { await Workflows.CalendarEventWithCalendarEventDetailsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.UserEventAttendances != null) { await Workflows.CalendarEventWithUserEventAttendancesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.CalendarEventTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateCalendarEventTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the CalendarEvent entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (CalendarEventType)resolved.Result!.CreateCalendarEventTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the CalendarEvent entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.CalendarEventStatuses.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Status!.UpdateCalendarEventStatusFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive StatusID to the CalendarEvent entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.StatusID = 0;
                entity.Status = (CalendarEventStatus)resolved.Result!.CreateCalendarEventStatusEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Status to the CalendarEvent entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive ContactID to the CalendarEvent entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Contact to the CalendarEvent entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.Groups.ResolveWithAutoGenerateOptionalAsync(
                    byID: model.GroupID, // By Other ID
                    byKey: model.GroupKey, // By Flattened Other Key
                    byName: model.GroupName, // By Flattened Other Name
                    model: model.Group, // The other property as a model
                    context: context)
                .ConfigureAwait(false);
            // Check for IDs and objects
            ...
            if (!entityIDIsNull && modelObjectIsActive)
            {
                ...
                entity.GroupID = null;
                entity.Group = (Group)resolved.Result!.CreateGroupEntity(timestamp, context.ContextProfileName);
                return;
            }
            if (entityIDIsNull && modelObjectIsActive)
            {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Group to the CalendarEvent entity");
        }
