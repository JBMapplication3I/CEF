// <autogenerated>
// <copyright file="CalendarEventProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CalendarEventProduct entities.</summary>
    /// <seealso cref="WorkflowBase{ICalendarEventProductModel, ICalendarEventProductSearchModel, ICalendarEventProduct, CalendarEventProduct}"/>
    /// <seealso cref="ICalendarEventProductWorkflow"/>
    public partial class CalendarEventProductWorkflow
        : WorkflowBase<ICalendarEventProductModel, ICalendarEventProductSearchModel, ICalendarEventProduct, CalendarEventProduct>
            , ICalendarEventProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CalendarEventProduct?, string?, ICalendarEventProductModel?> MapFromConcreteFull
            => ModelMapperForCalendarEventProduct.MapCalendarEventProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CalendarEventProduct>, string?, IEnumerable<ICalendarEventProductModel>> SelectLiteAndMapToModel
            => ModelMapperForCalendarEventProduct.SelectLiteCalendarEventProductAndMapToCalendarEventProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CalendarEventProduct>, string?, IEnumerable<ICalendarEventProductModel>> SelectListAndMapToModel
            => ModelMapperForCalendarEventProduct.SelectListCalendarEventProductAndMapToCalendarEventProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CalendarEventProduct>, string?, ICalendarEventProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCalendarEventProduct.SelectFirstFullCalendarEventProductAndMapToCalendarEventProductModel;

        /// <inheritdoc/>
        protected override Func<ICalendarEventProduct, ICalendarEventProductModel, DateTime, DateTime?, ICalendarEventProduct> UpdateEntityFromModel
            => ModelMapperForCalendarEventProduct.UpdateCalendarEventProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CalendarEventProduct>> FilterQueryByModelExtensionAsync(
            IQueryable<CalendarEventProduct> query,
            ICalendarEventProductSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCalendarEventProductsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the CalendarEventProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the CalendarEventProduct entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the CalendarEventProduct entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the CalendarEventProduct entity");
        }
