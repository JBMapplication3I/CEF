// <autogenerated>
// <copyright file="CartItemTargetWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CartItemTarget entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ICartItemTarget, CartItemTarget}"/>
    /// <seealso cref="ICartItemTargetWorkflow"/>
    public partial class CartItemTargetWorkflow
        : WorkflowBase<ISalesItemTargetBaseModel, ISalesItemTargetBaseSearchModel, ICartItemTarget, CartItemTarget>
            , ICartItemTargetWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CartItemTarget?, string?, ISalesItemTargetBaseModel?> MapFromConcreteFull
            => ModelMapperForCartItemTarget.MapCartItemTargetModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectLiteAndMapToModel
            => ModelMapperForCartItemTarget.SelectLiteCartItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartItemTarget>, string?, IEnumerable<ISalesItemTargetBaseModel>> SelectListAndMapToModel
            => ModelMapperForCartItemTarget.SelectListCartItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartItemTarget>, string?, ISalesItemTargetBaseModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCartItemTarget.SelectFirstFullCartItemTargetAndMapToSalesItemTargetBaseModel;

        /// <inheritdoc/>
        protected override Func<ICartItemTarget, ISalesItemTargetBaseModel, DateTime, DateTime?, ICartItemTarget> UpdateEntityFromModel
            => ModelMapperForCartItemTarget.UpdateCartItemTargetFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CartItemTarget>> FilterQueryByModelExtensionAsync(
            IQueryable<CartItemTarget> query,
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCartItemTargetsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the CartItemTarget entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the CartItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive DestinationContactID to the CartItemTarget entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given DestinationContact to the CartItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BrandProduct to the CartItemTarget entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SelectedRateQuote to the CartItemTarget entity");
        }
