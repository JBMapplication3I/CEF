// <autogenerated>
// <copyright file="CartItemWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CartItem entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesItemBaseModel, ISalesItemBaseSearchModel, ICartItem, CartItem}"/>
    /// <seealso cref="ICartItemWorkflow"/>
    public partial class CartItemWorkflow
        : NameableWorkflowBase<ISalesItemBaseModel<IAppliedCartItemDiscountModel>, ISalesItemBaseSearchModel, ICartItem, CartItem>
            , ICartItemWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CartItem?, string?, ISalesItemBaseModel<IAppliedCartItemDiscountModel>?> MapFromConcreteFull
            => ModelMapperForCartItem.MapCartItemModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedCartItemDiscountModel>>> SelectLiteAndMapToModel
            => ModelMapperForCartItem.SelectLiteCartItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartItem>, string?, IEnumerable<ISalesItemBaseModel<IAppliedCartItemDiscountModel>>> SelectListAndMapToModel
            => ModelMapperForCartItem.SelectListCartItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartItem>, string?, ISalesItemBaseModel<IAppliedCartItemDiscountModel>?> SelectFirstFullAndMapToModel
            => ModelMapperForCartItem.SelectFirstFullCartItemAndMapToSalesItemBaseModel;

        /// <inheritdoc/>
        protected override Func<ICartItem, ISalesItemBaseModel<IAppliedCartItemDiscountModel>, DateTime, DateTime?, ICartItem> UpdateEntityFromModel
            => ModelMapperForCartItem.UpdateCartItemFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CartItem>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCartItemsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Targets != null) { await Workflows.CartItemWithTargetsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Notes != null)
            {
                ...
                await Workflows.CartItemWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the CartItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given OriginalCurrency to the CartItem entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SellingCurrency to the CartItem entity");
        }
