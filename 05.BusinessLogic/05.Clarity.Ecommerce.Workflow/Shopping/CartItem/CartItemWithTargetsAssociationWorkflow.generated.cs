// <autogenerated>
// <copyright file="CartItemWithTargetsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Cart Item Targets association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ICartItem, ISalesItemTargetBaseModel, ICartItemTarget, CartItemTarget}"/>
    /// <seealso cref="ICartItemWithTargetsAssociationWorkflow"/>
    public partial class CartItemWithTargetsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesItemBaseModel<IAppliedCartItemDiscountModel>, ICartItem, ISalesItemTargetBaseModel, ICartItemTarget, CartItemTarget>
        , ICartItemWithTargetsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<CartItemTarget>? GetObjectsCollection(ICartItem entity) { return entity.Targets; }

        /// <inheritdoc/>
        protected override List<ISalesItemTargetBaseModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedCartItemDiscountModel> model) { return model.Targets; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ICartItem entity, ICartItemTarget newEntity)
        {
            if (newEntity == null) { return; }
            entity.Targets!.Add((CartItemTarget)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(ICartItem entity)
        {
            ...
            entity.Targets = new HashSet<CartItemTarget>();
        }

        /// <inheritdoc/>
        protected override async Task DeactivateObjectAsync(ICartItemTarget entity, DateTime timestamp)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<bool> MatchObjectModelWithObjectEntityAsync(ISalesItemTargetBaseModel model, ICartItemTarget entity, IClarityEcommerceEntities context)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<ICartItemTarget> ModelToNewObjectAsync(
            ...
            var thisEntityTypeID = Contract.CheckValidID(model.TypeID)
                ...
                : model.Type != null && Contract.CheckValidID(model.Type.ID)
                    ...
                    : UpsertThisEntityTypeAndGetID(
                        ...
                        timestamp,
                        context);
            if (thisEntityTypeID <= 0) { throw new ArgumentException("CartItemTarget requires a valid Type."); }
            // Create a new entity and populate it with data
            var newEntity = model.CreateCartItemTargetEntity(timestamp, context.ContextProfileName);
