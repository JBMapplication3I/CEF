// <autogenerated>
// <copyright file="CartWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Cart Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ICartModel, ICart, INoteModel, INote, Note}"/>
    /// <seealso cref="ICartWithNotesAssociationWorkflow"/>
    public partial class CartWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ICartModel, ICart, INoteModel, INote, Note>
        , ICartWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ICart entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ICartModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ICart entity, INote newEntity)
        {
