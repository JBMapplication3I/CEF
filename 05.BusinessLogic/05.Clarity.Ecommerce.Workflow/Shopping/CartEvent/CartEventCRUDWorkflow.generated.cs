// <autogenerated>
// <copyright file="CartEventWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CartEvent entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ICartEventModel, ICartEventSearchModel, ICartEvent, CartEvent}"/>
    /// <seealso cref="ICartEventWorkflow"/>
    public partial class CartEventWorkflow
        : NameableWorkflowBase<ICartEventModel, ICartEventSearchModel, ICartEvent, CartEvent>
            , ICartEventWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CartEvent?, string?, ICartEventModel?> MapFromConcreteFull
            => ModelMapperForCartEvent.MapCartEventModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartEvent>, string?, IEnumerable<ICartEventModel>> SelectLiteAndMapToModel
            => ModelMapperForCartEvent.SelectLiteCartEventAndMapToCartEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartEvent>, string?, IEnumerable<ICartEventModel>> SelectListAndMapToModel
            => ModelMapperForCartEvent.SelectListCartEventAndMapToCartEventModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartEvent>, string?, ICartEventModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCartEvent.SelectFirstFullCartEventAndMapToCartEventModel;

        /// <inheritdoc/>
        protected override Func<ICartEvent, ICartEventModel, DateTime, DateTime?, ICartEvent> UpdateEntityFromModel
            => ModelMapperForCartEvent.UpdateCartEventFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CartEvent>> FilterQueryByModelExtensionAsync(
            IQueryable<CartEvent> query,
            ICartEventSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCartEventsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.CartEventTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateCartEventTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the CartEvent entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (CartEventType)resolved.Result!.CreateCartEventTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the CartEvent entity");
        }
