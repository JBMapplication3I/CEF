// <autogenerated>
// <copyright file="CartTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CartType entities.</summary>
    /// <seealso cref="TypableWorkflowBase{ICartTypeModel, ICartTypeSearchModel, ICartType, CartType}"/>
    /// <seealso cref="ICartTypeWorkflow"/>
    public partial class CartTypeWorkflow
        : TypableWorkflowBase<ICartTypeModel, ICartTypeSearchModel, ICartType, CartType>
            , ICartTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CartType?, string?, ICartTypeModel?> MapFromConcreteFull
            => ModelMapperForCartType.MapCartTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartType>, string?, IEnumerable<ICartTypeModel>> SelectLiteAndMapToModel
            => ModelMapperForCartType.SelectLiteCartTypeAndMapToCartTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartType>, string?, IEnumerable<ICartTypeModel>> SelectListAndMapToModel
            => ModelMapperForCartType.SelectListCartTypeAndMapToCartTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartType>, string?, ICartTypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCartType.SelectFirstFullCartTypeAndMapToCartTypeModel;

        /// <inheritdoc/>
        protected override Func<ICartType, ICartTypeModel, DateTime, DateTime?, ICartType> UpdateEntityFromModel
            => ModelMapperForCartType.UpdateCartTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CartType>> FilterQueryByModelExtensionAsync(
            IQueryable<CartType> query,
            ICartTypeSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCartTypesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the CartType entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the CartType entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given CreatedByUser to the CartType entity");
        }
