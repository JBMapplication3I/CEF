// <autogenerated>
// <copyright file="CartFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CartFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ICartFileModel, ICartFileSearchModel, ICartFile, CartFile}"/>
    /// <seealso cref="ICartFileWorkflow"/>
    public partial class CartFileWorkflow
        : NameableWorkflowBase<ICartFileModel, ICartFileSearchModel, ICartFile, CartFile>
            , ICartFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CartFile?, string?, ICartFileModel?> MapFromConcreteFull
            => ModelMapperForCartFile.MapCartFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartFile>, string?, IEnumerable<ICartFileModel>> SelectLiteAndMapToModel
            => ModelMapperForCartFile.SelectLiteCartFileAndMapToCartFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartFile>, string?, IEnumerable<ICartFileModel>> SelectListAndMapToModel
            => ModelMapperForCartFile.SelectListCartFileAndMapToCartFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CartFile>, string?, ICartFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCartFile.SelectFirstFullCartFileAndMapToCartFileModel;

        /// <inheritdoc/>
        protected override Func<ICartFile, ICartFileModel, DateTime, DateTime?, ICartFile> UpdateEntityFromModel
            => ModelMapperForCartFile.UpdateCartFileFromModel;
        #endregion
        ...
        {
            return await context.Set<CartFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<ICartFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<ICartFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<CartFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        protected virtual Task<CartFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<CartFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<CartFile>> FilterQueryByModelExtensionAsync(
            IQueryable<CartFile> query,
            ICartFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterCartFilesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the CartFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the CartFile entity");
        }
