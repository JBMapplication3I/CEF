// <autogenerated>
// <copyright file="BrandAuctionWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BrandAuction entities.</summary>
    /// <seealso cref="WorkflowBase{IBrandAuctionModel, IBrandAuctionSearchModel, IBrandAuction, BrandAuction}"/>
    /// <seealso cref="IBrandAuctionWorkflow"/>
    public partial class BrandAuctionWorkflow
        : WorkflowBase<IBrandAuctionModel, IBrandAuctionSearchModel, IBrandAuction, BrandAuction>
            , IBrandAuctionWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BrandAuction?, string?, IBrandAuctionModel?> MapFromConcreteFull
            => ModelMapperForBrandAuction.MapBrandAuctionModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandAuction>, string?, IEnumerable<IBrandAuctionModel>> SelectLiteAndMapToModel
            => ModelMapperForBrandAuction.SelectLiteBrandAuctionAndMapToBrandAuctionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandAuction>, string?, IEnumerable<IBrandAuctionModel>> SelectListAndMapToModel
            => ModelMapperForBrandAuction.SelectListBrandAuctionAndMapToBrandAuctionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BrandAuction>, string?, IBrandAuctionModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBrandAuction.SelectFirstFullBrandAuctionAndMapToBrandAuctionModel;

        /// <inheritdoc/>
        protected override Func<IBrandAuction, IBrandAuctionModel, DateTime, DateTime?, IBrandAuction> UpdateEntityFromModel
            => ModelMapperForBrandAuction.UpdateBrandAuctionFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BrandAuction>> FilterQueryByModelExtensionAsync(
            IQueryable<BrandAuction> query,
            IBrandAuctionSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBrandAuctionsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IBrandAuction entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the BrandAuction entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the BrandAuction entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the BrandAuction entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the BrandAuction entity");
        }
