// <autogenerated>
// <copyright file="AuctionCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AuctionCategory entities.</summary>
    /// <seealso cref="WorkflowBase{IAuctionCategoryModel, IAuctionCategorySearchModel, IAuctionCategory, AuctionCategory}"/>
    /// <seealso cref="IAuctionCategoryWorkflow"/>
    public partial class AuctionCategoryWorkflow
        : WorkflowBase<IAuctionCategoryModel, IAuctionCategorySearchModel, IAuctionCategory, AuctionCategory>
            , IAuctionCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AuctionCategory?, string?, IAuctionCategoryModel?> MapFromConcreteFull
            => ModelMapperForAuctionCategory.MapAuctionCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AuctionCategory>, string?, IEnumerable<IAuctionCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForAuctionCategory.SelectLiteAuctionCategoryAndMapToAuctionCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AuctionCategory>, string?, IEnumerable<IAuctionCategoryModel>> SelectListAndMapToModel
            => ModelMapperForAuctionCategory.SelectListAuctionCategoryAndMapToAuctionCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AuctionCategory>, string?, IAuctionCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAuctionCategory.SelectFirstFullAuctionCategoryAndMapToAuctionCategoryModel;

        /// <inheritdoc/>
        protected override Func<IAuctionCategory, IAuctionCategoryModel, DateTime, DateTime?, IAuctionCategory> UpdateEntityFromModel
            => ModelMapperForAuctionCategory.UpdateAuctionCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AuctionCategory>> FilterQueryByModelExtensionAsync(
            IQueryable<AuctionCategory> query,
            IAuctionCategorySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAuctionCategoriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IAuctionCategory entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Auctions.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateAuctionFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AuctionCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AuctionCategory entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AuctionCategory entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AuctionCategory entity");
        }
