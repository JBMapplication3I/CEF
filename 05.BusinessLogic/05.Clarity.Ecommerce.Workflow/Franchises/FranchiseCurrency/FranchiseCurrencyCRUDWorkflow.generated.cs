// <autogenerated>
// <copyright file="FranchiseCurrencyWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseCurrency entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseCurrencyModel, IFranchiseCurrencySearchModel, IFranchiseCurrency, FranchiseCurrency}"/>
    /// <seealso cref="IFranchiseCurrencyWorkflow"/>
    public partial class FranchiseCurrencyWorkflow
        : WorkflowBase<IFranchiseCurrencyModel, IFranchiseCurrencySearchModel, IFranchiseCurrency, FranchiseCurrency>
            , IFranchiseCurrencyWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseCurrency?, string?, IFranchiseCurrencyModel?> MapFromConcreteFull
            => ModelMapperForFranchiseCurrency.MapFranchiseCurrencyModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseCurrency>, string?, IEnumerable<IFranchiseCurrencyModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseCurrency.SelectLiteFranchiseCurrencyAndMapToFranchiseCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseCurrency>, string?, IEnumerable<IFranchiseCurrencyModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseCurrency.SelectListFranchiseCurrencyAndMapToFranchiseCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseCurrency>, string?, IFranchiseCurrencyModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseCurrency.SelectFirstFullFranchiseCurrencyAndMapToFranchiseCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseCurrency, IFranchiseCurrencyModel, DateTime, DateTime?, IFranchiseCurrency> UpdateEntityFromModel
            => ModelMapperForFranchiseCurrency.UpdateFranchiseCurrencyFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseCurrency>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseCurrency> query,
            IFranchiseCurrencySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseCurrenciesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseCurrency entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseCurrency entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseCurrency entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseCurrency entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseCurrency entity");
        }
