// <autogenerated>
// <copyright file="FranchiseDistrictWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseDistrict entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseDistrictModel, IFranchiseDistrictSearchModel, IFranchiseDistrict, FranchiseDistrict}"/>
    /// <seealso cref="IFranchiseDistrictWorkflow"/>
    public partial class FranchiseDistrictWorkflow
        : WorkflowBase<IFranchiseDistrictModel, IFranchiseDistrictSearchModel, IFranchiseDistrict, FranchiseDistrict>
            , IFranchiseDistrictWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseDistrict?, string?, IFranchiseDistrictModel?> MapFromConcreteFull
            => ModelMapperForFranchiseDistrict.MapFranchiseDistrictModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseDistrict>, string?, IEnumerable<IFranchiseDistrictModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseDistrict.SelectLiteFranchiseDistrictAndMapToFranchiseDistrictModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseDistrict>, string?, IEnumerable<IFranchiseDistrictModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseDistrict.SelectListFranchiseDistrictAndMapToFranchiseDistrictModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseDistrict>, string?, IFranchiseDistrictModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseDistrict.SelectFirstFullFranchiseDistrictAndMapToFranchiseDistrictModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseDistrict, IFranchiseDistrictModel, DateTime, DateTime?, IFranchiseDistrict> UpdateEntityFromModel
            => ModelMapperForFranchiseDistrict.UpdateFranchiseDistrictFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseDistrict>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseDistrict> query,
            IFranchiseDistrictSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseDistrictsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseDistrict entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseDistrict entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseDistrict entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Districts.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateDistrictFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseDistrict entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (District)resolved.Result!.CreateDistrictEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseDistrict entity");
        }
