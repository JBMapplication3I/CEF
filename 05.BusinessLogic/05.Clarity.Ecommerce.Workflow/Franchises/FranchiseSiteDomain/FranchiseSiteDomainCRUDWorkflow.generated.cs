// <autogenerated>
// <copyright file="FranchiseSiteDomainWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseSiteDomain entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseSiteDomainModel, IFranchiseSiteDomainSearchModel, IFranchiseSiteDomain, FranchiseSiteDomain}"/>
    /// <seealso cref="IFranchiseSiteDomainWorkflow"/>
    public partial class FranchiseSiteDomainWorkflow
        : WorkflowBase<IFranchiseSiteDomainModel, IFranchiseSiteDomainSearchModel, IFranchiseSiteDomain, FranchiseSiteDomain>
            , IFranchiseSiteDomainWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseSiteDomain?, string?, IFranchiseSiteDomainModel?> MapFromConcreteFull
            => ModelMapperForFranchiseSiteDomain.MapFranchiseSiteDomainModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseSiteDomain>, string?, IEnumerable<IFranchiseSiteDomainModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseSiteDomain.SelectLiteFranchiseSiteDomainAndMapToFranchiseSiteDomainModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseSiteDomain>, string?, IEnumerable<IFranchiseSiteDomainModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseSiteDomain.SelectListFranchiseSiteDomainAndMapToFranchiseSiteDomainModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseSiteDomain>, string?, IFranchiseSiteDomainModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseSiteDomain.SelectFirstFullFranchiseSiteDomainAndMapToFranchiseSiteDomainModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseSiteDomain, IFranchiseSiteDomainModel, DateTime, DateTime?, IFranchiseSiteDomain> UpdateEntityFromModel
            => ModelMapperForFranchiseSiteDomain.UpdateFranchiseSiteDomainFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseSiteDomain>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseSiteDomain> query,
            IFranchiseSiteDomainSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseSiteDomainsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseSiteDomain entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseSiteDomain entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseSiteDomain entity");
        }
