// <autogenerated>
// <copyright file="FranchiseLanguageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseLanguage entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseLanguageModel, IFranchiseLanguageSearchModel, IFranchiseLanguage, FranchiseLanguage}"/>
    /// <seealso cref="IFranchiseLanguageWorkflow"/>
    public partial class FranchiseLanguageWorkflow
        : WorkflowBase<IFranchiseLanguageModel, IFranchiseLanguageSearchModel, IFranchiseLanguage, FranchiseLanguage>
            , IFranchiseLanguageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseLanguage?, string?, IFranchiseLanguageModel?> MapFromConcreteFull
            => ModelMapperForFranchiseLanguage.MapFranchiseLanguageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseLanguage>, string?, IEnumerable<IFranchiseLanguageModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseLanguage.SelectLiteFranchiseLanguageAndMapToFranchiseLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseLanguage>, string?, IEnumerable<IFranchiseLanguageModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseLanguage.SelectListFranchiseLanguageAndMapToFranchiseLanguageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseLanguage>, string?, IFranchiseLanguageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseLanguage.SelectFirstFullFranchiseLanguageAndMapToFranchiseLanguageModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseLanguage, IFranchiseLanguageModel, DateTime, DateTime?, IFranchiseLanguage> UpdateEntityFromModel
            => ModelMapperForFranchiseLanguage.UpdateFranchiseLanguageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseLanguage>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseLanguage> query,
            IFranchiseLanguageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseLanguagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseLanguage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseLanguage entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseLanguage entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseLanguage entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseLanguage entity");
        }
