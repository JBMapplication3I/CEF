// <autogenerated>
// <copyright file="FranchiseProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseProduct entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseProductModel, IFranchiseProductSearchModel, IFranchiseProduct, FranchiseProduct}"/>
    /// <seealso cref="IFranchiseProductWorkflow"/>
    public partial class FranchiseProductWorkflow
        : WorkflowBase<IFranchiseProductModel, IFranchiseProductSearchModel, IFranchiseProduct, FranchiseProduct>
            , IFranchiseProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseProduct?, string?, IFranchiseProductModel?> MapFromConcreteFull
            => ModelMapperForFranchiseProduct.MapFranchiseProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseProduct>, string?, IEnumerable<IFranchiseProductModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseProduct.SelectLiteFranchiseProductAndMapToFranchiseProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseProduct>, string?, IEnumerable<IFranchiseProductModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseProduct.SelectListFranchiseProductAndMapToFranchiseProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseProduct>, string?, IFranchiseProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseProduct.SelectFirstFullFranchiseProductAndMapToFranchiseProductModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseProduct, IFranchiseProductModel, DateTime, DateTime?, IFranchiseProduct> UpdateEntityFromModel
            => ModelMapperForFranchiseProduct.UpdateFranchiseProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseProduct>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseProductsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseProduct entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseProduct entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseProduct entity");
        }
