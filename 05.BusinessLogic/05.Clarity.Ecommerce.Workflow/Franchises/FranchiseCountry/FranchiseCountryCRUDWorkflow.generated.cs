// <autogenerated>
// <copyright file="FranchiseCountryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseCountry entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseCountryModel, IFranchiseCountrySearchModel, IFranchiseCountry, FranchiseCountry}"/>
    /// <seealso cref="IFranchiseCountryWorkflow"/>
    public partial class FranchiseCountryWorkflow
        : WorkflowBase<IFranchiseCountryModel, IFranchiseCountrySearchModel, IFranchiseCountry, FranchiseCountry>
            , IFranchiseCountryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseCountry?, string?, IFranchiseCountryModel?> MapFromConcreteFull
            => ModelMapperForFranchiseCountry.MapFranchiseCountryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseCountry>, string?, IEnumerable<IFranchiseCountryModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseCountry.SelectLiteFranchiseCountryAndMapToFranchiseCountryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseCountry>, string?, IEnumerable<IFranchiseCountryModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseCountry.SelectListFranchiseCountryAndMapToFranchiseCountryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseCountry>, string?, IFranchiseCountryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseCountry.SelectFirstFullFranchiseCountryAndMapToFranchiseCountryModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseCountry, IFranchiseCountryModel, DateTime, DateTime?, IFranchiseCountry> UpdateEntityFromModel
            => ModelMapperForFranchiseCountry.UpdateFranchiseCountryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseCountry>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseCountry> query,
            IFranchiseCountrySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseCountriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseCountry entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseCountry entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseCountry entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseCountry entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseCountry entity");
        }
