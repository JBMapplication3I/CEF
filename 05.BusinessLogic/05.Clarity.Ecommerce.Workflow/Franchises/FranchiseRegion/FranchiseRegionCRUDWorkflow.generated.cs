// <autogenerated>
// <copyright file="FranchiseRegionWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseRegion entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseRegionModel, IFranchiseRegionSearchModel, IFranchiseRegion, FranchiseRegion}"/>
    /// <seealso cref="IFranchiseRegionWorkflow"/>
    public partial class FranchiseRegionWorkflow
        : WorkflowBase<IFranchiseRegionModel, IFranchiseRegionSearchModel, IFranchiseRegion, FranchiseRegion>
            , IFranchiseRegionWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseRegion?, string?, IFranchiseRegionModel?> MapFromConcreteFull
            => ModelMapperForFranchiseRegion.MapFranchiseRegionModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseRegion>, string?, IEnumerable<IFranchiseRegionModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseRegion.SelectLiteFranchiseRegionAndMapToFranchiseRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseRegion>, string?, IEnumerable<IFranchiseRegionModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseRegion.SelectListFranchiseRegionAndMapToFranchiseRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseRegion>, string?, IFranchiseRegionModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseRegion.SelectFirstFullFranchiseRegionAndMapToFranchiseRegionModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseRegion, IFranchiseRegionModel, DateTime, DateTime?, IFranchiseRegion> UpdateEntityFromModel
            => ModelMapperForFranchiseRegion.UpdateFranchiseRegionFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseRegion>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseRegion> query,
            IFranchiseRegionSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseRegionsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseRegion entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseRegion entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseRegion entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseRegion entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseRegion entity");
        }
