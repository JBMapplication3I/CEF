// <autogenerated>
// <copyright file="FranchiseStoreWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseStore entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseStoreModel, IFranchiseStoreSearchModel, IFranchiseStore, FranchiseStore}"/>
    /// <seealso cref="IFranchiseStoreWorkflow"/>
    public partial class FranchiseStoreWorkflow
        : WorkflowBase<IFranchiseStoreModel, IFranchiseStoreSearchModel, IFranchiseStore, FranchiseStore>
            , IFranchiseStoreWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseStore?, string?, IFranchiseStoreModel?> MapFromConcreteFull
            => ModelMapperForFranchiseStore.MapFranchiseStoreModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseStore>, string?, IEnumerable<IFranchiseStoreModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseStore.SelectLiteFranchiseStoreAndMapToFranchiseStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseStore>, string?, IEnumerable<IFranchiseStoreModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseStore.SelectListFranchiseStoreAndMapToFranchiseStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseStore>, string?, IFranchiseStoreModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseStore.SelectFirstFullFranchiseStoreAndMapToFranchiseStoreModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseStore, IFranchiseStoreModel, DateTime, DateTime?, IFranchiseStore> UpdateEntityFromModel
            => ModelMapperForFranchiseStore.UpdateFranchiseStoreFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseStore>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseStore> query,
            IFranchiseStoreSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseStoresBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseStore entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseStore entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseStore entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseStore entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseStore entity");
        }
