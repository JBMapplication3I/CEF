// <autogenerated>
// <copyright file="FranchiseVendorWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseVendor entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseVendorModel, IFranchiseVendorSearchModel, IFranchiseVendor, FranchiseVendor}"/>
    /// <seealso cref="IFranchiseVendorWorkflow"/>
    public partial class FranchiseVendorWorkflow
        : WorkflowBase<IFranchiseVendorModel, IFranchiseVendorSearchModel, IFranchiseVendor, FranchiseVendor>
            , IFranchiseVendorWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseVendor?, string?, IFranchiseVendorModel?> MapFromConcreteFull
            => ModelMapperForFranchiseVendor.MapFranchiseVendorModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseVendor>, string?, IEnumerable<IFranchiseVendorModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseVendor.SelectLiteFranchiseVendorAndMapToFranchiseVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseVendor>, string?, IEnumerable<IFranchiseVendorModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseVendor.SelectListFranchiseVendorAndMapToFranchiseVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseVendor>, string?, IFranchiseVendorModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseVendor.SelectFirstFullFranchiseVendorAndMapToFranchiseVendorModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseVendor, IFranchiseVendorModel, DateTime, DateTime?, IFranchiseVendor> UpdateEntityFromModel
            => ModelMapperForFranchiseVendor.UpdateFranchiseVendorFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseVendor>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseVendor> query,
            IFranchiseVendorSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseVendorsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseVendor entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseVendor entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseVendor entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseVendor entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseVendor entity");
        }
