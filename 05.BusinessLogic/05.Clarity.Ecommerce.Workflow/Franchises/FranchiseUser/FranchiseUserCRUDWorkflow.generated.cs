// <autogenerated>
// <copyright file="FranchiseUserWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseUser entities.</summary>
    /// <seealso cref="WorkflowBase{IFranchiseUserModel, IFranchiseUserSearchModel, IFranchiseUser, FranchiseUser}"/>
    /// <seealso cref="IFranchiseUserWorkflow"/>
    public partial class FranchiseUserWorkflow
        : WorkflowBase<IFranchiseUserModel, IFranchiseUserSearchModel, IFranchiseUser, FranchiseUser>
            , IFranchiseUserWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseUser?, string?, IFranchiseUserModel?> MapFromConcreteFull
            => ModelMapperForFranchiseUser.MapFranchiseUserModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseUser>, string?, IEnumerable<IFranchiseUserModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseUser.SelectLiteFranchiseUserAndMapToFranchiseUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseUser>, string?, IEnumerable<IFranchiseUserModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseUser.SelectListFranchiseUserAndMapToFranchiseUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseUser>, string?, IFranchiseUserModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseUser.SelectFirstFullFranchiseUserAndMapToFranchiseUserModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseUser, IFranchiseUserModel, DateTime, DateTime?, IFranchiseUser> UpdateEntityFromModel
            => ModelMapperForFranchiseUser.UpdateFranchiseUserFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseUser>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseUser> query,
            IFranchiseUserSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseUsersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseUser entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FranchiseUser entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FranchiseUser entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FranchiseUser entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FranchiseUser entity");
        }
