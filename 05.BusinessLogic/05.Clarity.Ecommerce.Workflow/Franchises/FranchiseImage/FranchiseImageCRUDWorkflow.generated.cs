// <autogenerated>
// <copyright file="FranchiseImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FranchiseImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IFranchiseImageModel, IFranchiseImageSearchModel, IFranchiseImage, FranchiseImage}"/>
    /// <seealso cref="IFranchiseImageWorkflow"/>
    public partial class FranchiseImageWorkflow
        : NameableWorkflowBase<IFranchiseImageModel, IFranchiseImageSearchModel, IFranchiseImage, FranchiseImage>
            , IFranchiseImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FranchiseImage?, string?, IFranchiseImageModel?> MapFromConcreteFull
            => ModelMapperForFranchiseImage.MapFranchiseImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseImage>, string?, IEnumerable<IFranchiseImageModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchiseImage.SelectLiteFranchiseImageAndMapToFranchiseImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseImage>, string?, IEnumerable<IFranchiseImageModel>> SelectListAndMapToModel
            => ModelMapperForFranchiseImage.SelectListFranchiseImageAndMapToFranchiseImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FranchiseImage>, string?, IFranchiseImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchiseImage.SelectFirstFullFranchiseImageAndMapToFranchiseImageModel;

        /// <inheritdoc/>
        protected override Func<IFranchiseImage, IFranchiseImageModel, DateTime, DateTime?, IFranchiseImage> UpdateEntityFromModel
            => ModelMapperForFranchiseImage.UpdateFranchiseImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FranchiseImage>> FilterQueryByModelExtensionAsync(
            IQueryable<FranchiseImage> query,
            IFranchiseImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchiseImagesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFranchiseImage entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.FranchiseImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateFranchiseImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the FranchiseImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (FranchiseImageType)resolved.Result!.CreateFranchiseImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the FranchiseImage entity");
        }
