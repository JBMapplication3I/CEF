// <autogenerated>
// <copyright file="FranchiseWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Franchise Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IFranchiseModel, IFranchise, INoteModel, INote, Note}"/>
    /// <seealso cref="IFranchiseWithNotesAssociationWorkflow"/>
    public partial class FranchiseWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<IFranchiseModel, IFranchise, INoteModel, INote, Note>
        , IFranchiseWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IFranchise entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(IFranchiseModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IFranchise entity, INote newEntity)
        {
