// <autogenerated>
// <copyright file="FranchiseWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for Franchise entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IFranchiseModel, IFranchiseSearchModel, IFranchise, Franchise}"/>
    /// <seealso cref="IFranchiseWorkflow"/>
    public partial class FranchiseWorkflow
        : NameableWorkflowBase<IFranchiseModel, IFranchiseSearchModel, IFranchise, Franchise>
            , IFranchiseWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<Franchise?, string?, IFranchiseModel?> MapFromConcreteFull
            => ModelMapperForFranchise.MapFranchiseModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<Franchise>, string?, IEnumerable<IFranchiseModel>> SelectLiteAndMapToModel
            => ModelMapperForFranchise.SelectLiteFranchiseAndMapToFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Franchise>, string?, IEnumerable<IFranchiseModel>> SelectListAndMapToModel
            => ModelMapperForFranchise.SelectListFranchiseAndMapToFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Franchise>, string?, IFranchiseModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFranchise.SelectFirstFullFranchiseAndMapToFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IFranchise, IFranchiseModel, DateTime, DateTime?, IFranchise> UpdateEntityFromModel
            => ModelMapperForFranchise.UpdateFranchiseFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<Franchise>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFranchisesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Brands != null) { await Workflows.FranchiseWithBrandsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: Categories
            if (model.Manufacturers != null) { await Workflows.FranchiseWithManufacturersAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Products != null) { await Workflows.FranchiseWithProductsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            if (model.Vendors != null) { await Workflows.FranchiseWithVendorsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            ...
            if (model.FranchiseCountries != null) { await Workflows.FranchiseWithFranchiseCountriesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.FranchiseRegions != null) { await Workflows.FranchiseWithFranchiseRegionsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.FranchiseDistricts != null) { await Workflows.FranchiseWithFranchiseDistrictsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.FranchiseTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateFranchiseTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the Franchise entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (FranchiseType)resolved.Result!.CreateFranchiseTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderDollarAmountBufferProduct to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderQuantityAmountBufferProduct to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderDollarAmountBufferCategory to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumOrderQuantityAmountBufferCategory to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingDollarAmountBufferProduct to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingQuantityAmountBufferProduct to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingDollarAmountBufferCategory to the Franchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given MinimumForFreeShippingQuantityAmountBufferCategory to the Franchise entity");
        }
