// <autogenerated>
// <copyright file="AdWithAdZonesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Ad Ad Zones association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IAdModel, IAd, IAdZoneModel, IAdZone, AdZone}"/>
    /// <seealso cref="IAdWithAdZonesAssociationWorkflow"/>
    public partial class AdWithAdZonesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<IAdModel, IAd, IAdZoneModel, IAdZone, AdZone>
        , IAdWithAdZonesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<AdZone>? GetObjectsCollection(IAd entity) { return entity.AdZones; }

        /// <inheritdoc/>
        protected override List<IAdZoneModel>? GetModelObjectsList(IAdModel model) { return model.AdZones; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IAd entity, IAdZone newEntity)
        {
