// <autogenerated>
// <copyright file="AdBrandWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AdBrand entities.</summary>
    /// <seealso cref="WorkflowBase{IAdBrandModel, IAdBrandSearchModel, IAdBrand, AdBrand}"/>
    /// <seealso cref="IAdBrandWorkflow"/>
    public partial class AdBrandWorkflow
        : WorkflowBase<IAdBrandModel, IAdBrandSearchModel, IAdBrand, AdBrand>
            , IAdBrandWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AdBrand?, string?, IAdBrandModel?> MapFromConcreteFull
            => ModelMapperForAdBrand.MapAdBrandModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdBrand>, string?, IEnumerable<IAdBrandModel>> SelectLiteAndMapToModel
            => ModelMapperForAdBrand.SelectLiteAdBrandAndMapToAdBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdBrand>, string?, IEnumerable<IAdBrandModel>> SelectListAndMapToModel
            => ModelMapperForAdBrand.SelectListAdBrandAndMapToAdBrandModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdBrand>, string?, IAdBrandModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAdBrand.SelectFirstFullAdBrandAndMapToAdBrandModel;

        /// <inheritdoc/>
        protected override Func<IAdBrand, IAdBrandModel, DateTime, DateTime?, IAdBrand> UpdateEntityFromModel
            => ModelMapperForAdBrand.UpdateAdBrandFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AdBrand>> FilterQueryByModelExtensionAsync(
            IQueryable<AdBrand> query,
            IAdBrandSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAdBrandsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AdBrand entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AdBrand entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AdBrand entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AdBrand entity");
        }
