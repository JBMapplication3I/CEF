// <autogenerated>
// <copyright file="AdFranchiseWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AdFranchise entities.</summary>
    /// <seealso cref="WorkflowBase{IAdFranchiseModel, IAdFranchiseSearchModel, IAdFranchise, AdFranchise}"/>
    /// <seealso cref="IAdFranchiseWorkflow"/>
    public partial class AdFranchiseWorkflow
        : WorkflowBase<IAdFranchiseModel, IAdFranchiseSearchModel, IAdFranchise, AdFranchise>
            , IAdFranchiseWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AdFranchise?, string?, IAdFranchiseModel?> MapFromConcreteFull
            => ModelMapperForAdFranchise.MapAdFranchiseModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdFranchise>, string?, IEnumerable<IAdFranchiseModel>> SelectLiteAndMapToModel
            => ModelMapperForAdFranchise.SelectLiteAdFranchiseAndMapToAdFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdFranchise>, string?, IEnumerable<IAdFranchiseModel>> SelectListAndMapToModel
            => ModelMapperForAdFranchise.SelectListAdFranchiseAndMapToAdFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdFranchise>, string?, IAdFranchiseModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAdFranchise.SelectFirstFullAdFranchiseAndMapToAdFranchiseModel;

        /// <inheritdoc/>
        protected override Func<IAdFranchise, IAdFranchiseModel, DateTime, DateTime?, IAdFranchise> UpdateEntityFromModel
            => ModelMapperForAdFranchise.UpdateAdFranchiseFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AdFranchise>> FilterQueryByModelExtensionAsync(
            IQueryable<AdFranchise> query,
            IAdFranchiseSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAdFranchisesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AdFranchise entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AdFranchise entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AdFranchise entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AdFranchise entity");
        }
