// <autogenerated>
// <copyright file="AdAccountWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AdAccount entities.</summary>
    /// <seealso cref="WorkflowBase{IAdAccountModel, IAdAccountSearchModel, IAdAccount, AdAccount}"/>
    /// <seealso cref="IAdAccountWorkflow"/>
    public partial class AdAccountWorkflow
        : WorkflowBase<IAdAccountModel, IAdAccountSearchModel, IAdAccount, AdAccount>
            , IAdAccountWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AdAccount?, string?, IAdAccountModel?> MapFromConcreteFull
            => ModelMapperForAdAccount.MapAdAccountModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdAccount>, string?, IEnumerable<IAdAccountModel>> SelectLiteAndMapToModel
            => ModelMapperForAdAccount.SelectLiteAdAccountAndMapToAdAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdAccount>, string?, IEnumerable<IAdAccountModel>> SelectListAndMapToModel
            => ModelMapperForAdAccount.SelectListAdAccountAndMapToAdAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdAccount>, string?, IAdAccountModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAdAccount.SelectFirstFullAdAccountAndMapToAdAccountModel;

        /// <inheritdoc/>
        protected override Func<IAdAccount, IAdAccountModel, DateTime, DateTime?, IAdAccount> UpdateEntityFromModel
            => ModelMapperForAdAccount.UpdateAdAccountFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AdAccount>> FilterQueryByModelExtensionAsync(
            IQueryable<AdAccount> query,
            IAdAccountSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAdAccountsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AdAccount entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AdAccount entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AdAccount entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AdAccount entity");
        }
