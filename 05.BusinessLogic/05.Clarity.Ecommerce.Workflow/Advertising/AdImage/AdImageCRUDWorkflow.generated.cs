// <autogenerated>
// <copyright file="AdImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AdImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IAdImageModel, IAdImageSearchModel, IAdImage, AdImage}"/>
    /// <seealso cref="IAdImageWorkflow"/>
    public partial class AdImageWorkflow
        : NameableWorkflowBase<IAdImageModel, IAdImageSearchModel, IAdImage, AdImage>
            , IAdImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AdImage?, string?, IAdImageModel?> MapFromConcreteFull
            => ModelMapperForAdImage.MapAdImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdImage>, string?, IEnumerable<IAdImageModel>> SelectLiteAndMapToModel
            => ModelMapperForAdImage.SelectLiteAdImageAndMapToAdImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdImage>, string?, IEnumerable<IAdImageModel>> SelectListAndMapToModel
            => ModelMapperForAdImage.SelectListAdImageAndMapToAdImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdImage>, string?, IAdImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAdImage.SelectFirstFullAdImageAndMapToAdImageModel;

        /// <inheritdoc/>
        protected override Func<IAdImage, IAdImageModel, DateTime, DateTime?, IAdImage> UpdateEntityFromModel
            => ModelMapperForAdImage.UpdateAdImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AdImage>> FilterQueryByModelExtensionAsync(
            IQueryable<AdImage> query,
            IAdImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAdImagesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.AdImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateAdImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the AdImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (AdImageType)resolved.Result!.CreateAdImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the AdImage entity");
        }
