// <autogenerated>
// <copyright file="AdStoreWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AdStore entities.</summary>
    /// <seealso cref="WorkflowBase{IAdStoreModel, IAdStoreSearchModel, IAdStore, AdStore}"/>
    /// <seealso cref="IAdStoreWorkflow"/>
    public partial class AdStoreWorkflow
        : WorkflowBase<IAdStoreModel, IAdStoreSearchModel, IAdStore, AdStore>
            , IAdStoreWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AdStore?, string?, IAdStoreModel?> MapFromConcreteFull
            => ModelMapperForAdStore.MapAdStoreModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdStore>, string?, IEnumerable<IAdStoreModel>> SelectLiteAndMapToModel
            => ModelMapperForAdStore.SelectLiteAdStoreAndMapToAdStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdStore>, string?, IEnumerable<IAdStoreModel>> SelectListAndMapToModel
            => ModelMapperForAdStore.SelectListAdStoreAndMapToAdStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AdStore>, string?, IAdStoreModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAdStore.SelectFirstFullAdStoreAndMapToAdStoreModel;

        /// <inheritdoc/>
        protected override Func<IAdStore, IAdStoreModel, DateTime, DateTime?, IAdStore> UpdateEntityFromModel
            => ModelMapperForAdStore.UpdateAdStoreFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AdStore>> FilterQueryByModelExtensionAsync(
            IQueryable<AdStore> query,
            IAdStoreSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAdStoresBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AdStore entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AdStore entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AdStore entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AdStore entity");
        }
