// <autogenerated>
// <copyright file="BadgeImageWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for BadgeImage entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IBadgeImageModel, IBadgeImageSearchModel, IBadgeImage, BadgeImage}"/>
    /// <seealso cref="IBadgeImageWorkflow"/>
    public partial class BadgeImageWorkflow
        : NameableWorkflowBase<IBadgeImageModel, IBadgeImageSearchModel, IBadgeImage, BadgeImage>
            , IBadgeImageWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<BadgeImage?, string?, IBadgeImageModel?> MapFromConcreteFull
            => ModelMapperForBadgeImage.MapBadgeImageModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<BadgeImage>, string?, IEnumerable<IBadgeImageModel>> SelectLiteAndMapToModel
            => ModelMapperForBadgeImage.SelectLiteBadgeImageAndMapToBadgeImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BadgeImage>, string?, IEnumerable<IBadgeImageModel>> SelectListAndMapToModel
            => ModelMapperForBadgeImage.SelectListBadgeImageAndMapToBadgeImageModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<BadgeImage>, string?, IBadgeImageModel?> SelectFirstFullAndMapToModel
            => ModelMapperForBadgeImage.SelectFirstFullBadgeImageAndMapToBadgeImageModel;

        /// <inheritdoc/>
        protected override Func<IBadgeImage, IBadgeImageModel, DateTime, DateTime?, IBadgeImage> UpdateEntityFromModel
            => ModelMapperForBadgeImage.UpdateBadgeImageFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<BadgeImage>> FilterQueryByModelExtensionAsync(
            IQueryable<BadgeImage> query,
            IBadgeImageSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterBadgeImagesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.BadgeImageTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdateBadgeImageTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the BadgeImage entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (BadgeImageType)resolved.Result!.CreateBadgeImageTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the BadgeImage entity");
        }
