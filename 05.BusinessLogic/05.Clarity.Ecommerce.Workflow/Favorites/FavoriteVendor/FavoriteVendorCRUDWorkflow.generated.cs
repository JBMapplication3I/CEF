// <autogenerated>
// <copyright file="FavoriteVendorWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FavoriteVendor entities.</summary>
    /// <seealso cref="WorkflowBase{IFavoriteVendorModel, IFavoriteVendorSearchModel, IFavoriteVendor, FavoriteVendor}"/>
    /// <seealso cref="IFavoriteVendorWorkflow"/>
    public partial class FavoriteVendorWorkflow
        : WorkflowBase<IFavoriteVendorModel, IFavoriteVendorSearchModel, IFavoriteVendor, FavoriteVendor>
            , IFavoriteVendorWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FavoriteVendor?, string?, IFavoriteVendorModel?> MapFromConcreteFull
            => ModelMapperForFavoriteVendor.MapFavoriteVendorModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteVendor>, string?, IEnumerable<IFavoriteVendorModel>> SelectLiteAndMapToModel
            => ModelMapperForFavoriteVendor.SelectLiteFavoriteVendorAndMapToFavoriteVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteVendor>, string?, IEnumerable<IFavoriteVendorModel>> SelectListAndMapToModel
            => ModelMapperForFavoriteVendor.SelectListFavoriteVendorAndMapToFavoriteVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteVendor>, string?, IFavoriteVendorModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFavoriteVendor.SelectFirstFullFavoriteVendorAndMapToFavoriteVendorModel;

        /// <inheritdoc/>
        protected override Func<IFavoriteVendor, IFavoriteVendorModel, DateTime, DateTime?, IFavoriteVendor> UpdateEntityFromModel
            => ModelMapperForFavoriteVendor.UpdateFavoriteVendorFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FavoriteVendor>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFavoriteVendorsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFavoriteVendor entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FavoriteVendor entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FavoriteVendor entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FavoriteVendor entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FavoriteVendor entity");
        }
