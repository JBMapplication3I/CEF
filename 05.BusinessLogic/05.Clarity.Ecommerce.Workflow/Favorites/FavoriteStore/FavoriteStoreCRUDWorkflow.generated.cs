// <autogenerated>
// <copyright file="FavoriteStoreWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FavoriteStore entities.</summary>
    /// <seealso cref="WorkflowBase{IFavoriteStoreModel, IFavoriteStoreSearchModel, IFavoriteStore, FavoriteStore}"/>
    /// <seealso cref="IFavoriteStoreWorkflow"/>
    public partial class FavoriteStoreWorkflow
        : WorkflowBase<IFavoriteStoreModel, IFavoriteStoreSearchModel, IFavoriteStore, FavoriteStore>
            , IFavoriteStoreWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FavoriteStore?, string?, IFavoriteStoreModel?> MapFromConcreteFull
            => ModelMapperForFavoriteStore.MapFavoriteStoreModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteStore>, string?, IEnumerable<IFavoriteStoreModel>> SelectLiteAndMapToModel
            => ModelMapperForFavoriteStore.SelectLiteFavoriteStoreAndMapToFavoriteStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteStore>, string?, IEnumerable<IFavoriteStoreModel>> SelectListAndMapToModel
            => ModelMapperForFavoriteStore.SelectListFavoriteStoreAndMapToFavoriteStoreModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteStore>, string?, IFavoriteStoreModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFavoriteStore.SelectFirstFullFavoriteStoreAndMapToFavoriteStoreModel;

        /// <inheritdoc/>
        protected override Func<IFavoriteStore, IFavoriteStoreModel, DateTime, DateTime?, IFavoriteStore> UpdateEntityFromModel
            => ModelMapperForFavoriteStore.UpdateFavoriteStoreFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FavoriteStore>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FavoriteStore entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FavoriteStore entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FavoriteStore entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FavoriteStore entity");
        }
