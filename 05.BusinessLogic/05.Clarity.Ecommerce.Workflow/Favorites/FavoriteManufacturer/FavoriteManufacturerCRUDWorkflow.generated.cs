// <autogenerated>
// <copyright file="FavoriteManufacturerWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FavoriteManufacturer entities.</summary>
    /// <seealso cref="WorkflowBase{IFavoriteManufacturerModel, IFavoriteManufacturerSearchModel, IFavoriteManufacturer, FavoriteManufacturer}"/>
    /// <seealso cref="IFavoriteManufacturerWorkflow"/>
    public partial class FavoriteManufacturerWorkflow
        : WorkflowBase<IFavoriteManufacturerModel, IFavoriteManufacturerSearchModel, IFavoriteManufacturer, FavoriteManufacturer>
            , IFavoriteManufacturerWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FavoriteManufacturer?, string?, IFavoriteManufacturerModel?> MapFromConcreteFull
            => ModelMapperForFavoriteManufacturer.MapFavoriteManufacturerModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteManufacturer>, string?, IEnumerable<IFavoriteManufacturerModel>> SelectLiteAndMapToModel
            => ModelMapperForFavoriteManufacturer.SelectLiteFavoriteManufacturerAndMapToFavoriteManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteManufacturer>, string?, IEnumerable<IFavoriteManufacturerModel>> SelectListAndMapToModel
            => ModelMapperForFavoriteManufacturer.SelectListFavoriteManufacturerAndMapToFavoriteManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteManufacturer>, string?, IFavoriteManufacturerModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFavoriteManufacturer.SelectFirstFullFavoriteManufacturerAndMapToFavoriteManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IFavoriteManufacturer, IFavoriteManufacturerModel, DateTime, DateTime?, IFavoriteManufacturer> UpdateEntityFromModel
            => ModelMapperForFavoriteManufacturer.UpdateFavoriteManufacturerFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FavoriteManufacturer>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFavoriteManufacturersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFavoriteManufacturer entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FavoriteManufacturer entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FavoriteManufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FavoriteManufacturer entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FavoriteManufacturer entity");
        }
