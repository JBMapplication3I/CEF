// <autogenerated>
// <copyright file="FavoriteCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for FavoriteCategory entities.</summary>
    /// <seealso cref="WorkflowBase{IFavoriteCategoryModel, IFavoriteCategorySearchModel, IFavoriteCategory, FavoriteCategory}"/>
    /// <seealso cref="IFavoriteCategoryWorkflow"/>
    public partial class FavoriteCategoryWorkflow
        : WorkflowBase<IFavoriteCategoryModel, IFavoriteCategorySearchModel, IFavoriteCategory, FavoriteCategory>
            , IFavoriteCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<FavoriteCategory?, string?, IFavoriteCategoryModel?> MapFromConcreteFull
            => ModelMapperForFavoriteCategory.MapFavoriteCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteCategory>, string?, IEnumerable<IFavoriteCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForFavoriteCategory.SelectLiteFavoriteCategoryAndMapToFavoriteCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteCategory>, string?, IEnumerable<IFavoriteCategoryModel>> SelectListAndMapToModel
            => ModelMapperForFavoriteCategory.SelectListFavoriteCategoryAndMapToFavoriteCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<FavoriteCategory>, string?, IFavoriteCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForFavoriteCategory.SelectFirstFullFavoriteCategoryAndMapToFavoriteCategoryModel;

        /// <inheritdoc/>
        protected override Func<IFavoriteCategory, IFavoriteCategoryModel, DateTime, DateTime?, IFavoriteCategory> UpdateEntityFromModel
            => ModelMapperForFavoriteCategory.UpdateFavoriteCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<FavoriteCategory>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterFavoriteCategoriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IFavoriteCategory entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the FavoriteCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the FavoriteCategory entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the FavoriteCategory entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the FavoriteCategory entity");
        }
