// <autogenerated>
// <copyright file="StoreCountryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreCountry entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreCountryModel, IStoreCountrySearchModel, IStoreCountry, StoreCountry}"/>
    /// <seealso cref="IStoreCountryWorkflow"/>
    public partial class StoreCountryWorkflow
        : WorkflowBase<IStoreCountryModel, IStoreCountrySearchModel, IStoreCountry, StoreCountry>
            , IStoreCountryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreCountry?, string?, IStoreCountryModel?> MapFromConcreteFull
            => ModelMapperForStoreCountry.MapStoreCountryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreCountry>, string?, IEnumerable<IStoreCountryModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreCountry.SelectLiteStoreCountryAndMapToStoreCountryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreCountry>, string?, IEnumerable<IStoreCountryModel>> SelectListAndMapToModel
            => ModelMapperForStoreCountry.SelectListStoreCountryAndMapToStoreCountryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreCountry>, string?, IStoreCountryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreCountry.SelectFirstFullStoreCountryAndMapToStoreCountryModel;

        /// <inheritdoc/>
        protected override Func<IStoreCountry, IStoreCountryModel, DateTime, DateTime?, IStoreCountry> UpdateEntityFromModel
            => ModelMapperForStoreCountry.UpdateStoreCountryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreCountry>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreCountry> query,
            IStoreCountrySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreCountriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IStoreCountry entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreCountry entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreCountry entity");
        }
