// <autogenerated>
// <copyright file="SiteDomainSocialProviderWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SiteDomainSocialProvider entities.</summary>
    /// <seealso cref="WorkflowBase{ISiteDomainSocialProviderModel, ISiteDomainSocialProviderSearchModel, ISiteDomainSocialProvider, SiteDomainSocialProvider}"/>
    /// <seealso cref="ISiteDomainSocialProviderWorkflow"/>
    public partial class SiteDomainSocialProviderWorkflow
        : WorkflowBase<ISiteDomainSocialProviderModel, ISiteDomainSocialProviderSearchModel, ISiteDomainSocialProvider, SiteDomainSocialProvider>
            , ISiteDomainSocialProviderWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SiteDomainSocialProvider?, string?, ISiteDomainSocialProviderModel?> MapFromConcreteFull
            => ModelMapperForSiteDomainSocialProvider.MapSiteDomainSocialProviderModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SiteDomainSocialProvider>, string?, IEnumerable<ISiteDomainSocialProviderModel>> SelectLiteAndMapToModel
            => ModelMapperForSiteDomainSocialProvider.SelectLiteSiteDomainSocialProviderAndMapToSiteDomainSocialProviderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SiteDomainSocialProvider>, string?, IEnumerable<ISiteDomainSocialProviderModel>> SelectListAndMapToModel
            => ModelMapperForSiteDomainSocialProvider.SelectListSiteDomainSocialProviderAndMapToSiteDomainSocialProviderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SiteDomainSocialProvider>, string?, ISiteDomainSocialProviderModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSiteDomainSocialProvider.SelectFirstFullSiteDomainSocialProviderAndMapToSiteDomainSocialProviderModel;

        /// <inheritdoc/>
        protected override Func<ISiteDomainSocialProvider, ISiteDomainSocialProviderModel, DateTime, DateTime?, ISiteDomainSocialProvider> UpdateEntityFromModel
            => ModelMapperForSiteDomainSocialProvider.UpdateSiteDomainSocialProviderFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SiteDomainSocialProvider>> FilterQueryByModelExtensionAsync(
            IQueryable<SiteDomainSocialProvider> query,
            ISiteDomainSocialProviderSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSiteDomainSocialProvidersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SiteDomains.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateSiteDomainFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the SiteDomainSocialProvider entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the SiteDomainSocialProvider entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SocialProviders.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateSocialProviderFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SiteDomainSocialProvider entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (SocialProvider)resolved.Result!.CreateSocialProviderEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SiteDomainSocialProvider entity");
        }
