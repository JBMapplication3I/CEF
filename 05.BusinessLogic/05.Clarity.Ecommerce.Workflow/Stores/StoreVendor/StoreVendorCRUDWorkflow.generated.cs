// <autogenerated>
// <copyright file="StoreVendorWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreVendor entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreVendorModel, IStoreVendorSearchModel, IStoreVendor, StoreVendor}"/>
    /// <seealso cref="IStoreVendorWorkflow"/>
    public partial class StoreVendorWorkflow
        : WorkflowBase<IStoreVendorModel, IStoreVendorSearchModel, IStoreVendor, StoreVendor>
            , IStoreVendorWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreVendor?, string?, IStoreVendorModel?> MapFromConcreteFull
            => ModelMapperForStoreVendor.MapStoreVendorModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreVendor>, string?, IEnumerable<IStoreVendorModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreVendor.SelectLiteStoreVendorAndMapToStoreVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreVendor>, string?, IEnumerable<IStoreVendorModel>> SelectListAndMapToModel
            => ModelMapperForStoreVendor.SelectListStoreVendorAndMapToStoreVendorModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreVendor>, string?, IStoreVendorModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreVendor.SelectFirstFullStoreVendorAndMapToStoreVendorModel;

        /// <inheritdoc/>
        protected override Func<IStoreVendor, IStoreVendorModel, DateTime, DateTime?, IStoreVendor> UpdateEntityFromModel
            => ModelMapperForStoreVendor.UpdateStoreVendorFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreVendor>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreVendor> query,
            IStoreVendorSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreVendorsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the StoreVendor entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the StoreVendor entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreVendor entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreVendor entity");
        }
