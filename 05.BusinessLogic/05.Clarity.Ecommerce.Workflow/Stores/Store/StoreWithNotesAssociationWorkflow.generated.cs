// <autogenerated>
// <copyright file="StoreWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Store Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IStoreModel, IStore, INoteModel, INote, Note}"/>
    /// <seealso cref="IStoreWithNotesAssociationWorkflow"/>
    public partial class StoreWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<IStoreModel, IStore, INoteModel, INote, Note>
        , IStoreWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IStore entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(IStoreModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IStore entity, INote newEntity)
        {
