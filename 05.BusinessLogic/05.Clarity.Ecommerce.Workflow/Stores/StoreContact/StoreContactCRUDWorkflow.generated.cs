// <autogenerated>
// <copyright file="StoreContactWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreContact entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IStoreContactModel, IStoreContactSearchModel, IStoreContact, StoreContact}"/>
    /// <seealso cref="IStoreContactWorkflow"/>
    public partial class StoreContactWorkflow
        : NameableWorkflowBase<IStoreContactModel, IStoreContactSearchModel, IStoreContact, StoreContact>
            , IStoreContactWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreContact?, string?, IStoreContactModel?> MapFromConcreteFull
            => ModelMapperForStoreContact.MapStoreContactModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreContact>, string?, IEnumerable<IStoreContactModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreContact.SelectLiteStoreContactAndMapToStoreContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreContact>, string?, IEnumerable<IStoreContactModel>> SelectListAndMapToModel
            => ModelMapperForStoreContact.SelectListStoreContactAndMapToStoreContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreContact>, string?, IStoreContactModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreContact.SelectFirstFullStoreContactAndMapToStoreContactModel;

        /// <inheritdoc/>
        protected override Func<IStoreContact, IStoreContactModel, DateTime, DateTime?, IStoreContact> UpdateEntityFromModel
            => ModelMapperForStoreContact.UpdateStoreContactFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreContact>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreContactsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the StoreContact entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the StoreContact entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreContact entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreContact entity");
        }
