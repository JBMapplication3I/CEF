// <autogenerated>
// <copyright file="StoreRegionWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreRegion entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreRegionModel, IStoreRegionSearchModel, IStoreRegion, StoreRegion}"/>
    /// <seealso cref="IStoreRegionWorkflow"/>
    public partial class StoreRegionWorkflow
        : WorkflowBase<IStoreRegionModel, IStoreRegionSearchModel, IStoreRegion, StoreRegion>
            , IStoreRegionWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreRegion?, string?, IStoreRegionModel?> MapFromConcreteFull
            => ModelMapperForStoreRegion.MapStoreRegionModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreRegion>, string?, IEnumerable<IStoreRegionModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreRegion.SelectLiteStoreRegionAndMapToStoreRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreRegion>, string?, IEnumerable<IStoreRegionModel>> SelectListAndMapToModel
            => ModelMapperForStoreRegion.SelectListStoreRegionAndMapToStoreRegionModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreRegion>, string?, IStoreRegionModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreRegion.SelectFirstFullStoreRegionAndMapToStoreRegionModel;

        /// <inheritdoc/>
        protected override Func<IStoreRegion, IStoreRegionModel, DateTime, DateTime?, IStoreRegion> UpdateEntityFromModel
            => ModelMapperForStoreRegion.UpdateStoreRegionFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreRegion>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreRegion> query,
            IStoreRegionSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreRegionsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreRegion entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreRegion entity");
        }
