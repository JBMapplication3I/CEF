// <autogenerated>
// <copyright file="StoreInventoryLocationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreInventoryLocation entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreInventoryLocationModel, IStoreInventoryLocationSearchModel, IStoreInventoryLocation, StoreInventoryLocation}"/>
    /// <seealso cref="IStoreInventoryLocationWorkflow"/>
    public partial class StoreInventoryLocationWorkflow
        : WorkflowBase<IStoreInventoryLocationModel, IStoreInventoryLocationSearchModel, IStoreInventoryLocation, StoreInventoryLocation>
            , IStoreInventoryLocationWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreInventoryLocation?, string?, IStoreInventoryLocationModel?> MapFromConcreteFull
            => ModelMapperForStoreInventoryLocation.MapStoreInventoryLocationModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreInventoryLocation>, string?, IEnumerable<IStoreInventoryLocationModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreInventoryLocation.SelectLiteStoreInventoryLocationAndMapToStoreInventoryLocationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreInventoryLocation>, string?, IEnumerable<IStoreInventoryLocationModel>> SelectListAndMapToModel
            => ModelMapperForStoreInventoryLocation.SelectListStoreInventoryLocationAndMapToStoreInventoryLocationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreInventoryLocation>, string?, IStoreInventoryLocationModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreInventoryLocation.SelectFirstFullStoreInventoryLocationAndMapToStoreInventoryLocationModel;

        /// <inheritdoc/>
        protected override Func<IStoreInventoryLocation, IStoreInventoryLocationModel, DateTime, DateTime?, IStoreInventoryLocation> UpdateEntityFromModel
            => ModelMapperForStoreInventoryLocation.UpdateStoreInventoryLocationFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreInventoryLocation>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreInventoryLocation> query,
            IStoreInventoryLocationSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreInventoryLocationsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the StoreInventoryLocation entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the StoreInventoryLocation entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreInventoryLocation entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreInventoryLocation entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.StoreInventoryLocationTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Type!.UpdateStoreInventoryLocationTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the StoreInventoryLocation entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.TypeID = 0;
                entity.Type = (StoreInventoryLocationType)resolved.Result!.CreateStoreInventoryLocationTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the StoreInventoryLocation entity");
        }
