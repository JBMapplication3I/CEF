// <autogenerated>
// <copyright file="StoreProductWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreProduct entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreProductModel, IStoreProductSearchModel, IStoreProduct, StoreProduct}"/>
    /// <seealso cref="IStoreProductWorkflow"/>
    public partial class StoreProductWorkflow
        : WorkflowBase<IStoreProductModel, IStoreProductSearchModel, IStoreProduct, StoreProduct>
            , IStoreProductWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreProduct?, string?, IStoreProductModel?> MapFromConcreteFull
            => ModelMapperForStoreProduct.MapStoreProductModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreProduct>, string?, IEnumerable<IStoreProductModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreProduct.SelectLiteStoreProductAndMapToStoreProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreProduct>, string?, IEnumerable<IStoreProductModel>> SelectListAndMapToModel
            => ModelMapperForStoreProduct.SelectListStoreProductAndMapToStoreProductModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreProduct>, string?, IStoreProductModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreProduct.SelectFirstFullStoreProductAndMapToStoreProductModel;

        /// <inheritdoc/>
        protected override Func<IStoreProduct, IStoreProductModel, DateTime, DateTime?, IStoreProduct> UpdateEntityFromModel
            => ModelMapperForStoreProduct.UpdateStoreProductFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreProduct>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreProductsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the StoreProduct entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the StoreProduct entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreProduct entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreProduct entity");
        }
