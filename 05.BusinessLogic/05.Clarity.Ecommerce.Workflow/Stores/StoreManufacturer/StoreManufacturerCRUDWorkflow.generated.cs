// <autogenerated>
// <copyright file="StoreManufacturerWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreManufacturer entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreManufacturerModel, IStoreManufacturerSearchModel, IStoreManufacturer, StoreManufacturer}"/>
    /// <seealso cref="IStoreManufacturerWorkflow"/>
    public partial class StoreManufacturerWorkflow
        : WorkflowBase<IStoreManufacturerModel, IStoreManufacturerSearchModel, IStoreManufacturer, StoreManufacturer>
            , IStoreManufacturerWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreManufacturer?, string?, IStoreManufacturerModel?> MapFromConcreteFull
            => ModelMapperForStoreManufacturer.MapStoreManufacturerModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreManufacturer>, string?, IEnumerable<IStoreManufacturerModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreManufacturer.SelectLiteStoreManufacturerAndMapToStoreManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreManufacturer>, string?, IEnumerable<IStoreManufacturerModel>> SelectListAndMapToModel
            => ModelMapperForStoreManufacturer.SelectListStoreManufacturerAndMapToStoreManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreManufacturer>, string?, IStoreManufacturerModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreManufacturer.SelectFirstFullStoreManufacturerAndMapToStoreManufacturerModel;

        /// <inheritdoc/>
        protected override Func<IStoreManufacturer, IStoreManufacturerModel, DateTime, DateTime?, IStoreManufacturer> UpdateEntityFromModel
            => ModelMapperForStoreManufacturer.UpdateStoreManufacturerFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreManufacturer>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreManufacturer> query,
            IStoreManufacturerSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreManufacturersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IStoreManufacturer entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the StoreManufacturer entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the StoreManufacturer entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreManufacturer entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreManufacturer entity");
        }
