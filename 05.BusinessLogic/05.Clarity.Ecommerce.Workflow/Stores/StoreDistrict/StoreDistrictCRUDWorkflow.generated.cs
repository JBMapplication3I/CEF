// <autogenerated>
// <copyright file="StoreDistrictWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreDistrict entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreDistrictModel, IStoreDistrictSearchModel, IStoreDistrict, StoreDistrict}"/>
    /// <seealso cref="IStoreDistrictWorkflow"/>
    public partial class StoreDistrictWorkflow
        : WorkflowBase<IStoreDistrictModel, IStoreDistrictSearchModel, IStoreDistrict, StoreDistrict>
            , IStoreDistrictWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreDistrict?, string?, IStoreDistrictModel?> MapFromConcreteFull
            => ModelMapperForStoreDistrict.MapStoreDistrictModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreDistrict>, string?, IEnumerable<IStoreDistrictModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreDistrict.SelectLiteStoreDistrictAndMapToStoreDistrictModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreDistrict>, string?, IEnumerable<IStoreDistrictModel>> SelectListAndMapToModel
            => ModelMapperForStoreDistrict.SelectListStoreDistrictAndMapToStoreDistrictModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreDistrict>, string?, IStoreDistrictModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreDistrict.SelectFirstFullStoreDistrictAndMapToStoreDistrictModel;

        /// <inheritdoc/>
        protected override Func<IStoreDistrict, IStoreDistrictModel, DateTime, DateTime?, IStoreDistrict> UpdateEntityFromModel
            => ModelMapperForStoreDistrict.UpdateStoreDistrictFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreDistrict>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreDistrict> query,
            IStoreDistrictSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreDistrictsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IStoreDistrict entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreDistrict entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreDistrict entity");
        }
