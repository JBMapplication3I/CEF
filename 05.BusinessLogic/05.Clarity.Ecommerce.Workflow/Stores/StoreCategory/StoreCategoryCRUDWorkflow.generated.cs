// <autogenerated>
// <copyright file="StoreCategoryWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreCategory entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreCategoryModel, IStoreCategorySearchModel, IStoreCategory, StoreCategory}"/>
    /// <seealso cref="IStoreCategoryWorkflow"/>
    public partial class StoreCategoryWorkflow
        : WorkflowBase<IStoreCategoryModel, IStoreCategorySearchModel, IStoreCategory, StoreCategory>
            , IStoreCategoryWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreCategory?, string?, IStoreCategoryModel?> MapFromConcreteFull
            => ModelMapperForStoreCategory.MapStoreCategoryModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreCategory>, string?, IEnumerable<IStoreCategoryModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreCategory.SelectLiteStoreCategoryAndMapToStoreCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreCategory>, string?, IEnumerable<IStoreCategoryModel>> SelectListAndMapToModel
            => ModelMapperForStoreCategory.SelectListStoreCategoryAndMapToStoreCategoryModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreCategory>, string?, IStoreCategoryModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreCategory.SelectFirstFullStoreCategoryAndMapToStoreCategoryModel;

        /// <inheritdoc/>
        protected override Func<IStoreCategory, IStoreCategoryModel, DateTime, DateTime?, IStoreCategory> UpdateEntityFromModel
            => ModelMapperForStoreCategory.UpdateStoreCategoryFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreCategory>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreCategory> query,
            IStoreCategorySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreCategoriesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IStoreCategory entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreCategory entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreCategory entity");
        }
