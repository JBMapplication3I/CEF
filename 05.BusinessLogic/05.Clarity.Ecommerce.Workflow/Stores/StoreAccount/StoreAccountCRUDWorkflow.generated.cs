// <autogenerated>
// <copyright file="StoreAccountWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreAccount entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreAccountModel, IStoreAccountSearchModel, IStoreAccount, StoreAccount}"/>
    /// <seealso cref="IStoreAccountWorkflow"/>
    public partial class StoreAccountWorkflow
        : WorkflowBase<IStoreAccountModel, IStoreAccountSearchModel, IStoreAccount, StoreAccount>
            , IStoreAccountWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreAccount?, string?, IStoreAccountModel?> MapFromConcreteFull
            => ModelMapperForStoreAccount.MapStoreAccountModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreAccount>, string?, IEnumerable<IStoreAccountModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreAccount.SelectLiteStoreAccountAndMapToStoreAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreAccount>, string?, IEnumerable<IStoreAccountModel>> SelectListAndMapToModel
            => ModelMapperForStoreAccount.SelectListStoreAccountAndMapToStoreAccountModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreAccount>, string?, IStoreAccountModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreAccount.SelectFirstFullStoreAccountAndMapToStoreAccountModel;

        /// <inheritdoc/>
        protected override Func<IStoreAccount, IStoreAccountModel, DateTime, DateTime?, IStoreAccount> UpdateEntityFromModel
            => ModelMapperForStoreAccount.UpdateStoreAccountFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreAccount>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreAccount> query,
            IStoreAccountSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreAccountsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateStoreFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the StoreAccount entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the StoreAccount entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreAccount entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreAccount entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given PricePoint to the StoreAccount entity");
        }
