// <autogenerated>
// <copyright file="StoreUserWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for StoreUser entities.</summary>
    /// <seealso cref="WorkflowBase{IStoreUserModel, IStoreUserSearchModel, IStoreUser, StoreUser}"/>
    /// <seealso cref="IStoreUserWorkflow"/>
    public partial class StoreUserWorkflow
        : WorkflowBase<IStoreUserModel, IStoreUserSearchModel, IStoreUser, StoreUser>
            , IStoreUserWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<StoreUser?, string?, IStoreUserModel?> MapFromConcreteFull
            => ModelMapperForStoreUser.MapStoreUserModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreUser>, string?, IEnumerable<IStoreUserModel>> SelectLiteAndMapToModel
            => ModelMapperForStoreUser.SelectLiteStoreUserAndMapToStoreUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreUser>, string?, IEnumerable<IStoreUserModel>> SelectListAndMapToModel
            => ModelMapperForStoreUser.SelectListStoreUserAndMapToStoreUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<StoreUser>, string?, IStoreUserModel?> SelectFirstFullAndMapToModel
            => ModelMapperForStoreUser.SelectFirstFullStoreUserAndMapToStoreUserModel;

        /// <inheritdoc/>
        protected override Func<IStoreUser, IStoreUserModel, DateTime, DateTime?, IStoreUser> UpdateEntityFromModel
            => ModelMapperForStoreUser.UpdateStoreUserFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<StoreUser>> FilterQueryByModelExtensionAsync(
            IQueryable<StoreUser> query,
            IStoreUserSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterStoreUsersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the StoreUser entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the StoreUser entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the StoreUser entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the StoreUser entity");
        }
