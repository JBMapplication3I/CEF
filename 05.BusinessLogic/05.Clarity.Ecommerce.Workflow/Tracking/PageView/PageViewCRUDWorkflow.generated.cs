// <autogenerated>
// <copyright file="PageViewWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for PageView entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IPageViewModel, IPageViewSearchModel, IPageView, PageView}"/>
    /// <seealso cref="IPageViewWorkflow"/>
    public partial class PageViewWorkflow
        : NameableWorkflowBase<IPageViewModel, IPageViewSearchModel, IPageView, PageView>
            , IPageViewWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<PageView?, string?, IPageViewModel?> MapFromConcreteFull
            => ModelMapperForPageView.MapPageViewModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<PageView>, string?, IEnumerable<IPageViewModel>> SelectLiteAndMapToModel
            => ModelMapperForPageView.SelectLitePageViewAndMapToPageViewModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PageView>, string?, IEnumerable<IPageViewModel>> SelectListAndMapToModel
            => ModelMapperForPageView.SelectListPageViewAndMapToPageViewModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<PageView>, string?, IPageViewModel?> SelectFirstFullAndMapToModel
            => ModelMapperForPageView.SelectFirstFullPageViewAndMapToPageViewModel;

        /// <inheritdoc/>
        protected override Func<IPageView, IPageViewModel, DateTime, DateTime?, IPageView> UpdateEntityFromModel
            => ModelMapperForPageView.UpdatePageViewFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<PageView>> FilterQueryByModelExtensionAsync(
            IQueryable<PageView> query,
            IPageViewSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterPageViewsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.PageViewTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Type!.UpdatePageViewTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the PageView entity");
            }
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (PageViewType)resolved.Result!.CreatePageViewTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.PageViewStatuses.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Status!.UpdatePageViewStatusFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive StatusID to the PageView entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.StatusID = 0;
                entity.Status = (PageViewStatus)resolved.Result!.CreatePageViewStatusEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Status to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Address to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given IPOrganization to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Campaign to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Contact to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SiteDomain to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Visitor to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Category to the PageView entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Product to the PageView entity");
        }
