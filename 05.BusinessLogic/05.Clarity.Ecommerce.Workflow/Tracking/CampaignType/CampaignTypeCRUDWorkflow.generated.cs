// <autogenerated>
// <copyright file="CampaignTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for CampaignType entities.</summary>
    /// <seealso cref="TypableWorkflowBase{ITypeModel, ITypeSearchModel, ICampaignType, CampaignType}"/>
    /// <seealso cref="ICampaignTypeWorkflow"/>
    public partial class CampaignTypeWorkflow
        : TypableWorkflowBase<ITypeModel, ITypeSearchModel, ICampaignType, CampaignType>
            , ICampaignTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<CampaignType?, string?, ITypeModel?> MapFromConcreteFull
            => ModelMapperForCampaignType.MapCampaignTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<CampaignType>, string?, IEnumerable<ITypeModel>> SelectLiteAndMapToModel
            => ModelMapperForCampaignType.SelectLiteCampaignTypeAndMapToTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CampaignType>, string?, IEnumerable<ITypeModel>> SelectListAndMapToModel
            => ModelMapperForCampaignType.SelectListCampaignTypeAndMapToTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<CampaignType>, string?, ITypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForCampaignType.SelectFirstFullCampaignTypeAndMapToTypeModel;

        /// <inheritdoc/>
        protected override Func<ICampaignType, ITypeModel, DateTime, DateTime?, ICampaignType> UpdateEntityFromModel
            => ModelMapperForCampaignType.UpdateCampaignTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<CampaignType>> FilterQueryByModelExtensionAsync(
            IQueryable<CampaignType> query,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the CampaignType entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the CampaignType entity");
        }
