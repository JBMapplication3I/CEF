// <copyright file="EventCRUDWorkflow.extended.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the event workflow class</summary>
namespace Clarity.Ecommerce.Workflow
{
    ...
    public partial class EventWorkflow
    {
        ...
        {
            entity.UpdateEventFromModel(model, timestamp, Contract.CheckValidID(entity.ID) ? timestamp : null);
