// <autogenerated>
// <copyright file="SalesReturnWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Return Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesReturnModel, ISalesReturn, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesReturnWithNotesAssociationWorkflow"/>
    public partial class SalesReturnWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesReturnModel, ISalesReturn, INoteModel, INote, Note>
        , ISalesReturnWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesReturn entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesReturnModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesReturn entity, INote newEntity)
        {
