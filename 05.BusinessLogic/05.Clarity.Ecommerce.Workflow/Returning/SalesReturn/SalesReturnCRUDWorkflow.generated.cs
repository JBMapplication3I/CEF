// <autogenerated>
// <copyright file="SalesReturnWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesReturn entities.</summary>
    /// <seealso cref="SalesCollectionWorkflowBase{ISalesReturnModel, ISalesReturnSearchModel, ISalesReturn, SalesReturn, SalesReturnStatus, SalesReturnType, ITypeModel, ISalesReturnItem, SalesReturnItem, AppliedSalesReturnDiscount, SalesReturnState, SalesReturnFile, ISalesReturnFileModel, SalesReturnContact, ISalesReturnContactModel, SalesReturnEvent, ISalesReturnEventModel, SalesReturnEventType, AppliedSalesReturnItemDiscount, SalesReturnItemTarget, IAppliedSalesReturnDiscountModel, IAppliedSalesReturnItemDiscountModel}"/>
    /// <seealso cref="ISalesReturnWorkflow"/>
    public partial class SalesReturnWorkflow
        : SalesCollectionWorkflowBase<ISalesReturnModel,
            ...
            , ISalesReturnWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesReturn?, string?, ISalesReturnModel?> MapFromConcreteFull
            => ModelMapperForSalesReturn.MapSalesReturnModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturn>, string?, IEnumerable<ISalesReturnModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesReturn.SelectLiteSalesReturnAndMapToSalesReturnModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturn>, string?, IEnumerable<ISalesReturnModel>> SelectListAndMapToModel
            => ModelMapperForSalesReturn.SelectListSalesReturnAndMapToSalesReturnModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturn>, string?, ISalesReturnModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesReturn.SelectFirstFullSalesReturnAndMapToSalesReturnModel;

        /// <inheritdoc/>
        protected override Func<ISalesReturn, ISalesReturnModel, DateTime, DateTime?, ISalesReturn> UpdateEntityFromModel
            => ModelMapperForSalesReturn.UpdateSalesReturnFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesReturn>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesReturnsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Notes != null)
            {
                ...
                await Workflows.SalesReturnWithNotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false);
            }
            if (model.SalesReturnPayments != null) { await Workflows.SalesReturnWithSalesReturnPaymentsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.AssociatedSalesOrders != null) { await Workflows.SalesReturnWithAssociatedSalesOrdersAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.SalesItems != null) { await Workflows.SalesReturnWithSalesItemsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: Discounts
            if (model.StoredFiles != null) { await Workflows.SalesReturnWithStoredFilesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Contacts != null) { await Workflows.SalesReturnWithContactsAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            // Skipped: Not supposed to map this property in via this manner: SalesEvents
            if (model.RateQuotes != null) { await Workflows.SalesReturnWithRateQuotesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given SalesGroup to the SalesReturn entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Account to the SalesReturn entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the SalesReturn entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Franchise to the SalesReturn entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the SalesReturn entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given User to the SalesReturn entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesReturnStatuses.ResolveWithAutoGenerateOptionalAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SalesReturnStates.ResolveWithAutoGenerateOptionalAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // Look up the Object Model
            // Allowed to auto-generate if not found
            var resolved = await Workflows.SalesReturnTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given BillingContact to the SalesReturn entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given ShippingContact to the SalesReturn entity");
        }
