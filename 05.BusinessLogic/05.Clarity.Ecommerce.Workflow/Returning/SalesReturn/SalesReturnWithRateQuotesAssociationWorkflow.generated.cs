// <autogenerated>
// <copyright file="SalesReturnWithRateQuotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Return Rate Quotes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesReturnModel, ISalesReturn, IRateQuoteModel, IRateQuote, RateQuote}"/>
    /// <seealso cref="ISalesReturnWithRateQuotesAssociationWorkflow"/>
    public partial class SalesReturnWithRateQuotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesReturnModel, ISalesReturn, IRateQuoteModel, IRateQuote, RateQuote>
        , ISalesReturnWithRateQuotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<RateQuote>? GetObjectsCollection(ISalesReturn entity) { return entity.RateQuotes; }

        /// <inheritdoc/>
        protected override List<IRateQuoteModel>? GetModelObjectsList(ISalesReturnModel model) { return model.RateQuotes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesReturn entity, IRateQuote newEntity)
        {
