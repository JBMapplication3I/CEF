// <autogenerated>
// <copyright file="SalesReturnContactWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesReturnContact entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesReturnContactModel, ISalesReturnContactSearchModel, ISalesReturnContact, SalesReturnContact}"/>
    /// <seealso cref="ISalesReturnContactWorkflow"/>
    public partial class SalesReturnContactWorkflow
        : WorkflowBase<ISalesReturnContactModel, ISalesReturnContactSearchModel, ISalesReturnContact, SalesReturnContact>
            , ISalesReturnContactWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesReturnContact?, string?, ISalesReturnContactModel?> MapFromConcreteFull
            => ModelMapperForSalesReturnContact.MapSalesReturnContactModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnContact>, string?, IEnumerable<ISalesReturnContactModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesReturnContact.SelectLiteSalesReturnContactAndMapToSalesReturnContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnContact>, string?, IEnumerable<ISalesReturnContactModel>> SelectListAndMapToModel
            => ModelMapperForSalesReturnContact.SelectListSalesReturnContactAndMapToSalesReturnContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnContact>, string?, ISalesReturnContactModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesReturnContact.SelectFirstFullSalesReturnContactAndMapToSalesReturnContactModel;

        /// <inheritdoc/>
        protected override Func<ISalesReturnContact, ISalesReturnContactModel, DateTime, DateTime?, ISalesReturnContact> UpdateEntityFromModel
            => ModelMapperForSalesReturnContact.UpdateSalesReturnContactFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesReturnContact>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesReturnContactsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesReturnContact entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesReturnContact entity");
        }
