// <autogenerated>
// <copyright file="SalesReturnFileWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesReturnFile entities.</summary>
    /// <seealso cref="NameableWorkflowBase{ISalesReturnFileModel, ISalesReturnFileSearchModel, ISalesReturnFile, SalesReturnFile}"/>
    /// <seealso cref="ISalesReturnFileWorkflow"/>
    public partial class SalesReturnFileWorkflow
        : NameableWorkflowBase<ISalesReturnFileModel, ISalesReturnFileSearchModel, ISalesReturnFile, SalesReturnFile>
            , ISalesReturnFileWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesReturnFile?, string?, ISalesReturnFileModel?> MapFromConcreteFull
            => ModelMapperForSalesReturnFile.MapSalesReturnFileModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnFile>, string?, IEnumerable<ISalesReturnFileModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesReturnFile.SelectLiteSalesReturnFileAndMapToSalesReturnFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnFile>, string?, IEnumerable<ISalesReturnFileModel>> SelectListAndMapToModel
            => ModelMapperForSalesReturnFile.SelectListSalesReturnFileAndMapToSalesReturnFileModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnFile>, string?, ISalesReturnFileModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesReturnFile.SelectFirstFullSalesReturnFileAndMapToSalesReturnFileModel;

        /// <inheritdoc/>
        protected override Func<ISalesReturnFile, ISalesReturnFileModel, DateTime, DateTime?, ISalesReturnFile> UpdateEntityFromModel
            => ModelMapperForSalesReturnFile.UpdateSalesReturnFileFromModel;
        #endregion
        ...
        {
            return await context.Set<SalesReturnFile>()
                .AsNoTracking()
        ...
        /// <inheritdoc/>
        public virtual async Task<ISalesReturnFileModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<ISalesReturnFileModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<SalesReturnFile>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<SalesReturnFile>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<SalesReturnFile> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<SalesReturnFile>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesReturnFile>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesReturnFile> query,
            ISalesReturnFileSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesReturnFilesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesReturnFile entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesReturnFile entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesReturnFile entity");
        }
