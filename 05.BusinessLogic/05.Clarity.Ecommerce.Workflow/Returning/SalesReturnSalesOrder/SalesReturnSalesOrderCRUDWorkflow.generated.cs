// <autogenerated>
// <copyright file="SalesReturnSalesOrderWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for SalesReturnSalesOrder entities.</summary>
    /// <seealso cref="WorkflowBase{ISalesReturnSalesOrderModel, ISalesReturnSalesOrderSearchModel, ISalesReturnSalesOrder, SalesReturnSalesOrder}"/>
    /// <seealso cref="ISalesReturnSalesOrderWorkflow"/>
    public partial class SalesReturnSalesOrderWorkflow
        : WorkflowBase<ISalesReturnSalesOrderModel, ISalesReturnSalesOrderSearchModel, ISalesReturnSalesOrder, SalesReturnSalesOrder>
            , ISalesReturnSalesOrderWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<SalesReturnSalesOrder?, string?, ISalesReturnSalesOrderModel?> MapFromConcreteFull
            => ModelMapperForSalesReturnSalesOrder.MapSalesReturnSalesOrderModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnSalesOrder>, string?, IEnumerable<ISalesReturnSalesOrderModel>> SelectLiteAndMapToModel
            => ModelMapperForSalesReturnSalesOrder.SelectLiteSalesReturnSalesOrderAndMapToSalesReturnSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnSalesOrder>, string?, IEnumerable<ISalesReturnSalesOrderModel>> SelectListAndMapToModel
            => ModelMapperForSalesReturnSalesOrder.SelectListSalesReturnSalesOrderAndMapToSalesReturnSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<SalesReturnSalesOrder>, string?, ISalesReturnSalesOrderModel?> SelectFirstFullAndMapToModel
            => ModelMapperForSalesReturnSalesOrder.SelectFirstFullSalesReturnSalesOrderAndMapToSalesReturnSalesOrderModel;

        /// <inheritdoc/>
        protected override Func<ISalesReturnSalesOrder, ISalesReturnSalesOrderModel, DateTime, DateTime?, ISalesReturnSalesOrder> UpdateEntityFromModel
            => ModelMapperForSalesReturnSalesOrder.UpdateSalesReturnSalesOrderFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<SalesReturnSalesOrder>> FilterQueryByModelExtensionAsync(
            IQueryable<SalesReturnSalesOrder> query,
            ISalesReturnSalesOrderSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterSalesReturnSalesOrdersBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            ISalesReturnSalesOrder entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.SalesReturns.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateSalesReturnFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the SalesReturnSalesOrder entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the SalesReturnSalesOrder entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Slave!.UpdateSalesOrderFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the SalesReturnSalesOrder entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                // [Required] Scenario 7: We have an entity id, but a new model, remove the id on the entity and assign the new model
                entity.SlaveID = 0;
                entity.Slave = (SalesOrder)resolved.Result!.CreateSalesOrderEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the SalesReturnSalesOrder entity");
        }
