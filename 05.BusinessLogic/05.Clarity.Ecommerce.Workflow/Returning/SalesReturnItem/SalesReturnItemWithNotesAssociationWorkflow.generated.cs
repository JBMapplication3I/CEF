// <autogenerated>
// <copyright file="SalesReturnItemWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Return Item Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesReturnItem, INoteModel, INote, Note}"/>
    /// <seealso cref="ISalesReturnItemWithNotesAssociationWorkflow"/>
    public partial class SalesReturnItemWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<ISalesItemBaseModel<IAppliedSalesReturnItemDiscountModel>, ISalesReturnItem, INoteModel, INote, Note>
        , ISalesReturnItemWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(ISalesReturnItem entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesReturnItemDiscountModel> model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesReturnItem entity, INote newEntity)
        {
