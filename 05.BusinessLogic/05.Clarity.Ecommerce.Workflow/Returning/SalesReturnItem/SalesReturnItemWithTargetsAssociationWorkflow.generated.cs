// <autogenerated>
// <copyright file="SalesReturnItemWithTargetsAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Sales Return Item Targets association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{ISalesItemBaseModel, ISalesReturnItem, ISalesItemTargetBaseModel, ISalesReturnItemTarget, SalesReturnItemTarget}"/>
    /// <seealso cref="ISalesReturnItemWithTargetsAssociationWorkflow"/>
    public partial class SalesReturnItemWithTargetsAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateObjectsWorkflowBase<ISalesItemBaseModel<IAppliedSalesReturnItemDiscountModel>, ISalesReturnItem, ISalesItemTargetBaseModel, ISalesReturnItemTarget, SalesReturnItemTarget>
        , ISalesReturnItemWithTargetsAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<SalesReturnItemTarget>? GetObjectsCollection(ISalesReturnItem entity) { return entity.Targets; }

        /// <inheritdoc/>
        protected override List<ISalesItemTargetBaseModel>? GetModelObjectsList(ISalesItemBaseModel<IAppliedSalesReturnItemDiscountModel> model) { return model.Targets; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(ISalesReturnItem entity, ISalesReturnItemTarget newEntity)
        {
            if (newEntity == null) { return; }
            entity.Targets!.Add((SalesReturnItemTarget)newEntity);
        }
        ...
        protected override void InitializeObjectListIfNull(ISalesReturnItem entity)
        {
            ...
            entity.Targets = new HashSet<SalesReturnItemTarget>();
        }

        /// <inheritdoc/>
        protected override async Task DeactivateObjectAsync(ISalesReturnItemTarget entity, DateTime timestamp)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<bool> MatchObjectModelWithObjectEntityAsync(ISalesItemTargetBaseModel model, ISalesReturnItemTarget entity, IClarityEcommerceEntities context)
        {
        ...
        /// <inheritdoc/>
        protected override async Task<ISalesReturnItemTarget> ModelToNewObjectAsync(
            ...
            var thisEntityTypeID = Contract.CheckValidID(model.TypeID)
                ...
                : model.Type != null && Contract.CheckValidID(model.Type.ID)
                    ...
                    : UpsertThisEntityTypeAndGetID(
                        ...
                        timestamp,
                        context);
            if (thisEntityTypeID <= 0) { throw new ArgumentException("SalesReturnItemTarget requires a valid Type."); }
            // Create a new entity and populate it with data
            var newEntity = model.CreateSalesReturnItemTargetEntity(timestamp, context.ContextProfileName);
