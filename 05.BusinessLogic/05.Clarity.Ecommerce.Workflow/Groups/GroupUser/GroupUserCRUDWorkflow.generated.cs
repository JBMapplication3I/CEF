// <autogenerated>
// <copyright file="GroupUserWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for GroupUser entities.</summary>
    /// <seealso cref="WorkflowBase{IGroupUserModel, IGroupUserSearchModel, IGroupUser, GroupUser}"/>
    /// <seealso cref="IGroupUserWorkflow"/>
    public partial class GroupUserWorkflow
        : WorkflowBase<IGroupUserModel, IGroupUserSearchModel, IGroupUser, GroupUser>
            , IGroupUserWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<GroupUser?, string?, IGroupUserModel?> MapFromConcreteFull
            => ModelMapperForGroupUser.MapGroupUserModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<GroupUser>, string?, IEnumerable<IGroupUserModel>> SelectLiteAndMapToModel
            => ModelMapperForGroupUser.SelectLiteGroupUserAndMapToGroupUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<GroupUser>, string?, IEnumerable<IGroupUserModel>> SelectListAndMapToModel
            => ModelMapperForGroupUser.SelectListGroupUserAndMapToGroupUserModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<GroupUser>, string?, IGroupUserModel?> SelectFirstFullAndMapToModel
            => ModelMapperForGroupUser.SelectFirstFullGroupUserAndMapToGroupUserModel;

        /// <inheritdoc/>
        protected override Func<IGroupUser, IGroupUserModel, DateTime, DateTime?, IGroupUser> UpdateEntityFromModel
            => ModelMapperForGroupUser.UpdateGroupUserFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<GroupUser>> FilterQueryByModelExtensionAsync(
            IQueryable<GroupUser> query,
            IGroupUserSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterGroupUsersBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateGroupFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the GroupUser entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the GroupUser entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the GroupUser entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the GroupUser entity");
        }
