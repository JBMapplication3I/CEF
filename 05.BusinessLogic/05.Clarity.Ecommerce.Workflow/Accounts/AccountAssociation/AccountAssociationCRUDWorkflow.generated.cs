// <autogenerated>
// <copyright file="AccountAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AccountAssociation entities.</summary>
    /// <seealso cref="WorkflowBase{IAccountAssociationModel, IAccountAssociationSearchModel, IAccountAssociation, AccountAssociation}"/>
    /// <seealso cref="IAccountAssociationWorkflow"/>
    public partial class AccountAssociationWorkflow
        : WorkflowBase<IAccountAssociationModel, IAccountAssociationSearchModel, IAccountAssociation, AccountAssociation>
            , IAccountAssociationWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AccountAssociation?, string?, IAccountAssociationModel?> MapFromConcreteFull
            => ModelMapperForAccountAssociation.MapAccountAssociationModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountAssociation>, string?, IEnumerable<IAccountAssociationModel>> SelectLiteAndMapToModel
            => ModelMapperForAccountAssociation.SelectLiteAccountAssociationAndMapToAccountAssociationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountAssociation>, string?, IEnumerable<IAccountAssociationModel>> SelectListAndMapToModel
            => ModelMapperForAccountAssociation.SelectListAccountAssociationAndMapToAccountAssociationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountAssociation>, string?, IAccountAssociationModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAccountAssociation.SelectFirstFullAccountAssociationAndMapToAccountAssociationModel;

        /// <inheritdoc/>
        protected override Func<IAccountAssociation, IAccountAssociationModel, DateTime, DateTime?, IAccountAssociation> UpdateEntityFromModel
            => ModelMapperForAccountAssociation.UpdateAccountAssociationFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AccountAssociation>> FilterQueryByModelExtensionAsync(
            IQueryable<AccountAssociation> query,
            IAccountAssociationSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAccountAssociationsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AccountAssociation entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AccountAssociation entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.AccountAssociationTypes.ResolveWithAutoGenerateOptionalAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                if (!entityObjectIsNull && !modelObjectIsNull)
                {
                    entity.Type!.UpdateAccountAssociationTypeFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive TypeID to the AccountAssociation entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            if (modelObjectIsActive)
            {
                ...
                entity.TypeID = 0;
                entity.Type = (AccountAssociationType)resolved.Result!.CreateAccountAssociationTypeEntity(timestamp, context.ContextProfileName);
                return;
            }
            // [Required] Scenarios 8,9 are only for Optional relationships, skipped
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Type to the AccountAssociation entity");
        }
