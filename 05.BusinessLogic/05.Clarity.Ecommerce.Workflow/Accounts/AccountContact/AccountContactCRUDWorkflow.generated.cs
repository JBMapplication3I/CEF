// <autogenerated>
// <copyright file="AccountContactWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AccountContact entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IAccountContactModel, IAccountContactSearchModel, IAccountContact, AccountContact}"/>
    /// <seealso cref="IAccountContactWorkflow"/>
    public partial class AccountContactWorkflow
        : NameableWorkflowBase<IAccountContactModel, IAccountContactSearchModel, IAccountContact, AccountContact>
            , IAccountContactWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AccountContact?, string?, IAccountContactModel?> MapFromConcreteFull
            => ModelMapperForAccountContact.MapAccountContactModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountContact>, string?, IEnumerable<IAccountContactModel>> SelectLiteAndMapToModel
            => ModelMapperForAccountContact.SelectLiteAccountContactAndMapToAccountContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountContact>, string?, IEnumerable<IAccountContactModel>> SelectListAndMapToModel
            => ModelMapperForAccountContact.SelectListAccountContactAndMapToAccountContactModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountContact>, string?, IAccountContactModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAccountContact.SelectFirstFullAccountContactAndMapToAccountContactModel;

        /// <inheritdoc/>
        protected override Func<IAccountContact, IAccountContactModel, DateTime, DateTime?, IAccountContact> UpdateEntityFromModel
            => ModelMapperForAccountContact.UpdateAccountContactFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AccountContact>> FilterQueryByModelExtensionAsync(
            IQueryable<AccountContact> query,
            IAccountContactSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAccountContactsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AccountContact entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AccountContact entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AccountContact entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AccountContact entity");
        }
