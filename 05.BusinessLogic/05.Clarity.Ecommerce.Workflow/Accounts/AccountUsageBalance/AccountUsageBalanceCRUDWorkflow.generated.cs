// <autogenerated>
// <copyright file="AccountUsageBalanceWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AccountUsageBalance entities.</summary>
    /// <seealso cref="WorkflowBase{IAccountUsageBalanceModel, IAccountUsageBalanceSearchModel, IAccountUsageBalance, AccountUsageBalance}"/>
    /// <seealso cref="IAccountUsageBalanceWorkflow"/>
    public partial class AccountUsageBalanceWorkflow
        : WorkflowBase<IAccountUsageBalanceModel, IAccountUsageBalanceSearchModel, IAccountUsageBalance, AccountUsageBalance>
            , IAccountUsageBalanceWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AccountUsageBalance?, string?, IAccountUsageBalanceModel?> MapFromConcreteFull
            => ModelMapperForAccountUsageBalance.MapAccountUsageBalanceModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountUsageBalance>, string?, IEnumerable<IAccountUsageBalanceModel>> SelectLiteAndMapToModel
            => ModelMapperForAccountUsageBalance.SelectLiteAccountUsageBalanceAndMapToAccountUsageBalanceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountUsageBalance>, string?, IEnumerable<IAccountUsageBalanceModel>> SelectListAndMapToModel
            => ModelMapperForAccountUsageBalance.SelectListAccountUsageBalanceAndMapToAccountUsageBalanceModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountUsageBalance>, string?, IAccountUsageBalanceModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAccountUsageBalance.SelectFirstFullAccountUsageBalanceAndMapToAccountUsageBalanceModel;

        /// <inheritdoc/>
        protected override Func<IAccountUsageBalance, IAccountUsageBalanceModel, DateTime, DateTime?, IAccountUsageBalance> UpdateEntityFromModel
            => ModelMapperForAccountUsageBalance.UpdateAccountUsageBalanceFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AccountUsageBalance>> FilterQueryByModelExtensionAsync(
            IQueryable<AccountUsageBalance> query,
            IAccountUsageBalanceSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAccountUsageBalancesBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IAccountUsageBalance entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateAccountFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AccountUsageBalance entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AccountUsageBalance entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AccountUsageBalance entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AccountUsageBalance entity");
        }
