// <autogenerated>
// <copyright file="AccountPricePointWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AccountPricePoint entities.</summary>
    /// <seealso cref="WorkflowBase{IAccountPricePointModel, IAccountPricePointSearchModel, IAccountPricePoint, AccountPricePoint}"/>
    /// <seealso cref="IAccountPricePointWorkflow"/>
    public partial class AccountPricePointWorkflow
        : WorkflowBase<IAccountPricePointModel, IAccountPricePointSearchModel, IAccountPricePoint, AccountPricePoint>
            , IAccountPricePointWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AccountPricePoint?, string?, IAccountPricePointModel?> MapFromConcreteFull
            => ModelMapperForAccountPricePoint.MapAccountPricePointModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountPricePoint>, string?, IEnumerable<IAccountPricePointModel>> SelectLiteAndMapToModel
            => ModelMapperForAccountPricePoint.SelectLiteAccountPricePointAndMapToAccountPricePointModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountPricePoint>, string?, IEnumerable<IAccountPricePointModel>> SelectListAndMapToModel
            => ModelMapperForAccountPricePoint.SelectListAccountPricePointAndMapToAccountPricePointModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountPricePoint>, string?, IAccountPricePointModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAccountPricePoint.SelectFirstFullAccountPricePointAndMapToAccountPricePointModel;

        /// <inheritdoc/>
        protected override Func<IAccountPricePoint, IAccountPricePointModel, DateTime, DateTime?, IAccountPricePoint> UpdateEntityFromModel
            => ModelMapperForAccountPricePoint.UpdateAccountPricePointFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AccountPricePoint>> FilterQueryByModelExtensionAsync(
            IQueryable<AccountPricePoint> query,
            IAccountPricePointSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAccountPricePointsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IAccountPricePoint entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AccountPricePoint entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AccountPricePoint entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AccountPricePoint entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AccountPricePoint entity");
        }
