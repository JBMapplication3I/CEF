// <autogenerated>
// <copyright file="AccountWithNotesAssociationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>An Account Notes association workflow.</summary>
    /// <seealso cref="AssociateObjectsWorkflowBase{IAccountModel, IAccount, INoteModel, INote, Note}"/>
    /// <seealso cref="IAccountWithNotesAssociationWorkflow"/>
    public partial class AccountWithNotesAssociationWorkflow
        // ReSharper disable once RedundantExtendsListEntry
        : AssociateNotesWorkflowBase<IAccountModel, IAccount, INoteModel, INote, Note>
        , IAccountWithNotesAssociationWorkflow
    {
        /// <inheritdoc/>
        protected override ICollection<Note>? GetObjectsCollection(IAccount entity) { return entity.Notes; }

        /// <inheritdoc/>
        protected override List<INoteModel>? GetModelObjectsList(IAccountModel model) { return model.Notes; }

        /// <inheritdoc/>
        protected override async Task AddObjectToObjectsListAsync(IAccount entity, INote newEntity)
        {
