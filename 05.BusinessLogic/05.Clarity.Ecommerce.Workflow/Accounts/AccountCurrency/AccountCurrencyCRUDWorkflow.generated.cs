// <autogenerated>
// <copyright file="AccountCurrencyWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AccountCurrency entities.</summary>
    /// <seealso cref="WorkflowBase{IAccountCurrencyModel, IAccountCurrencySearchModel, IAccountCurrency, AccountCurrency}"/>
    /// <seealso cref="IAccountCurrencyWorkflow"/>
    public partial class AccountCurrencyWorkflow
        : WorkflowBase<IAccountCurrencyModel, IAccountCurrencySearchModel, IAccountCurrency, AccountCurrency>
            , IAccountCurrencyWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AccountCurrency?, string?, IAccountCurrencyModel?> MapFromConcreteFull
            => ModelMapperForAccountCurrency.MapAccountCurrencyModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountCurrency>, string?, IEnumerable<IAccountCurrencyModel>> SelectLiteAndMapToModel
            => ModelMapperForAccountCurrency.SelectLiteAccountCurrencyAndMapToAccountCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountCurrency>, string?, IEnumerable<IAccountCurrencyModel>> SelectListAndMapToModel
            => ModelMapperForAccountCurrency.SelectListAccountCurrencyAndMapToAccountCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountCurrency>, string?, IAccountCurrencyModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAccountCurrency.SelectFirstFullAccountCurrencyAndMapToAccountCurrencyModel;

        /// <inheritdoc/>
        protected override Func<IAccountCurrency, IAccountCurrencyModel, DateTime, DateTime?, IAccountCurrency> UpdateEntityFromModel
            => ModelMapperForAccountCurrency.UpdateAccountCurrencyFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AccountCurrency>> FilterQueryByModelExtensionAsync(
            IQueryable<AccountCurrency> query,
            IAccountCurrencySearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAccountCurrenciesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the AccountCurrency entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the AccountCurrency entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the AccountCurrency entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the AccountCurrency entity");
        }
