// <autogenerated>
// <copyright file="AccountTypeWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for AccountType entities.</summary>
    /// <seealso cref="TypableWorkflowBase{ITypeModel, ITypeSearchModel, IAccountType, AccountType}"/>
    /// <seealso cref="IAccountTypeWorkflow"/>
    public partial class AccountTypeWorkflow
        : TypableWorkflowBase<ITypeModel, ITypeSearchModel, IAccountType, AccountType>
            , IAccountTypeWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<AccountType?, string?, ITypeModel?> MapFromConcreteFull
            => ModelMapperForAccountType.MapAccountTypeModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountType>, string?, IEnumerable<ITypeModel>> SelectLiteAndMapToModel
            => ModelMapperForAccountType.SelectLiteAccountTypeAndMapToTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountType>, string?, IEnumerable<ITypeModel>> SelectListAndMapToModel
            => ModelMapperForAccountType.SelectListAccountTypeAndMapToTypeModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<AccountType>, string?, ITypeModel?> SelectFirstFullAndMapToModel
            => ModelMapperForAccountType.SelectFirstFullAccountTypeAndMapToTypeModel;

        /// <inheritdoc/>
        protected override Func<IAccountType, ITypeModel, DateTime, DateTime?, IAccountType> UpdateEntityFromModel
            => ModelMapperForAccountType.UpdateAccountTypeFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<AccountType>> FilterQueryByModelExtensionAsync(
            ...
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterAccountTypesBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the AccountType entity");
        }
