// <autogenerated>
// <copyright file="MessageAttachmentWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for MessageAttachment entities.</summary>
    /// <seealso cref="NameableWorkflowBase{IMessageAttachmentModel, IMessageAttachmentSearchModel, IMessageAttachment, MessageAttachment}"/>
    /// <seealso cref="IMessageAttachmentWorkflow"/>
    public partial class MessageAttachmentWorkflow
        : NameableWorkflowBase<IMessageAttachmentModel, IMessageAttachmentSearchModel, IMessageAttachment, MessageAttachment>
            , IMessageAttachmentWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<MessageAttachment?, string?, IMessageAttachmentModel?> MapFromConcreteFull
            => ModelMapperForMessageAttachment.MapMessageAttachmentModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<MessageAttachment>, string?, IEnumerable<IMessageAttachmentModel>> SelectLiteAndMapToModel
            => ModelMapperForMessageAttachment.SelectLiteMessageAttachmentAndMapToMessageAttachmentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<MessageAttachment>, string?, IEnumerable<IMessageAttachmentModel>> SelectListAndMapToModel
            => ModelMapperForMessageAttachment.SelectListMessageAttachmentAndMapToMessageAttachmentModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<MessageAttachment>, string?, IMessageAttachmentModel?> SelectFirstFullAndMapToModel
            => ModelMapperForMessageAttachment.SelectFirstFullMessageAttachmentAndMapToMessageAttachmentModel;

        /// <inheritdoc/>
        protected override Func<IMessageAttachment, IMessageAttachmentModel, DateTime, DateTime?, IMessageAttachment> UpdateEntityFromModel
            => ModelMapperForMessageAttachment.UpdateMessageAttachmentFromModel;
        #endregion
        ...
        /// <inheritdoc/>
        public virtual async Task<IMessageAttachmentModel?> GetBySeoUrlAsync(
            string seoUrl,
        ...
        /// <inheritdoc/>
        public virtual Task<IMessageAttachmentModel?> GetBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return Task.FromResult(
                SelectFirstFullAndMapToModel(
                    context.Set<MessageAttachment>()
                        .AsNoTracking()
                        .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false),
        ...
        {
            return context.Set<MessageAttachment>()
                .FilterByActive(true)
                .FilterBySeoUrl(Contract.RequiresValidKey(seoUrl), true, false)
                .Select(x => (int?)x.ID)
                .SingleOrDefaultAsync();
        ...
        protected virtual Task<MessageAttachment> GetEntityBySeoUrlAsync(
            string seoUrl,
            IClarityEcommerceEntities context)
        {
            return context.Set<MessageAttachment>()
        ...
        /// <inheritdoc/>
        protected override async Task<IQueryable<MessageAttachment>> FilterQueryByModelExtensionAsync(
            IQueryable<MessageAttachment> query,
            IMessageAttachmentSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterMessageAttachmentsBySearchModel(search);
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            var resolved = await Workflows.Messages.ResolveAsync(
            ...
            if (entityIDAndModelIDHaveSameID || entityObjectAndModelObjectHaveSameID)
            {
                ...
                {
                    entity.Master!.UpdateMessageFromModel(resolved.Result!, timestamp, timestamp);
                }
                return;
            }
            if (!modelIDIsNull)
            ...
            if (!modelObjectIDIsNull && !modelObjectIsActive)
            {
                ...
                throw new InvalidOperationException("Cannot assign an inactive MasterID to the MessageAttachment entity");
            }
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Master to the MessageAttachment entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive SlaveID to the MessageAttachment entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Slave to the MessageAttachment entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            {
                // [Required] Scenario 4: We have an ID on the model, but the object is inactive
                throw new InvalidOperationException("Cannot assign an inactive CreatedByUserID to the MessageAttachment entity");
            }
            if (!modelObjectIDIsNull)
            {
                // [Required] Scenario 5: We have IDs but they don't match, assign the model's ID to the entity's ID (from the model object)
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given CreatedByUser to the MessageAttachment entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given UpdatedByUser to the MessageAttachment entity");
        }
