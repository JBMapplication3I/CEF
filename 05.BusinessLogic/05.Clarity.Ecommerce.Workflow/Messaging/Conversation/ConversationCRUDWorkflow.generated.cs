// <autogenerated>
// <copyright file="ConversationWorkflow.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow
{
    ...
    /// <summary>A workflow for Conversation entities.</summary>
    /// <seealso cref="WorkflowBase{IConversationModel, IConversationSearchModel, IConversation, Conversation}"/>
    /// <seealso cref="IConversationWorkflow"/>
    public partial class ConversationWorkflow
        : WorkflowBase<IConversationModel, IConversationSearchModel, IConversation, Conversation>
            , IConversationWorkflow
    {
        #region Mappers
        /// <inheritdoc/>
        protected override Func<Conversation?, string?, IConversationModel?> MapFromConcreteFull
            => ModelMapperForConversation.MapConversationModelFromEntityFull;

        /// <inheritdoc/>
        protected override Func<IQueryable<Conversation>, string?, IEnumerable<IConversationModel>> SelectLiteAndMapToModel
            => ModelMapperForConversation.SelectLiteConversationAndMapToConversationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Conversation>, string?, IEnumerable<IConversationModel>> SelectListAndMapToModel
            => ModelMapperForConversation.SelectListConversationAndMapToConversationModel;

        /// <inheritdoc/>
        protected override Func<IQueryable<Conversation>, string?, IConversationModel?> SelectFirstFullAndMapToModel
            => ModelMapperForConversation.SelectFirstFullConversationAndMapToConversationModel;

        /// <inheritdoc/>
        protected override Func<IConversation, IConversationModel, DateTime, DateTime?, IConversation> UpdateEntityFromModel
            => ModelMapperForConversation.UpdateConversationFromModel;
        #endregion

        /// <inheritdoc/>
        protected override async Task<IQueryable<Conversation>> FilterQueryByModelExtensionAsync(
            IQueryable<Conversation> query,
            IConversationSearchModel search,
            IClarityEcommerceEntities context)
        {
            return (await base.FilterQueryByModelExtensionAsync(query, search, context).ConfigureAwait(false))
                .FilterConversationsBySearchModel(search);
        }

        /// <inheritdoc/>
        protected override async Task RunDefaultAssociateWorkflowsAsync(
            IConversation entity,
            ...
            IClarityEcommerceEntities context)
        {
            ...
            if (model.Users != null) { await Workflows.ConversationWithUsersAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
            if (model.Messages != null) { await Workflows.ConversationWithMessagesAssociation.AssociateObjectsAsync(entity, model, timestamp, context).ConfigureAwait(false); }
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Store to the Conversation entity");
        }
            ...
            IClarityEcommerceEntities context)
        {
            ...
            // [Optional/Required] Scenario 10: Could not figure out what to do
            throw new InvalidOperationException(
                "Couldn't figure out how to relate the given Brand to the Conversation entity");
        }
