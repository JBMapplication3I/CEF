// <copyright file="AmFilterableByVendorSlaveTSQLSearchExtensions.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Interfaces.Models
{
    ...
    /// <summary>An am filterable by vendor slave tsql search extensions.</summary>
    public static class AmFilterableByVendorSlaveTSQLSearchExtensions
    {
        /// <summary>An IQueryable{TEntity} extension method that filter i am filterable by slave vendors by search
        /// model.</summary>
        ...
        public static IQueryable<TEntity> FilterIAmFilterableBySlaveVendorsBySearchModel<TEntity, TVendorLink>(
                this IQueryable<TEntity> query,
                IAmFilterableByVendorSearchModel model)
            where TEntity : class, IAmFilterableByVendor<TVendorLink>
            where TVendorLink : class, IAmAVendorRelationshipTableWhereVendorIsTheSlave<TEntity>
        {
            if (model == null)
            {
                return query;
