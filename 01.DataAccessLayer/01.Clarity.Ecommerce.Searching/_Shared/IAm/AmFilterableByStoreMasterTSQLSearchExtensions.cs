// <copyright file="AmFilterableByStoreMasterTSQLSearchExtensions.cs" company="clarity-ventures.com">
// Copyright (c) 2020-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the am filterable by store master{T} sql search extensions class</summary>
namespace Clarity.Ecommerce.Interfaces.Models
{
    ...
    /// <summary>An am filterable by store master tsql search extensions.</summary>
    public static class AmFilterableByStoreMasterTSQLSearchExtensions
    {
        /// <summary>An IQueryable{TEntity} extension method that filter i am filterable by master stores by search
        /// model.</summary>
        ...
        public static IQueryable<TEntity> FilterIAmFilterableByMasterStoresBySearchModel<TEntity, TStoreLink>(
                this IQueryable<TEntity> query,
                IAmFilterableByStoreSearchModel model)
            where TEntity : class, IAmFilterableByStore<TStoreLink>
            where TStoreLink : class, IAmAStoreRelationshipTableWhereStoreIsTheMaster<TEntity>
        {
            if (model == null)
            {
                return query;
        ...
        /// <returns>An <see cref="IQueryable{TEntity}"/>.</returns>
        public static IQueryable<TEntity> FilterByStoreID<TEntity, TStoreLink>(
                this IQueryable<TEntity> query,
                int? id)
            where TEntity : class, IAmFilterableByStore<TStoreLink>
            where TStoreLink : class, IAmAStoreRelationshipTableWhereStoreIsTheMaster<TEntity>
            ...
            where TStoreLink : class, IAmAStoreRelationshipTableWhereStoreIsTheMaster<TEntity>
        {
            ...
            return Contract.RequiresNotNull(query)
                .Where(x => x.Stores!
                    .Any(y => y.Active && y.Master!.Active && y.Master.Contact!.Address!.CountryID == id));
        }
            ...
            where TStoreLink : class, IAmAStoreRelationshipTableWhereStoreIsTheMaster<TEntity>
        {
            ...
            return Contract.RequiresNotNull(query)
                .Where(x => x.Stores!
                    .Any(y => y.Active && y.Master!.Active && y.Master.Contact!.Address!.RegionID == id));
        }
            ...
            where TStoreLink : class, IAmAStoreRelationshipTableWhereStoreIsTheMaster<TEntity>
        {
            ...
            return Contract.RequiresNotNull(query)
                .Where(x => x.Stores!
                    .Any(y => y.Active && y.Master!.Active && y.Master.Contact!.Address!.City == city));
        }
            ...
            where TStoreLink : class, IAmAStoreRelationshipTableWhereStoreIsTheMaster<TEntity>
        {
            ...
            return Contract.RequiresNotNull(query)
                .Where(x => x.Stores!
                    .Any(y => y.Active && y.Master!.Active && y.Master.StoreContacts!
