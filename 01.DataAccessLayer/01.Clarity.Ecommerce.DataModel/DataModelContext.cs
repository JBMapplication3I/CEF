...
namespace Clarity.Ecommerce.Interfaces.DataModel
{
    ...
    public interface IClarityEcommerceEntities : IDbContext
    {
        ...
        IDbSet<ShipmentLine> ShipmentLines { get; set; }
...
namespace Clarity.Ecommerce.DataModel
{
    ...
    public partial class ClarityEcommerceEntities : IClarityEcommerceEntities
    {
        ...
        public IDbSet<ShipmentLine> ShipmentLines { get; set; }
        ...
        private static void OnModelCreatingDates(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ShipmentLine>().Property(x => x.CreatedDate).HasColumnType("datetime2").HasPrecision(7);
            modelBuilder.Entity<ShipmentLine>().Property(x => x.UpdatedDate).HasColumnType("datetime2").HasPrecision(7);
