// <copyright file="AccountCurrency.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the account currency class</summary>
#nullable enable
namespace Clarity.Ecommerce.Interfaces.DataModel
{
    using Ecommerce.DataModel;

    public interface IAccountCurrency
        : IAmAnAccountRelationshipTableWhereAccountIsTheMaster<Currency>
    {
...
namespace Clarity.Ecommerce.DataModel
{
    ...
    [SqlSchema("Accounts", "AccountCurrency")]
    public class AccountCurrency : Base, IAccountCurrency
    {
        #region IAmARelationshipTable<Account, Currency>
        /// <inheritdoc/>
        ...
        int IAmAnAccountRelationshipTableWhereAccountIsTheMaster<Currency>.AccountID { get => MasterID; set => MasterID = value; }

        /// <inheritdoc/>
        [NotMapped, JsonIgnore, Obsolete("Cannot use in queries, use Master instead.", true)]
        Account? IAmAnAccountRelationshipTableWhereAccountIsTheMaster<Currency>.Account { get => Master; set => Master = value; }
        #endregion
