// <copyright file="SampleRequestFile.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the sample request file class</summary>
#nullable enable
namespace Clarity.Ecommerce.Interfaces.DataModel
{
    using Ecommerce.DataModel;

    public interface ISampleRequestFile : IAmAStoredFileRelationshipTable<SampleRequest>
    {
    }
}
...
namespace Clarity.Ecommerce.DataModel
{
    ...
    [SqlSchema("Sampling", "SampleRequestFile")]
    public class SampleRequestFile : NameableBase, ISampleRequestFile
    {
        ...
        #region IAmAStoredFileRelationshipTable<SampleRequest>
