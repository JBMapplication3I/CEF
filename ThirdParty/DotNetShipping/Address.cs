namespace DotNetShipping
{
    ...
    {
        public Address(string city, string state, string postalCode, string countryCode) : this(
            null,
            null,
            null,
            city,
        ...
        public bool IsCanadaAddress()
        {
            return !string.IsNullOrEmpty(CountryCode)
                && string.Equals(CountryCode, "CA", StringComparison.OrdinalIgnoreCase);
        }

        /// <summary>Returns true if the CountryCode matches US or one of the US territories.</summary>
        /// <returns>True if united states address, false if not.</returns>
