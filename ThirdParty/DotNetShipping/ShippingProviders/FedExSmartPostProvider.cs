namespace DotNetShipping.ShippingProviders
{
    ...
    public class FedExSmartPostProvider : FedExBaseProvider
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="FedExSmartPostProvider"/> class.</summary>
        /// <param name="key">          The key.</param>
        /// <param name="password">     The password.</param>
        /// <param name="accountNumber">The account number.</param>
        /// <param name="meterNumber">  The meter number.</param>
        /// <param name="hubId">        If specified, the FedEx Rate API will only return SmartPost service type rates.
        ///                             Leave empty to get all service types.</param>
        ...
        {
            _serviceCodes = new Dictionary<string, string> { { "SMART_POST", "FedEx Smart Post" } };
        }
