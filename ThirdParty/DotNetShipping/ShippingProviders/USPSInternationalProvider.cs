namespace DotNetShipping.ShippingProviders
{
    ...
    public class USPSInternationalProvider : AbstractShippingProvider
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="USPSInternationalProvider"/> class.</summary>
            ...
            using (var writer = XmlWriter.Create(sb, settings))
            {
                ...
                foreach (var package in Shipment.Packages)
                {
                    ...
                    writer.WriteElementString(
                        "ValueOfContents",
                        package.InsuredValue < 0
                            ? package.InsuredValue.ToString()
                            : "100"); // todo: figure out best way to come up with insured value
        ...
        private void ParseResult(string response)
        {
            ...
            var rates = document.Descendants("Service")
                ...
                .Select(
                    g => new { Name = g.Key, TotalCharges = g.Sum(x => decimal.Parse((string)x.Element("Postage"))) });
