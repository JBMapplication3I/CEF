namespace DotNetShipping.Helpers.Extensions
{
    ...
    /// <summary>Extension methods for RequestedShipment.</summary>
    public static class RequestedShipmentExtensions
    {
        /// <summary>Calculates the total weight for all packages in the requested shipment.</summary>
        ...
        public static Weight GetTotalWeight(this RequestedShipment requestedShipment)
        {
            if (requestedShipment != null
                ...
                && requestedShipment.RequestedPackageLineItems.Length > 0)
            {
