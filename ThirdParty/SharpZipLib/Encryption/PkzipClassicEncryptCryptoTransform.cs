...
namespace ICSharpCode.SharpZipLib.Encryption
{
    ...
    /// <summary>Form for viewing the pkzip classic encrypt crypto transaction.</summary>
    ...
    internal class PkzipClassicEncryptCryptoTransform : PkzipClassicCryptoBase, ICryptoTransform, IDisposable
    {
        ...
        ///     <see cref="ICSharpCode.SharpZipLib.Encryption.PkzipClassicEncryptCryptoTransform" /> class.
        /// </summary>
            ...
            int outputOffset)
        {
            ...
            {
                var ch = inputBuffer[index];
                outputBuffer[outputOffset++] = (byte)(inputBuffer[index] ^ (uint)this.TransformByte());
                this.UpdateKeys(ch);
            }
