namespace StackExchange.Redis.Extensions.Core
{
    ...
    /// <summary>The implementation of <see cref="ICacheClient" /></summary>
    /// <seealso cref="ICacheClient"/>
    public class StackExchangeRedisCacheClient : ICacheClient
    {
        /// <summary>The keyprefix.</summary>
        private readonly string keyprefix = null;

        /// <summary>(Immutable) The connection multiplexer.</summary>
        private readonly IConnectionMultiplexer connectionMultiplexer;

        /// <summary>(Immutable) The server enumeration strategy.</summary>
        private readonly ServerEnumerationStrategy serverEnumerationStrategy = new();

        /// <summary>(Immutable) The dispose connection multiplexer.</summary>
        private readonly bool disposeConnectionMultiplexer = false;

        /// <summary>True if disposed.</summary>
        private bool disposed;

        /// <summary>Initializes a new instance of the <see cref="StackExchangeRedisCacheClient" /> class.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="StackExchangeRedisCacheClient" /> class.</summary>
        /// <exception cref="System.ArgumentNullException">connectionMultiplexer or serializer.</exception>
        ...
        /// <summary>Finalizes an instance of the StackExchangeRedisCacheClient class.</summary>
        ...
        /// resources.</summary>
        /// <param name="isDisposing">True if this StackExchangeRedisCacheClient is disposing.</param>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>Releases the unmanaged resources used by the StackExchangeRedisCacheClient and optionally releases
        ...
        /// <summary>Return the instance of <see cref="StackExchange.Redis.IDatabase" /> used be ICacheClient
        ...
        /// <summary>Adds all asynchronous.</summary>
        /// <typeparam name="T">.</typeparam>
        /// <param name="items">The items.</param>
        ...
        /// <param name="commandFlags">Command execution flags.</param>
        /// <returns>True if the object has been removed. Otherwise false.</returns>
        public IEnumerable<T> SortedSetRangeByScore<T>(string key, double start = double.NegativeInfinity, double stop = double.PositiveInfinity, Exclude exclude = Exclude.None, Order order = Order.Ascending, long skip = 0L, long take = -1L, CommandFlags commandFlags = CommandFlags.None)
        {
        ...
        /// <param name="commandFlags">Command execution flags.</param>
        /// <returns>True if the object has been removed. Otherwise false.</returns>
        public async Task<IEnumerable<T>> SortedSetRangeByScoreAsync<T>(string key, double start = double.NegativeInfinity, double stop = double.PositiveInfinity, Exclude exclude = Exclude.None, Order order = Order.Ascending, long skip = 0L, long take = -1L, CommandFlags commandFlags = CommandFlags.None)
        {
