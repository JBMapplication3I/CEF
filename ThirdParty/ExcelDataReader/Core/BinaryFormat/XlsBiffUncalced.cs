...
// Type: Excel.Core.BinaryFormat.XlsBiffUncalced
...
{
    /// <summary>The XLS biff uncalced.</summary>
    /// <seealso cref="Excel.Core.BinaryFormat.XlsBiffRecord"/>
    internal class XlsBiffUncalced : XlsBiffRecord
    {
        /// <summary>Initializes a new instance of the <see cref="Excel.Core.BinaryFormat.XlsBiffUncalced"/> class.</summary>
