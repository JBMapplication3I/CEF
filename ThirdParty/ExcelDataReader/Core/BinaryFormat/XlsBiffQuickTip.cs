...
// Type: Excel.Core.BinaryFormat.XlsBiffQuickTip
...
{
    /// <summary>The XLS biff quick tip.</summary>
    /// <seealso cref="Excel.Core.BinaryFormat.XlsBiffRecord"/>
    internal class XlsBiffQuickTip : XlsBiffRecord
    {
        /// <summary>Initializes a new instance of the <see cref="Excel.Core.BinaryFormat.XlsBiffQuickTip"/> class.</summary>
