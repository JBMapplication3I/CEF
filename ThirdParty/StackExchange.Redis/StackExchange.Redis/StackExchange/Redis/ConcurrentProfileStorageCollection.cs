namespace StackExchange.Redis
{
    ...
    sealed class ConcurrentProfileStorageCollection
    {
        ...
        static readonly ConcurrentProfileStorageCollection[] Pool = new ConcurrentProfileStorageCollection[PoolSize];
...
#pragma warning restore 420
                ...
                if (object.ReferenceEquals(got, cur))
                {
                    break;
                }
            } while (true);
