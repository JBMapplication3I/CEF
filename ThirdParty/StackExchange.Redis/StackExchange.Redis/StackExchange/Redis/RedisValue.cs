namespace StackExchange.Redis
{
    ...
    public struct RedisValue : IEquatable<RedisValue>, IComparable<RedisValue>, IComparable, IConvertible
    {
        ...
        static readonly byte[] EmptyByteArr = Array.Empty<byte>();

        private static readonly byte[] IntegerSentinel = Array.Empty<byte>();
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                null => valueBlob == null,
                RedisValue => Equals((RedisValue)obj),
                string => (string)obj == (string)this,
                byte[] => Equals((byte[])obj, this),
                long => (long)obj == (long)this,
                int => (int)obj == (int)this,
                _ => false
            };
        }
        ...
        public int CompareTo(RedisValue other)
        {
            try
            {
                CompareType thisType = this.ResolveType(out var thisInt64, out var thisDouble),
                    otherType = other.ResolveType(out var otherInt64, out var otherDouble);
        ...
        int IComparable.CompareTo(object obj)
        {
            return obj switch
            {
                RedisValue => CompareTo((RedisValue)obj),
                long => CompareTo((long)obj),
                double => CompareTo((double)obj),
                string => CompareTo((string)obj),
                byte[] => CompareTo((byte[])obj),
                bool => CompareTo((bool)obj),
                _ => -1
            };
        }
        ...
        internal static RedisValue Parse(object obj)
        {
            ...
            return obj switch
            {
                RedisValue => (RedisValue)obj,
                string => (RedisValue)(string)obj,
                int => (int)obj,
                double => (double)obj,
                byte[] => (RedisValue)(byte[])obj,
                bool => (bool)obj,
                long => (long)obj,
                float => (float)obj,
                _ => throw new InvalidOperationException("Unable to format type for redis: " + obj.GetType().FullName)
            };
        }
        /// <summary>
        ...
        public static explicit operator long(RedisValue value)
        {
            ...
            if (TryParseInt64(blob, 0, blob.Length, out var i64))
            {
                return i64;
            }
        ...
        public static explicit operator double(RedisValue value)
        {
            ...
            if (TryParseDouble(blob, out var r8))
            {
                return r8;
            }
    ...
    internal static class ReflectionExtensions
    {
        ...
        internal static TypeCode GetTypeCode(this Type type)
        {
            ...
            if (typeCodeLookup.TryGetValue(type, out var result))
                return result;
        ...
        static readonly Dictionary<Type, TypeCode> typeCodeLookup = new()
        {
