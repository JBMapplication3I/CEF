namespace StackExchange.Redis
{
    ...
    internal class RedisTransaction : RedisDatabase, ITransaction
    {
        ...
        {
            var msg = CreateMessage(flags, out var proc);
        ...
        internal override Task<T> ExecuteAsync<T>(Message message, ResultProcessor<T> processor, ServerEndPoint server = null)
        {
            ...
            (pending ??= new List<QueuedMessage>()).Add(queued);
        ...
        class QueuedMessage : Message
        {
            ...
            public Message Wrapped { get; private set; }
        ...
        {
            static readonly ConditionResult[] NixConditions = Array.Empty<ConditionResult>();

            static readonly QueuedMessage[] NixMessages = Array.Empty<QueuedMessage>();
            ...
            public QueuedMessage[] InnerOperations { get; private set; }
