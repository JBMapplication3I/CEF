namespace StackExchange.Redis
{
    ...
    public abstract class Condition
    {
        ...
        public static Condition HashEqual(RedisKey key, RedisValue hashField, RedisValue value)
        {
            ...
            if (value.IsNull)
            {
                return HashNotExists(key, hashField);
            }
        ...
        public static Condition HashNotEqual(RedisKey key, RedisValue hashField, RedisValue value)
        {
            ...
            if (value.IsNull)
            {
                return HashExists(key, hashField);
            }
        ...
        internal sealed class ConditionProcessor : ResultProcessor<bool>
        {
            ...
            public static Message CreateMessage(Condition condition, int db, CommandFlags flags, RedisCommand command, RedisKey key, RedisValue value = default)
            {
            ...
            protected override bool SetResultCore(PhysicalConnection connection, Message message, RawResult result)
            {
                ...
                if (condition != null && condition.TryValidate(result, out var final))
                {
        ...
        internal class ExistsCondition : Condition
        {
            ...
            {
                if (ResultProcessor.DemandZeroOrOneProcessor.TryGet(result, out var parsed))
                {
    ...
    public sealed class ConditionResult
    {
        ...
        internal bool UnwrapBox()
        {
            if (resultBox != null)
            {
                ResultBox<bool>.UnwrapAndRecycle(resultBox, false, out var val, out var ex);
                resultBox = null;
