namespace ServiceStack
{
    ...
    public class UrnId
    {
        ...
        private const char FieldPartsSeparator = '/';
        ...
        public static UrnId Parse(string urnId)
        {
            ...
            {
                return new() { TypeName = urnParts[1], IdFieldValue = urnParts[2] };
            }
            if (urnParts.Length == HasIdFieldName)
            {
                return new() { TypeName = urnParts[1], IdFieldName = urnParts[2], IdFieldValue = urnParts[3] };
            }
        ...
        {
            return new(Parse(urn).IdFieldValue);
        }
