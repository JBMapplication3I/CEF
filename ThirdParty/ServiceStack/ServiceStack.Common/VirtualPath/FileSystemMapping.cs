...
namespace ServiceStack.VirtualPath
{
    public class FileSystemMapping : AbstractVirtualPathProviderBase
    {
        ...
        public FileSystemMapping(string alias, DirectoryInfo rootDirInfo)
        {
            ...
            Alias = alias;
            RootDirInfo = rootDirInfo ?? throw new ArgumentNullException(nameof(rootDirInfo));
            Initialize();
        }
        ...
        protected sealed override void Initialize()
        {
            ...
            {
                throw new($"RootDir '{RootDirInfo.FullName}' for virtual path does not exist");
            }

            RootDir = new(this, null, RootDirInfo);
        }
        ...
        {
            return new[] { new InMemoryVirtualDirectory(new(), Alias) };
        }
