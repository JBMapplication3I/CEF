...
namespace ServiceStack
{
    public class Command : JsExpression
    {
        ...
        public override int IndexOfMethodEnd(StringSegment commandsString, int pos)
        {
            ...
            Suffix = commandsString.Subsegment(pos, endPos - pos).TrimEnd();
    ...
    public static class StringUtils
    {
        ...
        private static readonly Regex StripHtmlUnicodeRegEx = new(@"&(#)?([xX])?([^ \f\n\r\t\v;]+);", RegexOptions.Compiled);
        private static readonly Regex SafeInputRegEx = new(@"[^\w\s\.,@-\\+\\/]", RegexOptions.Compiled);
#else
