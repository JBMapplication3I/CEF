...
namespace ServiceStack.Templates
{
    ...
    public class TemplatePages : ITemplatePages
    {
        ...
        public TemplatePages(TemplateContext context) => Context = context;

        public static string Layout = "layout";

        private readonly ConcurrentDictionary<string, TemplatePage> pageMap = new(); 
        ...
        {
            return pageMap[virtualPath] = new(Context, file);
        }
        ...
        private static readonly InMemoryVirtualDirectory TempDir = new(TempFiles, TemplateConstants.TempFilePath);
