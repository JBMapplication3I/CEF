...
namespace ServiceStack.Templates
{
    ...
    public class TemplateHtmlFilters : TemplateFilter
    {
        ...
        [HandleUnknownValue] public IRawString htmlLink(string href) => htmlLink(href, new() { ["text"] = href });
        [HandleUnknownValue] public IRawString htmlLink(string href, Dictionary<string, object> attrs)
        {
            ...
            return htmlA(new(attrs ?? TypeConstants.EmptyObjectDictionary) { ["href"] = href });
        }
        ...
        [HandleUnknownValue] public IRawString htmlImage(string src, Dictionary<string, object> attrs)
        {
            ...
            return htmlImg(new(attrs ?? TypeConstants.EmptyObjectDictionary) { ["src"] = src });
        }
        ...
        {
            return htmlTag(new(attrs ?? TypeConstants.EmptyObjectDictionary) { ["html"] = innerHtml }, tag);
        }
        ...
        public IRawString htmlEm(string text) => htmlTag(new() { ["text"] = text }, "em");
        public IRawString htmlB(string innerHtml, Dictionary<string, object> attrs) => htmlTag(innerHtml, attrs, "b");
        public IRawString htmlB(string text) => htmlTag(new() { ["text"] = text }, "b");
        ...
        public IRawString htmlOption(string text) => htmlTag(new() { ["text"] = text }, "option");
    }
}