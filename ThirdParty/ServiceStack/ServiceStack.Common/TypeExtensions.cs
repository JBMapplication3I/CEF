...
namespace ServiceStack
{
    ...
    public static class TypeExtensions
    {
        ...
        private static Dictionary<ConstructorInfo, ObjectActivator> activatorCache = new();
        ...
        public static ObjectActivator GetActivator(this ConstructorInfo ctor)
        {
            ...
            do
            {
                ...
                newCache = new(activatorCache) { [ctor] = fn };
        ...
        private static Dictionary<MethodInfo, MethodInvoker> invokerCache = new();
        ...
        public static MethodInvoker GetInvoker(this MethodInfo method)
        {
            ...
            do
            {
                ...
                newCache = new(invokerCache) { [method] = fn };
