...
namespace ServiceStack.Text.Json
{
        ...
        : ITypeSerializer
    {
        ...
        {
            for (; i < value.Length; i++) { var c = value.GetChar(i); if (!JsonUtils.IsWhiteSpace(c))
                {
                    break;
                }
            } //Whitespace inline
        ...
        {
            for (; index < json.Length; index++) { var ch = json.GetChar(index); if (!JsonUtils.IsWhiteSpace(ch))
                {
                    break;
                }
            } //Whitespace inline
        ...
        public StringSegment EatValue(StringSegment value, ref int i)
        {
            ...
            return strValue == new StringSegment(JsonUtils.Null) ? default : strValue;
        }
    }
