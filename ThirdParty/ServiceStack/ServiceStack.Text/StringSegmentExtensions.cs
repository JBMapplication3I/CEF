    ...
    public static class StringSegmentExtensions
    {
        ...
        public static int ParseInt32(this StringSegment value)
        {
            return JsConfig.UseSystemParseMethods
                ...
                : (int)ParseSignedInteger(value, int.MaxValue, int.MinValue);
        }
        ...
        public static uint ParseUInt32(this StringSegment value)
        {
            return JsConfig.UseSystemParseMethods
                ...
                : (uint)ParseUnsignedInteger(value, uint.MaxValue);
        }
        ...
        public static long ParseInt64(this StringSegment value)
        {
            return JsConfig.UseSystemParseMethods
                ...
                : ParseSignedInteger(value, long.MaxValue, long.MinValue);
        }
        ...
        public static ulong ParseUInt64(this StringSegment value)
        {
            return JsConfig.UseSystemParseMethods
                ...
                : ParseUnsignedInteger(value, ulong.MaxValue);
        }
        ...
        public static long ParseSignedInteger(this StringSegment value, long maxValue, long minValue)
        {
            ...
            while (i < end && JsonUtils.IsWhiteSpace(value.Buffer[i]))
            {
                i++;
            }
        ...
        public static Guid ParseGuid(this StringSegment value)
        {
            ...
            result = ParseGeneralStyleGuid(new StringSegment(value.Buffer, i, end - i), out var guidLen);
            i += guidLen;
        ...
        public static StringSegment[] SplitOnFirst(this StringSegment strVal, char needle)
        {
            if (!strVal.HasValue)
            {
                return TypeConstants.EmptyStringSegmentArray;
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task WriteAsync(this Stream stream, StringSegment value, CancellationToken token = default)
        {
