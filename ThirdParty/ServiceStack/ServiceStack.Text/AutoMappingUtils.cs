...
namespace ServiceStack
{
    ...
    public static class AutoMappingUtils
    {
        ...
        private static object PopulateObjectInternal(object obj, Dictionary<Type, int> recursionInfo)
        {
            ...
            if (obj is string)
            {
                return obj; // prevents it from dropping into the char[] Chars property.  Sheesh
            }
    ...
    internal class AssignmentDefinition
    {
        ...
        {
            AssignmentMemberMap = new Dictionary<string, AssignmentEntry>();
        }
        ...
        {
            AssignmentMemberMap[name] = new AssignmentEntry(name, readMember, writeMember);
        }
