        ...
        JsConfig
    {
            ...
            bool? useSystemParseMethods = null)
        {
            return new JsConfigScope
            {
                ...
                UseSystemParseMethods = useSystemParseMethods,
            };
        }

        public static bool UseSystemParseMethods
        {
            get => (JsConfigScope.Current != null ? JsConfigScope.Current.UseSystemParseMethods : null)
                ?? false;
            set
            {
                if (!sConvertObjectTypesIntoStringDictionary.HasValue)
                {
                    sConvertObjectTypesIntoStringDictionary = value;
                }
            }
        }
        ...
        public static bool TryToParsePrimitiveTypeValues
        {
            ...
            set
            {
                if (!sTryToParsePrimitiveTypeValues.HasValue)
                {
                    sTryToParsePrimitiveTypeValues = value;
                }
            }
        }
        ...
        public static bool TryToParseNumericType
        {
            ...
            set
            {
                if (!sTryToParseNumericType.HasValue)
                {
                    sTryToParseNumericType = value;
                }
            }
        }
        ...
        public static bool TryParseIntoBestFit
        {
            ...
            set
            {
                if (!sTryParseIntoBestFit.HasValue)
                {
                    sTryParseIntoBestFit = value;
                }
            }
        }
        ...
        public static ParseAsType ParsePrimitiveFloatingPointTypes
        {
            ...
            set
            {
                if (sParsePrimitiveFloatingPointTypes == null)
                {
                    sParsePrimitiveFloatingPointTypes = value;
                }
            }
        }
        ...
        public static ParseAsType ParsePrimitiveIntegerTypes
        {
            ...
            set
            {
                if (!sParsePrimitiveIntegerTypes.HasValue)
                {
                    sParsePrimitiveIntegerTypes = value;
                }
            }
        }
        ...
        public static bool ExcludeDefaultValues
        {
            ...
            set
            {
                if (!sExcludeDefaultValues.HasValue)
                {
                    sExcludeDefaultValues = value;
                }
            }
        }
        ...
        public static bool IncludeNullValues
        {
            ...
            set
            {
                if (!sIncludeNullValues.HasValue)
                {
                    sIncludeNullValues = value;
                }
            }
        }
        ...
        public static bool IncludeNullValuesInDictionaries
        {
            ...
            set
            {
                if (!sIncludeNullValuesInDictionaries.HasValue)
                {
                    sIncludeNullValuesInDictionaries = value;
                }
            }
        }
        ...
        public static bool IncludeDefaultEnums
        {
            ...
            set
            {
                if (!sIncludeDefaultEnums.HasValue)
                {
                    sIncludeDefaultEnums = value;
                }
            }
        }
        ...
        public static bool TreatEnumAsInteger
        {
            ...
            set
            {
                if (!sTreatEnumAsInteger.HasValue)
                {
                    sTreatEnumAsInteger = value;
                }
            }
        }
        ...
        public static bool ExcludeTypeInfo
        {
            ...
            set
            {
                if (!sExcludeTypeInfo.HasValue)
                {
                    sExcludeTypeInfo = value;
                }
            }
        }
        ...
        public static bool IncludeTypeInfo
        {
            ...
            set
            {
                if (!sIncludeTypeInfo.HasValue)
                {
                    sIncludeTypeInfo = value;
                }
            }
        }
        ...
        internal static string JsonTypeAttrInObject
        {
            ...
            set
            {
                if (sJsonTypeAttrInObject == null)
                {
                    sJsonTypeAttrInObject = value;
                }
            }
        }
        ...
        internal static string JsvTypeAttrInObject
        {
            ...
            set
            {
                if (sJsvTypeAttrInObject == null)
                {
                    sJsvTypeAttrInObject = value;
                }
            }
        }
        ...
        public static Func<string, object> ParsePrimitiveFn
        {
            ...
            set
            {
                if (sParsePrimitiveFn == null)
                {
                    sParsePrimitiveFn = value;
                }
            }
        }
        ...
        public static TimeSpanHandler TimeSpanHandler
        {
            ...
            set
            {
                if (!sTimeSpanHandler.HasValue)
                {
                    sTimeSpanHandler = value;
                }
            }
        }
        ...
        public static bool EmitCamelCaseNames
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.EmitCamelCaseNames : null)
                    ?? sEmitCamelCaseNames
                    ?? false;
            set
            {
                if (!sEmitCamelCaseNames.HasValue)
                {
                    sEmitCamelCaseNames = value;
                }
            }
        }
        ...
        public static bool EmitLowercaseUnderscoreNames
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.EmitLowercaseUnderscoreNames : null)
                    ?? sEmitLowercaseUnderscoreNames
                    ?? false;
            set
            {
                if (!sEmitLowercaseUnderscoreNames.HasValue)
                {
                    sEmitLowercaseUnderscoreNames = value;
                }
            }
        }
        ...
        public static PropertyConvention PropertyConvention
        {
            ...
            set
            {
                if (!sPropertyConvention.HasValue)
                {
                    sPropertyConvention = value;
                }
            }
        }
        ...
        public static bool ThrowOnDeserializationError
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.ThrowOnDeserializationError : null)
                    ?? sThrowOnDeserializationError
                    ?? false;
            set
            {
                if (!sThrowOnDeserializationError.HasValue)
                {
                    sThrowOnDeserializationError = value;
                }
            }
        }
        ...
        public static bool AlwaysUseUtc
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.AlwaysUseUtc : null)
                    ?? sAlwaysUseUtc
                    ?? false;
            set
            {
                if (!sAlwaysUseUtc.HasValue)
                {
                    sAlwaysUseUtc = value;
                }
            }
        ...
        public static bool SkipDateTimeConversion
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.SkipDateTimeConversion : null)
                    ?? sSkipDateTimeConversion
                    ?? false;
            set
            {
                if (!sSkipDateTimeConversion.HasValue)
                {
                    sSkipDateTimeConversion = value;
                }
            }
        }
        /// <summary>
        ...
        public static bool AssumeUtc
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.AssumeUtc : null)
                    ?? sAssumeUtc
                    ?? false;
            set
            {
                if (!sAssumeUtc.HasValue)
                {
                    sAssumeUtc = value;
                }
            }
        ...
        public static bool? AppendUtcOffset
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.AppendUtcOffset : null)
                    ?? sAppendUtcOffset
                    ?? null;
            set
            {
                if (sAppendUtcOffset == null)
                {
                    sAppendUtcOffset = value;
                }
            }
        }
        ...
        public static bool EscapeUnicode
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.EscapeUnicode : null)
                       ?? sEscapeUnicode
                       ?? false;
            set
            {
                if (!sEscapeUnicode.HasValue)
                {
                    sEscapeUnicode = value;
                }
            }
        }
        ...
        public static bool EscapeHtmlChars
        {
            ...
            get
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            => (JsConfigScope.Current != null ? JsConfigScope.Current.EscapeHtmlChars : null)
                       ?? sEscapeHtmlChars
                       ?? false;
            set
            {
                if (!sEscapeHtmlChars.HasValue)
                {
                    sEscapeHtmlChars = value;
                }
            }
        }
        ...
        public static bool PreferInterfaces
        {
            ...
            set
            {
                if (!sPreferInterfaces.HasValue)
                {
                    sPreferInterfaces = value;
                }
            }
        }
        ...
        public static bool IncludePublicFields
        {
            ...
            set
            {
                if (!sIncludePublicFields.HasValue)
                {
                    sIncludePublicFields = value;
                }
            }
        }
        ...
        public static string[] ExcludePropertyReferences
        {
            ...
            set
            {
                if (sExcludePropertyReferences != null)
                {
                    sExcludePropertyReferences = value;
                }
            }
        }
