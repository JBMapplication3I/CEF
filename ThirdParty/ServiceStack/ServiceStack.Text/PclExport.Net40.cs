...
namespace ServiceStack
{
    public class Net40PclExport : PclExport
    {
        ...
        public Net40PclExport()
        {
            ...
            AltDirSep = Path.DirectorySeparatorChar == '/' ? '\\' : '/';
...
#else
            InvariantComparison = StringComparison.InvariantCulture;
            InvariantComparisonIgnoreCase = StringComparison.InvariantCultureIgnoreCase;
#endif
            InvariantComparer = StringComparer.InvariantCulture;
            InvariantComparerIgnoreCase = StringComparer.InvariantCultureIgnoreCase;
    ...
    public static class PclExportExt
    {
        ...
        public static DataContractAttribute GetWeakDataContract(this Type type)
        {
            ...
            if (attr != null)
            {
                ...
                if (!typeAccessorMap.TryGetValue(attrType, out var accessor))
                {
