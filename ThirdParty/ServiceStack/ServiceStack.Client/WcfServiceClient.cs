namespace ServiceStack
{
    ...
    public class CookieManagerMessageInspector : IClientMessageInspector
    {
        ...
        public void AfterReceiveReply(ref Message reply, object correlationState)
        {
            ...
            {
                cookieContainer.SetCookies(new(Uri), cookie);
            }
        }
        ...
        public object BeforeSendRequest(ref Message request, IClientChannel channel)
        {
            ...
            httpRequest.Headers.Add(HttpRequestHeader.Cookie, cookieContainer.GetCookieHeader(new(Uri)));
    ...
    public abstract class WcfServiceClient : IWcfServiceClient
    {
        ...
        private static Exception CreateException(Exception e, XmlReader reader)
        {
            ...
            if (node != null)
            {
                ...
                return new($"SOAP FAULT '{errMsg}': {node.InnerXml}", e);
            }
            return e;
        }
