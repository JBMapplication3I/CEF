...
namespace ServiceStack
{
        ...
        : Exception, IHasStatusCode, IHasStatusDescription, IResponseStatusConvertible
    {
        ...
        private void ParseResponseDto()
        {
            ...
            rsMap = new(rsMap, PclExport.Instance.InvariantComparerIgnoreCase);
        ...
        private bool TryGetResponseStatusFromResponseDto(out string responseStatus)
        {
            ...
            try
            {
                ...
                map = new(map, PclExport.Instance.InvariantComparerIgnoreCase);
        ...
        public ResponseStatus ResponseStatus
        {
            get
            {
                ...
                var propertyInfo = ResponseDto.GetType().GetPropertyInfo("ResponseStatus");
                return propertyInfo?.GetProperty(ResponseDto) as ResponseStatus;
            }
        }
    ...
    public class RefreshTokenException : WebServiceException
    {
            ...
            : base(webEx.Message)
        {
            ...
            StatusDescription = webEx.StatusDescription;
            ResponseHeaders = webEx.ResponseHeaders;
            ResponseBody = webEx.ResponseBody;
            ResponseDto = webEx.ResponseDto;
        }
    }
}
