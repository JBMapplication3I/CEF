namespace ServiceStack
{
    ...
    public partial class ServerEventsClient
    {
        ...
        {
            if (Resolver.TryResolve<T>() is not IReceiver receiver)
            {
    ...
    internal class ReceiverExec<T>
    {
        ...
        {
            RequestTypeExecMap = new(StringComparer.OrdinalIgnoreCase);
            MethodNameExecMap = new(StringComparer.OrdinalIgnoreCase);
