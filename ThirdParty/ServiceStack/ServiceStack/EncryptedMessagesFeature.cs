...
namespace ServiceStack
{
    ...
    public class EncryptedMessagesFeature : IPlugin
    {
        ...
        public void Register(IAppHost appHost)
        {
            ...
            {
                if (requestDto is not EncryptedMessage encRequest)
                {
                    return null;
                }
                ...
                try
                {
                    ...
                    {
                        throw new("EncryptedSymmetricKey is Invalid");
                    }
                    ...
                    {
                        throw new("EncryptedBody is Invalid");
                    }
                    ...
                    nonceCache.Where(x => now > x.Value).ToList()
                        .Each(entry => nonceCache.TryRemove(entry.Key, out var expiredEntry));
