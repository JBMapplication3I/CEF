...
namespace ServiceStack.Html
{
	public class ModelMetadata
	{
		...
		private Dictionary<string, object> _additionalValues = new(StringComparer.OrdinalIgnoreCase);
		...
		public static ModelMetadata FromStringExpression(string expression, ViewDataDictionary viewData)
		{
			...
			{
				var propertyMetadata = viewData.ModelMetadata.Properties.Where(p => p.PropertyName == expression).FirstOrDefault();
