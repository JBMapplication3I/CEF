...
namespace ServiceStack.Html.Claims
{
    ...
    internal sealed class ClaimsIdentityConverter
    {
        ...
        private static readonly ClaimsIdentityConverter _default = new(GetDefaultConverters());
        ...
        public ClaimsIdentity TryConvert(IIdentity identity)
        {
            ...
            {
                var retVal = _converters[i](identity);
                if (retVal != null)
                {
                    return retVal;
                }
        ...
        private static void AddToList(IList<Func<IIdentity, ClaimsIdentity>> converters, Type claimsIdentityType, Type claimType)
        {
            ...
            {
                var tryConvertClosedMethod = _claimsIdentityTryConvertOpenMethod.MakeGenericMethod(claimsIdentityType, claimType);
        ...
        private static Func<IIdentity, ClaimsIdentity>[] GetDefaultConverters()
        {
            ...
            {
                var mscorlibModule = typeof(object).Module;
                var claimsIdentityType = mscorlibModule.GetType("System.Security.Claims.ClaimsIdentity");
                var claimType = mscorlibModule.GetType("System.Security.Claims.Claim");
                AddToList(converters, claimsIdentityType, claimType);
            }
