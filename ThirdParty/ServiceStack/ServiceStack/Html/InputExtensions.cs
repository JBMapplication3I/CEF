...
namespace ServiceStack.Html
{
    public static class InputExtensions
    {
        ...
        public static MvcHtmlString RadioButton(this HtmlHelper htmlHelper, string name, object value, IDictionary<string, object> htmlAttributes)
        {
            ...
            var isChecked = !string.IsNullOrEmpty(name) && string.Equals(htmlHelper.EvalString(name), valueString, StringComparison.OrdinalIgnoreCase);
        ...
        private static MvcHtmlString InputHelper(HtmlHelper htmlHelper, InputType inputType, ModelMetadata metadata, string name, object value, bool useViewData, bool isChecked, bool setId, bool isExplicitValue, string format, IDictionary<string, object> htmlAttributes)
        {
            ...
            switch (inputType)
            {
                case InputType.CheckBox:
                    if (htmlHelper.GetModelStateValue(fullName, typeof(bool)) is bool modelStateWasChecked)
                    {
                        isChecked = modelStateWasChecked;
                        usedModelState = true;
                    }
        ...
        {
            return dictionary == null ? new() : new RouteValueDictionary(dictionary);
        }
        #endregion
    }
}
