...
namespace ServiceStack.Html
{
    public static class ScopeStorage
    {
        ...
        {
            get => _stateStorageProvider ?? _defaultStorageProvider;
            set => _stateStorageProvider = value;
        }

        public static IDictionary<object, object> CurrentScope => CurrentProvider.CurrentScope;

        public static IDictionary<object, object> GlobalScope => CurrentProvider.GlobalScope;
    ...
    public class StaticScopeStorageProvider : IScopeStorageProvider
    {
        ...
        {
            get => _currentContext ?? _defaultContext;
            set => _currentContext = value;
        }

        public IDictionary<object, object> GlobalScope => _defaultContext;
    }
    ...
    {
        private static readonly StateStorageKeyValueComparer _keyValueComparer = new();
        ...
        protected IDictionary<object, object> BackingStore => _backingStore;

        protected IDictionary<object, object> BaseScope => _baseScope;
        ...
        {
            return _backingStore.ContainsKey(key) || _baseScope?.ContainsKey(key) == true;
        }
        ...
        {
            return _backingStore.Contains(item) || _baseScope?.Contains(item) == true;
        }
