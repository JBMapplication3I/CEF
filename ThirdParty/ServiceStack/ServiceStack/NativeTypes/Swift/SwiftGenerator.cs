...
namespace ServiceStack.NativeTypes.Swift
{
    public class SwiftGenerator
    {
        ...
        private List<string> conflictTypeNames = new();
        ...
        public string GetCode(MetadataTypes metadata, IRequest request)
        {
            ...
            var sbExt = new StringBuilderWrapper(new());
            ...
            CreateTypeOptions options)
        {
            ...
            var hasGenericBaseType = type.Inherits?.GenericArgs.IsEmpty() == false;
...
#pragma warning restore 618
    ...
    public static class SwiftGeneratorExtensions
    {
        ...
        public static HashSet<string> SwiftKeyWords = new()
        {
            "class",
            "deinit",
            "enum",
