...
{
    public class IndexOperationsControl : Control
    {
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            var pluginLinks = metadata?.PluginLinks.Count > 0
                ? new ListTemplate
                {
            ...
            var debugOnlyInfo = HostContext.DebugMode && metadata?.DebugLinks.Count > 0
                ? new ListTemplate
                {
