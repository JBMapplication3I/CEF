...
{xml}
        ...
        protected override void RenderOperation(System.Web.UI.HtmlTextWriter writer, IRequest httpReq, string operationName, string requestMessage, string responseMessage, string metadataHtml, Host.Operation operation)
        {
            ...
            {
                operationControl.ContentType = ContentType;
            }
            if (!ContentFormat.IsNullOrEmpty())
            {
                operationControl.ContentFormat = ContentFormat;
            }
