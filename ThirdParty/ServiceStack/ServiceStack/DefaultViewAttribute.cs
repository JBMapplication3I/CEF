...
namespace ServiceStack
{
    ...
    public class DefaultViewAttribute : RequestFilterAttribute
    {
        ...
        public override void Execute(IRequest req, IResponse res, object requestDto)
        {
            ...
            {
                if (!req.Items.TryGetValue("View", out var currentView) || string.IsNullOrEmpty(currentView as string))
                {
                    req.Items["View"] = View;
                }
            }
            ...
            {
                if (!req.Items.TryGetValue("Template", out var currentTemplate) || string.IsNullOrEmpty(currentTemplate as string))
                {
