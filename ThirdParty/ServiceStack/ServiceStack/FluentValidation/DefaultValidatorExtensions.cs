...
namespace ServiceStack.FluentValidation
{
    ...
    public static class DefaultValidatorExtensions
    {
        ...
        public static ValidationResult Validate<T>(this IValidator<T> validator, T instance, params Expression<Func<T, object>>[] propertyExpressions)
        {
            ...
            var context = new ValidationContext<T>(instance, new(), selector);
        ...
        {
            var context = new ValidationContext<T>(instance, new(), ValidatorOptions.ValidatorSelectors.MemberNameValidatorSelectorFactory(properties));
            return validator.Validate(context);
        }
