...
namespace ServiceStack.FluentValidation.Validators
{
    ...
    public class ChildCollectionValidatorAdaptor : NoopPropertyValidator
    {
        ...
        private readonly Func<object, IValidator> childValidatorProvider;
        private readonly Type childValidatorType;
        ...
        {
            childValidatorProvider = _ => childValidator;
        ...
        {
            if (context.PropertyValue is not IEnumerable collection)
            {
                return emptyResult;
            }
