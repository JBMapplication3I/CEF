...
namespace ServiceStack.FluentValidation
{
	...
	public class ValidationContext<T> : ValidationContext
    {
        ...
        public ValidationContext(T instanceToValidate) : this(instanceToValidate, new(), ValidatorOptions.ValidatorSelectors.DefaultValidatorSelectorFactory())
        {
    ...
    public class ValidationContext
    {
        ...
        public Dictionary<string, object> RootContextData { get; internal set; } = new();
        ...
        public ValidationContext(object instanceToValidate)
         : this(instanceToValidate, new(), ValidatorOptions.ValidatorSelectors.DefaultValidatorSelectorFactory())
        {
        ...
        {
            return new(instanceToValidate ?? InstanceToValidate, chain ?? PropertyChain, selector ?? Selector)
            {
        ...
        {
            return new(instanceToValidate, PropertyChain, Selector)
            {
                IsChildContext = true,
                RootContextData = RootContextData,
                Request = Request
