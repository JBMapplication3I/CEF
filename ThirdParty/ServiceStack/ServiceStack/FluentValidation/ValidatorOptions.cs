...
namespace ServiceStack.FluentValidation
{
    ...
    public static class ValidatorOptions
    {
        ...
        private static ValidatorSelectorOptions validatorSelectorOptions = new();
        /// <summary>
        /// Customizations of validator selector
        /// </summary>
        public static ValidatorSelectorOptions ValidatorSelectors => validatorSelectorOptions;
    ...
    public class ValidatorSelectorOptions
    {
        ...
        {
            get => memberNameValidatorSelector;
