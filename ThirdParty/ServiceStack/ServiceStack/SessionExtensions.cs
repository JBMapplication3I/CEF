...
namespace ServiceStack
{
    ...
    public static class SessionExtensions
    {
        ...
        private static readonly RandomNumberGenerator randgen = RandomNumberGenerator.Create();

        [ThreadStatic] private static byte[] SessionBytesCache;
        ...
        {
            if (response is not IHttpResponse httpRes)
            {
                return;
            }
