...
namespace ServiceStack
{
        ...
        : AppHostHttpListenerBase
    {
        ...
        private readonly AutoResetEvent listenForNextRequest = new(false);
        ...
        {
            get => threadPoolManager.MinThreads;
            set => threadPoolManager.MinThreads = value;
        }

        public int MaxThreads
        {
            get => threadPoolManager.MaxThreads;
        ...
        private bool IsListening => IsStarted && Listener?.IsListening == true;
        ...
        private void ListenerCallback(IAsyncResult asyncResult)
        {
            ...
            if (asyncResult.AsyncState is not HttpListener listener)
            {
                return;
            }
