...
namespace ServiceStack
{
    ...
    public abstract partial class ServiceStackHost
    {
        ...
        /// <summary>Apply PreRequest Filters for participating Custom Handlers, e.g. RazorFormat, MarkdownFormat, etc.</summary>
        ...
        /// <summary>Apply PreAuthenticate Filters from IAuthWithRequest AuthProviders.</summary>
        /// <param name="httpReq">The HTTP request.</param>
        /// <param name="httpRes">The HTTP resource.</param>
        ...
        /// <summary>Applies the raw request filters. Returns whether or not the request has been handled and no more
        /// processing should be done.</summary>
        /// <param name="httpReq">The HTTP request.</param>
        /// <param name="httpRes">The HTTP resource.</param>
        /// <returns>True if it succeeds, false if it fails.</returns>
        ...
        /// <summary>Applies the request filters. Returns whether or not the request has been handled and no more
        /// processing should be done.</summary>
        ...
        public static Task IterateAsyncFilters(
            IEnumerable<Func<IRequest, IResponse, object, Task>> asyncIterator,
            IRequest req,
            IResponse res,
            object dto)
        {
            ...
            void RecursiveBody(Task t)
            {
                try
                {
                    ...
                    {
                        enumerator.Current(req, res, dto).ContinueWith(RecursiveBody, TaskContinuationOptions.ExecuteSynchronously);
                    }
                    else
                    {
                        tcs.TrySetResult(null);
        ...
        /// <summary>Applies the response filters. Returns whether or not the request has been handled and no more
        /// processing should be done.</summary>
        /// <param name="req">     The request.</param>
        /// <param name="res">     The resource.</param>
        ...
        public virtual void ExecTypedFilters(
            Dictionary<Type, ITypedFilter> typedFilters,
            IRequest req,
            IResponse res,
            object dto)
        {
            if (typedFilters.Count == 0)
            {
                return;
            }
        ...
        {
            return Config?.ReturnsInnerException == true && ex.InnerException != null && ex is not IHttpError
                ? ex.InnerException
                : ex;
        }
        ...
        public virtual void OnExceptionTypeFilter(Exception ex, ResponseStatus responseStatus)
        {
            ...
            if (argEx != null && !isValidationSummaryEx && argEx.ParamName != null)
            {
                ...
                var errorMsg = paramMsgIndex > 0
                    ...
                    : argEx.Message;
                responseStatus.Errors ??= new();
                responseStatus.Errors.Add(new()
                {
            ...
            if (serializationEx?.Data["errors"] is not List<RequestBindingError> errors)
            {
                return;
            }
            responseStatus.Errors ??= new();
        ...
        /// <summary>Inspect or modify ever new UserSession created or resolved from cache. return null if Session is
        /// invalid to create new Session.</summary>
        /// <param name="session">      The session.</param>
        /// <param name="withSessionId">Identifier for the with session.</param>
        /// <returns>An IAuthSession.</returns>
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public virtual bool ExportSoapType(Type type)
        {
            return !type.IsGenericTypeDefinition()
                && !type.AllAttributes<ExcludeAttribute>().Any(attr => attr.Feature.Has(Feature.Soap));
        }

        /// <summary>Gets IDbConnection Checks if DbInfo is seat in RequestContext. See multi-tenancy:
        /// https://github.com/ServiceStack/ServiceStack/wiki/Multitenancy Called by itself, <see cref="Service"></see>
        /// and <see cref="ServiceStack.Razor.ViewPageBase"></see></summary>
        ...
        /// <summary>Resolves <see cref="IRedisClient"></see> based on
        /// <see cref="IRedisClientsManager"></see>.GetClient();
        /// Called by itself, <see cref="Service"></see> and <see cref="ServiceStack.Razor.ViewPageBase"></see></summary>
        ...
        /// <summary>Tries to resolve <see cref="IRedisClient"></see> through Ioc container. If not registered, it falls
        /// back to <see cref="IRedisClientsManager"></see>.GetClient();
        /// Called by itself, <see cref="Service"></see> and <see cref="ServiceStack.Razor.ViewPageBase"></see></summary>
        /// <param name="req">Provided by services and pageView, can be helpful when overriding this method.</param>
        ...
        /// <summary>Returns <see cref="MemoryCacheClient"></see>. cache is only persisted for this running app instance.
        /// Called by <see cref="Service"></see>.MemoryCacheClient.</summary>
        /// <param name="req">Provided by services and pageView, can be helpful when overriding this method.</param>
        ...
        /// <summary>Returns <see cref="IMessageProducer"></see> from the IOC container. Called by itself,
        /// <see cref="Service"></see> and <see cref="ServiceStack.Razor.ViewPageBase"></see></summary>
