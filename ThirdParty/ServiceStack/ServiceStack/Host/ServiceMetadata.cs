...
namespace ServiceStack.Host
{
    public class ServiceMetadata
    {
        public ServiceMetadata(List<RestPath> restPaths)
        {
            ...
            ResponseTypes = new();
            OperationsMap = new();
            OperationsResponseMap = new();
            OperationNamesMap = new();
        }
        ...
        public void Add(Type serviceType, Type requestType, Type responseType)
        {
            ...
            OperationNamesMap[operation.Name.ToLowerInvariant()] = operation;
        ...
        private readonly HashSet<Assembly> excludeAssemblies = new()
        {
        ...
        private bool IsDtoType(Type type) => type?.Namespace?.StartsWith("System") == false &&
        ...
        private static MetadataType FindMetadataType(MetadataTypes metadataTypes, string name, string @namespace = null)
        {
            if (@namespace?.StartsWith("System") == true 
    ...
    public static class MetadataTypeExtensions
    {
        ...
        public static HashSet<string> CollectionTypes = new()
        {
            "List`1",
            "HashSet`1",
            "Dictionary`2",
