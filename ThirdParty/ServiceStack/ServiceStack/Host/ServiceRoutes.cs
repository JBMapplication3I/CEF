...
namespace ServiceStack.Host
{
    public class ServiceRoutes : IServiceRoutes
    {
        ...
        {
            if (HasExistingRoute(typeof(TRequest), restPath))
            {
                return this;
            }

            appHost.RestPaths.Add(new(typeof(TRequest), restPath));
            return this;
        }
        ...
        public IServiceRoutes Add<TRequest>(string restPath, string verbs)
        {
            ...
            appHost.RestPaths.Add(new(typeof(TRequest), restPath, verbs));
            return this;
        }

        public IServiceRoutes Add(Type requestType, string restPath, string verbs)
        {
            if (HasExistingRoute(requestType, restPath))
            {
                return this;
            }

            appHost.RestPaths.Add(new(requestType, restPath, verbs));
            return this;
        }
        ...
        public IServiceRoutes Add(Type requestType, string restPath, string verbs, string summary, string notes)
        {
            ...
            appHost.RestPaths.Add(new(requestType, restPath, verbs, summary, notes));
            return this;
        }
