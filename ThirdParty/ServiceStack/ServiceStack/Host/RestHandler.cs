namespace ServiceStack.Host
{
    ...
    public class RestHandler : ServiceStackHandlerBase
    {
        public RestHandler()
        {
            HandlerAttributes = RequestAttributes.Reply;
        }
        ...
        public IRestPath GetRestPath(string httpMethod, string pathInfo)
        {
            ...
            RestPath = FindMatchingRestPath(httpMethod, pathInfo, out var contentType);
            if (contentType != null)
            {
        ...
        public static object CreateRequest(IRequest httpReq, IRestPath restPath)
        {
            using (Profiler.Current.Step("Deserialize Request"))
            {
                ...
                return HostContext.AppHost.ApplyRequestConverters(
                    httpReq,
        ...
        /// <summary>Used in Unit tests.</summary>
        ...
        public override object CreateRequest(IRequest httpReq, string operationName)
        {
            ...
            return CreateRequest(httpReq, RestPath);
        }
    }
}
