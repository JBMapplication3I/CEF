...
namespace ServiceStack.Host.Handlers
{
    public class GenericHandler : ServiceStackHandlerBase
    {
        ...
        {
            HandlerContentType = contentType;
            ContentTypeAttribute = ContentFormat.GetEndpointAttributes(contentType);
        ...
        public override Task ProcessRequestAsync(IRequest httpReq, IResponse httpRes, string operationName)
        {
            try
            {
                ...
                httpReq.ResponseContentType = httpReq.GetQueryStringContentType() ?? HandlerContentType;
