...
namespace ServiceStack.Host.Handlers
{
    public abstract class SoapHandler : ServiceStackHandlerBase, IOneWay, ISyncReply
    {
        ...
        {
            var endpointAttributes = RequestAttributes.OneWay | HandlerAttributes;
        ...
        {
            var endpointAttributes = RequestAttributes.Reply | HandlerAttributes;
        ...
        {
            var useXmlSerializerResponse = response?.GetType().HasAttribute<XmlSerializerFormatAttribute>() == true;
        ...
        public string GetSoapContentType(string contentType)
        {
            ...
            return requestOperationName != null
                    ...
                    : HandlerAttributes == RequestAttributes.Soap11 ? MimeTypes.Soap11 : MimeTypes.Soap12;
        }
