...
namespace ServiceStack.Testing
{
    public class MockHttpRequest : IHttpRequest, IHasResolver, IHasVirtualFiles
    {
            ...
            : this()
        {
            ...
            QueryString = queryString.InWrapper();
            FormData = formData.InWrapper();
        }
        ...
        {
            get => responseContentType ?? ContentType ?? MimeTypes.Json;
        ...
        public string AbsoluteUri => "http://localhost" + PathInfo;
        ...
        public void AddSessionCookies()
        {
            ...
            Cookies[SessionFeature.PermanentSessionId] = new(SessionFeature.PermanentSessionId, permSessionId);
            var sessionId = Convert.ToBase64String(Guid.NewGuid().ToByteArray());
            Cookies[SessionFeature.SessionId] = new(SessionFeature.SessionId, sessionId);
        }
