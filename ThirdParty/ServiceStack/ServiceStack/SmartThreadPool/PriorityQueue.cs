...
namespace Amib.Threading.Internal
{
    ...
    public sealed class PriorityQueue : IEnumerable
    {
        ...
        public void Enqueue(IHasWorkItemPriority workItem)
        {
            ...
            var queueIndex = _queuesCount - (int)workItem.WorkItemPriority - 1;
        ...
        public IHasWorkItemPriority Dequeue()
        {
            ...
            {
                var queueIndex = GetNextNonEmptyQueue(-1);
                Debug.Assert(queueIndex >= 0);
        ...
        {
            for (var i = queueIndex + 1; i < _queuesCount; ++i)
            {
        ...
        /// </summary>
        public int Count => _workItemsCount;
