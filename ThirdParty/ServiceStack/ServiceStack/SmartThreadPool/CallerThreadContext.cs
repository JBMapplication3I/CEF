...
namespace Amib.Threading.Internal
{
    ...
    internal class CallerThreadContext
    {
        ...
        {
            var fi = typeof(HttpContext).GetField("CallContextSlotName", BindingFlags.Static | BindingFlags.NonPublic);
        ...
        public bool CapturedCallContext => null != _callContext;

        public bool CapturedHttpContext => null != _httpContext;
        ...
        public static void Apply(CallerThreadContext callerThreadContext)
        {
            ...
            {
                throw new ArgumentNullException(nameof(callerThreadContext));
            }
