...
namespace Amib.Threading.Internal
{
    ...
    public partial class WorkItem : IHasWorkItemPriority
    {
        ...
        internal void Initialize()
        {
            ...
            _waitingOnQueueStopwatch = new();
            _processingStopwatch = new();
            _expirationTime =
        ...
        private void ExecuteWorkItem()
        {
            ...
            try
            {
                ...
                var executionThread = Interlocked.CompareExchange(ref _executingThread, null, _executingThread);
            ...
            WaitHandle cancelWaitHandle)
        {
            ...
            else
            {
                ...
                for (var i = 0; i < waitableResults.Length; ++i)
                {
                    ...
                    whs[0] = waitHandles[i];
                    var result = STPEventWaitHandle.WaitAny(whs, millisecondsLeft, exitContext);
            ...
            WaitHandle cancelWaitHandle)
        {
            ...
            var result = STPEventWaitHandle.WaitAny(waitHandles, millisecondsTimeout, exitContext);
        ...
        private object GetResult(
            ...
            WaitHandle cancelWaitHandle)
        {
            var result = GetResult(millisecondsTimeout, exitContext, cancelWaitHandle, out var e);
            if (null != e)
            {
            ...
            out Exception e)
        {
            ...
            if (null == cancelWaitHandle)
            {
                var wh = GetWaitHandle();

                var timeout = !STPEventWaitHandle.WaitOne(wh, millisecondsTimeout, exitContext);
            ...
            {
                var wh = GetWaitHandle();
                var result = STPEventWaitHandle.WaitAny(new WaitHandle[] { wh, cancelWaitHandle });
                ReleaseWaitHandle();
