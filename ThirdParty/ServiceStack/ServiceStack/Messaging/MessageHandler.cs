...
namespace ServiceStack.Messaging
{
        ...
        : IMessageHandler, IDisposable
    {
            ...
            int retryCount)
        {
            ...
            ReplyClientFactory = ClientFactory.Create;
            ProcessQueueNames = new[] { QueueNames<T>.Priority, QueueNames<T>.In };
        }
        ...
        private void DefaultInExceptionHandler(IMessageHandler mqHandler, IMessage<T> message, Exception ex)
        {
            ...
            var requeue = ex is not UnRetryableMessagingException
