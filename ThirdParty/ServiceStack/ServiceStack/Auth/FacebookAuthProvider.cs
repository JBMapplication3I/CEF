...
namespace ServiceStack.Auth
{
    ...
    public class FacebookAuthProvider : OAuthProvider
    {
        ...
        {
            AppId = appSettings.GetString("oauth.facebook.AppId");
            AppSecret = appSettings.GetString("oauth.facebook.AppSecret");
            Permissions = appSettings.Get("oauth.facebook.Permissions", TypeConstants.EmptyStringArray);
            Fields = appSettings.Get("oauth.facebook.Fields", DefaultFields);
        }
        ...
        public override object Authenticate(IServiceBase authService, IAuthSession session, Authenticate request)
        {
            ...
            {
                var preAuthUrl = $"{PreAuthUrl}?client_id={AppId}&redirect_uri={CallbackUrl.UrlEncode()}&scope={string.Join(",", Permissions)}";
            ...
            try
            {
                var accessTokenUrl = $"{AccessTokenUrl}?client_id={AppId}&redirect_uri={CallbackUrl.UrlEncode()}&client_secret={AppSecret}&code={code}";
