    ...
    public class AuthenticateService : Service
    {
        ...
        public object Post(Authenticate request)
        {
            ...
            if (authProvider is IAuthWithRequest authWithRequest && !Request.IsInProcessRequest())
            {
                ...
                new AuthenticateAttribute().Execute(Request, base.Response, request);
        ...
        public AuthenticateResponse Authenticate(Authenticate request)
        {
            ...
            try
            {
                ...
                var result = Authenticate(request, provider, GetSession(), oAuthConfig);
        ...
        private object Authenticate(Authenticate request, string provider, IAuthSession session, IAuthProvider oAuthConfig)
        {
            ...
            var generateNewCookies = authFeature?.GenerateNewSessionCookiesOnAuthentication != false;
