...
namespace ServiceStack.Auth
{
    ...
    public class TwitterAuthProvider : OAuthProvider
    {
        ...
        {
            AuthorizeUrl = appSettings.Get("oauth.twitter.AuthorizeUrl", Realm + "oauth/authenticate");
        }
        ...
        public override object Authenticate(IServiceBase authService, IAuthSession session, Authenticate request)
        {
            ...
            {
                throw new("oauth.twitter.ConsumerKey is required");
            }

            if (string.IsNullOrEmpty(ConsumerSecret))
            {
                throw new("oauth.twitter.ConsumerSecret is required");
            }
            ...
            if (request.AccessToken != null && request.AccessTokenSecret != null)
            {
                ...
                var failedResult = OnAuthenticated(authService, session, tokens, new());
            ...
            if (OAuthUtils.AcquireRequestToken())
            {
                ...
                return authService.Redirect(AccessTokenUrlFilter(this, AuthorizeUrl
