...
namespace ServiceStack.Auth
{
    ...
    public class JwtAuthProviderReader : AuthProvider, IAuthWithRequest, IAuthPlugin
    {
        ...
        public static HashSet<string> IgnoreForOperationTypes = new()
        {
        ...
        public virtual void Init(IAppSettings appSettings = null)
        {
            ...
            FallbackAuthKeys = new();
            FallbackPublicKeys = new();
        ...
        {
            if (AuthenticateService.GetAuthProvider(Name) is not JwtAuthProviderReader jwtProvider)
            {
                throw new("JwtAuthProvider or JwtAuthProviderReader is not registered");
            }
        ...
        private static int? GetUnixTime(Dictionary<string, string> jwtPayload, string key)
        {
