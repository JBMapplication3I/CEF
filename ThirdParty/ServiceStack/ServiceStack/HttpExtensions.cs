namespace ServiceStack
{
    ...
    {
        public static string ToAbsoluteUri(
            this IReturn requestDto,
        ...
        /// <summary>End a ServiceStack Request.</summary>
        ...
        /// <param name="skipHeaders">      True to skip headers.</param>
        /// <param name="skipClose">        True to skip close.</param>
        /// <param name="closeOutputStream">True to close output stream.</param>
        /// <param name="afterHeaders">     The after headers.</param>
        public static void EndHttpHandlerRequest(
            this HttpContextBase context,
            bool skipHeaders = false,
            bool skipClose = false,
            bool closeOutputStream = false,
            Action<HttpResponseBase> afterHeaders = null)
        {
        ...
        public static void EndHttpHandlerRequest(
            ...
            bool skipHeaders = false,
            bool skipClose = false,
            Action<IResponse> afterHeaders = null)
        {
            if (!skipHeaders)
            {
                httpRes.ApplyGlobalResponseHeaders();
            ...
            if (req?.Items.ContainsKey(Keywords.HasLogged) == false)
            {
        ...
        public static async Task EndHttpHandlerRequestAsync(
            ...
            bool skipHeaders = false,
            bool skipClose = false,
            Func<IResponse, Task> afterHeaders = null)
        {
            if (!skipHeaders)
            {
                httpRes.ApplyGlobalResponseHeaders();
        ...
        /// <summary>End an MQ Request.</summary>
        /// <param name="httpRes">  The httpRes to act on.</param>
        /// <param name="skipClose">True to skip close.</param>
        ...
        /// <summary>End a ServiceStack Request with no content.</summary>
        /// <param name="httpRes">The httpRes to act on.</param>
