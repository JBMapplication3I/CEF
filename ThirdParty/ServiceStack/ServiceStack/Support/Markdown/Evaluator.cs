...
namespace ServiceStack.Support.Markdown
{
    public class EvaluatorExecutionContext
    {
        ...
        {
            Items = new();
            TypeProperties = new Dictionary<string, Type>();
        }
        ...
        {
            return new(Items, BaseType, GenericArgs, TypeProperties);
        }
    }
    ...
    public class Evaluator
    {
        ...
        private const string StaticMethodName = "__tmp";
#if !NETSTANDARD1_6
        private Assembly compiledAssembly;
#endif
        private Type compiledType = null;
        private object compiled = null;
        private EmptyCtorDelegate compiledTypeCtorFn;
...
//			typeof(XmlDocument).GetAssembly(),  //"system.xml.dll",
        ...
        public static readonly List<string> AssemblyNames = new()
        {
            "System",
            "System.Text",
//            "System.Xml",
        ...
        public static readonly Dictionary<string, string> NamespaceAssemblies = new();
        ...
        {
            BaseType = baseType;
            GenericArgs = genericArgs ?? TypeConstants.EmptyTypeArray;
...
");
            ...
            if (BaseType != null)
            {
                code.Append("   : " + GetTypeName(BaseType));
                ...
                ReferenceTypesIfNotExist(cp, Assemblies, BaseType);
            }
            ...
            if (compilerResults.Errors.HasErrors)
            {
                ...
                throw new("Error Compiling Expression: " + StringBuilderCache.ReturnAndFree(error));
            }
