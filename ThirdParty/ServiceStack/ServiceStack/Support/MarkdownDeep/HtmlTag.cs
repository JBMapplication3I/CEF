...
namespace MarkdownDeep
{
    ...
    public class HtmlTag
    {
        ...
        private Dictionary<string, string> m_attributes = new(StringComparer.CurrentCultureIgnoreCase);
        private bool m_closed;
        private bool m_closing;
        private HtmlTagFlags m_flags = 0;
        ...
        public bool IsSafe()
        {
            ...
            if (!m_allowed_attributes.TryGetValue(name_lower, out var allowed_attributes))
            {
            ...
            if (m_attributes.TryGetValue("href", out var href))
            {
            ...
            if (m_attributes.TryGetValue("src", out var src))
            {
