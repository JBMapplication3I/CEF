namespace CatalogComponents
{
    ...
    public class Tc33070 : UITestsBase
    {
        ...
        public void StartTest()
        {
            ...
            clarityCatalog.SelectSortBy_changeToPriceAscending();

            //STEP 3:
            clarityCatalog.WaitUntilJsReady();
            clarityCatalog.SelectSortBy_changeToNameAscending();

            Assert.IsTrue(clarityCatalog.CheckIfProductTitleAsSortNameAscending());
        }
    }
}
