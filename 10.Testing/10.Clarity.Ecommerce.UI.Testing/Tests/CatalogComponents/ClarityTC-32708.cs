namespace CatalogComponents
{
    ...
    public class Tc32708 : UITestsBase
    {
        ...
        public void StartTest()
        {
            ...
            clarityIndex.ProductsMegaMenu_LeftSide_Item_Click(variables.Tc32708DropdownOption);
            clarityIndex.ProductsMegaMenu_RightSide_SeeAllButton_Click(variables.Tc32708DropdownOptionSeeAll);
            ...
            clarityBookCatalog.filterPricesRangeOption_click(1);
            clarityBookCatalog.filterPricesRangeRemove_click(1);
            clarityBookCatalog.filterBookRemove_click();

            Assert.IsTrue(clarityBookCatalog.CheckIfCatalogInLevel1());
        }
    }
}
