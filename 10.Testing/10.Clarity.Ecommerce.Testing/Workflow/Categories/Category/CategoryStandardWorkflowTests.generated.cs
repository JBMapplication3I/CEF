// <autogenerated>
// <copyright file="Categories.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Categories_Categories_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            CategoryWorkflow>
    {
        protected Categories_Categories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCategoryTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoCategoryFileTable = true,
                DoCategoryImageTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Category>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Categories;
        }

        /// <inheritdoc/>
        protected override List<Mock<Category>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCategories;
        }

        /// <inheritdoc/>
        protected override async Task<CategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CategoryModel
            {
                ...
                TypeID = mockingSetup.RawCategoryTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Categories.Categories.Standard")]
    public partial class Categories_Categories_StandardWorkflowTests : Categories_Categories_WorkflowTestsBase
    {
        public Categories_Categories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
