...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Categories_CategoryImages_WorkflowTestsBase
        : AbstractNameableBase<
            ICategoryImage,
            CategoryImage,
            ICategoryImageModel,
            CategoryImageModel,
            ICategoryImageSearchModel,
            CategoryImageSearchModel,
            CategoryImageWorkflow>
    {
        protected Categories_CategoryImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCategoryImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoCategoryImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CategoryImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CategoryImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<CategoryImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCategoryImages;
        }

        /// <inheritdoc/>
        protected override async Task<CategoryImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CategoryImageModel
            {
                ...
                TypeID = mockingSetup.RawCategoryImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Categories.CategoryImages.Standard")]
    public partial class Categories_CategoryImages_StandardWorkflowTests : Categories_CategoryImages_WorkflowTestsBase
    {
        public Categories_CategoryImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
