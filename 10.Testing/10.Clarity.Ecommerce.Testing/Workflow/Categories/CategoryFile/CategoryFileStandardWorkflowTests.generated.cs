...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Categories_CategoryFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            CategoryFileSearchModel,
            CategoryFileWorkflow>
    {
        protected Categories_CategoryFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCategoryFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CategoryFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CategoryFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<CategoryFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCategoryFiles;
        }

        /// <inheritdoc/>
        protected override async Task<CategoryFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CategoryFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Categories.CategoryFiles.Standard")]
    public partial class Categories_CategoryFiles_StandardWorkflowTests : Categories_CategoryFiles_WorkflowTestsBase
    {
        public Categories_CategoryFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
