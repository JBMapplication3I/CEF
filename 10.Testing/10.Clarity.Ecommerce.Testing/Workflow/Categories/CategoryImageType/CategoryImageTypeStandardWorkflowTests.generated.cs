...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Categories_CategoryImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICategoryImageType,
            CategoryImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CategoryImageTypeWorkflow>
    {
        protected Categories_CategoryImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCategoryImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CategoryImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CategoryImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CategoryImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCategoryImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Categories.CategoryImageTypes.Standard")]
    public partial class Categories_CategoryImageTypes_StandardWorkflowTests : Categories_CategoryImageTypes_WorkflowTestsBase
    {
        public Categories_CategoryImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
