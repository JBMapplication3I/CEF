...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Categories_CategoryTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICategoryType,
            CategoryType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CategoryTypeWorkflow>
    {
        protected Categories_CategoryTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCategoryTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CategoryType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CategoryTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CategoryType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCategoryTypes;
        }
    ...
    [Trait("Category", "Workflows.Categories.CategoryTypes.Standard")]
    public partial class Categories_CategoryTypes_StandardWorkflowTests : Categories_CategoryTypes_WorkflowTestsBase
    {
        public Categories_CategoryTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
