...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Reviews_ReviewTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IReviewType,
            ReviewType,
            ITypeModel,
            ...
            ReviewTypeWorkflow>
    {
        protected Reviews_ReviewTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoReviewTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ReviewType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ReviewTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ReviewType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawReviewTypes;
        }
    ...
    [Trait("Category", "Workflows.Reviews.ReviewTypes.Standard")]
    public partial class Reviews_ReviewTypes_StandardWorkflowTests : Reviews_ReviewTypes_WorkflowTestsBase
    {
        public Reviews_ReviewTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
