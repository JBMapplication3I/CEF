...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Attributes_GeneralAttributes_WorkflowTestsBase
        : AbstractTypableBase<
            IGeneralAttribute,
            GeneralAttribute,
            IGeneralAttributeModel,
            GeneralAttributeModel,
            IGeneralAttributeSearchModel,
            GeneralAttributeSearchModel,
            GeneralAttributeWorkflow>
    {
        protected Attributes_GeneralAttributes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoGeneralAttributeTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAttributeGroupTable = true,
                DoAttributeTabTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<GeneralAttribute>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.GeneralAttributes;
        }

        /// <inheritdoc/>
        protected override List<Mock<GeneralAttribute>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawGeneralAttributes;
        }

        /// <inheritdoc/>
        protected override async Task<GeneralAttributeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new GeneralAttributeModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawAttributeTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Attributes.GeneralAttributes.Standard")]
    public partial class Attributes_GeneralAttributes_StandardWorkflowTests : Attributes_GeneralAttributes_WorkflowTestsBase
    {
        public Attributes_GeneralAttributes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
