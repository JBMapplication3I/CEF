// <autogenerated>
// <copyright file="Attributes.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Attributes_GeneralAttributePredefinedOptions_WorkflowTestsBase
        : AbstractBase<
            IGeneralAttributePredefinedOption,
            GeneralAttributePredefinedOption,
            IGeneralAttributePredefinedOptionModel,
            GeneralAttributePredefinedOptionModel,
            IGeneralAttributePredefinedOptionSearchModel,
            GeneralAttributePredefinedOptionSearchModel,
            GeneralAttributePredefinedOptionWorkflow>
    {
        protected Attributes_GeneralAttributePredefinedOptions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoGeneralAttributePredefinedOptionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoGeneralAttributePredefinedOptionTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<GeneralAttributePredefinedOption>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.GeneralAttributePredefinedOptions;
        }

        /// <inheritdoc/>
        protected override List<Mock<GeneralAttributePredefinedOption>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawGeneralAttributePredefinedOptions;
        }

        /// <inheritdoc/>
        protected override async Task<GeneralAttributePredefinedOptionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new GeneralAttributePredefinedOptionModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                AttributeID = mockingSetup.RawGeneralAttributes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Attributes.GeneralAttributePredefinedOptions.Standard")]
    public partial class Attributes_GeneralAttributePredefinedOptions_StandardWorkflowTests : Attributes_GeneralAttributePredefinedOptions_WorkflowTestsBase
    {
        public Attributes_GeneralAttributePredefinedOptions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
