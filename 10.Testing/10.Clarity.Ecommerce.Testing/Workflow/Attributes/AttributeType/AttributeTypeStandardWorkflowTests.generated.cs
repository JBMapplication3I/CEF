...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Attributes_AttributeTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAttributeType,
            AttributeType,
            IAttributeTypeModel,
            AttributeTypeModel,
            IAttributeTypeSearchModel,
            AttributeTypeSearchModel,
            AttributeTypeWorkflow>
    {
        protected Attributes_AttributeTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAttributeTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AttributeType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AttributeTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AttributeType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAttributeTypes;
        }

        /// <inheritdoc/>
        protected override async Task<AttributeTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Attributes.AttributeTypes.Standard")]
    public partial class Attributes_AttributeTypes_StandardWorkflowTests : Attributes_AttributeTypes_WorkflowTestsBase
    {
        public Attributes_AttributeTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
