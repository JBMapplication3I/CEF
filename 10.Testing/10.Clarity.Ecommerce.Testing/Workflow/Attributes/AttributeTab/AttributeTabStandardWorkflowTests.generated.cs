...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Attributes_AttributeTabs_WorkflowTestsBase
        : AbstractTypableBase<
            IAttributeTab,
            AttributeTab,
            IAttributeTabModel,
            ...
            AttributeTabWorkflow>
    {
        protected Attributes_AttributeTabs_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAttributeTabTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AttributeTab>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AttributeTabs;
        }

        /// <inheritdoc/>
        protected override List<Mock<AttributeTab>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAttributeTabs;
        }

        /// <inheritdoc/>
        protected override async Task<AttributeTabModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AttributeTabModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Attributes.AttributeTabs.Standard")]
    public partial class Attributes_AttributeTabs_StandardWorkflowTests : Attributes_AttributeTabs_WorkflowTestsBase
    {
        public Attributes_AttributeTabs_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
