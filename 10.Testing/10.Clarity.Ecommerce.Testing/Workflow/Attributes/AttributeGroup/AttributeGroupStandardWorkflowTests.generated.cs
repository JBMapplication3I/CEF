...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Attributes_AttributeGroups_WorkflowTestsBase
        : AbstractTypableBase<
            IAttributeGroup,
            AttributeGroup,
            IAttributeGroupModel,
            AttributeGroupModel,
            IAttributeGroupSearchModel,
            AttributeGroupSearchModel,
            AttributeGroupWorkflow>
    {
        protected Attributes_AttributeGroups_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAttributeGroupTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AttributeGroup>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AttributeGroups;
        }

        /// <inheritdoc/>
        protected override List<Mock<AttributeGroup>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAttributeGroups;
        }

        /// <inheritdoc/>
        protected override async Task<AttributeGroupModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Attributes.AttributeGroups.Standard")]
    public partial class Attributes_AttributeGroups_StandardWorkflowTests : Attributes_AttributeGroups_WorkflowTestsBase
    {
        public Attributes_AttributeGroups_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
