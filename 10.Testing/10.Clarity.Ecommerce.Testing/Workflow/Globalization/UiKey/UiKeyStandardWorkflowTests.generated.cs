...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Globalization_UiKeys_WorkflowTestsBase
        : AbstractBase<
            IUiKey,
            UiKey,
            IUiKeyModel,
            ...
            UiKeyWorkflow>
    {
        protected Globalization_UiKeys_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUiKeyTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<UiKey>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UiKeys;
        }

        /// <inheritdoc/>
        protected override List<Mock<UiKey>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUiKeys;
        }

        /// <inheritdoc/>
        protected override async Task<UiKeyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new UiKeyModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Globalization.UiKeys.Standard")]
    public partial class Globalization_UiKeys_StandardWorkflowTests : Globalization_UiKeys_WorkflowTestsBase
    {
        public Globalization_UiKeys_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
