...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Globalization_UiTranslations_WorkflowTestsBase
        : AbstractBase<
            IUiTranslation,
            UiTranslation,
            IUiTranslationModel,
            ...
            UiTranslationWorkflow>
    {
        protected Globalization_UiTranslations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUiTranslationTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoUiKeyTable = true,
                DoUiTranslationTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<UiTranslation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UiTranslations;
        }

        /// <inheritdoc/>
        protected override List<Mock<UiTranslation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUiTranslations;
        }

        /// <inheritdoc/>
        protected override async Task<UiTranslationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new UiTranslationModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                UiKeyID = mockingSetup.RawUiKeys.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Globalization.UiTranslations.Standard")]
    public partial class Globalization_UiTranslations_StandardWorkflowTests : Globalization_UiTranslations_WorkflowTestsBase
    {
        public Globalization_UiTranslations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
