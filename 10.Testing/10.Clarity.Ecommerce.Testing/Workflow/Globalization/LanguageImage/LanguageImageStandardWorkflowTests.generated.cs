// <autogenerated>
// <copyright file="Globalization.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Globalization_LanguageImages_WorkflowTestsBase
        : AbstractNameableBase<
            ILanguageImage,
            LanguageImage,
            ILanguageImageModel,
            LanguageImageModel,
            ILanguageImageSearchModel,
            LanguageImageSearchModel,
            LanguageImageWorkflow>
    {
        protected Globalization_LanguageImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoLanguageImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoLanguageImageTable = true,
                DoLanguageImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<LanguageImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.LanguageImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<LanguageImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawLanguageImages;
        }

        /// <inheritdoc/>
        protected override async Task<LanguageImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new LanguageImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawLanguageImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Globalization.LanguageImages.Standard")]
    public partial class Globalization_LanguageImages_StandardWorkflowTests : Globalization_LanguageImages_WorkflowTestsBase
    {
        public Globalization_LanguageImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
