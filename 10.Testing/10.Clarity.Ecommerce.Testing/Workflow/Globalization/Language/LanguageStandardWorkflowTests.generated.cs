...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Globalization_Languages_WorkflowTestsBase
        : AbstractBase<
            ILanguage,
            Language,
            ILanguageModel,
            ...
            LanguageWorkflow>
    {
        protected Globalization_Languages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoLanguageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Language>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Languages;
        }

        /// <inheritdoc/>
        protected override List<Mock<Language>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawLanguages;
        }

        /// <inheritdoc/>
        protected override async Task<LanguageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Globalization.Languages.Standard")]
    public partial class Globalization_Languages_StandardWorkflowTests : Globalization_Languages_WorkflowTestsBase
    {
        public Globalization_Languages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
