...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Globalization_LanguageImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ILanguageImageType,
            LanguageImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            LanguageImageTypeWorkflow>
    {
        protected Globalization_LanguageImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoLanguageImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<LanguageImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.LanguageImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<LanguageImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawLanguageImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Globalization.LanguageImageTypes.Standard")]
    public partial class Globalization_LanguageImageTypes_StandardWorkflowTests : Globalization_LanguageImageTypes_WorkflowTestsBase
    {
        public Globalization_LanguageImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
