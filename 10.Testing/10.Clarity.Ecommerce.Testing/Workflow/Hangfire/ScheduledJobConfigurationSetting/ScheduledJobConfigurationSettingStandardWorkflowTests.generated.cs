// <autogenerated>
// <copyright file="Hangfire.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Hangfire_ScheduledJobConfigurationSettings_WorkflowTestsBase
        : AbstractBase<
            IScheduledJobConfigurationSetting,
            ScheduledJobConfigurationSetting,
            IScheduledJobConfigurationSettingModel,
            ScheduledJobConfigurationSettingModel,
            IScheduledJobConfigurationSettingSearchModel,
            ScheduledJobConfigurationSettingSearchModel,
            ScheduledJobConfigurationSettingWorkflow>
    {
        protected Hangfire_ScheduledJobConfigurationSettings_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoScheduledJobConfigurationSettingTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoScheduledJobConfigurationTable = true,
                DoScheduledJobConfigurationSettingTable = true,
                DoSettingTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ScheduledJobConfigurationSetting>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ScheduledJobConfigurationSettings;
        }

        /// <inheritdoc/>
        protected override List<Mock<ScheduledJobConfigurationSetting>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawScheduledJobConfigurationSettings;
        }

        /// <inheritdoc/>
        protected override async Task<ScheduledJobConfigurationSettingModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ScheduledJobConfigurationSettingModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawScheduledJobConfigurations.First().Object.ID,
                SlaveID = mockingSetup.RawSettings.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Hangfire.ScheduledJobConfigurationSettings.Standard")]
    public partial class Hangfire_ScheduledJobConfigurationSettings_StandardWorkflowTests : Hangfire_ScheduledJobConfigurationSettings_WorkflowTestsBase
    {
        public Hangfire_ScheduledJobConfigurationSettings_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
