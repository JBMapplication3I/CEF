...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Hangfire_ScheduledJobConfigurations_WorkflowTestsBase
        : AbstractNameableBase<
            IScheduledJobConfiguration,
            ScheduledJobConfiguration,
            IScheduledJobConfigurationModel,
            ScheduledJobConfigurationModel,
            IScheduledJobConfigurationSearchModel,
            ScheduledJobConfigurationSearchModel,
            ScheduledJobConfigurationWorkflow>
    {
        protected Hangfire_ScheduledJobConfigurations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoScheduledJobConfigurationTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ScheduledJobConfiguration>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ScheduledJobConfigurations;
        }

        /// <inheritdoc/>
        protected override List<Mock<ScheduledJobConfiguration>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawScheduledJobConfigurations;
        }

        /// <inheritdoc/>
        protected override async Task<ScheduledJobConfigurationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ScheduledJobConfigurationModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Hangfire.ScheduledJobConfigurations.Standard")]
    public partial class Hangfire_ScheduledJobConfigurations_StandardWorkflowTests : Hangfire_ScheduledJobConfigurations_WorkflowTestsBase
    {
        public Hangfire_ScheduledJobConfigurations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
