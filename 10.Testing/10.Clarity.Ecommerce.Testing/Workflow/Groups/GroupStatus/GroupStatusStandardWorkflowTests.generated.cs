...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Groups_GroupStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            GroupStatusWorkflow>
    {
        protected Groups_GroupStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoGroupStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<GroupStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.GroupStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<GroupStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawGroupStatuses;
        }
    ...
    [Trait("Category", "Workflows.Groups.GroupStatuses.Standard")]
    public partial class Groups_GroupStatuses_StandardWorkflowTests : Groups_GroupStatuses_WorkflowTestsBase
    {
        public Groups_GroupStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
