...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Groups_Groups_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            GroupWorkflow>
    {
        protected Groups_Groups_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoGroupTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoGroupTable = true,
                DoGroupStatusTable = true,
                DoGroupTypeTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Group>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Groups;
        }

        /// <inheritdoc/>
        protected override List<Mock<Group>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawGroups;
        }

        /// <inheritdoc/>
        protected override async Task<GroupModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new GroupModel
            {
                ...
                TypeID = mockingSetup.RawGroupTypes.First().Object.ID,
                StatusID = mockingSetup.RawGroupStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Groups.Groups.Standard")]
    public partial class Groups_Groups_StandardWorkflowTests : Groups_Groups_WorkflowTestsBase
    {
        public Groups_Groups_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
