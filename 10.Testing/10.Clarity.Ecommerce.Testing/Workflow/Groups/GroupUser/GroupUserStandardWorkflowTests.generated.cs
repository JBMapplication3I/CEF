// <autogenerated>
// <copyright file="Groups.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Groups_GroupUsers_WorkflowTestsBase
        : AbstractBase<
            IGroupUser,
            GroupUser,
            IGroupUserModel,
            ...
            GroupUserSearchModel,
            GroupUserWorkflow>
    {
        protected Groups_GroupUsers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoGroupUserTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoGroupTable = true,
                DoGroupUserTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<GroupUser>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.GroupUsers;
        }

        /// <inheritdoc/>
        protected override List<Mock<GroupUser>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawGroupUsers;
        }

        /// <inheritdoc/>
        protected override async Task<GroupUserModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new GroupUserModel
            {
                ...
                MasterID = mockingSetup.RawGroups.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Groups.GroupUsers.Standard")]
    public partial class Groups_GroupUsers_StandardWorkflowTests : Groups_GroupUsers_WorkflowTestsBase
    {
        public Groups_GroupUsers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
