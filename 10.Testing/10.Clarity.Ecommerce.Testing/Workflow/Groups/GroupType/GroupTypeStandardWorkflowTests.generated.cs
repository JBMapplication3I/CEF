...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Groups_GroupTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IGroupType,
            GroupType,
            ITypeModel,
            ...
            GroupTypeWorkflow>
    {
        protected Groups_GroupTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoGroupTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<GroupType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.GroupTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<GroupType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawGroupTypes;
        }
    ...
    [Trait("Category", "Workflows.Groups.GroupTypes.Standard")]
    public partial class Groups_GroupTypes_StandardWorkflowTests : Groups_GroupTypes_WorkflowTestsBase
    {
        public Groups_GroupTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
