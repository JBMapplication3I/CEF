...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_Users_WorkflowTestsBase
        : AbstractBase<
            IUser,
            User,
            IUserModel,
            ...
            UserWorkflow>
    {
        protected Contacts_Users_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<User>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Users;
        }

        /// <inheritdoc/>
        protected override List<Mock<User>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUsers;
        }

        /// <inheritdoc/>
        protected override async Task<UserModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Contacts.Users.Standard")]
    public partial class Contacts_Users_StandardWorkflowTests : Contacts_Users_WorkflowTestsBase
    {
        public Contacts_Users_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
