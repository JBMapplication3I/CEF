...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_UserStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            UserStatusWorkflow>
    {
        protected Contacts_UserStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<UserStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserStatuses;
        }
    ...
    [Trait("Category", "Workflows.Contacts.UserStatuses.Standard")]
    public partial class Contacts_UserStatuses_StandardWorkflowTests : Contacts_UserStatuses_WorkflowTestsBase
    {
        public Contacts_UserStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
