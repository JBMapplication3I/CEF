...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_UserProductTypes_WorkflowTestsBase
        : AbstractBase<
            IUserProductType,
            UserProductType,
            ...
            UserProductTypeSearchModel,
            UserProductTypeWorkflow>
    {
        protected Contacts_UserProductTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserProductTypeTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoUserTable = true,
                DoUserProductTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<UserProductType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserProductTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserProductType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserProductTypes;
        }

        /// <inheritdoc/>
        protected override async Task<UserProductTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new UserProductTypeModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Contacts.UserProductTypes.Standard")]
    public partial class Contacts_UserProductTypes_StandardWorkflowTests : Contacts_UserProductTypes_WorkflowTestsBase
    {
        public Contacts_UserProductTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
