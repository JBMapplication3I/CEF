...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_ProfanityFilters_WorkflowTestsBase
        : AbstractBase<
            IProfanityFilter,
            ProfanityFilter,
            IProfanityFilterModel,
            ProfanityFilterModel,
            IProfanityFilterSearchModel,
            ProfanityFilterSearchModel,
            ProfanityFilterWorkflow>
    {
        protected Contacts_ProfanityFilters_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProfanityFilterTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoProfanityFilterTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ProfanityFilter>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProfanityFilters;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProfanityFilter>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProfanityFilters;
        }

        /// <inheritdoc/>
        protected override async Task<ProfanityFilterModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProfanityFilterModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Contacts.ProfanityFilters.Standard")]
    public partial class Contacts_ProfanityFilters_StandardWorkflowTests : Contacts_ProfanityFilters_WorkflowTestsBase
    {
        public Contacts_ProfanityFilters_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
