...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_Contacts_WorkflowTestsBase
        : AbstractBase<
            IContact,
            Contact,
            IContactModel,
            ...
            ContactWorkflow>
    {
        protected Contacts_Contacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Contact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Contacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<Contact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawContacts;
        }

        /// <inheritdoc/>
        protected override async Task<ContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ContactModel
            {
                ...
                TypeID = mockingSetup.RawContactTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Contacts.Contacts.Standard")]
    public partial class Contacts_Contacts_StandardWorkflowTests : Contacts_Contacts_WorkflowTestsBase
    {
        public Contacts_Contacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
