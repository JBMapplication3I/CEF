...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_UserFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            UserFileWorkflow>
    {
        protected Contacts_UserFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<UserFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserFiles;
        }

        /// <inheritdoc/>
        protected override async Task<UserFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Contacts.UserFiles.Standard")]
    public partial class Contacts_UserFiles_StandardWorkflowTests : Contacts_UserFiles_WorkflowTestsBase
    {
        public Contacts_UserFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
