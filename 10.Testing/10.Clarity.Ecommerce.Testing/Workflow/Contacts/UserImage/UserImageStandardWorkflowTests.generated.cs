...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_UserImages_WorkflowTestsBase
        : AbstractNameableBase<
            IUserImage,
            UserImage,
            IUserImageModel,
            UserImageModel,
            IUserImageSearchModel,
            UserImageSearchModel,
            UserImageWorkflow>
    {
        protected Contacts_UserImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoUserImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<UserImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserImages;
        }

        /// <inheritdoc/>
        protected override async Task<UserImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new UserImageModel
            {
                ...
                TypeID = mockingSetup.RawUserImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Contacts.UserImages.Standard")]
    public partial class Contacts_UserImages_StandardWorkflowTests : Contacts_UserImages_WorkflowTestsBase
    {
        public Contacts_UserImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
