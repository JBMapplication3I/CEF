...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_UserImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IUserImageType,
            UserImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            UserImageTypeWorkflow>
    {
        protected Contacts_UserImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<UserImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Contacts.UserImageTypes.Standard")]
    public partial class Contacts_UserImageTypes_StandardWorkflowTests : Contacts_UserImageTypes_WorkflowTestsBase
    {
        public Contacts_UserImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
