// <autogenerated>
// <copyright file="Contacts.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_ReferralCodes_WorkflowTestsBase
        : AbstractNameableBase<
            IReferralCode,
            ReferralCode,
            IReferralCodeModel,
            ReferralCodeModel,
            IReferralCodeSearchModel,
            ReferralCodeSearchModel,
            ReferralCodeWorkflow>
    {
        protected Contacts_ReferralCodes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoReferralCodeTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoReferralCodeTable = true,
                DoReferralCodeStatusTable = true,
                DoReferralCodeTypeTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ReferralCode>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ReferralCodes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ReferralCode>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawReferralCodes;
        }

        /// <inheritdoc/>
        protected override async Task<ReferralCodeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ReferralCodeModel
            {
                ...
                TypeID = mockingSetup.RawReferralCodeTypes.First().Object.ID,
                StatusID = mockingSetup.RawReferralCodeStatuses.First().Object.ID,
                UserID = mockingSetup.RawUsers.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Contacts.ReferralCodes.Standard")]
    public partial class Contacts_ReferralCodes_StandardWorkflowTests : Contacts_ReferralCodes_WorkflowTestsBase
    {
        public Contacts_ReferralCodes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
