...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_ContactImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IContactImageType,
            ContactImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            ContactImageTypeWorkflow>
    {
        protected Contacts_ContactImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoContactImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ContactImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ContactImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ContactImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawContactImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Contacts.ContactImageTypes.Standard")]
    public partial class Contacts_ContactImageTypes_StandardWorkflowTests : Contacts_ContactImageTypes_WorkflowTestsBase
    {
        public Contacts_ContactImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
