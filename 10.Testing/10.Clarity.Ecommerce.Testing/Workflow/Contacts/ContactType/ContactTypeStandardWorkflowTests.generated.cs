...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_ContactTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IContactType,
            ContactType,
            ITypeModel,
            ...
            ContactTypeWorkflow>
    {
        protected Contacts_ContactTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoContactTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ContactType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ContactTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ContactType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawContactTypes;
        }
    ...
    [Trait("Category", "Workflows.Contacts.ContactTypes.Standard")]
    public partial class Contacts_ContactTypes_StandardWorkflowTests : Contacts_ContactTypes_WorkflowTestsBase
    {
        public Contacts_ContactTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
