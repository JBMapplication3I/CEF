...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_ReferralCodeStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            ReferralCodeStatusWorkflow>
    {
        protected Contacts_ReferralCodeStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoReferralCodeStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ReferralCodeStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ReferralCodeStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<ReferralCodeStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawReferralCodeStatuses;
        }
    ...
    [Trait("Category", "Workflows.Contacts.ReferralCodeStatuses.Standard")]
    public partial class Contacts_ReferralCodeStatuses_StandardWorkflowTests : Contacts_ReferralCodeStatuses_WorkflowTestsBase
    {
        public Contacts_ReferralCodeStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
