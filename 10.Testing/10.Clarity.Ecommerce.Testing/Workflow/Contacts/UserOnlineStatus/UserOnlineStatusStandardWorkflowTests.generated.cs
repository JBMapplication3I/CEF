...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_UserOnlineStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            UserOnlineStatusWorkflow>
    {
        protected Contacts_UserOnlineStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserOnlineStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<UserOnlineStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserOnlineStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserOnlineStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserOnlineStatuses;
        }
    ...
    [Trait("Category", "Workflows.Contacts.UserOnlineStatuses.Standard")]
    public partial class Contacts_UserOnlineStatuses_StandardWorkflowTests : Contacts_UserOnlineStatuses_WorkflowTestsBase
    {
        public Contacts_UserOnlineStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
