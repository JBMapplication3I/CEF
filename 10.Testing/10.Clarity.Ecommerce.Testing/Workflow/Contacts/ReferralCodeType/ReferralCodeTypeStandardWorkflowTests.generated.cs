...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_ReferralCodeTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IReferralCodeType,
            ReferralCodeType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            ReferralCodeTypeWorkflow>
    {
        protected Contacts_ReferralCodeTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoReferralCodeTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ReferralCodeType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ReferralCodeTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ReferralCodeType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawReferralCodeTypes;
        }
    ...
    [Trait("Category", "Workflows.Contacts.ReferralCodeTypes.Standard")]
    public partial class Contacts_ReferralCodeTypes_StandardWorkflowTests : Contacts_ReferralCodeTypes_WorkflowTestsBase
    {
        public Contacts_ReferralCodeTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
