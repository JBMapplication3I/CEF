...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_UserTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IUserType,
            UserType,
            ITypeModel,
            ...
            UserTypeWorkflow>
    {
        protected Contacts_UserTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<UserType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserTypes;
        }
    ...
    [Trait("Category", "Workflows.Contacts.UserTypes.Standard")]
    public partial class Contacts_UserTypes_StandardWorkflowTests : Contacts_UserTypes_WorkflowTestsBase
    {
        public Contacts_UserTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
