...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Contacts_ContactImages_WorkflowTestsBase
        : AbstractNameableBase<
            IContactImage,
            ContactImage,
            IContactImageModel,
            ContactImageModel,
            IContactImageSearchModel,
            ContactImageSearchModel,
            ContactImageWorkflow>
    {
        protected Contacts_ContactImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoContactImageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ContactImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ContactImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<ContactImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawContactImages;
        }

        /// <inheritdoc/>
        protected override async Task<ContactImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ContactImageModel
            {
                ...
                TypeID = mockingSetup.RawContactImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Contacts.ContactImages.Standard")]
    public partial class Contacts_ContactImages_StandardWorkflowTests : Contacts_ContactImages_WorkflowTestsBase
    {
        public Contacts_ContactImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
