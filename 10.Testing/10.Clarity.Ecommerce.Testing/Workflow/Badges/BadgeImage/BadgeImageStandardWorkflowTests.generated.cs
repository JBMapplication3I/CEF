// <autogenerated>
// <copyright file="Badges.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Badges_BadgeImages_WorkflowTestsBase
        : AbstractNameableBase<
            IBadgeImage,
            BadgeImage,
            IBadgeImageModel,
            BadgeImageModel,
            IBadgeImageSearchModel,
            BadgeImageSearchModel,
            BadgeImageWorkflow>
    {
        protected Badges_BadgeImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBadgeImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoBadgeImageTable = true,
                DoBadgeImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<BadgeImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BadgeImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<BadgeImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBadgeImages;
        }

        /// <inheritdoc/>
        protected override async Task<BadgeImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BadgeImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawBadgeImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Badges.BadgeImages.Standard")]
    public partial class Badges_BadgeImages_StandardWorkflowTests : Badges_BadgeImages_WorkflowTestsBase
    {
        public Badges_BadgeImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
