...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Badges_BadgeTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IBadgeType,
            BadgeType,
            ITypeModel,
            ...
            BadgeTypeWorkflow>
    {
        protected Badges_BadgeTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBadgeTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BadgeType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BadgeTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<BadgeType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBadgeTypes;
        }
    ...
    [Trait("Category", "Workflows.Badges.BadgeTypes.Standard")]
    public partial class Badges_BadgeTypes_StandardWorkflowTests : Badges_BadgeTypes_WorkflowTestsBase
    {
        public Badges_BadgeTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
