...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Badges_Badges_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            BadgeWorkflow>
    {
        protected Badges_Badges_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBadgeTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoBadgeTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Badge>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Badges;
        }

        /// <inheritdoc/>
        protected override List<Mock<Badge>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBadges;
        }

        /// <inheritdoc/>
        protected override async Task<BadgeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BadgeModel
            {
                ...
                TypeID = mockingSetup.RawBadgeTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Badges.Badges.Standard")]
    public partial class Badges_Badges_StandardWorkflowTests : Badges_Badges_WorkflowTestsBase
    {
        public Badges_Badges_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
