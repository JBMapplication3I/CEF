...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Badges_BadgeImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IBadgeImageType,
            BadgeImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            BadgeImageTypeWorkflow>
    {
        protected Badges_BadgeImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBadgeImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BadgeImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BadgeImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<BadgeImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBadgeImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Badges.BadgeImageTypes.Standard")]
    public partial class Badges_BadgeImageTypes_StandardWorkflowTests : Badges_BadgeImageTypes_WorkflowTestsBase
    {
        public Badges_BadgeImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
