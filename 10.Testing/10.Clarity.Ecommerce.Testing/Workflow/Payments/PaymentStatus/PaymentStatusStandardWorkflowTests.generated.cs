...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_PaymentStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            PaymentStatusWorkflow>
    {
        protected Payments_PaymentStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPaymentStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PaymentStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PaymentStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<PaymentStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPaymentStatuses;
        }
    ...
    [Trait("Category", "Workflows.Payments.PaymentStatuses.Standard")]
    public partial class Payments_PaymentStatuses_StandardWorkflowTests : Payments_PaymentStatuses_WorkflowTestsBase
    {
        public Payments_PaymentStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
