...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_Payments_WorkflowTestsBase
        : AbstractBase<
            IPayment,
            Payment,
            IPaymentModel,
            ...
            PaymentWorkflow>
    {
        protected Payments_Payments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPaymentTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Payment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Payments;
        }

        /// <inheritdoc/>
        protected override List<Mock<Payment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPayments;
        }

        /// <inheritdoc/>
        protected override async Task<PaymentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PaymentModel
            {
                ...
                TypeID = mockingSetup.RawPaymentTypes.First().Object.ID,
                StatusID = mockingSetup.RawPaymentStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Payments.Payments.Standard")]
    public partial class Payments_Payments_StandardWorkflowTests : Payments_Payments_WorkflowTestsBase
    {
        public Payments_Payments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
