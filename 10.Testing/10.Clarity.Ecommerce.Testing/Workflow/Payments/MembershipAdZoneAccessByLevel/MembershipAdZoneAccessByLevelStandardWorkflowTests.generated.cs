// <autogenerated>
// <copyright file="Payments.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_MembershipAdZoneAccessByLevels_WorkflowTestsBase
        : AbstractBase<
            IMembershipAdZoneAccessByLevel,
            MembershipAdZoneAccessByLevel,
            IMembershipAdZoneAccessByLevelModel,
            MembershipAdZoneAccessByLevelModel,
            IMembershipAdZoneAccessByLevelSearchModel,
            MembershipAdZoneAccessByLevelSearchModel,
            MembershipAdZoneAccessByLevelWorkflow>
    {
        protected Payments_MembershipAdZoneAccessByLevels_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMembershipAdZoneAccessByLevelTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<MembershipAdZoneAccessByLevel>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.MembershipAdZoneAccessByLevels;
        }

        /// <inheritdoc/>
        protected override List<Mock<MembershipAdZoneAccessByLevel>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMembershipAdZoneAccessByLevels;
        }

        /// <inheritdoc/>
        protected override async Task<MembershipAdZoneAccessByLevelModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new MembershipAdZoneAccessByLevelModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawMembershipLevels.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Payments.MembershipAdZoneAccessByLevels.Standard")]
    public partial class Payments_MembershipAdZoneAccessByLevels_StandardWorkflowTests : Payments_MembershipAdZoneAccessByLevels_WorkflowTestsBase
    {
        public Payments_MembershipAdZoneAccessByLevels_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
