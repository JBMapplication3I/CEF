...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_MembershipAdZoneAccesses_WorkflowTestsBase
        : AbstractBase<
            IMembershipAdZoneAccess,
            MembershipAdZoneAccess,
            IMembershipAdZoneAccessModel,
            MembershipAdZoneAccessModel,
            IMembershipAdZoneAccessSearchModel,
            MembershipAdZoneAccessSearchModel,
            MembershipAdZoneAccessWorkflow>
    {
        protected Payments_MembershipAdZoneAccesses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMembershipAdZoneAccessTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<MembershipAdZoneAccess>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.MembershipAdZoneAccesses;
        }

        /// <inheritdoc/>
        protected override List<Mock<MembershipAdZoneAccess>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMembershipAdZoneAccesses;
        }

        /// <inheritdoc/>
        protected override async Task<MembershipAdZoneAccessModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new MembershipAdZoneAccessModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawAdZoneAccesses.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Payments.MembershipAdZoneAccesses.Standard")]
    public partial class Payments_MembershipAdZoneAccesses_StandardWorkflowTests : Payments_MembershipAdZoneAccesses_WorkflowTestsBase
    {
        public Payments_MembershipAdZoneAccesses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
