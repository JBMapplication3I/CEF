...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_PaymentMethods_WorkflowTestsBase
        : AbstractNameableBase<
            IPaymentMethod,
            PaymentMethod,
            IPaymentMethodModel,
            PaymentMethodModel,
            IPaymentMethodSearchModel,
            PaymentMethodSearchModel,
            PaymentMethodWorkflow>
    {
        protected Payments_PaymentMethods_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPaymentMethodTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PaymentMethod>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PaymentMethods;
        }

        /// <inheritdoc/>
        protected override List<Mock<PaymentMethod>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPaymentMethods;
        }

        /// <inheritdoc/>
        protected override async Task<PaymentMethodModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Payments.PaymentMethods.Standard")]
    public partial class Payments_PaymentMethods_StandardWorkflowTests : Payments_PaymentMethods_WorkflowTestsBase
    {
        public Payments_PaymentMethods_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
