...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_MembershipLevels_WorkflowTestsBase
        : AbstractTypableBase<
            IMembershipLevel,
            MembershipLevel,
            IMembershipLevelModel,
            MembershipLevelModel,
            IMembershipLevelSearchModel,
            MembershipLevelSearchModel,
            MembershipLevelWorkflow>
    {
        protected Payments_MembershipLevels_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMembershipLevelTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<MembershipLevel>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.MembershipLevels;
        }

        /// <inheritdoc/>
        protected override List<Mock<MembershipLevel>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMembershipLevels;
        }

        /// <inheritdoc/>
        protected override async Task<MembershipLevelModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new MembershipLevelModel
            {
                Active = true,
                ...
                MembershipID = mockingSetup.RawMemberships.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Payments.MembershipLevels.Standard")]
    public partial class Payments_MembershipLevels_StandardWorkflowTests : Payments_MembershipLevels_WorkflowTestsBase
    {
        public Payments_MembershipLevels_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
