...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_SubscriptionTypeRepeatTypes_WorkflowTestsBase
        : AbstractBase<
            ISubscriptionTypeRepeatType,
            SubscriptionTypeRepeatType,
            ISubscriptionTypeRepeatTypeModel,
            SubscriptionTypeRepeatTypeModel,
            ISubscriptionTypeRepeatTypeSearchModel,
            SubscriptionTypeRepeatTypeSearchModel,
            SubscriptionTypeRepeatTypeWorkflow>
    {
        protected Payments_SubscriptionTypeRepeatTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSubscriptionTypeRepeatTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SubscriptionTypeRepeatType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SubscriptionTypeRepeatTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SubscriptionTypeRepeatType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSubscriptionTypeRepeatTypes;
        }

        /// <inheritdoc/>
        protected override async Task<SubscriptionTypeRepeatTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SubscriptionTypeRepeatTypeModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawRepeatTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Payments.SubscriptionTypeRepeatTypes.Standard")]
    public partial class Payments_SubscriptionTypeRepeatTypes_StandardWorkflowTests : Payments_SubscriptionTypeRepeatTypes_WorkflowTestsBase
    {
        public Payments_SubscriptionTypeRepeatTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
