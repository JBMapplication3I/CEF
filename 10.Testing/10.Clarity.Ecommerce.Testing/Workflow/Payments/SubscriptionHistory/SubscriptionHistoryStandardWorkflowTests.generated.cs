...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_SubscriptionHistories_WorkflowTestsBase
        : AbstractBase<
            ...
            SubscriptionHistoryWorkflow>
    {
        protected Payments_SubscriptionHistories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSubscriptionHistoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SubscriptionHistory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SubscriptionHistories;
        }

        /// <inheritdoc/>
        protected override List<Mock<SubscriptionHistory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSubscriptionHistories;
        }

        /// <inheritdoc/>
        protected override async Task<SubscriptionHistoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SubscriptionHistoryModel
            {
                ...
                MasterID = mockingSetup.RawSubscriptions.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Payments.SubscriptionHistories.Standard")]
    public partial class Payments_SubscriptionHistories_StandardWorkflowTests : Payments_SubscriptionHistories_WorkflowTestsBase
    {
        public Payments_SubscriptionHistories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
