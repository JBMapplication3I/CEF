...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_SalesReturnPayments_WorkflowTestsBase
        : AbstractBase<
            ISalesReturnPayment,
            SalesReturnPayment,
            ISalesReturnPaymentModel,
            SalesReturnPaymentModel,
            ISalesReturnPaymentSearchModel,
            SalesReturnPaymentSearchModel,
            SalesReturnPaymentWorkflow>
    {
        protected Payments_SalesReturnPayments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnPaymentTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnPayment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnPayments;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnPayment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnPayments;
        }

        /// <inheritdoc/>
        protected override async Task<SalesReturnPaymentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesReturnPaymentModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawPayments.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Payments.SalesReturnPayments.Standard")]
    public partial class Payments_SalesReturnPayments_StandardWorkflowTests : Payments_SalesReturnPayments_WorkflowTestsBase
    {
        public Payments_SalesReturnPayments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
