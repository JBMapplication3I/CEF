...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_SubscriptionTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISubscriptionType,
            SubscriptionType,
            ISubscriptionTypeModel,
            SubscriptionTypeModel,
            ISubscriptionTypeSearchModel,
            SubscriptionTypeSearchModel,
            SubscriptionTypeWorkflow>
    {
        protected Payments_SubscriptionTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSubscriptionTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SubscriptionType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SubscriptionTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SubscriptionType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSubscriptionTypes;
        }

        /// <inheritdoc/>
        protected override async Task<SubscriptionTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Payments.SubscriptionTypes.Standard")]
    public partial class Payments_SubscriptionTypes_StandardWorkflowTests : Payments_SubscriptionTypes_WorkflowTestsBase
    {
        public Payments_SubscriptionTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
