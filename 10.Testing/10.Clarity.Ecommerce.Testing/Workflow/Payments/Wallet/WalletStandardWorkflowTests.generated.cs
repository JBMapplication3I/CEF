...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_Wallets_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            WalletWorkflow>
    {
        protected Payments_Wallets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoWalletTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Wallet>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Wallets;
        }

        /// <inheritdoc/>
        protected override List<Mock<Wallet>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawWallets;
        }

        /// <inheritdoc/>
        protected override async Task<WalletModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Payments.Wallets.Standard")]
    public partial class Payments_Wallets_StandardWorkflowTests : Payments_Wallets_WorkflowTestsBase
    {
        public Payments_Wallets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
