...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_PaymentTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IPaymentType,
            PaymentType,
            ITypeModel,
            ...
            PaymentTypeWorkflow>
    {
        protected Payments_PaymentTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPaymentTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PaymentType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PaymentTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<PaymentType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPaymentTypes;
        }
    ...
    [Trait("Category", "Workflows.Payments.PaymentTypes.Standard")]
    public partial class Payments_PaymentTypes_StandardWorkflowTests : Payments_PaymentTypes_WorkflowTestsBase
    {
        public Payments_PaymentTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
