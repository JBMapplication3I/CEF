...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_Memberships_WorkflowTestsBase
        : AbstractTypableBase<
            IMembership,
            Membership,
            IMembershipModel,
            MembershipModel,
            IMembershipSearchModel,
            MembershipSearchModel,
            MembershipWorkflow>
    {
        protected Payments_Memberships_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMembershipTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Membership>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Memberships;
        }

        /// <inheritdoc/>
        protected override List<Mock<Membership>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMemberships;
        }

        /// <inheritdoc/>
        protected override async Task<MembershipModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Payments.Memberships.Standard")]
    public partial class Payments_Memberships_StandardWorkflowTests : Payments_Memberships_WorkflowTestsBase
    {
        public Payments_Memberships_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
