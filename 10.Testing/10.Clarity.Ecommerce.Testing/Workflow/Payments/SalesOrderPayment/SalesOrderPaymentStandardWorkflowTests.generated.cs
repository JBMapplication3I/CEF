...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_SalesOrderPayments_WorkflowTestsBase
        : AbstractBase<
            ISalesOrderPayment,
            SalesOrderPayment,
            ISalesOrderPaymentModel,
            SalesOrderPaymentModel,
            ISalesOrderPaymentSearchModel,
            SalesOrderPaymentSearchModel,
            SalesOrderPaymentWorkflow>
    {
        protected Payments_SalesOrderPayments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderPaymentTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderPayment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderPayments;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderPayment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderPayments;
        }

        /// <inheritdoc/>
        protected override async Task<SalesOrderPaymentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesOrderPaymentModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Payments.SalesOrderPayments.Standard")]
    public partial class Payments_SalesOrderPayments_StandardWorkflowTests : Payments_SalesOrderPayments_WorkflowTestsBase
    {
        public Payments_SalesOrderPayments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
