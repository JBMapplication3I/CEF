...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_SalesInvoicePayments_WorkflowTestsBase
        : AbstractBase<
            ISalesInvoicePayment,
            SalesInvoicePayment,
            ISalesInvoicePaymentModel,
            SalesInvoicePaymentModel,
            ISalesInvoicePaymentSearchModel,
            SalesInvoicePaymentSearchModel,
            SalesInvoicePaymentWorkflow>
    {
        protected Payments_SalesInvoicePayments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoicePaymentTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoicePayment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoicePayments;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoicePayment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoicePayments;
        }

        /// <inheritdoc/>
        protected override async Task<SalesInvoicePaymentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Payments.SalesInvoicePayments.Standard")]
    public partial class Payments_SalesInvoicePayments_StandardWorkflowTests : Payments_SalesInvoicePayments_WorkflowTestsBase
    {
        public Payments_SalesInvoicePayments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
