...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_MembershipRepeatTypes_WorkflowTestsBase
        : AbstractBase<
            IMembershipRepeatType,
            MembershipRepeatType,
            IMembershipRepeatTypeModel,
            MembershipRepeatTypeModel,
            IMembershipRepeatTypeSearchModel,
            MembershipRepeatTypeSearchModel,
            MembershipRepeatTypeWorkflow>
    {
        protected Payments_MembershipRepeatTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMembershipRepeatTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<MembershipRepeatType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.MembershipRepeatTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<MembershipRepeatType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMembershipRepeatTypes;
        }

        /// <inheritdoc/>
        protected override async Task<MembershipRepeatTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new MembershipRepeatTypeModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Payments.MembershipRepeatTypes.Standard")]
    public partial class Payments_MembershipRepeatTypes_StandardWorkflowTests : Payments_MembershipRepeatTypes_WorkflowTestsBase
    {
        public Payments_MembershipRepeatTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
