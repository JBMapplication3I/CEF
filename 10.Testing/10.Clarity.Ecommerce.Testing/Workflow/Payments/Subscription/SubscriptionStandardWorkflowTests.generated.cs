...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_Subscriptions_WorkflowTestsBase
    ...
    {
        protected Payments_Subscriptions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSubscriptionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSubscriptionHistoryTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Subscription>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Subscriptions;
        }

        /// <inheritdoc/>
        protected override List<Mock<Subscription>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSubscriptions;
        }

        /// <inheritdoc/>
        protected override async Task<SubscriptionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SubscriptionModel
            {
                ...
                TypeID = mockingSetup.RawSubscriptionTypes.First().Object.ID,
                StatusID = mockingSetup.RawSubscriptionStatuses.First().Object.ID,
                RepeatTypeID = mockingSetup.RawRepeatTypes.First().Object.ID,
                // Optional Related Properties
                ProductMembershipLevelID = null,
                UserID = null,
                AccountID = null,
                SalesGroupID = null,
                SalesOrderID = null,
    ...
    [Trait("Category", "Workflows.Payments.Subscriptions.Standard")]
    public partial class Payments_Subscriptions_StandardWorkflowTests : Payments_Subscriptions_WorkflowTestsBase
    {
        public Payments_Subscriptions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
