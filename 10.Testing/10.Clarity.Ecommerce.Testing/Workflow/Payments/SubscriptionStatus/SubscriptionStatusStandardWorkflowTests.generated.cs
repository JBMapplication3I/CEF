...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_SubscriptionStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            SubscriptionStatusWorkflow>
    {
        protected Payments_SubscriptionStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSubscriptionStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SubscriptionStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SubscriptionStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<SubscriptionStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSubscriptionStatuses;
        }
    ...
    [Trait("Category", "Workflows.Payments.SubscriptionStatuses.Standard")]
    public partial class Payments_SubscriptionStatuses_StandardWorkflowTests : Payments_SubscriptionStatuses_WorkflowTestsBase
    {
        public Payments_SubscriptionStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
