...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Payments_RepeatTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IRepeatType,
            RepeatType,
            IRepeatTypeModel,
            ...
            RepeatTypeWorkflow>
    {
        protected Payments_RepeatTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRepeatTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<RepeatType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RepeatTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<RepeatType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRepeatTypes;
        }

        /// <inheritdoc/>
        protected override async Task<RepeatTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new RepeatTypeModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Payments.RepeatTypes.Standard")]
    public partial class Payments_RepeatTypes_StandardWorkflowTests : Payments_RepeatTypes_WorkflowTestsBase
    {
        public Payments_RepeatTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
