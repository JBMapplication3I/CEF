...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_Conversations_WorkflowTestsBase
        : AbstractBase<
            IConversation,
            Conversation,
            IConversationModel,
    ...
    {
        protected Messaging_Conversations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoConversationTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Conversation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Conversations;
        }

        /// <inheritdoc/>
        protected override List<Mock<Conversation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawConversations;
        }

        /// <inheritdoc/>
        protected override async Task<ConversationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Messaging.Conversations.Standard")]
    public partial class Messaging_Conversations_StandardWorkflowTests : Messaging_Conversations_WorkflowTestsBase
    {
        public Messaging_Conversations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
