...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_EmailTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IEmailType,
            EmailType,
            ITypeModel,
            ...
            EmailTypeWorkflow>
    {
        protected Messaging_EmailTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEmailTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<EmailType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EmailTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<EmailType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEmailTypes;
        }
    ...
    [Trait("Category", "Workflows.Messaging.EmailTypes.Standard")]
    public partial class Messaging_EmailTypes_StandardWorkflowTests : Messaging_EmailTypes_WorkflowTestsBase
    {
        public Messaging_EmailTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
