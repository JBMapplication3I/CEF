// <autogenerated>
// <copyright file="Messaging.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_EmailQueueAttachments_WorkflowTestsBase
        : AbstractNameableBase<
            IEmailQueueAttachment,
            EmailQueueAttachment,
            IEmailQueueAttachmentModel,
            EmailQueueAttachmentModel,
            IEmailQueueAttachmentSearchModel,
            EmailQueueAttachmentSearchModel,
            EmailQueueAttachmentWorkflow>
    {
        protected Messaging_EmailQueueAttachments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEmailQueueAttachmentTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoEmailQueueAttachmentTable = true,
                DoStoredFileTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<EmailQueueAttachment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EmailQueueAttachments;
        }

        /// <inheritdoc/>
        protected override List<Mock<EmailQueueAttachment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEmailQueueAttachments;
        }

        /// <inheritdoc/>
        protected override async Task<EmailQueueAttachmentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new EmailQueueAttachmentModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawStoredFiles.First().Object.ID,
                CreatedByUserID = mockingSetup.RawUsers.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Messaging.EmailQueueAttachments.Standard")]
    public partial class Messaging_EmailQueueAttachments_StandardWorkflowTests : Messaging_EmailQueueAttachments_WorkflowTestsBase
    {
        public Messaging_EmailQueueAttachments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
