...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_ProductNotifications_WorkflowTestsBase
        : AbstractNameableBase<
            IProductNotification,
            ProductNotification,
            IProductNotificationModel,
            ProductNotificationModel,
            IProductNotificationSearchModel,
            ProductNotificationSearchModel,
            ProductNotificationWorkflow>
    {
        protected Messaging_ProductNotifications_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductNotificationTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoProductNotificationTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ProductNotification>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductNotifications;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductNotification>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductNotifications;
        }

        /// <inheritdoc/>
        protected override async Task<ProductNotificationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductNotificationModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Messaging.ProductNotifications.Standard")]
    public partial class Messaging_ProductNotifications_StandardWorkflowTests : Messaging_ProductNotifications_WorkflowTestsBase
    {
        public Messaging_ProductNotifications_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
