...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_Messages_WorkflowTestsBase
        : AbstractBase<
            IMessage,
            Message,
            IMessageModel,
            ...
            MessageWorkflow>
    {
        protected Messaging_Messages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMessageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Message>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Messages;
        }

        /// <inheritdoc/>
        protected override List<Mock<Message>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMessages;
        }

        /// <inheritdoc/>
        protected override async Task<MessageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Messaging.Messages.Standard")]
    public partial class Messaging_Messages_StandardWorkflowTests : Messaging_Messages_WorkflowTestsBase
    {
        public Messaging_Messages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
