...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_MessageRecipients_WorkflowTestsBase
        : AbstractBase<
            IMessageRecipient,
            MessageRecipient,
            ...
            MessageRecipientSearchModel,
            MessageRecipientWorkflow>
    {
        protected Messaging_MessageRecipients_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMessageRecipientTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoGroupTable = true,
                DoMessageRecipientTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<MessageRecipient>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.MessageRecipients;
        }

        /// <inheritdoc/>
        protected override List<Mock<MessageRecipient>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMessageRecipients;
        }

        /// <inheritdoc/>
        protected override async Task<MessageRecipientModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new MessageRecipientModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Messaging.MessageRecipients.Standard")]
    public partial class Messaging_MessageRecipients_StandardWorkflowTests : Messaging_MessageRecipients_WorkflowTestsBase
    {
        public Messaging_MessageRecipients_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
