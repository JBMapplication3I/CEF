...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_EmailStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            EmailStatusWorkflow>
    {
        protected Messaging_EmailStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEmailStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<EmailStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EmailStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<EmailStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEmailStatuses;
        }
    ...
    [Trait("Category", "Workflows.Messaging.EmailStatuses.Standard")]
    public partial class Messaging_EmailStatuses_StandardWorkflowTests : Messaging_EmailStatuses_WorkflowTestsBase
    {
        public Messaging_EmailStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
