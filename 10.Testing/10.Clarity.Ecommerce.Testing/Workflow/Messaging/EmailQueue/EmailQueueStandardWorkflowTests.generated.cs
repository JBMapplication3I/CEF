...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_EmailQueues_WorkflowTestsBase
        : AbstractBase<
            IEmailQueue,
            EmailQueue,
            IEmailQueueModel,
            ...
            EmailQueueSearchModel,
            EmailQueueWorkflow>
    {
        protected Messaging_EmailQueues_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEmailQueueTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<EmailQueue>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EmailQueues;
        }

        /// <inheritdoc/>
        protected override List<Mock<EmailQueue>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEmailQueues;
        }

        /// <inheritdoc/>
        protected override async Task<EmailQueueModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new EmailQueueModel
            {
                ...
                TypeID = mockingSetup.RawEmailTypes.First().Object.ID,
                StatusID = mockingSetup.RawEmailStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Messaging.EmailQueues.Standard")]
    public partial class Messaging_EmailQueues_StandardWorkflowTests : Messaging_EmailQueues_WorkflowTestsBase
    {
        public Messaging_EmailQueues_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
