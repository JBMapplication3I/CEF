...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_EmailTemplates_WorkflowTestsBase
    ...
    {
        protected Messaging_EmailTemplates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEmailTemplateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<EmailTemplate>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EmailTemplates;
        }

        /// <inheritdoc/>
        protected override List<Mock<EmailTemplate>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEmailTemplates;
        }

        /// <inheritdoc/>
        protected override async Task<EmailTemplateModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Messaging.EmailTemplates.Standard")]
    public partial class Messaging_EmailTemplates_StandardWorkflowTests : Messaging_EmailTemplates_WorkflowTestsBase
    {
        public Messaging_EmailTemplates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
