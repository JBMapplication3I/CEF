...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Messaging_MessageAttachments_WorkflowTestsBase
        : AbstractNameableBase<
            IMessageAttachment,
            MessageAttachment,
            IMessageAttachmentModel,
            MessageAttachmentModel,
            IMessageAttachmentSearchModel,
            MessageAttachmentSearchModel,
            MessageAttachmentWorkflow>
    {
        protected Messaging_MessageAttachments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoMessageAttachmentTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<MessageAttachment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.MessageAttachments;
        }

        /// <inheritdoc/>
        protected override List<Mock<MessageAttachment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawMessageAttachments;
        }

        /// <inheritdoc/>
        protected override async Task<MessageAttachmentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new MessageAttachmentModel
            {
                ...
                MasterID = mockingSetup.RawMessages.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Messaging.MessageAttachments.Standard")]
    public partial class Messaging_MessageAttachments_StandardWorkflowTests : Messaging_MessageAttachments_WorkflowTestsBase
    {
        public Messaging_MessageAttachments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
