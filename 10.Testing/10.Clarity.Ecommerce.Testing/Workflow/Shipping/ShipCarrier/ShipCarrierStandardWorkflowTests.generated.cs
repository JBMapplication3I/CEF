...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_ShipCarriers_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            ShipCarrierSearchModel,
            ShipCarrierWorkflow>
    {
        protected Shipping_ShipCarriers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoShipCarrierTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ShipCarrier>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ShipCarriers;
        }

        /// <inheritdoc/>
        protected override List<Mock<ShipCarrier>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawShipCarriers;
        }

        /// <inheritdoc/>
        protected override async Task<ShipCarrierModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ShipCarrierModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Shipping.ShipCarriers.Standard")]
    public partial class Shipping_ShipCarriers_StandardWorkflowTests : Shipping_ShipCarriers_WorkflowTestsBase
    {
        public Shipping_ShipCarriers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
