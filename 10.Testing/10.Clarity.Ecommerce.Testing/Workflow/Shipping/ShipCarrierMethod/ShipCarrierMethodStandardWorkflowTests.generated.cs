...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_ShipCarrierMethods_WorkflowTestsBase
        : AbstractNameableBase<
            IShipCarrierMethod,
            ShipCarrierMethod,
            IShipCarrierMethodModel,
            ShipCarrierMethodModel,
            IShipCarrierMethodSearchModel,
            ShipCarrierMethodSearchModel,
            ShipCarrierMethodWorkflow>
    {
        protected Shipping_ShipCarrierMethods_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoShipCarrierMethodTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ShipCarrierMethod>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ShipCarrierMethods;
        }

        /// <inheritdoc/>
        protected override List<Mock<ShipCarrierMethod>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawShipCarrierMethods;
        }

        /// <inheritdoc/>
        protected override async Task<ShipCarrierMethodModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ShipCarrierMethodModel
            {
                Active = true,
                ...
                ShipCarrierID = mockingSetup.RawShipCarriers.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Shipping.ShipCarrierMethods.Standard")]
    public partial class Shipping_ShipCarrierMethods_StandardWorkflowTests : Shipping_ShipCarrierMethods_WorkflowTestsBase
    {
        public Shipping_ShipCarrierMethods_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
