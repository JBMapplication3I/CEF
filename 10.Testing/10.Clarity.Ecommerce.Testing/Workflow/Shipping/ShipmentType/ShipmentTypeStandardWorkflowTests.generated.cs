...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_ShipmentTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IShipmentType,
            ShipmentType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            ShipmentTypeWorkflow>
    {
        protected Shipping_ShipmentTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoShipmentTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ShipmentType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ShipmentTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ShipmentType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawShipmentTypes;
        }
    ...
    [Trait("Category", "Workflows.Shipping.ShipmentTypes.Standard")]
    public partial class Shipping_ShipmentTypes_StandardWorkflowTests : Shipping_ShipmentTypes_WorkflowTestsBase
    {
        public Shipping_ShipmentTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
