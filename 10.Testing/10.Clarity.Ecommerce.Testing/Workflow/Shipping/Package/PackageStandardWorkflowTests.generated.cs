...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_Packages_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            PackageWorkflow>
    {
        protected Shipping_Packages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPackageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Package>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Packages;
        }

        /// <inheritdoc/>
        protected override List<Mock<Package>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPackages;
        }

        /// <inheritdoc/>
        protected override async Task<PackageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PackageModel
            {
                ...
                TypeID = mockingSetup.RawPackageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Shipping.Packages.Standard")]
    public partial class Shipping_Packages_StandardWorkflowTests : Shipping_Packages_WorkflowTestsBase
    {
        public Shipping_Packages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
