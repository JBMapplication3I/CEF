...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_ShipmentStatuses_WorkflowTestsBase
    ...
    {
        protected Shipping_ShipmentStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoShipmentStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ShipmentStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ShipmentStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<ShipmentStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawShipmentStatuses;
        }
    ...
    [Trait("Category", "Workflows.Shipping.ShipmentStatuses.Standard")]
    public partial class Shipping_ShipmentStatuses_StandardWorkflowTests : Shipping_ShipmentStatuses_WorkflowTestsBase
    {
        public Shipping_ShipmentStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
