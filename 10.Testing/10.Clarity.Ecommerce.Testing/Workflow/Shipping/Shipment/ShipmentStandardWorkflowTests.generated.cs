// <autogenerated>
// <copyright file="Shipping.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_Shipments_WorkflowTestsBase
        : AbstractBase<
            IShipment,
            Shipment,
            IShipmentModel,
            ...
            ShipmentWorkflow>
    {
        protected Shipping_Shipments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoShipmentTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoShipmentEventTable = true,
                DoShipmentStatusTable = true,
                DoShipmentTypeTable = true,
                DoVendorTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Shipment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Shipments;
        }

        /// <inheritdoc/>
        protected override List<Mock<Shipment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawShipments;
        }

        /// <inheritdoc/>
        protected override async Task<ShipmentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ShipmentModel
            {
                ...
                TypeID = mockingSetup.RawShipmentTypes.First().Object.ID,
                StatusID = mockingSetup.RawShipmentStatuses.First().Object.ID,
                OriginContactID = mockingSetup.RawContacts.First().Object.ID,
                DestinationContactID = mockingSetup.RawContacts.First().Object.ID,
                // Optional Related Properties
                InventoryLocationSectionID = null,
                ShipCarrierID = null,
                ShipCarrierMethodID = null,
                VendorID = null,
            };
        }
    }

    [Trait("Category", "Workflows.Shipping.Shipments.Standard")]
    public partial class Shipping_Shipments_StandardWorkflowTests : Shipping_Shipments_WorkflowTestsBase
    {
        public Shipping_Shipments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
