...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_RateQuotes_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            RateQuoteSearchModel,
            RateQuoteWorkflow>
    {
        protected Shipping_RateQuotes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRateQuoteTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<RateQuote>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RateQuotes;
        }

        /// <inheritdoc/>
        protected override List<Mock<RateQuote>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRateQuotes;
        }

        /// <inheritdoc/>
        protected override async Task<RateQuoteModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new RateQuoteModel
            {
                Active = true,
                ...
                ShipCarrierMethodID = mockingSetup.RawShipCarrierMethods.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Shipping.RateQuotes.Standard")]
    public partial class Shipping_RateQuotes_StandardWorkflowTests : Shipping_RateQuotes_WorkflowTestsBase
    {
        public Shipping_RateQuotes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
