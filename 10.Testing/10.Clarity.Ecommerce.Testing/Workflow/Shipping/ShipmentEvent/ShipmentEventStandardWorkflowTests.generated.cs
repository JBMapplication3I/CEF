...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_ShipmentEvents_WorkflowTestsBase
        : AbstractBase<
            IShipmentEvent,
            ShipmentEvent,
            IShipmentEventModel,
            ...
            ShipmentEventSearchModel,
            ShipmentEventWorkflow>
    {
        protected Shipping_ShipmentEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoShipmentEventTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ShipmentEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ShipmentEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<ShipmentEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawShipmentEvents;
        }

        /// <inheritdoc/>
        protected override async Task<ShipmentEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ShipmentEventModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                AddressID = mockingSetup.RawAddresses.First().Object.ID,
                ShipmentID = mockingSetup.RawShipments.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Shipping.ShipmentEvents.Standard")]
    public partial class Shipping_ShipmentEvents_StandardWorkflowTests : Shipping_ShipmentEvents_WorkflowTestsBase
    {
        public Shipping_ShipmentEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
