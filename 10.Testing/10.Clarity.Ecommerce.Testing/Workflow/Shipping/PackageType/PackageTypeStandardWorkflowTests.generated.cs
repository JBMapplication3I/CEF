...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shipping_PackageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IPackageType,
            PackageType,
            ITypeModel,
            ...
            PackageTypeWorkflow>
    {
        protected Shipping_PackageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPackageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PackageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PackageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<PackageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPackageTypes;
        }
    ...
    [Trait("Category", "Workflows.Shipping.PackageTypes.Standard")]
    public partial class Shipping_PackageTypes_StandardWorkflowTests : Shipping_PackageTypes_WorkflowTestsBase
    {
        public Shipping_PackageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
