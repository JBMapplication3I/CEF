...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IPurchaseOrderEventType,
            PurchaseOrderEventType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            PurchaseOrderEventTypeWorkflow>
    {
        protected Purchasing_PurchaseOrderEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderEventTypes.Standard")]
    public partial class Purchasing_PurchaseOrderEventTypes_StandardWorkflowTests : Purchasing_PurchaseOrderEventTypes_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
