...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IPurchaseOrderType,
            PurchaseOrderType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            PurchaseOrderTypeWorkflow>
    {
        protected Purchasing_PurchaseOrderTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderTypes;
        }
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderTypes.Standard")]
    public partial class Purchasing_PurchaseOrderTypes_StandardWorkflowTests : Purchasing_PurchaseOrderTypes_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
