...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderFiles_WorkflowTestsBase
        : AbstractNameableBase<
            IPurchaseOrderFile,
            PurchaseOrderFile,
            IPurchaseOrderFileModel,
            PurchaseOrderFileModel,
            IPurchaseOrderFileSearchModel,
            PurchaseOrderFileSearchModel,
            PurchaseOrderFileWorkflow>
    {
        protected Purchasing_PurchaseOrderFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderFiles;
        }

        /// <inheritdoc/>
        protected override async Task<PurchaseOrderFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PurchaseOrderFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderFiles.Standard")]
    public partial class Purchasing_PurchaseOrderFiles_StandardWorkflowTests : Purchasing_PurchaseOrderFiles_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
