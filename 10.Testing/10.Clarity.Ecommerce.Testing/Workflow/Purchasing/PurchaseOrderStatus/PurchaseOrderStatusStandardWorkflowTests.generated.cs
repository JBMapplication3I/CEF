...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            PurchaseOrderStatusWorkflow>
    {
        protected Purchasing_PurchaseOrderStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderStatuses;
        }
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderStatuses.Standard")]
    public partial class Purchasing_PurchaseOrderStatuses_StandardWorkflowTests : Purchasing_PurchaseOrderStatuses_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
