...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderContacts_WorkflowTestsBase
        : AbstractBase<
            IPurchaseOrderContact,
            PurchaseOrderContact,
            IPurchaseOrderContactModel,
            PurchaseOrderContactModel,
            IPurchaseOrderContactSearchModel,
            PurchaseOrderContactSearchModel,
            PurchaseOrderContactWorkflow>
    {
        protected Purchasing_PurchaseOrderContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderContacts;
        }

        /// <inheritdoc/>
        protected override async Task<PurchaseOrderContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PurchaseOrderContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderContacts.Standard")]
    public partial class Purchasing_PurchaseOrderContacts_StandardWorkflowTests : Purchasing_PurchaseOrderContacts_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
