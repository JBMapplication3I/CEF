...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_SalesOrderPurchaseOrders_WorkflowTestsBase
        : AbstractBase<
            ISalesOrderPurchaseOrder,
            SalesOrderPurchaseOrder,
            ISalesOrderPurchaseOrderModel,
            SalesOrderPurchaseOrderModel,
            ISalesOrderPurchaseOrderSearchModel,
            SalesOrderPurchaseOrderSearchModel,
            SalesOrderPurchaseOrderWorkflow>
    {
        protected Purchasing_SalesOrderPurchaseOrders_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderPurchaseOrderTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderPurchaseOrder>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderPurchaseOrders;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderPurchaseOrder>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderPurchaseOrders;
        }

        /// <inheritdoc/>
        protected override async Task<SalesOrderPurchaseOrderModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesOrderPurchaseOrderModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawPurchaseOrders.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Purchasing.SalesOrderPurchaseOrders.Standard")]
    public partial class Purchasing_SalesOrderPurchaseOrders_StandardWorkflowTests : Purchasing_SalesOrderPurchaseOrders_WorkflowTestsBase
    {
        public Purchasing_SalesOrderPurchaseOrders_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
