...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderStates_WorkflowTestsBase
        : AbstractStateableBase<
            ...
            IStateSearchModel,
            StateSearchModel,
            PurchaseOrderStateWorkflow>
    {
        protected Purchasing_PurchaseOrderStates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderStateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderState>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderStates;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderState>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderStates;
        }
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderStates.Standard")]
    public partial class Purchasing_PurchaseOrderStates_StandardWorkflowTests : Purchasing_PurchaseOrderStates_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderStates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
