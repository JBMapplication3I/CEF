...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderItemTargets_WorkflowTestsBase
        : AbstractBase<
            ...
            PurchaseOrderItemTargetWorkflow>
    {
        protected Purchasing_PurchaseOrderItemTargets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderItemTargetTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderItemTarget>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderItemTargets;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderItemTarget>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderItemTargets;
        }
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderItemTargets.Standard")]
    public partial class Purchasing_PurchaseOrderItemTargets_StandardWorkflowTests : Purchasing_PurchaseOrderItemTargets_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderItemTargets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
