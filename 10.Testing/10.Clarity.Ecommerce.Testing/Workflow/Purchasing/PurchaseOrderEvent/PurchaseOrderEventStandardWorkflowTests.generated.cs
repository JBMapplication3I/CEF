...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderEvents_WorkflowTestsBase
        : AbstractNameableBase<
            IPurchaseOrderEvent,
            PurchaseOrderEvent,
            IPurchaseOrderEventModel,
            PurchaseOrderEventModel,
            IPurchaseOrderEventSearchModel,
            PurchaseOrderEventSearchModel,
            PurchaseOrderEventWorkflow>
    {
        protected Purchasing_PurchaseOrderEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderEventTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoPurchaseOrderEventTable = true,
                DoPurchaseOrderEventTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderEvents;
        }

        /// <inheritdoc/>
        protected override async Task<PurchaseOrderEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PurchaseOrderEventModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawPurchaseOrderEventTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Purchasing.PurchaseOrderEvents.Standard")]
    public partial class Purchasing_PurchaseOrderEvents_StandardWorkflowTests : Purchasing_PurchaseOrderEvents_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
