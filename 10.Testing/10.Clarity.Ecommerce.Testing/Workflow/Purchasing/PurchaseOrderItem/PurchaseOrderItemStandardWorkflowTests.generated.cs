...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Purchasing_PurchaseOrderItems_WorkflowTestsBase
        : AbstractNameableBase<
            IPurchaseOrderItem,
            PurchaseOrderItem,
            ISalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel>,
            SalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel, AppliedPurchaseOrderItemDiscountModel>,
            ISalesItemBaseSearchModel,
            SalesItemBaseSearchModel,
            PurchaseOrderItemWorkflow>
    {
        protected Purchasing_PurchaseOrderItems_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPurchaseOrderItemTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoPurchaseOrderItemTargetTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<PurchaseOrderItem>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PurchaseOrderItems;
        }

        /// <inheritdoc/>
        protected override List<Mock<PurchaseOrderItem>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPurchaseOrderItems;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel, AppliedPurchaseOrderItemDiscountModel>> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemBaseModel<IAppliedPurchaseOrderItemDiscountModel, AppliedPurchaseOrderItemDiscountModel>
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Purchasing.PurchaseOrderItems.Standard")]
    public partial class Purchasing_PurchaseOrderItems_StandardWorkflowTests : Purchasing_PurchaseOrderItems_WorkflowTestsBase
    {
        public Purchasing_PurchaseOrderItems_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
