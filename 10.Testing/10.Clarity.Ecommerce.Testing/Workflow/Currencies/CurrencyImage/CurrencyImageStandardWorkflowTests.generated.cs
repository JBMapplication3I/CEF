...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Currencies_CurrencyImages_WorkflowTestsBase
        : AbstractNameableBase<
            ICurrencyImage,
            CurrencyImage,
            ICurrencyImageModel,
            CurrencyImageModel,
            ICurrencyImageSearchModel,
            CurrencyImageSearchModel,
            CurrencyImageWorkflow>
    {
        protected Currencies_CurrencyImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCurrencyImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCurrencyImageTable = true,
                DoCurrencyImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CurrencyImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CurrencyImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<CurrencyImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCurrencyImages;
        }

        /// <inheritdoc/>
        protected override async Task<CurrencyImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CurrencyImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawCurrencyImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Currencies.CurrencyImages.Standard")]
    public partial class Currencies_CurrencyImages_StandardWorkflowTests : Currencies_CurrencyImages_WorkflowTestsBase
    {
        public Currencies_CurrencyImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
