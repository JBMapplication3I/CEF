...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Currencies_CurrencyConversions_WorkflowTestsBase
        : AbstractBase<
            ICurrencyConversion,
            CurrencyConversion,
            ICurrencyConversionModel,
            CurrencyConversionModel,
            ICurrencyConversionSearchModel,
            CurrencyConversionSearchModel,
            CurrencyConversionWorkflow>
    {
        protected Currencies_CurrencyConversions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCurrencyConversionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoCurrencyConversionTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CurrencyConversion>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CurrencyConversions;
        }

        /// <inheritdoc/>
        protected override List<Mock<CurrencyConversion>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCurrencyConversions;
        }

        /// <inheritdoc/>
        protected override async Task<CurrencyConversionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Currencies.CurrencyConversions.Standard")]
    public partial class Currencies_CurrencyConversions_StandardWorkflowTests : Currencies_CurrencyConversions_WorkflowTestsBase
    {
        public Currencies_CurrencyConversions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
