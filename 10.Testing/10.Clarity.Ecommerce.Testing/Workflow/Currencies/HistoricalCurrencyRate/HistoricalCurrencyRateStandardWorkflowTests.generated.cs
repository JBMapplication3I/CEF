// <autogenerated>
// <copyright file="Currencies.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Currencies_HistoricalCurrencyRates_WorkflowTestsBase
        : AbstractBase<
            IHistoricalCurrencyRate,
            HistoricalCurrencyRate,
            IHistoricalCurrencyRateModel,
            HistoricalCurrencyRateModel,
            IHistoricalCurrencyRateSearchModel,
            HistoricalCurrencyRateSearchModel,
            HistoricalCurrencyRateWorkflow>
    {
        protected Currencies_HistoricalCurrencyRates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoHistoricalCurrencyRateTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoHistoricalCurrencyRateTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<HistoricalCurrencyRate>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.HistoricalCurrencyRates;
        }

        /// <inheritdoc/>
        protected override List<Mock<HistoricalCurrencyRate>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawHistoricalCurrencyRates;
        }

        /// <inheritdoc/>
        protected override async Task<HistoricalCurrencyRateModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new HistoricalCurrencyRateModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                StartingCurrencyID = mockingSetup.RawCurrencies.First().Object.ID,
                EndingCurrencyID = mockingSetup.RawCurrencies.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Currencies.HistoricalCurrencyRates.Standard")]
    public partial class Currencies_HistoricalCurrencyRates_StandardWorkflowTests : Currencies_HistoricalCurrencyRates_WorkflowTestsBase
    {
        public Currencies_HistoricalCurrencyRates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
