...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Currencies_Currencies_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            CurrencyWorkflow>
    {
        protected Currencies_Currencies_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCurrencyTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Currency>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Currencies;
        }

        /// <inheritdoc/>
        protected override List<Mock<Currency>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCurrencies;
        }

        /// <inheritdoc/>
        protected override async Task<CurrencyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Currencies.Currencies.Standard")]
    public partial class Currencies_Currencies_StandardWorkflowTests : Currencies_Currencies_WorkflowTestsBase
    {
        public Currencies_Currencies_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
