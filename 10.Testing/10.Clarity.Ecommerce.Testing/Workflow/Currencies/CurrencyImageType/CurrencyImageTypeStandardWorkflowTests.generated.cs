...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Currencies_CurrencyImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICurrencyImageType,
            CurrencyImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CurrencyImageTypeWorkflow>
    {
        protected Currencies_CurrencyImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCurrencyImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CurrencyImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CurrencyImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CurrencyImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCurrencyImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Currencies.CurrencyImageTypes.Standard")]
    public partial class Currencies_CurrencyImageTypes_StandardWorkflowTests : Currencies_CurrencyImageTypes_WorkflowTestsBase
    {
        public Currencies_CurrencyImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
