...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductDownloadTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IProductDownloadType,
            ProductDownloadType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            ProductDownloadTypeWorkflow>
    {
        protected Products_ProductDownloadTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductDownloadTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductDownloadType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductDownloadTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductDownloadType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductDownloadTypes;
        }
    ...
    [Trait("Category", "Workflows.Products.ProductDownloadTypes.Standard")]
    public partial class Products_ProductDownloadTypes_StandardWorkflowTests : Products_ProductDownloadTypes_WorkflowTestsBase
    {
        public Products_ProductDownloadTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
