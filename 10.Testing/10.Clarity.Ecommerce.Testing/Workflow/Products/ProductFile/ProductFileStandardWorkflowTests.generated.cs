...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductFiles_WorkflowTestsBase
        : AbstractNameableBase<
            IProductFile,
            ProductFile,
            IProductFileModel,
            ProductFileModel,
            IProductFileSearchModel,
            ProductFileSearchModel,
            ProductFileWorkflow>
    {
        protected Products_ProductFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductFiles;
        }

        /// <inheritdoc/>
        protected override async Task<ProductFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Products.ProductFiles.Standard")]
    public partial class Products_ProductFiles_StandardWorkflowTests : Products_ProductFiles_WorkflowTestsBase
    {
        public Products_ProductFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
