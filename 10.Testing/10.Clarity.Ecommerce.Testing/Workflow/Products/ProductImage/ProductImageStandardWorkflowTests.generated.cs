...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductImages_WorkflowTestsBase
        : AbstractNameableBase<
            IProductImage,
            ProductImage,
            IProductImageModel,
            ProductImageModel,
            IProductImageSearchModel,
            ProductImageSearchModel,
            ProductImageWorkflow>
    {
        protected Products_ProductImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductImageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductImages;
        }

        /// <inheritdoc/>
        protected override async Task<ProductImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductImageModel
            {
                ...
                TypeID = mockingSetup.RawProductImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Products.ProductImages.Standard")]
    public partial class Products_ProductImages_StandardWorkflowTests : Products_ProductImages_WorkflowTestsBase
    {
        public Products_ProductImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
