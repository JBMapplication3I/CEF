...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_Products_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            ProductWorkflow>
    {
        protected Products_Products_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Product>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Products;
        }

        /// <inheritdoc/>
        protected override List<Mock<Product>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProducts;
        }

        /// <inheritdoc/>
        protected override async Task<ProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductModel
            {
                ...
                StatusID = mockingSetup.RawProductStatuses.First().Object.ID,
                TypeID = mockingSetup.RawProductTypes.First().Object.ID,
                // Optional Related Properties
                TotalPurchasedAmountCurrencyID = null,
                PackageID = null,
                MasterPackID = null,
                PalletID = null,
    ...
    [Trait("Category", "Workflows.Products.Products.Standard")]
    public partial class Products_Products_StandardWorkflowTests : Products_Products_WorkflowTestsBase
    {
        public Products_Products_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
