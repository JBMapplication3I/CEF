...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_FutureImports_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            FutureImportSearchModel,
            FutureImportWorkflow>
    {
        protected Products_FutureImports_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFutureImportTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoFutureImportTable = true,
                DoFutureImportStatusTable = true,
                DoStoreTable = true,
                DoVendorTable = true,
            };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FutureImport>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FutureImports;
        }

        /// <inheritdoc/>
        protected override List<Mock<FutureImport>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFutureImports;
        }

        /// <inheritdoc/>
        protected override async Task<FutureImportModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FutureImportModel
            {
                Active = true,
                ...
                StatusID = mockingSetup.RawFutureImportStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Products.FutureImports.Standard")]
    public partial class Products_FutureImports_StandardWorkflowTests : Products_FutureImports_WorkflowTestsBase
    {
        public Products_FutureImports_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
