...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductMembershipLevels_WorkflowTestsBase
        : AbstractBase<
            IProductMembershipLevel,
            ProductMembershipLevel,
            IProductMembershipLevelModel,
            ProductMembershipLevelModel,
            IProductMembershipLevelSearchModel,
            ProductMembershipLevelSearchModel,
            ProductMembershipLevelWorkflow>
    {
        protected Products_ProductMembershipLevels_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductMembershipLevelTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductMembershipLevel>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductMembershipLevels;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductMembershipLevel>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductMembershipLevels;
        }

        /// <inheritdoc/>
        protected override async Task<ProductMembershipLevelModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductMembershipLevelModel
            {
                Active = true,
                ...
                MembershipRepeatTypeID = mockingSetup.RawMembershipRepeatTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Products.ProductMembershipLevels.Standard")]
    public partial class Products_ProductMembershipLevels_StandardWorkflowTests : Products_ProductMembershipLevels_WorkflowTestsBase
    {
        public Products_ProductMembershipLevels_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
