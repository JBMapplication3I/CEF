...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IProductType,
            ProductType,
            ITypeModel,
            ...
            ProductTypeWorkflow>
    {
        protected Products_ProductTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductTypes;
        }
    ...
    [Trait("Category", "Workflows.Products.ProductTypes.Standard")]
    public partial class Products_ProductTypes_StandardWorkflowTests : Products_ProductTypes_WorkflowTestsBase
    {
        public Products_ProductTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
