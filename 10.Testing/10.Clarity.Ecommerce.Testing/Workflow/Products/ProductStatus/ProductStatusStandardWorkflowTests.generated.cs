...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            ProductStatusWorkflow>
    {
        protected Products_ProductStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductStatuses;
        }
    ...
    [Trait("Category", "Workflows.Products.ProductStatuses.Standard")]
    public partial class Products_ProductStatuses_StandardWorkflowTests : Products_ProductStatuses_WorkflowTestsBase
    {
        public Products_ProductStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
