...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductPricePoints_WorkflowTestsBase
        : AbstractBase<
            IProductPricePoint,
            ProductPricePoint,
            IProductPricePointModel,
            ProductPricePointModel,
            IProductPricePointSearchModel,
            ProductPricePointSearchModel,
            ProductPricePointWorkflow>
    {
        protected Products_ProductPricePoints_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductPricePointTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductPricePoint>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductPricePoints;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductPricePoint>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductPricePoints;
        }

        /// <inheritdoc/>
        protected override async Task<ProductPricePointModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductPricePointModel
            {
                ...
                FranchiseID = null,
                BrandID = null,
                PriceRoundingID = null,
                CurrencyID = null,
            };
        }
    }

    [Trait("Category", "Workflows.Products.ProductPricePoints.Standard")]
    public partial class Products_ProductPricePoints_StandardWorkflowTests : Products_ProductPricePoints_WorkflowTestsBase
    {
        public Products_ProductPricePoints_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
