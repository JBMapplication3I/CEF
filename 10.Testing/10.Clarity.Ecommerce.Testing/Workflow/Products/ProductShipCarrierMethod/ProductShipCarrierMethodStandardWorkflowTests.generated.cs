...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductShipCarrierMethods_WorkflowTestsBase
        : AbstractBase<
            IProductShipCarrierMethod,
            ProductShipCarrierMethod,
            IProductShipCarrierMethodModel,
            ProductShipCarrierMethodModel,
            IProductShipCarrierMethodSearchModel,
            ProductShipCarrierMethodSearchModel,
            ProductShipCarrierMethodWorkflow>
    {
        protected Products_ProductShipCarrierMethods_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductShipCarrierMethodTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoProductShipCarrierMethodTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductShipCarrierMethod>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductShipCarrierMethods;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductShipCarrierMethod>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductShipCarrierMethods;
        }

        /// <inheritdoc/>
        protected override async Task<ProductShipCarrierMethodModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductShipCarrierMethodModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawShipCarrierMethods.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Products.ProductShipCarrierMethods.Standard")]
    public partial class Products_ProductShipCarrierMethods_StandardWorkflowTests : Products_ProductShipCarrierMethods_WorkflowTestsBase
    {
        public Products_ProductShipCarrierMethods_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
