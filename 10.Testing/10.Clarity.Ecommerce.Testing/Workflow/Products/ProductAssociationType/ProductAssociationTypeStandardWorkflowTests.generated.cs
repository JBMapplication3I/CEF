...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductAssociationTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IProductAssociationType,
            ProductAssociationType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            ProductAssociationTypeWorkflow>
    {
        protected Products_ProductAssociationTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductAssociationTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductAssociationType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductAssociationTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductAssociationType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductAssociationTypes;
        }
    ...
    [Trait("Category", "Workflows.Products.ProductAssociationTypes.Standard")]
    public partial class Products_ProductAssociationTypes_StandardWorkflowTests : Products_ProductAssociationTypes_WorkflowTestsBase
    {
        public Products_ProductAssociationTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
