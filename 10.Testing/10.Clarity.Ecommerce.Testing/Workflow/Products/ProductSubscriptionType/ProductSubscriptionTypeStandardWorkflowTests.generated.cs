// <autogenerated>
// <copyright file="Products.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductSubscriptionTypes_WorkflowTestsBase
        : AbstractBase<
            IProductSubscriptionType,
            ProductSubscriptionType,
            IProductSubscriptionTypeModel,
            ProductSubscriptionTypeModel,
            IProductSubscriptionTypeSearchModel,
            ProductSubscriptionTypeSearchModel,
            ProductSubscriptionTypeWorkflow>
    {
        protected Products_ProductSubscriptionTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductSubscriptionTypeTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSubscriptionTypeRepeatTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ProductSubscriptionType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductSubscriptionTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductSubscriptionType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductSubscriptionTypes;
        }

        /// <inheritdoc/>
        protected override async Task<ProductSubscriptionTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductSubscriptionTypeModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawProducts.First().Object.ID,
                SlaveID = mockingSetup.RawSubscriptionTypes.First().Object.ID,
                SubscriptionTypeRepeatTypeID = mockingSetup.RawSubscriptionTypeRepeatTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Products.ProductSubscriptionTypes.Standard")]
    public partial class Products_ProductSubscriptionTypes_StandardWorkflowTests : Products_ProductSubscriptionTypes_WorkflowTestsBase
    {
        public Products_ProductSubscriptionTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
