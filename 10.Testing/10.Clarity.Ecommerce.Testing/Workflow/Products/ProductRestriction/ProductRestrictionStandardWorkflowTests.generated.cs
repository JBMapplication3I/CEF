...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductRestrictions_WorkflowTestsBase
        : AbstractBase<
            IProductRestriction,
            ProductRestriction,
            IProductRestrictionModel,
            ProductRestrictionModel,
            IProductRestrictionSearchModel,
            ProductRestrictionSearchModel,
            ProductRestrictionWorkflow>
    {
        protected Products_ProductRestrictions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductRestrictionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoProductRestrictionTable = true,
                DoRegionTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ProductRestriction>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductRestrictions;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductRestriction>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductRestrictions;
        }

        /// <inheritdoc/>
        protected override async Task<ProductRestrictionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductRestrictionModel
            {
                Active = true,
                ...
                OverrideWithAccountTypeID = null,
                RestrictionsApplyToCountryID = null,
                RestrictionsApplyToRegionID = null,
            };
        }
    }

    [Trait("Category", "Workflows.Products.ProductRestrictions.Standard")]
    public partial class Products_ProductRestrictions_StandardWorkflowTests : Products_ProductRestrictions_WorkflowTestsBase
    {
        public Products_ProductRestrictions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
