...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductAssociations_WorkflowTestsBase
        : AbstractBase<
            IProductAssociation,
            ProductAssociation,
            IProductAssociationModel,
            ProductAssociationModel,
            IProductAssociationSearchModel,
            ProductAssociationSearchModel,
            ProductAssociationWorkflow>
    {
        protected Products_ProductAssociations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductAssociationTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductAssociation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductAssociations;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductAssociation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductAssociations;
        }

        /// <inheritdoc/>
        protected override async Task<ProductAssociationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductAssociationModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawProductAssociationTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Products.ProductAssociations.Standard")]
    public partial class Products_ProductAssociations_StandardWorkflowTests : Products_ProductAssociations_WorkflowTestsBase
    {
        public Products_ProductAssociations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
