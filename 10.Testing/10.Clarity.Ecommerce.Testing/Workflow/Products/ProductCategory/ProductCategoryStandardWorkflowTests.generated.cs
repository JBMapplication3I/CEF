...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductCategories_WorkflowTestsBase
        : AbstractBase<
            IProductCategory,
            ProductCategory,
            IProductCategoryModel,
            ProductCategoryModel,
            IProductCategorySearchModel,
            ProductCategorySearchModel,
            ProductCategoryWorkflow>
    {
        protected Products_ProductCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductCategories;
        }

        /// <inheritdoc/>
        protected override async Task<ProductCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Products.ProductCategories.Standard")]
    public partial class Products_ProductCategories_StandardWorkflowTests : Products_ProductCategories_WorkflowTestsBase
    {
        public Products_ProductCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
