...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IProductImageType,
            ProductImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            ProductImageTypeWorkflow>
    {
        protected Products_ProductImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Products.ProductImageTypes.Standard")]
    public partial class Products_ProductImageTypes_StandardWorkflowTests : Products_ProductImageTypes_WorkflowTestsBase
    {
        public Products_ProductImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
