...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductInventoryLocationSections_WorkflowTestsBase
        : AbstractBase<
            IProductInventoryLocationSection,
            ProductInventoryLocationSection,
            IProductInventoryLocationSectionModel,
            ...
            ProductInventoryLocationSectionWorkflow>
    {
        protected Products_ProductInventoryLocationSections_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductInventoryLocationSectionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductInventoryLocationSection>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductInventoryLocationSections;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductInventoryLocationSection>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductInventoryLocationSections;
        }

        /// <inheritdoc/>
        protected override async Task<ProductInventoryLocationSectionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductInventoryLocationSectionModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawInventoryLocationSections.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Products.ProductInventoryLocationSections.Standard")]
    public partial class Products_ProductInventoryLocationSections_StandardWorkflowTests : Products_ProductInventoryLocationSections_WorkflowTestsBase
    {
        public Products_ProductInventoryLocationSections_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
