...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_ProductDownloads_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            ProductDownloadSearchModel,
            ProductDownloadWorkflow>
    {
        protected Products_ProductDownloads_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoProductDownloadTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoProductTable = true,
                DoProductDownloadTable = true,
                DoProductDownloadTypeTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ProductDownload>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ProductDownloads;
        }

        /// <inheritdoc/>
        protected override List<Mock<ProductDownload>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawProductDownloads;
        }

        /// <inheritdoc/>
        protected override async Task<ProductDownloadModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ProductDownloadModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawProductDownloadTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Products.ProductDownloads.Standard")]
    public partial class Products_ProductDownloads_StandardWorkflowTests : Products_ProductDownloads_WorkflowTestsBase
    {
        public Products_ProductDownloads_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
