...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Products_FutureImportStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            FutureImportStatusWorkflow>
    {
        protected Products_FutureImportStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFutureImportStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FutureImportStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FutureImportStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<FutureImportStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFutureImportStatuses;
        }
    ...
    [Trait("Category", "Workflows.Products.FutureImportStatuses.Standard")]
    public partial class Products_FutureImportStatuses_StandardWorkflowTests : Products_FutureImportStatuses_WorkflowTestsBase
    {
        public Products_FutureImportStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
