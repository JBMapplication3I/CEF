...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandCategories_WorkflowTestsBase
        : AbstractBase<
            IBrandCategory,
            BrandCategory,
            IBrandCategoryModel,
            BrandCategoryModel,
            IBrandCategorySearchModel,
            BrandCategorySearchModel,
            BrandCategoryWorkflow>
    {
        protected Brands_BrandCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandCategories;
        }

        /// <inheritdoc/>
        protected override async Task<BrandCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Brands.BrandCategories.Standard")]
    public partial class Brands_BrandCategories_StandardWorkflowTests : Brands_BrandCategories_WorkflowTestsBase
    {
        public Brands_BrandCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
