...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_Brands_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            BrandWorkflow>
    {
        protected Brands_Brands_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoBrandTable = true,
                DoBrandAccountTable = true,
                DoBrandCurrencyTable = true,
                DoBrandFranchiseTable = true,
                DoBrandImageTable = true,
                DoBrandInventoryLocationTable = true,
                DoBrandLanguageTable = true,
                DoBrandProductTable = true,
                DoBrandSiteDomainTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Brand>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Brands;
        }

        /// <inheritdoc/>
        protected override List<Mock<Brand>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrands;
        }

        /// <inheritdoc/>
        protected override async Task<BrandModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Brands.Brands.Standard")]
    public partial class Brands_Brands_StandardWorkflowTests : Brands_Brands_WorkflowTestsBase
    {
        public Brands_Brands_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
