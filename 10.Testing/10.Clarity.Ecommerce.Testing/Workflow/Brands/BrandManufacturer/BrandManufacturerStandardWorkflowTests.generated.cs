...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandManufacturers_WorkflowTestsBase
        : AbstractBase<
            IBrandManufacturer,
            BrandManufacturer,
            ...
            BrandManufacturerSearchModel,
            BrandManufacturerWorkflow>
    {
        protected Brands_BrandManufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandManufacturerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandManufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandManufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandManufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<BrandManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandManufacturerModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandManufacturers.Standard")]
    public partial class Brands_BrandManufacturers_StandardWorkflowTests : Brands_BrandManufacturers_WorkflowTestsBase
    {
        public Brands_BrandManufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
