...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandProducts_WorkflowTestsBase
        : AbstractBase<
            IBrandProduct,
            BrandProduct,
            IBrandProductModel,
            ...
            BrandProductSearchModel,
            BrandProductWorkflow>
    {
        protected Brands_BrandProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandProducts;
        }

        /// <inheritdoc/>
        protected override async Task<BrandProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Brands.BrandProducts.Standard")]
    public partial class Brands_BrandProducts_StandardWorkflowTests : Brands_BrandProducts_WorkflowTestsBase
    {
        public Brands_BrandProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
