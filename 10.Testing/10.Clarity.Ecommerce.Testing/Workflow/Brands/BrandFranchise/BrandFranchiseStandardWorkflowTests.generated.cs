...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandFranchises_WorkflowTestsBase
        : AbstractBase<
            IBrandFranchise,
            BrandFranchise,
            IBrandFranchiseModel,
            BrandFranchiseModel,
            IBrandFranchiseSearchModel,
            BrandFranchiseSearchModel,
            BrandFranchiseWorkflow>
    {
        protected Brands_BrandFranchises_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandFranchiseTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandFranchise>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandFranchises;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandFranchise>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandFranchises;
        }

        /// <inheritdoc/>
        protected override async Task<BrandFranchiseModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandFranchiseModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandFranchises.Standard")]
    public partial class Brands_BrandFranchises_StandardWorkflowTests : Brands_BrandFranchises_WorkflowTestsBase
    {
        public Brands_BrandFranchises_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
