...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandVendors_WorkflowTestsBase
        : AbstractBase<
            IBrandVendor,
            BrandVendor,
            IBrandVendorModel,
            BrandVendorModel,
            IBrandVendorSearchModel,
            BrandVendorSearchModel,
            BrandVendorWorkflow>
    {
        protected Brands_BrandVendors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandVendorTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandVendor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandVendors;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandVendor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandVendors;
        }

        /// <inheritdoc/>
        protected override async Task<BrandVendorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandVendorModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandVendors.Standard")]
    public partial class Brands_BrandVendors_StandardWorkflowTests : Brands_BrandVendors_WorkflowTestsBase
    {
        public Brands_BrandVendors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
