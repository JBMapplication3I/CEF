...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandLanguages_WorkflowTestsBase
        : AbstractBase<
            IBrandLanguage,
            BrandLanguage,
            IBrandLanguageModel,
            ...
            BrandLanguageWorkflow>
    {
        protected Brands_BrandLanguages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandLanguageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandLanguage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandLanguages;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandLanguage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandLanguages;
        }

        /// <inheritdoc/>
        protected override async Task<BrandLanguageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandLanguageModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandLanguages.Standard")]
    public partial class Brands_BrandLanguages_StandardWorkflowTests : Brands_BrandLanguages_WorkflowTestsBase
    {
        public Brands_BrandLanguages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
