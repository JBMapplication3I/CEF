...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandSiteDomains_WorkflowTestsBase
        : AbstractBase<
            IBrandSiteDomain,
            BrandSiteDomain,
            IBrandSiteDomainModel,
            BrandSiteDomainModel,
            IBrandSiteDomainSearchModel,
            BrandSiteDomainSearchModel,
            BrandSiteDomainWorkflow>
    {
        protected Brands_BrandSiteDomains_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandSiteDomainTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandSiteDomain>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandSiteDomains;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandSiteDomain>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandSiteDomains;
        }

        /// <inheritdoc/>
        protected override async Task<BrandSiteDomainModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandSiteDomainModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandSiteDomains.Standard")]
    public partial class Brands_BrandSiteDomains_StandardWorkflowTests : Brands_BrandSiteDomains_WorkflowTestsBase
    {
        public Brands_BrandSiteDomains_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
