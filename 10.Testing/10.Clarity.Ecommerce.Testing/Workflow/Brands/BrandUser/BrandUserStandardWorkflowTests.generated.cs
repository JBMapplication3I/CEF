...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandUsers_WorkflowTestsBase
        : AbstractBase<
            IBrandUser,
            BrandUser,
            IBrandUserModel,
            ...
            BrandUserSearchModel,
            BrandUserWorkflow>
    {
        protected Brands_BrandUsers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandUserTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandUser>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandUsers;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandUser>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandUsers;
        }

        /// <inheritdoc/>
        protected override async Task<BrandUserModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandUserModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandUsers.Standard")]
    public partial class Brands_BrandUsers_StandardWorkflowTests : Brands_BrandUsers_WorkflowTestsBase
    {
        public Brands_BrandUsers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
