// <autogenerated>
// <copyright file="Brands.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandInventoryLocations_WorkflowTestsBase
        : AbstractBase<
            IBrandInventoryLocation,
            BrandInventoryLocation,
            IBrandInventoryLocationModel,
            BrandInventoryLocationModel,
            IBrandInventoryLocationSearchModel,
            BrandInventoryLocationSearchModel,
            BrandInventoryLocationWorkflow>
    {
        protected Brands_BrandInventoryLocations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandInventoryLocationTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoBrandTable = true,
                DoBrandInventoryLocationTable = true,
                DoBrandInventoryLocationTypeTable = true,
                DoInventoryLocationTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<BrandInventoryLocation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandInventoryLocations;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandInventoryLocation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandInventoryLocations;
        }

        /// <inheritdoc/>
        protected override async Task<BrandInventoryLocationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandInventoryLocationModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawBrands.First().Object.ID,
                SlaveID = mockingSetup.RawInventoryLocations.First().Object.ID,
                TypeID = mockingSetup.RawBrandInventoryLocationTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Brands.BrandInventoryLocations.Standard")]
    public partial class Brands_BrandInventoryLocations_StandardWorkflowTests : Brands_BrandInventoryLocations_WorkflowTestsBase
    {
        public Brands_BrandInventoryLocations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
