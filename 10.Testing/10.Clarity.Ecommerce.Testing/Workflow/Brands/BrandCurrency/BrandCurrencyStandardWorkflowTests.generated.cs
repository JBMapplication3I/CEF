...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandCurrencies_WorkflowTestsBase
        : AbstractBase<
            IBrandCurrency,
            BrandCurrency,
            IBrandCurrencyModel,
            ...
            BrandCurrencyWorkflow>
    {
        protected Brands_BrandCurrencies_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandCurrencyTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandCurrency>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandCurrencies;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandCurrency>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandCurrencies;
        }

        /// <inheritdoc/>
        protected override async Task<BrandCurrencyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandCurrencyModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandCurrencies.Standard")]
    public partial class Brands_BrandCurrencies_StandardWorkflowTests : Brands_BrandCurrencies_WorkflowTestsBase
    {
        public Brands_BrandCurrencies_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
