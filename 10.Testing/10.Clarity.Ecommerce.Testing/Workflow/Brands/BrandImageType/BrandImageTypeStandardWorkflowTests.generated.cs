...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IBrandImageType,
            BrandImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            BrandImageTypeWorkflow>
    {
        protected Brands_BrandImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Brands.BrandImageTypes.Standard")]
    public partial class Brands_BrandImageTypes_StandardWorkflowTests : Brands_BrandImageTypes_WorkflowTestsBase
    {
        public Brands_BrandImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
