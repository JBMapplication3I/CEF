...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandImages_WorkflowTestsBase
        : AbstractNameableBase<
            IBrandImage,
            BrandImage,
            IBrandImageModel,
            BrandImageModel,
            IBrandImageSearchModel,
            BrandImageSearchModel,
            BrandImageWorkflow>
    {
        protected Brands_BrandImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoBrandImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<BrandImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandImages;
        }

        /// <inheritdoc/>
        protected override async Task<BrandImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawBrandImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Brands.BrandImages.Standard")]
    public partial class Brands_BrandImages_StandardWorkflowTests : Brands_BrandImages_WorkflowTestsBase
    {
        public Brands_BrandImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
