...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandInventoryLocationTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IBrandInventoryLocationType,
            BrandInventoryLocationType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            BrandInventoryLocationTypeWorkflow>
    {
        protected Brands_BrandInventoryLocationTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandInventoryLocationTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandInventoryLocationType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandInventoryLocationTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandInventoryLocationType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandInventoryLocationTypes;
        }
    ...
    [Trait("Category", "Workflows.Brands.BrandInventoryLocationTypes.Standard")]
    public partial class Brands_BrandInventoryLocationTypes_StandardWorkflowTests : Brands_BrandInventoryLocationTypes_WorkflowTestsBase
    {
        public Brands_BrandInventoryLocationTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
