...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandStores_WorkflowTestsBase
        : AbstractBase<
            IBrandStore,
            BrandStore,
            IBrandStoreModel,
            ...
            BrandStoreSearchModel,
            BrandStoreWorkflow>
    {
        protected Brands_BrandStores_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandStoreTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandStore>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandStores;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandStore>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandStores;
        }

        /// <inheritdoc/>
        protected override async Task<BrandStoreModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandStoreModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandStores.Standard")]
    public partial class Brands_BrandStores_StandardWorkflowTests : Brands_BrandStores_WorkflowTestsBase
    {
        public Brands_BrandStores_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
