...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Brands_BrandAccounts_WorkflowTestsBase
        : AbstractBase<
            IBrandAccount,
            BrandAccount,
            IBrandAccountModel,
            ...
            BrandAccountSearchModel,
            BrandAccountWorkflow>
    {
        protected Brands_BrandAccounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandAccountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandAccount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandAccounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandAccount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<BrandAccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandAccountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Brands.BrandAccounts.Standard")]
    public partial class Brands_BrandAccounts_StandardWorkflowTests : Brands_BrandAccounts_WorkflowTestsBase
    {
        public Brands_BrandAccounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
