...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_Franchises_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            FranchiseWorkflow>
    {
        protected Franchises_Franchises_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Franchise>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Franchises;
        }

        /// <inheritdoc/>
        protected override List<Mock<Franchise>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchises;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseModel
            {
                ...
                TypeID = mockingSetup.RawFranchiseTypes.First().Object.ID,
                // Optional Related Properties
                MinimumOrderDollarAmountBufferProductID = null,
                MinimumOrderQuantityAmountBufferProductID = null,
                MinimumOrderDollarAmountBufferCategoryID = null,
                MinimumOrderQuantityAmountBufferCategoryID = null,
                MinimumForFreeShippingDollarAmountBufferProductID = null,
                MinimumForFreeShippingQuantityAmountBufferProductID = null,
                MinimumForFreeShippingDollarAmountBufferCategoryID = null,
                MinimumForFreeShippingQuantityAmountBufferCategoryID = null,
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.Franchises.Standard")]
    public partial class Franchises_Franchises_StandardWorkflowTests : Franchises_Franchises_WorkflowTestsBase
    {
        public Franchises_Franchises_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
