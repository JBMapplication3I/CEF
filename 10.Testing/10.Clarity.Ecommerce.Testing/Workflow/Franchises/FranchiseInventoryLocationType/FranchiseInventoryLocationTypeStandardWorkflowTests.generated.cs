...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseInventoryLocationTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IFranchiseInventoryLocationType,
            FranchiseInventoryLocationType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            FranchiseInventoryLocationTypeWorkflow>
    {
        protected Franchises_FranchiseInventoryLocationTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseInventoryLocationTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseInventoryLocationType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseInventoryLocationTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseInventoryLocationType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseInventoryLocationTypes;
        }

        /// <inheritdoc/>
        protected override async Task<TypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseInventoryLocationTypes.Standard")]
    public partial class Franchises_FranchiseInventoryLocationTypes_StandardWorkflowTests : Franchises_FranchiseInventoryLocationTypes_WorkflowTestsBase
    {
        public Franchises_FranchiseInventoryLocationTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
