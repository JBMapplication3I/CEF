...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseImages_WorkflowTestsBase
        : AbstractNameableBase<
            IFranchiseImage,
            FranchiseImage,
            IFranchiseImageModel,
            FranchiseImageModel,
            IFranchiseImageSearchModel,
            FranchiseImageSearchModel,
            FranchiseImageWorkflow>
    {
        protected Franchises_FranchiseImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoFranchiseImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseImages;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawFranchiseImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseImages.Standard")]
    public partial class Franchises_FranchiseImages_StandardWorkflowTests : Franchises_FranchiseImages_WorkflowTestsBase
    {
        public Franchises_FranchiseImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
