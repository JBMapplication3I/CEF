...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseAccounts_WorkflowTestsBase
        : AbstractBase<
            IFranchiseAccount,
            FranchiseAccount,
            IFranchiseAccountModel,
            FranchiseAccountModel,
            IFranchiseAccountSearchModel,
            FranchiseAccountSearchModel,
            FranchiseAccountWorkflow>
    {
        protected Franchises_FranchiseAccounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseAccountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseAccount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseAccounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseAccount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseAccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseAccountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseAccounts.Standard")]
    public partial class Franchises_FranchiseAccounts_StandardWorkflowTests : Franchises_FranchiseAccounts_WorkflowTestsBase
    {
        public Franchises_FranchiseAccounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
