...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseCurrencies_WorkflowTestsBase
        : AbstractBase<
            IFranchiseCurrency,
            FranchiseCurrency,
            IFranchiseCurrencyModel,
            FranchiseCurrencyModel,
            IFranchiseCurrencySearchModel,
            FranchiseCurrencySearchModel,
            FranchiseCurrencyWorkflow>
    {
        protected Franchises_FranchiseCurrencies_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseCurrencyTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseCurrency>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseCurrencies;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseCurrency>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseCurrencies;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseCurrencyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseCurrencyModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawCurrencies.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseCurrencies.Standard")]
    public partial class Franchises_FranchiseCurrencies_StandardWorkflowTests : Franchises_FranchiseCurrencies_WorkflowTestsBase
    {
        public Franchises_FranchiseCurrencies_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
