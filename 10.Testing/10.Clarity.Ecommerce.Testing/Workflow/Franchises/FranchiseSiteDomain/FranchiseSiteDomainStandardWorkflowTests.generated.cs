...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseSiteDomains_WorkflowTestsBase
        : AbstractBase<
            IFranchiseSiteDomain,
            FranchiseSiteDomain,
            IFranchiseSiteDomainModel,
            FranchiseSiteDomainModel,
            IFranchiseSiteDomainSearchModel,
            FranchiseSiteDomainSearchModel,
            FranchiseSiteDomainWorkflow>
    {
        protected Franchises_FranchiseSiteDomains_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseSiteDomainTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseSiteDomain>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseSiteDomains;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseSiteDomain>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseSiteDomains;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseSiteDomainModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseSiteDomainModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawSiteDomains.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseSiteDomains.Standard")]
    public partial class Franchises_FranchiseSiteDomains_StandardWorkflowTests : Franchises_FranchiseSiteDomains_WorkflowTestsBase
    {
        public Franchises_FranchiseSiteDomains_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
