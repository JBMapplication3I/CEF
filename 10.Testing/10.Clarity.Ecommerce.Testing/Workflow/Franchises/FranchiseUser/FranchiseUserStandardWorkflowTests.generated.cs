...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseUsers_WorkflowTestsBase
        : AbstractBase<
            IFranchiseUser,
            FranchiseUser,
            IFranchiseUserModel,
            ...
            FranchiseUserSearchModel,
            FranchiseUserWorkflow>
    {
        protected Franchises_FranchiseUsers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseUserTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseUser>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseUsers;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseUser>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseUsers;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseUserModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseUserModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseUsers.Standard")]
    public partial class Franchises_FranchiseUsers_StandardWorkflowTests : Franchises_FranchiseUsers_WorkflowTestsBase
    {
        public Franchises_FranchiseUsers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
