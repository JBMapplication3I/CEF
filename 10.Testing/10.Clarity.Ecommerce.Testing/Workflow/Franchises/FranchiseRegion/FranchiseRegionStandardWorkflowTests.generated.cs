...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseRegions_WorkflowTestsBase
        : AbstractBase<
            IFranchiseRegion,
            FranchiseRegion,
            IFranchiseRegionModel,
            FranchiseRegionModel,
            IFranchiseRegionSearchModel,
            FranchiseRegionSearchModel,
            FranchiseRegionWorkflow>
    {
        protected Franchises_FranchiseRegions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseRegionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseRegion>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseRegions;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseRegion>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseRegions;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseRegionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseRegionModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseRegions.Standard")]
    public partial class Franchises_FranchiseRegions_StandardWorkflowTests : Franchises_FranchiseRegions_WorkflowTestsBase
    {
        public Franchises_FranchiseRegions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
