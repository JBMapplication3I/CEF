...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseDistricts_WorkflowTestsBase
        : AbstractBase<
            IFranchiseDistrict,
            FranchiseDistrict,
            IFranchiseDistrictModel,
            FranchiseDistrictModel,
            IFranchiseDistrictSearchModel,
            FranchiseDistrictSearchModel,
            FranchiseDistrictWorkflow>
    {
        protected Franchises_FranchiseDistricts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseDistrictTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseDistrict>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseDistricts;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseDistrict>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseDistricts;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseDistrictModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseDistrictModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawDistricts.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseDistricts.Standard")]
    public partial class Franchises_FranchiseDistricts_StandardWorkflowTests : Franchises_FranchiseDistricts_WorkflowTestsBase
    {
        public Franchises_FranchiseDistricts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
