...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IFranchiseType,
            FranchiseType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            FranchiseTypeWorkflow>
    {
        protected Franchises_FranchiseTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseTypes;
        }
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseTypes.Standard")]
    public partial class Franchises_FranchiseTypes_StandardWorkflowTests : Franchises_FranchiseTypes_WorkflowTestsBase
    {
        public Franchises_FranchiseTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
