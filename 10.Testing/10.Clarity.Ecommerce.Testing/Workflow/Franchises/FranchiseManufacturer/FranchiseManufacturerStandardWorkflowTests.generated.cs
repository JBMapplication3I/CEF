...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseManufacturers_WorkflowTestsBase
        : AbstractBase<
            IFranchiseManufacturer,
            FranchiseManufacturer,
            IFranchiseManufacturerModel,
            FranchiseManufacturerModel,
            IFranchiseManufacturerSearchModel,
            FranchiseManufacturerSearchModel,
            FranchiseManufacturerWorkflow>
    {
        protected Franchises_FranchiseManufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseManufacturerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseManufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseManufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseManufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseManufacturerModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawManufacturers.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseManufacturers.Standard")]
    public partial class Franchises_FranchiseManufacturers_StandardWorkflowTests : Franchises_FranchiseManufacturers_WorkflowTestsBase
    {
        public Franchises_FranchiseManufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
