...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseCountries_WorkflowTestsBase
        : AbstractBase<
            IFranchiseCountry,
            FranchiseCountry,
            IFranchiseCountryModel,
            FranchiseCountryModel,
            IFranchiseCountrySearchModel,
            FranchiseCountrySearchModel,
            FranchiseCountryWorkflow>
    {
        protected Franchises_FranchiseCountries_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseCountryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseCountry>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseCountries;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseCountry>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseCountries;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseCountryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseCountryModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawCountries.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseCountries.Standard")]
    public partial class Franchises_FranchiseCountries_StandardWorkflowTests : Franchises_FranchiseCountries_WorkflowTestsBase
    {
        public Franchises_FranchiseCountries_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
