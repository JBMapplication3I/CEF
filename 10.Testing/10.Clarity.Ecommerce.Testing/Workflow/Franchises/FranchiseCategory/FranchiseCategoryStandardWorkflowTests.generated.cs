...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseCategories_WorkflowTestsBase
        : AbstractBase<
            IFranchiseCategory,
            FranchiseCategory,
            IFranchiseCategoryModel,
            FranchiseCategoryModel,
            IFranchiseCategorySearchModel,
            FranchiseCategorySearchModel,
            FranchiseCategoryWorkflow>
    {
        protected Franchises_FranchiseCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseCategories;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseCategoryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseCategories.Standard")]
    public partial class Franchises_FranchiseCategories_StandardWorkflowTests : Franchises_FranchiseCategories_WorkflowTestsBase
    {
        public Franchises_FranchiseCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
