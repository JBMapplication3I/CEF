...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseLanguages_WorkflowTestsBase
        : AbstractBase<
            IFranchiseLanguage,
            FranchiseLanguage,
            IFranchiseLanguageModel,
            FranchiseLanguageModel,
            IFranchiseLanguageSearchModel,
            FranchiseLanguageSearchModel,
            FranchiseLanguageWorkflow>
    {
        protected Franchises_FranchiseLanguages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseLanguageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseLanguage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseLanguages;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseLanguage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseLanguages;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseLanguageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseLanguageModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawLanguages.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseLanguages.Standard")]
    public partial class Franchises_FranchiseLanguages_StandardWorkflowTests : Franchises_FranchiseLanguages_WorkflowTestsBase
    {
        public Franchises_FranchiseLanguages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
