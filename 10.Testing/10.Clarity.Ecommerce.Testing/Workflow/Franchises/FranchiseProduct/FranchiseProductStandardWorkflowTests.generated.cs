...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseProducts_WorkflowTestsBase
        : AbstractBase<
            IFranchiseProduct,
            FranchiseProduct,
            IFranchiseProductModel,
            FranchiseProductModel,
            IFranchiseProductSearchModel,
            FranchiseProductSearchModel,
            FranchiseProductWorkflow>
    {
        protected Franchises_FranchiseProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseProducts;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseProductModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseProducts.Standard")]
    public partial class Franchises_FranchiseProducts_StandardWorkflowTests : Franchises_FranchiseProducts_WorkflowTestsBase
    {
        public Franchises_FranchiseProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
        ...
        public virtual async Task Verify_ThisTablesTests_Create_RunAppropriately()
        {
            await Task.WhenAll(
                ...
                // Skip: Duplicates Allowed for this Entity kind: Verify_Create_WithADuplicateKey_Should_ThrowAnInvalidOperationException(),
