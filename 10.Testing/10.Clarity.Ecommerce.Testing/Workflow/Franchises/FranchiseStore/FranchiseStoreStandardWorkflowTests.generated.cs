...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseStores_WorkflowTestsBase
        : AbstractBase<
            IFranchiseStore,
            FranchiseStore,
            IFranchiseStoreModel,
            FranchiseStoreModel,
            IFranchiseStoreSearchModel,
            FranchiseStoreSearchModel,
            FranchiseStoreWorkflow>
    {
        protected Franchises_FranchiseStores_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseStoreTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseStore>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseStores;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseStore>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseStores;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseStoreModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseStoreModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawStores.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseStores.Standard")]
    public partial class Franchises_FranchiseStores_StandardWorkflowTests : Franchises_FranchiseStores_WorkflowTestsBase
    {
        public Franchises_FranchiseStores_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
