...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IFranchiseImageType,
            FranchiseImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            FranchiseImageTypeWorkflow>
    {
        protected Franchises_FranchiseImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Franchises.FranchiseImageTypes.Standard")]
    public partial class Franchises_FranchiseImageTypes_StandardWorkflowTests : Franchises_FranchiseImageTypes_WorkflowTestsBase
    {
        public Franchises_FranchiseImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
