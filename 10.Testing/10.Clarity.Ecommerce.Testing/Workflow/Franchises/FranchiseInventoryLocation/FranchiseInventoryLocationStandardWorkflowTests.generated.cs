...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Franchises_FranchiseInventoryLocations_WorkflowTestsBase
        : AbstractBase<
            IFranchiseInventoryLocation,
            FranchiseInventoryLocation,
            IFranchiseInventoryLocationModel,
            FranchiseInventoryLocationModel,
            IFranchiseInventoryLocationSearchModel,
            FranchiseInventoryLocationSearchModel,
            FranchiseInventoryLocationWorkflow>
    {
        protected Franchises_FranchiseInventoryLocations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseInventoryLocationTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoFranchiseInventoryLocationTable = true,
                DoFranchiseInventoryLocationTypeTable = true,
                DoInventoryLocationTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseInventoryLocation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseInventoryLocations;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseInventoryLocation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseInventoryLocations;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseInventoryLocationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseInventoryLocationModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawInventoryLocations.First().Object.ID,
                TypeID = mockingSetup.RawFranchiseInventoryLocationTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Franchises.FranchiseInventoryLocations.Standard")]
    public partial class Franchises_FranchiseInventoryLocations_StandardWorkflowTests : Franchises_FranchiseInventoryLocations_WorkflowTestsBase
    {
        public Franchises_FranchiseInventoryLocations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
