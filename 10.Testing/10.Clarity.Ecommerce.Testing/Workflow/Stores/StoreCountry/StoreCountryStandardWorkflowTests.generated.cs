...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreCountries_WorkflowTestsBase
        : AbstractBase<
            IStoreCountry,
            StoreCountry,
            IStoreCountryModel,
            StoreCountryModel,
            IStoreCountrySearchModel,
            StoreCountrySearchModel,
            StoreCountryWorkflow>
    {
        protected Stores_StoreCountries_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreCountryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreCountry>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreCountries;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreCountry>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreCountries;
        }

        /// <inheritdoc/>
        protected override async Task<StoreCountryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreCountryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Stores.StoreCountries.Standard")]
    public partial class Stores_StoreCountries_StandardWorkflowTests : Stores_StoreCountries_WorkflowTestsBase
    {
        public Stores_StoreCountries_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
