...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreInventoryLocationTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IStoreInventoryLocationType,
            StoreInventoryLocationType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            StoreInventoryLocationTypeWorkflow>
    {
        protected Stores_StoreInventoryLocationTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreInventoryLocationTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreInventoryLocationType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreInventoryLocationTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreInventoryLocationType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreInventoryLocationTypes;
        }
    ...
    [Trait("Category", "Workflows.Stores.StoreInventoryLocationTypes.Standard")]
    public partial class Stores_StoreInventoryLocationTypes_StandardWorkflowTests : Stores_StoreInventoryLocationTypes_WorkflowTestsBase
    {
        public Stores_StoreInventoryLocationTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
