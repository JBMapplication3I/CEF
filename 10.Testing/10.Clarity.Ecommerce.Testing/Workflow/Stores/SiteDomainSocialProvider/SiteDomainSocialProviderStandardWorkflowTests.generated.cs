// <autogenerated>
// <copyright file="Stores.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_SiteDomainSocialProviders_WorkflowTestsBase
        : AbstractBase<
            ISiteDomainSocialProvider,
            SiteDomainSocialProvider,
            ISiteDomainSocialProviderModel,
            SiteDomainSocialProviderModel,
            ISiteDomainSocialProviderSearchModel,
            SiteDomainSocialProviderSearchModel,
            SiteDomainSocialProviderWorkflow>
    {
        protected Stores_SiteDomainSocialProviders_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSiteDomainSocialProviderTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoSiteDomainTable = true,
                DoSiteDomainSocialProviderTable = true,
                DoSocialProviderTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SiteDomainSocialProvider>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SiteDomainSocialProviders;
        }

        /// <inheritdoc/>
        protected override List<Mock<SiteDomainSocialProvider>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSiteDomainSocialProviders;
        }

        /// <inheritdoc/>
        protected override async Task<SiteDomainSocialProviderModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SiteDomainSocialProviderModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawSiteDomains.First().Object.ID,
                SlaveID = mockingSetup.RawSocialProviders.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Stores.SiteDomainSocialProviders.Standard")]
    public partial class Stores_SiteDomainSocialProviders_StandardWorkflowTests : Stores_SiteDomainSocialProviders_WorkflowTestsBase
    {
        public Stores_SiteDomainSocialProviders_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
