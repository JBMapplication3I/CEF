...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IStoreImageType,
            StoreImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            StoreImageTypeWorkflow>
    {
        protected Stores_StoreImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Stores.StoreImageTypes.Standard")]
    public partial class Stores_StoreImageTypes_StandardWorkflowTests : Stores_StoreImageTypes_WorkflowTestsBase
    {
        public Stores_StoreImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
