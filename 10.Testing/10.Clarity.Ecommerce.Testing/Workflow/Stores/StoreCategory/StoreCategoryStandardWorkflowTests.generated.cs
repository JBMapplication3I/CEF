...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreCategories_WorkflowTestsBase
        : AbstractBase<
            IStoreCategory,
            StoreCategory,
            IStoreCategoryModel,
            StoreCategoryModel,
            IStoreCategorySearchModel,
            StoreCategorySearchModel,
            StoreCategoryWorkflow>
    {
        protected Stores_StoreCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreCategories;
        }

        /// <inheritdoc/>
        protected override async Task<StoreCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Stores.StoreCategories.Standard")]
    public partial class Stores_StoreCategories_StandardWorkflowTests : Stores_StoreCategories_WorkflowTestsBase
    {
        public Stores_StoreCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
