...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreContacts_WorkflowTestsBase
        : AbstractNameableBase<
            IStoreContact,
            StoreContact,
            IStoreContactModel,
            StoreContactModel,
            IStoreContactSearchModel,
            StoreContactSearchModel,
            StoreContactWorkflow>
    {
        protected Stores_StoreContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreContacts;
        }

        /// <inheritdoc/>
        protected override async Task<StoreContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Stores.StoreContacts.Standard")]
    public partial class Stores_StoreContacts_StandardWorkflowTests : Stores_StoreContacts_WorkflowTestsBase
    {
        public Stores_StoreContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
