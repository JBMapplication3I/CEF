...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreImages_WorkflowTestsBase
        : AbstractNameableBase<
            IStoreImage,
            StoreImage,
            IStoreImageModel,
            StoreImageModel,
            IStoreImageSearchModel,
            StoreImageSearchModel,
            StoreImageWorkflow>
    {
        protected Stores_StoreImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoStoreImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<StoreImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreImages;
        }

        /// <inheritdoc/>
        protected override async Task<StoreImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawStoreImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Stores.StoreImages.Standard")]
    public partial class Stores_StoreImages_StandardWorkflowTests : Stores_StoreImages_WorkflowTestsBase
    {
        public Stores_StoreImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
