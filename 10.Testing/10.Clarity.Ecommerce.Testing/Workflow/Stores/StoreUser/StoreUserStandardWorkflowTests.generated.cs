...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreUsers_WorkflowTestsBase
        : AbstractBase<
            IStoreUser,
            StoreUser,
            IStoreUserModel,
            StoreUserModel,
            IStoreUserSearchModel,
            StoreUserSearchModel,
            StoreUserWorkflow>
    {
        protected Stores_StoreUsers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreUserTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreUser>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreUsers;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreUser>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreUsers;
        }

        /// <inheritdoc/>
        protected override async Task<StoreUserModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Stores.StoreUsers.Standard")]
    public partial class Stores_StoreUsers_StandardWorkflowTests : Stores_StoreUsers_WorkflowTestsBase
    {
        public Stores_StoreUsers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
