...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IStoreType,
            StoreType,
            ITypeModel,
            ...
            StoreTypeWorkflow>
    {
        protected Stores_StoreTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreTypes;
        }
    ...
    [Trait("Category", "Workflows.Stores.StoreTypes.Standard")]
    public partial class Stores_StoreTypes_StandardWorkflowTests : Stores_StoreTypes_WorkflowTestsBase
    {
        public Stores_StoreTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
