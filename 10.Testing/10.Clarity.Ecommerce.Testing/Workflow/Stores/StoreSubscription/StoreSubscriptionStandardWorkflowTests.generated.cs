...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreSubscriptions_WorkflowTestsBase
        : AbstractBase<
            IStoreSubscription,
            StoreSubscription,
            IStoreSubscriptionModel,
            StoreSubscriptionModel,
            IStoreSubscriptionSearchModel,
            StoreSubscriptionSearchModel,
            StoreSubscriptionWorkflow>
    {
        protected Stores_StoreSubscriptions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreSubscriptionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreSubscription>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreSubscriptions;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreSubscription>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreSubscriptions;
        }

        /// <inheritdoc/>
        protected override async Task<StoreSubscriptionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreSubscriptionModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawSubscriptions.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Stores.StoreSubscriptions.Standard")]
    public partial class Stores_StoreSubscriptions_StandardWorkflowTests : Stores_StoreSubscriptions_WorkflowTestsBase
    {
        public Stores_StoreSubscriptions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
