...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreAccounts_WorkflowTestsBase
        : AbstractBase<
            IStoreAccount,
            StoreAccount,
            IStoreAccountModel,
            ...
            StoreAccountSearchModel,
            StoreAccountWorkflow>
    {
        protected Stores_StoreAccounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreAccountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreAccount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreAccounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreAccount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<StoreAccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreAccountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Stores.StoreAccounts.Standard")]
    public partial class Stores_StoreAccounts_StandardWorkflowTests : Stores_StoreAccounts_WorkflowTestsBase
    {
        public Stores_StoreAccounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
