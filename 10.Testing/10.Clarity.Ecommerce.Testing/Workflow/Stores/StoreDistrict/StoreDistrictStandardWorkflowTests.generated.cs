...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreDistricts_WorkflowTestsBase
        : AbstractBase<
            IStoreDistrict,
            StoreDistrict,
            IStoreDistrictModel,
            StoreDistrictModel,
            IStoreDistrictSearchModel,
            StoreDistrictSearchModel,
            StoreDistrictWorkflow>
    {
        protected Stores_StoreDistricts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreDistrictTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreDistrict>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreDistricts;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreDistrict>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreDistricts;
        }

        /// <inheritdoc/>
        protected override async Task<StoreDistrictModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreDistrictModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Stores.StoreDistricts.Standard")]
    public partial class Stores_StoreDistricts_StandardWorkflowTests : Stores_StoreDistricts_WorkflowTestsBase
    {
        public Stores_StoreDistricts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
