...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreProducts_WorkflowTestsBase
        : AbstractBase<
            IStoreProduct,
            StoreProduct,
            IStoreProductModel,
            ...
            StoreProductSearchModel,
            StoreProductWorkflow>
    {
        protected Stores_StoreProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreProducts;
        }

        /// <inheritdoc/>
        protected override async Task<StoreProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Stores.StoreProducts.Standard")]
    public partial class Stores_StoreProducts_StandardWorkflowTests : Stores_StoreProducts_WorkflowTestsBase
    {
        public Stores_StoreProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
