...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreRegions_WorkflowTestsBase
        : AbstractBase<
            IStoreRegion,
            StoreRegion,
            IStoreRegionModel,
            ...
            StoreRegionWorkflow>
    {
        protected Stores_StoreRegions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreRegionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreRegion>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreRegions;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreRegion>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreRegions;
        }

        /// <inheritdoc/>
        protected override async Task<StoreRegionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreRegionModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Stores.StoreRegions.Standard")]
    public partial class Stores_StoreRegions_StandardWorkflowTests : Stores_StoreRegions_WorkflowTestsBase
    {
        public Stores_StoreRegions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
