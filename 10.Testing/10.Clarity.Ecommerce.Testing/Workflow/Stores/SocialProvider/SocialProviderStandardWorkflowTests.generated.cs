...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_SocialProviders_WorkflowTestsBase
        : AbstractNameableBase<
            ISocialProvider,
            SocialProvider,
            ISocialProviderModel,
            SocialProviderModel,
            ISocialProviderSearchModel,
            SocialProviderSearchModel,
            SocialProviderWorkflow>
    {
        protected Stores_SocialProviders_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSocialProviderTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SocialProvider>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SocialProviders;
        }

        /// <inheritdoc/>
        protected override List<Mock<SocialProvider>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSocialProviders;
        }

        /// <inheritdoc/>
        protected override async Task<SocialProviderModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Stores.SocialProviders.Standard")]
    public partial class Stores_SocialProviders_StandardWorkflowTests : Stores_SocialProviders_WorkflowTestsBase
    {
        public Stores_SocialProviders_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
