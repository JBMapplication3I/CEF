...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreVendors_WorkflowTestsBase
        : AbstractBase<
            IStoreVendor,
            StoreVendor,
            IStoreVendorModel,
            StoreVendorModel,
            IStoreVendorSearchModel,
            StoreVendorSearchModel,
            StoreVendorWorkflow>
    {
        protected Stores_StoreVendors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreVendorTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreVendor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreVendors;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreVendor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreVendors;
        }

        /// <inheritdoc/>
        protected override async Task<StoreVendorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreVendorModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Stores.StoreVendors.Standard")]
    public partial class Stores_StoreVendors_StandardWorkflowTests : Stores_StoreVendors_WorkflowTestsBase
    {
        public Stores_StoreVendors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
