...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_SiteDomains_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            SiteDomainWorkflow>
    {
        protected Stores_SiteDomains_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSiteDomainTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SiteDomain>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SiteDomains;
        }

        /// <inheritdoc/>
        protected override List<Mock<SiteDomain>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSiteDomains;
        }

        /// <inheritdoc/>
        protected override async Task<SiteDomainModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Stores.SiteDomains.Standard")]
    public partial class Stores_SiteDomains_StandardWorkflowTests : Stores_SiteDomains_WorkflowTestsBase
    {
        public Stores_SiteDomains_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
