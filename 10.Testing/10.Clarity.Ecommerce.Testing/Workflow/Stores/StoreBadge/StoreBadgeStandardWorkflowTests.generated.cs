...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreBadges_WorkflowTestsBase
        : AbstractBase<
            IStoreBadge,
            StoreBadge,
            IStoreBadgeModel,
            StoreBadgeModel,
            IStoreBadgeSearchModel,
            StoreBadgeSearchModel,
            StoreBadgeWorkflow>
    {
        protected Stores_StoreBadges_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreBadgeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreBadge>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreBadges;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreBadge>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreBadges;
        }

        /// <inheritdoc/>
        protected override async Task<StoreBadgeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreBadgeModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawBadges.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Stores.StoreBadges.Standard")]
    public partial class Stores_StoreBadges_StandardWorkflowTests : Stores_StoreBadges_WorkflowTestsBase
    {
        public Stores_StoreBadges_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
