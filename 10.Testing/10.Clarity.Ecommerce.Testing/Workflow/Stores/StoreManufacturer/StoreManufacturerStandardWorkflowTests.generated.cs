...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_StoreManufacturers_WorkflowTestsBase
        : AbstractBase<
            IStoreManufacturer,
            StoreManufacturer,
            IStoreManufacturerModel,
            StoreManufacturerModel,
            IStoreManufacturerSearchModel,
            StoreManufacturerSearchModel,
            StoreManufacturerWorkflow>
    {
        protected Stores_StoreManufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreManufacturerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreManufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreManufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreManufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<StoreManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreManufacturerModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Stores.StoreManufacturers.Standard")]
    public partial class Stores_StoreManufacturers_StandardWorkflowTests : Stores_StoreManufacturers_WorkflowTestsBase
    {
        public Stores_StoreManufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
