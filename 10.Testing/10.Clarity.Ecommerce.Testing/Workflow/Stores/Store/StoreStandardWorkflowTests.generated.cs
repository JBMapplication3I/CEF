...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Stores_Stores_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            StoreWorkflow>
    {
        protected Stores_Stores_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Store>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Stores;
        }

        /// <inheritdoc/>
        protected override List<Mock<Store>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStores;
        }

        /// <inheritdoc/>
        protected override async Task<StoreModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreModel
            {
                ...
                TypeID = mockingSetup.RawStoreTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Stores.Stores.Standard")]
    public partial class Stores_Stores_StandardWorkflowTests : Stores_Stores_WorkflowTestsBase
    {
        public Stores_Stores_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
