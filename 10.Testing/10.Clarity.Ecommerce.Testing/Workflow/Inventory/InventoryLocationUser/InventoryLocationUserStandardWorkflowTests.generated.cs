// <autogenerated>
// <copyright file="Inventory.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Inventory_InventoryLocationUsers_WorkflowTestsBase
        : AbstractBase<
            IInventoryLocationUser,
            InventoryLocationUser,
            IInventoryLocationUserModel,
            InventoryLocationUserModel,
            IInventoryLocationUserSearchModel,
            InventoryLocationUserSearchModel,
            InventoryLocationUserWorkflow>
    {
        protected Inventory_InventoryLocationUsers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoInventoryLocationUserTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoInventoryLocationUserTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<InventoryLocationUser>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.InventoryLocationUsers;
        }

        /// <inheritdoc/>
        protected override List<Mock<InventoryLocationUser>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawInventoryLocationUsers;
        }

        /// <inheritdoc/>
        protected override async Task<InventoryLocationUserModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new InventoryLocationUserModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawInventoryLocations.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Inventory.InventoryLocationUsers.Standard")]
    public partial class Inventory_InventoryLocationUsers_StandardWorkflowTests : Inventory_InventoryLocationUsers_WorkflowTestsBase
    {
        public Inventory_InventoryLocationUsers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
