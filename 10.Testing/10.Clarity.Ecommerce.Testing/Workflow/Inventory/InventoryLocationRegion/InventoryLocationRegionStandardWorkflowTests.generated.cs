...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Inventory_InventoryLocationRegions_WorkflowTestsBase
        : AbstractBase<
            IInventoryLocationRegion,
            InventoryLocationRegion,
            IInventoryLocationRegionModel,
            InventoryLocationRegionModel,
            IInventoryLocationRegionSearchModel,
            InventoryLocationRegionSearchModel,
            InventoryLocationRegionWorkflow>
    {
        protected Inventory_InventoryLocationRegions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoInventoryLocationRegionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoInventoryLocationRegionTable = true,
                DoRegionTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<InventoryLocationRegion>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.InventoryLocationRegions;
        }

        /// <inheritdoc/>
        protected override List<Mock<InventoryLocationRegion>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawInventoryLocationRegions;
        }

        /// <inheritdoc/>
        protected override async Task<InventoryLocationRegionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new InventoryLocationRegionModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawRegions.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Inventory.InventoryLocationRegions.Standard")]
    public partial class Inventory_InventoryLocationRegions_StandardWorkflowTests : Inventory_InventoryLocationRegions_WorkflowTestsBase
    {
        public Inventory_InventoryLocationRegions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
