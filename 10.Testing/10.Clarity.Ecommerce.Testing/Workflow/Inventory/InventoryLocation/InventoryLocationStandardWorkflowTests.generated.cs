...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Inventory_InventoryLocations_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            InventoryLocationWorkflow>
    {
        protected Inventory_InventoryLocations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoInventoryLocationTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<InventoryLocation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.InventoryLocations;
        }

        /// <inheritdoc/>
        protected override List<Mock<InventoryLocation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawInventoryLocations;
        }

        /// <inheritdoc/>
        protected override async Task<InventoryLocationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Inventory.InventoryLocations.Standard")]
    public partial class Inventory_InventoryLocations_StandardWorkflowTests : Inventory_InventoryLocations_WorkflowTestsBase
    {
        public Inventory_InventoryLocations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
