...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Inventory_InventoryLocationSections_WorkflowTestsBase
        : AbstractNameableBase<
            IInventoryLocationSection,
            InventoryLocationSection,
            IInventoryLocationSectionModel,
            InventoryLocationSectionModel,
            IInventoryLocationSectionSearchModel,
            InventoryLocationSectionSearchModel,
            InventoryLocationSectionWorkflow>
    {
        protected Inventory_InventoryLocationSections_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoInventoryLocationSectionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<InventoryLocationSection>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.InventoryLocationSections;
        }

        /// <inheritdoc/>
        protected override List<Mock<InventoryLocationSection>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawInventoryLocationSections;
        }

        /// <inheritdoc/>
        protected override async Task<InventoryLocationSectionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new InventoryLocationSectionModel
            {
                Active = true,
                ...
                InventoryLocationID = mockingSetup.RawInventoryLocations.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Inventory.InventoryLocationSections.Standard")]
    public partial class Inventory_InventoryLocationSections_StandardWorkflowTests : Inventory_InventoryLocationSections_WorkflowTestsBase
    {
        public Inventory_InventoryLocationSections_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
