...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            CartFileWorkflow>
    {
        protected Shopping_CartFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CartFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartFiles;
        }

        /// <inheritdoc/>
        protected override async Task<CartFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CartFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Shopping.CartFiles.Standard")]
    public partial class Shopping_CartFiles_StandardWorkflowTests : Shopping_CartFiles_WorkflowTestsBase
    {
        public Shopping_CartFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
