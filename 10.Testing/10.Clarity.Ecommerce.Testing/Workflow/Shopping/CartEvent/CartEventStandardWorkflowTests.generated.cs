...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartEvents_WorkflowTestsBase
        : AbstractNameableBase<
            ICartEvent,
            CartEvent,
            ICartEventModel,
            CartEventModel,
            ICartEventSearchModel,
            CartEventSearchModel,
            CartEventWorkflow>
    {
        protected Shopping_CartEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartEventTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCartTable = true,
                DoCartEventTable = true,
                DoCartEventTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CartEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartEvents;
        }

        /// <inheritdoc/>
        protected override async Task<CartEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CartEventModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawCartEventTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Shopping.CartEvents.Standard")]
    public partial class Shopping_CartEvents_StandardWorkflowTests : Shopping_CartEvents_WorkflowTestsBase
    {
        public Shopping_CartEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
