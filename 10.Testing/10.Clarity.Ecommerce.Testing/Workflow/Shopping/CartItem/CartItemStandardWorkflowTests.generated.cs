...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartItems_WorkflowTestsBase
        : AbstractNameableBase<
            ICartItem,
            CartItem,
            ISalesItemBaseModel<IAppliedCartItemDiscountModel>,
            SalesItemBaseModel<IAppliedCartItemDiscountModel, AppliedCartItemDiscountModel>,
            ISalesItemBaseSearchModel,
            SalesItemBaseSearchModel,
            CartItemWorkflow>
    {
        protected Shopping_CartItems_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartItemTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CartItem>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartItems;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartItem>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartItems;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemBaseModel<IAppliedCartItemDiscountModel, AppliedCartItemDiscountModel>> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemBaseModel<IAppliedCartItemDiscountModel, AppliedCartItemDiscountModel>
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Shopping.CartItems.Standard")]
    public partial class Shopping_CartItems_StandardWorkflowTests : Shopping_CartItems_WorkflowTestsBase
    {
        public Shopping_CartItems_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
