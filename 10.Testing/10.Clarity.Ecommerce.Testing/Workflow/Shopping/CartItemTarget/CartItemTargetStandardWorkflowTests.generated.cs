...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartItemTargets_WorkflowTestsBase
        : AbstractBase<
            ICartItemTarget,
            CartItemTarget,
            ...
            CartItemTargetWorkflow>
    {
        protected Shopping_CartItemTargets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartItemTargetTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CartItemTarget>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartItemTargets;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartItemTarget>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartItemTargets;
        }
    ...
    [Trait("Category", "Workflows.Shopping.CartItemTargets.Standard")]
    public partial class Shopping_CartItemTargets_StandardWorkflowTests : Shopping_CartItemTargets_WorkflowTestsBase
    {
        public Shopping_CartItemTargets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
