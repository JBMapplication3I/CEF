...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            CartStatusWorkflow>
    {
        protected Shopping_CartStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CartStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartStatuses;
        }
    ...
    [Trait("Category", "Workflows.Shopping.CartStatuses.Standard")]
    public partial class Shopping_CartStatuses_StandardWorkflowTests : Shopping_CartStatuses_WorkflowTestsBase
    {
        public Shopping_CartStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
