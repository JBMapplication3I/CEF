...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartStates_WorkflowTestsBase
        : AbstractStateableBase<
            ...
            CartStateWorkflow>
    {
        protected Shopping_CartStates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartStateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CartState>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartStates;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartState>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartStates;
        }
    ...
    [Trait("Category", "Workflows.Shopping.CartStates.Standard")]
    public partial class Shopping_CartStates_StandardWorkflowTests : Shopping_CartStates_WorkflowTestsBase
    {
        public Shopping_CartStates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
