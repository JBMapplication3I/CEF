...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICartEventType,
            CartEventType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CartEventTypeWorkflow>
    {
        protected Shopping_CartEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CartEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Shopping.CartEventTypes.Standard")]
    public partial class Shopping_CartEventTypes_StandardWorkflowTests : Shopping_CartEventTypes_WorkflowTestsBase
    {
        public Shopping_CartEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
