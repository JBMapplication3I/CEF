...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartContacts_WorkflowTestsBase
        : AbstractBase<
            ICartContact,
            CartContact,
            ICartContactModel,
            CartContactModel,
            ICartContactSearchModel,
            CartContactSearchModel,
            CartContactWorkflow>
    {
        protected Shopping_CartContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CartContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CartContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<CartContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCartContacts;
        }

        /// <inheritdoc/>
        protected override async Task<CartContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CartContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Shopping.CartContacts.Standard")]
    public partial class Shopping_CartContacts_StandardWorkflowTests : Shopping_CartContacts_WorkflowTestsBase
    {
        public Shopping_CartContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
