...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Shopping_CartTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICartType,
            CartType,
            ICartTypeModel,
            CartTypeModel,
            ICartTypeSearchModel,
            CartTypeSearchModel,
            CartTypeWorkflow>
    {
        protected Shopping_CartTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCartTypeTable = true };
        }
    ...
    [Trait("Category", "Workflows.Shopping.CartTypes.Standard")]
    public partial class Shopping_CartTypes_StandardWorkflowTests : Shopping_CartTypes_WorkflowTestsBase
    {
        public Shopping_CartTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
