...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Favorites_FavoriteCategories_WorkflowTestsBase
        : AbstractBase<
            IFavoriteCategory,
            FavoriteCategory,
            IFavoriteCategoryModel,
            FavoriteCategoryModel,
            IFavoriteCategorySearchModel,
            FavoriteCategorySearchModel,
            FavoriteCategoryWorkflow>
    {
        protected Favorites_FavoriteCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFavoriteCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FavoriteCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FavoriteCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<FavoriteCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFavoriteCategories;
        }

        /// <inheritdoc/>
        protected override async Task<FavoriteCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FavoriteCategoryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Favorites.FavoriteCategories.Standard")]
    public partial class Favorites_FavoriteCategories_StandardWorkflowTests : Favorites_FavoriteCategories_WorkflowTestsBase
    {
        public Favorites_FavoriteCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
