...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Favorites_FavoriteVendors_WorkflowTestsBase
        : AbstractBase<
            IFavoriteVendor,
            FavoriteVendor,
            IFavoriteVendorModel,
            FavoriteVendorModel,
            IFavoriteVendorSearchModel,
            FavoriteVendorSearchModel,
            FavoriteVendorWorkflow>
    {
        protected Favorites_FavoriteVendors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFavoriteVendorTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FavoriteVendor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FavoriteVendors;
        }

        /// <inheritdoc/>
        protected override List<Mock<FavoriteVendor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFavoriteVendors;
        }

        /// <inheritdoc/>
        protected override async Task<FavoriteVendorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FavoriteVendorModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Favorites.FavoriteVendors.Standard")]
    public partial class Favorites_FavoriteVendors_StandardWorkflowTests : Favorites_FavoriteVendors_WorkflowTestsBase
    {
        public Favorites_FavoriteVendors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
