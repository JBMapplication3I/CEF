// <autogenerated>
// <copyright file="Favorites.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Favorites_FavoriteShipCarriers_WorkflowTestsBase
        : AbstractBase<
            IFavoriteShipCarrier,
            FavoriteShipCarrier,
            IFavoriteShipCarrierModel,
            FavoriteShipCarrierModel,
            IFavoriteShipCarrierSearchModel,
            FavoriteShipCarrierSearchModel,
            FavoriteShipCarrierWorkflow>
    {
        protected Favorites_FavoriteShipCarriers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFavoriteShipCarrierTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoFavoriteShipCarrierTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FavoriteShipCarrier>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FavoriteShipCarriers;
        }

        /// <inheritdoc/>
        protected override List<Mock<FavoriteShipCarrier>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFavoriteShipCarriers;
        }

        /// <inheritdoc/>
        protected override async Task<FavoriteShipCarrierModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FavoriteShipCarrierModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawUsers.First().Object.ID,
                SlaveID = mockingSetup.RawShipCarriers.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Favorites.FavoriteShipCarriers.Standard")]
    public partial class Favorites_FavoriteShipCarriers_StandardWorkflowTests : Favorites_FavoriteShipCarriers_WorkflowTestsBase
    {
        public Favorites_FavoriteShipCarriers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
