...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Favorites_FavoriteStores_WorkflowTestsBase
        : AbstractBase<
            IFavoriteStore,
            FavoriteStore,
            IFavoriteStoreModel,
            FavoriteStoreModel,
            IFavoriteStoreSearchModel,
            FavoriteStoreSearchModel,
            FavoriteStoreWorkflow>
    {
        protected Favorites_FavoriteStores_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFavoriteStoreTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FavoriteStore>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FavoriteStores;
        }

        /// <inheritdoc/>
        protected override List<Mock<FavoriteStore>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFavoriteStores;
        }

        /// <inheritdoc/>
        protected override async Task<FavoriteStoreModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Favorites.FavoriteStores.Standard")]
    public partial class Favorites_FavoriteStores_StandardWorkflowTests : Favorites_FavoriteStores_WorkflowTestsBase
    {
        public Favorites_FavoriteStores_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
