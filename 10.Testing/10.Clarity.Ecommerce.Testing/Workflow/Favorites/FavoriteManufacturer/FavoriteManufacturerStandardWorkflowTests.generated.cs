...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Favorites_FavoriteManufacturers_WorkflowTestsBase
        : AbstractBase<
            IFavoriteManufacturer,
            FavoriteManufacturer,
            IFavoriteManufacturerModel,
            FavoriteManufacturerModel,
            IFavoriteManufacturerSearchModel,
            FavoriteManufacturerSearchModel,
            FavoriteManufacturerWorkflow>
    {
        protected Favorites_FavoriteManufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFavoriteManufacturerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FavoriteManufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FavoriteManufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<FavoriteManufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFavoriteManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<FavoriteManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FavoriteManufacturerModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Favorites.FavoriteManufacturers.Standard")]
    public partial class Favorites_FavoriteManufacturers_StandardWorkflowTests : Favorites_FavoriteManufacturers_WorkflowTestsBase
    {
        public Favorites_FavoriteManufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
