...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceItemTargets_WorkflowTestsBase
        : AbstractBase<
            ...
            SalesInvoiceItemTargetWorkflow>
    {
        protected Invoicing_SalesInvoiceItemTargets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceItemTargetTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceItemTarget>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceItemTargets;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceItemTarget>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceItemTargets;
        }
    ...
    [Trait("Category", "Workflows.Invoicing.SalesInvoiceItemTargets.Standard")]
    public partial class Invoicing_SalesInvoiceItemTargets_StandardWorkflowTests : Invoicing_SalesInvoiceItemTargets_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceItemTargets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
