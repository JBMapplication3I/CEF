...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceItems_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesInvoiceItem,
            SalesInvoiceItem,
            ISalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel>,
            SalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel, AppliedSalesInvoiceItemDiscountModel>,
            ISalesItemBaseSearchModel,
            SalesItemBaseSearchModel,
            SalesInvoiceItemWorkflow>
    {
        protected Invoicing_SalesInvoiceItems_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceItemTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesInvoiceItemTargetTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceItem>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceItems;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceItem>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceItems;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel, AppliedSalesInvoiceItemDiscountModel>> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemBaseModel<IAppliedSalesInvoiceItemDiscountModel, AppliedSalesInvoiceItemDiscountModel>
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Invoicing.SalesInvoiceItems.Standard")]
    public partial class Invoicing_SalesInvoiceItems_StandardWorkflowTests : Invoicing_SalesInvoiceItems_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceItems_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
