...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesInvoiceFile,
            SalesInvoiceFile,
            ISalesInvoiceFileModel,
            SalesInvoiceFileModel,
            ISalesInvoiceFileSearchModel,
            SalesInvoiceFileSearchModel,
            SalesInvoiceFileWorkflow>
    {
        protected Invoicing_SalesInvoiceFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceFiles;
        }

        /// <inheritdoc/>
        protected override async Task<SalesInvoiceFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesInvoiceFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Invoicing.SalesInvoiceFiles.Standard")]
    public partial class Invoicing_SalesInvoiceFiles_StandardWorkflowTests : Invoicing_SalesInvoiceFiles_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
