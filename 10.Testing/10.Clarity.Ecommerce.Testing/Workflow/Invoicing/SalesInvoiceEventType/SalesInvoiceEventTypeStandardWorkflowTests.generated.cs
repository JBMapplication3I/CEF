...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesInvoiceEventType,
            SalesInvoiceEventType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            SalesInvoiceEventTypeWorkflow>
    {
        protected Invoicing_SalesInvoiceEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Invoicing.SalesInvoiceEventTypes.Standard")]
    public partial class Invoicing_SalesInvoiceEventTypes_StandardWorkflowTests : Invoicing_SalesInvoiceEventTypes_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
