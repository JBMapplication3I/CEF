...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesInvoiceType,
            SalesInvoiceType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            SalesInvoiceTypeWorkflow>
    {
        protected Invoicing_SalesInvoiceTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceTypes;
        }
    ...
    [Trait("Category", "Workflows.Invoicing.SalesInvoiceTypes.Standard")]
    public partial class Invoicing_SalesInvoiceTypes_StandardWorkflowTests : Invoicing_SalesInvoiceTypes_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
