...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceStates_WorkflowTestsBase
        : AbstractStateableBase<
            ...
            IStateSearchModel,
            StateSearchModel,
            SalesInvoiceStateWorkflow>
    {
        protected Invoicing_SalesInvoiceStates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceStateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceState>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceStates;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceState>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceStates;
        }
    ...
    [Trait("Category", "Workflows.Invoicing.SalesInvoiceStates.Standard")]
    public partial class Invoicing_SalesInvoiceStates_StandardWorkflowTests : Invoicing_SalesInvoiceStates_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceStates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
