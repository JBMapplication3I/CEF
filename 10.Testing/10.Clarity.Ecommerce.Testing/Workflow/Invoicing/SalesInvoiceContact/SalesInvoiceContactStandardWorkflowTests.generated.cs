...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceContacts_WorkflowTestsBase
        : AbstractBase<
            ISalesInvoiceContact,
            SalesInvoiceContact,
            ISalesInvoiceContactModel,
            SalesInvoiceContactModel,
            ISalesInvoiceContactSearchModel,
            SalesInvoiceContactSearchModel,
            SalesInvoiceContactWorkflow>
    {
        protected Invoicing_SalesInvoiceContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceContacts;
        }

        /// <inheritdoc/>
        protected override async Task<SalesInvoiceContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesInvoiceContactModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawContacts.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Invoicing.SalesInvoiceContacts.Standard")]
    public partial class Invoicing_SalesInvoiceContacts_StandardWorkflowTests : Invoicing_SalesInvoiceContacts_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
