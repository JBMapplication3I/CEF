...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            SalesInvoiceStatusWorkflow>
    {
        protected Invoicing_SalesInvoiceStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceStatuses;
        }
    ...
    [Trait("Category", "Workflows.Invoicing.SalesInvoiceStatuses.Standard")]
    public partial class Invoicing_SalesInvoiceStatuses_StandardWorkflowTests : Invoicing_SalesInvoiceStatuses_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
