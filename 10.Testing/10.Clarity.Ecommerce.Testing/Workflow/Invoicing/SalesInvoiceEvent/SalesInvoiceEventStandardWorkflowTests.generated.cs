...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesInvoiceEvents_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesInvoiceEvent,
            SalesInvoiceEvent,
            ISalesInvoiceEventModel,
            SalesInvoiceEventModel,
            ISalesInvoiceEventSearchModel,
            SalesInvoiceEventSearchModel,
            SalesInvoiceEventWorkflow>
    {
        protected Invoicing_SalesInvoiceEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesInvoiceEventTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesInvoiceEventTable = true,
                DoSalesInvoiceEventTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesInvoiceEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesInvoiceEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesInvoiceEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesInvoiceEvents;
        }

        /// <inheritdoc/>
        protected override async Task<SalesInvoiceEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesInvoiceEventModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawSalesInvoiceEventTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Invoicing.SalesInvoiceEvents.Standard")]
    public partial class Invoicing_SalesInvoiceEvents_StandardWorkflowTests : Invoicing_SalesInvoiceEvents_WorkflowTestsBase
    {
        public Invoicing_SalesInvoiceEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
