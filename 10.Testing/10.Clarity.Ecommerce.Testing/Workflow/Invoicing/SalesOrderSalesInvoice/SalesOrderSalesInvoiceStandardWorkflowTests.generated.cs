...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Invoicing_SalesOrderSalesInvoices_WorkflowTestsBase
        : AbstractBase<
            ISalesOrderSalesInvoice,
            SalesOrderSalesInvoice,
            ISalesOrderSalesInvoiceModel,
            SalesOrderSalesInvoiceModel,
            ISalesOrderSalesInvoiceSearchModel,
            SalesOrderSalesInvoiceSearchModel,
            SalesOrderSalesInvoiceWorkflow>
    {
        protected Invoicing_SalesOrderSalesInvoices_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderSalesInvoiceTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderSalesInvoice>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderSalesInvoices;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderSalesInvoice>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderSalesInvoices;
        }

        /// <inheritdoc/>
        protected override async Task<SalesOrderSalesInvoiceModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesOrderSalesInvoiceModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawSalesOrders.First().Object.ID,
                SlaveID = mockingSetup.RawSalesInvoices.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Invoicing.SalesOrderSalesInvoices.Standard")]
    public partial class Invoicing_SalesOrderSalesInvoices_StandardWorkflowTests : Invoicing_SalesOrderSalesInvoices_WorkflowTestsBase
    {
        public Invoicing_SalesOrderSalesInvoices_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
