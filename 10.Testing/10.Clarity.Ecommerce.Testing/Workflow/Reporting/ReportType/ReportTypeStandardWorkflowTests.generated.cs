// <autogenerated>
// <copyright file="Reporting.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Reporting_ReportTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IReportType,
            ReportType,
            IReportTypeModel,
            ReportTypeModel,
            IReportTypeSearchModel,
            ReportTypeSearchModel,
            ReportTypeWorkflow>
    {
        protected Reporting_ReportTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoReportTypeTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoReportTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ReportType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ReportTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ReportType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawReportTypes;
        }

        /// <inheritdoc/>
        protected override async Task<ReportTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Reporting.ReportTypes.Standard")]
    public partial class Reporting_ReportTypes_StandardWorkflowTests : Reporting_ReportTypes_WorkflowTestsBase
    {
        public Reporting_ReportTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
