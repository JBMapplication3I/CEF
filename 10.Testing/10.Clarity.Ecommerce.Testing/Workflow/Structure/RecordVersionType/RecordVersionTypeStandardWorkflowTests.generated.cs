...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_RecordVersionTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IRecordVersionType,
            RecordVersionType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            RecordVersionTypeWorkflow>
    {
        protected Structure_RecordVersionTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRecordVersionTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<RecordVersionType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RecordVersionTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<RecordVersionType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRecordVersionTypes;
        }
    ...
    [Trait("Category", "Workflows.Structure.RecordVersionTypes.Standard")]
    public partial class Structure_RecordVersionTypes_StandardWorkflowTests : Structure_RecordVersionTypes_WorkflowTestsBase
    {
        public Structure_RecordVersionTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
