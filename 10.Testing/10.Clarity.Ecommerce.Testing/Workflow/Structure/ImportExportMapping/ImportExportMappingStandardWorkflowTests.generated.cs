...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_ImportExportMappings_WorkflowTestsBase
        : AbstractNameableBase<
            IImportExportMapping,
            ImportExportMapping,
            IImportExportMappingModel,
            ImportExportMappingModel,
            IImportExportMappingSearchModel,
            ImportExportMappingSearchModel,
            ImportExportMappingWorkflow>
    {
        protected Structure_ImportExportMappings_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoImportExportMappingTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoImportExportMappingTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ImportExportMapping>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ImportExportMappings;
        }

        /// <inheritdoc/>
        protected override List<Mock<ImportExportMapping>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawImportExportMappings;
        }

        /// <inheritdoc/>
        protected override async Task<ImportExportMappingModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ImportExportMappingModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Structure.ImportExportMappings.Standard")]
    public partial class Structure_ImportExportMappings_StandardWorkflowTests : Structure_ImportExportMappings_WorkflowTestsBase
    {
        public Structure_ImportExportMappings_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
