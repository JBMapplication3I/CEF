// <autogenerated>
// <copyright file="Structure.StandardWorkflowTests.cs" company="clarity-ventures.com">
// Copyright (c) 2016-2023 clarity-ventures.com. All rights reserved.
// </copyright>
// <summary>Implements the Structure section of the Mocking Setup class</summary>
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_RecordVersions_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            RecordVersionSearchModel,
            RecordVersionWorkflow>
    {
        protected Structure_RecordVersions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRecordVersionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoBrandTable = true,
                DoRecordVersionTable = true,
                DoRecordVersionTypeTable = true,
                DoStoreTable = true,
                DoUserTable = true,
            };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<RecordVersion>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RecordVersions;
        }

        /// <inheritdoc/>
        protected override List<Mock<RecordVersion>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRecordVersions;
        }

        /// <inheritdoc/>
        protected override async Task<RecordVersionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new RecordVersionModel
            {
                ...
                TypeID = mockingSetup.RawRecordVersionTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Structure.RecordVersions.Standard")]
    public partial class Structure_RecordVersions_StandardWorkflowTests : Structure_RecordVersions_WorkflowTestsBase
    {
        public Structure_RecordVersions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
