...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_SettingTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISettingType,
            SettingType,
            ITypeModel,
            ...
            SettingTypeWorkflow>
    {
        protected Structure_SettingTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSettingTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SettingType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SettingTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SettingType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSettingTypes;
        }
    ...
    [Trait("Category", "Workflows.Structure.SettingTypes.Standard")]
    public partial class Structure_SettingTypes_StandardWorkflowTests : Structure_SettingTypes_WorkflowTestsBase
    {
        public Structure_SettingTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
