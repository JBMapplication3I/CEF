...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_NoteTypes_WorkflowTestsBase
        : AbstractTypableBase<
            INoteType,
            NoteType,
            INoteTypeModel,
            ...
            NoteTypeWorkflow>
    {
        protected Structure_NoteTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoNoteTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<NoteType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.NoteTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<NoteType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawNoteTypes;
        }

        /// <inheritdoc/>
        protected override async Task<NoteTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Structure.NoteTypes.Standard")]
    public partial class Structure_NoteTypes_StandardWorkflowTests : Structure_NoteTypes_WorkflowTestsBase
    {
        public Structure_NoteTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
