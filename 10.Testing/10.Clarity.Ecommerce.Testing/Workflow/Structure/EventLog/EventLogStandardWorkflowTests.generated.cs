...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_EventLogs_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            EventLogWorkflow>
    {
        protected Structure_EventLogs_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEventLogTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoBrandTable = true,
                DoEventLogTable = true,
                DoStoreTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<EventLog>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EventLogs;
        }

        /// <inheritdoc/>
        protected override List<Mock<EventLog>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEventLogs;
        }

        /// <inheritdoc/>
        protected override async Task<EventLogModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Structure.EventLogs.Standard")]
    public partial class Structure_EventLogs_StandardWorkflowTests : Structure_EventLogs_WorkflowTestsBase
    {
        public Structure_EventLogs_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
