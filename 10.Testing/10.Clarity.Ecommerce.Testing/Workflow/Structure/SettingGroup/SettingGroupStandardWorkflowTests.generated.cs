...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_SettingGroups_WorkflowTestsBase
        : AbstractTypableBase<
            ISettingGroup,
            SettingGroup,
            ISettingGroupModel,
            SettingGroupModel,
            ISettingGroupSearchModel,
            SettingGroupSearchModel,
            SettingGroupWorkflow>
    {
        protected Structure_SettingGroups_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSettingGroupTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SettingGroup>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SettingGroups;
        }

        /// <inheritdoc/>
        protected override List<Mock<SettingGroup>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSettingGroups;
        }

        /// <inheritdoc/>
        protected override async Task<SettingGroupModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SettingGroupModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Structure.SettingGroups.Standard")]
    public partial class Structure_SettingGroups_StandardWorkflowTests : Structure_SettingGroups_WorkflowTestsBase
    {
        public Structure_SettingGroups_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
