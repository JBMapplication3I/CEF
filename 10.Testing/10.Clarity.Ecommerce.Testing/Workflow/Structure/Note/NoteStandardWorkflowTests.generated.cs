...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_Notes_WorkflowTestsBase
        : AbstractBase<
            INote,
            Note,
            INoteModel,
            ...
            NoteWorkflow>
    {
        protected Structure_Notes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoNoteTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Note>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Notes;
        }

        /// <inheritdoc/>
        protected override List<Mock<Note>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawNotes;
        }

        /// <inheritdoc/>
        protected override async Task<NoteModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new NoteModel
            {
                ...
                TypeID = mockingSetup.RawNoteTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Structure.Notes.Standard")]
    public partial class Structure_Notes_StandardWorkflowTests : Structure_Notes_WorkflowTestsBase
    {
        public Structure_Notes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
