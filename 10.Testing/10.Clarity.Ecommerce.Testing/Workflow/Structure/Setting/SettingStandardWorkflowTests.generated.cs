...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Structure_Settings_WorkflowTestsBase
        : AbstractBase<
            ISetting,
            Setting,
            ISettingModel,
            ...
            SettingWorkflow>
    {
        protected Structure_Settings_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSettingTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Setting>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Settings;
        }

        /// <inheritdoc/>
        protected override List<Mock<Setting>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSettings;
        }

        /// <inheritdoc/>
        protected override async Task<SettingModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SettingModel
            {
                ...
                TypeID = mockingSetup.RawSettingTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Structure.Settings.Standard")]
    public partial class Structure_Settings_StandardWorkflowTests : Structure_Settings_WorkflowTestsBase
    {
        public Structure_Settings_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
