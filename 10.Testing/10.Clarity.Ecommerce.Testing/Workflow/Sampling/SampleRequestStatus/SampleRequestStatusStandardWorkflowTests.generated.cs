...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ISampleRequestStatus,
            SampleRequestStatus,
            IStatusModel,
            StatusModel,
            IStatusSearchModel,
            StatusSearchModel,
            SampleRequestStatusWorkflow>
    {
        protected Sampling_SampleRequestStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestStatuses;
        }
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestStatuses.Standard")]
    public partial class Sampling_SampleRequestStatuses_StandardWorkflowTests : Sampling_SampleRequestStatuses_WorkflowTestsBase
    {
        public Sampling_SampleRequestStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
