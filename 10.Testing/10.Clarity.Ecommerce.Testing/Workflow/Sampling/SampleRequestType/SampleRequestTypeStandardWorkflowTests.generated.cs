...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISampleRequestType,
            SampleRequestType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            SampleRequestTypeWorkflow>
    {
        protected Sampling_SampleRequestTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestTypes;
        }
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestTypes.Standard")]
    public partial class Sampling_SampleRequestTypes_StandardWorkflowTests : Sampling_SampleRequestTypes_WorkflowTestsBase
    {
        public Sampling_SampleRequestTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
