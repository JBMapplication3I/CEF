...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestEvents_WorkflowTestsBase
        : AbstractNameableBase<
            ISampleRequestEvent,
            SampleRequestEvent,
            ISampleRequestEventModel,
            SampleRequestEventModel,
            ISampleRequestEventSearchModel,
            SampleRequestEventSearchModel,
            SampleRequestEventWorkflow>
    {
        protected Sampling_SampleRequestEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestEventTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSampleRequestEventTable = true,
                DoSampleRequestEventTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestEvents;
        }

        /// <inheritdoc/>
        protected override async Task<SampleRequestEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SampleRequestEventModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawSampleRequestEventTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Sampling.SampleRequestEvents.Standard")]
    public partial class Sampling_SampleRequestEvents_StandardWorkflowTests : Sampling_SampleRequestEvents_WorkflowTestsBase
    {
        public Sampling_SampleRequestEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
