...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISampleRequestEventType,
            SampleRequestEventType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            SampleRequestEventTypeWorkflow>
    {
        protected Sampling_SampleRequestEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestEventTypes.Standard")]
    public partial class Sampling_SampleRequestEventTypes_StandardWorkflowTests : Sampling_SampleRequestEventTypes_WorkflowTestsBase
    {
        public Sampling_SampleRequestEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
