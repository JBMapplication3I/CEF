...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestContacts_WorkflowTestsBase
        : AbstractBase<
            ISampleRequestContact,
            SampleRequestContact,
            ISampleRequestContactModel,
            SampleRequestContactModel,
            ISampleRequestContactSearchModel,
            SampleRequestContactSearchModel,
            SampleRequestContactWorkflow>
    {
        protected Sampling_SampleRequestContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestContacts;
        }

        /// <inheritdoc/>
        protected override async Task<SampleRequestContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SampleRequestContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestContacts.Standard")]
    public partial class Sampling_SampleRequestContacts_StandardWorkflowTests : Sampling_SampleRequestContacts_WorkflowTestsBase
    {
        public Sampling_SampleRequestContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
