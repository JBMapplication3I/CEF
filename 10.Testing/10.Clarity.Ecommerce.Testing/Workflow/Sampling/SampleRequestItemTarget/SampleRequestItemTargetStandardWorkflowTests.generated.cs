...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestItemTargets_WorkflowTestsBase
        : AbstractBase<
            ...
            SalesItemTargetBaseSearchModel,
            SampleRequestItemTargetWorkflow>
    {
        protected Sampling_SampleRequestItemTargets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestItemTargetTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestItemTarget>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestItemTargets;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestItemTarget>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestItemTargets;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemTargetBaseModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemTargetBaseModel
            {
                ...
                TypeID = mockingSetup.RawSalesItemTargetTypes.First().Object.ID,
                DestinationContactID = mockingSetup.RawContacts.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestItemTargets.Standard")]
    public partial class Sampling_SampleRequestItemTargets_StandardWorkflowTests : Sampling_SampleRequestItemTargets_WorkflowTestsBase
    {
        public Sampling_SampleRequestItemTargets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
