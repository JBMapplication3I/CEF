...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestStates_WorkflowTestsBase
        : AbstractStateableBase<
            ISampleRequestState,
            SampleRequestState,
            IStateModel,
            StateModel,
            IStateSearchModel,
            StateSearchModel,
            SampleRequestStateWorkflow>
    {
        protected Sampling_SampleRequestStates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestStateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestState>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestStates;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestState>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestStates;
        }

        /// <inheritdoc/>
        protected override async Task<StateModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestStates.Standard")]
    public partial class Sampling_SampleRequestStates_StandardWorkflowTests : Sampling_SampleRequestStates_WorkflowTestsBase
    {
        public Sampling_SampleRequestStates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
