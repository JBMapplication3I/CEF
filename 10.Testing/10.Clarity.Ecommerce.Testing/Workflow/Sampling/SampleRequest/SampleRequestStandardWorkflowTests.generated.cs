...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequests_WorkflowTestsBase
        : AbstractBase<
            ISampleRequest,
            SampleRequest,
            ISampleRequestModel,
            ...
            SampleRequestWorkflow>
    {
        protected Sampling_SampleRequests_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSampleRequestTable = true,
                DoSampleRequestContactTable = true,
                DoSampleRequestFileTable = true,
                DoSampleRequestItemTable = true,
                DoSampleRequestStateTable = true,
                DoSampleRequestStatusTable = true,
                DoSampleRequestTypeTable = true,
                DoStoreTable = true,
                DoUserTable = true,
            };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequest>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequests;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequest>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequests;
        }

        /// <inheritdoc/>
        protected override async Task<SampleRequestModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SampleRequestModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                StatusID = mockingSetup.RawSampleRequestStatuses.First().Object.ID,
                StateID = mockingSetup.RawSampleRequestStates.First().Object.ID,
                TypeID = mockingSetup.RawSampleRequestTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequests.Standard")]
    public partial class Sampling_SampleRequests_StandardWorkflowTests : Sampling_SampleRequests_WorkflowTestsBase
    {
        public Sampling_SampleRequests_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
