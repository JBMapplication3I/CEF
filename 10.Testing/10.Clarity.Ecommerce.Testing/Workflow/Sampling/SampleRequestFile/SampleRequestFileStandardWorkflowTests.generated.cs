...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ISampleRequestFile,
            SampleRequestFile,
            ISampleRequestFileModel,
            SampleRequestFileModel,
            ISampleRequestFileSearchModel,
            SampleRequestFileSearchModel,
            SampleRequestFileWorkflow>
    {
        protected Sampling_SampleRequestFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestFiles;
        }

        /// <inheritdoc/>
        protected override async Task<SampleRequestFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SampleRequestFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestFiles.Standard")]
    public partial class Sampling_SampleRequestFiles_StandardWorkflowTests : Sampling_SampleRequestFiles_WorkflowTestsBase
    {
        public Sampling_SampleRequestFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
