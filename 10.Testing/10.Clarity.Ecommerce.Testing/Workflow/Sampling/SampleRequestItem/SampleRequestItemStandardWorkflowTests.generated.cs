// <autogenerated>
// <copyright file="Sampling.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sampling_SampleRequestItems_WorkflowTestsBase
        : AbstractNameableBase<
            ISampleRequestItem,
            SampleRequestItem,
            ISalesItemBaseModel<IAppliedSampleRequestItemDiscountModel>,
            SalesItemBaseModel<IAppliedSampleRequestItemDiscountModel, AppliedSampleRequestItemDiscountModel>,
            ISalesItemBaseSearchModel,
            SalesItemBaseSearchModel,
            SampleRequestItemWorkflow>
    {
        protected Sampling_SampleRequestItems_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSampleRequestItemTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSampleRequestItemTable = true,
                DoSampleRequestItemTargetTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SampleRequestItem>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SampleRequestItems;
        }

        /// <inheritdoc/>
        protected override List<Mock<SampleRequestItem>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSampleRequestItems;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemBaseModel<IAppliedSampleRequestItemDiscountModel, AppliedSampleRequestItemDiscountModel>> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemBaseModel<IAppliedSampleRequestItemDiscountModel, AppliedSampleRequestItemDiscountModel>
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Sampling.SampleRequestItems.Standard")]
    public partial class Sampling_SampleRequestItems_StandardWorkflowTests : Sampling_SampleRequestItems_WorkflowTestsBase
    {
        public Sampling_SampleRequestItems_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
