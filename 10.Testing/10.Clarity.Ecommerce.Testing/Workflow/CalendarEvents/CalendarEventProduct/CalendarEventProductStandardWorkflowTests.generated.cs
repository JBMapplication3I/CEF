...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEventProducts_WorkflowTestsBase
        : AbstractBase<
            ICalendarEventProduct,
            CalendarEventProduct,
            ICalendarEventProductModel,
            CalendarEventProductModel,
            ICalendarEventProductSearchModel,
            CalendarEventProductSearchModel,
            CalendarEventProductWorkflow>
    {
        protected CalendarEvents_CalendarEventProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEventProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEventProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEventProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEventProducts;
        }

        /// <inheritdoc/>
        protected override async Task<CalendarEventProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CalendarEventProductModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawProducts.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.CalendarEvents.CalendarEventProducts.Standard")]
    public partial class CalendarEvents_CalendarEventProducts_StandardWorkflowTests : CalendarEvents_CalendarEventProducts_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEventProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
