...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICalendarEventType,
            CalendarEventType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CalendarEventTypeWorkflow>
    {
        protected CalendarEvents_CalendarEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEventTypes;
        }
    ...
    [Trait("Category", "Workflows.CalendarEvents.CalendarEventTypes.Standard")]
    public partial class CalendarEvents_CalendarEventTypes_StandardWorkflowTests : CalendarEvents_CalendarEventTypes_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
