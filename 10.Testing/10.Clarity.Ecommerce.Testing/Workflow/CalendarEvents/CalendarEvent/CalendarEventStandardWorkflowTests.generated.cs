...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEvents_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            CalendarEventSearchModel,
            CalendarEventWorkflow>
    {
        protected CalendarEvents_CalendarEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoCalendarEventDetailTable = true,
                DoCalendarEventFileTable = true,
                DoCalendarEventImageTable = true,
                DoCalendarEventProductTable = true,
                DoCalendarEventStatusTable = true,
                DoCalendarEventTypeTable = true,
                DoContactTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEvents;
        }

        /// <inheritdoc/>
        protected override async Task<CalendarEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CalendarEventModel
            {
                ...
                TypeID = mockingSetup.RawCalendarEventTypes.First().Object.ID,
                StatusID = mockingSetup.RawCalendarEventStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.CalendarEvents.CalendarEvents.Standard")]
    public partial class CalendarEvents_CalendarEvents_StandardWorkflowTests : CalendarEvents_CalendarEvents_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
