...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEventFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ICalendarEventFile,
            CalendarEventFile,
            ICalendarEventFileModel,
            CalendarEventFileModel,
            ICalendarEventFileSearchModel,
            CalendarEventFileSearchModel,
            CalendarEventFileWorkflow>
    {
        protected CalendarEvents_CalendarEventFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEventFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEventFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEventFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEventFiles;
        }

        /// <inheritdoc/>
        protected override async Task<CalendarEventFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CalendarEventFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.CalendarEvents.CalendarEventFiles.Standard")]
    public partial class CalendarEvents_CalendarEventFiles_StandardWorkflowTests : CalendarEvents_CalendarEventFiles_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEventFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
