...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_UserEventAttendanceTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IUserEventAttendanceType,
            UserEventAttendanceType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            UserEventAttendanceTypeWorkflow>
    {
        protected CalendarEvents_UserEventAttendanceTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserEventAttendanceTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<UserEventAttendanceType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserEventAttendanceTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserEventAttendanceType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserEventAttendanceTypes;
        }
    ...
    [Trait("Category", "Workflows.CalendarEvents.UserEventAttendanceTypes.Standard")]
    public partial class CalendarEvents_UserEventAttendanceTypes_StandardWorkflowTests : CalendarEvents_UserEventAttendanceTypes_WorkflowTestsBase
    {
        public CalendarEvents_UserEventAttendanceTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
