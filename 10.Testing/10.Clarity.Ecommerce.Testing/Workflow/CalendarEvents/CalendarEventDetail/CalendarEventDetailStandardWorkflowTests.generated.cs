...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEventDetails_WorkflowTestsBase
        : AbstractNameableBase<
            ICalendarEventDetail,
            CalendarEventDetail,
            ICalendarEventDetailModel,
            CalendarEventDetailModel,
            ICalendarEventDetailSearchModel,
            CalendarEventDetailSearchModel,
            CalendarEventDetailWorkflow>
    {
        protected CalendarEvents_CalendarEventDetails_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventDetailTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEventDetail>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEventDetails;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEventDetail>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEventDetails;
        }

        /// <inheritdoc/>
        protected override async Task<CalendarEventDetailModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CalendarEventDetailModel
            {
                Active = true,
                ...
                CalendarEventID = mockingSetup.RawCalendarEvents.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.CalendarEvents.CalendarEventDetails.Standard")]
    public partial class CalendarEvents_CalendarEventDetails_StandardWorkflowTests : CalendarEvents_CalendarEventDetails_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEventDetails_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
