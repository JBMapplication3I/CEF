...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEventImages_WorkflowTestsBase
        : AbstractNameableBase<
            ICalendarEventImage,
            CalendarEventImage,
            ICalendarEventImageModel,
            CalendarEventImageModel,
            ICalendarEventImageSearchModel,
            CalendarEventImageSearchModel,
            CalendarEventImageWorkflow>
    {
        protected CalendarEvents_CalendarEventImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoCalendarEventImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEventImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEventImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEventImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEventImages;
        }

        /// <inheritdoc/>
        protected override async Task<CalendarEventImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CalendarEventImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawCalendarEventImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.CalendarEvents.CalendarEventImages.Standard")]
    public partial class CalendarEvents_CalendarEventImages_StandardWorkflowTests : CalendarEvents_CalendarEventImages_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEventImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
