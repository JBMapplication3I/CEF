...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEventImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICalendarEventImageType,
            CalendarEventImageType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            CalendarEventImageTypeWorkflow>
    {
        protected CalendarEvents_CalendarEventImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEventImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEventImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEventImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEventImageTypes;
        }
    ...
    [Trait("Category", "Workflows.CalendarEvents.CalendarEventImageTypes.Standard")]
    public partial class CalendarEvents_CalendarEventImageTypes_StandardWorkflowTests : CalendarEvents_CalendarEventImageTypes_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEventImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
