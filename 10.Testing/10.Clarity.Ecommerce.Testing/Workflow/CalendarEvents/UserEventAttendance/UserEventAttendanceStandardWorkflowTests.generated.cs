// <autogenerated>
// <copyright file="CalendarEvents.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_UserEventAttendances_WorkflowTestsBase
        : AbstractBase<
            IUserEventAttendance,
            UserEventAttendance,
            IUserEventAttendanceModel,
            UserEventAttendanceModel,
            IUserEventAttendanceSearchModel,
            UserEventAttendanceSearchModel,
            UserEventAttendanceWorkflow>
    {
        protected CalendarEvents_UserEventAttendances_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoUserEventAttendanceTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoUserTable = true,
                DoUserEventAttendanceTable = true,
                DoUserEventAttendanceTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<UserEventAttendance>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.UserEventAttendances;
        }

        /// <inheritdoc/>
        protected override List<Mock<UserEventAttendance>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawUserEventAttendances;
        }

        /// <inheritdoc/>
        protected override async Task<UserEventAttendanceModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new UserEventAttendanceModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                TypeID = mockingSetup.RawUserEventAttendanceTypes.First().Object.ID,
                MasterID = mockingSetup.RawCalendarEvents.First().Object.ID,
                SlaveID = mockingSetup.RawUsers.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.CalendarEvents.UserEventAttendances.Standard")]
    public partial class CalendarEvents_UserEventAttendances_StandardWorkflowTests : CalendarEvents_UserEventAttendances_WorkflowTestsBase
    {
        public CalendarEvents_UserEventAttendances_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
