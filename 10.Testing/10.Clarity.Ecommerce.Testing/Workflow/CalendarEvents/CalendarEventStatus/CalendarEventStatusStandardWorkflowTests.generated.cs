...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class CalendarEvents_CalendarEventStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            CalendarEventStatusWorkflow>
    {
        protected CalendarEvents_CalendarEventStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarEventStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarEventStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarEventStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarEventStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarEventStatuses;
        }
    ...
    [Trait("Category", "Workflows.CalendarEvents.CalendarEventStatuses.Standard")]
    public partial class CalendarEvents_CalendarEventStatuses_StandardWorkflowTests : CalendarEvents_CalendarEventStatuses_WorkflowTestsBase
    {
        public CalendarEvents_CalendarEventStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
