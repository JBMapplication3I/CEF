...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            AccountFileSearchModel,
            AccountFileWorkflow>
    {
        protected Accounts_AccountFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountFiles;
        }

        /// <inheritdoc/>
        protected override async Task<AccountFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Accounts.AccountFiles.Standard")]
    public partial class Accounts_AccountFiles_StandardWorkflowTests : Accounts_AccountFiles_WorkflowTestsBase
    {
        public Accounts_AccountFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
