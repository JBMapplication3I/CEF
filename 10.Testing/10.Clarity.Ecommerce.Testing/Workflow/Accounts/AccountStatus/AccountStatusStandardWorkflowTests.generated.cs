...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountStatuses_WorkflowTestsBase
    ...
    {
        protected Accounts_AccountStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountStatuses;
        }
    ...
    [Trait("Category", "Workflows.Accounts.AccountStatuses.Standard")]
    public partial class Accounts_AccountStatuses_StandardWorkflowTests : Accounts_AccountStatuses_WorkflowTestsBase
    {
        public Accounts_AccountStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
