...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_ServiceAreas_WorkflowTestsBase
        : AbstractBase<
            IServiceArea,
            ServiceArea,
            IServiceAreaModel,
            ...
            ServiceAreaSearchModel,
            ServiceAreaWorkflow>
    {
        protected Accounts_ServiceAreas_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoServiceAreaTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAddressTable = true,
                DoContractorTable = true,
                DoCountryTable = true,
                DoRegionTable = true,
                DoServiceAreaTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ServiceArea>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ServiceAreas;
        }

        /// <inheritdoc/>
        protected override List<Mock<ServiceArea>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawServiceAreas;
        }

        /// <inheritdoc/>
        protected override async Task<ServiceAreaModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ServiceAreaModel
            {
                ...
                ContractorID = mockingSetup.RawContractors.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Accounts.ServiceAreas.Standard")]
    public partial class Accounts_ServiceAreas_StandardWorkflowTests : Accounts_ServiceAreas_WorkflowTestsBase
    {
        public Accounts_ServiceAreas_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
