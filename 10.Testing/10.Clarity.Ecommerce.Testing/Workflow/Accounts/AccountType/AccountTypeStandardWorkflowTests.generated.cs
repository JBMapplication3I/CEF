...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAccountType,
            AccountType,
            ITypeModel,
            ...
            AccountTypeWorkflow>
    {
        protected Accounts_AccountTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountTypes;
        }
    ...
    [Trait("Category", "Workflows.Accounts.AccountTypes.Standard")]
    public partial class Accounts_AccountTypes_StandardWorkflowTests : Accounts_AccountTypes_WorkflowTestsBase
    {
        public Accounts_AccountTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
