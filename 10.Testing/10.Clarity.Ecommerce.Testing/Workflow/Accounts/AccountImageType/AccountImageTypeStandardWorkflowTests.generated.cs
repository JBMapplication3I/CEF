...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAccountImageType,
            AccountImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            AccountImageTypeWorkflow>
    {
        protected Accounts_AccountImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Accounts.AccountImageTypes.Standard")]
    public partial class Accounts_AccountImageTypes_StandardWorkflowTests : Accounts_AccountImageTypes_WorkflowTestsBase
    {
        public Accounts_AccountImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
