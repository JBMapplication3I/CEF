...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountAssociations_WorkflowTestsBase
        : AbstractBase<
            IAccountAssociation,
            AccountAssociation,
            IAccountAssociationModel,
            AccountAssociationModel,
            IAccountAssociationSearchModel,
            AccountAssociationSearchModel,
            AccountAssociationWorkflow>
    {
        protected Accounts_AccountAssociations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountAssociationTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoAccountAssociationTypeTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountAssociation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountAssociations;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountAssociation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountAssociations;
        }

        /// <inheritdoc/>
        protected override async Task<AccountAssociationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountAssociationModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawAccounts.First().Object.ID,
                TypeID = mockingSetup.RawAccountAssociationTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Accounts.AccountAssociations.Standard")]
    public partial class Accounts_AccountAssociations_StandardWorkflowTests : Accounts_AccountAssociations_WorkflowTestsBase
    {
        public Accounts_AccountAssociations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
