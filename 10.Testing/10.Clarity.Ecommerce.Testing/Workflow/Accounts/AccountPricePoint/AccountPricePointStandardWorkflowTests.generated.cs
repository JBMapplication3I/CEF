...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountPricePoints_WorkflowTestsBase
        : AbstractBase<
            IAccountPricePoint,
            AccountPricePoint,
            IAccountPricePointModel,
            AccountPricePointModel,
            IAccountPricePointSearchModel,
            AccountPricePointSearchModel,
            AccountPricePointWorkflow>
    {
        protected Accounts_AccountPricePoints_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountPricePointTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountPricePoint>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountPricePoints;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountPricePoint>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountPricePoints;
        }

        /// <inheritdoc/>
        protected override async Task<AccountPricePointModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountPricePointModel
            {
                ...
                SlaveID = mockingSetup.RawPricePoints.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Accounts.AccountPricePoints.Standard")]
    public partial class Accounts_AccountPricePoints_StandardWorkflowTests : Accounts_AccountPricePoints_WorkflowTestsBase
    {
        public Accounts_AccountPricePoints_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
