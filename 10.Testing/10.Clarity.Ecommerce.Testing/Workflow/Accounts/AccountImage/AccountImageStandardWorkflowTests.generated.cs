...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountImages_WorkflowTestsBase
        : AbstractNameableBase<
            IAccountImage,
            AccountImage,
            IAccountImageModel,
            AccountImageModel,
            IAccountImageSearchModel,
            AccountImageSearchModel,
            AccountImageWorkflow>
    {
        protected Accounts_AccountImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoAccountImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AccountImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountImages;
        }

        /// <inheritdoc/>
        protected override async Task<AccountImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawAccountImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Accounts.AccountImages.Standard")]
    public partial class Accounts_AccountImages_StandardWorkflowTests : Accounts_AccountImages_WorkflowTestsBase
    {
        public Accounts_AccountImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
