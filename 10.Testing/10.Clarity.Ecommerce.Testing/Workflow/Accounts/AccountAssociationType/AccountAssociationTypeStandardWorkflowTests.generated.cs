...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountAssociationTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAccountAssociationType,
            AccountAssociationType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            AccountAssociationTypeWorkflow>
    {
        protected Accounts_AccountAssociationTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountAssociationTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountAssociationType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountAssociationTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountAssociationType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountAssociationTypes;
        }
    ...
    [Trait("Category", "Workflows.Accounts.AccountAssociationTypes.Standard")]
    public partial class Accounts_AccountAssociationTypes_StandardWorkflowTests : Accounts_AccountAssociationTypes_WorkflowTestsBase
    {
        public Accounts_AccountAssociationTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
