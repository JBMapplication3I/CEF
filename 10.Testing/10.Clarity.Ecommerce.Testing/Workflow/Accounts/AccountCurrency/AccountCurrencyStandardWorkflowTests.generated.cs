...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountCurrencies_WorkflowTestsBase
        : AbstractBase<
            IAccountCurrency,
            AccountCurrency,
            ...
            AccountCurrencySearchModel,
            AccountCurrencyWorkflow>
    {
        protected Accounts_AccountCurrencies_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountCurrencyTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountCurrency>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountCurrencies;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountCurrency>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountCurrencies;
        }

        /// <inheritdoc/>
        protected override async Task<AccountCurrencyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountCurrencyModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Accounts.AccountCurrencies.Standard")]
    public partial class Accounts_AccountCurrencies_StandardWorkflowTests : Accounts_AccountCurrencies_WorkflowTestsBase
    {
        public Accounts_AccountCurrencies_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
