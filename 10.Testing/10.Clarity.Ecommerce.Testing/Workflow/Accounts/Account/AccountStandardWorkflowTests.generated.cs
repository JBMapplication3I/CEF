...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_Accounts_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            AccountWorkflow>
    {
        protected Accounts_Accounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoAccountFileTable = true,
                DoAccountImageTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Account>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Accounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<Account>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<AccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountModel
            {
                ...
                TypeID = mockingSetup.RawAccountTypes.First().Object.ID,
                StatusID = mockingSetup.RawAccountStatuses.First().Object.ID,
                // Optional Related Properties
                CreditCurrencyID = null,
            };
        }
    }

    [Trait("Category", "Workflows.Accounts.Accounts.Standard")]
    public partial class Accounts_Accounts_StandardWorkflowTests : Accounts_Accounts_WorkflowTestsBase
    {
        public Accounts_Accounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
