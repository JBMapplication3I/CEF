...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountProducts_WorkflowTestsBase
        : AbstractBase<
            IAccountProduct,
            AccountProduct,
            ...
            AccountProductSearchModel,
            AccountProductWorkflow>
    {
        protected Accounts_AccountProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountProductTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAccountProductTable = true,
                DoAccountProductTypeTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountProducts;
        }

        /// <inheritdoc/>
        protected override async Task<AccountProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountProductModel
            {
                ...
                TypeID = mockingSetup.RawAccountProductTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Accounts.AccountProducts.Standard")]
    public partial class Accounts_AccountProducts_StandardWorkflowTests : Accounts_AccountProducts_WorkflowTestsBase
    {
        public Accounts_AccountProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
