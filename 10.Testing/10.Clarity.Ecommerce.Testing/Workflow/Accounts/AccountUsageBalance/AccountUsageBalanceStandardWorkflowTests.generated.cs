// <autogenerated>
// <copyright file="Accounts.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountUsageBalances_WorkflowTestsBase
        : AbstractBase<
            IAccountUsageBalance,
            AccountUsageBalance,
            IAccountUsageBalanceModel,
            AccountUsageBalanceModel,
            IAccountUsageBalanceSearchModel,
            AccountUsageBalanceSearchModel,
            AccountUsageBalanceWorkflow>
    {
        protected Accounts_AccountUsageBalances_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountUsageBalanceTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoAccountUsageBalanceTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountUsageBalance>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountUsageBalances;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountUsageBalance>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountUsageBalances;
        }

        /// <inheritdoc/>
        protected override async Task<AccountUsageBalanceModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountUsageBalanceModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawAccounts.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Accounts.AccountUsageBalances.Standard")]
    public partial class Accounts_AccountUsageBalances_StandardWorkflowTests : Accounts_AccountUsageBalances_WorkflowTestsBase
    {
        public Accounts_AccountUsageBalances_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
