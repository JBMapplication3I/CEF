...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_Contractors_WorkflowTestsBase
        : AbstractBase<
            IContractor,
            Contractor,
            IContractorModel,
            ...
            ContractorWorkflow>
    {
        protected Accounts_Contractors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoContractorTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Contractor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Contractors;
        }

        /// <inheritdoc/>
        protected override List<Mock<Contractor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawContractors;
        }

        /// <inheritdoc/>
        protected override async Task<ContractorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Accounts.Contractors.Standard")]
    public partial class Accounts_Contractors_StandardWorkflowTests : Accounts_Contractors_WorkflowTestsBase
    {
        public Accounts_Contractors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
