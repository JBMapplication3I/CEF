...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountContacts_WorkflowTestsBase
        : AbstractNameableBase<
            IAccountContact,
            AccountContact,
            IAccountContactModel,
            AccountContactModel,
            IAccountContactSearchModel,
            AccountContactSearchModel,
            AccountContactWorkflow>
    {
        protected Accounts_AccountContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountContacts;
        }

        /// <inheritdoc/>
        protected override async Task<AccountContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AccountContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Accounts.AccountContacts.Standard")]
    public partial class Accounts_AccountContacts_StandardWorkflowTests : Accounts_AccountContacts_WorkflowTestsBase
    {
        public Accounts_AccountContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
