...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Accounts_AccountProductTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAccountProductType,
            AccountProductType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            AccountProductTypeWorkflow>
    {
        protected Accounts_AccountProductTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAccountProductTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AccountProductType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AccountProductTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AccountProductType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAccountProductTypes;
        }
    ...
    [Trait("Category", "Workflows.Accounts.AccountProductTypes.Standard")]
    public partial class Accounts_AccountProductTypes_StandardWorkflowTests : Accounts_AccountProductTypes_WorkflowTestsBase
    {
        public Accounts_AccountProductTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
