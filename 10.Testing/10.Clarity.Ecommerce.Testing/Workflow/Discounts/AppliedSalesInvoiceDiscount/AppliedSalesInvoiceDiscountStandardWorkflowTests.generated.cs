...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesInvoiceDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesInvoiceDiscount,
            AppliedSalesInvoiceDiscount,
            IAppliedSalesInvoiceDiscountModel,
            AppliedSalesInvoiceDiscountModel,
            IAppliedSalesInvoiceDiscountSearchModel,
            AppliedSalesInvoiceDiscountSearchModel,
            AppliedSalesInvoiceDiscountWorkflow>
    {
        protected Discounts_AppliedSalesInvoiceDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesInvoiceDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSalesInvoiceDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesInvoiceDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesInvoiceDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesInvoiceDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesInvoiceDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesInvoiceDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesInvoiceDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesInvoiceDiscounts.Standard")]
    public partial class Discounts_AppliedSalesInvoiceDiscounts_StandardWorkflowTests : Discounts_AppliedSalesInvoiceDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesInvoiceDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
