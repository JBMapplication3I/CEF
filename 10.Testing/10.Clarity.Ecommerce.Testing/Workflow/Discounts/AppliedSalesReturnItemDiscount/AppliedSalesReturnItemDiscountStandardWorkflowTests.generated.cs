...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesReturnItemDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesReturnItemDiscount,
            AppliedSalesReturnItemDiscount,
            IAppliedSalesReturnItemDiscountModel,
            AppliedSalesReturnItemDiscountModel,
            IAppliedSalesReturnItemDiscountSearchModel,
            AppliedSalesReturnItemDiscountSearchModel,
            AppliedSalesReturnItemDiscountWorkflow>
    {
        protected Discounts_AppliedSalesReturnItemDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesReturnItemDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSalesReturnItemDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesReturnItemDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesReturnItemDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesReturnItemDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesReturnItemDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesReturnItemDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesReturnItemDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesReturnItemDiscounts.Standard")]
    public partial class Discounts_AppliedSalesReturnItemDiscounts_StandardWorkflowTests : Discounts_AppliedSalesReturnItemDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesReturnItemDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
