...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountCountries_WorkflowTestsBase
        : AbstractBase<
            IDiscountCountry,
            DiscountCountry,
            IDiscountCountryModel,
            DiscountCountryModel,
            IDiscountCountrySearchModel,
            DiscountCountrySearchModel,
            DiscountCountryWorkflow>
    {
        protected Discounts_DiscountCountries_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountCountryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountCountry>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountCountries;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountCountry>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountCountries;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountCountryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountCountryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountCountries.Standard")]
    public partial class Discounts_DiscountCountries_StandardWorkflowTests : Discounts_DiscountCountries_WorkflowTestsBase
    {
        public Discounts_DiscountCountries_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
