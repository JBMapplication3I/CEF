...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountProducts_WorkflowTestsBase
        : AbstractBase<
            IDiscountProduct,
            DiscountProduct,
            IDiscountProductModel,
            DiscountProductModel,
            IDiscountProductSearchModel,
            DiscountProductSearchModel,
            DiscountProductWorkflow>
    {
        protected Discounts_DiscountProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountProducts;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountProductModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountProducts.Standard")]
    public partial class Discounts_DiscountProducts_StandardWorkflowTests : Discounts_DiscountProducts_WorkflowTestsBase
    {
        public Discounts_DiscountProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
