...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountShipCarrierMethods_WorkflowTestsBase
        : AbstractBase<
            IDiscountShipCarrierMethod,
            DiscountShipCarrierMethod,
            IDiscountShipCarrierMethodModel,
            DiscountShipCarrierMethodModel,
            IDiscountShipCarrierMethodSearchModel,
            DiscountShipCarrierMethodSearchModel,
            DiscountShipCarrierMethodWorkflow>
    {
        protected Discounts_DiscountShipCarrierMethods_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountShipCarrierMethodTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoDiscountShipCarrierMethodTable = true,
                DoShipCarrierMethodTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountShipCarrierMethod>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountShipCarrierMethods;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountShipCarrierMethod>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountShipCarrierMethods;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountShipCarrierMethodModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountShipCarrierMethodModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountShipCarrierMethods.Standard")]
    public partial class Discounts_DiscountShipCarrierMethods_StandardWorkflowTests : Discounts_DiscountShipCarrierMethods_WorkflowTestsBase
    {
        public Discounts_DiscountShipCarrierMethods_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
