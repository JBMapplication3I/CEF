...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesInvoiceItemDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesInvoiceItemDiscount,
            AppliedSalesInvoiceItemDiscount,
            IAppliedSalesInvoiceItemDiscountModel,
            AppliedSalesInvoiceItemDiscountModel,
            IAppliedSalesInvoiceItemDiscountSearchModel,
            AppliedSalesInvoiceItemDiscountSearchModel,
            AppliedSalesInvoiceItemDiscountWorkflow>
    {
        protected Discounts_AppliedSalesInvoiceItemDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesInvoiceItemDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSalesInvoiceItemDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesInvoiceItemDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesInvoiceItemDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesInvoiceItemDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesInvoiceItemDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesInvoiceItemDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesInvoiceItemDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesInvoiceItemDiscounts.Standard")]
    public partial class Discounts_AppliedSalesInvoiceItemDiscounts_StandardWorkflowTests : Discounts_AppliedSalesInvoiceItemDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesInvoiceItemDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
