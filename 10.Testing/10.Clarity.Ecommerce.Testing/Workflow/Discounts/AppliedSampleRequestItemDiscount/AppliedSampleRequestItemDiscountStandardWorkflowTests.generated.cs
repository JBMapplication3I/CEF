// <autogenerated>
// <copyright file="Discounts.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSampleRequestItemDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSampleRequestItemDiscount,
            AppliedSampleRequestItemDiscount,
            IAppliedSampleRequestItemDiscountModel,
            AppliedSampleRequestItemDiscountModel,
            IAppliedSampleRequestItemDiscountSearchModel,
            AppliedSampleRequestItemDiscountSearchModel,
            AppliedSampleRequestItemDiscountWorkflow>
    {
        protected Discounts_AppliedSampleRequestItemDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSampleRequestItemDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSampleRequestItemDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSampleRequestItemDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSampleRequestItemDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSampleRequestItemDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSampleRequestItemDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSampleRequestItemDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSampleRequestItemDiscountModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawDiscounts.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Discounts.AppliedSampleRequestItemDiscounts.Standard")]
    public partial class Discounts_AppliedSampleRequestItemDiscounts_StandardWorkflowTests : Discounts_AppliedSampleRequestItemDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSampleRequestItemDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
