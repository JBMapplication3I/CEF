...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedPurchaseOrderDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedPurchaseOrderDiscount,
            AppliedPurchaseOrderDiscount,
            IAppliedPurchaseOrderDiscountModel,
            AppliedPurchaseOrderDiscountModel,
            IAppliedPurchaseOrderDiscountSearchModel,
            AppliedPurchaseOrderDiscountSearchModel,
            AppliedPurchaseOrderDiscountWorkflow>
    {
        protected Discounts_AppliedPurchaseOrderDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedPurchaseOrderDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedPurchaseOrderDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedPurchaseOrderDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedPurchaseOrderDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedPurchaseOrderDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedPurchaseOrderDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedPurchaseOrderDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedPurchaseOrderDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedPurchaseOrderDiscounts.Standard")]
    public partial class Discounts_AppliedPurchaseOrderDiscounts_StandardWorkflowTests : Discounts_AppliedPurchaseOrderDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedPurchaseOrderDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
