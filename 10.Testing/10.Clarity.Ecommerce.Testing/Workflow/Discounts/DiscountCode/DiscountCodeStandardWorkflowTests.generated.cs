...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountCodes_WorkflowTestsBase
        : AbstractBase<
            IDiscountCode,
            DiscountCode,
            IDiscountCodeModel,
            ...
            DiscountCodeSearchModel,
            DiscountCodeWorkflow>
    {
        protected Discounts_DiscountCodes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountCodeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountCode>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountCodes;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountCode>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountCodes;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountCodeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountCodeModel
            {
                ...
                DiscountID = mockingSetup.RawDiscounts.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountCodes.Standard")]
    public partial class Discounts_DiscountCodes_StandardWorkflowTests : Discounts_DiscountCodes_WorkflowTestsBase
    {
        public Discounts_DiscountCodes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
