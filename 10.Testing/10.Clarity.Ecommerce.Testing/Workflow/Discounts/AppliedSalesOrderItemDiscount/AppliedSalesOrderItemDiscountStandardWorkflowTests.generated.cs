...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesOrderItemDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesOrderItemDiscount,
            AppliedSalesOrderItemDiscount,
            IAppliedSalesOrderItemDiscountModel,
            AppliedSalesOrderItemDiscountModel,
            IAppliedSalesOrderItemDiscountSearchModel,
            AppliedSalesOrderItemDiscountSearchModel,
            AppliedSalesOrderItemDiscountWorkflow>
    {
        protected Discounts_AppliedSalesOrderItemDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesOrderItemDiscountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesOrderItemDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesOrderItemDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesOrderItemDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesOrderItemDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesOrderItemDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesOrderItemDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesOrderItemDiscounts.Standard")]
    public partial class Discounts_AppliedSalesOrderItemDiscounts_StandardWorkflowTests : Discounts_AppliedSalesOrderItemDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesOrderItemDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
