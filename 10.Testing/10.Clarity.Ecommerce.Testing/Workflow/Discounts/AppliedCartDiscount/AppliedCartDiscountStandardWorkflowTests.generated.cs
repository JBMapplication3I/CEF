...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedCartDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedCartDiscount,
            AppliedCartDiscount,
            IAppliedCartDiscountModel,
            AppliedCartDiscountModel,
            IAppliedCartDiscountSearchModel,
            AppliedCartDiscountSearchModel,
            AppliedCartDiscountWorkflow>
    {
        protected Discounts_AppliedCartDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedCartDiscountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedCartDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedCartDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedCartDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedCartDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedCartDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedCartDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedCartDiscounts.Standard")]
    public partial class Discounts_AppliedCartDiscounts_StandardWorkflowTests : Discounts_AppliedCartDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedCartDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
