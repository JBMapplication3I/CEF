...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedCartItemDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedCartItemDiscount,
            AppliedCartItemDiscount,
            IAppliedCartItemDiscountModel,
            AppliedCartItemDiscountModel,
            IAppliedCartItemDiscountSearchModel,
            AppliedCartItemDiscountSearchModel,
            AppliedCartItemDiscountWorkflow>
    {
        protected Discounts_AppliedCartItemDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedCartItemDiscountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedCartItemDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedCartItemDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedCartItemDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedCartItemDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedCartItemDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedCartItemDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedCartItemDiscounts.Standard")]
    public partial class Discounts_AppliedCartItemDiscounts_StandardWorkflowTests : Discounts_AppliedCartItemDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedCartItemDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
