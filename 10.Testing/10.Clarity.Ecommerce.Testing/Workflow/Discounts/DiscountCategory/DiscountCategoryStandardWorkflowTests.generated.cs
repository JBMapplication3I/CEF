...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountCategories_WorkflowTestsBase
        : AbstractBase<
            IDiscountCategory,
            DiscountCategory,
            IDiscountCategoryModel,
            DiscountCategoryModel,
            IDiscountCategorySearchModel,
            DiscountCategorySearchModel,
            DiscountCategoryWorkflow>
    {
        protected Discounts_DiscountCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountCategories;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountCategoryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountCategories.Standard")]
    public partial class Discounts_DiscountCategories_StandardWorkflowTests : Discounts_DiscountCategories_WorkflowTestsBase
    {
        public Discounts_DiscountCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
