...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountUserRoles_WorkflowTestsBase
        : AbstractBase<
            IDiscountUserRole,
            DiscountUserRole,
            IDiscountUserRoleModel,
            DiscountUserRoleModel,
            IDiscountUserRoleSearchModel,
            DiscountUserRoleSearchModel,
            DiscountUserRoleWorkflow>
    {
        protected Discounts_DiscountUserRoles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountUserRoleTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountUserRole>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountUserRoles;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountUserRole>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountUserRoles;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountUserRoleModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountUserRoleModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawDiscounts.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Discounts.DiscountUserRoles.Standard")]
    public partial class Discounts_DiscountUserRoles_StandardWorkflowTests : Discounts_DiscountUserRoles_WorkflowTestsBase
    {
        public Discounts_DiscountUserRoles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
