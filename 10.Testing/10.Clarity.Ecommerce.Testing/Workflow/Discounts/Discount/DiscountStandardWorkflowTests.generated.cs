...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_Discounts_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            DiscountWorkflow>
    {
        protected Discounts_Discounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoDiscountAccountTable = true,
                DoDiscountAccountTypeTable = true,
                DoDiscountBrandTable = true,
                DoDiscountCategoryTable = true,
                DoDiscountCodeTable = true,
                DoDiscountCountryTable = true,
                DoDiscountFranchiseTable = true,
                DoDiscountManufacturerTable = true,
                DoDiscountProductTable = true,
                DoDiscountProductTypeTable = true,
                DoDiscountShipCarrierMethodTable = true,
                DoDiscountStoreTable = true,
                DoDiscountUserTable = true,
                DoDiscountUserRoleTable = true,
                DoDiscountVendorTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Discount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Discounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<Discount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Discounts.Discounts.Standard")]
    public partial class Discounts_Discounts_StandardWorkflowTests : Discounts_Discounts_WorkflowTestsBase
    {
        public Discounts_Discounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
