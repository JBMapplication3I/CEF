...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountVendors_WorkflowTestsBase
        : AbstractBase<
            IDiscountVendor,
            DiscountVendor,
            IDiscountVendorModel,
            DiscountVendorModel,
            IDiscountVendorSearchModel,
            DiscountVendorSearchModel,
            DiscountVendorWorkflow>
    {
        protected Discounts_DiscountVendors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountVendorTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountVendor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountVendors;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountVendor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountVendors;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountVendorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountVendorModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountVendors.Standard")]
    public partial class Discounts_DiscountVendors_StandardWorkflowTests : Discounts_DiscountVendors_WorkflowTestsBase
    {
        public Discounts_DiscountVendors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
