...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountStores_WorkflowTestsBase
        : AbstractBase<
            IDiscountStore,
            DiscountStore,
            IDiscountStoreModel,
            DiscountStoreModel,
            IDiscountStoreSearchModel,
            DiscountStoreSearchModel,
            DiscountStoreWorkflow>
    {
        protected Discounts_DiscountStores_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountStoreTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountStore>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountStores;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountStore>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountStores;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountStoreModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountStoreModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountStores.Standard")]
    public partial class Discounts_DiscountStores_StandardWorkflowTests : Discounts_DiscountStores_WorkflowTestsBase
    {
        public Discounts_DiscountStores_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
