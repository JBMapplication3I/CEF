...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSampleRequestDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSampleRequestDiscount,
            AppliedSampleRequestDiscount,
            IAppliedSampleRequestDiscountModel,
            AppliedSampleRequestDiscountModel,
            IAppliedSampleRequestDiscountSearchModel,
            AppliedSampleRequestDiscountSearchModel,
            AppliedSampleRequestDiscountWorkflow>
    {
        protected Discounts_AppliedSampleRequestDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSampleRequestDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSampleRequestDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSampleRequestDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSampleRequestDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSampleRequestDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSampleRequestDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSampleRequestDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSampleRequestDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSampleRequestDiscounts.Standard")]
    public partial class Discounts_AppliedSampleRequestDiscounts_StandardWorkflowTests : Discounts_AppliedSampleRequestDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSampleRequestDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
