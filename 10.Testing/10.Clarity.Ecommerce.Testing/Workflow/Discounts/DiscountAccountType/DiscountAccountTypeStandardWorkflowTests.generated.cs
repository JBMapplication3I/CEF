...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountAccountTypes_WorkflowTestsBase
        : AbstractBase<
            IDiscountAccountType,
            DiscountAccountType,
            IDiscountAccountTypeModel,
            DiscountAccountTypeModel,
            IDiscountAccountTypeSearchModel,
            DiscountAccountTypeSearchModel,
            DiscountAccountTypeWorkflow>
    {
        protected Discounts_DiscountAccountTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountAccountTypeTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoDiscountAccountTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountAccountType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountAccountTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountAccountType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountAccountTypes;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountAccountTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountAccountTypeModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawAccountTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Discounts.DiscountAccountTypes.Standard")]
    public partial class Discounts_DiscountAccountTypes_StandardWorkflowTests : Discounts_DiscountAccountTypes_WorkflowTestsBase
    {
        public Discounts_DiscountAccountTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
