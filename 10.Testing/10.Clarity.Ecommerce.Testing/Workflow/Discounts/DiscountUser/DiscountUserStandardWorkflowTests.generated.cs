...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountUsers_WorkflowTestsBase
        : AbstractBase<
            IDiscountUser,
            DiscountUser,
            IDiscountUserModel,
            DiscountUserModel,
            IDiscountUserSearchModel,
            DiscountUserSearchModel,
            DiscountUserWorkflow>
    {
        protected Discounts_DiscountUsers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountUserTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountUser>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountUsers;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountUser>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountUsers;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountUserModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountUserModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountUsers.Standard")]
    public partial class Discounts_DiscountUsers_StandardWorkflowTests : Discounts_DiscountUsers_WorkflowTestsBase
    {
        public Discounts_DiscountUsers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
