...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesOrderDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesOrderDiscount,
            AppliedSalesOrderDiscount,
            IAppliedSalesOrderDiscountModel,
            AppliedSalesOrderDiscountModel,
            IAppliedSalesOrderDiscountSearchModel,
            AppliedSalesOrderDiscountSearchModel,
            AppliedSalesOrderDiscountWorkflow>
    {
        protected Discounts_AppliedSalesOrderDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesOrderDiscountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesOrderDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesOrderDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesOrderDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesOrderDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesOrderDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesOrderDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesOrderDiscounts.Standard")]
    public partial class Discounts_AppliedSalesOrderDiscounts_StandardWorkflowTests : Discounts_AppliedSalesOrderDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesOrderDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
