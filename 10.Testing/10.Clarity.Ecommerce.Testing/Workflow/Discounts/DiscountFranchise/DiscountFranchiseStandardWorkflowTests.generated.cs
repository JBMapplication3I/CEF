...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountFranchises_WorkflowTestsBase
        : AbstractBase<
            IDiscountFranchise,
            DiscountFranchise,
            IDiscountFranchiseModel,
            DiscountFranchiseModel,
            IDiscountFranchiseSearchModel,
            DiscountFranchiseSearchModel,
            DiscountFranchiseWorkflow>
    {
        protected Discounts_DiscountFranchises_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountFranchiseTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountFranchise>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountFranchises;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountFranchise>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountFranchises;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountFranchiseModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountFranchiseModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawFranchises.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Discounts.DiscountFranchises.Standard")]
    public partial class Discounts_DiscountFranchises_StandardWorkflowTests : Discounts_DiscountFranchises_WorkflowTestsBase
    {
        public Discounts_DiscountFranchises_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
