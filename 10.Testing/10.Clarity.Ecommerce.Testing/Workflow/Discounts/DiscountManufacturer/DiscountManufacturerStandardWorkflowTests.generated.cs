...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountManufacturers_WorkflowTestsBase
        : AbstractBase<
            IDiscountManufacturer,
            DiscountManufacturer,
            IDiscountManufacturerModel,
            DiscountManufacturerModel,
            IDiscountManufacturerSearchModel,
            DiscountManufacturerSearchModel,
            DiscountManufacturerWorkflow>
    {
        protected Discounts_DiscountManufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountManufacturerTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoDiscountManufacturerTable = true,
                DoManufacturerTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountManufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountManufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountManufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountManufacturerModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountManufacturers.Standard")]
    public partial class Discounts_DiscountManufacturers_StandardWorkflowTests : Discounts_DiscountManufacturers_WorkflowTestsBase
    {
        public Discounts_DiscountManufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
