...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesReturnDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesReturnDiscount,
            AppliedSalesReturnDiscount,
            IAppliedSalesReturnDiscountModel,
            AppliedSalesReturnDiscountModel,
            IAppliedSalesReturnDiscountSearchModel,
            AppliedSalesReturnDiscountSearchModel,
            AppliedSalesReturnDiscountWorkflow>
    {
        protected Discounts_AppliedSalesReturnDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesReturnDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSalesReturnDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesReturnDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesReturnDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesReturnDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesReturnDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesReturnDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesReturnDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesReturnDiscounts.Standard")]
    public partial class Discounts_AppliedSalesReturnDiscounts_StandardWorkflowTests : Discounts_AppliedSalesReturnDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesReturnDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
