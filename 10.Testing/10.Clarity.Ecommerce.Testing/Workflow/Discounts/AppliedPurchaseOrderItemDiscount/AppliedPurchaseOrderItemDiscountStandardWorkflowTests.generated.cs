...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedPurchaseOrderItemDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedPurchaseOrderItemDiscount,
            ...
            AppliedPurchaseOrderItemDiscountSearchModel,
            AppliedPurchaseOrderItemDiscountWorkflow>
    {
        protected Discounts_AppliedPurchaseOrderItemDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedPurchaseOrderItemDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedPurchaseOrderItemDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedPurchaseOrderItemDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedPurchaseOrderItemDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedPurchaseOrderItemDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedPurchaseOrderItemDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedPurchaseOrderItemDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedPurchaseOrderItemDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedPurchaseOrderItemDiscounts.Standard")]
    public partial class Discounts_AppliedPurchaseOrderItemDiscounts_StandardWorkflowTests : Discounts_AppliedPurchaseOrderItemDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedPurchaseOrderItemDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
