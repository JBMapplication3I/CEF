...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountAccounts_WorkflowTestsBase
        : AbstractBase<
            IDiscountAccount,
            DiscountAccount,
            IDiscountAccountModel,
            DiscountAccountModel,
            IDiscountAccountSearchModel,
            DiscountAccountSearchModel,
            DiscountAccountWorkflow>
    {
        protected Discounts_DiscountAccounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountAccountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountAccount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountAccounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountAccount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountAccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountAccountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.DiscountAccounts.Standard")]
    public partial class Discounts_DiscountAccounts_StandardWorkflowTests : Discounts_DiscountAccounts_WorkflowTestsBase
    {
        public Discounts_DiscountAccounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
