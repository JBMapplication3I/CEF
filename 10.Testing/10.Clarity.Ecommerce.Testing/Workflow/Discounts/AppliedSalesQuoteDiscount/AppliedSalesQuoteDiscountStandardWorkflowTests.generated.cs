...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesQuoteDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesQuoteDiscount,
            AppliedSalesQuoteDiscount,
            IAppliedSalesQuoteDiscountModel,
            AppliedSalesQuoteDiscountModel,
            IAppliedSalesQuoteDiscountSearchModel,
            AppliedSalesQuoteDiscountSearchModel,
            AppliedSalesQuoteDiscountWorkflow>
    {
        protected Discounts_AppliedSalesQuoteDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesQuoteDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSalesQuoteDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesQuoteDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesQuoteDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesQuoteDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesQuoteDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesQuoteDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesQuoteDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesQuoteDiscounts.Standard")]
    public partial class Discounts_AppliedSalesQuoteDiscounts_StandardWorkflowTests : Discounts_AppliedSalesQuoteDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesQuoteDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
