...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_DiscountBrands_WorkflowTestsBase
        : AbstractBase<
            IDiscountBrand,
            DiscountBrand,
            IDiscountBrandModel,
            DiscountBrandModel,
            IDiscountBrandSearchModel,
            DiscountBrandSearchModel,
            DiscountBrandWorkflow>
    {
        protected Discounts_DiscountBrands_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDiscountBrandTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DiscountBrand>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DiscountBrands;
        }

        /// <inheritdoc/>
        protected override List<Mock<DiscountBrand>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDiscountBrands;
        }

        /// <inheritdoc/>
        protected override async Task<DiscountBrandModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DiscountBrandModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                SlaveID = mockingSetup.RawBrands.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Discounts.DiscountBrands.Standard")]
    public partial class Discounts_DiscountBrands_StandardWorkflowTests : Discounts_DiscountBrands_WorkflowTestsBase
    {
        public Discounts_DiscountBrands_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
