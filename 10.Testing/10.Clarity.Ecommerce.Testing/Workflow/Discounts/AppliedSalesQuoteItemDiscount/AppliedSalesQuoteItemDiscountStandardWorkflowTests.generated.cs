...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Discounts_AppliedSalesQuoteItemDiscounts_WorkflowTestsBase
        : AbstractBase<
            IAppliedSalesQuoteItemDiscount,
            AppliedSalesQuoteItemDiscount,
            IAppliedSalesQuoteItemDiscountModel,
            AppliedSalesQuoteItemDiscountModel,
            IAppliedSalesQuoteItemDiscountSearchModel,
            AppliedSalesQuoteItemDiscountSearchModel,
            AppliedSalesQuoteItemDiscountWorkflow>
    {
        protected Discounts_AppliedSalesQuoteItemDiscounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppliedSalesQuoteItemDiscountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAppliedSalesQuoteItemDiscountTable = true,
                DoDiscountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AppliedSalesQuoteItemDiscount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppliedSalesQuoteItemDiscounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppliedSalesQuoteItemDiscount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppliedSalesQuoteItemDiscounts;
        }

        /// <inheritdoc/>
        protected override async Task<AppliedSalesQuoteItemDiscountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppliedSalesQuoteItemDiscountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Discounts.AppliedSalesQuoteItemDiscounts.Standard")]
    public partial class Discounts_AppliedSalesQuoteItemDiscounts_StandardWorkflowTests : Discounts_AppliedSalesQuoteItemDiscounts_WorkflowTestsBase
    {
        public Discounts_AppliedSalesQuoteItemDiscounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
