...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scouting_ScoutCategoryTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IScoutCategoryType,
            ScoutCategoryType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            ScoutCategoryTypeWorkflow>
    {
        protected Scouting_ScoutCategoryTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoScoutCategoryTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ScoutCategoryType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ScoutCategoryTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ScoutCategoryType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawScoutCategoryTypes;
        }
    ...
    [Trait("Category", "Workflows.Scouting.ScoutCategoryTypes.Standard")]
    public partial class Scouting_ScoutCategoryTypes_StandardWorkflowTests : Scouting_ScoutCategoryTypes_WorkflowTestsBase
    {
        public Scouting_ScoutCategoryTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
