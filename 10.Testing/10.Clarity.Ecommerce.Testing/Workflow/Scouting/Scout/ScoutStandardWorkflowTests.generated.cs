...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scouting_Scouts_WorkflowTestsBase
        : AbstractBase<
            IScout,
            Scout,
            IScoutModel,
            ...
            ScoutWorkflow>
    {
        protected Scouting_Scouts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoScoutTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Scout>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Scouts;
        }

        /// <inheritdoc/>
        protected override List<Mock<Scout>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawScouts;
        }

        /// <inheritdoc/>
        protected override async Task<ScoutModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ScoutModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Scouting.Scouts.Standard")]
    public partial class Scouting_Scouts_StandardWorkflowTests : Scouting_Scouts_WorkflowTestsBase
    {
        public Scouting_Scouts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
