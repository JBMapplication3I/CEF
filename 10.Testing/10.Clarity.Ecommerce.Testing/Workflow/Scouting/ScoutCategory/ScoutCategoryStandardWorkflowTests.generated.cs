// <autogenerated>
// <copyright file="Scouting.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scouting_ScoutCategories_WorkflowTestsBase
        : AbstractBase<
            IScoutCategory,
            ScoutCategory,
            IScoutCategoryModel,
            ...
            ScoutCategorySearchModel,
            ScoutCategoryWorkflow>
    {
        protected Scouting_ScoutCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoScoutCategoryTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoScoutTable = true,
                DoScoutCategoryTable = true,
                DoScoutCategoryTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ScoutCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ScoutCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<ScoutCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawScoutCategories;
        }

        /// <inheritdoc/>
        protected override async Task<ScoutCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ScoutCategoryModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawScouts.First().Object.ID,
                SlaveID = mockingSetup.RawCategories.First().Object.ID,
                TypeID = mockingSetup.RawScoutCategoryTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Scouting.ScoutCategories.Standard")]
    public partial class Scouting_ScoutCategories_StandardWorkflowTests : Scouting_ScoutCategories_WorkflowTestsBase
    {
        public Scouting_ScoutCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
