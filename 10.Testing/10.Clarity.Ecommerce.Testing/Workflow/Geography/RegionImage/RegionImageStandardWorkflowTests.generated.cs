...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_RegionImages_WorkflowTestsBase
        : AbstractNameableBase<
            IRegionImage,
            RegionImage,
            IRegionImageModel,
            RegionImageModel,
            IRegionImageSearchModel,
            RegionImageSearchModel,
            RegionImageWorkflow>
    {
        protected Geography_RegionImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRegionImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoRegionImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<RegionImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RegionImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<RegionImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRegionImages;
        }

        /// <inheritdoc/>
        protected override async Task<RegionImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new RegionImageModel
            {
                ...
                TypeID = mockingSetup.RawRegionImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Geography.RegionImages.Standard")]
    public partial class Geography_RegionImages_StandardWorkflowTests : Geography_RegionImages_WorkflowTestsBase
    {
        public Geography_RegionImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
