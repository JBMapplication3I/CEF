...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_Districts_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            DistrictWorkflow>
    {
        protected Geography_Districts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDistrictTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<District>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Districts;
        }

        /// <inheritdoc/>
        protected override List<Mock<District>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDistricts;
        }

        /// <inheritdoc/>
        protected override async Task<DistrictModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Geography.Districts.Standard")]
    public partial class Geography_Districts_StandardWorkflowTests : Geography_Districts_WorkflowTestsBase
    {
        public Geography_Districts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
