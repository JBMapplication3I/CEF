...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_CountryLanguages_WorkflowTestsBase
        : AbstractBase<
            ICountryLanguage,
            CountryLanguage,
            ICountryLanguageModel,
            CountryLanguageModel,
            ICountryLanguageSearchModel,
            CountryLanguageSearchModel,
            CountryLanguageWorkflow>
    {
        protected Geography_CountryLanguages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCountryLanguageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCountryLanguageTable = true,
                DoLanguageTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CountryLanguage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CountryLanguages;
        }

        /// <inheritdoc/>
        protected override List<Mock<CountryLanguage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCountryLanguages;
        }

        /// <inheritdoc/>
        protected override async Task<CountryLanguageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Geography.CountryLanguages.Standard")]
    public partial class Geography_CountryLanguages_StandardWorkflowTests : Geography_CountryLanguages_WorkflowTestsBase
    {
        public Geography_CountryLanguages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
