...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_Regions_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            RegionWorkflow>
    {
        protected Geography_Regions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRegionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Region>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Regions;
        }

        /// <inheritdoc/>
        protected override List<Mock<Region>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRegions;
        }

        /// <inheritdoc/>
        protected override async Task<RegionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Geography.Regions.Standard")]
    public partial class Geography_Regions_StandardWorkflowTests : Geography_Regions_WorkflowTestsBase
    {
        public Geography_Regions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
