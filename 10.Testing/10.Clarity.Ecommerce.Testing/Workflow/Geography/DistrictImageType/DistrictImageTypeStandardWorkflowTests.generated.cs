...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_DistrictImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IDistrictImageType,
            DistrictImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            DistrictImageTypeWorkflow>
    {
        protected Geography_DistrictImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDistrictImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<DistrictImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DistrictImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<DistrictImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDistrictImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Geography.DistrictImageTypes.Standard")]
    public partial class Geography_DistrictImageTypes_StandardWorkflowTests : Geography_DistrictImageTypes_WorkflowTestsBase
    {
        public Geography_DistrictImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
