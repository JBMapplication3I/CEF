...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_DistrictLanguages_WorkflowTestsBase
        : AbstractBase<
            IDistrictLanguage,
            DistrictLanguage,
            IDistrictLanguageModel,
            DistrictLanguageModel,
            IDistrictLanguageSearchModel,
            DistrictLanguageSearchModel,
            DistrictLanguageWorkflow>
    {
        protected Geography_DistrictLanguages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDistrictLanguageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoDistrictLanguageTable = true,
                DoLanguageTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<DistrictLanguage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DistrictLanguages;
        }

        /// <inheritdoc/>
        protected override List<Mock<DistrictLanguage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDistrictLanguages;
        }

        /// <inheritdoc/>
        protected override async Task<DistrictLanguageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DistrictLanguageModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Geography.DistrictLanguages.Standard")]
    public partial class Geography_DistrictLanguages_StandardWorkflowTests : Geography_DistrictLanguages_WorkflowTestsBase
    {
        public Geography_DistrictLanguages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
