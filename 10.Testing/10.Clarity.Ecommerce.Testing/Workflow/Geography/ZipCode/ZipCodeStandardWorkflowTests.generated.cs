...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_ZipCodes_WorkflowTestsBase
        : AbstractBase<
            IZipCode,
            ZipCode,
            IZipCodeModel,
            ...
            ZipCodeWorkflow>
    {
        protected Geography_ZipCodes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoZipCodeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ZipCode>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ZipCodes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ZipCode>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawZipCodes;
        }

        /// <inheritdoc/>
        protected override async Task<ZipCodeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Geography.ZipCodes.Standard")]
    public partial class Geography_ZipCodes_StandardWorkflowTests : Geography_ZipCodes_WorkflowTestsBase
    {
        public Geography_ZipCodes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
