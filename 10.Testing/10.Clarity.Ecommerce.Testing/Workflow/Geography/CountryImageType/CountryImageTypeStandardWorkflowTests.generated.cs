...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_CountryImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICountryImageType,
            CountryImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CountryImageTypeWorkflow>
    {
        protected Geography_CountryImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCountryImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CountryImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CountryImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CountryImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCountryImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Geography.CountryImageTypes.Standard")]
    public partial class Geography_CountryImageTypes_StandardWorkflowTests : Geography_CountryImageTypes_WorkflowTestsBase
    {
        public Geography_CountryImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
