...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_RegionLanguages_WorkflowTestsBase
        : AbstractBase<
            IRegionLanguage,
            RegionLanguage,
            IRegionLanguageModel,
            RegionLanguageModel,
            IRegionLanguageSearchModel,
            RegionLanguageSearchModel,
            RegionLanguageWorkflow>
    {
        protected Geography_RegionLanguages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRegionLanguageTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<RegionLanguage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RegionLanguages;
        }

        /// <inheritdoc/>
        protected override List<Mock<RegionLanguage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRegionLanguages;
        }

        /// <inheritdoc/>
        protected override async Task<RegionLanguageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new RegionLanguageModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Geography.RegionLanguages.Standard")]
    public partial class Geography_RegionLanguages_StandardWorkflowTests : Geography_RegionLanguages_WorkflowTestsBase
    {
        public Geography_RegionLanguages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
