...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_Countries_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            CountryWorkflow>
    {
        protected Geography_Countries_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCountryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Country>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Countries;
        }

        /// <inheritdoc/>
        protected override List<Mock<Country>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCountries;
        }

        /// <inheritdoc/>
        protected override async Task<CountryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Geography.Countries.Standard")]
    public partial class Geography_Countries_StandardWorkflowTests : Geography_Countries_WorkflowTestsBase
    {
        public Geography_Countries_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
