...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_RegionCurrencies_WorkflowTestsBase
        : AbstractBase<
            IRegionCurrency,
            RegionCurrency,
            IRegionCurrencyModel,
            RegionCurrencyModel,
            IRegionCurrencySearchModel,
            RegionCurrencySearchModel,
            RegionCurrencyWorkflow>
    {
        protected Geography_RegionCurrencies_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRegionCurrencyTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<RegionCurrency>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RegionCurrencies;
        }

        /// <inheritdoc/>
        protected override List<Mock<RegionCurrency>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRegionCurrencies;
        }

        /// <inheritdoc/>
        protected override async Task<RegionCurrencyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new RegionCurrencyModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Geography.RegionCurrencies.Standard")]
    public partial class Geography_RegionCurrencies_StandardWorkflowTests : Geography_RegionCurrencies_WorkflowTestsBase
    {
        public Geography_RegionCurrencies_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
