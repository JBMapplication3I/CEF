...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_Addresses_WorkflowTestsBase
        : AbstractBase<
            IAddress,
            Address,
            IAddressModel,
            ...
            AddressWorkflow>
    {
        protected Geography_Addresses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAddressTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Address>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Addresses;
        }

        /// <inheritdoc/>
        protected override List<Mock<Address>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAddresses;
        }

        /// <inheritdoc/>
        protected override async Task<AddressModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Geography.Addresses.Standard")]
    public partial class Geography_Addresses_StandardWorkflowTests : Geography_Addresses_WorkflowTestsBase
    {
        public Geography_Addresses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
