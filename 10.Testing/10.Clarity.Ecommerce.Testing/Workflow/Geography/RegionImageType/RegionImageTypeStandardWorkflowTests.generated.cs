...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_RegionImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IRegionImageType,
            RegionImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            RegionImageTypeWorkflow>
    {
        protected Geography_RegionImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoRegionImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<RegionImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RegionImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<RegionImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawRegionImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Geography.RegionImageTypes.Standard")]
    public partial class Geography_RegionImageTypes_StandardWorkflowTests : Geography_RegionImageTypes_WorkflowTestsBase
    {
        public Geography_RegionImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
