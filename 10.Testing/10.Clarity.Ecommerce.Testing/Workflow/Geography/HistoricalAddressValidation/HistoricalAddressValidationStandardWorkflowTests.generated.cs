...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_HistoricalAddressValidations_WorkflowTestsBase
        : AbstractBase<
            IHistoricalAddressValidation,
            HistoricalAddressValidation,
            IHistoricalAddressValidationModel,
            HistoricalAddressValidationModel,
            IHistoricalAddressValidationSearchModel,
            HistoricalAddressValidationSearchModel,
            HistoricalAddressValidationWorkflow>
    {
        protected Geography_HistoricalAddressValidations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoHistoricalAddressValidationTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoHistoricalAddressValidationTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<HistoricalAddressValidation>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.HistoricalAddressValidations;
        }

        /// <inheritdoc/>
        protected override List<Mock<HistoricalAddressValidation>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawHistoricalAddressValidations;
        }

        /// <inheritdoc/>
        protected override async Task<HistoricalAddressValidationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new HistoricalAddressValidationModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Geography.HistoricalAddressValidations.Standard")]
    public partial class Geography_HistoricalAddressValidations_StandardWorkflowTests : Geography_HistoricalAddressValidations_WorkflowTestsBase
    {
        public Geography_HistoricalAddressValidations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
