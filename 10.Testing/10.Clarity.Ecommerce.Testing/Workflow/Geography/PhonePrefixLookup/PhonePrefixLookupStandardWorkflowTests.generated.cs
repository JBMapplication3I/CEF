...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_PhonePrefixLookups_WorkflowTestsBase
        : AbstractBase<
            IPhonePrefixLookup,
            PhonePrefixLookup,
            IPhonePrefixLookupModel,
            PhonePrefixLookupModel,
            IPhonePrefixLookupSearchModel,
            PhonePrefixLookupSearchModel,
            PhonePrefixLookupWorkflow>
    {
        protected Geography_PhonePrefixLookups_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPhonePrefixLookupTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCountryTable = true,
                DoPhonePrefixLookupTable = true,
                DoRegionTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<PhonePrefixLookup>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PhonePrefixLookups;
        }

        /// <inheritdoc/>
        protected override List<Mock<PhonePrefixLookup>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPhonePrefixLookups;
        }

        /// <inheritdoc/>
        protected override async Task<PhonePrefixLookupModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PhonePrefixLookupModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Geography.PhonePrefixLookups.Standard")]
    public partial class Geography_PhonePrefixLookups_StandardWorkflowTests : Geography_PhonePrefixLookups_WorkflowTestsBase
    {
        public Geography_PhonePrefixLookups_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
