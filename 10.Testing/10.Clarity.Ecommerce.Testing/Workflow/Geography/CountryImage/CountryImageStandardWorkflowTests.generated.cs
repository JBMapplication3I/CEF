...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_CountryImages_WorkflowTestsBase
        : AbstractNameableBase<
            ICountryImage,
            CountryImage,
            ICountryImageModel,
            CountryImageModel,
            ICountryImageSearchModel,
            CountryImageSearchModel,
            CountryImageWorkflow>
    {
        protected Geography_CountryImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCountryImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCountryImageTable = true,
                DoCountryImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CountryImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CountryImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<CountryImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCountryImages;
        }

        /// <inheritdoc/>
        protected override async Task<CountryImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CountryImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawCountryImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Geography.CountryImages.Standard")]
    public partial class Geography_CountryImages_StandardWorkflowTests : Geography_CountryImages_WorkflowTestsBase
    {
        public Geography_CountryImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
