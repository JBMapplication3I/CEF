...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_DistrictCurrencies_WorkflowTestsBase
        : AbstractBase<
            IDistrictCurrency,
            DistrictCurrency,
            IDistrictCurrencyModel,
            DistrictCurrencyModel,
            IDistrictCurrencySearchModel,
            DistrictCurrencySearchModel,
            DistrictCurrencyWorkflow>
    {
        protected Geography_DistrictCurrencies_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoDistrictCurrencyTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoDistrictCurrencyTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<DistrictCurrency>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.DistrictCurrencies;
        }

        /// <inheritdoc/>
        protected override List<Mock<DistrictCurrency>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawDistrictCurrencies;
        }

        /// <inheritdoc/>
        protected override async Task<DistrictCurrencyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new DistrictCurrencyModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Geography.DistrictCurrencies.Standard")]
    public partial class Geography_DistrictCurrencies_StandardWorkflowTests : Geography_DistrictCurrencies_WorkflowTestsBase
    {
        public Geography_DistrictCurrencies_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
