...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Geography_CountryCurrencies_WorkflowTestsBase
        : AbstractBase<
            ICountryCurrency,
            CountryCurrency,
            ICountryCurrencyModel,
            CountryCurrencyModel,
            ICountryCurrencySearchModel,
            CountryCurrencySearchModel,
            CountryCurrencyWorkflow>
    {
        protected Geography_CountryCurrencies_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCountryCurrencyTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCountryCurrencyTable = true,
                DoCurrencyTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CountryCurrency>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CountryCurrencies;
        }

        /// <inheritdoc/>
        protected override List<Mock<CountryCurrency>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCountryCurrencies;
        }

        /// <inheritdoc/>
        protected override async Task<CountryCurrencyModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CountryCurrencyModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Geography.CountryCurrencies.Standard")]
    public partial class Geography_CountryCurrencies_StandardWorkflowTests : Geography_CountryCurrencies_WorkflowTestsBase
    {
        public Geography_CountryCurrencies_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
