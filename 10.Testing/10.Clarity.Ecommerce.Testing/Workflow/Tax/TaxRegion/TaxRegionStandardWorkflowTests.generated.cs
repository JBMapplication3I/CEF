...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tax_TaxRegions_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            TaxRegionSearchModel,
            TaxRegionWorkflow>
    {
        protected Tax_TaxRegions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoTaxRegionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoRegionTable = true,
                DoTaxRegionTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<TaxRegion>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.TaxRegions;
        }

        /// <inheritdoc/>
        protected override List<Mock<TaxRegion>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawTaxRegions;
        }

        /// <inheritdoc/>
        protected override async Task<TaxRegionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new TaxRegionModel
            {
                Active = true,
                ...
                RegionID = mockingSetup.RawRegions.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Tax.TaxRegions.Standard")]
    public partial class Tax_TaxRegions_StandardWorkflowTests : Tax_TaxRegions_WorkflowTestsBase
    {
        public Tax_TaxRegions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
