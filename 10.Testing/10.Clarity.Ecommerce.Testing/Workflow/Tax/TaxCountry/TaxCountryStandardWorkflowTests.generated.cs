...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tax_TaxCountries_WorkflowTestsBase
        : AbstractNameableBase<
            ITaxCountry,
            TaxCountry,
            ITaxCountryModel,
            TaxCountryModel,
            ITaxCountrySearchModel,
            TaxCountrySearchModel,
            TaxCountryWorkflow>
    {
        protected Tax_TaxCountries_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoTaxCountryTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCountryTable = true,
                DoTaxCountryTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<TaxCountry>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.TaxCountries;
        }

        /// <inheritdoc/>
        protected override List<Mock<TaxCountry>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawTaxCountries;
        }

        /// <inheritdoc/>
        protected override async Task<TaxCountryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new TaxCountryModel
            {
                Active = true,
                ...
                CountryID = mockingSetup.RawCountries.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Tax.TaxCountries.Standard")]
    public partial class Tax_TaxCountries_StandardWorkflowTests : Tax_TaxCountries_WorkflowTestsBase
    {
        public Tax_TaxCountries_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
