...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tax_TaxDistricts_WorkflowTestsBase
        : AbstractNameableBase<
            ITaxDistrict,
            TaxDistrict,
            ITaxDistrictModel,
            TaxDistrictModel,
            ITaxDistrictSearchModel,
            TaxDistrictSearchModel,
            TaxDistrictWorkflow>
    {
        protected Tax_TaxDistricts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoTaxDistrictTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoTaxDistrictTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<TaxDistrict>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.TaxDistricts;
        }

        /// <inheritdoc/>
        protected override List<Mock<TaxDistrict>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawTaxDistricts;
        }

        /// <inheritdoc/>
        protected override async Task<TaxDistrictModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new TaxDistrictModel
            {
                Active = true,
                ...
                DistrictID = mockingSetup.RawDistricts.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Tax.TaxDistricts.Standard")]
    public partial class Tax_TaxDistricts_StandardWorkflowTests : Tax_TaxDistricts_WorkflowTestsBase
    {
        public Tax_TaxDistricts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
