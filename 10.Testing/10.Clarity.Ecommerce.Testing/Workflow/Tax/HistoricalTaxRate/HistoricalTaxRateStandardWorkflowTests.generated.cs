// <autogenerated>
// <copyright file="Tax.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tax_HistoricalTaxRates_WorkflowTestsBase
        : AbstractBase<
            IHistoricalTaxRate,
            HistoricalTaxRate,
            IHistoricalTaxRateModel,
            HistoricalTaxRateModel,
            IHistoricalTaxRateSearchModel,
            HistoricalTaxRateSearchModel,
            HistoricalTaxRateWorkflow>
    {
        protected Tax_HistoricalTaxRates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoHistoricalTaxRateTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoHistoricalTaxRateTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<HistoricalTaxRate>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.HistoricalTaxRates;
        }

        /// <inheritdoc/>
        protected override List<Mock<HistoricalTaxRate>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawHistoricalTaxRates;
        }

        /// <inheritdoc/>
        protected override async Task<HistoricalTaxRateModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new HistoricalTaxRateModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Tax.HistoricalTaxRates.Standard")]
    public partial class Tax_HistoricalTaxRates_StandardWorkflowTests : Tax_HistoricalTaxRates_WorkflowTestsBase
    {
        public Tax_HistoricalTaxRates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
