// <autogenerated>
// <copyright file="Scheduling.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scheduling_CalendarAppointments_WorkflowTestsBase
        : AbstractBase<
            ...
            CalendarAppointmentSearchModel,
            CalendarAppointmentWorkflow>
    {
        protected Scheduling_CalendarAppointments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarAppointmentTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CalendarAppointment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CalendarAppointments;
        }

        /// <inheritdoc/>
        protected override List<Mock<CalendarAppointment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendarAppointments;
        }

        /// <inheritdoc/>
        protected override async Task<CalendarAppointmentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CalendarAppointmentModel
            {
                ...
                MasterID = mockingSetup.RawCalendars.First().Object.ID,
                SlaveID = mockingSetup.RawAppointments.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Scheduling.CalendarAppointments.Standard")]
    public partial class Scheduling_CalendarAppointments_StandardWorkflowTests : Scheduling_CalendarAppointments_WorkflowTestsBase
    {
        public Scheduling_CalendarAppointments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
