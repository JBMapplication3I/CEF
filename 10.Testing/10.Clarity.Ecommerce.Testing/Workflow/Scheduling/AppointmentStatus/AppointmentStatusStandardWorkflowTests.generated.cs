...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scheduling_AppointmentStatuses_WorkflowTestsBase
    ...
    {
        protected Scheduling_AppointmentStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppointmentStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AppointmentStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppointmentStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppointmentStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppointmentStatuses;
        }
    ...
    [Trait("Category", "Workflows.Scheduling.AppointmentStatuses.Standard")]
    public partial class Scheduling_AppointmentStatuses_StandardWorkflowTests : Scheduling_AppointmentStatuses_WorkflowTestsBase
    {
        public Scheduling_AppointmentStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
