...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scheduling_AppointmentTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAppointmentType,
            AppointmentType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            AppointmentTypeWorkflow>
    {
        protected Scheduling_AppointmentTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppointmentTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AppointmentType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AppointmentTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AppointmentType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppointmentTypes;
        }
    ...
    [Trait("Category", "Workflows.Scheduling.AppointmentTypes.Standard")]
    public partial class Scheduling_AppointmentTypes_StandardWorkflowTests : Scheduling_AppointmentTypes_WorkflowTestsBase
    {
        public Scheduling_AppointmentTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
