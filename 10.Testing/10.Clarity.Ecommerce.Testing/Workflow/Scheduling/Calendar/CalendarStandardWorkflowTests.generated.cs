...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scheduling_Calendars_WorkflowTestsBase
        : AbstractBase<
            ICalendar,
            Calendar,
            ICalendarModel,
            ...
            CalendarWorkflow>
    {
        protected Scheduling_Calendars_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCalendarTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Calendar>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Calendars;
        }

        /// <inheritdoc/>
        protected override List<Mock<Calendar>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCalendars;
        }

        /// <inheritdoc/>
        protected override async Task<CalendarModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CalendarModel
            {
                ...
                AccountID = mockingSetup.RawAccounts.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Scheduling.Calendars.Standard")]
    public partial class Scheduling_Calendars_StandardWorkflowTests : Scheduling_Calendars_WorkflowTestsBase
    {
        public Scheduling_Calendars_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
