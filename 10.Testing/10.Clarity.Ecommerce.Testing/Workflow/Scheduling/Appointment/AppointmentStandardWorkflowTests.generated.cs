...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Scheduling_Appointments_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            AppointmentWorkflow>
    {
        protected Scheduling_Appointments_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAppointmentTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Appointment>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Appointments;
        }

        /// <inheritdoc/>
        protected override List<Mock<Appointment>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAppointments;
        }

        /// <inheritdoc/>
        protected override async Task<AppointmentModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AppointmentModel
            {
                ...
                TypeID = mockingSetup.RawAppointmentTypes.First().Object.ID,
                StatusID = mockingSetup.RawAppointmentStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Scheduling.Appointments.Standard")]
    public partial class Scheduling_Appointments_StandardWorkflowTests : Scheduling_Appointments_WorkflowTestsBase
    {
        public Scheduling_Appointments_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
