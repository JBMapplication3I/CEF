// <autogenerated>
// <copyright file="Sales.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sales_SalesItemTargetTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesItemTargetType,
            SalesItemTargetType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            SalesItemTargetTypeWorkflow>
    {
        protected Sales_SalesItemTargetTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesItemTargetTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesItemTargetType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesItemTargetTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesItemTargetType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesItemTargetTypes;
        }
    ...
    [Trait("Category", "Workflows.Sales.SalesItemTargetTypes.Standard")]
    public partial class Sales_SalesItemTargetTypes_StandardWorkflowTests : Sales_SalesItemTargetTypes_WorkflowTestsBase
    {
        public Sales_SalesItemTargetTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
