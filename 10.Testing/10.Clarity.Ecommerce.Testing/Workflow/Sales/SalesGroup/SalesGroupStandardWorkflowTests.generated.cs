...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Sales_SalesGroups_WorkflowTestsBase
        : AbstractBase<
            ISalesGroup,
            SalesGroup,
            ISalesGroupModel,
            SalesGroupModel,
            ISalesGroupSearchModel,
            SalesGroupSearchModel,
            SalesGroupWorkflow>
    {
        protected Sales_SalesGroups_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesGroupTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesGroup>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesGroups;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesGroup>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesGroups;
        }

        /// <inheritdoc/>
        protected override async Task<SalesGroupModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Sales.SalesGroups.Standard")]
    public partial class Sales_SalesGroups_StandardWorkflowTests : Sales_SalesGroups_WorkflowTestsBase
    {
        public Sales_SalesGroups_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
