...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Vendors_VendorImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IVendorImageType,
            VendorImageType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            VendorImageTypeWorkflow>
    {
        protected Vendors_VendorImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVendorImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<VendorImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.VendorImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<VendorImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVendorImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Vendors.VendorImageTypes.Standard")]
    public partial class Vendors_VendorImageTypes_StandardWorkflowTests : Vendors_VendorImageTypes_WorkflowTestsBase
    {
        public Vendors_VendorImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
