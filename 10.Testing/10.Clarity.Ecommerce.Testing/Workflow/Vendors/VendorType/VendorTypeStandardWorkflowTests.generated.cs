...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Vendors_VendorTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IVendorType,
            VendorType,
            ITypeModel,
            ...
            VendorTypeWorkflow>
    {
        protected Vendors_VendorTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVendorTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<VendorType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.VendorTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<VendorType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVendorTypes;
        }
    ...
    [Trait("Category", "Workflows.Vendors.VendorTypes.Standard")]
    public partial class Vendors_VendorTypes_StandardWorkflowTests : Vendors_VendorTypes_WorkflowTestsBase
    {
        public Vendors_VendorTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
