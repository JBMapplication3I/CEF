...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Vendors_VendorProducts_WorkflowTestsBase
        : AbstractBase<
            IVendorProduct,
            VendorProduct,
            IVendorProductModel,
            ...
            VendorProductWorkflow>
    {
        protected Vendors_VendorProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVendorProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<VendorProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.VendorProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<VendorProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVendorProducts;
        }

        /// <inheritdoc/>
        protected override async Task<VendorProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Vendors.VendorProducts.Standard")]
    public partial class Vendors_VendorProducts_StandardWorkflowTests : Vendors_VendorProducts_WorkflowTestsBase
    {
        public Vendors_VendorProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
