// <autogenerated>
// <copyright file="Vendors.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Vendors_Vendors_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            VendorWorkflow>
    {
        protected Vendors_Vendors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVendorTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoVendorTable = true,
                DoVendorAccountTable = true,
                DoVendorImageTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Vendor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Vendors;
        }

        /// <inheritdoc/>
        protected override List<Mock<Vendor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVendors;
        }

        /// <inheritdoc/>
        protected override async Task<VendorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new VendorModel
            {
                ...
                TypeID = mockingSetup.RawVendorTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Vendors.Vendors.Standard")]
    public partial class Vendors_Vendors_StandardWorkflowTests : Vendors_Vendors_WorkflowTestsBase
    {
        public Vendors_Vendors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
