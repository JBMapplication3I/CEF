...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Vendors_VendorImages_WorkflowTestsBase
        : AbstractNameableBase<
            IVendorImage,
            VendorImage,
            IVendorImageModel,
            VendorImageModel,
            IVendorImageSearchModel,
            VendorImageSearchModel,
            VendorImageWorkflow>
    {
        protected Vendors_VendorImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVendorImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoVendorImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<VendorImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.VendorImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<VendorImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVendorImages;
        }

        /// <inheritdoc/>
        protected override async Task<VendorImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new VendorImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawVendorImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Vendors.VendorImages.Standard")]
    public partial class Vendors_VendorImages_StandardWorkflowTests : Vendors_VendorImages_WorkflowTestsBase
    {
        public Vendors_VendorImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
