...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Vendors_VendorManufacturers_WorkflowTestsBase
        : AbstractBase<
            IVendorManufacturer,
            VendorManufacturer,
            IVendorManufacturerModel,
            VendorManufacturerModel,
            IVendorManufacturerSearchModel,
            VendorManufacturerSearchModel,
            VendorManufacturerWorkflow>
    {
        protected Vendors_VendorManufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVendorManufacturerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<VendorManufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.VendorManufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<VendorManufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVendorManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<VendorManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new VendorManufacturerModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawVendors.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Vendors.VendorManufacturers.Standard")]
    public partial class Vendors_VendorManufacturers_StandardWorkflowTests : Vendors_VendorManufacturers_WorkflowTestsBase
    {
        public Vendors_VendorManufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
