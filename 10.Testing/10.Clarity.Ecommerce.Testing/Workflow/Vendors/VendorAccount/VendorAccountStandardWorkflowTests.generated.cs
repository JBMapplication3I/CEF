...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Vendors_VendorAccounts_WorkflowTestsBase
        : AbstractBase<
            IVendorAccount,
            VendorAccount,
            IVendorAccountModel,
            VendorAccountModel,
            IVendorAccountSearchModel,
            VendorAccountSearchModel,
            VendorAccountWorkflow>
    {
        protected Vendors_VendorAccounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVendorAccountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<VendorAccount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.VendorAccounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<VendorAccount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVendorAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<VendorAccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new VendorAccountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Vendors.VendorAccounts.Standard")]
    public partial class Vendors_VendorAccounts_StandardWorkflowTests : Vendors_VendorAccounts_WorkflowTestsBase
    {
        public Vendors_VendorAccounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
