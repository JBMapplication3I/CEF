// <autogenerated>
// <copyright file="Media.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Media_StoredFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            StoredFileWorkflow>
    {
        protected Media_StoredFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoredFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoredFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoredFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoredFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoredFiles;
        }

        /// <inheritdoc/>
        protected override async Task<StoredFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Media.StoredFiles.Standard")]
    public partial class Media_StoredFiles_StandardWorkflowTests : Media_StoredFiles_WorkflowTestsBase
    {
        public Media_StoredFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
