...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnStates_WorkflowTestsBase
        : AbstractStateableBase<
            ...
            IStateSearchModel,
            StateSearchModel,
            SalesReturnStateWorkflow>
    {
        protected Returning_SalesReturnStates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnStateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnState>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnStates;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnState>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnStates;
        }
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnStates.Standard")]
    public partial class Returning_SalesReturnStates_StandardWorkflowTests : Returning_SalesReturnStates_WorkflowTestsBase
    {
        public Returning_SalesReturnStates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
