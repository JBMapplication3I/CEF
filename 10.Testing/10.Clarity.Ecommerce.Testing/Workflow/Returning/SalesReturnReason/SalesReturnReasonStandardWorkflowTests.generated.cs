...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnReasons_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesReturnReason,
            SalesReturnReason,
            ISalesReturnReasonModel,
            SalesReturnReasonModel,
            ISalesReturnReasonSearchModel,
            SalesReturnReasonSearchModel,
            SalesReturnReasonWorkflow>
    {
        protected Returning_SalesReturnReasons_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnReasonTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnReason>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnReasons;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnReason>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnReasons;
        }

        /// <inheritdoc/>
        protected override async Task<SalesReturnReasonModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesReturnReasonModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnReasons.Standard")]
    public partial class Returning_SalesReturnReasons_StandardWorkflowTests : Returning_SalesReturnReasons_WorkflowTestsBase
    {
        public Returning_SalesReturnReasons_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
