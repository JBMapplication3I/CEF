...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnSalesOrders_WorkflowTestsBase
        : AbstractBase<
            ISalesReturnSalesOrder,
            SalesReturnSalesOrder,
            ISalesReturnSalesOrderModel,
            SalesReturnSalesOrderModel,
            ISalesReturnSalesOrderSearchModel,
            SalesReturnSalesOrderSearchModel,
            SalesReturnSalesOrderWorkflow>
    {
        protected Returning_SalesReturnSalesOrders_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnSalesOrderTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesReturnTable = true,
                DoSalesReturnReasonTable = true,
                DoSalesReturnSalesOrderTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnSalesOrder>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnSalesOrders;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnSalesOrder>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnSalesOrders;
        }

        /// <inheritdoc/>
        protected override async Task<SalesReturnSalesOrderModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesReturnSalesOrderModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawSalesReturns.First().Object.ID,
                SlaveID = mockingSetup.RawSalesOrders.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Returning.SalesReturnSalesOrders.Standard")]
    public partial class Returning_SalesReturnSalesOrders_StandardWorkflowTests : Returning_SalesReturnSalesOrders_WorkflowTestsBase
    {
        public Returning_SalesReturnSalesOrders_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
