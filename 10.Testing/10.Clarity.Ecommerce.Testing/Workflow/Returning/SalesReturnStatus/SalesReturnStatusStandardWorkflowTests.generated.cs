...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            SalesReturnStatusWorkflow>
    {
        protected Returning_SalesReturnStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnStatuses;
        }
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnStatuses.Standard")]
    public partial class Returning_SalesReturnStatuses_StandardWorkflowTests : Returning_SalesReturnStatuses_WorkflowTestsBase
    {
        public Returning_SalesReturnStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
