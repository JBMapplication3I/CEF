...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesReturnFile,
            SalesReturnFile,
            ISalesReturnFileModel,
            SalesReturnFileModel,
            ISalesReturnFileSearchModel,
            SalesReturnFileSearchModel,
            SalesReturnFileWorkflow>
    {
        protected Returning_SalesReturnFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnFiles;
        }

        /// <inheritdoc/>
        protected override async Task<SalesReturnFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesReturnFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnFiles.Standard")]
    public partial class Returning_SalesReturnFiles_StandardWorkflowTests : Returning_SalesReturnFiles_WorkflowTestsBase
    {
        public Returning_SalesReturnFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
