...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnContacts_WorkflowTestsBase
        : AbstractBase<
            ISalesReturnContact,
            SalesReturnContact,
            ISalesReturnContactModel,
            SalesReturnContactModel,
            ISalesReturnContactSearchModel,
            SalesReturnContactSearchModel,
            SalesReturnContactWorkflow>
    {
        protected Returning_SalesReturnContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnContacts;
        }

        /// <inheritdoc/>
        protected override async Task<SalesReturnContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesReturnContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnContacts.Standard")]
    public partial class Returning_SalesReturnContacts_StandardWorkflowTests : Returning_SalesReturnContacts_WorkflowTestsBase
    {
        public Returning_SalesReturnContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
