...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturns_WorkflowTestsBase
        : AbstractBase<
            ISalesReturn,
            SalesReturn,
            ISalesReturnModel,
            ...
            SalesReturnWorkflow>
    {
        protected Returning_SalesReturns_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesReturnContactTable = true,
                DoSalesReturnFileTable = true,
                DoSalesReturnItemTable = true,
                DoSalesReturnPaymentTable = true,
                DoSalesReturnReasonTable = true,
                DoSalesReturnSalesOrderTable = true,
                DoSalesReturnStateTable = true,
                DoSalesReturnStatusTable = true,
                DoSalesReturnTypeTable = true,
                DoStoreTable = true,
                DoUserTable = true,
            };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturn>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturns;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturn>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturns;
        }

        /// <inheritdoc/>
        protected override async Task<SalesReturnModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesReturnModel
            {
                ...
                StatusID = mockingSetup.RawSalesReturnStatuses.First().Object.ID,
                StateID = mockingSetup.RawSalesReturnStates.First().Object.ID,
                TypeID = mockingSetup.RawSalesReturnTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Returning.SalesReturns.Standard")]
    public partial class Returning_SalesReturns_StandardWorkflowTests : Returning_SalesReturns_WorkflowTestsBase
    {
        public Returning_SalesReturns_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
