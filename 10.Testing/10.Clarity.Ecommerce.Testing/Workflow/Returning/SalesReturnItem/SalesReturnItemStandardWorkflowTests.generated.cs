// <autogenerated>
// <copyright file="Returning.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnItems_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesReturnItem,
            SalesReturnItem,
            ISalesItemBaseModel<IAppliedSalesReturnItemDiscountModel>,
            SalesItemBaseModel<IAppliedSalesReturnItemDiscountModel, AppliedSalesReturnItemDiscountModel>,
            ISalesItemBaseSearchModel,
            SalesItemBaseSearchModel,
            SalesReturnItemWorkflow>
    {
        protected Returning_SalesReturnItems_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnItemTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesReturnItemTable = true,
                DoSalesReturnItemTargetTable = true,
                DoSalesReturnReasonTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnItem>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnItems;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnItem>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnItems;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemBaseModel<IAppliedSalesReturnItemDiscountModel, AppliedSalesReturnItemDiscountModel>> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemBaseModel<IAppliedSalesReturnItemDiscountModel, AppliedSalesReturnItemDiscountModel>
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnItems.Standard")]
    public partial class Returning_SalesReturnItems_StandardWorkflowTests : Returning_SalesReturnItems_WorkflowTestsBase
    {
        public Returning_SalesReturnItems_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
