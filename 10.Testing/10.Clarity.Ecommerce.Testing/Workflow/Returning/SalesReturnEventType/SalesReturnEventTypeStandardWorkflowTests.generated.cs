...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesReturnEventType,
            SalesReturnEventType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            SalesReturnEventTypeWorkflow>
    {
        protected Returning_SalesReturnEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnEventTypes.Standard")]
    public partial class Returning_SalesReturnEventTypes_StandardWorkflowTests : Returning_SalesReturnEventTypes_WorkflowTestsBase
    {
        public Returning_SalesReturnEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
