...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnItemTargets_WorkflowTestsBase
        : AbstractBase<
            ...
            SalesReturnItemTargetWorkflow>
    {
        protected Returning_SalesReturnItemTargets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnItemTargetTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnItemTarget>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnItemTargets;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnItemTarget>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnItemTargets;
        }
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnItemTargets.Standard")]
    public partial class Returning_SalesReturnItemTargets_StandardWorkflowTests : Returning_SalesReturnItemTargets_WorkflowTestsBase
    {
        public Returning_SalesReturnItemTargets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
