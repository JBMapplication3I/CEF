...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnEvents_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesReturnEvent,
            SalesReturnEvent,
            ISalesReturnEventModel,
            SalesReturnEventModel,
            ISalesReturnEventSearchModel,
            SalesReturnEventSearchModel,
            SalesReturnEventWorkflow>
    {
        protected Returning_SalesReturnEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnEventTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesReturnEventTable = true,
                DoSalesReturnEventTypeTable = true,
                DoSalesReturnReasonTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnEvents;
        }

        /// <inheritdoc/>
        protected override async Task<SalesReturnEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesReturnEventModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawSalesReturnEventTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Returning.SalesReturnEvents.Standard")]
    public partial class Returning_SalesReturnEvents_StandardWorkflowTests : Returning_SalesReturnEvents_WorkflowTestsBase
    {
        public Returning_SalesReturnEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
