...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Returning_SalesReturnTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesReturnType,
            SalesReturnType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            SalesReturnTypeWorkflow>
    {
        protected Returning_SalesReturnTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesReturnTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesReturnType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesReturnTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesReturnType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesReturnTypes;
        }
    ...
    [Trait("Category", "Workflows.Returning.SalesReturnTypes.Standard")]
    public partial class Returning_SalesReturnTypes_StandardWorkflowTests : Returning_SalesReturnTypes_WorkflowTestsBase
    {
        public Returning_SalesReturnTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
