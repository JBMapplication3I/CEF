...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_VisitStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            VisitStatusWorkflow>
    {
        protected Tracking_VisitStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVisitStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<VisitStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.VisitStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<VisitStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVisitStatuses;
        }
    ...
    [Trait("Category", "Workflows.Tracking.VisitStatuses.Standard")]
    public partial class Tracking_VisitStatuses_StandardWorkflowTests : Tracking_VisitStatuses_WorkflowTestsBase
    {
        public Tracking_VisitStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
