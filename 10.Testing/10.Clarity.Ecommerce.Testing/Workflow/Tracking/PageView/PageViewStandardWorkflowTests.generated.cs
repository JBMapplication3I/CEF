...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_PageViews_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            PageViewWorkflow>
    {
        protected Tracking_PageViews_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPageViewTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoPageViewStatusTable = true,
                DoPageViewTypeTable = true,
                DoProductTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PageView>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PageViews;
        }

        /// <inheritdoc/>
        protected override List<Mock<PageView>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPageViews;
        }

        /// <inheritdoc/>
        protected override async Task<PageViewModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PageViewModel
            {
                ...
                TypeID = mockingSetup.RawPageViewTypes.First().Object.ID,
                StatusID = mockingSetup.RawPageViewStatuses.First().Object.ID,
                // Optional Related Properties
                AddressID = null,
                IPOrganizationID = null,
                UserID = null,
                CampaignID = null,
                ContactID = null,
                SiteDomainID = null,
    ...
    [Trait("Category", "Workflows.Tracking.PageViews.Standard")]
    public partial class Tracking_PageViews_StandardWorkflowTests : Tracking_PageViews_WorkflowTestsBase
    {
        public Tracking_PageViews_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
