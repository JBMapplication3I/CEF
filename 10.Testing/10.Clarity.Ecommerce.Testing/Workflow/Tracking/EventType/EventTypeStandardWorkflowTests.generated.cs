...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_EventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IEventType,
            EventType,
            ITypeModel,
            ...
            EventTypeWorkflow>
    {
        protected Tracking_EventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<EventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<EventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Tracking.EventTypes.Standard")]
    public partial class Tracking_EventTypes_StandardWorkflowTests : Tracking_EventTypes_WorkflowTestsBase
    {
        public Tracking_EventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
