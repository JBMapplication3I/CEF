...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_CampaignTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICampaignType,
            CampaignType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CampaignTypeWorkflow>
    {
        protected Tracking_CampaignTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCampaignTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CampaignType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CampaignTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CampaignType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCampaignTypes;
        }
    ...
    [Trait("Category", "Workflows.Tracking.CampaignTypes.Standard")]
    public partial class Tracking_CampaignTypes_StandardWorkflowTests : Tracking_CampaignTypes_WorkflowTestsBase
    {
        public Tracking_CampaignTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
