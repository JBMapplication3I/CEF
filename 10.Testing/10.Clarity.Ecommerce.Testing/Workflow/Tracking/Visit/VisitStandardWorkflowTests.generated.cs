...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_Visits_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            VisitWorkflow>
    {
        protected Tracking_Visits_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVisitTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoVisitTable = true,
                DoVisitorTable = true,
                DoVisitStatusTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Visit>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Visits;
        }

        /// <inheritdoc/>
        protected override List<Mock<Visit>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVisits;
        }

        /// <inheritdoc/>
        protected override async Task<VisitModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new VisitModel
            {
                ...
                StatusID = mockingSetup.RawVisitStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Tracking.Visits.Standard")]
    public partial class Tracking_Visits_StandardWorkflowTests : Tracking_Visits_WorkflowTestsBase
    {
        public Tracking_Visits_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
