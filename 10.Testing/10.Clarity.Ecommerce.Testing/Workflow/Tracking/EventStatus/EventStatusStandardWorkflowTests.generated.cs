...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_EventStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            EventStatusWorkflow>
    {
        protected Tracking_EventStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEventStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<EventStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.EventStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<EventStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEventStatuses;
        }
    ...
    [Trait("Category", "Workflows.Tracking.EventStatuses.Standard")]
    public partial class Tracking_EventStatuses_StandardWorkflowTests : Tracking_EventStatuses_WorkflowTestsBase
    {
        public Tracking_EventStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
