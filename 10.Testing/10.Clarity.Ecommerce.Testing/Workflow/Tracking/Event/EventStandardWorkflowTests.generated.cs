...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_Events_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            EventWorkflow>
    {
        protected Tracking_Events_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoEventTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Event>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Events;
        }

        /// <inheritdoc/>
        protected override List<Mock<Event>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawEvents;
        }

        /// <inheritdoc/>
        protected override async Task<EventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new EventModel
            {
                ...
                TypeID = mockingSetup.RawEventTypes.First().Object.ID,
                StatusID = mockingSetup.RawEventStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Tracking.Events.Standard")]
    public partial class Tracking_Events_StandardWorkflowTests : Tracking_Events_WorkflowTestsBase
    {
        public Tracking_Events_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
