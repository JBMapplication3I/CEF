// <autogenerated>
// <copyright file="Tracking.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_IPOrganizations_WorkflowTestsBase
        : AbstractNameableBase<
            IIPOrganization,
            IPOrganization,
            IIPOrganizationModel,
            IPOrganizationModel,
            IIPOrganizationSearchModel,
            IPOrganizationSearchModel,
            IPOrganizationWorkflow>
    {
        protected Tracking_IPOrganizations_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoIPOrganizationTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                DoAddressTable = true,
                DoCountryTable = true,
                DoIPOrganizationTable = true,
                DoIPOrganizationStatusTable = true,
                DoRegionTable = true,
                DoUserTable = true,
            };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<IPOrganization>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.IPOrganizations;
        }

        /// <inheritdoc/>
        protected override List<Mock<IPOrganization>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawIPOrganizations;
        }

        /// <inheritdoc/>
        protected override async Task<IPOrganizationModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new IPOrganizationModel
            {
                Active = true,
                ...
                StatusID = mockingSetup.RawIPOrganizationStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Tracking.IPOrganizations.Standard")]
    public partial class Tracking_IPOrganizations_StandardWorkflowTests : Tracking_IPOrganizations_WorkflowTestsBase
    {
        public Tracking_IPOrganizations_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
