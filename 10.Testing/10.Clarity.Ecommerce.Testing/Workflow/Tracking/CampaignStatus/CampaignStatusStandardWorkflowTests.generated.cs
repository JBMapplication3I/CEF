...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_CampaignStatuses_WorkflowTestsBase
    ...
    {
        protected Tracking_CampaignStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCampaignStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CampaignStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CampaignStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<CampaignStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCampaignStatuses;
        }
    ...
    [Trait("Category", "Workflows.Tracking.CampaignStatuses.Standard")]
    public partial class Tracking_CampaignStatuses_StandardWorkflowTests : Tracking_CampaignStatuses_WorkflowTestsBase
    {
        public Tracking_CampaignStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
