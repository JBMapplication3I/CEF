...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_PageViewTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IPageViewType,
            PageViewType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            PageViewTypeWorkflow>
    {
        protected Tracking_PageViewTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPageViewTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PageViewType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PageViewTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<PageViewType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPageViewTypes;
        }
    ...
    [Trait("Category", "Workflows.Tracking.PageViewTypes.Standard")]
    public partial class Tracking_PageViewTypes_StandardWorkflowTests : Tracking_PageViewTypes_WorkflowTestsBase
    {
        public Tracking_PageViewTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
