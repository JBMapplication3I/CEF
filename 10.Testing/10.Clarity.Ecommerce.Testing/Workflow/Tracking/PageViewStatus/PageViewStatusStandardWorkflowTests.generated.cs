...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_PageViewStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            PageViewStatusWorkflow>
    {
        protected Tracking_PageViewStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPageViewStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PageViewStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PageViewStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<PageViewStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPageViewStatuses;
        }
    ...
    [Trait("Category", "Workflows.Tracking.PageViewStatuses.Standard")]
    public partial class Tracking_PageViewStatuses_StandardWorkflowTests : Tracking_PageViewStatuses_WorkflowTestsBase
    {
        public Tracking_PageViewStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
