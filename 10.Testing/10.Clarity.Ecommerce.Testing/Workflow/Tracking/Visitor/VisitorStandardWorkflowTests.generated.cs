...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_Visitors_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            VisitorWorkflow>
    {
        protected Tracking_Visitors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoVisitorTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Visitor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Visitors;
        }

        /// <inheritdoc/>
        protected override List<Mock<Visitor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawVisitors;
        }

        /// <inheritdoc/>
        protected override async Task<VisitorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Tracking.Visitors.Standard")]
    public partial class Tracking_Visitors_StandardWorkflowTests : Tracking_Visitors_WorkflowTestsBase
    {
        public Tracking_Visitors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
