...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_IPOrganizationStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            IIPOrganizationStatus,
            IPOrganizationStatus,
            IStatusModel,
            StatusModel,
            IStatusSearchModel,
            StatusSearchModel,
            IPOrganizationStatusWorkflow>
    {
        protected Tracking_IPOrganizationStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoIPOrganizationStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<IPOrganizationStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.IPOrganizationStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<IPOrganizationStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawIPOrganizationStatuses;
        }

        /// <inheritdoc/>
        protected override async Task<StatusModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
    ...
    [Trait("Category", "Workflows.Tracking.IPOrganizationStatuses.Standard")]
    public partial class Tracking_IPOrganizationStatuses_StandardWorkflowTests : Tracking_IPOrganizationStatuses_WorkflowTestsBase
    {
        public Tracking_IPOrganizationStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
