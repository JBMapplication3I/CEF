...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Tracking_Campaigns_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            CampaignWorkflow>
    {
        protected Tracking_Campaigns_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCampaignTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoCampaignStatusTable = true,
                DoCampaignTypeTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Campaign>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Campaigns;
        }

        /// <inheritdoc/>
        protected override List<Mock<Campaign>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCampaigns;
        }

        /// <inheritdoc/>
        protected override async Task<CampaignModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CampaignModel
            {
                ...
                TypeID = mockingSetup.RawCampaignTypes.First().Object.ID,
                StatusID = mockingSetup.RawCampaignStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Tracking.Campaigns.Standard")]
    public partial class Tracking_Campaigns_StandardWorkflowTests : Tracking_Campaigns_WorkflowTestsBase
    {
        public Tracking_Campaigns_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
