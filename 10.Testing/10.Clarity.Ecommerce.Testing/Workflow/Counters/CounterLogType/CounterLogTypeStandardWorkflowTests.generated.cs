...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Counters_CounterLogTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICounterLogType,
            CounterLogType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            CounterLogTypeWorkflow>
    {
        protected Counters_CounterLogTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCounterLogTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CounterLogType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CounterLogTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CounterLogType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCounterLogTypes;
        }
    ...
    [Trait("Category", "Workflows.Counters.CounterLogTypes.Standard")]
    public partial class Counters_CounterLogTypes_StandardWorkflowTests : Counters_CounterLogTypes_WorkflowTestsBase
    {
        public Counters_CounterLogTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
