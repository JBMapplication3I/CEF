// <autogenerated>
// <copyright file="Counters.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Counters_CounterLogs_WorkflowTestsBase
        : AbstractBase<
            ICounterLog,
            CounterLog,
            ICounterLogModel,
            ...
            CounterLogSearchModel,
            CounterLogWorkflow>
    {
        protected Counters_CounterLogs_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCounterLogTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoCounterTable = true,
                DoCounterLogTable = true,
                DoCounterLogTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<CounterLog>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CounterLogs;
        }

        /// <inheritdoc/>
        protected override List<Mock<CounterLog>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCounterLogs;
        }

        /// <inheritdoc/>
        protected override async Task<CounterLogModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CounterLogModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                TypeID = mockingSetup.RawCounterLogTypes.First().Object.ID,
                CounterID = mockingSetup.RawCounters.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Counters.CounterLogs.Standard")]
    public partial class Counters_CounterLogs_StandardWorkflowTests : Counters_CounterLogs_WorkflowTestsBase
    {
        public Counters_CounterLogs_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
