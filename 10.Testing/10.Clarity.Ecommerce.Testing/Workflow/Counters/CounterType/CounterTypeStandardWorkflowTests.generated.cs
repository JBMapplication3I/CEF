...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Counters_CounterTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ICounterType,
            CounterType,
            ITypeModel,
            ...
            CounterTypeWorkflow>
    {
        protected Counters_CounterTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCounterTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<CounterType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.CounterTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<CounterType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCounterTypes;
        }
    ...
    [Trait("Category", "Workflows.Counters.CounterTypes.Standard")]
    public partial class Counters_CounterTypes_StandardWorkflowTests : Counters_CounterTypes_WorkflowTestsBase
    {
        public Counters_CounterTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
