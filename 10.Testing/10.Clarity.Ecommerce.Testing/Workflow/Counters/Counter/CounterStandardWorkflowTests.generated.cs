...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Counters_Counters_WorkflowTestsBase
        : AbstractBase<
            ICounter,
            Counter,
            ICounterModel,
            ...
            CounterWorkflow>
    {
        protected Counters_Counters_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoCounterTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoCounterTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Counter>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Counters;
        }

        /// <inheritdoc/>
        protected override List<Mock<Counter>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawCounters;
        }

        /// <inheritdoc/>
        protected override async Task<CounterModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new CounterModel
            {
                ...
                TypeID = mockingSetup.RawCounterTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Counters.Counters.Standard")]
    public partial class Counters_Counters_StandardWorkflowTests : Counters_Counters_WorkflowTestsBase
    {
        public Counters_Counters_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
