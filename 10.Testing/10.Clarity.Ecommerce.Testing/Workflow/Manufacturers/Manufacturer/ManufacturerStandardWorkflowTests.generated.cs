// <autogenerated>
// <copyright file="Manufacturers.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Manufacturers_Manufacturers_WorkflowTestsBase
    ...
    {
        protected Manufacturers_Manufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoManufacturerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Manufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Manufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<Manufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<ManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ManufacturerModel
            {
                ...
                TypeID = mockingSetup.RawManufacturerTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Manufacturers.Manufacturers.Standard")]
    public partial class Manufacturers_Manufacturers_StandardWorkflowTests : Manufacturers_Manufacturers_WorkflowTestsBase
    {
        public Manufacturers_Manufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
