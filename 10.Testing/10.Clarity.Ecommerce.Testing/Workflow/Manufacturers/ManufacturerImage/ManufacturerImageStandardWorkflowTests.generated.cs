...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Manufacturers_ManufacturerImages_WorkflowTestsBase
        : AbstractNameableBase<
            IManufacturerImage,
            ManufacturerImage,
            IManufacturerImageModel,
            ManufacturerImageModel,
            IManufacturerImageSearchModel,
            ManufacturerImageSearchModel,
            ManufacturerImageWorkflow>
    {
        protected Manufacturers_ManufacturerImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoManufacturerImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoManufacturerImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<ManufacturerImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ManufacturerImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<ManufacturerImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawManufacturerImages;
        }

        /// <inheritdoc/>
        protected override async Task<ManufacturerImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ManufacturerImageModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawManufacturerImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Manufacturers.ManufacturerImages.Standard")]
    public partial class Manufacturers_ManufacturerImages_StandardWorkflowTests : Manufacturers_ManufacturerImages_WorkflowTestsBase
    {
        public Manufacturers_ManufacturerImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
