...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Manufacturers_ManufacturerTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IManufacturerType,
            ManufacturerType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            ManufacturerTypeWorkflow>
    {
        protected Manufacturers_ManufacturerTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoManufacturerTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ManufacturerType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ManufacturerTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ManufacturerType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawManufacturerTypes;
        }
    ...
    [Trait("Category", "Workflows.Manufacturers.ManufacturerTypes.Standard")]
    public partial class Manufacturers_ManufacturerTypes_StandardWorkflowTests : Manufacturers_ManufacturerTypes_WorkflowTestsBase
    {
        public Manufacturers_ManufacturerTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
