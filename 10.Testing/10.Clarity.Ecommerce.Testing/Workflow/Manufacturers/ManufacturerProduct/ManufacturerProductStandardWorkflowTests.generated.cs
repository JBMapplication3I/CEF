...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Manufacturers_ManufacturerProducts_WorkflowTestsBase
        : AbstractBase<
            IManufacturerProduct,
            ManufacturerProduct,
            IManufacturerProductModel,
            ManufacturerProductModel,
            IManufacturerProductSearchModel,
            ManufacturerProductSearchModel,
            ManufacturerProductWorkflow>
    {
        protected Manufacturers_ManufacturerProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoManufacturerProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ManufacturerProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ManufacturerProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<ManufacturerProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawManufacturerProducts;
        }

        /// <inheritdoc/>
        protected override async Task<ManufacturerProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ManufacturerProductModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawManufacturers.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Manufacturers.ManufacturerProducts.Standard")]
    public partial class Manufacturers_ManufacturerProducts_StandardWorkflowTests : Manufacturers_ManufacturerProducts_WorkflowTestsBase
    {
        public Manufacturers_ManufacturerProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
