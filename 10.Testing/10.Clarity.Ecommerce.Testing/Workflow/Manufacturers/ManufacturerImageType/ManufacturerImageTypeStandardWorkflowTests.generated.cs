...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Manufacturers_ManufacturerImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IManufacturerImageType,
            ManufacturerImageType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            ManufacturerImageTypeWorkflow>
    {
        protected Manufacturers_ManufacturerImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoManufacturerImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ManufacturerImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ManufacturerImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ManufacturerImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawManufacturerImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Manufacturers.ManufacturerImageTypes.Standard")]
    public partial class Manufacturers_ManufacturerImageTypes_StandardWorkflowTests : Manufacturers_ManufacturerImageTypes_WorkflowTestsBase
    {
        public Manufacturers_ManufacturerImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
