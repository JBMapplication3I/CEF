...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleVendors_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleVendor,
            PriceRuleVendor,
            IPriceRuleVendorModel,
            PriceRuleVendorModel,
            IPriceRuleVendorSearchModel,
            PriceRuleVendorSearchModel,
            PriceRuleVendorWorkflow>
    {
        protected Pricing_PriceRuleVendors_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleVendorTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleVendor>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleVendors;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleVendor>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleVendors;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleVendorModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleVendorModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleVendors.Standard")]
    public partial class Pricing_PriceRuleVendors_StandardWorkflowTests : Pricing_PriceRuleVendors_WorkflowTestsBase
    {
        public Pricing_PriceRuleVendors_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
