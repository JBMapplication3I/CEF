...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleUserRoles_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleUserRole,
            PriceRuleUserRole,
            IPriceRuleUserRoleModel,
            PriceRuleUserRoleModel,
            IPriceRuleUserRoleSearchModel,
            PriceRuleUserRoleSearchModel,
            PriceRuleUserRoleWorkflow>
    {
        protected Pricing_PriceRuleUserRoles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleUserRoleTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleUserRole>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleUserRoles;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleUserRole>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleUserRoles;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleUserRoleModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleUserRoleModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                PriceRuleID = mockingSetup.RawPriceRules.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Pricing.PriceRuleUserRoles.Standard")]
    public partial class Pricing_PriceRuleUserRoles_StandardWorkflowTests : Pricing_PriceRuleUserRoles_WorkflowTestsBase
    {
        public Pricing_PriceRuleUserRoles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
