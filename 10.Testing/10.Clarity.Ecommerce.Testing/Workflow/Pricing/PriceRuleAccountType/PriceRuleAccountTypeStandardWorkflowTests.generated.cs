...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleAccountTypes_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleAccountType,
            PriceRuleAccountType,
            IPriceRuleAccountTypeModel,
            PriceRuleAccountTypeModel,
            IPriceRuleAccountTypeSearchModel,
            PriceRuleAccountTypeSearchModel,
            PriceRuleAccountTypeWorkflow>
    {
        protected Pricing_PriceRuleAccountTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleAccountTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleAccountType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleAccountTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleAccountType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleAccountTypes;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleAccountTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleAccountTypeModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawPriceRules.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleAccountTypes.Standard")]
    public partial class Pricing_PriceRuleAccountTypes_StandardWorkflowTests : Pricing_PriceRuleAccountTypes_WorkflowTestsBase
    {
        public Pricing_PriceRuleAccountTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
