...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleAccounts_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleAccount,
            PriceRuleAccount,
            IPriceRuleAccountModel,
            PriceRuleAccountModel,
            IPriceRuleAccountSearchModel,
            PriceRuleAccountSearchModel,
            PriceRuleAccountWorkflow>
    {
        protected Pricing_PriceRuleAccounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleAccountTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleAccount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleAccounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleAccount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleAccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleAccountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleAccounts.Standard")]
    public partial class Pricing_PriceRuleAccounts_StandardWorkflowTests : Pricing_PriceRuleAccounts_WorkflowTestsBase
    {
        public Pricing_PriceRuleAccounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
