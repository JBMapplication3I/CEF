...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleProductTypes_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleProductType,
            PriceRuleProductType,
            IPriceRuleProductTypeModel,
            PriceRuleProductTypeModel,
            IPriceRuleProductTypeSearchModel,
            PriceRuleProductTypeSearchModel,
            PriceRuleProductTypeWorkflow>
    {
        protected Pricing_PriceRuleProductTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleProductTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleProductType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleProductTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleProductType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleProductTypes;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleProductTypeModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleProductTypeModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleProductTypes.Standard")]
    public partial class Pricing_PriceRuleProductTypes_StandardWorkflowTests : Pricing_PriceRuleProductTypes_WorkflowTestsBase
    {
        public Pricing_PriceRuleProductTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
