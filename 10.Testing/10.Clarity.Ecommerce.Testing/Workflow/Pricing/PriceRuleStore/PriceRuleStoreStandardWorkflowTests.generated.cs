...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleStores_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleStore,
            PriceRuleStore,
            IPriceRuleStoreModel,
            PriceRuleStoreModel,
            IPriceRuleStoreSearchModel,
            PriceRuleStoreSearchModel,
            PriceRuleStoreWorkflow>
    {
        protected Pricing_PriceRuleStores_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleStoreTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleStore>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleStores;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleStore>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleStores;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleStoreModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleStoreModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleStores.Standard")]
    public partial class Pricing_PriceRuleStores_StandardWorkflowTests : Pricing_PriceRuleStores_WorkflowTestsBase
    {
        public Pricing_PriceRuleStores_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
