...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleManufacturers_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleManufacturer,
            PriceRuleManufacturer,
            IPriceRuleManufacturerModel,
            PriceRuleManufacturerModel,
            IPriceRuleManufacturerSearchModel,
            PriceRuleManufacturerSearchModel,
            PriceRuleManufacturerWorkflow>
    {
        protected Pricing_PriceRuleManufacturers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleManufacturerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleManufacturer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleManufacturers;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleManufacturer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleManufacturers;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleManufacturerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleManufacturerModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleManufacturers.Standard")]
    public partial class Pricing_PriceRuleManufacturers_StandardWorkflowTests : Pricing_PriceRuleManufacturers_WorkflowTestsBase
    {
        public Pricing_PriceRuleManufacturers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
