...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleBrands_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleBrand,
            PriceRuleBrand,
            IPriceRuleBrandModel,
            PriceRuleBrandModel,
            IPriceRuleBrandSearchModel,
            PriceRuleBrandSearchModel,
            PriceRuleBrandWorkflow>
    {
        protected Pricing_PriceRuleBrands_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleBrandTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleBrand>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleBrands;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleBrand>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleBrands;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleBrandModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleBrandModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleBrands.Standard")]
    public partial class Pricing_PriceRuleBrands_StandardWorkflowTests : Pricing_PriceRuleBrands_WorkflowTestsBase
    {
        public Pricing_PriceRuleBrands_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
