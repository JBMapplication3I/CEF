...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PricePoints_WorkflowTestsBase
        : AbstractTypableBase<
            IPricePoint,
            PricePoint,
            IPricePointModel,
            PricePointModel,
            IPricePointSearchModel,
            PricePointSearchModel,
            PricePointWorkflow>
    {
        protected Pricing_PricePoints_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPricePointTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PricePoint>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PricePoints;
        }

        /// <inheritdoc/>
        protected override List<Mock<PricePoint>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPricePoints;
        }

        /// <inheritdoc/>
        protected override async Task<PricePointModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PricePointModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PricePoints.Standard")]
    public partial class Pricing_PricePoints_StandardWorkflowTests : Pricing_PricePoints_WorkflowTestsBase
    {
        public Pricing_PricePoints_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
