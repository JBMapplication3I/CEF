...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleFranchises_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleFranchise,
            PriceRuleFranchise,
            IPriceRuleFranchiseModel,
            PriceRuleFranchiseModel,
            IPriceRuleFranchiseSearchModel,
            PriceRuleFranchiseSearchModel,
            PriceRuleFranchiseWorkflow>
    {
        protected Pricing_PriceRuleFranchises_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleFranchiseTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleFranchise>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleFranchises;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleFranchise>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleFranchises;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleFranchiseModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleFranchiseModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleFranchises.Standard")]
    public partial class Pricing_PriceRuleFranchises_StandardWorkflowTests : Pricing_PriceRuleFranchises_WorkflowTestsBase
    {
        public Pricing_PriceRuleFranchises_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
