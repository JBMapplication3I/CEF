...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRoundings_WorkflowTestsBase
        : AbstractBase<
            IPriceRounding,
            PriceRounding,
            IPriceRoundingModel,
            ...
            PriceRoundingSearchModel,
            PriceRoundingWorkflow>
    {
        protected Pricing_PriceRoundings_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRoundingTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRounding>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRoundings;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRounding>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRoundings;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRoundingModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRoundingModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRoundings.Standard")]
    public partial class Pricing_PriceRoundings_StandardWorkflowTests : Pricing_PriceRoundings_WorkflowTestsBase
    {
        public Pricing_PriceRoundings_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
