...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleCountries_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleCountry,
            PriceRuleCountry,
            IPriceRuleCountryModel,
            PriceRuleCountryModel,
            IPriceRuleCountrySearchModel,
            PriceRuleCountrySearchModel,
            PriceRuleCountryWorkflow>
    {
        protected Pricing_PriceRuleCountries_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleCountryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleCountry>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleCountries;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleCountry>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleCountries;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleCountryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleCountryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleCountries.Standard")]
    public partial class Pricing_PriceRuleCountries_StandardWorkflowTests : Pricing_PriceRuleCountries_WorkflowTestsBase
    {
        public Pricing_PriceRuleCountries_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
