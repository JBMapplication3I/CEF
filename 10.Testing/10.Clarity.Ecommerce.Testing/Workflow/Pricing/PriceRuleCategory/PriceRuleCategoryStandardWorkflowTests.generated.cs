...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleCategories_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleCategory,
            PriceRuleCategory,
            IPriceRuleCategoryModel,
            PriceRuleCategoryModel,
            IPriceRuleCategorySearchModel,
            PriceRuleCategorySearchModel,
            PriceRuleCategoryWorkflow>
    {
        protected Pricing_PriceRuleCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleCategories;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleCategoryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleCategories.Standard")]
    public partial class Pricing_PriceRuleCategories_StandardWorkflowTests : Pricing_PriceRuleCategories_WorkflowTestsBase
    {
        public Pricing_PriceRuleCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
