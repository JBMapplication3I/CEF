...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Pricing_PriceRuleProducts_WorkflowTestsBase
        : AbstractBase<
            IPriceRuleProduct,
            PriceRuleProduct,
            ...
            PriceRuleProductSearchModel,
            PriceRuleProductWorkflow>
    {
        protected Pricing_PriceRuleProducts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoPriceRuleProductTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<PriceRuleProduct>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.PriceRuleProducts;
        }

        /// <inheritdoc/>
        protected override List<Mock<PriceRuleProduct>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawPriceRuleProducts;
        }

        /// <inheritdoc/>
        protected override async Task<PriceRuleProductModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new PriceRuleProductModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Pricing.PriceRuleProducts.Standard")]
    public partial class Pricing_PriceRuleProducts_StandardWorkflowTests : Pricing_PriceRuleProducts_WorkflowTestsBase
    {
        public Pricing_PriceRuleProducts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
