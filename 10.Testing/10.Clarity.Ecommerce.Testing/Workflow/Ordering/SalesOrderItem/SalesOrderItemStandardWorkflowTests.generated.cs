// <autogenerated>
// <copyright file="Ordering.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderItems_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesOrderItem,
            SalesOrderItem,
            ISalesItemBaseModel<IAppliedSalesOrderItemDiscountModel>,
            SalesItemBaseModel<IAppliedSalesOrderItemDiscountModel, AppliedSalesOrderItemDiscountModel>,
            ISalesItemBaseSearchModel,
            SalesItemBaseSearchModel,
            SalesOrderItemWorkflow>
    {
        protected Ordering_SalesOrderItems_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderItemTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesOrderItemTargetTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderItem>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderItems;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderItem>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderItems;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemBaseModel<IAppliedSalesOrderItemDiscountModel, AppliedSalesOrderItemDiscountModel>> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemBaseModel<IAppliedSalesOrderItemDiscountModel, AppliedSalesOrderItemDiscountModel>
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderItems.Standard")]
    public partial class Ordering_SalesOrderItems_StandardWorkflowTests : Ordering_SalesOrderItems_WorkflowTestsBase
    {
        public Ordering_SalesOrderItems_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
