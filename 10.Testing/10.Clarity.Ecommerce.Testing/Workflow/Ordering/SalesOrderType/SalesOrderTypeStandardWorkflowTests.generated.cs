...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesOrderType,
            SalesOrderType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            SalesOrderTypeWorkflow>
    {
        protected Ordering_SalesOrderTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderTypes;
        }
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderTypes.Standard")]
    public partial class Ordering_SalesOrderTypes_StandardWorkflowTests : Ordering_SalesOrderTypes_WorkflowTestsBase
    {
        public Ordering_SalesOrderTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
