...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderContacts_WorkflowTestsBase
        : AbstractBase<
            ISalesOrderContact,
            SalesOrderContact,
            ISalesOrderContactModel,
            SalesOrderContactModel,
            ISalesOrderContactSearchModel,
            SalesOrderContactSearchModel,
            SalesOrderContactWorkflow>
    {
        protected Ordering_SalesOrderContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderContacts;
        }

        /// <inheritdoc/>
        protected override async Task<SalesOrderContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesOrderContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderContacts.Standard")]
    public partial class Ordering_SalesOrderContacts_StandardWorkflowTests : Ordering_SalesOrderContacts_WorkflowTestsBase
    {
        public Ordering_SalesOrderContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
