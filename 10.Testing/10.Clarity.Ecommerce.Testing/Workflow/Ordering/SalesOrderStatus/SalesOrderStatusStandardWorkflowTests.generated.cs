...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            SalesOrderStatusWorkflow>
    {
        protected Ordering_SalesOrderStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderStatuses;
        }
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderStatuses.Standard")]
    public partial class Ordering_SalesOrderStatuses_StandardWorkflowTests : Ordering_SalesOrderStatuses_WorkflowTestsBase
    {
        public Ordering_SalesOrderStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
