...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesOrderFile,
            SalesOrderFile,
            ISalesOrderFileModel,
            SalesOrderFileModel,
            ISalesOrderFileSearchModel,
            SalesOrderFileSearchModel,
            SalesOrderFileWorkflow>
    {
        protected Ordering_SalesOrderFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderFiles;
        }

        /// <inheritdoc/>
        protected override async Task<SalesOrderFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesOrderFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderFiles.Standard")]
    public partial class Ordering_SalesOrderFiles_StandardWorkflowTests : Ordering_SalesOrderFiles_WorkflowTestsBase
    {
        public Ordering_SalesOrderFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
