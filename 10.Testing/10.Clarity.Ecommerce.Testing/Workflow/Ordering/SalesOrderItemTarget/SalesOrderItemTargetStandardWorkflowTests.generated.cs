...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderItemTargets_WorkflowTestsBase
        : AbstractBase<
            ...
            SalesOrderItemTargetWorkflow>
    {
        protected Ordering_SalesOrderItemTargets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderItemTargetTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderItemTarget>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderItemTargets;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderItemTarget>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderItemTargets;
        }
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderItemTargets.Standard")]
    public partial class Ordering_SalesOrderItemTargets_StandardWorkflowTests : Ordering_SalesOrderItemTargets_WorkflowTestsBase
    {
        public Ordering_SalesOrderItemTargets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
