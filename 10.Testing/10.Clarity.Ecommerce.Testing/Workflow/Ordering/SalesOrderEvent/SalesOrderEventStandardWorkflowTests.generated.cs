...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderEvents_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesOrderEvent,
            SalesOrderEvent,
            ISalesOrderEventModel,
            SalesOrderEventModel,
            ISalesOrderEventSearchModel,
            SalesOrderEventSearchModel,
            SalesOrderEventWorkflow>
    {
        protected Ordering_SalesOrderEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderEventTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderEvents;
        }

        /// <inheritdoc/>
        protected override async Task<SalesOrderEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesOrderEventModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawSalesOrderEventTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Ordering.SalesOrderEvents.Standard")]
    public partial class Ordering_SalesOrderEvents_StandardWorkflowTests : Ordering_SalesOrderEvents_WorkflowTestsBase
    {
        public Ordering_SalesOrderEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
