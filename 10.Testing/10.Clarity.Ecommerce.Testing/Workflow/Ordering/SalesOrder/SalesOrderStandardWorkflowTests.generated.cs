...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrders_WorkflowTestsBase
        : AbstractBase<
            ISalesOrder,
            SalesOrder,
            ISalesOrderModel,
            ...
            SalesOrderWorkflow>
    {
        protected Ordering_SalesOrders_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesOrderContactTable = true,
                DoSalesOrderFileTable = true,
                DoSalesOrderItemTable = true,
                DoSalesOrderPaymentTable = true,
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrder>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrders;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrder>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrders;
        }

        /// <inheritdoc/>
        protected override async Task<SalesOrderModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesOrderModel
            {
                ...
                StatusID = mockingSetup.RawSalesOrderStatuses.First().Object.ID,
                StateID = mockingSetup.RawSalesOrderStates.First().Object.ID,
                TypeID = mockingSetup.RawSalesOrderTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrders.Standard")]
    public partial class Ordering_SalesOrders_StandardWorkflowTests : Ordering_SalesOrders_WorkflowTestsBase
    {
        public Ordering_SalesOrders_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
