...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesOrderEventType,
            SalesOrderEventType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            SalesOrderEventTypeWorkflow>
    {
        protected Ordering_SalesOrderEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderEventTypes.Standard")]
    public partial class Ordering_SalesOrderEventTypes_StandardWorkflowTests : Ordering_SalesOrderEventTypes_WorkflowTestsBase
    {
        public Ordering_SalesOrderEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
