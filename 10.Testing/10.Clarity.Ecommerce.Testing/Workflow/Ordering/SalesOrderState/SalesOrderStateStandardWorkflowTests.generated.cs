...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Ordering_SalesOrderStates_WorkflowTestsBase
        : AbstractStateableBase<
            ...
            IStateSearchModel,
            StateSearchModel,
            SalesOrderStateWorkflow>
    {
        protected Ordering_SalesOrderStates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesOrderStateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesOrderState>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesOrderStates;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesOrderState>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesOrderStates;
        }
    ...
    [Trait("Category", "Workflows.Ordering.SalesOrderStates.Standard")]
    public partial class Ordering_SalesOrderStates_StandardWorkflowTests : Ordering_SalesOrderStates_WorkflowTestsBase
    {
        public Ordering_SalesOrderStates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
