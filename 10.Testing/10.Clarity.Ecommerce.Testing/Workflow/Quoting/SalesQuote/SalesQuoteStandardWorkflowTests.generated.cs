...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuotes_WorkflowTestsBase
        : AbstractBase<
            ISalesQuote,
            SalesQuote,
            ISalesQuoteModel,
            ...
            SalesQuoteWorkflow>
    {
        protected Quoting_SalesQuotes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesQuoteCategoryTable = true,
                DoSalesQuoteContactTable = true,
                DoSalesQuoteFileTable = true,
                DoSalesQuoteItemTable = true,
                DoSalesQuoteSalesOrderTable = true,
                DoSalesQuoteStateTable = true,
                DoSalesQuoteStatusTable = true,
                DoSalesQuoteTypeTable = true,
                DoStoreTable = true,
                DoUserTable = true,
                DoVendorTable = true,
            };
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuote>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuotes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuote>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuotes;
        }

        /// <inheritdoc/>
        protected override async Task<SalesQuoteModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesQuoteModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                StatusID = mockingSetup.RawSalesQuoteStatuses.First().Object.ID,
                StateID = mockingSetup.RawSalesQuoteStates.First().Object.ID,
                TypeID = mockingSetup.RawSalesQuoteTypes.First().Object.ID,
                // Optional Related Properties
                ResponseAsVendorID = null,
                ResponseAsStoreID = null,
                AccountID = null,
                BrandID = null,
                FranchiseID = null,
                StoreID = null,
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuotes.Standard")]
    public partial class Quoting_SalesQuotes_StandardWorkflowTests : Quoting_SalesQuotes_WorkflowTestsBase
    {
        public Quoting_SalesQuotes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
