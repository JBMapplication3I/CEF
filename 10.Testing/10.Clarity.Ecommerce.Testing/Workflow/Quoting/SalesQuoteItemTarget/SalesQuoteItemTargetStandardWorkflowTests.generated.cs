...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteItemTargets_WorkflowTestsBase
        : AbstractBase<
            ...
            SalesQuoteItemTargetWorkflow>
    {
        protected Quoting_SalesQuoteItemTargets_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteItemTargetTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteItemTarget>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteItemTargets;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteItemTarget>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteItemTargets;
        }
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteItemTargets.Standard")]
    public partial class Quoting_SalesQuoteItemTargets_StandardWorkflowTests : Quoting_SalesQuoteItemTargets_WorkflowTestsBase
    {
        public Quoting_SalesQuoteItemTargets_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
