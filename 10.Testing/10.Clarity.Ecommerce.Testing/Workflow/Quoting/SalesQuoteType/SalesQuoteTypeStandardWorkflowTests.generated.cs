...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesQuoteType,
            SalesQuoteType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            SalesQuoteTypeWorkflow>
    {
        protected Quoting_SalesQuoteTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteTypes;
        }
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteTypes.Standard")]
    public partial class Quoting_SalesQuoteTypes_StandardWorkflowTests : Quoting_SalesQuoteTypes_WorkflowTestsBase
    {
        public Quoting_SalesQuoteTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
