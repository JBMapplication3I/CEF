// <autogenerated>
// <copyright file="Quoting.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteSalesOrders_WorkflowTestsBase
        : AbstractBase<
            ISalesQuoteSalesOrder,
            SalesQuoteSalesOrder,
            ISalesQuoteSalesOrderModel,
            SalesQuoteSalesOrderModel,
            ISalesQuoteSalesOrderSearchModel,
            SalesQuoteSalesOrderSearchModel,
            SalesQuoteSalesOrderWorkflow>
    {
        protected Quoting_SalesQuoteSalesOrders_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteSalesOrderTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesQuoteTable = true,
                DoSalesQuoteSalesOrderTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteSalesOrder>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteSalesOrders;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteSalesOrder>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteSalesOrders;
        }

        /// <inheritdoc/>
        protected override async Task<SalesQuoteSalesOrderModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesQuoteSalesOrderModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawSalesQuotes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteSalesOrders.Standard")]
    public partial class Quoting_SalesQuoteSalesOrders_StandardWorkflowTests : Quoting_SalesQuoteSalesOrders_WorkflowTestsBase
    {
        public Quoting_SalesQuoteSalesOrders_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
