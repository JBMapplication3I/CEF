...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteCategories_WorkflowTestsBase
        : AbstractBase<
            ISalesQuoteCategory,
            SalesQuoteCategory,
            ISalesQuoteCategoryModel,
            SalesQuoteCategoryModel,
            ISalesQuoteCategorySearchModel,
            SalesQuoteCategorySearchModel,
            SalesQuoteCategoryWorkflow>
    {
        protected Quoting_SalesQuoteCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteCategories;
        }

        /// <inheritdoc/>
        protected override async Task<SalesQuoteCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesQuoteCategoryModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteCategories.Standard")]
    public partial class Quoting_SalesQuoteCategories_StandardWorkflowTests : Quoting_SalesQuoteCategories_WorkflowTestsBase
    {
        public Quoting_SalesQuoteCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
