...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteEventTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ISalesQuoteEventType,
            SalesQuoteEventType,
            ITypeModel,
            TypeModel,
            ITypeSearchModel,
            TypeSearchModel,
            SalesQuoteEventTypeWorkflow>
    {
        protected Quoting_SalesQuoteEventTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteEventTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteEventType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteEventTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteEventType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteEventTypes;
        }
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteEventTypes.Standard")]
    public partial class Quoting_SalesQuoteEventTypes_StandardWorkflowTests : Quoting_SalesQuoteEventTypes_WorkflowTestsBase
    {
        public Quoting_SalesQuoteEventTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
