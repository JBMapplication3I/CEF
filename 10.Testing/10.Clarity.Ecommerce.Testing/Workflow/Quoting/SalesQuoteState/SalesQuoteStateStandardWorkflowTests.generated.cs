...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteStates_WorkflowTestsBase
        : AbstractStateableBase<
            ...
            IStateSearchModel,
            StateSearchModel,
            SalesQuoteStateWorkflow>
    {
        protected Quoting_SalesQuoteStates_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteStateTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteState>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteStates;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteState>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteStates;
        }
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteStates.Standard")]
    public partial class Quoting_SalesQuoteStates_StandardWorkflowTests : Quoting_SalesQuoteStates_WorkflowTestsBase
    {
        public Quoting_SalesQuoteStates_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
