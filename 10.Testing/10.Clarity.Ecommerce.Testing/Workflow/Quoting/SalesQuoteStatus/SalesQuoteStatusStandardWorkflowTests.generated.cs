...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            SalesQuoteStatusWorkflow>
    {
        protected Quoting_SalesQuoteStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteStatuses;
        }
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteStatuses.Standard")]
    public partial class Quoting_SalesQuoteStatuses_StandardWorkflowTests : Quoting_SalesQuoteStatuses_WorkflowTestsBase
    {
        public Quoting_SalesQuoteStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
