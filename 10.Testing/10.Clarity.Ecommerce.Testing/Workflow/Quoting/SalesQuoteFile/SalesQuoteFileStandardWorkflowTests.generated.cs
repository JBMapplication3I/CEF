...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteFiles_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            SalesQuoteFileSearchModel,
            SalesQuoteFileWorkflow>
    {
        protected Quoting_SalesQuoteFiles_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteFileTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteFile>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteFiles;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteFile>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteFiles;
        }

        /// <inheritdoc/>
        protected override async Task<SalesQuoteFileModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesQuoteFileModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteFiles.Standard")]
    public partial class Quoting_SalesQuoteFiles_StandardWorkflowTests : Quoting_SalesQuoteFiles_WorkflowTestsBase
    {
        public Quoting_SalesQuoteFiles_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
