...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteContacts_WorkflowTestsBase
        : AbstractBase<
            ISalesQuoteContact,
            SalesQuoteContact,
            ISalesQuoteContactModel,
            SalesQuoteContactModel,
            ISalesQuoteContactSearchModel,
            SalesQuoteContactSearchModel,
            SalesQuoteContactWorkflow>
    {
        protected Quoting_SalesQuoteContacts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteContactTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteContact>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteContacts;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteContact>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteContacts;
        }

        /// <inheritdoc/>
        protected override async Task<SalesQuoteContactModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesQuoteContactModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteContacts.Standard")]
    public partial class Quoting_SalesQuoteContacts_StandardWorkflowTests : Quoting_SalesQuoteContacts_WorkflowTestsBase
    {
        public Quoting_SalesQuoteContacts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
