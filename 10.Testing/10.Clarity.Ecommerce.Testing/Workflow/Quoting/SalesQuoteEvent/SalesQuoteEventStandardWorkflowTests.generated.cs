...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteEvents_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesQuoteEvent,
            SalesQuoteEvent,
            ISalesQuoteEventModel,
            SalesQuoteEventModel,
            ISalesQuoteEventSearchModel,
            SalesQuoteEventSearchModel,
            SalesQuoteEventWorkflow>
    {
        protected Quoting_SalesQuoteEvents_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteEventTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesQuoteEventTable = true,
                DoSalesQuoteEventTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteEvent>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteEvents;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteEvent>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteEvents;
        }

        /// <inheritdoc/>
        protected override async Task<SalesQuoteEventModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesQuoteEventModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawSalesQuoteEventTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Quoting.SalesQuoteEvents.Standard")]
    public partial class Quoting_SalesQuoteEvents_StandardWorkflowTests : Quoting_SalesQuoteEvents_WorkflowTestsBase
    {
        public Quoting_SalesQuoteEvents_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
