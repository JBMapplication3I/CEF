...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Quoting_SalesQuoteItems_WorkflowTestsBase
        : AbstractNameableBase<
            ISalesQuoteItem,
            SalesQuoteItem,
            ISalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel>,
            SalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel, AppliedSalesQuoteItemDiscountModel>,
            ISalesItemBaseSearchModel,
            SalesItemBaseSearchModel,
            SalesQuoteItemWorkflow>
    {
        protected Quoting_SalesQuoteItems_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoSalesQuoteItemTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoSalesQuoteItemTargetTable = true,
                DoUserTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<SalesQuoteItem>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.SalesQuoteItems;
        }

        /// <inheritdoc/>
        protected override List<Mock<SalesQuoteItem>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawSalesQuoteItems;
        }

        /// <inheritdoc/>
        protected override async Task<SalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel, AppliedSalesQuoteItemDiscountModel>> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new SalesItemBaseModel<IAppliedSalesQuoteItemDiscountModel, AppliedSalesQuoteItemDiscountModel>
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Quoting.SalesQuoteItems.Standard")]
    public partial class Quoting_SalesQuoteItems_StandardWorkflowTests : Quoting_SalesQuoteItems_WorkflowTestsBase
    {
        public Quoting_SalesQuoteItems_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
