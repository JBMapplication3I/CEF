...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_Bids_WorkflowTestsBase
        : AbstractBase<
            IBid,
            Bid,
            IBidModel,
            ...
            BidWorkflow>
    {
        protected Auctions_Bids_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBidTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Bid>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Bids;
        }

        /// <inheritdoc/>
        protected override List<Mock<Bid>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBids;
        }

        /// <inheritdoc/>
        protected override async Task<BidModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BidModel
            {
                Active = true,
                ...
                StatusID = mockingSetup.RawBidStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Auctions.Bids.Standard")]
    public partial class Auctions_Bids_StandardWorkflowTests : Auctions_Bids_WorkflowTestsBase
    {
        public Auctions_Bids_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
