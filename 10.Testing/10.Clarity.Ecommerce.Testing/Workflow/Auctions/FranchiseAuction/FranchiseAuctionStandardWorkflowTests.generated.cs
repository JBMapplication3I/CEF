...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_FranchiseAuctions_WorkflowTestsBase
        : AbstractBase<
            IFranchiseAuction,
            FranchiseAuction,
            IFranchiseAuctionModel,
            FranchiseAuctionModel,
            IFranchiseAuctionSearchModel,
            FranchiseAuctionSearchModel,
            FranchiseAuctionWorkflow>
    {
        protected Auctions_FranchiseAuctions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoFranchiseAuctionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<FranchiseAuction>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.FranchiseAuctions;
        }

        /// <inheritdoc/>
        protected override List<Mock<FranchiseAuction>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawFranchiseAuctions;
        }

        /// <inheritdoc/>
        protected override async Task<FranchiseAuctionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new FranchiseAuctionModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawAuctions.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Auctions.FranchiseAuctions.Standard")]
    public partial class Auctions_FranchiseAuctions_StandardWorkflowTests : Auctions_FranchiseAuctions_WorkflowTestsBase
    {
        public Auctions_FranchiseAuctions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
