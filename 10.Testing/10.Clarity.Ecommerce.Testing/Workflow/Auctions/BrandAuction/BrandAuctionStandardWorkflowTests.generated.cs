...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_BrandAuctions_WorkflowTestsBase
        : AbstractBase<
            IBrandAuction,
            BrandAuction,
            IBrandAuctionModel,
            BrandAuctionModel,
            IBrandAuctionSearchModel,
            BrandAuctionSearchModel,
            BrandAuctionWorkflow>
    {
        protected Auctions_BrandAuctions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBrandAuctionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<BrandAuction>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BrandAuctions;
        }

        /// <inheritdoc/>
        protected override List<Mock<BrandAuction>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBrandAuctions;
        }

        /// <inheritdoc/>
        protected override async Task<BrandAuctionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new BrandAuctionModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Auctions.BrandAuctions.Standard")]
    public partial class Auctions_BrandAuctions_StandardWorkflowTests : Auctions_BrandAuctions_WorkflowTestsBase
    {
        public Auctions_BrandAuctions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
