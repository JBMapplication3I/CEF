...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_AuctionTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAuctionType,
            AuctionType,
            ITypeModel,
            ...
            AuctionTypeWorkflow>
    {
        protected Auctions_AuctionTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAuctionTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AuctionType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AuctionTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AuctionType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAuctionTypes;
        }
    ...
    [Trait("Category", "Workflows.Auctions.AuctionTypes.Standard")]
    public partial class Auctions_AuctionTypes_StandardWorkflowTests : Auctions_AuctionTypes_WorkflowTestsBase
    {
        public Auctions_AuctionTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
