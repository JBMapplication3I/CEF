...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_LotCategories_WorkflowTestsBase
        : AbstractBase<
            ILotCategory,
            LotCategory,
            ILotCategoryModel,
            LotCategoryModel,
            ILotCategorySearchModel,
            LotCategorySearchModel,
            LotCategoryWorkflow>
    {
        protected Auctions_LotCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoLotCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<LotCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.LotCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<LotCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawLotCategories;
        }

        /// <inheritdoc/>
        protected override async Task<LotCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new LotCategoryModel
            {
                ...
                MasterID = mockingSetup.RawLots.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Auctions.LotCategories.Standard")]
    public partial class Auctions_LotCategories_StandardWorkflowTests : Auctions_LotCategories_WorkflowTestsBase
    {
        public Auctions_LotCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
