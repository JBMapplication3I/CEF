...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_BidStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            BidStatusWorkflow>
    {
        protected Auctions_BidStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoBidStatusTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoBidStatusTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<BidStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.BidStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<BidStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawBidStatuses;
        }
    ...
    [Trait("Category", "Workflows.Auctions.BidStatuses.Standard")]
    public partial class Auctions_BidStatuses_StandardWorkflowTests : Auctions_BidStatuses_WorkflowTestsBase
    {
        public Auctions_BidStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
