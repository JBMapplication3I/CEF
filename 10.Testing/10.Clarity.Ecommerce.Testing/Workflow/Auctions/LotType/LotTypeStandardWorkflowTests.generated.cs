...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_LotTypes_WorkflowTestsBase
        : AbstractTypableBase<
            ILotType,
            LotType,
            ITypeModel,
            ...
            LotTypeWorkflow>
    {
        protected Auctions_LotTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoLotTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<LotType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.LotTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<LotType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawLotTypes;
        }
    ...
    [Trait("Category", "Workflows.Auctions.LotTypes.Standard")]
    public partial class Auctions_LotTypes_StandardWorkflowTests : Auctions_LotTypes_WorkflowTestsBase
    {
        public Auctions_LotTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
