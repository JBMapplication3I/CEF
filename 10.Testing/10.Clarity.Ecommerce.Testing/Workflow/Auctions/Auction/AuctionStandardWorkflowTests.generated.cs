...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_Auctions_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            AuctionWorkflow>
    {
        protected Auctions_Auctions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAuctionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Auction>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Auctions;
        }

        /// <inheritdoc/>
        protected override List<Mock<Auction>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAuctions;
        }

        /// <inheritdoc/>
        protected override async Task<AuctionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AuctionModel
            {
                ...
                TypeID = mockingSetup.RawAuctionTypes.First().Object.ID,
                StatusID = mockingSetup.RawAuctionStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Auctions.Auctions.Standard")]
    public partial class Auctions_Auctions_StandardWorkflowTests : Auctions_Auctions_WorkflowTestsBase
    {
        public Auctions_Auctions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
