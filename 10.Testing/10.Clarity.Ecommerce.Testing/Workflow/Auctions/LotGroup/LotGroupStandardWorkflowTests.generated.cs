...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_LotGroups_WorkflowTestsBase
        : AbstractTypableBase<
            ILotGroup,
            LotGroup,
            ILotGroupModel,
            LotGroupModel,
            ILotGroupSearchModel,
            LotGroupSearchModel,
            LotGroupWorkflow>
    {
        protected Auctions_LotGroups_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoLotGroupTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<LotGroup>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.LotGroups;
        }

        /// <inheritdoc/>
        protected override List<Mock<LotGroup>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawLotGroups;
        }

        /// <inheritdoc/>
        protected override async Task<LotGroupModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new LotGroupModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Auctions.LotGroups.Standard")]
    public partial class Auctions_LotGroups_StandardWorkflowTests : Auctions_LotGroups_WorkflowTestsBase
    {
        public Auctions_LotGroups_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
