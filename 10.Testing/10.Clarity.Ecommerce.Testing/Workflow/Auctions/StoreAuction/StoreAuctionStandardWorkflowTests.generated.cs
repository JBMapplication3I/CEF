...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_StoreAuctions_WorkflowTestsBase
        : AbstractBase<
            IStoreAuction,
            StoreAuction,
            IStoreAuctionModel,
            StoreAuctionModel,
            IStoreAuctionSearchModel,
            StoreAuctionSearchModel,
            StoreAuctionWorkflow>
    {
        protected Auctions_StoreAuctions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoStoreAuctionTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<StoreAuction>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.StoreAuctions;
        }

        /// <inheritdoc/>
        protected override List<Mock<StoreAuction>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawStoreAuctions;
        }

        /// <inheritdoc/>
        protected override async Task<StoreAuctionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new StoreAuctionModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Auctions.StoreAuctions.Standard")]
    public partial class Auctions_StoreAuctions_StandardWorkflowTests : Auctions_StoreAuctions_WorkflowTestsBase
    {
        public Auctions_StoreAuctions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
