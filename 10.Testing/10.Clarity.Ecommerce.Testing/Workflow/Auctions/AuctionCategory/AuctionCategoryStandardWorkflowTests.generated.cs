...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_AuctionCategories_WorkflowTestsBase
        : AbstractBase<
            IAuctionCategory,
            AuctionCategory,
            ...
            AuctionCategoryWorkflow>
    {
        protected Auctions_AuctionCategories_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAuctionCategoryTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AuctionCategory>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AuctionCategories;
        }

        /// <inheritdoc/>
        protected override List<Mock<AuctionCategory>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAuctionCategories;
        }

        /// <inheritdoc/>
        protected override async Task<AuctionCategoryModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AuctionCategoryModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawAuctions.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Auctions.AuctionCategories.Standard")]
    public partial class Auctions_AuctionCategories_StandardWorkflowTests : Auctions_AuctionCategories_WorkflowTestsBase
    {
        public Auctions_AuctionCategories_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
