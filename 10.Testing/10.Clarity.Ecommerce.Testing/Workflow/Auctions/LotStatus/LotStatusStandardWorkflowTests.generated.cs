...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_LotStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            LotStatusWorkflow>
    {
        protected Auctions_LotStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoLotStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<LotStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.LotStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<LotStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawLotStatuses;
        }
    ...
    [Trait("Category", "Workflows.Auctions.LotStatuses.Standard")]
    public partial class Auctions_LotStatuses_StandardWorkflowTests : Auctions_LotStatuses_WorkflowTestsBase
    {
        public Auctions_LotStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
