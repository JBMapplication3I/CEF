...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Auctions_AuctionStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            IStatusSearchModel,
            StatusSearchModel,
            AuctionStatusWorkflow>
    {
        protected Auctions_AuctionStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAuctionStatusTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAuctionStatusTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AuctionStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AuctionStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<AuctionStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAuctionStatuses;
        }
    ...
    [Trait("Category", "Workflows.Auctions.AuctionStatuses.Standard")]
    public partial class Auctions_AuctionStatuses_StandardWorkflowTests : Auctions_AuctionStatuses_WorkflowTestsBase
    {
        public Auctions_AuctionStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
