...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdImages_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            AdImageWorkflow>
    {
        protected Advertising_AdImages_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdImageTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAdImageTable = true,
                DoAdImageTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AdImage>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdImages;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdImage>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdImages;
        }

        /// <inheritdoc/>
        protected override async Task<AdImageModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdImageModel
            {
                ...
                TypeID = mockingSetup.RawAdImageTypes.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Advertising.AdImages.Standard")]
    public partial class Advertising_AdImages_StandardWorkflowTests : Advertising_AdImages_WorkflowTestsBase
    {
        public Advertising_AdImages_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
