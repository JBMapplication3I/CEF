...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_ZoneTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IZoneType,
            ZoneType,
            ITypeModel,
            ...
            ZoneTypeWorkflow>
    {
        protected Advertising_ZoneTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoZoneTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ZoneType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ZoneTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<ZoneType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawZoneTypes;
        }
    ...
    [Trait("Category", "Workflows.Advertising.ZoneTypes.Standard")]
    public partial class Advertising_ZoneTypes_StandardWorkflowTests : Advertising_ZoneTypes_WorkflowTestsBase
    {
        public Advertising_ZoneTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
