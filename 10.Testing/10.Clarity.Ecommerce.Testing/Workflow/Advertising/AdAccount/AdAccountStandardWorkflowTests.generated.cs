...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdAccounts_WorkflowTestsBase
        : AbstractBase<
            IAdAccount,
            AdAccount,
            IAdAccountModel,
            AdAccountModel,
            IAdAccountSearchModel,
            AdAccountSearchModel,
            AdAccountWorkflow>
    {
        protected Advertising_AdAccounts_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdAccountTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoAdTable = true,
                DoAdAccountTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AdAccount>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdAccounts;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdAccount>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdAccounts;
        }

        /// <inheritdoc/>
        protected override async Task<AdAccountModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdAccountModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Advertising.AdAccounts.Standard")]
    public partial class Advertising_AdAccounts_StandardWorkflowTests : Advertising_AdAccounts_WorkflowTestsBase
    {
        public Advertising_AdAccounts_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
