...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdBrands_WorkflowTestsBase
        : AbstractBase<
            IAdBrand,
            AdBrand,
            IAdBrandModel,
            ...
            AdBrandWorkflow>
    {
        protected Advertising_AdBrands_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdBrandTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AdBrand>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdBrands;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdBrand>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdBrands;
        }

        /// <inheritdoc/>
        protected override async Task<AdBrandModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdBrandModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Advertising.AdBrands.Standard")]
    public partial class Advertising_AdBrands_StandardWorkflowTests : Advertising_AdBrands_WorkflowTestsBase
    {
        public Advertising_AdBrands_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
