...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdZones_WorkflowTestsBase
        : AbstractBase<
            IAdZone,
            AdZone,
            IAdZoneModel,
            ...
            AdZoneWorkflow>
    {
        protected Advertising_AdZones_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdZoneTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AdZone>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdZones;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdZone>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdZones;
        }

        /// <inheritdoc/>
        protected override async Task<AdZoneModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdZoneModel
            {
                Active = true,
                ...
                SlaveID = mockingSetup.RawZones.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Advertising.AdZones.Standard")]
    public partial class Advertising_AdZones_StandardWorkflowTests : Advertising_AdZones_WorkflowTestsBase
    {
        public Advertising_AdZones_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
