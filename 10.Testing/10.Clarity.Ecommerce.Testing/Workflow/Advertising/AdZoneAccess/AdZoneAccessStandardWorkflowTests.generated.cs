...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdZoneAccesses_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            AdZoneAccessSearchModel,
            AdZoneAccessWorkflow>
    {
        protected Advertising_AdZoneAccesses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdZoneAccessTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AdZoneAccess>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdZoneAccesses;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdZoneAccess>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdZoneAccesses;
        }

        /// <inheritdoc/>
        protected override async Task<AdZoneAccessModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdZoneAccessModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Advertising.AdZoneAccesses.Standard")]
    public partial class Advertising_AdZoneAccesses_StandardWorkflowTests : Advertising_AdZoneAccesses_WorkflowTestsBase
    {
        public Advertising_AdZoneAccesses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
