...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdImageTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAdImageType,
            AdImageType,
            ITypeModel,
            ...
            AdImageTypeWorkflow>
    {
        protected Advertising_AdImageTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdImageTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AdImageType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdImageTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdImageType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdImageTypes;
        }
    ...
    [Trait("Category", "Workflows.Advertising.AdImageTypes.Standard")]
    public partial class Advertising_AdImageTypes_StandardWorkflowTests : Advertising_AdImageTypes_WorkflowTestsBase
    {
        public Advertising_AdImageTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
