...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            AdStatusWorkflow>
    {
        protected Advertising_AdStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AdStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdStatuses;
        }
    ...
    [Trait("Category", "Workflows.Advertising.AdStatuses.Standard")]
    public partial class Advertising_AdStatuses_StandardWorkflowTests : Advertising_AdStatuses_WorkflowTestsBase
    {
        public Advertising_AdStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
