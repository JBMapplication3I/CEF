...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IAdType,
            AdType,
            ITypeModel,
            ...
            AdTypeWorkflow>
    {
        protected Advertising_AdTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AdType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdTypes;
        }
    ...
    [Trait("Category", "Workflows.Advertising.AdTypes.Standard")]
    public partial class Advertising_AdTypes_StandardWorkflowTests : Advertising_AdTypes_WorkflowTestsBase
    {
        public Advertising_AdTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
