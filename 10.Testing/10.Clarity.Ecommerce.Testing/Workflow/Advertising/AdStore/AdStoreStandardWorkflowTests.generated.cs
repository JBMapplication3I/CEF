...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdStores_WorkflowTestsBase
        : AbstractBase<
            IAdStore,
            AdStore,
            IAdStoreModel,
            ...
            AdStoreWorkflow>
    {
        protected Advertising_AdStores_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdStoreTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<AdStore>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdStores;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdStore>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdStores;
        }

        /// <inheritdoc/>
        protected override async Task<AdStoreModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdStoreModel
            {
                Active = true,
    ...
    [Trait("Category", "Workflows.Advertising.AdStores.Standard")]
    public partial class Advertising_AdStores_StandardWorkflowTests : Advertising_AdStores_WorkflowTestsBase
    {
        public Advertising_AdStores_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
