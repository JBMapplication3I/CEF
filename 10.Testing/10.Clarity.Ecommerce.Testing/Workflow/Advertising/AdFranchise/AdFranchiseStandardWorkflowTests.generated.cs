// <autogenerated>
// <copyright file="Advertising.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_AdFranchises_WorkflowTestsBase
        : AbstractBase<
            IAdFranchise,
            AdFranchise,
            IAdFranchiseModel,
            AdFranchiseModel,
            IAdFranchiseSearchModel,
            AdFranchiseSearchModel,
            AdFranchiseWorkflow>
    {
        protected Advertising_AdFranchises_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdFranchiseTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoAdTable = true,
                DoAdFranchiseTable = true,
                DoFranchiseTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<AdFranchise>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.AdFranchises;
        }

        /// <inheritdoc/>
        protected override List<Mock<AdFranchise>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAdFranchises;
        }

        /// <inheritdoc/>
        protected override async Task<AdFranchiseModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdFranchiseModel
            {
                Active = true,
                CustomKey = await GetCustomKeyAsync(mockingSetup, contextProfileName).ConfigureAwait(false),
                // Required Related Properties
                MasterID = mockingSetup.RawAds.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Advertising.AdFranchises.Standard")]
    public partial class Advertising_AdFranchises_StandardWorkflowTests : Advertising_AdFranchises_WorkflowTestsBase
    {
        public Advertising_AdFranchises_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
