...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_Zones_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            ZoneWorkflow>
    {
        protected Advertising_Zones_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoZoneTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                DoAdZoneTable = true,
                DoZoneTable = true,
                DoZoneStatusTable = true,
                DoZoneTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Zone>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Zones;
        }

        /// <inheritdoc/>
        protected override List<Mock<Zone>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawZones;
        }

        /// <inheritdoc/>
        protected override async Task<ZoneModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new ZoneModel
            {
                ...
                TypeID = mockingSetup.RawZoneTypes.First().Object.ID,
                StatusID = mockingSetup.RawZoneStatuses.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Advertising.Zones.Standard")]
    public partial class Advertising_Zones_StandardWorkflowTests : Advertising_Zones_WorkflowTestsBase
    {
        public Advertising_Zones_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
