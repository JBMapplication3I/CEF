...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_Ads_WorkflowTestsBase
        : AbstractNameableBase<
            ...
            AdWorkflow>
    {
        protected Advertising_Ads_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAdTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Ad>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Ads;
        }

        /// <inheritdoc/>
        protected override List<Mock<Ad>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAds;
        }

        /// <inheritdoc/>
        protected override async Task<AdModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AdModel
            {
                Active = true,
                ...
                TypeID = mockingSetup.RawAdTypes.First().Object.ID,
                StatusID = mockingSetup.RawAdStatuses.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Advertising.Ads.Standard")]
    public partial class Advertising_Ads_StandardWorkflowTests : Advertising_Ads_WorkflowTestsBase
    {
        public Advertising_Ads_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
