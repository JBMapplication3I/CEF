...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Advertising_ZoneStatuses_WorkflowTestsBase
        : AbstractStatusableBase<
            ...
            ZoneStatusWorkflow>
    {
        protected Advertising_ZoneStatuses_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoZoneStatusTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<ZoneStatus>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.ZoneStatuses;
        }

        /// <inheritdoc/>
        protected override List<Mock<ZoneStatus>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawZoneStatuses;
        }
    ...
    [Trait("Category", "Workflows.Advertising.ZoneStatuses.Standard")]
    public partial class Advertising_ZoneStatuses_StandardWorkflowTests : Advertising_ZoneStatuses_WorkflowTestsBase
    {
        public Advertising_ZoneStatuses_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
