...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Questionnaire_QuestionTypes_WorkflowTestsBase
        : AbstractTypableBase<
            IQuestionType,
            QuestionType,
            ITypeModel,
            ...
            ITypeSearchModel,
            TypeSearchModel,
            QuestionTypeWorkflow>
    {
        protected Questionnaire_QuestionTypes_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoQuestionTypeTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<QuestionType>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.QuestionTypes;
        }

        /// <inheritdoc/>
        protected override List<Mock<QuestionType>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawQuestionTypes;
        }
    ...
    [Trait("Category", "Workflows.Questionnaire.QuestionTypes.Standard")]
    public partial class Questionnaire_QuestionTypes_StandardWorkflowTests : Questionnaire_QuestionTypes_WorkflowTestsBase
    {
        public Questionnaire_QuestionTypes_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
