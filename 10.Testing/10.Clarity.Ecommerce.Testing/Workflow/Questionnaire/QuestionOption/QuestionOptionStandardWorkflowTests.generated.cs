// <autogenerated>
// <copyright file="Questionnaire.StandardWorkflowTests.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Questionnaire_QuestionOptions_WorkflowTestsBase
        : AbstractBase<
            IQuestionOption,
            QuestionOption,
            IQuestionOptionModel,
            QuestionOptionModel,
            IQuestionOptionSearchModel,
            QuestionOptionSearchModel,
            QuestionOptionWorkflow>
    {
        protected Questionnaire_QuestionOptions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoQuestionOptionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            ...
            {
                DoQuestionTable = true,
                DoQuestionOptionTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<QuestionOption>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.QuestionOptions;
        }

        /// <inheritdoc/>
        protected override List<Mock<QuestionOption>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawQuestionOptions;
        }

        /// <inheritdoc/>
        protected override async Task<QuestionOptionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new QuestionOptionModel
            {
                ...
                QuestionID = mockingSetup.RawQuestions.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Questionnaire.QuestionOptions.Standard")]
    public partial class Questionnaire_QuestionOptions_StandardWorkflowTests : Questionnaire_QuestionOptions_WorkflowTestsBase
    {
        public Questionnaire_QuestionOptions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
