...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Questionnaire_Questions_WorkflowTestsBase
        : AbstractBase<
            IQuestion,
            Question,
            IQuestionModel,
            QuestionModel,
            IQuestionSearchModel,
            QuestionSearchModel,
            QuestionWorkflow>
    {
        protected Questionnaire_Questions_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoQuestionTable = true };
        }
        ...
        protected override MockingSetup GetMockingSetupWithExistingDataForThisTableAndExpandedTables()
        {
            return new MockingSetup
            {
                ...
                DoQuestionTypeTable = true,
            };
        }

        /// <inheritdoc/>
        protected override Mock<DbSet<Question>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Questions;
        }

        /// <inheritdoc/>
        protected override List<Mock<Question>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawQuestions;
        }

        /// <inheritdoc/>
        protected override async Task<QuestionModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new QuestionModel
            {
                ...
                TypeID = mockingSetup.RawQuestionTypes.First().Object.ID,
    ...
    [Trait("Category", "Workflows.Questionnaire.Questions.Standard")]
    public partial class Questionnaire_Questions_StandardWorkflowTests : Questionnaire_Questions_WorkflowTestsBase
    {
        public Questionnaire_Questions_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
