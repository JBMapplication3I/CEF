...
namespace Clarity.Ecommerce.Workflow.Testing
{
    ...
    public abstract class Questionnaire_Answers_WorkflowTestsBase
        : AbstractBase<
            IAnswer,
            Answer,
            IAnswerModel,
            ...
            AnswerWorkflow>
    {
        protected Questionnaire_Answers_WorkflowTestsBase(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }

        protected override MockingSetup GetMockingSetupWithExistingDataForThisTable()
        {
            return new MockingSetup { DoAnswerTable = true };
        }
        ...
        /// <inheritdoc/>
        protected override Mock<DbSet<Answer>>? GetMockSet(MockingSetup mockingSetup)
        {
            return mockingSetup.Answers;
        }

        /// <inheritdoc/>
        protected override List<Mock<Answer>>? GetRawSet(MockingSetup mockingSetup)
        {
            return mockingSetup.RawAnswers;
        }

        /// <inheritdoc/>
        protected override async Task<AnswerModel> GenNewModelAsync(MockingSetup mockingSetup, string contextProfileName)
        {
            return new AnswerModel
            {
                ...
                OptionID = mockingSetup.RawQuestionOptions.First().Object.ID,
                // Optional Related Properties
            };
        }
    }

    [Trait("Category", "Workflows.Questionnaire.Answers.Standard")]
    public partial class Questionnaire_Answers_StandardWorkflowTests : Questionnaire_Answers_WorkflowTestsBase
    {
        public Questionnaire_Answers_StandardWorkflowTests(Xunit.Abstractions.ITestOutputHelper testOutputHelper) : base(testOutputHelper) { }
