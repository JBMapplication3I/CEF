// <autogenerated>
// <copyright file="GeneralAttributeModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for General Attribute.</summary>
    public partial class GeneralAttributeModel
        : TypableBaseModel
            , IGeneralAttributeModel
    {
        #region IHaveATypeBaseModel<IAttributeTypeModel>
        /// <inheritdoc/>
        [DefaultValue(0),
        ...
        /// <inheritdoc cref="IHaveATypeBaseModel{IAttributeTypeModel}.Type"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Type), IsRequired = true, DataType = "AttributeTypeModel", ParameterType = "body",
                Description = "Model for Type of this Account, required if no TypeID present")]
        public AttributeTypeModel? Type { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        IAttributeTypeModel? IHaveATypeBaseModel<IAttributeTypeModel>.Type { get => Type; set => Type = (AttributeTypeModel?)value; }
