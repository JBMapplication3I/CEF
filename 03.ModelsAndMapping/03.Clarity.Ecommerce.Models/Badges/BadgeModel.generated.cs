// <autogenerated>
// <copyright file="BadgeModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Badge.</summary>
            ...
            , IBadgeModel
    {
        ...
        /// <inheritdoc cref="IHaveImagesBaseModel{IBadgeImageModel, ITypeModel}.Images"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Images), DataType = "List<BadgeImageModel>", ParameterType = "body", IsRequired = false,
                Description = "Images for the object, optional")]
        public List<BadgeImageModel>? Images { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<IBadgeImageModel>? IHaveImagesBaseModel<IBadgeImageModel, ITypeModel>.Images { get => Images?.ToList<IBadgeImageModel>(); set => Images = value?.Cast<BadgeImageModel>().ToList(); }
