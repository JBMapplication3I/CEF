// <autogenerated>
// <copyright file="QuestionSearchModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data model for the Question search.</summary>
    public partial class QuestionSearchModel
        : BaseSearchModel
        , IQuestionSearchModel
    {
        ...
        #endregion
        /// <inheritdoc/>
        [ApiMember(Name = nameof(NextQuestionID), DataType = "int?", ParameterType = "query", IsRequired = false)]
        public int? NextQuestionID { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(NextQuestionIDIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? NextQuestionIDIncludeNull { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(QuestionTranslationKey), DataType = "string", ParameterType = "query", IsRequired = false)]
        public string? QuestionTranslationKey { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(QuestionTranslationKeyStrict), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? QuestionTranslationKeyStrict { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(QuestionTranslationKeyIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
