// <autogenerated>
// <copyright file="AuctionModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Auction.</summary>
            ...
            , IAuctionModel
    {
        ...
        /// <inheritdoc cref="IAmFilterableByBrandModel{IBrandAuctionModel}.Brands"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Brands), DataType = "List<BrandAuctionModel>", ParameterType = "body", IsRequired = false,
                Description = "Brands this object is associated with")]
        public List<BrandAuctionModel>? Brands { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<IBrandAuctionModel>? IAmFilterableByBrandModel<IBrandAuctionModel>.Brands { get => Brands?.ToList<IBrandAuctionModel>(); set => Brands = value?.Cast<BrandAuctionModel>().ToList(); }
        #endregion
        #region IAmFilterableByCategoryModel<> Properties
        /// <inheritdoc cref="IAmFilterableByCategoryModel{IAuctionCategoryModel}.Categories"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Categories), DataType = "List<AuctionCategoryModel>", ParameterType = "body", IsRequired = false,
                Description = "Categories this object is associated with")]
        public List<AuctionCategoryModel>? Categories { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<IAuctionCategoryModel>? IAmFilterableByCategoryModel<IAuctionCategoryModel>.Categories { get => Categories?.ToList<IAuctionCategoryModel>(); set => Categories = value?.Cast<AuctionCategoryModel>().ToList(); }
        #endregion
        #region IAmFilterableByFranchiseModel<> Properties
        /// <inheritdoc cref="IAmFilterableByFranchiseModel{IFranchiseAuctionModel}.Franchises"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Franchises), DataType = "List<FranchiseAuctionModel>", ParameterType = "body", IsRequired = false,
                Description = "Franchises this object is associated with")]
        public List<FranchiseAuctionModel>? Franchises { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<IFranchiseAuctionModel>? IAmFilterableByFranchiseModel<IFranchiseAuctionModel>.Franchises { get => Franchises?.ToList<IFranchiseAuctionModel>(); set => Franchises = value?.Cast<FranchiseAuctionModel>().ToList(); }
        #endregion
        #region IAmFilterableByStoreModel<> Properties
        /// <inheritdoc cref="IAmFilterableByStoreModel{IStoreAuctionModel}.Stores"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Stores), DataType = "List<StoreAuctionModel>", ParameterType = "body", IsRequired = false,
                Description = "Stores this object is associated with")]
        public List<StoreAuctionModel>? Stores { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<IStoreAuctionModel>? IAmFilterableByStoreModel<IStoreAuctionModel>.Stores { get => Stores?.ToList<IStoreAuctionModel>(); set => Stores = value?.Cast<StoreAuctionModel>().ToList(); }
        #endregion
