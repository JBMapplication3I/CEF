// <autogenerated>
// <copyright file="AccountUsageBalanceSearchModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data model for the Account Usage Balance search.</summary>
    public partial class AccountUsageBalanceSearchModel
        ...
        , IAccountUsageBalanceSearchModel
    {
        ...
        #endregion
        /// <inheritdoc/>
        [ApiMember(Name = nameof(MinQuantity), DataType = "int?", ParameterType = "query", IsRequired = false)]
        public int? MinQuantity { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MaxQuantity), DataType = "int?", ParameterType = "query", IsRequired = false)]
        public int? MaxQuantity { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MatchQuantity), DataType = "int?", ParameterType = "query", IsRequired = false)]
