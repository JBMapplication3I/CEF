// <autogenerated>
// <copyright file="SubscriptionModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Subscription.</summary>
    public partial class SubscriptionModel
        : NameableBaseModel
            , ISubscriptionModel
    {
        #region IHaveATypeBaseModel<ISubscriptionTypeModel>
        /// <inheritdoc/>
        [DefaultValue(0),
        ...
        /// <inheritdoc cref="IHaveATypeBaseModel{ISubscriptionTypeModel}.Type"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Type), IsRequired = true, DataType = "SubscriptionTypeModel", ParameterType = "body",
                Description = "Model for Type of this Account, required if no TypeID present")]
        public SubscriptionTypeModel? Type { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        ISubscriptionTypeModel? IHaveATypeBaseModel<ISubscriptionTypeModel>.Type { get => Type; set => Type = (SubscriptionTypeModel?)value; }
