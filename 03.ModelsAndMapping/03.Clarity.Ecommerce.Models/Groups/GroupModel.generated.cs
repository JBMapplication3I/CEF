// <autogenerated>
// <copyright file="GroupModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Group.</summary>
            ...
            , IGroupModel
    {
        ...
        /// <inheritdoc cref="IAmFilterableByUserModel{IGroupUserModel}.Users"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Users), DataType = "List<GroupUserModel>", ParameterType = "body", IsRequired = false,
                Description = "Users this object is associated with")]
        public List<GroupUserModel>? Users { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<IGroupUserModel>? IAmFilterableByUserModel<IGroupUserModel>.Users { get => Users?.ToList<IGroupUserModel>(); set => Users = value?.Cast<GroupUserModel>().ToList(); }
        #endregion
        #region IHaveAParentBaseModel<IGroupModel>
        // Related Objects
        ...
        /// <inheritdoc/>
        [JsonIgnore]
        IGroupModel? IHaveAParentBaseModel<IGroupModel>.Parent { get => Parent; set => Parent = (GroupModel?)value; }
        ...
        /// <inheritdoc/>
        [JsonIgnore]
        List<IGroupModel>? IHaveAParentBaseModel<IGroupModel>.Children { get => Children?.ToList<IGroupModel>(); set => Children = value?.Cast<GroupModel>().ToList(); }
