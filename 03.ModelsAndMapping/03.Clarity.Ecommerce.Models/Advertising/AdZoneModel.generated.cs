// <autogenerated>
// <copyright file="AdZoneModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Ad Zone.</summary>
            ...
            , IAdZoneModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IAdModel,IZoneModel>
        /// <inheritdoc/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
        ...
        /// <inheritdoc cref="IAmARelationshipTableBaseModel{IZoneModel}.Slave"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Slave), DataType = "ZoneModel?", ParameterType = "body", IsRequired = false,
                Description = "The Slave record (may only be partially mapped out).")]
        public ZoneModel? Slave { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        IZoneModel? IAmARelationshipTableBaseModel<IZoneModel>.Slave { get => Slave; set => Slave = (ZoneModel?)value; }
        #endregion
    }
}
