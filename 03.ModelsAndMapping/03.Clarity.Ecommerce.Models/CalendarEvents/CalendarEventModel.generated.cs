// <autogenerated>
// <copyright file="CalendarEventModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Calendar Event.</summary>
            ...
            , ICalendarEventModel
    {
        ...
        /// <inheritdoc cref="IAmFilterableByProductModel{ICalendarEventProductModel}.Products"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Products), DataType = "List<CalendarEventProductModel>", ParameterType = "body", IsRequired = false,
                Description = "Products this object is associated with")]
        public List<CalendarEventProductModel>? Products { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<ICalendarEventProductModel>? IAmFilterableByProductModel<ICalendarEventProductModel>.Products { get => Products?.ToList<ICalendarEventProductModel>(); set => Products = value?.Cast<CalendarEventProductModel>().ToList(); }
        #endregion
        ...
        /// <inheritdoc cref="IHaveImagesBaseModel{ICalendarEventImageModel, ITypeModel}.Images"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Images), DataType = "List<CalendarEventImageModel>", ParameterType = "body", IsRequired = false,
                Description = "Images for the object, optional")]
        public List<CalendarEventImageModel>? Images { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<ICalendarEventImageModel>? IHaveImagesBaseModel<ICalendarEventImageModel, ITypeModel>.Images { get => Images?.ToList<ICalendarEventImageModel>(); set => Images = value?.Cast<CalendarEventImageModel>().ToList(); }
        ...
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(StoredFiles), IsRequired = false, DataType = "List<CalendarEventFileModel>", ParameterType = "body",
                Description = "Stored Files for the object, optional")]
        public List<CalendarEventFileModel>? StoredFiles { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        List<ICalendarEventFileModel>? IHaveStoredFilesBaseModel<ICalendarEventFileModel>.StoredFiles { get => StoredFiles?.ToList<ICalendarEventFileModel>(); set => StoredFiles = value?.Cast<CalendarEventFileModel>().ToList(); }
        #endregion
    }
}
