// <autogenerated>
// <copyright file="NoteModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Note.</summary>
    public partial class NoteModel
        : BaseModel
            , INoteModel
    {
        #region IHaveATypeBaseModel<INoteTypeModel>
        /// <inheritdoc/>
        [DefaultValue(0),
        ...
        /// <inheritdoc cref="IHaveATypeBaseModel{INoteTypeModel}.Type"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Type), IsRequired = true, DataType = "NoteTypeModel", ParameterType = "body",
                Description = "Model for Type of this Account, required if no TypeID present")]
        public NoteTypeModel? Type { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        INoteTypeModel? IHaveATypeBaseModel<INoteTypeModel>.Type { get => Type; set => Type = (NoteTypeModel?)value; }
