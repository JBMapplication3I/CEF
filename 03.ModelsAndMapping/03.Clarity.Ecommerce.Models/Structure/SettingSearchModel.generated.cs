// <autogenerated>
// <copyright file="SettingSearchModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data model for the Setting search.</summary>
    public partial class SettingSearchModel
        : BaseSearchModel
        , ISettingSearchModel
    {
        ...
        #endregion
        /// <inheritdoc/>
        [ApiMember(Name = nameof(SettingGroupID), DataType = "int?", ParameterType = "query", IsRequired = false)]
        public int? SettingGroupID { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(SettingGroupIDIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
