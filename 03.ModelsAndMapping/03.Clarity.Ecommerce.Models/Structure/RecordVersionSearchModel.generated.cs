// <autogenerated>
// <copyright file="RecordVersionSearchModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data model for the Record Version search.</summary>
    public partial class RecordVersionSearchModel
        : NameableBaseSearchModel
        , IRecordVersionSearchModel
    {
        ...
        #endregion
        /// <inheritdoc/>
        [ApiMember(Name = nameof(IsDraft), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? IsDraft { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MinMostRecentPublishDate), DataType = "DateTime?", ParameterType = "query", IsRequired = false)]
        public DateTime? MinMostRecentPublishDate { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MaxMostRecentPublishDate), DataType = "DateTime?", ParameterType = "query", IsRequired = false)]
        public DateTime? MaxMostRecentPublishDate { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MatchMostRecentPublishDate), DataType = "DateTime?", ParameterType = "query", IsRequired = false)]
        public DateTime? MatchMostRecentPublishDate { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MatchMostRecentPublishDateIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? MatchMostRecentPublishDateIncludeNull { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MinOriginalPublishDate), DataType = "DateTime?", ParameterType = "query", IsRequired = false)]
        public DateTime? MinOriginalPublishDate { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MaxOriginalPublishDate), DataType = "DateTime?", ParameterType = "query", IsRequired = false)]
        public DateTime? MaxOriginalPublishDate { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MatchOriginalPublishDate), DataType = "DateTime?", ParameterType = "query", IsRequired = false)]
        public DateTime? MatchOriginalPublishDate { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(MatchOriginalPublishDateIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? MatchOriginalPublishDateIncludeNull { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(PublishedByUserID), DataType = "int?", ParameterType = "query", IsRequired = false)]
        public int? PublishedByUserID { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(PublishedByUserIDIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? PublishedByUserIDIncludeNull { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(RecordID), DataType = "int?", ParameterType = "query", IsRequired = false)]
        public int? RecordID { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(RecordIDIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? RecordIDIncludeNull { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(SerializedRecord), DataType = "string", ParameterType = "query", IsRequired = false)]
        public string? SerializedRecord { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(SerializedRecordStrict), DataType = "bool?", ParameterType = "query", IsRequired = false)]
        public bool? SerializedRecordStrict { get; set; }

        /// <inheritdoc/>
        [ApiMember(Name = nameof(SerializedRecordIncludeNull), DataType = "bool?", ParameterType = "query", IsRequired = false)]
