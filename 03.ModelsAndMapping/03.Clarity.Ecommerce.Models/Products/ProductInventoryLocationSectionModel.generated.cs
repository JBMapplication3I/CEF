// <autogenerated>
// <copyright file="ProductInventoryLocationSectionModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Product Inventory Location Section.</summary>
            ...
            , IProductInventoryLocationSectionModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IProductModel,IInventoryLocationSectionModel>
        /// <inheritdoc/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
        ...
        /// <inheritdoc cref="IAmARelationshipTableBaseModel{IInventoryLocationSectionModel}.Slave"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Slave), DataType = "InventoryLocationSectionModel?", ParameterType = "body", IsRequired = false,
                Description = "The Slave record (may only be partially mapped out).")]
        public InventoryLocationSectionModel? Slave { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        IInventoryLocationSectionModel? IAmARelationshipTableBaseModel<IInventoryLocationSectionModel>.Slave { get => Slave; set => Slave = (InventoryLocationSectionModel?)value; }
        #endregion
    }
}
