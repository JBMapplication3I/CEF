// <autogenerated>
// <copyright file="DiscountStoreModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Discount Store.</summary>
            ...
            , IDiscountStoreModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IDiscountModel,IStoreModel>
        /// <inheritdoc/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
        ...
        #endregion
        #region IAmADiscountFilterRelationshipTable<IStoreModel>
        /// <inheritdoc/>
        [JsonIgnore]
        int IAmADiscountFilterRelationshipTableModel<IStoreModel>.DiscountID { get => MasterID; set => MasterID = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<IStoreModel>.DiscountKey { get => MasterKey; set => MasterKey = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<IStoreModel>.DiscountName { get => MasterName; set => MasterName = value; }
        #endregion
    }
}
