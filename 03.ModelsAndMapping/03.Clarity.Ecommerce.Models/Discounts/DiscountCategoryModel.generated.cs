// <autogenerated>
// <copyright file="DiscountCategoryModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Discount Category.</summary>
            ...
            , IDiscountCategoryModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IDiscountModel,ICategoryModel>
        /// <inheritdoc/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
        ...
        #endregion
        #region IAmADiscountFilterRelationshipTable<ICategoryModel>
        /// <inheritdoc/>
        [JsonIgnore]
        int IAmADiscountFilterRelationshipTableModel<ICategoryModel>.DiscountID { get => MasterID; set => MasterID = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<ICategoryModel>.DiscountKey { get => MasterKey; set => MasterKey = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<ICategoryModel>.DiscountName { get => MasterName; set => MasterName = value; }
        #endregion
    }
}
