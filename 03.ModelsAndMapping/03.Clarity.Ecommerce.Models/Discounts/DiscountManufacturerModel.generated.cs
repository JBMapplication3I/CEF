// <autogenerated>
// <copyright file="DiscountManufacturerModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Discount Manufacturer.</summary>
            ...
            , IDiscountManufacturerModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IDiscountModel,IManufacturerModel>
        /// <inheritdoc/>
        [DefaultValue(null),
        ...
        #endregion
        #region IAmADiscountFilterRelationshipTable<IManufacturerModel>
        /// <inheritdoc/>
        [JsonIgnore]
        int IAmADiscountFilterRelationshipTableModel<IManufacturerModel>.DiscountID { get => MasterID; set => MasterID = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<IManufacturerModel>.DiscountKey { get => MasterKey; set => MasterKey = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<IManufacturerModel>.DiscountName { get => MasterName; set => MasterName = value; }
        #endregion
    }
}
