// <autogenerated>
// <copyright file="DiscountUserModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Discount User.</summary>
            ...
            , IDiscountUserModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IDiscountModel,IUserModel>
        /// <inheritdoc/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
        ...
        #endregion
        #region IAmADiscountFilterRelationshipTable<IUserModel>
        /// <inheritdoc/>
        [JsonIgnore]
        int IAmADiscountFilterRelationshipTableModel<IUserModel>.DiscountID { get => MasterID; set => MasterID = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<IUserModel>.DiscountKey { get => MasterKey; set => MasterKey = value; }

        /// <inheritdoc/>
        [JsonIgnore]
        string? IAmADiscountFilterRelationshipTableModel<IUserModel>.DiscountName { get => MasterName; set => MasterName = value; }
        #endregion
    }
}
