// <autogenerated>
// <copyright file="StoreSubscriptionModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Store Subscription.</summary>
    public partial class StoreSubscriptionModel
            ...
            , IStoreSubscriptionModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IStoreModel,ISubscriptionModel>
        /// <inheritdoc/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
        ...
        /// <inheritdoc cref="IAmARelationshipTableBaseModel{ISubscriptionModel}.Slave"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Slave), DataType = "SubscriptionModel?", ParameterType = "body", IsRequired = false,
                Description = "The Slave record (may only be partially mapped out).")]
        public SubscriptionModel? Slave { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        ISubscriptionModel? IAmARelationshipTableBaseModel<ISubscriptionModel>.Slave { get => Slave; set => Slave = (SubscriptionModel?)value; }
        #endregion
    }
}
