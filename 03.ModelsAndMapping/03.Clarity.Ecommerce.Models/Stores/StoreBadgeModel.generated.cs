// <autogenerated>
// <copyright file="StoreBadgeModel.generated.cs" company="clarity-ventures.com">
...
namespace Clarity.Ecommerce.Models
{
    ...
    /// <summary>A data transfer model for Store Badge.</summary>
    public partial class StoreBadgeModel
            ...
            , IStoreBadgeModel
    {
        ...
        #endregion
        #region IAmARelationshipTable<IStoreModel,IBadgeModel>
        /// <inheritdoc/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
        ...
        /// <inheritdoc cref="IAmARelationshipTableBaseModel{IBadgeModel}.Slave"/>
        [DefaultValue(null),
            DataMember(EmitDefaultValue = false),
            ApiMember(Name = nameof(Slave), DataType = "BadgeModel?", ParameterType = "body", IsRequired = false,
                Description = "The Slave record (may only be partially mapped out).")]
        public BadgeModel? Slave { get; set; }

        /// <inheritdoc/>
        [JsonIgnore]
        IBadgeModel? IAmARelationshipTableBaseModel<IBadgeModel>.Slave { get => Slave; set => Slave = (BadgeModel?)value; }
        #endregion
    }
}
